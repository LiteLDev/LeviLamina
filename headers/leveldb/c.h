...
LEVELDB_EXPORT leveldb_iterator_t *leveldb_create_iterator(leveldb_t *db,
                                                           const leveldb_readoptions_t *options);
...
LEVELDB_EXPORT void leveldb_writebatch_append(leveldb_writebatch_t *destination,
...
LEVELDB_EXPORT void leveldb_options_set_create_if_missing(leveldb_options_t *, unsigned char);
LEVELDB_EXPORT void leveldb_options_set_error_if_exists(leveldb_options_t *, unsigned char);
LEVELDB_EXPORT void leveldb_options_set_paranoid_checks(leveldb_options_t *, unsigned char);
...
LEVELDB_EXPORT leveldb_filterpolicy_t *leveldb_filterpolicy_create(
    ...
    unsigned char (*key_may_match)(void *,
                                   const char *key,
                                   size_t length,
                                   const char *filter,
                                   size_t filter_length),
...
LEVELDB_EXPORT void leveldb_readoptions_set_verify_checksums(leveldb_readoptions_t *,
                                                             unsigned char);
...
LEVELDB_EXPORT void leveldb_writeoptions_set_sync(leveldb_writeoptions_t *, unsigned char);
