...
public:
	...
	MCAPI class WeakPtr<class BlockLegacy> createWeakPtr(void)const;
	...
	MCAPI class BlockStateGroup* getBlockStateGroup(void);
	MCAPI class std::vector<struct CommandName, class std::allocator<struct CommandName> > getCommandNames(void)const;
	...
	MCAPI std::string const& getNamespace(void)const;
	...
	MCAPI class HashedString const& getRawNameHash(void)const;
	MCAPI std::string const& getRawNameId(void)const;
	MCAPI class BaseGameVersion const& getRequiredBaseGameVersion(void)const;
	...
	MCAPI void initializeBlockStateGroup(void);
	MCAPI bool isSolid(void)const;
	MCAPI bool isVanilla(void)const;
	...
	MCAPI class BlockLegacy& setBlockProperty(enum BlockProperty);
	...
	MCAPI void setOnlyPermutationandDefaultState(class std::unique_ptr<class Block, struct std::default_delete<class Block> >);
