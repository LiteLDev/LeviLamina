...
#    define EVP_PKEY_CTX_set_rsa_keygen_primes(ctx, primes) \
        RSA_pkey_ctx_ctrl(ctx, EVP_PKEY_OP_KEYGEN, EVP_PKEY_CTRL_RSA_KEYGEN_PRIMES, primes, NULL)
...
#    define EVP_PKEY_CTX_set_rsa_pss_keygen_mgf1_md(ctx, md)                                       \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_RSA_PSS, EVP_PKEY_OP_KEYGEN, EVP_PKEY_CTRL_RSA_MGF1_MD, 0, \
                          (void *)(md))

#    define EVP_PKEY_CTX_set_rsa_oaep_md(ctx, md)                                                  \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_RSA, EVP_PKEY_OP_TYPE_CRYPT, EVP_PKEY_CTRL_RSA_OAEP_MD, 0, \
                          (void *)(md))
...
#    define EVP_PKEY_CTX_set0_rsa_oaep_label(ctx, l, llen)                                         \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_RSA, EVP_PKEY_OP_TYPE_CRYPT, EVP_PKEY_CTRL_RSA_OAEP_LABEL, \
                          llen, (void *)(l))
...
#    define EVP_PKEY_CTX_set_rsa_pss_keygen_md(ctx, md)                                   \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_RSA_PSS, EVP_PKEY_OP_KEYGEN, EVP_PKEY_CTRL_MD, 0, \
                          (void *)(md))
...
/* Deprecated version */
DEPRECATEDIN_0_9_8(RSA *RSA_generate_key(int bits,
                                         unsigned long e,
...
int (*RSA_meth_get_multi_prime_keygen(
    const RSA_METHOD *meth))(RSA *rsa, int bits, int primes, BIGNUM *e, BN_GENCB *cb);
