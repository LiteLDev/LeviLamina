...
#    define PEM_read_bio_OCSP_REQUEST(bp, x, cb)                                                  \
        (OCSP_REQUEST *)PEM_ASN1_read_bio((char *(*)())d2i_OCSP_REQUEST, PEM_STRING_OCSP_REQUEST, \
                                          bp, (char **)(x), cb, NULL)
...
#    define PEM_write_bio_OCSP_REQUEST(bp, o)                                                     \
        PEM_ASN1_write_bio((int (*)())i2d_OCSP_REQUEST, PEM_STRING_OCSP_REQUEST, bp, (char *)(o), \
                           NULL, NULL, 0, NULL, NULL)

#    define PEM_write_bio_OCSP_RESPONSE(bp, o)                                         \
        PEM_ASN1_write_bio((int (*)())i2d_OCSP_RESPONSE, PEM_STRING_OCSP_RESPONSE, bp, \
