 ...
 *  \return 1 on success and 0 if an error occurred
 */
DEPRECATEDIN_1_2_0(int EC_GROUP_set_curve_GFp(EC_GROUP *group,
                                              const BIGNUM *p,
                                              const BIGNUM *a,
                                              const BIGNUM *b,
                                              BN_CTX *ctx))
 ...
 *  \return 1 on success and 0 if an error occurred
 */
DEPRECATEDIN_1_2_0(int EC_GROUP_set_curve_GF2m(EC_GROUP *group,
                                               const BIGNUM *p,
                                               const BIGNUM *a,
                                               const BIGNUM *b,
                                               BN_CTX *ctx))
...
#    define EVP_PKEY_CTX_set_ecdh_cofactor_mode(ctx, flag)                                      \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_EC, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_EC_ECDH_COFACTOR, \
                          flag, NULL)
...
#    define EVP_PKEY_CTX_set_ecdh_kdf_type(ctx, kdf)                                            \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_EC, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_EC_KDF_TYPE, kdf, \
                          NULL)
...
#    define EVP_PKEY_CTX_set_ecdh_kdf_md(ctx, md)                                           \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_EC, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_EC_KDF_MD, 0, \
                          (void *)(md))

#    define EVP_PKEY_CTX_get_ecdh_kdf_md(ctx, pmd)                                              \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_EC, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_GET_EC_KDF_MD, 0, \
                          (void *)(pmd))

#    define EVP_PKEY_CTX_set_ecdh_kdf_outlen(ctx, len)                                            \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_EC, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_EC_KDF_OUTLEN, len, \
                          NULL)

#    define EVP_PKEY_CTX_get_ecdh_kdf_outlen(ctx, plen)                                          \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_EC, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_GET_EC_KDF_OUTLEN, \
                          0, (void *)(plen))

#    define EVP_PKEY_CTX_set0_ecdh_kdf_ukm(ctx, p, plen)                                        \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_EC, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_EC_KDF_UKM, plen, \
                          (void *)(p))

#    define EVP_PKEY_CTX_get0_ecdh_kdf_ukm(ctx, p)                                               \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_EC, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_GET_EC_KDF_UKM, 0, \
                          (void *)(p))
