...
static_assert(
    sizeof(AddPlayerPacket) == 0x5E8 || sizeof(AddPlayerPacket) == 48,
    "size of AddPlayerPacket should be 1512 or 48(default)"
);
static_assert(
...
static_assert(
    sizeof(PlayerActionPacket) == 0x58 || sizeof(PlayerActionPacket) == 48,
...
static_assert(
    sizeof(EventPacket) == 0x140 || sizeof(EventPacket) == 48,
...
static_assert(
    sizeof(AvailableCommandsPacket) == 0xC0 || sizeof(AvailableCommandsPacket) == 48,
...
static_assert(
    sizeof(ScriptCustomEventPacket) == 0x60 || sizeof(ScriptCustomEventPacket) == 48,
...
static_assert(
    sizeof(EmotePacket) == 0x60 || sizeof(EmotePacket) == 48,
...
static_assert(
    sizeof(NetworkSettingsPacket) == 0x48 || sizeof(NetworkSettingsPacket) == 48,
    "size of NetworkSettingsPacket should be 72 or 48(default)"
);
static_assert(
    sizeof(PlayerAuthInputPacket) == 0xB0 || sizeof(PlayerAuthInputPacket) == 48,
...
static_assert(
    sizeof(ClientCheatAbilityPacket) == 0x58 || sizeof(ClientCheatAbilityPacket) == 48,
    "size of ClientCheatAbilityPacket should be 88 or 48(default)"
);
