...
namespace RIPEMD_320_NS
{
	class RIPEMD_320
	{
		...
		public:
			...
			CONSTEXPR_CPP17_CHOCOBO1_HASH RIPEMD_320& addData(const void *ptr, const std::size_t length);
	...
	CONSTEXPR_CPP17_CHOCOBO1_HASH RIPEMD_320& RIPEMD_320::addData(const void *ptr, const std::size_t length)
	{
