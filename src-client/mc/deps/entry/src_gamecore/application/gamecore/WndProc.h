...
public:
    ...
    virtual ::std::optional<int64> onShow(::MainGameCore::WndProc::WndProcParams);
    ...
    virtual ::std::optional<int64> onEnterSizeMove(::MainGameCore::WndProc::WndProcParams);
    ...
    virtual ::std::optional<int64> onDPIChange(::MainGameCore::WndProc::WndProcParams);
    ...
    virtual ::std::optional<int64> onActivateApp(::MainGameCore::WndProc::WndProcParams);

    virtual ::std::optional<int64> onFocusChange(::MainGameCore::WndProc::WndProcParams);
