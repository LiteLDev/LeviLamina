...
public:
    ...
    MCNAPI void addToEnd(::Certificate const& certificate);
    ...
    MCNAPI ::Certificate& getRootParentCertificate();
...
public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static ::std::unique_ptr<::Certificate> addAuthorityToCertificate(
