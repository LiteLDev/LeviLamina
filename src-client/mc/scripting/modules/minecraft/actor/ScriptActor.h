...
struct ScoreboardId;
struct VecXZ;
namespace ScriptModuleMinecraft { struct IComponentFactory; }
namespace ScriptModuleMinecraft { struct ScriptAABB; }
...
namespace ScriptModuleMinecraft { struct ScriptActorComponent; }
...
namespace ScriptModuleMinecraft { struct ScriptBlockRaycastHit; }
...
namespace ScriptModuleMinecraft { struct ScriptEffectType; }
namespace ScriptModuleMinecraft { struct ScriptEntityEffectOptions; }
namespace ScriptModuleMinecraft { struct ScriptEntityRaycastHit; }
...
namespace ScriptModuleMinecraft { struct ScriptMobEffectInstance; }
namespace ScriptModuleMinecraft { struct ScriptPlayAnimationOptions; }
namespace ScriptModuleMinecraft { struct ScriptScoreboardIdentity; }
namespace ScriptModuleMinecraft { struct ScriptTeleportOptions; }
namespace ScriptModuleMinecraft { struct ScriptVector; }
...
namespace Scripting { struct ScriptObjectFactory; }
