...
namespace ScriptModuleMinecraftServerUI { struct ScriptActionFormResponse; }
namespace ScriptModuleMinecraftServerUI { struct ScriptFormRejectError; }
namespace ScriptModuleMinecraftServerUI { struct ScriptMessageFormResponse; }
namespace ScriptModuleMinecraftServerUI { struct ScriptMessageFormResponseV2; }
namespace ScriptModuleMinecraftServerUI { struct ScriptModalFormResponse; }
namespace ScriptModuleMinecraftServerUI { struct ScriptModalFormResponseV2; }
// clang-format on
