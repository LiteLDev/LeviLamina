...
namespace VoxelShapes { struct VoxelShape; }
// clang-format on
...
public:
    ...
    MCAPI float getDestructionParticleCount() const;

    MCAPI ::Matrix getItemDisplayTransform(::ClientBlockPipeline::ItemTransforms::Type type) const;
