...
struct IContainerRegistryTracker;
struct IDynamicContainerSerialization;
...
public:
    ...
    MCAPI short getLegacyIDFromName(::HashedString const& name);
    ...
    MCAPI void initClientData(::ResourcePackManager& resourcePackManager, ::Experiments const& experiments);
