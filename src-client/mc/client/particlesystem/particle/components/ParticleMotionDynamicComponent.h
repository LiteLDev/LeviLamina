...
class ParticleMotionDynamicComponent : public ::ParticleSystem::ParticleMotionComponentBase {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<8, 48, ::ExpressionNode[3]> mLinearAccelerationExpr;
    ::ll::TypedStorage<8, 16, ::ExpressionNode>    mLinearDragCoefficientExpr;
    ::ll::TypedStorage<8, 16, ::ExpressionNode>    mRotationAccelerationExpr;
    ::ll::TypedStorage<8, 16, ::ExpressionNode>    mRotationDragCoefficientExpr;
    // NOLINTEND
