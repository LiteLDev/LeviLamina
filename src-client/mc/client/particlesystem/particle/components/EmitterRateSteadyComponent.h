...
class EmitterRateSteadyComponent : public ::ParticleSystem::EmitterRateComponentBase {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<8, 16, ::ExpressionNode> mSpawnRateExpr;
    ::ll::TypedStorage<8, 16, ::ExpressionNode> mMaxParticlesExpr;
    // NOLINTEND
...
public:
    ...
    MCAPI uint64 $getNumberOfParticlesToEmit(
        ::ParticleSystem::ComponentAccessParticleEmitter& emitter,
        ::RenderParams&                                   renderParams,
        ::std::chrono::nanoseconds const&                 dt
    );
