...
public:
    // IOptionRegistry inner types define
...
public:
    ...
    virtual ::std::shared_ptr<::IOptionRegistry const> sharedFromThis() const = 0;
    ...
    virtual void elevateSaveRequestMode(::IOptionRegistry::SaveRequestMode saveRequestMode) = 0;

    virtual ::ChatOptions const& getChatOptions() const = 0;

    virtual ::ChatOptions& getChatOptions() = 0;

    virtual ::ConstOptionIterator begin() const = 0;

    virtual ::ConstOptionIterator end() const = 0;
    ...
    virtual bool getHideSkyFlash() const = 0;
    ...
    virtual float getPanoramaSpeed() const = 0;
    ...
    virtual void setDoNotShowPartyTabFTUE(bool hasShownModal) = 0;

    virtual bool getDoNotShowPartyTabFTUE() const = 0;
    ...
    virtual ::std::string const& getRealmsV2EndpointPayment() const = 0;
    ...
    virtual int getMaxFrameRate() const = 0;

    virtual ::gsl::not_null<::Option*> getEffectiveMaxFramerateOption() = 0;

    virtual ::gsl::not_null<::Option const*> getEffectiveMaxFramerateOption() const = 0;
    // NOLINTEND
};
