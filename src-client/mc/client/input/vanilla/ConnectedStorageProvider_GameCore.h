...
public:
    ...
    MCAPI ::std::string $encodeWorldName(::std::string const&);

    MCAPI ::std::string $encodeFileName(::std::string const&);
    ...
    MCAPI ::Core::RemoteStorageManifest $getManifest(::std::string const&);
