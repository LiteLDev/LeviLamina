...
public:
    ...
    ::ll::TypedStorage<1, 1, bool>                          mBackupFontHandleOverridden;
    ...
    ::ll::TypedStorage<1, 1, bool>                          mCachedTextDirty;
    ...
    ::ll::TypedStorage<1, 1, bool>                          mNotifyEllipsesOnSiblings;
...
public:
    ...
    virtual bool overridesLayoutAxisOffset(::LayoutVariableType const type) const /*override*/;

    virtual float getLayoutAxisOffsetOverride(::LayoutVariableType const type) const /*override*/;
...
public:
    ...
    MCAPI bool $overridesLayoutAxisOffset(::LayoutVariableType const type) const;

    MCAPI float $getLayoutAxisOffsetOverride(::LayoutVariableType const type) const;
