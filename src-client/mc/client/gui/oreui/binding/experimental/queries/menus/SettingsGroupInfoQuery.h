...
class SettingsGroupInfoQuery : public ::OreUI::Experimental::QueryBase<::OreUI::Experimental::SettingsGroupInfoQuery> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI SettingsGroupInfoQuery(::OreUI::Experimental::ClientDependencies const& client, ::std::string const& id);
    // NOLINTEND
