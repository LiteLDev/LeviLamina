...
: public ::OreUI::Experimental::QueryBase<::OreUI::Experimental::DeviceStorageInformationQuery>,
...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<8, 80, ::OreUI::Experimental::DeviceStorageInformationQuery::ThrottledUpdater> mStorageUpdater;
    ::ll::TypedStorage<8, 176, ::OreUI::Experimental::Property<::FileStorageDirectory>>               mStorageLocation;
    ::ll::TypedStorage<8, 176, ::OreUI::Experimental::Property<uint64>>                               mStorageSize;
    ::ll::TypedStorage<8, 176, ::OreUI::Experimental::Property<uint64>>                               mStorageUsed;
    ::ll::TypedStorage<8, 200, ::OreUI::Experimental::Property<::std::string>> mStorageAvailableSize;
    ::ll::TypedStorage<8, 176, ::OreUI::Experimental::Property<bool>>          mSupportsSizeQuery;
    ::ll::TypedStorage<8, 176, ::OreUI::Experimental::Property<bool>>          mIsStorageFull;
    ::ll::TypedStorage<8, 176, ::OreUI::Experimental::Property<bool>>          mIsStorageLow;
    // NOLINTEND
