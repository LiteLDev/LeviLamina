...
class LicenseQuery : public ::OreUI::Experimental::QueryBase<::OreUI::Experimental::LicenseQuery> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<8, 200, ::OreUI::Experimental::Property<::std::string>> mFontLicense;
    // NOLINTEND
