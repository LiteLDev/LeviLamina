...
public:
    ...
    ::ll::TypedStorage<
        8,
        176,
        ::OreUI::Property<::std::optional<::OreUI::ContentItemType>, ::std::optional<::OreUI::ContentItemType>>>
        mContentType;
    ...
    ::ll::TypedStorage<8, 208, ::OreUI::Property<::std::optional<::std::string>, ::std::optional<::std::string>>>
        mDescription;
    ::ll::TypedStorage<8, 208, ::OreUI::Property<::std::optional<::std::string>, ::std::optional<::std::string>>> mDate;
    ::ll::TypedStorage<
        8,
        176,
    ...
    ::ll::TypedStorage<8, 208, ::OreUI::Property<::std::optional<::std::string>, ::std::optional<::std::string>>>
                                                              mVersion;
    ::ll::TypedStorage<8, 176, ::OreUI::Property<bool, bool>> mIsSelected;
    ::ll::TypedStorage<8, 176, ::OreUI::Property<bool, bool>> mHasErrors;
    // NOLINTEND
