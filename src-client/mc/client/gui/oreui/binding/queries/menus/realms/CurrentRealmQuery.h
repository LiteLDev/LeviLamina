...
namespace Social { struct RealmWorldPublisherData; }
// clang-format on
...
public:
    ...
    MCAPI void _clearRealmProperties();

    MCAPI void _setRealmProperties(::Social::RealmWorldPublisherData const& realmData, ::std::string xuid);
    // NOLINTEND
