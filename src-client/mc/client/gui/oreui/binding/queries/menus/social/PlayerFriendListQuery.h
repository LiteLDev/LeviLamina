...
namespace Social { class PlayerFriendList; }
// clang-format on

namespace OreUI {

class PlayerFriendListQuery : public ::OreUI::QueryBase<::OreUI::PlayerFriendListQuery> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    PlayerFriendListQuery();

public:
    // member functions
    // NOLINTBEGIN
    MCAPI PlayerFriendListQuery(
