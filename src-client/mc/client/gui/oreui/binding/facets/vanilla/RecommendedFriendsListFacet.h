...
class RecommendedFriendsListFacet : public ::OreUI::FacetBase_DEPRECATED<::OreUI::RecommendedFriendsListFacet> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~RecommendedFriendsListFacet() /*override*/ = default;
