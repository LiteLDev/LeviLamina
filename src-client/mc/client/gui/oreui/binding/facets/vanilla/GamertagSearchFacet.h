...
namespace Social { struct GamertagSearchResults; }
// clang-format on

namespace OreUI {

class GamertagSearchFacet : public ::OreUI::FacetBase<::OreUI::GamertagSearchFacet> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCFOLD ::std::vector<::OreUI::AddFriendUserItem> const& getDisplayableResults() const;

    MCFOLD ::XboxAPICallResult const getXboxAPICallResult() const;

    MCFOLD bool isDataLoading() const;

    MCAPI void search(::std::string const& query) const;
    // NOLINTEND
