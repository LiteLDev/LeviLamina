...
#include "mc/deps/renoir/IndexBufferObject.h"
...
#include "mc/deps/renoir/Sampler2DObject.h"
#include "mc/deps/renoir/Texture2DObject.h"
#include "mc/deps/renoir/VertexBufferObject.h"
...
namespace renoir { struct DrawIndexedCmd; }
...
namespace renoir { struct UpdateConstantBufferCmd; }
// clang-format on

namespace OreUI {

class UIRenderDragonBackend : public ::OreUI::IRenderingBackend {
public:
...
public:
    ...
    ::ll::TypedStorage<
        8,
        64,
        ::std::unordered_map<::renoir::VertexBufferObject, ::OreUI::UIRenderDragonBackend::VertexBuffer>>
                                                           mVertexBuffers;
    ::ll::TypedStorage<4, 4, ::renoir::VertexBufferObject> mCurrentVertexBuffer;
    ::ll::TypedStorage<
        8,
        64,
        ::std::unordered_map<::renoir::IndexBufferObject, ::OreUI::UIRenderDragonBackend::IndexBuffer>>
                                                          mIndexBuffers;
    ::ll::TypedStorage<4, 4, ::renoir::IndexBufferObject> mCurrentIndexBuffer;
    ::ll::TypedStorage<
        8,
        64,
        ::std::unordered_map<::renoir::ConstantBufferObject, ::OreUI::UIRenderDragonBackend::ConstantBuffer>>
        mConstantBuffers;
    ::ll::TypedStorage<
        8,
        64,
        ::std::unordered_map<::renoir::Texture2DObject, ::OreUI::UIRenderDragonBackend::TextureData>>
        mTextures;
    ::ll::TypedStorage<
        8,
        64,
        ::std::unordered_map<::renoir::DepthStencilTextureObject, ::OreUI::UIRenderDragonBackend::TextureData>>
        mDepthTextures;
    ...
    ::ll::TypedStorage<8, 160, ::mce::framebuilder::GamefacePipelineState>           mCurrentPipelineState;
    ::ll::TypedStorage<8, 856, ::mce::framebuilder::GamefaceBatchDraw::GamefaceMesh> mMesh;
    ::ll::TypedStorage<8, 24, ::mce::framebuilder::GamefaceBatchDraw>                mBatch;
    // NOLINTEND

public:
    // prevent constructor by default
    UIRenderDragonBackend& operator=(UIRenderDragonBackend const&);
    UIRenderDragonBackend(UIRenderDragonBackend const&);
    UIRenderDragonBackend();

public:
    // virtual functions
    // NOLINTBEGIN
    virtual void
    initializeStaticResources(::Bedrock::NonOwnerPointer<::mce::ShaderGroup> const& shaderGroup) /*override*/;

    virtual void onAppPreSuspended() /*override*/;

    virtual ::std::vector<::OreUI::BufferSnapshot> getVertexBufferSnapshots() /*override*/;

    virtual ::std::vector<::OreUI::BufferSnapshot> getIndexBufferSnapshots() /*override*/;
    ...
    virtual void UnmapIndexBuffer(::renoir::IndexBufferObject object, uint count) /*override*/;
    ...
    virtual ~UIRenderDragonBackend() /*override*/;
    // NOLINTEND

public:
    // member functions
    // NOLINTBEGIN
    MCAPI UIRenderDragonBackend(
        ::OreUI::FrameDebugData&         frameDebugData,
        ::OreUI::TemporaryTextureHolder& temporaryTextureHolder
    );

    MCAPI void _drawIndexed(::renoir::DrawIndexedCmd const& cmd);
    ...
    MCAPI void _updateConstantBuffer(::renoir::UpdateConstantBufferCmd const& cmd);
    // NOLINTEND
...
public:
    ...
    // NOLINTBEGIN
    MCFOLD void $initializeStaticResources(::Bedrock::NonOwnerPointer<::mce::ShaderGroup> const& shaderGroup);

    MCFOLD void $onAppPreSuspended();

    MCAPI ::std::vector<::OreUI::BufferSnapshot> $getVertexBufferSnapshots();

    MCAPI ::std::vector<::OreUI::BufferSnapshot> $getIndexBufferSnapshots();
    ...
    MCAPI void $UnmapIndexBuffer(::renoir::IndexBufferObject object, uint count);
