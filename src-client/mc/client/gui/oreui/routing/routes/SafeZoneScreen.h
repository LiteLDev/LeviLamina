...
class SafeZoneScreen : public ::OreUI::IEntryPoint {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    SafeZoneScreen& operator=(SafeZoneScreen const&);
    SafeZoneScreen(SafeZoneScreen const&);
    SafeZoneScreen();
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit SafeZoneScreen(::ui::ScreenTechStackSelector const& screenTechStackSelector);
    // NOLINTEND
