...
class CreateNewWorld : public ::OreUI::IEntryPoint {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    CreateNewWorld& operator=(CreateNewWorld const&);
    CreateNewWorld(CreateNewWorld const&);
    CreateNewWorld();
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit CreateNewWorld(::ui::ScreenTechStackSelector const& screenTechStackSelector);

    MCAPI bool _isOreUICreateNewWorldEnabled() const;
    // NOLINTEND

public:
    // static functions
    // NOLINTBEGIN
    MCAPI static ::std::string composeRoute(::std::string const& manifestId);

    MCAPI static bool isMatchingRoute(::std::string const& route);
