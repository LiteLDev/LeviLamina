...
class WorldPreloading : public ::OreUI::IEntryPoint {
public:
    // virtual functions
    // NOLINTBEGIN
    ...
    virtual ~WorldPreloading() /*override*/ = default;
    // NOLINTEND

public:
    // static variables
    // NOLINTBEGIN
    MCAPI static ::std::add_lvalue_reference_t<char const[]> PROJECT_ROUTE();
