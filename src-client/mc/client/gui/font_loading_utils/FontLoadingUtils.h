...
namespace FontLoadingUtils { struct ParsedFontAliasData; }
...
MCAPI ::std::shared_ptr<::FontAlias> loadFontAlias(
    ::FontLoadingUtils::ParsedFontAliasData const&  parsedData,
...
MCAPI bool parseFontAliasMetadata(::Json::Value const& aliasMetaData, ::FontLoadingUtils::ParsedFontAliasData& outData);
// NOLINTEND
