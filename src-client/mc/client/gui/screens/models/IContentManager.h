...
public:
    ...
    virtual ::Bedrock::PubSub::Subscription registerToReloadViews(::std::function<void()>) = 0;

    virtual ::Bedrock::PubSub::Subscription registerToDeleteContent(::std::function<void()>) = 0;
    // NOLINTEND
