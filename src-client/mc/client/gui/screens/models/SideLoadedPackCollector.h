...
class SideLoadedPackCollector : public ::SkinPackCollector {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    SideLoadedPackCollector& operator=(SideLoadedPackCollector const&);
...
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~SideLoadedPackCollector() /*override*/ = default;
