...
class Pack;
struct DirectoryPackSource;
struct IInPackagePacks;
struct IPackIOProvider;
struct IWorldTemplateManager;
struct InPackagePackSource;
struct PackIdVersion;
struct PackSource;
struct TreatmentPackSource;
struct WorldHistoryPackSource;
struct WorldTemplateCollectionView;
struct WorldTemplatePackSource;
namespace Core { class Path; }
namespace PackCommand { struct IPackCommandPipeline; }
namespace Realms { struct RealmsServicePackSource; }
