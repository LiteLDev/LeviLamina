...
struct AsyncJoinTaskManager;
struct ChatEvent;
struct ClassroomModeNetworkHandler;
struct GameSpecificNetEventCallback;
struct GameTestNetworkAdapter;
struct IEDUSystems;
struct ILevel;
struct IMinecraftApp;
struct IPacketSecurityController;
