...
class ScriptProjectAfterEvents : public ::Scripting::WeakHandleFromThis<::Editor::ScriptModule::ScriptProjectAfterEvents> {
public:
    ...
    class ScriptProjectAfterEventsDeferredEventListener : public ::ScriptModuleMinecraft::IScriptScriptDeferredEventListener<::Editor::ScriptModule::ScriptProjectAfterEvents> {
    public:
        // virtual functions
        // NOLINTBEGIN
        // vIndex: 4
...
public:
    ...
    MCNAPI ::Editor::ScriptModule::ScriptProjectAfterEvents& operator=(::Editor::ScriptModule::ScriptProjectAfterEvents&&);

    MCNAPI void registerListeners(::ScriptDeferredEventCoordinator& eventCoordinator, ::Editor::ServiceProviderCollection& serviceProviders);
...
public:
    ...
    MCNAPI static ::ScriptModuleMinecraft::ScriptAfterEventMetadata<::Editor::ScriptModule::ScriptProjectAfterEvents> const& getMetadata();
    // NOLINTEND
