...
class WidgetStateChangePayload : public ::Editor::Network::NetworkPayload<::Editor::Network::WidgetStateChangePayload>, public ::Editor::Network::WidgetCommonBasePayload {
public:
    // member variables
    // NOLINTBEGIN
