...
class RealmsAPI : public ::Realms::IContentApi, public ::Realms::ISubscriptionApi, public ::Realms::IWorldApi, public ::Realms::IInvitesApi, public ::std::enable_shared_from_this<::RealmsAPI> {
public:
...
public:
    ...
    // vIndex: 1
    virtual void initializeWorld(::Realms::RealmId, ::std::string const&, ::std::string const&, ::std::function<void(::Realms::GenericStatus, ::Realms::FailureReason)>) /*override*/;

    // vIndex: 2
    virtual void openWorld(::Realms::RealmId, ::std::function<void(::Realms::GenericStatus)>, ::std::function<void(int)>) /*override*/;

    // vIndex: 3
    virtual void closeWorld(::Realms::RealmId, ::std::function<void(::Realms::GenericStatus)>, ::std::function<void(int)>) /*override*/;

    // vIndex: 4
    virtual void resetWorld(::Realms::RealmId, ::std::function<void(::Realms::GenericStatus)>, ::std::function<void(int)>) /*override*/;

    // vIndex: 1
    virtual void getPendingInviteCount(::std::function<void(::Realms::GenericStatus, int)>) /*override*/;

    // vIndex: 2
    virtual void getPendingInviteCountFriendsOnly(::std::function<void(::Realms::GenericStatus, int)>, ::std::vector<::std::string> const&) /*override*/;

    // vIndex: 3
    virtual void listInvites(::std::function<void(::Realms::GenericStatus, ::std::vector<::Invites::Invite>)>, bool) /*override*/;

    // vIndex: 1
    virtual void applyContentOnRealm(::Realms::RealmId const, ::std::vector<::Realms::Content> const&, ::std::function<void(::Realms::GenericStatus)>) /*override*/;

    // vIndex: 2
    virtual void fetchAppliedPacks(::Realms::RealmId, ::std::function<void(::Realms::GenericStatus, ::std::vector<::Realms::Content>)>) /*override*/;

    // vIndex: 3
    virtual void checkForExistingPack(::std::string const&, ::std::string const&, ::std::function<void(::Realms::GenericStatus, bool)>) /*override*/;

    // vIndex: 1
    virtual void getSubscriptionDetails(::Realms::RealmId, ::std::function<void(::Realms::GenericStatus, ::Realms::SubscriptionInfo)>) /*override*/;
    // NOLINTEND
