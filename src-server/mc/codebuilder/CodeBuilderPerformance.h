...
public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static void fireCodeBuilderLoadPerformanceEvent(::IMinecraftEventing const* eventing, ::CodeBuilderPerformance::Stage stage, ::std::string_view codeProjectId, uint64 tutorialSize, uint64 downloadSize, ::std::chrono::milliseconds duration);
