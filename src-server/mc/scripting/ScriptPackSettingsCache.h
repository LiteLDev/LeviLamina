...
public:
    ...
    public:
        // member functions
        // NOLINTBEGIN
        MCNAPI CachedSettingsByPackId(::mce::UUID packId, ::std::unordered_map<::std::string, ::PackSettingValueAndDefault> values);
        // NOLINTEND
    
    public:
        // constructor thunks
        // NOLINTBEGIN
        MCNAPI void* $ctor(::mce::UUID packId, ::std::unordered_map<::std::string, ::PackSettingValueAndDefault> values);
        // NOLINTEND
...
public:
    ...
    MCNAPI ::Bedrock::PubSub::Subscription registerObserver(::mce::UUID packId, ::std::function<void(::std::string const&, ::std::variant<float, bool, ::std::string> const&)> callback);

    MCNAPI void updatePackSetting(::mce::UUID packId, ::std::string const& name, ::std::variant<float, bool, ::std::string> const& value);
    // NOLINTEND
