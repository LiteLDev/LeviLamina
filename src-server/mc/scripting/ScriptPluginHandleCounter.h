...
public:
    ...
    // NOLINTBEGIN
    // vIndex: 1
    virtual void onMakeObject(::Scripting::LifetimeRegistry&, ::Scripting::ObjectHandle, ::entt::meta_type const& type, uint size) /*override*/;

    // vIndex: 2
    virtual void onDestroyObject(::Scripting::LifetimeRegistry&, ::Scripting::ObjectHandle, ::entt::meta_type const& type, uint size) /*override*/;
...
public:
    ...
    // NOLINTBEGIN
    MCNAPI void $onMakeObject(::Scripting::LifetimeRegistry&, ::Scripting::ObjectHandle, ::entt::meta_type const& type, uint size);

    MCNAPI void $onDestroyObject(::Scripting::LifetimeRegistry&, ::Scripting::ObjectHandle, ::entt::meta_type const& type, uint size);
    // NOLINTEND
