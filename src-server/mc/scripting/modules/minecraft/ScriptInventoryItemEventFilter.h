...
public:
    ...
    MCNAPI ::ScriptModuleMinecraft::EventFilters::ScriptInventoryItemEventFilter& operator=(::ScriptModuleMinecraft::EventFilters::ScriptInventoryItemEventFilter&&);

    MCNAPI ::ScriptModuleMinecraft::EventFilters::ScriptInventoryItemEventFilter& operator=(::ScriptModuleMinecraft::EventFilters::ScriptInventoryItemEventFilter const&);

    MCNAPI void process();

    MCNAPI bool shouldAllow(::ScriptModuleMinecraft::EventFilters::ScriptInventoryItemEventFilterData const& data) const;
