...
// functions
// NOLINTBEGIN
MCNAPI ::std::unique_ptr<::LevelEventGenericPacket> createPlayMusicPacket(::std::string const& trackId, ::std::optional<::ScriptModuleMinecraft::ScriptMusicOptions> musicOptions, bool shouldQueue);
