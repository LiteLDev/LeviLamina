...
public:
    ...
    MCAPI ScriptItemStartUseAfterEvent(::Scripting::StrongTypedObjectHandle<::ScriptModuleMinecraft::ScriptItemStack> item, ::Player const& player, ::ItemStartUseEvent const& itemEvent, ::Scripting::WeakLifetimeScope const& scope);
...
public:
    ...
    MCAPI void* $ctor(::Scripting::StrongTypedObjectHandle<::ScriptModuleMinecraft::ScriptItemStack> item, ::Player const& player, ::ItemStartUseEvent const& itemEvent, ::Scripting::WeakLifetimeScope const& scope);
    // NOLINTEND
