...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI ::ScriptModuleMinecraft::ScriptStructurePlaceOptions& operator=(::ScriptModuleMinecraft::ScriptStructurePlaceOptions const&);

    MCNAPI ::ScriptModuleMinecraft::ScriptStructurePlaceOptions& operator=(::ScriptModuleMinecraft::ScriptStructurePlaceOptions&&);
