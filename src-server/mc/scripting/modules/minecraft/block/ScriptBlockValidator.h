...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI ::std::optional<::ScriptModuleMinecraft::ScriptLocationInUnloadedChunkError> getChunkAtPositionLoadedAndTickingError();

    MCNAPI ::std::optional<::ScriptModuleMinecraft::ScriptLocationOutOfWorldBoundsError> getPositionWithinWorldBoundsError();
    // NOLINTEND
