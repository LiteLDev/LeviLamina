...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI ScriptSentrySession(::std::unique_ptr<::ScriptModuleDiagnostics::IScriptSentryRequestSender> requestSender, ::ScriptModuleDiagnostics::ScriptSentrySessionParameters parameters);

    MCNAPI void _fillError(::SentryEnvelopePayload& result, ::Scripting::BaseError const& error, ::SentryEnvelopePayloadExceptionMechanism const& exceptionMechanism);

    MCNAPI void _sendEvent(::SentryEnvelopePayload eventPayload) const;

    MCNAPI void addBreadcrumb(::SentryBreadcrumbLevel level, ::std::string message, ::std::optional<::std::string> category);

    MCNAPI void onManuallyCapturedException(::Scripting::BaseError const& error, ::std::optional<::ScriptModuleDiagnostics::ScriptSentryCaptureContext> context);
...
public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::std::unique_ptr<::ScriptModuleDiagnostics::IScriptSentryRequestSender> requestSender, ::ScriptModuleDiagnostics::ScriptSentrySessionParameters parameters);
    // NOLINTEND
