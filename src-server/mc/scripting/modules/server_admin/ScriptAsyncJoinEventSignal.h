...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI void OnAsyncJoinCallback(::Scripting::Closure<::Scripting::Future<void()>(::Scripting::StrongTypedObjectHandle<::ScriptModuleServerAdmin::ScriptAsyncPlayerJoinBeforeEvent>)> closure, ::IAsyncJoinRegistrar* asyncJoinRegistrar, ::std::variant<::std::reference_wrapper<::ConnectionRequest const>, ::std::reference_wrapper<::SubClientConnectionRequest const>> const& anyReq, ::std::shared_ptr<::AsyncVerdictPromise> promisePtr);

    MCNAPI ::Scripting::Closure<::Scripting::Future<void()>(::Scripting::StrongTypedObjectHandle<::ScriptModuleServerAdmin::ScriptAsyncPlayerJoinBeforeEvent>)> subscribe(::Scripting::Closure<::Scripting::Future<void ()> (::Scripting::StrongTypedObjectHandle<::ScriptModuleServerAdmin::ScriptAsyncPlayerJoinBeforeEvent>)> closure);

    MCNAPI void tick();

    MCNAPI bool unsubscribe(::Scripting::Closure<::Scripting::Future<void()>(::Scripting::StrongTypedObjectHandle<::ScriptModuleServerAdmin::ScriptAsyncPlayerJoinBeforeEvent>)> const& closure);
