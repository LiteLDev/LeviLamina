...
public:
    ...
    public:
        ...
        ::ll::TypedStorage<8, 8, bool(::CommandRegistry::*) (void*, ::CommandRegistry::ParseToken const&, ::CommandOrigin const&, int, ::std::string&, ::std::vector<::std::string>&)const> parse;
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::TypedStorage<8, 16, ::std::map<::CommandRegistry::Symbol, ::entt::dense_set<::CommandRegistry::Symbol, ::CommandRegistry::SymbolHasher, ::std::equal_to<void>>>> first;
        ::ll::TypedStorage<8, 16, ::std::map<::CommandRegistry::Symbol, ::entt::dense_set<::CommandRegistry::Symbol, ::CommandRegistry::SymbolHasher, ::std::equal_to<void>>>> follow;
        ::ll::TypedStorage<8, 72, ::entt::dense_map<::std::pair<::CommandRegistry::Symbol, ::CommandRegistry::Symbol>, int, ::CommandRegistry::SymbolPairHasher, ::std::equal_to<void>>> predict;
...
public:
    ...
    ::ll::TypedStorage<8, 64, ::std::function<void(::std::string const&, ::CommandFlag&, ::CommandPermissionLevel&)>> mCommandOverrideFunctor;
...
public:
    ...
    MCAPI void setCommandRegistrationOverride(::std::function<void(::std::string const&, ::CommandFlag&, ::CommandPermissionLevel&)> functor);
