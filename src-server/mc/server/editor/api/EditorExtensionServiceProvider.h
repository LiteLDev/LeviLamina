...
public:
    ...
    // vIndex: 7
    virtual ::Scripting::Result_deprecated<::Bedrock::PubSub::Subscription> registerForScriptSystemRebuildEvent(::std::function<::Scripting::Result_deprecated<void>(::std::optional<::Scripting::ContextId>)>) = 0;

    // vIndex: 8
    virtual ::Scripting::Result_deprecated<::Bedrock::PubSub::Subscription> registerForScriptSystemTeardownEvent(::std::function<::Scripting::Result_deprecated<void>()>) = 0;
