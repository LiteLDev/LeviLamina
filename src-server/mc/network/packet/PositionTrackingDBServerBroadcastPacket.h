...
#include "mc/network/packet/PositionTrackingDBServerBroadcastPacketPayload.h"
...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<8, 32, ::PositionTrackingDBServerBroadcastPacketPayload> mPayload;
