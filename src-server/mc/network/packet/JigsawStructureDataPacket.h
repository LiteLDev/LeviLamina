...
#include "mc/network/packet/JigsawStructureDataPacketPayload.h"
...
MC_NETWORK_PACKET_DECALARE(JigsawStructureDataPacket) {
...
public:
    ...
    virtual ::Bedrock::Result<void> _read(
        ::ReadOnlyBinaryStream & stream) /*override*/;

    // vIndex: 16
    virtual ::Bedrock::Result<void> _read(::ReadOnlyBinaryStream& bitStream,
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit JigsawStructureDataPacket(::JigsawStructureDataPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::JigsawStructureDataPacketPayload payload);
    // NOLINTEND
