...
MC_NETWORK_PACKET_DECALARE(ItemRegistryPacket) {
...
public:
    ...
    // vIndex: 0
    virtual ~ItemRegistryPacket() /*override*/;
    // NOLINTEND

public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit ItemRegistryPacket(::ItemRegistryPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::ItemRegistryPacketPayload payload);
    // NOLINTEND
