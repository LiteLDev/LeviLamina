...
#include "mc/network/packet/AgentActionEventPacketPayload.h"
...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<8, 56, ::AgentActionEventPacketPayload> mPayload;
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit AgentActionEventPacket(::AgentActionEventPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::AgentActionEventPacketPayload payload);
    // NOLINTEND
