...
#include "mc/network/packet/SyncActorPropertyPacketPayload.h"
...
MC_NETWORK_PACKET_DECALARE(SyncActorPropertyPacket) {
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit SyncActorPropertyPacket(::SyncActorPropertyPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::SyncActorPropertyPacketPayload payload);
    // NOLINTEND
