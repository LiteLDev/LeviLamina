...
#include "mc/network/packet/AutomationClientConnectPacketPayload.h"
...
class AutomationClientConnectPacket : public ::ll::PayloadPacket<::AutomationClientConnectPacketPayload> {
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit AutomationClientConnectPacket(::AutomationClientConnectPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::AutomationClientConnectPacketPayload payload);
    // NOLINTEND
