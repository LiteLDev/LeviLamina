...
public:
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::UntypedStorage<8, 16> mUnk3419c9;
...
public:
    ...
    ::ll::UntypedStorage<8, 56> mUnkac92f2;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI AsyncJoinTaskManager(::std::unique_ptr<::TaskGroup> taskGroup, ::nonstd::expected<::AsyncJoinAllow, ::AsyncJoinDeny> defaultJoinVerdict);

    MCNAPI ::nonstd::expected<::AsyncJoinAllow, ::AsyncJoinDeny> _handleAllVerdictsTaskCompletion(::SubClientId subClientId, uint64 verdictId, ::std::vector<::Bedrock::Threading::SharedAsync<::std::variant<::std::monostate, ::AsyncJoinAllow, ::AsyncJoinDeny>>> const& results);

    MCNAPI ::Bedrock::Threading::Async<::nonstd::expected<::AsyncJoinAllow, ::AsyncJoinDeny>> handleAsyncJoinCallbacks(::NetworkIdentifier const& source, ::std::variant<::std::reference_wrapper<::ConnectionRequest const>, ::std::reference_wrapper<::SubClientConnectionRequest const>> const& request, ::SubClientId subClientId);
...
public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::std::unique_ptr<::TaskGroup> taskGroup, ::nonstd::expected<::AsyncJoinAllow, ::AsyncJoinDeny> defaultJoinVerdict);
    // NOLINTEND
