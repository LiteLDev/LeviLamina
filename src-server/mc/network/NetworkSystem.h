...
class NetworkSystem : public ::RakNetConnector::ConnectionCallbacks, public ::RakPeerHelper::IPSupportInterface, public ::NetworkEnableDisableListener {
public:
...
public:
    ...
    // vIndex: 1
    virtual bool onNewIncomingConnection(::NetworkIdentifier const& id, ::std::shared_ptr<::NetworkPeer>&& peer) /*override*/;

    // vIndex: 2
    virtual bool onNewOutgoingConnection(::NetworkIdentifier const& id, ::std::shared_ptr<::NetworkPeer>&& peer) /*override*/;

    // vIndex: 3
    virtual void onConnectionClosed(::NetworkIdentifier const& id, ::Connection::DisconnectFailReason const discoReason, ::std::string const& reasonMessage, bool skipDisconnectMessage, ::Json::Value const& sessionSummary) /*override*/;

    // vIndex: 4
    virtual void onAllConnectionsClosed(::Connection::DisconnectFailReason discoReason, ::std::string const& reasonMessage, bool skipDisconnectMessage) /*override*/;

    // vIndex: 5
    virtual void onAllRemoteConnectionsClosed(::Connection::DisconnectFailReason discoReason, ::std::string const& reasonMessage, bool skipDisconnectMessage) /*override*/;

    // vIndex: 6
    virtual void onOutgoingConnectionFailed(::Connection::DisconnectFailReason discoReason, ::std::string const& reasonMessage) /*override*/;
...
public:
    ...
    MCAPI void $onAllConnectionsClosed(::Connection::DisconnectFailReason discoReason, ::std::string const& reasonMessage, bool skipDisconnectMessage);

    MCAPI void $onAllRemoteConnectionsClosed(::Connection::DisconnectFailReason discoReason, ::std::string const& reasonMessage, bool skipDisconnectMessage);
