...
class SignalingService : public ::Bedrock::EnableNonOwnerReferences, public ::std::enable_shared_from_this<::SignalingService> {
public:
    ...
    public:
        // member functions
        // NOLINTBEGIN
        MCNAPI Connection(::PlayerMessaging::SigninID id, ::Bedrock::NotNullNonOwnerPtr<::ISignalingServiceConfigProvider> serviceConfigProvider, ::Bedrock::NotNullNonOwnerPtr<::IMinecraftEventing> eventing, bool useJsonRpc);
    
        MCNAPI void _handleError(::SignalingService::Connection::ServiceError errorCode, ::std::string const& errorMessage, ::std::string const& messageId);
    
        MCNAPI void _parseError(::std::string const& message, ::std::string messageId);
    
        MCNAPI ::Bedrock::Result<::std::vector<::NetherNet::StunRelayServer>, ::NetherNet::ESessionError> _parseTurnConfig(::Json::Value const& config);
    
        MCNAPI void _sendTurnConfigTelemetry(::NetherNet::ESessionError result, ::std::vector<::NetherNet::StunRelayServer> const& config);
        ...
        MCNAPI ::Bedrock::Threading::Async<::NetherNet::ESessionError> sendTo(::NetherNet::NetworkID to, ::std::string const& message);
    ...
    public:
        // constructor thunks
        // NOLINTBEGIN
        MCNAPI void* $ctor(::PlayerMessaging::SigninID id, ::Bedrock::NotNullNonOwnerPtr<::ISignalingServiceConfigProvider> serviceConfigProvider, ::Bedrock::NotNullNonOwnerPtr<::IMinecraftEventing> eventing, bool useJsonRpc);
        // NOLINTEND
    ...
    public:
        // member functions
        // NOLINTBEGIN
        MCNAPI ::Bedrock::Threading::Async<::Bedrock::Copyable<::Bedrock::Result<::std::monostate, ::NetherNet::ESessionError>>> sendJsonRpc(::std::string const& message);
    
        MCNAPI ::Bedrock::Threading::Async<::Bedrock::Copyable<::Bedrock::Result<::std::monostate, ::NetherNet::ESessionError>>> sendJsonRpcTo(::PlayerMessaging::NetworkID networkIdTo, ::std::optional<::std::string> const& messageId, ::std::string const& message);
        // NOLINTEND
    ...
    public:
        ...
        // vIndex: 1
        virtual void SendSignal(::NetherNet::NetworkID to, ::std::string const& message, ::std::function<void(::NetherNet::ESessionError)>&& onComplete) /*override*/;
    
        // vIndex: 2
        virtual ::Bedrock::PubSub::Subscription RegisterEventHandler(::NetherNet::ISignalingEventHandler* handler) /*override*/;
        // NOLINTEND
    
    public:
        // member functions
        // NOLINTBEGIN
        MCNAPI void _SendJsonRpcSignal(::NetherNet::NetworkID networkIDTo, ::std::string const& message, ::std::function<void(::NetherNet::ESessionError)>&& onComplete);
        // NOLINTEND
    
    public:
        // virtual function thunks
        // NOLINTBEGIN
        MCNAPI void $SendSignal(::NetherNet::NetworkID to, ::std::string const& message, ::std::function<void(::NetherNet::ESessionError)>&& onComplete);
    ...
    public:
        ...
        // vIndex: 1
        virtual ::Bedrock::Threading::Async<::Bedrock::Copyable<::Bedrock::Result<::std::monostate, ::NetherNet::ESessionError>>> sendJsonRpcTo(::PlayerMessaging::NetworkID networkIdTo, ::std::optional<::std::string> const& messageId, ::std::string const& message) const /*override*/;
    
        // vIndex: 2
        virtual ::Bedrock::Threading::Async<::Bedrock::Copyable<::Bedrock::Result<::std::monostate, ::NetherNet::ESessionError>>> sendJsonRpc(::std::string const& message) const /*override*/;
    
        // vIndex: 3
        virtual ::gsl::not_null<::std::shared_ptr<::MessageTracker>> getMessageTracker() /*override*/;
    
        // vIndex: 4
        virtual void parseSignal(::NetherNet::NetworkID fromNetworkID, ::std::string message, ::std::string messageId) /*override*/;
    
        // vIndex: 5
        virtual void parseTurnConfig(::Json::Value const& config) /*override*/;
    
        // vIndex: 6
        virtual void setTurnConfig(::std::vector<::NetherNet::StunRelayServer>&& config, ::std::chrono::steady_clock::time_point expiration) /*override*/;
    ...
    public:
        // virtual function thunks
        // NOLINTBEGIN
        MCNAPI ::Bedrock::Threading::Async<::Bedrock::Copyable<::Bedrock::Result<::std::monostate, ::NetherNet::ESessionError>>> $sendJsonRpcTo(::PlayerMessaging::NetworkID networkIdTo, ::std::optional<::std::string> const& messageId, ::std::string const& message) const;
    
        MCNAPI ::Bedrock::Threading::Async<::Bedrock::Copyable<::Bedrock::Result<::std::monostate, ::NetherNet::ESessionError>>> $sendJsonRpc(::std::string const& message) const;
        ...
        MCNAPI void $setTurnConfig(::std::vector<::NetherNet::StunRelayServer>&& config, ::std::chrono::steady_clock::time_point expiration);
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI SignalingService(::Bedrock::NotNullNonOwnerPtr<::IMinecraftEventing> eventing, ::WorkerPool& pool, ::Scheduler& scheduler);
...
public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::Bedrock::NotNullNonOwnerPtr<::IMinecraftEventing> eventing, ::WorkerPool& pool, ::Scheduler& scheduler);
    // NOLINTEND
