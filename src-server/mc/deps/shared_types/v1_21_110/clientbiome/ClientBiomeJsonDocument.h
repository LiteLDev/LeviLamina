...
public:
    ...
    public:
        ...
        public:
            // member variables
            // NOLINTBEGIN
            ::ll::UntypedStorage<8, 16> mUnke3164c;
            // NOLINTEND
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::UntypedStorage<8, 32> mUnk8f13b8;
        ::ll::UntypedStorage<8, 16> mUnk1319b6;
        // NOLINTEND
    ...
    public:
        // member functions
        // NOLINTBEGIN
        MCNAPI ::SharedTypes::v1_21_110::ClientBiomeJsonDocument::ClientBiomeJsonObject& operator=(::SharedTypes::v1_21_110::ClientBiomeJsonDocument::ClientBiomeJsonObject&&);
...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<8, 48> mUnk4c2acb;
    ::ll::UntypedStorage<8, 32> mUnkbcf83f;
    // NOLINTEND
