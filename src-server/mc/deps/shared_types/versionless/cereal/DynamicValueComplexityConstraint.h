...
class DynamicValueComplexityConstraint : public ::cereal::ConstraintHandle<::SharedTypes::DynamicValueComplexityConstraint> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI void validateValue(::cereal::DynamicValue const& value, ::cereal::SerializerContext& serializerContext) const;
    // NOLINTEND
