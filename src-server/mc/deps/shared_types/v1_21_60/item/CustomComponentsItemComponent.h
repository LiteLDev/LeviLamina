...
public:
    ...
    MCNAPI static void upgrade(::std::optional<::SharedTypes::v1_20_80::CustomComponentsItemComponent>& oldComp, ::std::optional<::SharedTypes::v1_21_60::CustomComponentsItemComponent>& newComp);
    // NOLINTEND
