...
public:
    ...
    public:
        // static functions
        // NOLINTBEGIN
        MCNAPI static void fromReference(::SharedTypes::v1_20_60::OverworldGenerationRulesBiomeJsonComponent::WeightedBiomeName& instance, ::SharedTypes::Reference<3> const& ref);
        // NOLINTEND
    ...
    public:
        ...
        MCNAPI static void fromReference(::SharedTypes::v1_20_60::OverworldGenerationRulesBiomeJsonComponent::WeightedBiomeNameVector& instance, ::SharedTypes::Reference<3> const& ref);
    
        MCNAPI static void fromVector(::SharedTypes::v1_20_60::OverworldGenerationRulesBiomeJsonComponent::WeightedBiomeNameVector& instance, ::std::vector<::SharedTypes::v1_20_60::OverworldGenerationRulesBiomeJsonComponent::WeightedBiomeName>& entries);
        // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI ::SharedTypes::v1_20_60::OverworldGenerationRulesBiomeJsonComponent& operator=(::SharedTypes::v1_20_60::OverworldGenerationRulesBiomeJsonComponent&&);

    MCNAPI ::SharedTypes::v1_20_60::OverworldGenerationRulesBiomeJsonComponent& operator=(::SharedTypes::v1_20_60::OverworldGenerationRulesBiomeJsonComponent const&);
    // NOLINTEND
