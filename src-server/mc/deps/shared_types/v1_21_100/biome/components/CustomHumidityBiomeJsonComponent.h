...
struct CustomHumidityBiomeJsonComponent : public ::SharedTypes::v1_20_60::IBiomeJsonComponent {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<1, 1> mUnk47ee1b;
    // NOLINTEND

public:
    // prevent constructor by default
    CustomHumidityBiomeJsonComponent& operator=(CustomHumidityBiomeJsonComponent const&);
    CustomHumidityBiomeJsonComponent(CustomHumidityBiomeJsonComponent const&);
    CustomHumidityBiomeJsonComponent();
