...
public:
    ...
    MCNAPI static ::nonstd::expected<
        ::SharedTypes::v1_19_40::ItemCategory::CreativeItemCategory,
        ::SharedTypes::v1_19_40::ItemCategory::CreativeItemCategoryStringError>
    creativeItemCategoryFromString(::std::string_view str);

    MCNAPI static ::std::string
    stringFromCreativeItemCategory(::SharedTypes::v1_19_40::ItemCategory::CreativeItemCategory category);
    // NOLINTEND
