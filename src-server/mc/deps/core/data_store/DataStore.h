...
public:
    ...
    public:
        ...
        MCNAPI ::Bedrock::JSONObject::Node* _setValueForKey(char const* key, uint64 keyLength, ::Bedrock::JSONObject::ValueWrapper const& value);
    ...
    public:
        ...
        // vIndex: 5
        virtual ::Bedrock::JSONObject::Node* setValueForKey(::std::string_view, ::Bedrock::JSONObject::ValueWrapper const&) = 0;
