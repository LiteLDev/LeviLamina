...
public:
    ...
    MCNAPI ::Scripting::ScriptContextResult createScriptingContext(::Scripting::ContextConfig const& config, ::Scripting::ModuleDescriptor const& forModule, ::std::vector<::Scripting::ModuleDescriptor> const& dependencies, ::Scripting::IDependencyLoader* loader, ::Scripting::IPrinter* printer);

    MCNAPI ::std::optional<::Scripting::Version> getLatestVersionOfModuleWithPreRelease(::std::string const& name, ::std::string_view preRelease) const;
    ...
    MCNAPI void setRuntimeFactory(::std::function<::std::shared_ptr<::Scripting::IRuntime>(::Scripting::ContextConfig const&, ::std::vector<::Scripting::ModuleDescriptor> const&)> factoryFn);
