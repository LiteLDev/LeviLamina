...
public:
    ...
    // vIndex: 19
    virtual void GetVerifiedJoinRequiredProcessingList(::RakNet::RakNetGUID, ::DataStructures::List<::RakNet::SystemAddress>&, ::DataStructures::List<::RakNet::RakNetGUID>&, ::DataStructures::List<::RakNet::BitStream*>&);

    // vIndex: 20
    virtual void GetVerifiedJoinAcceptedAdditionalData(::RakNet::Packet*, bool*, ::DataStructures::List<::RakNet::RakNetGUID>&, ::RakNet::BitStream*);
