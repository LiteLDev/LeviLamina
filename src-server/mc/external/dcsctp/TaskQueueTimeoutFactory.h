...
public:
    ...
    public:
        ...
        // vIndex: 1
        virtual void Start(::dcsctp::DurationMs duration_ms, ::webrtc::StrongAlias<::dcsctp::TimeoutTag, uint64> timeout_id) /*override*/;
    ...
    public:
        // member functions
        // NOLINTBEGIN
        MCNAPI TaskQueueTimeout(::dcsctp::TaskQueueTimeoutFactory& parent, ::webrtc::TaskQueueBase::DelayPrecision precision);
        // NOLINTEND
    
    public:
        // constructor thunks
        // NOLINTBEGIN
        MCNAPI void* $ctor(::dcsctp::TaskQueueTimeoutFactory& parent, ::webrtc::TaskQueueBase::DelayPrecision precision);
        // NOLINTEND
    ...
    public:
        ...
        // NOLINTBEGIN
        MCNAPI void $Start(::dcsctp::DurationMs duration_ms, ::webrtc::StrongAlias<::dcsctp::TimeoutTag, uint64> timeout_id);
