...
public:
    ...
    public:
        ...
        MCNAPI uint64 AssembleMessage(::std::map<::webrtc::StrongAlias<::dcsctp::FSNTag, uint>, ::std::pair<::dcsctp::UnwrappedSequenceNumber<::webrtc::StrongAlias<::dcsctp::TSNTag, uint>>, ::dcsctp::Data>> const& tsn_chunks);
    
        MCNAPI uint64 EraseTo(::webrtc::StrongAlias<::dcsctp::MIDTag, uint> mid);
    
        MCNAPI Stream(::dcsctp::InterleavedReassemblyStreams::FullStreamId stream_id, ::dcsctp::InterleavedReassemblyStreams* parent, ::webrtc::StrongAlias<::dcsctp::MIDTag, uint> next_mid);
    
        MCNAPI uint64 TryToAssembleMessage(::dcsctp::UnwrappedSequenceNumber<::webrtc::StrongAlias<::dcsctp::MIDTag, uint>> mid);
    ...
    public:
        // constructor thunks
        // NOLINTBEGIN
        MCNAPI void* $ctor(::dcsctp::InterleavedReassemblyStreams::FullStreamId stream_id, ::dcsctp::InterleavedReassemblyStreams* parent, ::webrtc::StrongAlias<::dcsctp::MIDTag, uint> next_mid);
        // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI ::dcsctp::InterleavedReassemblyStreams::Stream& GetOrCreateStream(::dcsctp::InterleavedReassemblyStreams::FullStreamId const& stream_id);

    MCNAPI InterleavedReassemblyStreams(::std::string_view log_prefix, ::std::function<void(::rtc::ArrayView<::dcsctp::UnwrappedSequenceNumber<::webrtc::StrongAlias<::dcsctp::TSNTag, uint>> const>, ::dcsctp::DcSctpMessage)> on_assembled_message);
    // NOLINTEND
