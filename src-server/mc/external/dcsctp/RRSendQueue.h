...
public:
    ...
    // NOLINTBEGIN
    MCNAPI void
    Add(::webrtc::Timestamp now, ::dcsctp::DcSctpMessage message, ::dcsctp::SendOptions const& send_options);
    ...
    GetOrCreateStreamInfo(::webrtc::StrongAlias<::dcsctp::StreamIDTag, ushort> stream_id);
