...
public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static void BinaryMessageFragmentFunc(::HC_WEBSOCKET_OBSERVER* internalHandle, uchar const* payloadBytes, uint payloadSize, bool isLastFragment, void* context);

    MCNAPI static void BinaryMessageFunc(::HC_WEBSOCKET_OBSERVER* internalHandle, uchar const* bytes, uint payloadSize, void* context);

    MCNAPI static void CloseFunc(::HC_WEBSOCKET_OBSERVER* internalHandle, ::HCWebSocketCloseStatus status, void* context);

    MCNAPI static ::std::unique_ptr<::HC_WEBSOCKET_OBSERVER, ::xbox::httpclient::ObserverDeleter> Initialize(::std::shared_ptr<::xbox::httpclient::WebSocket> websocket, void(*messageFunc) (::HC_WEBSOCKET_OBSERVER*, char const*, void*), void(*binaryMessageFunc) (::HC_WEBSOCKET_OBSERVER*, uchar const*, uint, void*), void(*binaryFragmentFunc) (::HC_WEBSOCKET_OBSERVER*, uchar const*, uint, bool, void*), void(*closeFunc) (::HC_WEBSOCKET_OBSERVER*, ::HCWebSocketCloseStatus, void*), void* callbackContext);
