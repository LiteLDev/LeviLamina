...
public:
    ...
    MCNAPI PrioritizedPacketQueue(::webrtc::Timestamp creation_time, bool prioritize_audio_retransmission, ::webrtc::PacketQueueTTL packet_queue_ttl);
...
public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static ::absl::InlinedVector<::webrtc::TimeDelta, 5, ::std::allocator<::webrtc::TimeDelta>> ToTtlPerPrio(::webrtc::PacketQueueTTL packet_queue_ttl);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::webrtc::Timestamp creation_time, bool prioritize_audio_retransmission, ::webrtc::PacketQueueTTL packet_queue_ttl);
    // NOLINTEND
