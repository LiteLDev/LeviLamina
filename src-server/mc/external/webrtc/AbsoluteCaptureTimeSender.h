...
public:
    ...
    MCNAPI ::std::optional<::webrtc::AbsoluteCaptureTime> OnSendPacket(uint source, uint rtp_timestamp, int rtp_clock_frequency_hz, ::webrtc::NtpTime absolute_capture_time, ::std::optional<int64> estimated_capture_clock_offset, bool force);

    MCNAPI bool ShouldSendExtension(::webrtc::Timestamp send_time, uint source, uint rtp_timestamp, int rtp_clock_frequency_hz, ::webrtc::NtpTime absolute_capture_time, ::std::optional<int64> estimated_capture_clock_offset) const;
    // NOLINTEND
