...
public:
    ...
    public:
        ...
        // vIndex: 1
        virtual bool OnTransportChanged(::std::string const&, ::webrtc::RtpTransportInternal*, ::webrtc::scoped_refptr<::webrtc::DtlsTransport>, ::webrtc::DataChannelTransportInterface*) = 0;
        // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI ::webrtc::RTCError AddRemoteCandidates(::std::string const& transport_name, ::std::vector<::cricket::Candidate> const& candidates);

    MCNAPI ::webrtc::RTCError ApplyDescription_n(bool local, ::webrtc::SdpType type, ::cricket::SessionDescription const* local_desc, ::cricket::SessionDescription const* remote_desc);

    MCNAPI ::std::unique_ptr<::webrtc::DtlsSrtpTransport> CreateDtlsSrtpTransport(::std::string const& transport_name, ::cricket::DtlsTransportInternal* rtp_dtls_transport, ::cricket::DtlsTransportInternal* rtcp_dtls_transport);

    MCNAPI ::std::unique_ptr<::cricket::DtlsTransportInternal> CreateDtlsTransport(::cricket::ContentInfo const& content_info, ::cricket::IceTransportInternal* ice);

    MCNAPI ::webrtc::scoped_refptr<::webrtc::IceTransportInterface> CreateIceTransport(::std::string const& transport_name, bool rtcp);

    MCNAPI ::cricket::JsepTransportDescription CreateJsepTransportDescription(::cricket::ContentInfo const& content_info, ::cricket::TransportInfo const& transport_info, ::std::vector<int> const& encrypted_extension_ids, int rtp_abs_sendtime_extn_id);

    MCNAPI ::std::unique_ptr<::webrtc::RtpTransport> CreateUnencryptedRtpTransport(::std::string const& transport_name, ::rtc::PacketTransportInternal* rtp_packet_transport, ::rtc::PacketTransportInternal* rtcp_packet_transport);

    MCNAPI void DestroyAllJsepTransports_n();

    MCNAPI ::cricket::IceRole DetermineIceRole(::cricket::JsepTransport* jsep_transport, ::cricket::TransportInfo const& transport_info, ::webrtc::SdpType type, bool local);
    ...
    MCNAPI ::webrtc::scoped_refptr<::rtc::RTCCertificate> GetLocalCertificate(::std::string const& transport_name) const;
    ...
    MCNAPI bool HandleBundledContent(::cricket::ContentInfo const& content_info, ::cricket::ContentGroup const& bundle_group);

    MCNAPI void HandleRejectedContent(::cricket::ContentInfo const& content_info);

    MCNAPI JsepTransportController(::webrtc::Environment const& env, ::rtc::Thread* network_thread, ::cricket::PortAllocator* port_allocator, ::webrtc::AsyncDnsResolverFactoryInterface* async_dns_resolver_factory, ::webrtc::JsepTransportController::Config config);

    MCNAPI ::webrtc::scoped_refptr<::webrtc::DtlsTransport> LookupDtlsTransportByMid(::std::string const& mid);

    MCNAPI ::webrtc::RTCError MaybeCreateJsepTransport(bool local, ::cricket::ContentInfo const& content_info, ::cricket::SessionDescription const& description);

    MCNAPI void MaybeStartGathering();

    MCNAPI ::std::map<::cricket::ContentGroup const*, ::std::vector<int>> MergeEncryptedHeaderExtensionIdsForBundles(::cricket::SessionDescription const* description);
    ...
    MCNAPI void OnTransportCandidateError_n(::cricket::IceTransportInternal* transport, ::cricket::IceCandidateErrorEvent const& event);

    MCNAPI void OnTransportCandidateGathered_n(::cricket::IceTransportInternal* transport, ::cricket::Candidate const& candidate);

    MCNAPI void OnTransportCandidatePairChanged_n(::cricket::CandidatePairChangeEvent const& event);

    MCNAPI void OnTransportCandidatesRemoved_n(::cricket::IceTransportInternal* transport, ::std::vector<::cricket::Candidate> const& candidates);
    ...
    MCNAPI ::webrtc::RTCError SetLocalDescription(::webrtc::SdpType type, ::cricket::SessionDescription const* local_desc, ::cricket::SessionDescription const* remote_desc);

    MCNAPI void SetNeedsIceRestartFlag();

    MCNAPI ::webrtc::RTCError SetRemoteDescription(::webrtc::SdpType type, ::cricket::SessionDescription const* local_desc, ::cricket::SessionDescription const* remote_desc);

    MCNAPI void UpdateAggregateStates_n();

    MCNAPI ::webrtc::RTCError ValidateAndMaybeUpdateBundleGroups(bool local, ::webrtc::SdpType type, ::cricket::SessionDescription const* local_desc, ::cricket::SessionDescription const* remote_desc);
...
public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::webrtc::Environment const& env, ::rtc::Thread* network_thread, ::cricket::PortAllocator* port_allocator, ::webrtc::AsyncDnsResolverFactoryInterface* async_dns_resolver_factory, ::webrtc::JsepTransportController::Config config);
    // NOLINTEND
