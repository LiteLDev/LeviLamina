...
public:
    ...
    GetAudioTrack(::cricket::VoiceReceiverInfo const& voice_receiver_info) const;

    MCNAPI ::webrtc::scoped_refptr<::webrtc::AudioTrackInterface>
    GetAudioTrack(::cricket::VoiceSenderInfo const& voice_sender_info) const;
    ...
    GetVideoTrack(::cricket::VideoReceiverInfo const& video_receiver_info) const;

    MCNAPI ::webrtc::scoped_refptr<::webrtc::VideoTrackInterface>
    GetVideoTrack(::cricket::VideoSenderInfo const& video_sender_info) const;
    ...
    MCNAPI void Initialize(
        ...
        ::rtc::ArrayView<::webrtc::scoped_refptr<::webrtc::RtpSenderInternal>>   rtp_senders,
        ::rtc::ArrayView<::webrtc::scoped_refptr<::webrtc::RtpReceiverInternal>> rtp_receivers
    );
