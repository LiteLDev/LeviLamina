...
public:
    ...
    // vIndex: 1
    virtual void Update(double recv_delta_ms, double send_delta_ms, int64 send_time_ms, int64 arrival_time_ms, uint64 packet_size, bool calculated_deltas) /*override*/;
...
public:
    ...
    MCNAPI TrendlineEstimator(::webrtc::FieldTrialsView const* key_value_config, ::webrtc::NetworkStatePredictor* network_state_predictor);

    MCNAPI void UpdateThreshold(double modified_trend, int64 now_ms);

    MCNAPI void UpdateTrendline(double recv_delta_ms, double send_delta_ms, int64 send_time_ms, int64 arrival_time_ms, uint64 packet_size);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::webrtc::FieldTrialsView const* key_value_config, ::webrtc::NetworkStatePredictor* network_state_predictor);
    // NOLINTEND
...
public:
    ...
    // NOLINTBEGIN
    MCNAPI void $Update(double recv_delta_ms, double send_delta_ms, int64 send_time_ms, int64 arrival_time_ms, uint64 packet_size, bool calculated_deltas);
