...
public:
    ...
    MCNAPI RtpPacketizerAv1(::rtc::ArrayView<uchar const> payload, ::webrtc::RtpPacketizer::PayloadSizeLimits limits, ::webrtc::VideoFrameType frame_type, bool is_last_frame_in_picture);
    // NOLINTEND
...
public:
    ...
    MCNAPI static ::std::vector<::webrtc::RtpPacketizerAv1::Packet> Packetize(::rtc::ArrayView<::webrtc::RtpPacketizerAv1::Obu const> obus, ::webrtc::RtpPacketizer::PayloadSizeLimits limits);
...
public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::rtc::ArrayView<uchar const> payload, ::webrtc::RtpPacketizer::PayloadSizeLimits limits, ::webrtc::VideoFrameType frame_type, bool is_last_frame_in_picture);
    // NOLINTEND
