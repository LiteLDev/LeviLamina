...
public:
    ...
    // vIndex: 9
    virtual ::webrtc::NetworkControlUpdate OnTargetRateConstraints(::webrtc::TargetRateConstraints constraints) /*override*/;

    // vIndex: 10
    virtual ::webrtc::NetworkControlUpdate OnTransportLossReport(::webrtc::TransportLossReport msg) /*override*/;

    // vIndex: 11
    virtual ::webrtc::NetworkControlUpdate OnTransportPacketsFeedback(::webrtc::TransportPacketsFeedback report) /*override*/;
...
public:
    ...
    MCNAPI ::std::vector<::webrtc::ProbeClusterConfig> ResetConstraints(::webrtc::TargetRateConstraints new_constraints);
