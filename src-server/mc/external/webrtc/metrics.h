...
MCNAPI ::webrtc::metrics::Histogram* HistogramFactoryGetCounts(::std::string_view name, int min, int max, int bucket_count);

MCNAPI ::webrtc::metrics::Histogram* HistogramFactoryGetCountsLinear(::std::string_view name, int min, int max, int bucket_count);
