...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI ConnectionContext(::webrtc::Environment const& env, ::webrtc::PeerConnectionFactoryDependencies* dependencies);
...
public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static ::webrtc::scoped_refptr<::webrtc::ConnectionContext> Create(::webrtc::Environment const& env, ::webrtc::PeerConnectionFactoryDependencies* dependencies);
    // NOLINTEND
