...
public:
    ...
    // NOLINTBEGIN
    MCNAPI void
    AddPacket(::webrtc::RtpPacketSendInfo const& packet_info, uint64 overhead_bytes, ::webrtc::Timestamp creation_time);
    ...
    MCNAPI ::std::vector<::webrtc::PacketResult> ProcessTransportFeedbackInner(
        ::webrtc::rtcp::TransportFeedback const& feedback,
        ::webrtc::Timestamp                      feedback_receive_time
    );
