...
public:
    ...
    // vIndex: 4
    virtual ::webrtc::RTCErrorOr<::webrtc::scoped_refptr<::webrtc::PeerConnectionInterface>> CreatePeerConnectionOrError(::webrtc::PeerConnectionInterface::RTCConfiguration const& configuration, ::webrtc::PeerConnectionDependencies dependencies) /*override*/;
    ...
    // vIndex: 9
    virtual ::webrtc::scoped_refptr<::webrtc::MediaStreamInterface> CreateLocalMediaStream(::std::string const& stream_id) /*override*/;

    // vIndex: 10
    virtual ::webrtc::scoped_refptr<::webrtc::AudioSourceInterface> CreateAudioSource(::cricket::AudioOptions const& options) /*override*/;

    // vIndex: 12
    virtual ::webrtc::scoped_refptr<::webrtc::VideoTrackInterface> CreateVideoTrack(::webrtc::scoped_refptr<::webrtc::VideoTrackSourceInterface> source, ::std::string_view id) /*override*/;

    // vIndex: 13
    virtual ::webrtc::scoped_refptr<::webrtc::AudioTrackInterface> CreateAudioTrack(::std::string const& id, ::webrtc::AudioSourceInterface* source) /*override*/;
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI ::std::unique_ptr<::webrtc::Call> CreateCall_w(::webrtc::Environment const& env, ::webrtc::PeerConnectionInterface::RTCConfiguration const& configuration);
    ...
    MCNAPI PeerConnectionFactory(::webrtc::scoped_refptr<::webrtc::ConnectionContext> context, ::webrtc::PeerConnectionFactoryDependencies* dependencies);
...
public:
    ...
    MCNAPI void* $ctor(::webrtc::scoped_refptr<::webrtc::ConnectionContext> context, ::webrtc::PeerConnectionFactoryDependencies* dependencies);
    // NOLINTEND
...
public:
    ...
    MCNAPI ::webrtc::RTCErrorOr<::webrtc::scoped_refptr<::webrtc::PeerConnectionInterface>> $CreatePeerConnectionOrError(::webrtc::PeerConnectionInterface::RTCConfiguration const& configuration, ::webrtc::PeerConnectionDependencies dependencies);
    ...
    MCNAPI ::webrtc::scoped_refptr<::webrtc::MediaStreamInterface> $CreateLocalMediaStream(::std::string const& stream_id);

    MCNAPI ::webrtc::scoped_refptr<::webrtc::AudioSourceInterface> $CreateAudioSource(::cricket::AudioOptions const& options);

    MCNAPI ::webrtc::scoped_refptr<::webrtc::VideoTrackInterface> $CreateVideoTrack(::webrtc::scoped_refptr<::webrtc::VideoTrackSourceInterface> source, ::std::string_view id);

    MCNAPI ::webrtc::scoped_refptr<::webrtc::AudioTrackInterface> $CreateAudioTrack(::std::string const& id, ::webrtc::AudioSourceInterface* source);
