...
// functions
// NOLINTBEGIN
MCNAPI bool AV1IsSameProfile(::std::map<::std::string, ::std::string> const& params1, ::std::map<::std::string, ::std::string> const& params2);

MCNAPI char const* AdapterTypeToStatsType(::rtc::AdapterType type);

MCNAPI void AddAudioAttribute(::std::string const& name, ::std::string_view value, ::cricket::MediaContentDescription* desc);
...
MCNAPI ::std::unique_ptr<::webrtc::TaskQueueFactory> CreateDefaultTaskQueueFactory(::webrtc::FieldTrialsView const* field_trials);

MCNAPI ::webrtc::IceCandidateInterface* CreateIceCandidate(::std::string const& sdp_mid, int sdp_mline_index, ::std::string const& sdp, ::webrtc::SdpParseError* error);

MCNAPI ::std::unique_ptr<::webrtc::SessionDescriptionInterface> CreateSessionDescription(::webrtc::SdpType type, ::std::string const& sdp);

MCNAPI ::std::unique_ptr<::webrtc::SessionDescriptionInterface> CreateSessionDescription(::webrtc::SdpType type, ::std::string const& sdp, ::webrtc::SdpParseError* error_out);

MCNAPI ::std::unique_ptr<::webrtc::TaskQueueFactory> CreateTaskQueueStdlibFactory();

MCNAPI void CreateTrackWithNoSsrcs(::std::vector<::std::string> const& msid_stream_ids, ::std::string_view msid_track_id, ::std::vector<::cricket::RidDescription> const& rids, ::std::vector<::cricket::StreamParams>* tracks);

MCNAPI void CreateTracksFromSsrcInfos(::std::vector<::webrtc::SsrcInfo> const& ssrc_infos, ::std::vector<::std::string> const& msid_stream_ids, ::std::string_view msid_track_id, ::std::vector<::cricket::StreamParams>* tracks, int msid_signaling);

MCNAPI ::cricket::Codec GetCodecWithPayloadType(::cricket::MediaType type, ::std::vector<::cricket::Codec> const& codecs, int payload_type);
...
MCNAPI void H264GenerateProfileLevelIdForAnswer(::std::map<::std::string, ::std::string> const& local_supported_params, ::std::map<::std::string, ::std::string> const& remote_offered_params, ::std::map<::std::string, ::std::string>* answer_params);

MCNAPI bool H264IsSameProfile(::std::map<::std::string, ::std::string> const& params1, ::std::map<::std::string, ::std::string> const& params2);
...
MCNAPI ::webrtc::RTCError InvokeSetParametersCallback(::absl::AnyInvocable<void(::webrtc::RTCError)&&>& callback, ::webrtc::RTCError error);
...
MCNAPI void MaybeCreateStaticPayloadAudioCodecs(::std::vector<int> const& fmts, ::cricket::MediaContentDescription* media_desc);

MCNAPI bool ParseCandidate(::std::string_view message, ::cricket::Candidate* candidate, ::webrtc::SdpParseError* error, bool is_raw);
...
MCNAPI bool ParseDataChannelOpenMessage(::rtc::CopyOnWriteBuffer const& payload, ::std::string* label, ::webrtc::DataChannelInit* config);

MCNAPI void ParseFieldTrial(::std::initializer_list<::webrtc::FieldTrialParameterInterface*> fields, ::std::string_view trial_string);

MCNAPI ::std::optional<::webrtc::H264ProfileLevelId> ParseH264ProfileLevelId(char const* str);

MCNAPI ::webrtc::RTCError ParseIceServersOrError(::std::vector<::webrtc::PeerConnectionInterface::IceServer> const& servers, ::std::set<::rtc::SocketAddress>* stun_servers, ::std::vector<::cricket::RelayServerConfig>* turn_servers);
...
MCNAPI ::std::optional<::webrtc::AV1Profile> ParseSdpForAV1Profile(::std::map<::std::string, ::std::string> const& params);

MCNAPI ::std::optional<::webrtc::H264ProfileLevelId> ParseSdpForH264ProfileLevelId(::std::map<::std::string, ::std::string> const& params);

MCNAPI ::std::optional<::webrtc::VP9Profile> ParseSdpForVP9Profile(::std::map<::std::string, ::std::string> const& params);
...
MCNAPI int RtpHeaderExtensionSize(::rtc::ArrayView<::webrtc::RtpExtensionSize const> extensions, ::webrtc::RtpHeaderExtensionMap const& registered_extensions);
...
MCNAPI ::webrtc::RtpTransceiverDirection RtpTransceiverDirectionIntersection(::webrtc::RtpTransceiverDirection lhs, ::webrtc::RtpTransceiverDirection rhs);
...
MCNAPI ::webrtc::RtpTransceiverDirection RtpTransceiverDirectionWithRecvSet(::webrtc::RtpTransceiverDirection direction, bool recv);

MCNAPI ::absl::AnyInvocable<void()&&> SafeTask(::webrtc::scoped_refptr<::webrtc::PendingTaskSafetyFlag> flag, ::absl::AnyInvocable<void () &&> task);

MCNAPI ::std::string_view ScalabilityModeToString(::webrtc::ScalabilityMode scalability_mode);

MCNAPI bool SdpDeserialize(::std::string_view message, ::webrtc::JsepSessionDescription* jdesc, ::webrtc::SdpParseError* error);

MCNAPI bool SdpDeserializeCandidate(::std::string_view message, ::webrtc::JsepIceCandidate* jcandidate, ::webrtc::SdpParseError* error);
...
MCNAPI ::webrtc::scoped_refptr<::webrtc::RTCStatsReport> TakeReferencedStats(::webrtc::scoped_refptr<::webrtc::RTCStatsReport> report, ::std::vector<::std::string> const& ids);

MCNAPI ::std::optional<::webrtc::RtcpFeedback> ToRtcpFeedback(::cricket::FeedbackParam const& cricket_feedback);

MCNAPI ::webrtc::RtpCapabilities ToRtpCapabilities(::std::vector<::cricket::Codec> const& cricket_codecs, ::std::vector<::webrtc::RtpExtension> const& cricket_extensions);
...
MCNAPI void UpdateCodec(::cricket::MediaContentDescription* content_desc, int payload_type, ::cricket::FeedbackParam const& feedback_param);

MCNAPI void UpdateCodec(::cricket::MediaContentDescription* content_desc, int payload_type, ::std::map<::std::string, ::std::string> const& parameters);

MCNAPI void UpdateCodec(int payload_type, ::std::string_view name, ::cricket::MediaContentDescription* desc);

MCNAPI void UpdateCodec(int payload_type, ::std::string_view name, int clockrate, int bitrate, uint64 channels, ::cricket::MediaContentDescription* desc);

MCNAPI void UpdateFromWildcardCodecs(::cricket::MediaContentDescription* desc);

MCNAPI void UpdateRtpHeaderExtensionPreferencesFromSdpMunging(::cricket::SessionDescription const* description, ::webrtc::TransceiverList* transceivers);

MCNAPI void UpdateVideoCodecPacketization(::cricket::MediaContentDescription* desc, int payload_type, ::std::string_view packetization);

MCNAPI bool VP9IsSameProfile(::std::map<::std::string, ::std::string> const& params1, ::std::map<::std::string, ::std::string> const& params2);

MCNAPI bool ValidAlignment(uint64 alignment);

MCNAPI void WriteDataChannelOpenAckMessage(::rtc::CopyOnWriteBuffer* payload);

MCNAPI bool WriteDataChannelOpenMessage(::std::string const& label, ::std::string const& protocol, ::std::optional<::webrtc::Priority> opt_priority, bool ordered, ::std::optional<int> max_retransmits, ::std::optional<int> max_retransmit_time, ::rtc::CopyOnWriteBuffer* payload);

MCNAPI void WriteFmtpHeader(int payload_type, ::rtc::StringBuilder* os);

MCNAPI void WriteFmtpParameter(::std::string_view parameter_name, ::std::string_view parameter_value, ::rtc::StringBuilder* os);
...
MCNAPI bool operator<(::webrtc::scoped_refptr<::webrtc::RtpTransceiverProxyWithInternal<::webrtc::RtpTransceiver>> const& a, ::webrtc::scoped_refptr<::webrtc::RtpTransceiverProxyWithInternal<::webrtc::RtpTransceiver>> const& b);
...
MCNAPI bool operator==(::webrtc::scoped_refptr<::webrtc::MediaStreamTrackInterface> const& a, ::webrtc::MediaStreamTrackInterface const* b);

MCNAPI bool operator==(::webrtc::scoped_refptr<::webrtc::RtpSenderInterface> const& a, ::webrtc::scoped_refptr<::webrtc::RtpSenderInterface> const& b);

MCNAPI bool operator==(::webrtc::scoped_refptr<::webrtc::RtpTransceiverProxyWithInternal<::webrtc::RtpTransceiver>> const& a, ::webrtc::scoped_refptr<::webrtc::RtpTransceiverProxyWithInternal<::webrtc::RtpTransceiver>> const& b);

MCNAPI bool operator==(::webrtc::scoped_refptr<::webrtc::RtpSenderProxyWithInternal<::webrtc::RtpSenderInternal>> const& a, ::webrtc::scoped_refptr<::webrtc::RtpSenderInterface> const& b);

MCNAPI bool operator==(::webrtc::scoped_refptr<::webrtc::RtpSenderProxyWithInternal<::webrtc::RtpSenderInternal>> const& a, ::webrtc::RtpSenderInterface const* b);

MCNAPI bool operator==(::webrtc::scoped_refptr<::webrtc::RtpReceiverProxyWithInternal<::webrtc::RtpReceiverInternal>> const& a, ::webrtc::scoped_refptr<::webrtc::RtpReceiverInterface> const& b);

MCNAPI bool operator==(::webrtc::scoped_refptr<::webrtc::RtpReceiverProxyWithInternal<::webrtc::RtpReceiverInternal>> const& a, ::webrtc::RtpReceiverInterface const* b);

MCNAPI bool operator==(::webrtc::scoped_refptr<::rtc::RTCCertificate> const& a, ::webrtc::scoped_refptr<::rtc::RTCCertificate> const& b);
// NOLINTEND
