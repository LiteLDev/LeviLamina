...
public:
    ...
    MCNAPI bool HandleApp(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI bool HandleBye(::webrtc::rtcp::CommonHeader const& rtcp_block);

    MCNAPI bool HandleFir(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI bool HandleNack(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI bool HandlePli(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI void HandlePsfbApp(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI bool HandleReceiverReport(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI void HandleReportBlock(::webrtc::rtcp::ReportBlock const& report_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information, uint remote_ssrc);

    MCNAPI bool HandleSdes(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI bool HandleSenderReport(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI bool HandleSrReq(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI bool HandleTmmbn(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI bool HandleTmmbr(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI void HandleTransportFeedback(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information);

    MCNAPI bool HandleXr(::webrtc::rtcp::CommonHeader const& rtcp_block, ::webrtc::RTCPReceiver::PacketInformation* packet_information, bool& contains_dlrr, uint& ssrc);
    ...
    MCNAPI void HandleXrTargetBitrate(uint ssrc, ::webrtc::rtcp::TargetBitrate const& target_bitrate, ::webrtc::RTCPReceiver::PacketInformation* packet_information);
    ...
    MCNAPI bool ParseCompoundPacket(::rtc::ArrayView<uchar const> packet, ::webrtc::RTCPReceiver::PacketInformation* packet_information);
