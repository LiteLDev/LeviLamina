...
public:
    ...
    using DataVariant = ::std::variant<::InsideBubbleColumnBlockComponent::AboveColumnData, ::InsideBubbleColumnBlockComponent::InsideColumnData>;
    
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<8, 24, ::std::vector<::std::variant<::InsideBubbleColumnBlockComponent::AboveColumnData, ::InsideBubbleColumnBlockComponent::InsideColumnData>>> mData;
    // NOLINTEND
