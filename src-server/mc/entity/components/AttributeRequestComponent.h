...
public:
    ...
    using Variant = ::std::variant<::AttributeRequestComponent::AddModifier, ::AttributeRequestComponent::RemoveModifier, ::AttributeRequestComponent::AddBuffModifier>;
    
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<8, 24, ::std::vector<::std::variant<::AttributeRequestComponent::AddModifier, ::AttributeRequestComponent::RemoveModifier, ::AttributeRequestComponent::AddBuffModifier>>> mRequests;
    // NOLINTEND
