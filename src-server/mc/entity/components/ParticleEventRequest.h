...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<8, 128, ::std::variant<::ParticleEventRequest::BasicData, ::ParticleEventRequest::MolangData, ::ParticleEventRequest::TerrainData, ::ParticleEventRequest::TerrainSlideData, ::ParticleEventRequest::BreakingItemData>> mData;
    // NOLINTEND
...
public:
    // static functions
    // NOLINTBEGIN
    MCAPI static ::ParticleEventRequest addParticleEffect(::HashedString effect, ::Vec3 const& emitterPosition, ::MolangVariableMap molangVariables);
    // NOLINTEND
