...
public:
    ...
    public:
        // member functions
        // NOLINTBEGIN
        MCNAPI ::DryingOutTimerComponent::DryingOutTimerDefinition& operator=(::DryingOutTimerComponent::DryingOutTimerDefinition const&);
    ...
    public:
        // static functions
        // NOLINTBEGIN
        MCNAPI static void buildSchema(::std::shared_ptr<::JsonUtil::JsonSchemaObjectNode<::JsonUtil::EmptyClass, ::DryingOutTimerComponent::DryingOutTimerDefinition>>& root);
        // NOLINTEND
