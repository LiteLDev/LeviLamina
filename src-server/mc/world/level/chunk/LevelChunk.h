...
#include "mc/versionless/world/level/ChunkLocalHeight.h"
...
public:
    ...
    MCAPI ::std::shared_ptr<::BlockActor> _createBlockEntity(::BlockPos const& block, ::BlockSource* currentSource, ::Block const& current, ::Block const& old);
    ...
    MCAPI void _dispatchBlockBreakEvents(::BlockPos const& pos, ::Block const& oldBlock, ::Block const& current, ::BlockSource* currentSource, ::BlockChangeContext const& changeSourceContext);
    ...
    MCAPI void _lightingCallbacks(::ChunkBlockPos const& pos, ::Block const& old, ::Block const& current, ::BlockSource* currentSource);

    MCAPI void _makeUniformBiomes(::Biome const& biome);

    MCAPI void _placeBlockEntity(::std::shared_ptr<::BlockActor> te);

    MCAPI void _placeCallbackIfChunkLoaded(::BlockSource& currentSource, ::BlockPos const& blockPos, ::Block const& old, ::gsl::not_null<::Block const*> current);

    MCAPI bool _recalcHeight(::ChunkBlockPos const& start, ::BlockSource* source);

    MCAPI void _removeCallbacks(::ChunkBlockPos const& pos, ::Block const& oldBlock, ::Block const& current, ::BlockSource* currentSource, ::BlockChangeContext const& changeSourceContext);
    ...
    MCAPI void placeCallbacks(::ChunkBlockPos const& pos, ::Block const& old, ::Block const& current, ::BlockSource* currentSource, ::std::shared_ptr<::BlockActor> blockEntity);
    ...
    MCAPI ::Block const& setBlock(::ChunkBlockPos const& pos, ::Block const& block, ::BlockSource* issuingSource, ::std::shared_ptr<::BlockActor> blockEntity, ::BlockChangeContext const& changeSourceContext);
...
public:
    // static functions
    // NOLINTBEGIN
    MCAPI static ::std::pair<ushort, ::std::vector<::std::unique_ptr<::SubChunkStorage<::Biome>>>> deserialize3DBiomes(::IDataInput& stream, ::BiomeRegistry const& biomeRegistry, ushort dimensionHeightInSubchunks, ::Biome const* defaultBiome, bool fromNetwork);

    MCAPI static void serializeEntities(::std::vector<::WeakEntityRef> const& entities, ::std::string const& serializedEntitiesBuffer, ::std::string const& failedSerializedEntitiesBuffer, ::std::string& buffer, bool markProcessedOnChunkDisard, ::std::function<void(::std::string const&)> addLiveActorCallback, ::std::function<void(::std::string const&)> addActorKeyCallback, ::std::function<void(::std::string const&)> addSerializedActor);

    MCAPI static ::std::tuple<::std::array<::ChunkLocalHeight, 256>, ::std::array<::BiomeChunkData, 256>, ::std::vector<::SubChunk>> staticDeserializeLegacyTerrain(::IDataInput& stream, short minY, ushort dimensionSizeInSubchunks);
    // NOLINTEND
