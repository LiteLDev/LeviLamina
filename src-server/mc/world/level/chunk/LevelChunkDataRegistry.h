...
public:
    ...
    using StorageType = ::br::detail::StorageTypeHelper<::br::StructureType, ::br::ChunkBoundingBox, ::br::StructureKey, ::br::FullStructureBoundingBox, ::br::DynamicSpawnArea, ::br::StaticSpawnArea, ::std::unordered_map<::SpawnCategory::Type, ::br::worldgen::StructureSpawnOverride>>;
