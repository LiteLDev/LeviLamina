...
public:
    // static functions
    // NOLINTBEGIN
    MCAPI static void _addOrMergeItemStack(::ItemStack const& newItemStack, ::BlockPos pos, ::std::vector<::std::pair<::ItemStack, ::BlockPos>>& itemStacks);

    MCAPI static void _spawnExtraResourcesAndMergeItemDropsForBlock(::BlockSource& region, ::BlockPos const& blockPos, ::Block const& block, ::Randomize& randomize, ::ResourceDropsContext const& resourceDropsContext, ::std::vector<::std::pair<::ItemStack, ::BlockPos>>& itemStacks);
    // NOLINTEND
