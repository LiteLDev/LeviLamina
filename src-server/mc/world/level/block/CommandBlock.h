...
public:
    ...
    MCAPI bool _executeChainBlock(::BlockSource& region, ::BlockPos const& pos, ::CommandBlockActor& blockActor, bool fromTickQueue) const;
    ...
    MCAPI void updateBlock(::BlockSource& region, ::BlockPos const& pos, ::CommandBlockMode newMode, bool conditional) const;
