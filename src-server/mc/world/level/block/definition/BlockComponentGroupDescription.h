...
public:
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::TypedStorage<8, 64, ::std::unordered_map<::std::string, ::std::shared_ptr<::BlockComponentDescription>>> mMap;
        // NOLINTEND
    ...
    public:
        ...
        MCFOLD ::BlockComponentGroupDescription::Components& operator=(::BlockComponentGroupDescription::Components const&);
