...
public:
    ...
    public:
        ...
        ::ll::TypedStorage<8, 24, ::std::vector<::std::pair<::BeardAndShaverDescription, ::std::weak_ptr<bool>>>> mBeardAndShavers;
...
public:
    // static functions
    // NOLINTBEGIN
    MCAPI static float calculateContribution(::FeatureTerrainAdjustments::Descriptions const& descriptions, ::BlockPos const& currentPos, float noiseValue);
    // NOLINTEND
