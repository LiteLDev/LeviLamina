...
public:
    ...
    // NOLINTBEGIN
    // vIndex: 1
    virtual void appendJunctions(::BoundingBox const& box, ::std::vector<::br::worldgen::JigsawJunction>& junctions) /*override*/;

    // vIndex: 2
    virtual void appendRigid(::br::worldgen::TerrainAdjustment::Type type, ::std::vector<::br::worldgen::Rigid>& rigids) /*override*/;

    // vIndex: 4
    virtual bool postProcess(::BlockSource& region, ::Random& random, ::BoundingBox const& chunkBB) const /*override*/;

    // vIndex: 3
    virtual bool postProcess(::BlockSource& region, ::IRandom& random, ::BlockPos structurePos, ::BoundingBox const& chunkBB, ::br::worldgen::JigsawReplacement replacement) const /*override*/;
