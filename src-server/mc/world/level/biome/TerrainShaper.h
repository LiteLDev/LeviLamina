...
public:
    // static functions
    // NOLINTBEGIN
    MCAPI static ::ToFloatFunction<::TerrainShaper::Point> buildErosionJaggednessSpline(float jaggednessFactorAtPeakRidgeAndErosionIndex0, float jaggednessFactorAtPeakRidgeAndErosionIndex1, float jaggednessFactorAtHighRidgeAndErosionIndex0, float jaggednessFactorAtHighRidgeAndErosionIndex1);

    MCAPI static ::ToFloatFunction<::TerrainShaper::Point> buildErosionOffsetSpline(::std::string const& name, float lowValley, float hill, float tallHill, float mountainFactor, float plain, float swamp, bool includeExtremeHills, bool saddle);

    MCAPI static ::ToFloatFunction<::TerrainShaper::Point> buildMountainRidgeSplineWithPoints(float modulation, bool saddle);

    MCAPI static ::TerrainShaper buildOverworld();

    MCAPI static ::ToFloatFunction<::TerrainShaper::Point> buildRidgeJaggednessSpline(float jaggednessFactorAtPeakRidge, float jaggednessFactorAtHighRidge);
    ...
    MCAPI static ::ToFloatFunction<::TerrainShaper::Point> ridgeSpline(::std::string const& name, float valley, float low, float mid, float high, float peaks, float minValleySteepness);
    // NOLINTEND
