...
public:
    ...
    public:
        ...
        using InTaskFilePathCallBack = ::std::function<void(::Core::PathBuffer<::Core::BasicStackString<char, 1024>> const&)>;
...
public:
    ...
    MCAPI ::Bedrock::Threading::Async<::FileArchiver::Result> exportCurrentEditorLevel(::Level* level, ::Core::Path const& exportFilePath, ::std::function<void(::LevelData&)> preExportConvertedCallback, ::std::vector<::std::function<void(::Core::PathBuffer<::Core::BasicStackString<char, 1024>> const&)>> pathCallbacks, ::FileArchiver::ExportType exportType, ::FileArchiver::ShowToast toast);

    MCAPI ::Bedrock::Threading::Async<::FileArchiver::Result> exportCurrentLevel(::Level* level, bool isBundle, ::FileArchiver::ExportType exportType, ::Core::Path const& exportFilePath);
