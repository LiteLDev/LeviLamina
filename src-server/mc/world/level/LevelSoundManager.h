...
public:
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::UntypedStorage<8, 120> mUnk60c58b;
        // NOLINTEND
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::UntypedStorage<8, 120> mUnkff179a;
        // NOLINTEND
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::UntypedStorage<8, 120> mUnkd66652;
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::UntypedStorage<8, 120> mUnk4a5289;
...
public:
    ...
    // NOLINTBEGIN
    // vIndex: 1
    virtual ::Bedrock::PubSub::Connector<void(::SharedTypes::Legacy::LevelSoundEvent, ::Vec3 const&, int, ::ActorSoundIdentifier const&, bool)>& getOnLevelSoundEventConnector() /*override*/;

    // vIndex: 2
    virtual ::Bedrock::PubSub::Connector<void(::std::string const&, ::Vec3 const&, float, float)>& getOnLevelSoundEventWithVolumeAndPitchConnector() /*override*/;
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI LevelSoundManager(::Bedrock::NotNullNonOwnerPtr<::SoundPlayerInterface> soundPlayer, bool isClientSide, ::Bedrock::NotNullNonOwnerPtr<::LevelEventCoordinator> levelEventCoordinator, ::Bedrock::NotNullNonOwnerPtr<::PacketSender> packetSender, bool isServerAuthSoundEnabled);

    MCNAPI void _queueSoundPacket(::std::variant<::LevelSoundManager::QueuedSoundSendPacket, ::LevelSoundManager::QueuedSoundBroadcastPacket, ::LevelSoundManager::QueuedSoundBroadcastUserIdPacket, ::LevelSoundManager::QueuedSoundBroadcastMultipleUserIdsPacket> packet);

    MCNAPI void broadcastSoundEvent(::IDimension& dimension, ::SharedTypes::Legacy::LevelSoundEvent type, ::Vec3 const& pos, int data, ::ActorSoundIdentifier const& actorSoundIdentifier, bool isGlobal, ::Player* primaryLocalPlayer);

    MCNAPI void playPredictiveSynchronizedSound(::IDimension& dimension, ::SharedTypes::Legacy::LevelSoundEvent type, ::Vec3 const& pos, ::Player* targetPlayer, int data, ::ActorSoundIdentifier const& actorSoundIdentifier, bool isGlobal);

    MCNAPI void playSynchronizedSound_DEPRECATED(::IDimension& dimension, ::SharedTypes::Legacy::LevelSoundEvent type, ::Vec3 const& pos, ::Player* primaryLocalPlayer, int data, ::ActorSoundIdentifier const& actorSoundIdentifier, bool isGlobal);
...
public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::Bedrock::NotNullNonOwnerPtr<::SoundPlayerInterface> soundPlayer, bool isClientSide, ::Bedrock::NotNullNonOwnerPtr<::LevelEventCoordinator> levelEventCoordinator, ::Bedrock::NotNullNonOwnerPtr<::PacketSender> packetSender, bool isServerAuthSoundEnabled);
    // NOLINTEND
...
public:
    ...
    // NOLINTBEGIN
    MCNAPI ::Bedrock::PubSub::Connector<void(::SharedTypes::Legacy::LevelSoundEvent, ::Vec3 const&, int, ::ActorSoundIdentifier const&, bool)>& $getOnLevelSoundEventConnector();

    MCNAPI ::Bedrock::PubSub::Connector<void(::std::string const&, ::Vec3 const&, float, float)>& $getOnLevelSoundEventWithVolumeAndPitchConnector();
