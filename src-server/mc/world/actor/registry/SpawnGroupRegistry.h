...
public:
    ...
    using SpawnRulesHandler = ::std::function<void(::std::string const&, int, ::BiomeFilterGroup&, ::MobSpawnRules&, ::SemVersion const&)>;
...
public:
    ...
    MCAPI ::Puv::LoadResult<::ActorSpawnRuleData> _readJson(::std::string&& data, ::std::unordered_map<::std::string, ::ActorSpawnRuleData>& dataMap);
