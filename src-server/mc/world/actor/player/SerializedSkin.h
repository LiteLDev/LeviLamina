...
public:
    ...
    ::ll::TypedStorage<
        ...
        ::std::shared_ptr<::Bedrock::Application::
                              ThreadOwner<::SerializedSkinImpl, Bedrock::Application::ThreadOwnerBehavior::Assert>>> mSkinImpl;
    // NOLINTEND
