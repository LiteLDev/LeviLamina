...
public:
    ...
    MCAPI ::RenderParams& init(::BaseActorRenderContext* baseActorRenderContext, ::Actor* actor, ::AnimationComponent* animationComponent, ::MolangVariableMap* variableMap, ::std::shared_ptr<::DataDrivenModel> model, float frameAlpha, float modelScale, bool isDitheringEnabled);
