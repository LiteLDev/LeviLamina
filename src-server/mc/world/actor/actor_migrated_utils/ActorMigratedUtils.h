...
// functions
// NOLINTBEGIN
MCNAPI void initialize(::EntityContext&, ::SonicBoomGoal& goal, ::SharedTypes::v1_21_110::SonicBoomGoalDefinition definition);

MCNAPI void initialize(::EntityContext&, ::EatMobGoal& goal, ::SharedTypes::v1_21_100::EatMobGoalDefinition definition);

MCNAPI void initialize(::EntityContext&, ::SwimUpForBreathGoal& goal, ::SharedTypes::v1_21_110::SwimUpForBreathGoalDefinition definition);

MCNAPI void initialize(::EntityContext&, ::TransportItemsGoal& goal, ::SharedTypes::v1_21_100::TransportItemsGoalDefinition const& definition);

MCNAPI void initialize(::EntityContext&, ::ExperienceRewardComponent& runtimeComponent, ::SharedTypes::v1_21_110::ExperienceRewardDefinition const& loadedData);
// NOLINTEND
