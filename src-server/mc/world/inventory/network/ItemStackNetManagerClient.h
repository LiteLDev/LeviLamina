...
public:
    ...
    public:
        ...
        ::ll::TypedStorage<8, 64, ::std::unordered_map<::ItemStackRequestId, ::std::vector<::HistoricPredictionData>>> mHistoricPredictions;
        ::ll::TypedStorage<8, 64, ::std::unordered_map<::ItemStackRequestId, ::std::vector<::HistoricPredictionData>>> mZeroedOutItems;
        // NOLINTEND
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::TypedStorage<8, 64, ::std::unordered_map<::ContainerEnumName, ::std::unordered_set<uchar>>> mLegacyTransactionSetItemSlots;
        ::ll::TypedStorage<8, 64, ::std::unordered_map<::ItemStackRequestId, ::std::vector<::ItemStackNetManagerClient::PredictiveContainer*>>> mRequestContainers;
        ::ll::TypedStorage<8, 24, ::std::vector<::std::unique_ptr<::ClientScratchContainer>>> mClientScratchContainers;
        ::ll::TypedStorage<8, 24, ::std::vector<::std::unique_ptr<::ItemStackNetManagerClient::PredictiveContainer>>> mPlayerOwnedPredictiveContainers;
        ::ll::TypedStorage<8, 24, ::std::vector<::std::unique_ptr<::ItemStackNetManagerClient::PredictiveContainer>>> mOpenSessionPredictiveContainers;
        ::ll::TypedStorage<8, 64, ::std::unordered_map<::FullContainerName, ::ItemStackNetManagerClient::OpenSessionContainerData>> mOpenSessionContainerMap;
        ::ll::TypedStorage<8, 64, ::std::unordered_map<::FullContainerName, ::ItemStackNetManagerClient::OpenSessionContainerData>> mHudContainerMap;
        // NOLINTEND
...
public:
    ...
    // vIndex: 8
    virtual ::SparseContainer* initOpenContainer(::BlockSource&, ::FullContainerName const&, ::ContainerWeakRef const&) /*override*/;
    ...
    // vIndex: 9
    virtual void _addLegacyTransactionRequestSetItemSlot(::ItemStackNetManagerScreen&, ::SharedTypes::Legacy::ContainerType, int) /*override*/;
