...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI ContainerScreenValidation(::ContainerScreenContext const& screenContext, ::ContainerValidationCaller caller, ::std::unordered_map<::FullContainerName, ::std::shared_ptr<::Container>> predictiveContainers);
    ...
    MCNAPI ::std::shared_ptr<::ContainerValidationBase const> _getOrCreateContainerValidator(::FullContainerName const& containerEnumName);
    ...
    MCNAPI int _trySetItem(::ContainerValidationSlotInfo& slotInfo, ::ItemStack const& stack, bool isWholeStackTransfer, bool allowPartialSuccess, bool isInternalTransfer);

    MCNAPI ::ContainerValidationResult _tryTransferSpecial(::ContainerValidationSlotData const& srcSlotData, int transferAmount, ::ContainerScreenRequestActionType actionType);

    MCNAPI ::std::shared_ptr<::SimpleSparseContainer> getOrCreateSparseContainer(::FullContainerName const& containerEnumName);
    ...
    MCNAPI ::ContainerValidationResult tryDrop(::ContainerValidationSlotData const& srcSlotData, int transferAmount, bool dropRandomly);

    MCNAPI ::ContainerValidationResult trySwap(::ContainerValidationSlotData const& srcSlotData, ::ContainerValidationSlotData const& dstSlotData);

    MCNAPI ::ContainerValidationResult tryTransfer(::ContainerValidationSlotData const& srcSlotData, ::ContainerValidationSlotData const& dstSlotData, int transferAmount, bool isAllowingPartialTransfer);
    // NOLINTEND

public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static ::std::unique_ptr<::ContainerScreenValidation> makeContainerScreenValidation(::ContainerScreenContext const& screenContext, ::ContainerValidationCaller caller, ::std::unordered_map<::FullContainerName, ::std::shared_ptr<::Container>> predictiveContainers);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::ContainerScreenContext const& screenContext, ::ContainerValidationCaller caller, ::std::unordered_map<::FullContainerName, ::std::shared_ptr<::Container>> predictiveContainers);
    // NOLINTEND
...
public:
    ...
    // NOLINTBEGIN
    MCNAPI ::ContainerValidationResult $tryCraft(::std::unique_ptr<::ContainerValidationCraftInputs> craftInputs, uchar const);

    MCNAPI ::ContainerValidationCraftResult $getCraftResults(::std::unique_ptr<::ContainerValidationCraftInputs> craftInputs, uchar const);
