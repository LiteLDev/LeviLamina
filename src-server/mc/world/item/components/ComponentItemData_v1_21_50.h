...
public:
    ...
    ::ll::TypedStorage<8, 1088, ::SharedTypes::v1_21_50::ComponentItemComponentData> mItemComponents;
...
public:
    ...
    MCAPI static void upgrade(::Puv::CerealUpgrader<::ComponentItemData_v1_21_40, ::ComponentItemData_v1_21_50, nullptr_t>& upgrader);
    // NOLINTEND
