...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI void insertAfterGroup(::SharedTypes::v1_21_60::CraftingCatalogItemCategory itemCategory, ::std::string_view groupName, ::CraftingItemCatalogMergeResult::Group insertGroup);
