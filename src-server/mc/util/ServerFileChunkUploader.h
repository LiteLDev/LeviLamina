...
public:
    ...
    // vIndex: 1
    virtual void initFileUploader(::std::string const& uploadId, ::FileInfo const& file, int chunkSize, ::Json::Value const& uploadOptions, ::std::function<void(bool)> callback) /*override*/;

    // vIndex: 2
    virtual void getServerMissingChunks(::FileInfo const& file, ::std::function<void(::std::vector<::FileChunkInfo>)> callback) const /*override*/;

    // vIndex: 3
    virtual void confirmChunkReceived(::FileInfo const& file, ::FileChunkInfo const& chunk) /*override*/;

    // vIndex: 4
    virtual void uploadChunk(::FileInfo const& file, ::FileChunkInfo const& chunk, ::std::vector<uchar> data, ::std::function<void(bool)> onCompleteCallback) /*override*/;
...
public:
    ...
    // NOLINTBEGIN
    MCNAPI void $initFileUploader(::std::string const& uploadId, ::FileInfo const& file, int chunkSize, ::Json::Value const& uploadOptions, ::std::function<void(bool)> callback);
