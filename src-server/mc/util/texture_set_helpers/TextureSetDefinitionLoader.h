...
public:
    ...
    public:
        ...
        // vIndex: 4
        virtual bool loadResourceOfExtensions(::ResourceLocationPair const&, ::std::string&, ::gsl::span<::std::string const>) const;
    
        // vIndex: 5
        virtual bool loadResource(::ResourceLocation const&, ::std::string&) const;
    
        // vIndex: 6
        virtual bool loadImageResourceFromFile(::std::shared_ptr<::cg::ImageResource>&, ::ResourceLocationPair const&, ::gsl::span<::std::string const>) const;
