...
class PrefabDBPrefabInstance : public ::std::enable_shared_from_this<::Editor::Prefabs::PrefabDBPrefabInstance>, public ::EnableGetWeakRef<::Editor::Prefabs::PrefabDBPrefabInstance> {
public:
    // member variables
    // NOLINTBEGIN
