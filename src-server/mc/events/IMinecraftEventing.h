...
class IMinecraftEventing : public ::Bedrock::EnableNonOwnerReferences, public ::IPackTelemetry, public ::IScreenChangedEventing, public ::IConnectionEventing, public ::IWebviewTelemetry, public ::IUIEventTelemetry {
public:
...
public:
    ...
    // vIndex: 1
    virtual void init(::Bedrock::NotNullNonOwnerPtr<::Social::IUserManager> const&, ::Bedrock::NonOwnerPointer<::AppPlatform> const&, ::std::unique_ptr<::Social::Events::EventManager>) = 0;
    ...
    // vIndex: 108
    virtual void fireEventPurchaseAttempt(::std::string const&, ::std::string const&, ::std::string const&, ::IMinecraftEventing::StoreType, ::PurchasePath, ::std::optional<uint64>) = 0;

    // vIndex: 109
    virtual void fireEventPurchaseResolved(::std::string const&, ::std::string const&, ::std::string const&, ::IMinecraftEventing::StoreType, ::IMinecraftEventing::PurchaseResult, ::PurchasePath, ::std::optional<uint64>) = 0;
    ...
    // vIndex: 137
    virtual void fireEventWorldLoaded(::Player*, ::persona::ProfileType const, ::std::string const&, bool, ::NetworkType) = 0;
    ...
    // vIndex: 264
    virtual void fireEventRealmsPurchase(::std::string const&, ::RealmsPurchaseFlow, ::RealmsPurchaseIntent, ::RealmsOfferPeriod, ::RealmsOfferTier, bool, ::ProductSku const&, ::RealmsPurchaseStage, ::RealmsPurchaseStatus, ::RealmsPurchaseTelemetryFailureReason, ::std::vector<::Offer*> const&) = 0;
    ...
    // vIndex: 292
    virtual void fireEventPersonaItemPreviewed(::persona::ProfileType const, ::std::string const&, ::std::string const&, uint, uint, ::IMinecraftEventing::PromotionType, bool, ::std::string const&, ::std::string const&, double, ::IMinecraftEventing::StoreType) = 0;
