...
LL_AUTO_STATIC_HOOK(
    ...
    return origin(serverNetworkHandler, networkIdentifier, animatePacket);
}

/////////////////// PlayerAttackEntity ///////////////////
LL_AUTO_TYPED_INSTANCE_HOOK(
    PlayerAttackEntityEventHook,
    Player,
    ll::memory::Priority::PriorityNormal,
...
LL_AUTO_INSTANCE_HOOK(
    ...
    Actor* pl = LL_SYMBOL_CALL("??$tryUnwrap@VActor@@$$V@WeakEntityRef@@QEBAPEAVActor@@XZ", Actor*, void*)(a2);
    if (pl->isPlayer()) {
...
LL_AUTO_TYPED_INSTANCE_HOOK(
    PlayerExperienceAddEventEventHook,
    Player,
    ll::memory::Priority::PriorityNormal,
...
LL_AUTO_TYPED_INSTANCE_HOOK(
    ...
    return origin(bp, a3, afterBlock, beforeBlock, a6, a7, ac);
}
...
LL_AUTO_INSTANCE_HOOK(
    ...
    return origin(bs, bp, level, isActive);
}
...
LL_AUTO_TYPED_INSTANCE_HOOK(
    PistonTryPushEventAndPistonPushEventEventHook,
    PistonBlockActor,
    ll::memory::Priority::PriorityNormal,
...
LL_AUTO_TYPED_INSTANCE_HOOK(
    ...
    auto rtn = origin(bs, to, from, unk);
    if (!rtn)
        return rtn;
...
LL_AUTO_INSTANCE_HOOK(
    EntityAndBlockExplosionEventHook,
    ll::memory::Priority::PriorityNormal,
