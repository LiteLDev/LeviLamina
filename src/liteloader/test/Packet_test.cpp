...
static_assert(sizeof(Unknown(65)) == 0x140, "size of Unknown(65) should be 320");
...
static_assert(
    sizeof(ResourcePacksInfoPacket) == 0x68 || sizeof(ResourcePacksInfoPacket) == 48,
...
static_assert(
    sizeof(StartGamePacket) == 0x520 || sizeof(StartGamePacket) == 48,
    "size of StartGamePacket should be 1312 or 48(default)"
);
static_assert(
...
static_assert(
    sizeof(CameraPresetsPacket) == 0x48 || sizeof(CameraPresetsPacket) == 48,
    "size of CameraPresetsPacket should be 72 or 48(default)"
);
static_assert(
...
static_assert(
    sizeof(CameraInstructionPacket) == 0x48 || sizeof(CameraInstructionPacket) == 48,
    "size of CameraInstructionPacket should be 72 or 48(default)"
);
static_assert(
