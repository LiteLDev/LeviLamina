...
public:
    TestDimension(ILevel& ilevel, Scheduler& scheduler): Dimension(ilevel, VanillaDimensions::TestDimension,DimensionHeightRange(-64,320),scheduler,"TestDimension") {
    ...
    bool hasPrecipitationFog() const {
        return true;
    };
