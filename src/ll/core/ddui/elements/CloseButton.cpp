...
CloseButton::CloseButton(ObsStringOrString label, std::function<void()> onClick, ButtonOptions options)
: mLabel(std::move(label)),
  mOnClick(std::move(onClick)),
  mOptions(std::move(options)) {}

nlohmann::ordered_json CloseButton::serialize() const {
...
void CloseButton::setupSubscriptions(
    ...
    setupTextSubscription(mOptions.tooltip, prefix + "tooltip", addSub, updateString, updateObject);
