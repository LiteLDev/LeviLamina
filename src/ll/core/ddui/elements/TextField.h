...
private:
    ...
    std::shared_ptr<ObservableString> mText;
    TextFieldOptions                  mOptions;

public:
    TextField(ObsStringOrString label, std::shared_ptr<ObservableString> text, TextFieldOptions options);
