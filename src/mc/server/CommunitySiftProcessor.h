...
public:
    ...
    processAnonymousMessages(class IMinecraftEventing*, enum class TextProcessingEventOrigin, std::vector<std::string> const&, class std::function<void(std::vector<std::string> const&, std::vector<enum class Safety::TextFilteringEvent> const&)>); // NOLINT
    /**
     * @vftbl 2
     * @symbol
     ...
     */
    virtual class CallbackToken
    processMessages(class Player const&, enum class TextProcessingEventOrigin, std::vector<std::string> const&, class std::function<void(std::vector<std::string> const&, std::vector<enum class Safety::TextFilteringEvent> const&)>); // NOLINT
    /**
     * @vftbl 3
     * @symbol
     ...
     */
    virtual class CallbackToken
    processAnonymousNonChatText(class IMinecraftEventing*, enum class TextProcessingEventOrigin, std::vector<std::string> const&, class std::function<void(std::vector<std::string> const&, std::vector<enum class Safety::TextFilteringEvent> const&)>); // NOLINT
    /**
     * @vftbl 4
     * @symbol
     ...
     */
    virtual class CallbackToken
    processNonChatText(class Player const&, enum class TextProcessingEventOrigin, std::vector<std::string> const&, class std::function<void(std::vector<std::string> const&, std::vector<enum class Safety::TextFilteringEvent> const&)>); // NOLINT
    /**
     * @vftbl 5
     * @symbol ?processJoinEvent\@CommunitySiftProcessor\@\@UEAAXAEBVPlayer\@\@\@Z
     */
    virtual void processJoinEvent(class Player const&); // NOLINT
    /**
     * @vftbl 6
     * @symbol ?processLeaveEvent\@CommunitySiftProcessor\@\@UEAAXAEBVPlayer\@\@\@Z
     */
    virtual void processLeaveEvent(class Player const&); // NOLINT
    /**
     * @vftbl 7
     * @symbol ?onStartShutdown\@CommunitySiftProcessor\@\@UEAAXXZ
     */
    virtual void onStartShutdown(); // NOLINT
    /**
     * @symbol
     * ??0CommunitySiftProcessor\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@0AEAVScheduler\@\@\@Z
     */
    MCAPI CommunitySiftProcessor(std::string const&, std::string const&, class Scheduler&); // NOLINT
     ...
     */
    MCAPI class std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> _createRequest(
        std::string const&,
        std::string const&,
        class IMinecraftEventing*,
        std::string const&,
        enum class TextProcessingEventOrigin,
        class std::shared_ptr<std::vector<struct std::pair<int, std::string>>>,
        class std::shared_ptr<std::vector<class Json::Value>>,
        bool,
        std::string const&,
        int
    ); // NOLINT
    ...
    _processAnonymousMessages(class IMinecraftEventing*, enum class TextProcessingEventOrigin, std::vector<std::string> const&, std::string const&, class std::function<void(std::vector<std::string> const&, std::vector<enum class Safety::TextFilteringEvent> const&)>); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    _processEvent(class Player const&, enum class TextProcessingEventOrigin, class UserEntityIdentifierComponent const*, std::string const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class CallbackToken
    _processMessages(class Player const&, bool, enum class TextProcessingEventOrigin, std::vector<std::string> const&, std::string const&, class std::function<void(std::vector<std::string> const&, std::vector<enum class Safety::TextFilteringEvent> const&)>); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class CallbackToken _processMessages(std::string, std::string, class IMinecraftEventing*, bool, enum class TextProcessingEventOrigin, std::vector<std::string> const&, std::string const&, class std::function<void(std::vector<std::string> const&, std::vector<enum class Safety::TextFilteringEvent> const&)>); // NOLINT
    /**
     * @symbol ?_validateCommunitySiftConfiguration\@CommunitySiftProcessor\@\@AEAA_NXZ
     */
    MCAPI bool _validateCommunitySiftConfiguration(); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI static struct CommunitySiftConfig _createConfigFromJson(std::string const&); // NOLINT
    /**
     * @symbol
    ...
    _processJsonEvents(std::vector<class Json::Value> const&, float, enum class Safety::ChatFloodingAction); // NOLINT
