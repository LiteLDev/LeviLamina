 ...
 */
MCAPI void handleResult(class Command const&, std::vector<class Actor const*> const&, class CommandOutput&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void
runCommand(class Command const&, class CommandOrigin const&, class Actor const&, std::vector<class Actor const*>&, class CommandOutput&); // NOLINT
