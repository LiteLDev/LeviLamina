...
public:
    ...
    public:
         ...
         */
        MCAPI class entt::internal::dense_map_iterator<std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<struct entt::internal::dense_map_node<std::pair<class CommandRegistry::Symbol, class CommandRegistry::Symbol>, int32_t>>>>> _findParsePrediction(struct CommandRegistry::LexicalToken const &, class CommandRegistry::Symbol const &) const;
        /**
...
public:
     ...
     */
    MCAPI class CommandRegistry::Symbol _addChainedSubcommandValuesInternal(std::string const &, std::vector<std::pair<std::string, uint32_t>> const &, class Bedrock::typeid_t<class CommandRegistry>, bool (__cdecl CommandRegistry::*)(void *, struct CommandRegistry::ParseToken const &, class CommandOrigin const &, int32_t, std::string &, std::vector<std::string> &) const, struct CommandRegistry::Signature *);
    /**
     ...
     */
    MCAPI class CommandRegistry::Symbol _addChainedSubcommandValuesInternal(std::string const &, std::vector<std::pair<uint64_t, uint32_t>> const &, class Bedrock::typeid_t<class CommandRegistry>, bool (__cdecl CommandRegistry::*)(void *, struct CommandRegistry::ParseToken const &, class CommandOrigin const &, int32_t, std::string &, std::vector<std::string> &) const, struct CommandRegistry::Signature *);
    /**
     ...
     */
    MCAPI class CommandRegistry::Symbol _addEnumValuesInternal(std::string const &, std::vector<std::pair<std::string, uint64_t>> const &, class Bedrock::typeid_t<class CommandRegistry>, bool (__cdecl CommandRegistry::*)(void *, struct CommandRegistry::ParseToken const &, class CommandOrigin const &, int32_t, std::string &, std::vector<std::string> &) const);
    /**
     ...
     */
    MCAPI class CommandRegistry::Symbol _addEnumValuesInternal(std::string const &, std::vector<std::pair<uint64_t, uint64_t>> const &, class Bedrock::typeid_t<class CommandRegistry>, bool (__cdecl CommandRegistry::*)(void *, struct CommandRegistry::ParseToken const &, class CommandOrigin const &, int32_t, std::string &, std::vector<std::string> &) const);
    /**
     ...
     */
    MCAPI void buildFollowSet(struct CommandRegistry::ParseTable &, class CommandRegistry::Symbol, uint32_t, std::set<class CommandRegistry::Symbol> &) const;
    /**
     ...
     */
    MCAPI class CommandRegistry::Symbol buildOptionalRuleChain(struct CommandRegistry::Signature const &, std::vector<class CommandParameterData> const &, class CommandParameterData const *, uint64_t);
    /**
     ...
     */
    MCAPI class CommandRegistry::Symbol buildRules(struct CommandRegistry::Signature &, std::vector<class gsl::not_null<struct CommandRegistry::Overload *>> const &, uint64_t);
    /**
     ...
     */
    MCAPI std::unique_ptr<class Command> createCommand(struct CommandRegistry::ParseToken const &, class CommandOrigin const &, int32_t, std::string &, std::vector<std::string> &) const;
    /**
     ...
     */
    MCAPI std::string describe(struct CommandRegistry::Signature const &, std::string const &, struct CommandRegistry::Overload const &, uint32_t, uint32_t *, uint32_t *) const;
    /**
     ...
     */
    MCAPI bool parseSelector(struct ActorSelectorArgs &, struct CommandRegistry::ParseToken const &, class CommandOrigin const &, int32_t, std::string &, std::vector<std::string> &) const;
    /**
     ...
     */
    MCAPI bool parseSelector(class CommandSelectorBase *, struct CommandRegistry::ParseToken const &, class CommandOrigin const &, int32_t, std::string &, std::vector<std::string> &, bool) const;
    /**
     ...
     */
    MCAPI static void addNonEpsilonSymbols(class entt::dense_set<class CommandRegistry::Symbol, struct CommandRegistry::SymbolHasher, std::equal_to<class CommandRegistry::Symbol>, std::allocator<class CommandRegistry::Symbol>> &, class entt::dense_set<class CommandRegistry::Symbol, struct CommandRegistry::SymbolHasher, std::equal_to<class CommandRegistry::Symbol>, std::allocator<class CommandRegistry::Symbol>> const &);
    /**
     ...
     */
    MCAPI static bool readInt(int32_t &, struct CommandRegistry::ParseToken const &, std::string &, std::vector<std::string> &);
    /**
...
private:
     ...
     */
    MCAPI static std::pair<bool (__cdecl CommandRegistry::*)(void *, struct CommandRegistry::ParseToken const &, class CommandOrigin const &, int32_t, std::string &, std::vector<std::string> &) const, class CommandRegistry::Symbol> const ParseRuleSymbols[];
    // NOLINTEND
