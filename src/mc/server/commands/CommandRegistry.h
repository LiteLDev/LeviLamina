...
public:
    ...
    public:
        // member functions
        // NOLINTBEGIN
        MCAPI explicit Symbol(::CommandLexer::TokenType value);
    ...
    public:
        // constructor thunks
        // NOLINTBEGIN
        MCFOLD void* $ctor(::CommandLexer::TokenType value);
    ...
    public:
        ...
        MCAPI
        Overload(::CommandVersion version_, ::brstd::copyable_function<::std::unique_ptr<::Command>() const> alloc_);
    ...
    public:
        ...
        MCAPI void*
        $ctor(::CommandVersion version_, ::brstd::copyable_function<::std::unique_ptr<::Command>() const> alloc_);
        // NOLINTEND
