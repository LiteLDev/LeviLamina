...
public:
     ...
     */
    MCAPI
    FunctionManager(std::unique_ptr<class ICommandDispatcher>, std::unique_ptr<class CommandOrigin>, class GameRule const*); // NOLINT
    /**
     * @symbol ?execute\@FunctionManager\@\@QEAAHAEAVFunctionEntry\@\@AEBVCommandOrigin\@\@W4FunctionQueueOrder\@\@\@Z
     */
    MCAPI int execute(class FunctionEntry&, class CommandOrigin const&, enum class FunctionQueueOrder); // NOLINT
    /**
     * @symbol
     * ?getFunction\@FunctionManager\@\@QEAAPEAVFunctionEntry\@\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@\@Z
     */
    MCAPI class FunctionEntry* getFunction(std::string const&); // NOLINT
    /**
     * @symbol ?load\@FunctionManager\@\@QEAAXAEAVResourcePackManager\@\@AEAVCommandRegistry\@\@\@Z
     */
    MCAPI void load(class ResourcePackManager&, class CommandRegistry&); // NOLINT
    /**
     ...
     */
    MCAPI static std::string getFunctionNameFromPath(class Core::Path const&); // NOLINT
    /**
     * @symbol
     * ?getQueueOrderForCommandVersion\@FunctionManager\@\@SA?AW4FunctionQueueOrder\@\@W4CurrentCmdVersion\@\@\@Z
     */
    MCAPI static enum class FunctionQueueOrder getQueueOrderForCommandVersion(enum class CurrentCmdVersion); // NOLINT

    // protected:
    /**
     * @symbol ?_addTickFunctionsFromJson\@FunctionManager\@\@IEAAXAEBVValue\@Json\@\@W4CurrentCmdVersion\@\@\@Z
     */
    MCAPI void _addTickFunctionsFromJson(class Json::Value const&, enum class CurrentCmdVersion); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    _processFunctionEntry(std::string const&, std::vector<std::string> const&, std::vector<std::string>&, enum class CurrentCmdVersion, class CommandRegistry const&); // NOLINT

    // private:
    /**
     * @symbol ?_addOriginReference\@FunctionManager\@\@AEAAAEBVCommandOrigin\@\@AEBV2\@I\@Z
     */
    MCAPI class CommandOrigin const& _addOriginReference(class CommandOrigin const&, unsigned int); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    _queueCommandsAfterCaller(std::vector<std::unique_ptr<class IFunctionEntry>> const&, class CommandOrigin const&); // NOLINT
    /**
     * @symbol ?_removeOriginReference\@FunctionManager\@\@AEAAXAEBVCommandOrigin\@\@I\@Z
     */
    MCAPI void _removeOriginReference(class CommandOrigin const&, unsigned int); // NOLINT
