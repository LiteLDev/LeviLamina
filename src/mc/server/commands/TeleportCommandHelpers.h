...
actorToLocationTeleportAnalysis(class BlockSource const&, class Actor const&, class Vec3); // NOLINT
/**
 * @symbol ?getSafetyAABB\@TeleportCommandHelpers\@\@YA?AVAABB\@\@AEBVActor\@\@VVec3\@\@\@Z
 */
MCAPI class AABB getSafetyAABB(class Actor const&, class Vec3); // NOLINT
