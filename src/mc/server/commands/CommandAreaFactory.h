...
public:
    ...
    MCAPI std::unique_ptr<class CommandArea>
          findArea(class BlockPos const& min, class BlockPos const& max, bool, bool allowUnloadedChunks, bool) const;
    ...
    MCAPI std::unique_ptr<class CommandArea>
          _getArea(struct Bounds const& requiredArea, bool, bool allowUnloadedChunks, bool) const;
