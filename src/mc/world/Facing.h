...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_FACING_PLANE
    public:
...
public:
    ...
    MCAPI static class std::unordered_map<
        ...
        class std::allocator<struct std::pair<std::string const, unsigned char>>> const FROM_STRING_MAP;
    /**
     ...
     */
    MCAPI static class std::basic_string_view<char, struct std::char_traits<char>> toString(unsigned char);
};
