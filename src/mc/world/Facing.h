...
public:
     ...
     */
    MCAPI static uint8_t convertDirectionToFacingDirection(enum class Direction::Type);
    /**
     * @symbol ?convertWeirdoDirectionToFacingDirection\@Facing\@\@SAEW4WeirdoDirection\@\@\@Z
     */
    MCAPI static uint8_t convertWeirdoDirectionToFacingDirection(enum class WeirdoDirection);
    /**
     ...
     */
    MCAPI static enum class Facing::Name from2DDataValue(int32_t);
    /**
     ...
     */
    MCAPI static enum class Facing::Axis getAxis(uint8_t);
    /**
     * @symbol ?getAxisFromStandingRotation\@Facing\@\@SA?AV?$optional\@W4Axis\@Facing\@\@\@std\@\@H\@Z
     */
    MCAPI static std::optional<enum class Facing::Axis> getAxisFromStandingRotation(int32_t);
    /**
     ...
     */
    MCAPI static struct glm::mat<3, 3, float, 0> getRotationMatrix(uint8_t, enum class Facing::Rotation);
    /**
     ...
     */
    MCAPI static uint8_t rotateFace(uint8_t, enum class Facing::Rotation);
    /**
     * @symbol ?rotateFaceAroundGivenFace\@Facing\@\@SAEEEW4Rotation\@1\@\@Z
     */
    MCAPI static uint8_t rotateFaceAroundGivenFace(uint8_t, uint8_t, enum class Facing::Rotation);
    /**
