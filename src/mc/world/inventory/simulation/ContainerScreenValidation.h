...
public:
     ...
     */
    MCAPI
    ContainerScreenValidation(class ContainerScreenContext const&, enum class ContainerValidationCaller, std::unordered_map<enum class ContainerEnumName, std::shared_ptr<class Container>>);
    /**
     * @symbol
     * ?getOrCreateSparseContainer\@ContainerScreenValidation\@\@QEAA?AV?$shared_ptr\@VSimpleSparseContainer\@\@\@std\@\@W4ContainerEnumName\@\@\@Z
     */
    MCAPI std::shared_ptr<class SimpleSparseContainer> getOrCreateSparseContainer(enum class ContainerEnumName);
    /**
    ...
    MCAPI std::shared_ptr<class ContainerValidationBase const>
          _getOrCreateContainerValidator(enum class ContainerEnumName);
    /**
