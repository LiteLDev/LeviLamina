...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI AllowedAnywhereConsume(::FullContainerName const& openContainerNetId, uchar minSlot, uchar maxSlot);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::FullContainerName const& openContainerNetId, uchar minSlot, uchar maxSlot);
    // NOLINTEND
};
