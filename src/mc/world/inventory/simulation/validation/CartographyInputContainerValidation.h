...
public:
    // NOLINTBEGIN
    // vIndex: 0, symbol: __gen_??1CartographyInputContainerValidation@@UEAA@XZ
    virtual ~CartographyInputContainerValidation() = default;
    ...
    // vIndex: 2, symbol:
    // ?isItemAllowedInSlot@CartographyInputContainerValidation@@UEBA_NAEBVContainerScreenContext@@HAEBVItemStackBase@@H@Z
