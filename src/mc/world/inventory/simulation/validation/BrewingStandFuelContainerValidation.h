...
public:
    // NOLINTBEGIN
    // vIndex: 0, symbol: __gen_??1BrewingStandFuelContainerValidation@@UEAA@XZ
    virtual ~BrewingStandFuelContainerValidation() = default;
    ...
    // vIndex: 2, symbol:
    // ?isItemAllowedInSlot@BrewingStandFuelContainerValidation@@UEBA_NAEBVContainerScreenContext@@HAEBVItemStackBase@@H@Z
