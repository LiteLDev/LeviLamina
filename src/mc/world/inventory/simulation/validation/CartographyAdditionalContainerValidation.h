...
public:
    // NOLINTBEGIN
    // vIndex: 0, symbol: __gen_??1CartographyAdditionalContainerValidation@@UEAA@XZ
    virtual ~CartographyAdditionalContainerValidation() = default;
    ...
    // vIndex: 2, symbol:
    // ?isItemAllowedInSlot@CartographyAdditionalContainerValidation@@UEBA_NAEBVContainerScreenContext@@HAEBVItemStackBase@@H@Z
    ...
    // vIndex: 8, symbol:
    // ?getContainerOffset@CartographyAdditionalContainerValidation@@UEBAHAEBVContainerScreenContext@@@Z
