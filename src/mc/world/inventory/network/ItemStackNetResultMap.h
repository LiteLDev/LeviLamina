...
public:
     ...
     */
    MCAPI static std::string const& getItemStackNetResultName(enum class ItemStackNetResult); // NOLINT
...
private:
     ...
     */
    MCAPI static class BidirectionalUnorderedMap<enum class ItemStackNetResult, std::string> const mMap; // NOLINT
};
