...
public:
    ...
    MCAPI ItemStackRequestActionCraftHandler(class ItemStackRequestActionHandler& actionHandler, class Player& player);
...
public:
    ...
    MCAPI void* ctor$(class ItemStackRequestActionHandler& actionHandler, class Player& player);
