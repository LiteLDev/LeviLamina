 ...
 */
MCAPI bool
doesItemHaveResultingTrim(class CraftingContext const&, class ItemStack const&, std::string const&, std::string const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI bool validateAdditionIngredient(class Level const&, class RecipeIngredient, std::string const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI bool validateBaseIngredient(class RecipeIngredient, std::string const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI bool validateTemplateIngredient(class Level const&, class RecipeIngredient, std::string const&); // NOLINT
