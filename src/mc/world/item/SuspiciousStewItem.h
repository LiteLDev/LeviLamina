...
public:
     ...
     */
    MCAPI static void applyStewEffect(class ItemStack const&, class Actor&); // NOLINT

    // private:
    /**
     * @symbol ?_getStewEffects\@SuspiciousStewItem\@\@CAAEBV?$array\@VMobEffectInstance\@\@$0L\@\@std\@\@XZ
     */
    MCAPI static class std::array<class MobEffectInstance, 11> const& _getStewEffects(); // NOLINT
