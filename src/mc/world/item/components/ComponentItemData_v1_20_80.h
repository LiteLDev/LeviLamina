...
public:
    ...
    ::ll::TypedStorage<8, 872, ::SharedTypes::v1_20_80::ComponentItemComponentData> mItemComponents;
...
public:
    ...
    MCAPI ::ComponentItemData_v1_20_80& operator=(::ComponentItemData_v1_20_80 const&);
