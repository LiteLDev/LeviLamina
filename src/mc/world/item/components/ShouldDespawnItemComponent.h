...
// clang-format off
namespace Puv::v1_20_50 { struct ShouldDespawnItemComponent; }
...
public:
    // NOLINTBEGIN
    // vIndex: 0, symbol: __gen_??1ShouldDespawnItemComponent@@UEAA@XZ
    ...
    // vIndex: 4, symbol:
    // ?buildNetworkTag@?$NetworkedItemComponent@VShouldDespawnItemComponent@@@@UEBA?AV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@AEBUReflectionCtx@cereal@@@Z
    virtual std::unique_ptr<class CompoundTag> buildNetworkTag(struct cereal::ReflectionCtx const&) const;

    // vIndex: 5, symbol:
    // ?initializeFromNetwork@?$NetworkedItemComponent@VShouldDespawnItemComponent@@@@UEAA_NAEBVCompoundTag@@AEBUReflectionCtx@cereal@@@Z
    ...
    // vIndex: 9, symbol: ?_initializeComponent@ShouldDespawnItemComponent@@UEAAXXZ
    virtual void _initializeComponent();

    // symbol: ??0ShouldDespawnItemComponent@@QEAA@U0v1_20_50@Puv@@@Z
    MCAPI explicit ShouldDespawnItemComponent(struct Puv::v1_20_50::ShouldDespawnItemComponent);
