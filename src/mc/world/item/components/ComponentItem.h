...
public:
    ...
    // vIndex: 106, symbol: ?getAnimationFrameFor@ComponentItem@@UEBAHPEAVMob@@_NPEBVItemStack@@_N@Z
    ...
    // symbol:
    // ??0ComponentItem@@QEAA@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@FAEAUReflectionCtx@cereal@@@Z
    MCAPI ComponentItem(std::string const&, short, struct cereal::ReflectionCtx&);
