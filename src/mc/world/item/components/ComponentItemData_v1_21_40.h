...
public:
    ...
    ::ll::TypedStorage<8, 1088, ::SharedTypes::v1_21_40::ComponentItemComponentData> mItemComponents;
...
public:
    ...
    MCAPI ::ComponentItemData_v1_21_40& operator=(::ComponentItemData_v1_21_40 const&);
