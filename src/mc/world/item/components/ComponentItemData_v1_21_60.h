...
public:
    ...
    ::ll::TypedStorage<8, 1112, ::SharedTypes::v1_21_60::ComponentItemComponentData> mItemComponents;
    ::ll::TypedStorage<8, 840, ::ComponentItemDeprecatedComponentData_v1_20_80>      mDeprecatedItemComponents;
    // NOLINTEND

public:
    // prevent constructor by default
    ComponentItemData_v1_21_60(ComponentItemData_v1_21_60 const&);
    ComponentItemData_v1_21_60();

public:
    // member functions
    // NOLINTBEGIN
    MCFOLD ::ComponentItemData_v1_21_60& operator=(::ComponentItemData_v1_21_60 const&);
