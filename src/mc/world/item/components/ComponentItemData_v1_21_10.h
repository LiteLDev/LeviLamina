...
public:
    ...
    ::ll::TypedStorage<8, 936, ::SharedTypes::v1_21_10::ComponentItemComponentData> mItemComponents;
...
public:
    ...
    MCAPI ::ComponentItemData_v1_21_10& operator=(::ComponentItemData_v1_21_10 const&);
