...
public:
     ...
     */
    MCAPI ProjectileItemComponent(class ComponentItem*, enum class ActorType, float); // NOLINT
    /**
     ...
     */
    MCAPI class Vec3 getShootDir(class Player const&, float) const; // NOLINT
    /**
     * @symbol
     * ?shootProjectile\@ProjectileItemComponent\@\@QEBAPEAVActor\@\@AEAVBlockSource\@\@AEBVVec3\@\@1MPEAVPlayer\@\@\@Z
     */
    MCAPI class Actor*
    shootProjectile(class BlockSource&, class Vec3 const&, class Vec3 const&, float, class Player*) const; // NOLINT
    /**
