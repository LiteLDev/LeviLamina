...
// clang-format off
namespace Puv::v1_20_50 { struct UseAnimationItemComponent; }
...
public:
    ...
    // vIndex: 4, symbol:
    // ?buildNetworkTag@?$NetworkedItemComponent@VUseAnimationItemComponent@@@@UEBA?AV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@AEBUReflectionCtx@cereal@@@Z
    virtual std::unique_ptr<class CompoundTag> buildNetworkTag(struct cereal::ReflectionCtx const&) const;

    // vIndex: 5, symbol:
    // ?initializeFromNetwork@?$NetworkedItemComponent@VUseAnimationItemComponent@@@@UEAA_NAEBVCompoundTag@@AEBUReflectionCtx@cereal@@@Z
    ...
    // vIndex: 9, symbol: ?_initializeComponent@UseAnimationItemComponent@@UEAAXXZ
    virtual void _initializeComponent();

    // symbol: ??0UseAnimationItemComponent@@QEAA@U0v1_20_50@Puv@@@Z
    MCAPI explicit UseAnimationItemComponent(struct Puv::v1_20_50::UseAnimationItemComponent);
