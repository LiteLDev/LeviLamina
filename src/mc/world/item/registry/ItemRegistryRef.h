...
public:
    ...
    public:
         ...
         */
        MCAPI LockGuard(class std::shared_ptr<class std::mutex>); // NOLINT
        /**
         * @symbol ??1LockGuard\@ItemRegistryRef\@\@QEAA\@XZ
         */
        MCAPI ~LockGuard(); // NOLINT
    };
...
public:
     ...
     */
    MCAPI ItemRegistryRef(class ItemRegistryRef const&); // NOLINT
    /**
     * @symbol ?addItemToTagMap\@ItemRegistryRef\@\@QEBAXAEBVItem\@\@\@Z
     */
    MCAPI void addItemToTagMap(class Item const&) const; // NOLINT
    /**
     * @symbol ?allowTagUpdate\@ItemRegistryRef\@\@QEBA?AVTagUpdateToken\@\@XZ
     */
    MCAPI class TagUpdateToken allowTagUpdate() const; // NOLINT
    /**
     * @symbol ?alterAvailableCreativeItems\@ItemRegistryRef\@\@QEBAXPEAVActorInfoRegistry\@\@AEAVLevelData\@\@\@Z
     */
    MCAPI void alterAvailableCreativeItems(class ActorInfoRegistry*, class LevelData&) const; // NOLINT
    /**
     * @symbol ?canAddTags\@ItemRegistryRef\@\@QEBA_NXZ
     */
    MCAPI bool canAddTags() const; // NOLINT
    /**
     * @symbol ?clearDeadItemRegistry\@ItemRegistryRef\@\@QEBAXXZ
     */
    MCAPI void clearDeadItemRegistry() const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    digestServerItemComponents(std::vector<struct std::pair<std::string, class CompoundTag>> const&) const; // NOLINT
    /**
     * @symbol
    ...
    MCAPI std::vector<class std::reference_wrapper<class HashedString const>> const&
          getComplexAliasSplitNames(class HashedString const&) const; // NOLINT
    /**
     * @symbol ?getItem\@ItemRegistryRef\@\@QEBA?AV?$WeakPtr\@VItem\@\@\@\@F\@Z
     */
    MCAPI class WeakPtr<class Item> getItem(short) const; // NOLINT
    /**
     * @symbol ?getItem\@ItemRegistryRef\@\@QEBA?AV?$WeakPtr\@VItem\@\@\@\@AEBVHashedString\@\@\@Z
     */
    MCAPI class WeakPtr<class Item> getItem(class HashedString const&) const; // NOLINT
    /**
     * @symbol ?getItemCount\@ItemRegistryRef\@\@QEBAHXZ
     */
    MCAPI int getItemCount() const; // NOLINT
    /**
     * @symbol ?getItemResponseFactory\@ItemRegistryRef\@\@QEBAPEAVItemEventResponseFactory\@\@XZ
     */
    MCAPI class ItemEventResponseFactory* getItemResponseFactory() const; // NOLINT
    /**
     * @symbol ?getNameFromLegacyID\@ItemRegistryRef\@\@QEBA?AVHashedString\@\@F\@Z
     */
    MCAPI class HashedString getNameFromLegacyID(short) const; // NOLINT
    /**
     * @symbol
    ...
    getNameToItemMap() const; // NOLINT
    /**
     * @symbol ?getWorldBaseGameVersion\@ItemRegistryRef\@\@QEBA?AVBaseGameVersion\@\@XZ
     */
    MCAPI class BaseGameVersion getWorldBaseGameVersion() const; // NOLINT
    /**
     * @symbol ?init\@ItemRegistryRef\@\@QEBAXAEBVExperiments\@\@AEBVBaseGameVersion\@\@PEAVResourcePackManager\@\@\@Z
     */
    MCAPI void init(class Experiments const&, class BaseGameVersion const&, class ResourcePackManager*) const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI bool isComplexAlias(class HashedString const&) const; // NOLINT
    /**
     * @symbol ?isComponentBasedItemSchema\@ItemRegistryRef\@\@QEBA_NAEBVSemVersion\@\@AEBVValue\@Json\@\@\@Z
     */
    MCAPI bool isComponentBasedItemSchema(class SemVersion const&, class Json::Value const&) const; // NOLINT
    /**
     * @symbol ?isCreativeItem\@ItemRegistryRef\@\@QEBA_NAEBVItemInstance\@\@\@Z
     */
    MCAPI bool isCreativeItem(class ItemInstance const&) const; // NOLINT
    /**
     * @symbol ?isServerInitializingCreativeItems\@ItemRegistryRef\@\@QEBA_NXZ
     */
    MCAPI bool isServerInitializingCreativeItems() const; // NOLINT
    /**
     * @symbol ?lockItemWorldCompatibilityMutex\@ItemRegistryRef\@\@QEBA?AVLockGuard\@1\@XZ
     */
    MCAPI class ItemRegistryRef::LockGuard lockItemWorldCompatibilityMutex() const; // NOLINT
    /**
     ...
     */
    MCAPI class WeakPtr<class Item>
    lookupByName(int&, int&, class std::basic_string_view<char, struct std::char_traits<char>>) const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class WeakPtr<class Item> lookupByNameNoAlias(class HashedString const&) const; // NOLINT
    /**
    ...
    lookupByTag(struct ItemTag const&) const; // NOLINT
    /**
     * @symbol ?lookupByVanillaName\@ItemRegistryRef\@\@QEBA?AV?$WeakPtr\@VItem\@\@\@\@AEBVHashedString\@\@\@Z
     */
    MCAPI class WeakPtr<class Item> lookupByVanillaName(class HashedString const&) const; // NOLINT
    /**
     * @symbol ?registerAlias\@ItemRegistryRef\@\@QEBAXAEBVHashedString\@\@0AEBVBaseGameVersion\@\@\@Z
     */
    MCAPI void
    registerAlias(class HashedString const&, class HashedString const&, class BaseGameVersion const&) const; // NOLINT
    /**
     * @symbol
     * ?registerComplexAlias\@ItemRegistryRef\@\@QEBA?AV?$WeakPtr\@VItem\@\@\@\@AEBVHashedString\@\@AEBUComplexAlias\@ItemRegistry\@\@\@Z
     */
    MCAPI class WeakPtr<class Item>
    registerComplexAlias(class HashedString const&, struct ItemRegistry::ComplexAlias const&) const; // NOLINT
    /**
     * @symbol
     * ?registerExtraItemInitCallback\@ItemRegistryRef\@\@QEBAXV?$function\@$$A6AXVItemRegistryRef\@\@\@Z\@std\@\@\@Z
     */
    MCAPI void registerExtraItemInitCallback(class std::function<void(class ItemRegistryRef)>) const; // NOLINT
    /**
     * @symbol ?registerLegacyID\@ItemRegistryRef\@\@QEBAXAEBVHashedString\@\@F\@Z
     */
    MCAPI void registerLegacyID(class HashedString const&, short) const; // NOLINT
    /**
     ...
     */
    MCAPI unsigned __int64 remapToFullLegacyNameByHash(unsigned __int64) const; // NOLINT
    /**
     * @symbol ?remapToLegacyNameByHash\@ItemRegistryRef\@\@QEBA_K_K\@Z
     */
    MCAPI unsigned __int64 remapToLegacyNameByHash(unsigned __int64) const; // NOLINT
    /**
     * @symbol ?setCheckForItemWorldCompatibility\@ItemRegistryRef\@\@QEBAX_N\@Z
     */
    MCAPI void setCheckForItemWorldCompatibility(bool) const; // NOLINT
    /**
     * @symbol ?setOwningThreadId\@ItemRegistryRef\@\@QEBAXVid\@thread\@std\@\@\@Z
     */
    MCAPI void setOwningThreadId(class std::thread::id) const; // NOLINT
    /**
     * @symbol ?setServerInitializingCreativeItems\@ItemRegistryRef\@\@QEBAX_N\@Z
     */
    MCAPI void setServerInitializingCreativeItems(bool) const; // NOLINT
    /**
     * @symbol ?shouldCheckForItemWorldCompatibility\@ItemRegistryRef\@\@QEBA_NXZ
     */
    MCAPI bool shouldCheckForItemWorldCompatibility() const; // NOLINT
    /**
     * @symbol ?shutdown\@ItemRegistryRef\@\@QEBAXXZ
     */
    MCAPI void shutdown() const; // NOLINT
    /**
     * @symbol ?unregisterItem\@ItemRegistryRef\@\@QEBAXAEBVHashedString\@\@\@Z
     */
    MCAPI void unregisterItem(class HashedString const&) const; // NOLINT
    /**
     * @symbol
    ...
    validateServerItemComponents(std::vector<struct std::pair<std::string, class CompoundTag>> const&) const; // NOLINT
    /**
     * @symbol ??1ItemRegistryRef\@\@QEAA\@XZ
     */
    MCAPI ~ItemRegistryRef(); // NOLINT
    /**
     * @symbol ?isUsingCombinedItemRegistry\@ItemRegistryRef\@\@SA_NXZ
     */
    MCAPI static bool isUsingCombinedItemRegistry(); // NOLINT
    /**
     * @symbol ?setUseCombinedItemRegistryToggle\@ItemRegistryRef\@\@SAX_N\@Z
     */
    MCAPI static void setUseCombinedItemRegistryToggle(bool); // NOLINT

    // private:
    /**
     * @symbol ?_lockRegistry\@ItemRegistryRef\@\@AEBA?AV?$shared_ptr\@VItemRegistry\@\@\@std\@\@XZ
     */
    MCAPI class std::shared_ptr<class ItemRegistry> _lockRegistry() const; // NOLINT

private:
    /**
     * @symbol ?mCombinedItemRegistryInstance\@ItemRegistryRef\@\@0V?$shared_ptr\@VItemRegistry\@\@\@std\@\@A
     */
    MCAPI static class std::shared_ptr<class ItemRegistry> mCombinedItemRegistryInstance; // NOLINT
};
