...
public:
    ...
    // vIndex: 103, symbol: ?getIconInfo@RecordItem@@UEBA?AUResolvedItemIconInfo@@AEBVItemStackBase@@H_N@Z
    ...
    MCAPI RecordItem(std::string const& name, int, ::Puv::Legacy::LevelSoundEvent soundEvent);
