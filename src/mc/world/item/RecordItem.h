...
public:
     ...
     */
    virtual class RecordItem& setDescriptionId(std::string const&); // NOLINT
    /**
     * @vftbl 11
     * @symbol __unk_vfn_11
     */
    ...
    /**
     * @symbol
     * ??0RecordItem\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HW4LevelSoundEvent\@\@\@Z
     */
    MCAPI RecordItem(std::string const&, int, enum class LevelSoundEvent); // NOLINT
};
