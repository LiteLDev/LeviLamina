...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_ITEMSTACKBASE_COMPARISONOPTIONS
    public:
...
public:
     ...
     */
    MCAPI
    ItemStackBase(class std::basic_string_view<char, struct std::char_traits<char>>, int, int, class CompoundTag const*);
    /**
     ...
     */
    MCAPI bool _isInstance(class std::basic_string_view<char, struct std::char_traits<char>>) const;
    /**
