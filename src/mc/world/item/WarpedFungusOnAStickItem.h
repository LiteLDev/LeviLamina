...
public:
    ...
    // vIndex: 35, symbol: ?isHandEquipped@WarpedFungusOnAStickItem@@UEBA_NXZ
    ...
    // vIndex: 45, symbol: ?requiresInteract@WarpedFungusOnAStickItem@@UEBA_NXZ
    virtual bool requiresInteract() const;

    // vIndex: 48, symbol: ?getEnchantSlot@WarpedFungusOnAStickItem@@UEBAHXZ
    virtual int getEnchantSlot() const;

    // vIndex: 49, symbol: ?getEnchantValue@WarpedFungusOnAStickItem@@UEBAHXZ
    ...
    MCAPI WarpedFungusOnAStickItem(std::string const& name, int id);
