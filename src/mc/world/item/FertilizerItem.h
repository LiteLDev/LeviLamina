...
public:
     ...
     */
    MCVAPI ~FertilizerItem(); // NOLINT
#endif
    /**
     * @symbol
     * ??0FertilizerItem\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HW4FertilizerType\@\@\@Z
     */
    MCAPI FertilizerItem(std::string const&, int, enum class FertilizerType); // NOLINT
    /**
     * @symbol ?getFertilizerType\@FertilizerItem\@\@QEBA?AW4FertilizerType\@\@XZ
     */
    MCAPI enum class FertilizerType getFertilizerType() const; // NOLINT
};
