...
public:
     ...
     */
    MCAPI std::optional<class RecipeUnlockingRequirement> _createUnlockingRequirementFromContext(enum class RecipeUnlockingRequirement::UnlockingContext) const;
    /**
