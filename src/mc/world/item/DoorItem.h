...
public:
     ...
     */
    MCAPI DoorItem(std::string const&, int, enum class DoorBlock::DoorType); // NOLINT
    /**
     * @symbol ?place\@DoorItem\@\@SA_NPEAVBlockSource\@\@HHHHPEBVBlock\@\@\@Z
     */
    MCAPI static bool place(class BlockSource*, int, int, int, int, class Block const*); // NOLINT
};
