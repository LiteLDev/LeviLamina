...
public:
    ...
    // vIndex: 49, symbol: ?getEnchantSlot@ShearsItem@@UEBAHXZ
    virtual int getEnchantSlot() const;

    // vIndex: 72, symbol: ?dispense@ShearsItem@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z
    virtual bool
    dispense(class BlockSource& region, class Container& container, int slot, class Vec3 const& pos, uchar) const;

    // vIndex: 75, symbol: ?getDestroySpeed@ShearsItem@@UEBAMAEBVItemStackBase@@AEBVBlock@@@Z
    ...
    // private:
    // NOLINTBEGIN
    // symbol: ?_tryShearMooshroom@ShearsItem@@CA_NAEAVLevel@@AEAVBlockSource@@AEAVActor@@@Z
    MCAPI static bool _tryShearMooshroom(class Level& level, class BlockSource& region, class Actor& actor);

    // symbol: ?_tryShearSheep@ShearsItem@@CA_NAEAVLevel@@AEAVActor@@@Z
    MCAPI static bool _tryShearSheep(class Level& level, class Actor& actor);

    // symbol: ?_tryShearSnowGolem@ShearsItem@@CA_NAEAVLevel@@AEAVActor@@@Z
