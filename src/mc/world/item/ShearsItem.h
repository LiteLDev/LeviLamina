...
public:
     ...
     */
    MCAPI ShearsItem(std::string const&, int); // NOLINT
     ...
     */
    MCAPI static void _spawnLoot(class Level&, class Actor*, std::string const&); // NOLINT
    /**
     * @symbol ?_tryShearMooshroom\@ShearsItem\@\@CA_NAEAVLevel\@\@AEAVBlockSource\@\@PEAVActor\@\@\@Z
     */
    MCAPI static bool _tryShearMooshroom(class Level&, class BlockSource&, class Actor*); // NOLINT
    /**
     * @symbol ?_tryShearSheep\@ShearsItem\@\@CA_NAEAVLevel\@\@PEAVActor\@\@\@Z
     */
    MCAPI static bool _tryShearSheep(class Level&, class Actor*); // NOLINT
    /**
     * @symbol ?_tryShearSnowGolem\@ShearsItem\@\@CA_NAEAVLevel\@\@PEAVActor\@\@\@Z
     */
    MCAPI static bool _tryShearSnowGolem(class Level&, class Actor*); // NOLINT
