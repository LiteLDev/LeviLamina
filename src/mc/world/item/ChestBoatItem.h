...
public:
     ...
     */
    virtual enum class ActorType _getActorType() const; // NOLINT
    /**
     * @symbol
     * ??0ChestBoatItem\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HH\@Z
     */
    MCAPI ChestBoatItem(std::string const&, int, int); // NOLINT
};
