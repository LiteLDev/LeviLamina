...
public:
    ...
    MCVAPI bool hasCustomColor(class ItemStackBase const& instance) const;
    ...
    useOn(class ItemStack& itemStack, class Actor& entity, int x, int y, int z, uchar face, class Vec3 const& clickPos)
        const;
