...
public:
     ...
     */
    MCAPI LodestoneCompassItem(std::string const&, int); // NOLINT
    /**
     * @symbol ?linkCompassToLodestone\@LodestoneCompassItem\@\@SA_NAEAVItemStack\@\@AEAVBlockSource\@\@VBlockPos\@\@\@Z
     */
    MCAPI static bool linkCompassToLodestone(class ItemStack&, class BlockSource&, class BlockPos); // NOLINT
    ...
    _tryGetOrAddComponent(class PositionTrackingDB::TrackingRecord*, class std::variant<struct ActorUniqueID, struct std::pair<class BlockPos, class AutomaticID<class Dimension, int>>> const&); // NOLINT
