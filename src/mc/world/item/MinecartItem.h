...
public:
    ...
    // vIndex: 71, symbol: ?dispense@MinecartItem@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z
    virtual bool
    ...
    MCAPI MinecartItem(std::string const& name, int id, enum MinecartType type);
