...
public:
     ...
     */
    MCAPI ~CommandResponseBase(); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void _addCommand(std::string const&); // NOLINT
    /**
     * @symbol ?_executeAction\@CommandResponseBase\@\@IEBAXAEAVRenderParams\@\@\@Z
     */
    MCAPI void _executeAction(class RenderParams&) const; // NOLINT

    // private:
    /**
     * @symbol ?_compileCommands\@CommandResponseBase\@\@AEBAXAEAVLevel\@\@\@Z
     */
    MCAPI void _compileCommands(class Level&) const; // NOLINT
