...
public:
    ...
    virtual ::EventResult onScoreChanged(struct ScoreboardId const&, std::string const& objective, int score);
    ...
    MCAPI class SubscribedObjectives& getPlayerSubscriptions(struct ScoreboardId const&, class Player const& player);
