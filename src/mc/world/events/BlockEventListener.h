...
public:
     ...
     */
    MCVAPI enum class EventResult onBlockDestructionStopped(class Player&, class BlockPos const&, int); // NOLINT
    /**
     * @symbol
     ...
     */
    MCVAPI enum class EventResult onBlockInPosWillBeDestroyedByPlayer(class Player&, class BlockPos const&); // NOLINT
    /**
     ...
     */
    MCVAPI enum class EventResult
    onBlockModified(class BlockPos const&, class Block const&, class Block const&); // NOLINT
    /**
     * @symbol ?onBlockMovedByPiston\@BlockEventListener\@\@UEAA?AW4EventResult\@\@AEBVBlockPos\@\@0W4PistonState\@\@\@Z
     */
    MCVAPI enum class EventResult
    onBlockMovedByPiston(class BlockPos const&, class BlockPos const&, enum class PistonState); // NOLINT
    /**
     * @symbol
     ...
     */
    MCVAPI enum class EventResult onEvent(struct BlockNotificationEvent const&); // NOLINT
    /**
     * @symbol ?onUnknownBlockReceived\@BlockEventListener\@\@UEAA?AW4EventResult\@\@AEAVLevel\@\@AEBUNewBlockID\@\@G\@Z
     */
    MCVAPI enum class EventResult
    onUnknownBlockReceived(class Level&, struct NewBlockID const&, unsigned short); // NOLINT
#endif
};
