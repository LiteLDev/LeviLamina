...
public:
     ...
     */
    MCAPI void
    post(class BlockSource&, class Actor*, class GameEvent const&, class Vec3 const&, class Block const*); // NOLINT
    /**
     * @symbol
     * ?post\@GameEventDispatcher\@\@QEAAXAEAVBlockSource\@\@PEAVActor\@\@AEBVGameEvent\@\@AEBVBlockPos\@\@PEBVBlock\@\@\@Z
     */
    MCAPI void
    post(class BlockSource&, class Actor*, class GameEvent const&, class BlockPos const&, class Block const*); // NOLINT
};
