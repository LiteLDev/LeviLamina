...
public:
    ...
    MCAPI void
    post(class BlockSource& region, class Actor* source, class GameEvent const&, class BlockPos const&, class Block const*);

    // symbol: ?post@GameEventDispatcher@@QEAAXAEAVBlockSource@@PEAVActor@@AEBVGameEvent@@AEBVVec3@@PEBVBlock@@@Z
    MCAPI void
    post(class BlockSource& region, class Actor* source, class GameEvent const&, class Vec3 const&, class Block const*);
