...
public:
    ...
    // vIndex: 5, symbol: ?createScoreboardId@Scoreboard@@UEAAAEBUScoreboardId@@AEBVPlayer@@@Z
    ...
    MCAPI void addScoreListener(class Player& player, std::string const& objective);
