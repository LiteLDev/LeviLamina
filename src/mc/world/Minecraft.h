...
public:
     ...
     */
    MCAPI bool
    hostMultiplayer(std::string const&, std::pair<std::unique_ptr<class Level>, class OwnerPtrT<struct EntityRefTraits>>, class Player*, class mce::UUID const&, std::unique_ptr<class NetEventCallback>, int32_t, bool, bool, std::vector<std::string> const&, std::string, struct ConnectionDefinition const&, std::unordered_map<struct PackIdVersion, std::string> const&, class Scheduler&, class TextFilteringProcessor*, struct NetworkPermissions const&);
    /**
