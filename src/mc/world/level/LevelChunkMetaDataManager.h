...
public:
     ...
     */
    MCAPI static void
    inferInitialMetaDataAfterDeserialization(class LevelChunk&, class LevelSeed64, enum class GeneratorType, std::string const&, DimensionType, class DimensionHeightRange const&, class BaseGameVersion const&, class LevelChunkMetaData&);
    /**
     * @symbol
    ...
    initializeLevelChunkMetaData(DimensionType, std::string const&, class DimensionHeightRange const&, bool, class LevelSeed64, enum class GeneratorType, class BaseGameVersion const&);
    // NOLINTEND
