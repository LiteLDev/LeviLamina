...
public:
    ...
    // vIndex: 2, symbol: ?getBiomeArea@BiomeSource3d@@UEBA?AVBiomeArea@@AEBVBoundingBox@@IAEBUGetBiomeOptions@@@Z
    virtual class BiomeArea getBiomeArea(class BoundingBox const& box, uint scale, struct GetBiomeOptions const&) const;

    // vIndex: 3, symbol: ?getBiomeArea@BiomeSource3d@@UEBA?AVBiomeArea@@AEBVBoundingBox@@I@Z
    ...
    // vIndex: 5, symbol: ?getBiome@BiomeSource3d@@UEBAPEBVBiome@@HHH@Z
    ...
    // vIndex: 7, symbol: ?getBiome@BiomeSource3d@@UEBAPEBVBiome@@AEBVBlockPos@@@Z
