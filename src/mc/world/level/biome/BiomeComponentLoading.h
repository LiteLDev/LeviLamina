 ...
 */
MCAPI void
_read(std::string const&, class CompoundTag const&, std::vector<struct std::pair<class Biome*, unsigned int>>&, class IWorldRegistriesProvider&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void
_write(std::string const&, class CompoundTag&, std::vector<struct std::pair<class Biome*, unsigned int>> const&); // NOLINT
