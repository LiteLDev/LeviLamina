...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_MAPITEMSAVEDDATA_CHUNKBOUNDS
    public:
...
public:
     ...
     */
    MCAPI class std::shared_ptr<class MapItemTrackedActor>
    addTrackedMapEntity(class Actor&, enum class MapDecoration::Type);
    /**
     ...
     */
    MCAPI void
    _addDecoration(enum class MapDecoration::Type, class Level&, struct MapItemTrackedActor::UniqueId const&, class Vec3 const&, std::string const&, class mce::Color const&);
    /**
     * @symbol
