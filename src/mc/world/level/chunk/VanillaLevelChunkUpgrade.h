 ...
 */
MCAPI bool _updateBelowZero(class LevelChunk&, class LevelChunk&, class BlockSource&); // NOLINT
/**
 * @symbol ?_upgradeLevelChunkLegacy\@VanillaLevelChunkUpgrade\@\@YAXAEAVLevelChunk\@\@AEAVBlockSource\@\@\@Z
 */
MCAPI void _upgradeLevelChunkLegacy(class LevelChunk&, class BlockSource&); // NOLINT
/**
 * @symbol ?_upgradeLevelChunkViaMetaData\@VanillaLevelChunkUpgrade\@\@YAXAEAVLevelChunk\@\@0AEAVBlockSource\@\@\@Z
 */
MCAPI void _upgradeLevelChunkViaMetaData(class LevelChunk&, class LevelChunk&, class BlockSource&); // NOLINT
/**
 * @symbol ?addBiomeSpecificVillageSkins\@VanillaLevelChunkUpgrade\@\@YA_NAEAVCompoundTag\@\@AEAVBlockSource\@\@\@Z
 */
MCAPI bool addBiomeSpecificVillageSkins(class CompoundTag&, class BlockSource&); // NOLINT
/**
 * @symbol ?convertOcelotTagToCat\@VanillaLevelChunkUpgrade\@\@YA_NAEAVCompoundTag\@\@\@Z
 */
MCAPI bool convertOcelotTagToCat(class CompoundTag&); // NOLINT
/**
 * @symbol ?convertVillagerV1TagToV2\@VanillaLevelChunkUpgrade\@\@YA_NAEAVCompoundTag\@\@\@Z
 */
MCAPI bool convertVillagerV1TagToV2(class CompoundTag&); // NOLINT
/**
 * @symbol ?convertVillagerV2TagToV1\@VanillaLevelChunkUpgrade\@\@YA_NAEAVCompoundTag\@\@\@Z
 */
MCAPI bool convertVillagerV2TagToV1(class CompoundTag&); // NOLINT
/**
 * @symbol ?convertZombieVillagerV1TagToV2\@VanillaLevelChunkUpgrade\@\@YA_NAEAVCompoundTag\@\@\@Z
 */
MCAPI bool convertZombieVillagerV1TagToV2(class CompoundTag&); // NOLINT
/**
 * @symbol ?convertZombieVillagerV2TagToV1\@VanillaLevelChunkUpgrade\@\@YA_NAEAVCompoundTag\@\@\@Z
 */
MCAPI bool convertZombieVillagerV2TagToV1(class CompoundTag&); // NOLINT
/**
 * @symbol ?fillNegativeSubChunksWithAir\@VanillaLevelChunkUpgrade\@\@YAXAEAVLevelChunk\@\@AEAVBlockSource\@\@\@Z
 */
MCAPI void fillNegativeSubChunksWithAir(class LevelChunk&, class BlockSource&); // NOLINT
/**
 * @symbol ?fillNegativeSubChunksWithGeneration\@VanillaLevelChunkUpgrade\@\@YAXAEAVLevelChunk\@\@0\@Z
 */
MCAPI void fillNegativeSubChunksWithGeneration(class LevelChunk&, class LevelChunk&); // NOLINT
/**
 * @symbol
 * ?fillNegativeSubChunksWithGenerationOrAir\@VanillaLevelChunkUpgrade\@\@YAXAEAVLevelChunk\@\@0AEAVBlockSource\@\@\@Z
 */
MCAPI void fillNegativeSubChunksWithGenerationOrAir(class LevelChunk&, class LevelChunk&, class BlockSource&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void fixStemBlockStates(class BlockSource&, class BlockPos, class Block const&); // NOLINT
/**
 * @symbol ?fixUselessDynamicWater\@VanillaLevelChunkUpgrade\@\@YAXAEAVLevelChunk\@\@AEAVBlockSource\@\@\@Z
 */
MCAPI void fixUselessDynamicWater(class LevelChunk&, class BlockSource&); // NOLINT
/**
 * @symbol ?fixWallBlockStates\@VanillaLevelChunkUpgrade\@\@YAXAEAVBlockSource\@\@VBlockPos\@\@\@Z
 */
MCAPI void fixWallBlockStates(class BlockSource&, class BlockPos); // NOLINT
/**
 * @symbol ?fixWallChunk\@VanillaLevelChunkUpgrade\@\@YAXAEAVLevelChunk\@\@AEAVBlockSource\@\@\@Z
 */
MCAPI void fixWallChunk(class LevelChunk&, class BlockSource&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI std::string const& getV1CareerFromDefinitionsList(class ListTag const*); // NOLINT
/**
 * @symbol ?isWallBlock\@VanillaLevelChunkUpgrade\@\@YA_NAEBVBlock\@\@\@Z
 */
MCAPI bool isWallBlock(class Block const&); // NOLINT
/**
 * @symbol ?levelChunkNeedsUpgrade\@VanillaLevelChunkUpgrade\@\@YA_NAEBVLevelChunk\@\@\@Z
 */
MCAPI bool levelChunkNeedsUpgrade(class LevelChunk const&); // NOLINT
/**
 * @symbol ?upgradeArmorStandComponents\@VanillaLevelChunkUpgrade\@\@YA_NAEAVCompoundTag\@\@\@Z
 */
MCAPI bool upgradeArmorStandComponents(class CompoundTag&); // NOLINT
/**
 * @symbol ?upgradeOldLimboEntity\@VanillaLevelChunkUpgrade\@\@YAXAEAVCompoundTag\@\@W4LimboEntitiesVersion\@\@_N\@Z
 */
MCAPI void upgradeOldLimboEntity(class CompoundTag&, enum class LimboEntitiesVersion, bool); // NOLINT
