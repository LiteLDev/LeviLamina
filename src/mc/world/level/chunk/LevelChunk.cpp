...
// ) const {
//     using HeightMapDataType = SubChunkPacketPayload::HeightMapDataType;
//     using HeightmapData     = SubChunkPacketPayload::HeightmapData;
...
//             if (!heightMapData.mSubchunkHeightMap->has_value()) {
//                 heightMapData.mSubchunkHeightMap = {};
//             }
//             heightMapData.mSubchunkHeightMap->value()[x][z] = static_cast<schar>(regularHeight);
//             if (!heightMapData.mSubchunkRenderHeightMap->has_value()) {
//                 heightMapData.mSubchunkRenderHeightMap = {};
//             }
//             heightMapData.mSubchunkRenderHeightMap->value()[x][z] = static_cast<schar>(renderHeight);
//         }
//     }
