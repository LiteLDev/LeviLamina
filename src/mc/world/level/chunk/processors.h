...
MCAPI ::br::worldgen::processors::BlockRules::Test BlockStateMatch(::Block const& block);

MCAPI ::br::worldgen::processors::BlockRules::Test RandomBlockMatch(::Block const& block, float probability);

MCAPI ::br::worldgen::processors::BlockRules::Test RandomBlockStateMatch(::Block const& block, float probability);
