...
_readLevelDataFromFile(class Core::Path const&, std::string const&, class LevelData&); // NOLINT
/**
 * @symbol ?_writeLevelDat\@ExternalFileLevelStorage\@\@YA_NAEBVPath\@Core\@\@AEBVLevelData\@\@\@Z
 */
MCAPI bool _writeLevelDat(class Core::Path const&, class LevelData const&); // NOLINT
/**
 * @symbol
...
getAccessStrategy(class Core::Path const&, class ContentIdentity const&, class gsl::not_null<class Bedrock::NonOwnerPointer<class IContentKeyProvider const>> const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI std::vector<std::string> const getImportantFiles(); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI std::string getLevelIDFromPath(class Core::Path const&, class Core::Path const&); // NOLINT
/**
 * @symbol ?isLevelMarkedForSync\@ExternalFileLevelStorage\@\@YA_NAEBVPath\@Core\@\@\@Z
 */
MCAPI bool isLevelMarkedForSync(class Core::Path const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void makeReadableLevelnameFile(class Core::Path const&, std::string const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI class Core::Result readLevelDataFromData(std::string const&, class LevelData&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI class Core::Result readLevelDataFromFile(class Core::Path const&, std::string const&, class LevelData&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI bool
readShallowLevelSummaryFromSyncFile(class Core::Path const&, std::string const&, struct LevelSummary&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI bool readSyncFileData(class Core::Path const&, std::string&, __int64&, __int64&, bool&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void saveLevelData(class Core::Path const&, std::string const&, class LevelData const&, bool); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void saveLevelDataToPath(class Core::Path const&, std::string const&, class LevelData const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void
saveLevelDisplayDataToCache(std::string const&, class LevelData const&, class gsl::not_null<class TaskGroup*>); // NOLINT
/**
 * @symbol ?validateLevelDat\@ExternalFileLevelStorage\@\@YA?AVResult\@Core\@\@VPath\@3\@\@Z
 */
MCAPI class Core::Result validateLevelDat(class Core::Path); // NOLINT
