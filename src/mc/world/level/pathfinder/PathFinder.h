...
public:
     ...
     */
    MCAPI bool
    _checkBlockAndNeighborsProperty(struct ActorPathingData const&, class BlockPos const&, class Block const&, enum class BlockProperty, int, class BreakBlocksComponent const*, class std::function<bool(class Block const&, class BlockPos const&)>);
    /**
     * @symbol
    ...
    _classifyDoorNode(struct ActorPathingData const&, class Block const&, class BlockPos const&, class BlockPos const&);
    /**
     * @symbol
    ...
    _getPartialBlockNodeType(class BlockPos const&, class BlockPos const&, struct ActorPathingData const&);
    /**
    ...
    _getWaterNode(struct ActorPathingData const&, class BlockPos const&, class BlockPos const&);
    /**
     * @symbol
     * ?_isFreeStartNode\@PathFinder\@\@AEAA?AW4NodeType\@\@AEBUActorPathingData\@\@AEBVAABB\@\@AEBVBlockPos\@\@2\@Z
     */
    MCAPI enum class NodeType
    _isFreeStartNode(struct ActorPathingData const&, class AABB const&, class BlockPos const&, class BlockPos const&);
    /**
     * @symbol ?_isFreeWaterNode\@PathFinder\@\@AEAA?AW4NodeType\@\@AEBUActorPathingData\@\@AEBVBlockPos\@\@1\@Z
     */
    MCAPI enum class NodeType
    _isFreeWaterNode(struct ActorPathingData const&, class BlockPos const&, class BlockPos const&);
    /**
     * @symbol
    ...
    MCAPI std::unique_ptr<class Path>
          _reconstructPath(class PathfinderNode*, enum class PathCompletionType, struct ActorUniqueID);
