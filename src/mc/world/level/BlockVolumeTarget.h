...
public:
    ...
    virtual bool mayPlacePlacementFilterComponent(::BlockPos const&, ::Block const&) const /*override*/;
...
public:
    ...
    MCFOLD bool $mayPlacePlacementFilterComponent(::BlockPos const&, ::Block const&) const;
