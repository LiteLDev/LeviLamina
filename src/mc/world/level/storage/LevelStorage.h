...
public:
     ...
     */
    virtual bool hasKey(std::string_view, enum class DBHelpers::Category) const = 0;
    /**
     * @vftbl 4
     * @symbol
     ...
     */
    virtual void
    forEachKeyWithPrefix(std::string_view, enum class DBHelpers::Category, std::function<void(std::string_view, std::string_view)> const&)
        const = 0;
    /**
     * @vftbl 5
     ...
     */
    virtual bool loadData(std::string_view, std::string&, enum class DBHelpers::Category) const;
    /**
     * @vftbl 19
     * @symbol __unk_vfn_19
     */
     ...
     */
    virtual void setCompactionCallback(std::function<void(enum class CompactionStatus)>) = 0;
    /**
     * @vftbl 29
