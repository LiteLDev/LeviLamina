...
public:
     ...
     */
    virtual void
    forEachKeyWithPrefix(class std::basic_string_view<char, struct std::char_traits<char>>, enum class DBHelpers::Category, class std::function<void(class std::basic_string_view<char, struct std::char_traits<char>>, class std::basic_string_view<char, struct std::char_traits<char>>)> const&) const = 0;
    /**
     * @vftbl 5
    ...
    virtual std::unique_ptr<class ChunkSource>
        createChunkStorage(std::unique_ptr<class ChunkSource>, enum class StorageVersion) = 0;
    /**
     * @vftbl 7
    ...
    saveData(std::string const&, std::string&&, enum class DBHelpers::Category) = 0;
    /**
     * @vftbl 10
     * @symbol
     ...
     */
    virtual class std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>>
    deleteData(std::string const&, enum class DBHelpers::Category) = 0;
    /**
     * @vftbl 12
     * @symbol
     ...
     */
    virtual bool
        clonePlayerData(class std::basic_string_view<char, struct std::char_traits<char>>, class std::basic_string_view<char, struct std::char_traits<char>>);
    /**
     * @vftbl 14
     * @symbol __unk_vfn_14
     */
    ...
    MCAPI std::unique_ptr<class CompoundTag>
          loadPlayerDataFromTag(class std::basic_string_view<char, struct std::char_traits<char>>);
    /**
     * @symbol
    ...
    saveData(std::string const&, class CompoundTag const&, enum class DBHelpers::Category);
    /**
     * @symbol
