...
public:
     ...
     */
    virtual class LevelData getLevelData(std::string const&) const; // NOLINT
    /**
     * @vftbl 3
     * @symbol
     ...
     */
    virtual class Core::Result getLevelData(std::string const&, class LevelData&) const; // NOLINT
    /**
     * @vftbl 4
     * @symbol
     ...
     */
    virtual void saveLevelData(std::string const&, class LevelData const&); // NOLINT
    /**
     * @vftbl 5
     * @symbol
     ...
     */
    virtual void getLevelList(std::vector<class Core::PathBuffer<std::string>>&); // NOLINT
    /**
     * @vftbl 6
     * @symbol
     ...
     */
    virtual void renameLevel(class LevelData&, class Core::Path const&, std::string const&); // NOLINT
    /**
     * @vftbl 12
     * @symbol
     ...
     */
    virtual bool createBackupCopyOfWorld(std::string const&, std::string const&, std::string const&); // NOLINT
    /**
     * @vftbl 13
     * @symbol __unk_vfn_13
     */
     ...
     */
    virtual bool isLevelMarkedForSync(class Core::Path const&) const; // NOLINT
    /**
     * @vftbl 17
     * @symbol ?isLevelPartiallyCopied\@ExternalFileLevelStorageSource\@\@UEBA_NAEBVPath\@Core\@\@\@Z
     */
    virtual bool isLevelPartiallyCopied(class Core::Path const&) const; // NOLINT
    /**
     * @vftbl 18
     * @symbol
     ...
     */
    virtual class Core::PathBuffer<std::string> getLevelDatFoundPath(class Core::Path const&) const; // NOLINT
    /**
     * @vftbl 19
     * @symbol
     ...
     */
    virtual class Core::PathBuffer<std::string> const getBasePath() const; // NOLINT
    /**
     * @vftbl 20
     * @symbol
     ...
     */
    virtual class Core::PathBuffer<std::string> const getPathToLevel(std::string const&) const; // NOLINT
    /**
     * @vftbl 21
     * @symbol
     ...
     */
    virtual class Core::PathBuffer<std::string> const getPathToLevelInfo(std::string const&, bool) const; // NOLINT
     ...
     */
    MCAPI
    ExternalFileLevelStorageSource(class gsl::not_null<class Bedrock::NonOwnerPointer<class Core::FilePathManager>> const&, class gsl::not_null<class Bedrock::NonOwnerPointer<class SaveTransactionManager>> const&); // NOLINT
};
