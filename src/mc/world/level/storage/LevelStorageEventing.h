...
public:
     ...
     */
    MCAPI LevelStorageEventing(std::string const&, class LevelData const&, std::string const&); // NOLINT
    /**
     * @symbol ?fireDBStorageError\@LevelStorageEventing\@\@QEAAXPEBD\@Z
     */
    MCAPI void fireDBStorageError(char const*); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void fireEventWorldCorruptionCausedWorldShutdown(std::string const&, class std::optional<bool>); // NOLINT
};
