...
calculateHeight(class BlendingData&, std::vector<struct BlendingDataFactoryUtil::BorderCellEntry>&, class ChunkLocalHeight, class std::function<struct SubChunk&(int)>);
/**
 ...
 */
MCAPI void
iterateDownCellColumnUntil(class ChunkLocalHeight, std::vector<struct BlendingDataFactoryUtil::BorderCellEntry>&, int, class std::function<struct SubChunk&(int)>, class std::function<bool(struct SubChunk const&, struct BlendingDataFactoryUtil::BorderCellEntry&, class ChunkLocalHeight, unsigned short, int)>);
/**
 * @symbol
 * ?processBorderCells\@BlendingDataFactoryUtil\@\@YAXVNeighbors\@LevelChunk\@\@V?$function\@$$A6AX_KHH0\@Z\@std\@\@\@Z
 */
MCAPI void
    processBorderCells(class LevelChunk::Neighbors, class std::function<void(unsigned __int64, int, int, unsigned __int64)>);
/**
