...
public:
    // NOLINTBEGIN
    // vIndex: 0, symbol: __gen_??1ExplorationMapFunction@@UEAA@XZ
    virtual ~ExplorationMapFunction() = default;

    // vIndex: 2, symbol: ?apply@ExplorationMapFunction@@UEAAXAEAVItemInstance@@AEAVRandom@@AEAVLootTableContext@@@Z
    virtual void apply(class ItemInstance& item, class Random& random, class LootTableContext& context);

    // vIndex: 4, symbol: ?apply@ExplorationMapFunction@@UEAAXAEAVItemStack@@AEAVRandom@@AEAVLootTableContext@@@Z
