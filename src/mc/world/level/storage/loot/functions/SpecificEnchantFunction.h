...
public:
    ...
    /**
     * @symbol
     * ?_applyInner\@SpecificEnchantFunction\@\@AEAAXAEAVItemStackBase\@\@AEAVRandom\@\@AEAVLootTableContext\@\@_N\@Z
     */
    MCAPI void _applyInner(class ItemStackBase&, class Random&, class LootTableContext&, bool); // NOLINT
