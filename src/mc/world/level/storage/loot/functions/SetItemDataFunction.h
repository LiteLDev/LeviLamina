...
public:
    ...
    _applyImplForComplexAliasBlock(class Item const*&, std::string const&, class Random&, int&); // NOLINT
    /**
     * @symbol
    ...
    _applyImplForItem(std::string const&, std::string const&, class Random&, int&, class WeakPtr<class Item>&); // NOLINT
    /**
     * @symbol ?_applyImplForNormalBlock\@SetItemDataFunction\@\@AEAAXAEAPEBVBlock\@\@AEAVRandom\@\@\@Z
     */
    MCAPI void _applyImplForNormalBlock(class Block const*&, class Random&); // NOLINT
