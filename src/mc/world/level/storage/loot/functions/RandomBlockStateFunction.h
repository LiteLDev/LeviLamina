...
public:
    // RandomBlockStateFunction inner types declare
    // clang-format off
...
public:
    ...
    _remapComplexAliasBlock(int, class Block const*&, std::string const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI enum class RandomBlockStateFunction::RemapComplexAliasBlockResult
    _tryRemapComplexAliasBlock(class ItemStack&, int, class Block const*&, std::string const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI enum class RandomBlockStateFunction::RemapComplexAliasBlockResult
    _tryRemapComplexAliasBlock(class ItemInstance&, int, class Block const*&, std::string const&); // NOLINT
