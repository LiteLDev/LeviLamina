...
public:
    ...
    MCAPI void $spawnMobsForChunkGeneration(::BlockSource&, ::Biome const&, ::ChunkPos, ::IRandom&) const;

    MCAPI ::br::spawn::SpawnPlacements& $getSpawnPlacements();

    MCAPI void $initializeServerSide(::ResourcePackManager&, ::IWorldRegistriesProvider&);

    MCAPI ::SpawnSettings const& $getSpawnSettings() const;

    MCAPI void $setSpawnSettings(::SpawnSettings const&);
    ...
    MCAPI void $postProcessSpawnMobs(::BlockSource&, int, int, ::Random&);

    MCAPI void $tick(::BlockSource&, ::LevelChunkVolumeData const&, ::ChunkPos const);
    ...
    MCAPI ::std::unordered_set<::ActorUniqueID>
    $spawnMobGroup(::BlockSource&, ::std::string const&, ::Vec3 const&, bool, bool, ::std::function<void(::Mob&)>&&);
