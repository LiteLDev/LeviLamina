...
public:
     ...
     */
    MCAPI TickingAreasManager(); // NOLINT
    /**
     * @symbol
    ...
    addArea(class AutomaticID<class Dimension, int>, std::string const&, class BlockPos const&, int, enum class TickingAreasManager::AreaLimitCheck, bool, enum class TickingAreaLoadMode, class LevelStorage&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI enum class AddTickingAreaStatus
    addArea(class AutomaticID<class Dimension, int>, std::string const&, class BlockPos const&, class BlockPos const&, enum class TickingAreasManager::AreaLimitCheck, bool, enum class TickingAreaLoadMode, class LevelStorage&); // NOLINT
    /**
     * @symbol
     * ?addEntityArea\@TickingAreasManager\@\@QEAAXV?$AutomaticID\@VDimension\@\@H\@\@AEBVActor\@\@AEAVLevelStorage\@\@\@Z
     */
    MCAPI void
    addEntityArea(class AutomaticID<class Dimension, int>, class Actor const&, class LevelStorage&); // NOLINT
    /**
     * @symbol
     * ?addEntityArea\@TickingAreasManager\@\@QEAAXV?$AutomaticID\@VDimension\@\@H\@\@AEBUActorUniqueID\@\@AEBUBounds\@\@_NMAEAVLevelStorage\@\@\@Z
     */
    MCAPI void
    addEntityArea(class AutomaticID<class Dimension, int>, struct ActorUniqueID const&, struct Bounds const&, bool, float, class LevelStorage&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    addTickingAreaListForDimension(class AutomaticID<class Dimension, int>, class std::shared_ptr<class TickingAreaList> const&); // NOLINT
    /**
     * @symbol ?countActiveStandaloneTickingAreas\@TickingAreasManager\@\@QEBAIXZ
     */
    MCAPI unsigned int countActiveStandaloneTickingAreas() const; // NOLINT
    /**
     * @symbol ?countStandaloneTickingAreas\@TickingAreasManager\@\@QEBAIXZ
     */
    MCAPI unsigned int countStandaloneTickingAreas() const; // NOLINT
    /**
     * @symbol
    ...
    MCAPI std::vector<struct TickingAreaDescription>
          getPendingStandaloneAreaDescriptions(class AutomaticID<class Dimension, int>) const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
          getPendingStandaloneAreaDescriptionsByName(class AutomaticID<class Dimension, int>, std::string const&)
        const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
          getPendingStandaloneAreaDescriptionsByPosition(class AutomaticID<class Dimension, int>, class BlockPos const&)
        const; // NOLINT
    /**
     * @symbol ?hasActiveAreas\@TickingAreasManager\@\@QEBA_NXZ
     */
    MCAPI bool hasActiveAreas() const; // NOLINT
    /**
     * @symbol ?isPreloadDone\@TickingAreasManager\@\@QEBA_NXZ
     */
    MCAPI bool isPreloadDone() const; // NOLINT
    /**
     * @symbol
     * ?loadArea\@TickingAreasManager\@\@QEAAXAEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@PEBVCompoundTag\@\@\@Z
     */
    MCAPI void loadArea(std::string const&, class CompoundTag const*); // NOLINT
    /**
     * @symbol ?loadAreasFromSaveData\@TickingAreasManager\@\@QEAAXAEAVLevelStorage\@\@\@Z
     */
    MCAPI void loadAreasFromSaveData(class LevelStorage&); // NOLINT
    /**
     * @symbol
     * ?onTickingEntityAdded\@TickingAreasManager\@\@QEAAXV?$AutomaticID\@VDimension\@\@H\@\@AEAVActor\@\@AEAVLevelStorage\@\@\@Z
     */
    MCAPI void
    onTickingEntityAdded(class AutomaticID<class Dimension, int>, class Actor&, class LevelStorage&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
    removePendingAreaByName(class AutomaticID<class Dimension, int>, std::string const&, class LevelStorage&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
    removePendingAreaByPosition(class AutomaticID<class Dimension, int>, class BlockPos const&, class LevelStorage&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
    setPendingAreaLoadModeByName(class AutomaticID<class Dimension, int>, std::string const&, enum class TickingAreaLoadMode, class LevelStorage&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
    setPendingAreaLoadModeByPosition(class AutomaticID<class Dimension, int>, class BlockPos const&, enum class TickingAreaLoadMode, class LevelStorage&); // NOLINT
    /**
     ...
     */
    MCAPI void update(class Level&, class LevelStorage&); // NOLINT
    /**
     * @symbol ?getLimitCheck\@TickingAreasManager\@\@SA?AW4AreaLimitCheck\@1\@AEBVLevel\@\@_N\@Z
     */
    MCAPI static enum class TickingAreasManager::AreaLimitCheck getLimitCheck(class Level const&, bool); // NOLINT
     ...
     */
    MCAPI enum class AddTickingAreaStatus
    _addArea(class AutomaticID<class Dimension, int>, std::string const&, struct Bounds const&, bool, enum class TickingAreasManager::AreaLimitCheck, bool, enum class TickingAreaLoadMode, class LevelStorage&); // NOLINT
    /**
     * @symbol ?_deletePendingArea\@TickingAreasManager\@\@AEAAXAEAVLevelStorage\@\@AEBUPendingArea\@\@\@Z
     */
    MCAPI void _deletePendingArea(class LevelStorage&, struct PendingArea const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI std::string
          _findUsableDefaultName(class TickingAreaList const&, std::vector<struct PendingArea> const&) const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
        _getPendingAreaDescriptionsFiltered(class AutomaticID<class Dimension, int>, class std::function<bool(struct PendingArea const&)>)
            const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI bool _hasPendingTickingAreaNamed(std::string const&, std::vector<struct PendingArea> const&) const; // NOLINT
    /**
     * @symbol ?_processAdds\@TickingAreasManager\@\@AEAAXAEAVLevel\@\@\@Z
     */
    MCAPI void _processAdds(class Level&); // NOLINT
    /**
     * @symbol
     * ?_processRemoves\@TickingAreasManager\@\@AEAAXV?$AutomaticID\@VDimension\@\@H\@\@AEAVTickingAreaList\@\@AEAVLevel\@\@AEAVLevelStorage\@\@\@Z
     */
    MCAPI void
    _processRemoves(class AutomaticID<class Dimension, int>, class TickingAreaList&, class Level&, class LevelStorage&); // NOLINT
    /**
     * @symbol
     * ?_savePendingArea\@TickingAreasManager\@\@AEAAXAEAVLevelStorage\@\@V?$AutomaticID\@VDimension\@\@H\@\@AEBUPendingArea\@\@\@Z
     */
    MCAPI void
    _savePendingArea(class LevelStorage&, class AutomaticID<class Dimension, int>, struct PendingArea const&); // NOLINT
