...
public:
    ...
    addArea(DimensionType, std::string const&, class BlockPos const&, class BlockPos const&, enum class TickingAreasManager::AreaLimitCheck, bool, enum class TickingAreaLoadMode, class LevelStorage&);
    /**
     * @symbol
     ...
     */
    MCAPI enum class AddTickingAreaStatus
    addArea(DimensionType, std::string const&, class BlockPos const&, int32_t, enum class TickingAreasManager::AreaLimitCheck, bool, enum class TickingAreaLoadMode, class LevelStorage&);
    /**
     * @symbol
     * ?addEntityArea\@TickingAreasManager\@\@QEAAXV?$AutomaticID\@VDimension\@\@H\@\@AEBUActorUniqueID\@\@AEBUBounds\@\@_NMAEAVLevelStorage\@\@\@Z
     */
    MCAPI void
    addEntityArea(DimensionType, struct ActorUniqueID const&, struct Bounds const&, bool, float, class LevelStorage&);
    /**
     * @symbol
    ...
    MCAPI std::vector<struct TickingAreaDescription>
          getPendingStandaloneAreaDescriptionsByName(DimensionType, std::string const&) const;
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
          getPendingStandaloneAreaDescriptionsByPosition(DimensionType, class BlockPos const&) const;
    /**
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
          removePendingAreaByName(DimensionType, std::string const&, class LevelStorage&);
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
          removePendingAreaByPosition(DimensionType, class BlockPos const&, class LevelStorage&);
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
    setPendingAreaLoadModeByName(DimensionType, std::string const&, enum class TickingAreaLoadMode, class LevelStorage&);
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
    setPendingAreaLoadModeByPosition(DimensionType, class BlockPos const&, enum class TickingAreaLoadMode, class LevelStorage&);
    /**
     ...
     */
    MCAPI enum class AddTickingAreaStatus
    _addArea(DimensionType, std::string const&, struct Bounds const&, bool, enum class TickingAreasManager::AreaLimitCheck, bool, enum class TickingAreaLoadMode, class LevelStorage&);
    /**
     ...
     */
    MCAPI std::vector<struct TickingAreaDescription>
          _getPendingAreaDescriptionsFiltered(DimensionType, std::function<bool(struct PendingArea const&)>) const;
    /**
     * @symbol
