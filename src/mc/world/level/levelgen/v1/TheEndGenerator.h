...
public:
     ...
     */
    MCAPI
    TheEndGenerator(class Dimension&, unsigned int, class Biome const*, std::unique_ptr<class StructureFeatureRegistry>); // NOLINT
    /**
     * @symbol ?buildSurfaces\@TheEndGenerator\@\@QEAAXAEAVBlockVolume\@\@AEBVChunkPos\@\@AEAVLevelChunk\@\@\@Z
     */
    MCAPI void buildSurfaces(class BlockVolume&, class ChunkPos const&, class LevelChunk&); // NOLINT
    /**
     * @symbol
     * ?generateDensityCellsForChunk\@TheEndGenerator\@\@QEBA?AV?$MultidimensionalArray\@M$02$02$0CB\@\@Util\@\@AEBVChunkPos\@\@\@Z
     */
    MCAPI class Util::MultidimensionalArray<float, 3, 3, 33>
     ...
     */
    MCAPI static bool isOutsideCentralIslandArea(class ChunkPos const&); // NOLINT
     ...
     */
    MCAPI float getIslandHeightValue(int, int, int, int) const; // NOLINT
