...
public:
     ...
     */
    virtual class std::optional<short> getPreliminarySurfaceLevel(class DividedPos2d<4>) const; // NOLINT
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_SURFACELEVELCACHE
    /**
     * @symbol __unk_destructor_-1
     */
    MCVAPI ~SurfaceLevelCache(); // NOLINT
#endif
    /**
     * @symbol ??0SurfaceLevelCache\@\@QEAA\@V?$DividedPos2d\@$03\@\@AEBVIPreliminarySurfaceProvider\@\@_K\@Z
     */
    MCAPI
    SurfaceLevelCache(class DividedPos2d<4>, class IPreliminarySurfaceProvider const&, unsigned __int64); // NOLINT
};
