...
public:
     ...
     */
    MCAPI void
    _buildHand(class BlockSource&, class BlockPos const&, class Random&, std::vector<class BlockPos>&, std::vector<struct std::pair<class BlockPos, unsigned char>>&, class gsl::not_null<class Block const*>)
        const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    _buildPlantLike(class BlockSource&, class BlockPos const&, class Random&, std::vector<class BlockPos>&, std::vector<struct std::pair<class BlockPos, unsigned char>>&, class gsl::not_null<class Block const*>)
        const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    _buildSmallClump(class BlockSource&, class BlockPos const&, class Random&, std::vector<class BlockPos>&, std::vector<struct std::pair<class BlockPos, unsigned char>>&, class gsl::not_null<class Block const*>)
        const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    _buildSpire(class BlockSource&, class BlockPos const&, class Random&, std::vector<class BlockPos>&, std::vector<struct std::pair<class BlockPos, unsigned char>>&, class gsl::not_null<class Block const*>)
        const; // NOLINT
    /**
     * @symbol ?_canOverwrite\@CoralFeature\@\@AEBA_NAEBVBlockSource\@\@AEBVBlockPos\@\@H\@Z
     */
    MCAPI bool _canOverwrite(class BlockSource const&, class BlockPos const&, int) const; // NOLINT
    /**
     ...
     */
    MCAPI unsigned char _randomDirectionExcept(class Random&, unsigned char) const; // NOLINT
    /**
     * @symbol
     * ?_setBlock\@CoralFeature\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@V?$not_null\@PEBVBlock\@\@\@gsl\@\@H\@Z
     */
    MCAPI bool
    _setBlock(class BlockSource&, class BlockPos const&, class gsl::not_null<class Block const*>, int) const; // NOLINT
    /**
     * @symbol
     * ?_setBlockOnSolid\@CoralFeature\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@V?$not_null\@PEBVBlock\@\@\@gsl\@\@H\@Z
     */
    MCAPI bool _setBlockOnSolid(class BlockSource&, class BlockPos const&, class gsl::not_null<class Block const*>, int)
        const; // NOLINT
    /**
     * @symbol
