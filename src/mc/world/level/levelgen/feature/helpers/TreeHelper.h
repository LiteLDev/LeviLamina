 ...
 */
MCAPI bool
isValidTreePosition(class IBlockWorldGenAPI const&, class BlockPos const&, struct TreeHelper::TreeParams const&); // NOLINT
/**
 * @symbol ?isValidTreePosition\@TreeHelper\@\@YA_NAEBVIBlockWorldGenAPI\@\@AEBVBlockPos\@\@\@Z
 */
MCAPI bool isValidTreePosition(class IBlockWorldGenAPI const&, class BlockPos const&); // NOLINT
/**
 * @symbol
...
placeBaseBlock(class IBlockWorldGenAPI&, class BlockPos const&, std::vector<class BlockDescriptor> const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI class std::optional<class BlockPos>
placeDecoratedBlock(class IBlockWorldGenAPI&, class BlockPos const&, class Random&, class Block const&, struct TreeHelper::AttachableDecoration const&, struct TreeHelper::AttachableDecoration::DirectionMask const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI class std::optional<class BlockPos>
placeRadialBlockGroup(class IBlockWorldGenAPI&, class BlockPos const&, class Random&, class Block const&, int, int, bool, std::vector<class BlockDescriptor> const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI bool
prepareSpawn(class IBlockWorldGenAPI const&, class BlockPos const&, int, std::vector<class BlockDescriptor> const&, std::vector<class BlockDescriptor> const&); // NOLINT
