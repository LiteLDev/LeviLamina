...
public:
    // NOLINTBEGIN
    // vIndex: 0, symbol: __gen_??1SimpleTreeCanopy@@UEAA@XZ
    ...
    placeCanopy(class IBlockWorldGenAPI& target, class BlockPos const& pos, class Random& random, class RenderParams& renderParams, struct TreeHelper::TreeParams const&, std::vector<class BlockPos> const&)
        const;
