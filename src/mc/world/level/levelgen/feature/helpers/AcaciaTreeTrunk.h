...
public:
     ...
     */
    MCAPI void
    _placeLeaningBranches(class IBlockWorldGenAPI&, class BlockPos const&, class BlockPos const&, class Random&, class RenderParams&, int32_t, int32_t, int32_t, struct TreeHelper::TreeParams const&)
        const;
    /**
     * @symbol
