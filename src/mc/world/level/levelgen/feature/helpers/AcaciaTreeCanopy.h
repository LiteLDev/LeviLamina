...
public:
    ...
    placeCanopy(class IBlockWorldGenAPI& target, class BlockPos const& pos, class Random&, class RenderParams&, struct TreeHelper::TreeParams const&, std::vector<class BlockPos> const&)
        const;
    ...
    MCAPI void
    _placeLeaf(class IBlockWorldGenAPI& target, class BlockPos const& pos, gsl::not_null<class Block const*>, struct TreeHelper::TreeParams const&)
        const;
