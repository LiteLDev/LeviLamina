...
public:
     ...
     */
    MCAPI static bool
    createChest(class StructurePiece&, class BlockSource&, class BoundingBox const&, class Random&, int32_t, int32_t, int32_t, uint8_t, std::string const&);
    /**
     * @symbol
     ...
     */
    MCAPI static bool
    createDispenser(class StructurePiece&, class BlockSource&, class BoundingBox const&, class Random&, int32_t, int32_t, int32_t, int32_t, std::string const&);
    /**
     * @symbol
     ...
     */
    MCAPI static bool
    createMinecartChest(class StructurePiece&, class BlockSource&, class BoundingBox const&, class Random&, int32_t, int32_t, int32_t, int32_t, std::string const&);
    /**
     * @symbol
     * ?fillColumnDown\@StructureHelpers\@\@SAXAEAVStructurePiece\@\@AEAVBlockSource\@\@AEBVBlock\@\@HHHAEBVBoundingBox\@\@\@Z
     */
    MCAPI static void
    fillColumnDown(class StructurePiece&, class BlockSource&, class Block const&, int32_t, int32_t, int32_t, class BoundingBox const&);
    /**
