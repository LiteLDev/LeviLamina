...
public:
     ...
     */
    MCAPI
    StructureTemplatePool(std::string, std::string, std::vector<struct std::pair<class StructurePoolElement const*, int>>&); // NOLINT
    /**
     * @symbol
     * ?getFallback\@StructureTemplatePool\@\@QEBAAEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@XZ
     */
    MCAPI std::string const& getFallback() const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class StructurePoolElement const* getRandomTemplate(class Random&) const; // NOLINT
    /**
     * @symbol
     * ?getShuffledTemplateIndexes\@StructureTemplatePool\@\@QEBA?AV?$vector\@_KV?$allocator\@_K\@std\@\@\@std\@\@AEAVRandom\@\@\@Z
     */
    MCAPI std::vector<unsigned __int64> getShuffledTemplateIndexes(class Random&) const; // NOLINT
    /**
     * @symbol ?getTemplate\@StructureTemplatePool\@\@QEBAPEBVStructurePoolElement\@\@_K\@Z
     */
    MCAPI class StructurePoolElement const* getTemplate(unsigned __int64) const; // NOLINT
    /**
