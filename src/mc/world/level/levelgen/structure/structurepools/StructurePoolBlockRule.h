...
public:
     ...
     */
    MCAPI
    StructurePoolBlockRule(std::unique_ptr<class IStructurePoolBlockPredicate>&&, std::unique_ptr<class IStructurePoolBlockPredicate>&&, class Block const*); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI
    StructurePoolBlockRule(std::unique_ptr<class IStructurePoolBlockPredicate>&&, std::unique_ptr<class IStructurePoolBlockPredicate>&&, std::unique_ptr<class IStructurePoolBlockPredicate>&&, class Block const*); // NOLINT
    /**
     * @symbol ?finalizeRule\@StructurePoolBlockRule\@\@QEAA_NAEAVBlockSource\@\@AEAVIRandom\@\@\@Z
     */
    MCAPI bool finalizeRule(class BlockSource&, class IRandom&); // NOLINT
    /**
