...
public:
    ...
    public:
         ...
         */
        MCAPI
        LazyTemplate(class gsl::not_null<class Bedrock::NonOwnerPointer<class StructureManager>>, std::string const&, std::vector<std::unique_ptr<class StructurePoolBlockTagRule>> const*); // NOLINT
        ...
        _findJigsawBlocks(std::vector<class JigsawStructureBlockInfo>&, std::vector<std::unique_ptr<class StructurePoolBlockTagRule>> const*); // NOLINT
...
public:
     ...
     */
    virtual class BlockPos getSize(enum class Rotation) const; // NOLINT
    /**
     * @vftbl 1
     * @symbol
     ...
     */
    virtual std::vector<class JigsawBlockInfo> getJigsawMarkers(class BlockPos, enum class Rotation) const; // NOLINT
    /**
     * @vftbl 2
     * @symbol
    ...
    getJigsawMarkers(class BlockPos, class LegacyStructureSettings&, class BlockSource*) const; // NOLINT
    /**
     * @vftbl 3
     * @symbol ?getBoundingBox\@StructurePoolElement\@\@UEBA?AVBoundingBox\@\@VBlockPos\@\@W4Rotation\@\@\@Z
     */
    virtual class BoundingBox getBoundingBox(class BlockPos, enum class Rotation) const; // NOLINT
    /**
     * @vftbl 4
     * @symbol ?setProjection\@StructurePoolElement\@\@UEAAXW4Projection\@\@\@Z
     */
    virtual void setProjection(enum class Projection); // NOLINT
    /**
     * @vftbl 5
     * @symbol ?getProjection\@StructurePoolElement\@\@UEBA?AW4Projection\@\@XZ
     */
    virtual enum class Projection getProjection() const; // NOLINT
    /**
     * @vftbl 6
     * @symbol ?getPostProcessSettings\@StructurePoolElement\@\@UEBA?AW4PostProcessSettings\@\@XZ
     */
    virtual enum class PostProcessSettings getPostProcessSettings() const; // NOLINT
    /**
     * @vftbl 7
     * @symbol
     ...
     */
    virtual void placeActors(class BlockSource&, class BlockPos, enum class Rotation, class Random&) const; // NOLINT
    /**
     * @vftbl 9
     * @symbol
     ...
     */
    virtual void
    handleJigsawBlock(class BlockSource&, class JigsawBlockInfo&, class LegacyStructureSettings&) const; // NOLINT
    /**
     * @vftbl 10
     * @symbol
     ...
     */
    MCVAPI ~StructurePoolElement(); // NOLINT
#endif
    /**
     * @symbol
     ...
     */
    MCAPI std::string const& getLocation() const; // NOLINT

    // private:
    /**
     * @symbol ?_getTemplate\@StructurePoolElement\@\@AEBAAEBVLazyTemplate\@1\@XZ
     */
    MCAPI class StructurePoolElement::LazyTemplate const& _getTemplate() const; // NOLINT
