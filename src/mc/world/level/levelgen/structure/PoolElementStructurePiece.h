...
public:
    ...
    getSupportBlock(class BlockSource&, class BlockPos const&, class Block const&) const = 0; // NOLINT
    /**
     * @vftbl 15
     * @symbol ?getBeardStabilizeBlock\@VillagePiece\@\@UEBAAEBVBlock\@\@AEBV2\@\@Z
     */
    virtual class Block const& getBeardStabilizeBlock(class Block const&) const = 0; // NOLINT
    /**
     * @vftbl 16
     * @symbol ?getTerrainAdjustmentEffect\@VillagePiece\@\@UEBA?AW4AdjustmentEffect\@\@XZ
     */
    virtual enum class AdjustmentEffect getTerrainAdjustmentEffect() const = 0; // NOLINT
    /**
     * @vftbl 17
     ...
     */
    MCVAPI ~PoolElementStructurePiece(); // NOLINT
#endif
    /**
     * @symbol
