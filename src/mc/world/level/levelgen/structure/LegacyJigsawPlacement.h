...
public:
     ...
     */
    MCAPI
    LegacyJigsawPlacement(int, class std::function<std::unique_ptr<class PoolElementStructurePiece>(class StructurePoolElement const&, class BlockPos const&, enum class Rotation const&, int, struct JigsawJunction&, class BoundingBox const&, class BlockPos const&)>); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    addPieces(std::vector<std::unique_ptr<class StructurePiece>>&, class StructurePoolElement const&, class Random&, class BlockPos const&, enum class Rotation const&, class JigsawStructureRegistry const&, class Dimension&); // NOLINT
    /**
     * @symbol ??1LegacyJigsawPlacement\@\@QEAA\@XZ
     */
    MCAPI ~LegacyJigsawPlacement(); // NOLINT
     ...
     */
    MCAPI void
    _addPiece(std::vector<std::unique_ptr<class StructurePiece>>&, class PoolElementStructurePiece const&, class Random&, class BlockPos const&, enum class Rotation const&, class JigsawStructureRegistry const&, class Dimension&, class BlockVolume&, class BlockPos const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI static class std::shared_ptr<bool>
    _setTerrainAdjustment(enum class AdjustmentEffect, class BoundingBox const&, struct JigsawJunction const&, class Dimension&); // NOLINT
