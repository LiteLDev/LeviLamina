...
public:
     ...
     */
    MCAPI
    LegacyJigsawPlacement(int, class std::function<std::unique_ptr<class PoolElementStructurePiece>(class StructurePoolElement const&, class BlockPos const&, enum class Rotation const&, int, struct JigsawJunction&, class BoundingBox const&, class BlockPos const&)>);
    /**
     * @symbol
     ...
     */
    MCAPI void
    addPieces(std::vector<std::unique_ptr<class StructurePiece>>&, class StructurePoolElement const&, class Random&, class BlockPos const&, enum class Rotation const&, class JigsawStructureRegistry const&, class Dimension&);
    /**
