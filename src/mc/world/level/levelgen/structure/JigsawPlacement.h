...
public:
     ...
     */
    MCAPI void
    addPieces(class StructurePoolElement const&, class BlockPos const&, enum class Rotation const&, class std::basic_string_view<char, struct std::char_traits<char>>);
    /**
