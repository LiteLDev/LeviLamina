...
public:
     ...
     */
    MCAPI bool
    _placeSegment(class Dimension&, class StructureAnimationData&, class ChunkLoadActionList&, class BoundingBox const&, std::function<enum class ChunksLoadedStatus(struct Tick)> const&);
    /**
     * @symbol
