...
public:
    ...
    createStructureDataImportPacket(std::string const&, enum class StructureTemplateResponseType);
    /**
     * @symbol
     ...
     */
    MCAPI bool
    _placeSegment(class Dimension&, class StructureAnimationData&, class ChunkLoadActionList&, class BoundingBox const&, class std::function<enum class ChunksLoadedStatus(struct Tick)> const&);
    /**
     * @symbol
