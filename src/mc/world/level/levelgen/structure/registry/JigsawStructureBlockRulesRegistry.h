...
public:
     ...
     */
    MCAPI JigsawStructureBlockRulesRegistry(); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI std::vector<std::unique_ptr<class StructurePoolBlockRule>> const* lookupByName(std::string) const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    registerBlockRules(std::string, std::unique_ptr<std::vector<class std::unique_ptr<class StructurePoolBlockRule, struct std::default_delete<class StructurePoolBlockRule>>>>&&); // NOLINT
    /**
