...
public:
     ...
     */
    MCAPI void _readArea(float*, class Vec3 const&, int, int, int, class Vec3 const&, float) const; // NOLINT
     ...
     */
    MCAPI void
    _blendCubeCorners(class Vec3 const&, int, int, int, float, float&, float&, float&, float&) const; // NOLINT
    /**
     * @symbol ?_init\@ImprovedNoise\@\@AEAAXAEBVVec3\@\@AEAVIRandom\@\@UYBlendingBugSettings\@\@\@Z
     */
    MCAPI void _init(class Vec3 const&, class IRandom&, struct YBlendingBugSettings); // NOLINT
