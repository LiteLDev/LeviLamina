...
public:
    ...
    MCAPI class Bedrock::PubSub::Subscription
        registerOnCanStartGameSaveTimerCheckCallback(class std::function<bool(void)>);
    /**
     * @symbol
     ...
     */
    MCAPI class Bedrock::PubSub::Subscription
        registerOnPollSaveGameStatisticsCallback(class std::function<void(class LevelStorage&)>);
    /**
     * @symbol
     ...
     */
    MCAPI class Bedrock::PubSub::Subscription
        registerOnSaveGameDataCallback(class std::function<void(class LevelStorage&)>);
    /**
     * @symbol
     ...
     */
    MCAPI class Bedrock::PubSub::Subscription
        registerOnSaveLevelDataCallback(class std::function<void(class LevelStorage&)>);
    /**
     * @symbol
     ...
     */
    MCAPI class Bedrock::PubSub::Subscription
        registerOnStartLeaveGameCallback(class std::function<void(class LevelStorage&)>);
    /**
     ...
     */
    MCAPI void
        tryStartGameDataSaveTimerIfNotSet(class std::chrono::time_point<
                                          struct std::chrono::steady_clock,
                                          class std::chrono::duration<__int64, struct std::ratio<1, 1000000000>>>);
    /**
