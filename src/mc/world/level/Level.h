...
public:
     ...
     */
    MCVAPI void
    addTickingAreaList(class AutomaticID<class Dimension, int>, class std::shared_ptr<class TickingAreaList> const&);
    /**
     ...
     */
    MCVAPI void
    broadcastLevelEvent(enum class LevelEvent, class CompoundTag const&, class UserEntityIdentifierComponent const*);
    /**
     ...
     */
    MCVAPI void
    entityChangeDimension(class Actor&, class AutomaticID<class Dimension, int>, class std::optional<class Vec3>);
    /**
