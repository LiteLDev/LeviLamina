...
public:
     ...
     */
    MCAPI FurnaceBlock(std::string const&, int, bool); // NOLINT
    /**
     * @symbol ?setLit\@FurnaceBlock\@\@SAX_NAEAVBlockSource\@\@AEBVBlockPos\@\@W4BlockActorType\@\@AEBVBlock\@\@4\@Z
     */
    MCAPI static void
    setLit(bool, class BlockSource&, class BlockPos const&, enum class BlockActorType, class Block const&, class Block const&); // NOLINT
};
