...
public:
     ...
     */
    MCAPI LiquidBlockDynamic(std::string const&, int, class Material const&); // NOLINT
    /**
     * @symbol ?getSpread\@LiquidBlockDynamic\@\@QEBA?AV?$array\@_N$03\@std\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI class std::array<bool, 4> getSpread(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?shouldBecomeStatic\@LiquidBlockDynamic\@\@QEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@\@Z
     */
    MCAPI bool shouldBecomeStatic(class BlockSource&, class BlockPos const&, class Random&) const; // NOLINT
     ...
     */
    MCAPI bool
    _canSpreadTo(class BlockSource&, class BlockPos const&, class BlockPos const&, unsigned char) const; // NOLINT
    /**
     * @symbol ?_getSlopeDistance\@LiquidBlockDynamic\@\@AEBAHAEAVBlockSource\@\@AEBVBlockPos\@\@HH\@Z
     */
    MCAPI int _getSlopeDistance(class BlockSource&, class BlockPos const&, int, int) const; // NOLINT
    /**
     * @symbol ?_isWaterBlocking\@LiquidBlockDynamic\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@1E\@Z
     */
    MCAPI bool
    _isWaterBlocking(class BlockSource&, class BlockPos const&, class BlockPos const&, unsigned char) const; // NOLINT
    /**
     * @symbol ?_setStatic\@LiquidBlockDynamic\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@_N\@Z
     */
    MCAPI void _setStatic(class BlockSource&, class BlockPos const&, bool) const; // NOLINT
    /**
     * @symbol ?_tick\@LiquidBlockDynamic\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@_N\@Z
     */
    MCAPI bool _tick(class BlockSource&, class BlockPos const&, class Random&, bool) const; // NOLINT
    /**
     * @symbol ?_trySpreadTo\@LiquidBlockDynamic\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@H1E\@Z
     */
    MCAPI void
    _trySpreadTo(class BlockSource&, class BlockPos const&, int, class BlockPos const&, unsigned char) const; // NOLINT
