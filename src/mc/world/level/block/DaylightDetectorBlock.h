...
public:
     ...
     */
    virtual void updateShape(class BlockSource&, class BlockPos const&); // NOLINT
    /**
     * @vftbl 194
     * @symbol ?updateSignalStrength\@DaylightDetectorBlock\@\@UEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    virtual void updateSignalStrength(class BlockSource&, class BlockPos const&) const; // NOLINT
     ...
     */
    MCAPI DaylightDetectorBlock(std::string const&, int, bool); // NOLINT
};
