...
public:
     ...
     */
    MCAPI TripWireHookBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?calculateState\@TripWireHookBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@_N2HAEBVBlock\@\@\@Z
     */
    MCAPI void
    calculateState(class BlockSource&, class BlockPos const&, bool, bool, int, class Block const&) const; // NOLINT

    // private:
    /**
     * @symbol ?_emitState\@TripWireHookBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@_N222\@Z
     */
    MCAPI void _emitState(class BlockSource&, class BlockPos const&, bool, bool, bool, bool) const; // NOLINT
    /**
     * @symbol ?_getShape\@TripWireHookBlock\@\@AEBAXHAEAVAABB\@\@\@Z
     */
    MCAPI void _getShape(int, class AABB&) const; // NOLINT
