...
public:
     ...
     */
    MCAPI NoteBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?enableSkullPlacement\@NoteBlock\@\@QEAAAEAV1\@_N\@Z
     */
    MCAPI class NoteBlock& enableSkullPlacement(bool); // NOLINT

    // private:
    /**
     * @symbol ?_triggerNoteParticle\@NoteBlock\@\@AEBAXAEAVLevel\@\@AEBVVec3\@\@H\@Z
     */
    MCAPI void _triggerNoteParticle(class Level&, class Vec3 const&, int) const; // NOLINT
