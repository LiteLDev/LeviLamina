...
public:
    ...
    // symbol:
    // ??0OakLeavesBlock@@QEAA@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@HV?$WeakPtr@VBlockLegacy@@@@@Z
    MCAPI OakLeavesBlock(std::string const&, int, class WeakPtr<class BlockLegacy>);
