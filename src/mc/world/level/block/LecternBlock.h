...
public:
     ...
     */
    MCAPI LecternBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?emitRedstonePulse\@LecternBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void emitRedstonePulse(class BlockSource&, class BlockPos const&) const; // NOLINT

    // private:
    /**
     * @symbol ?_dropBook\@LecternBlock\@\@AEBA_NAEAVPlayer\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool _dropBook(class Player&, class BlockPos const&) const; // NOLINT
