...
public:
    ...
    // vIndex: 75, symbol: ?onRedstoneUpdate@ActivatorRailBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@H_N@Z
    ...
    // vIndex: 143, symbol: ?getVariant@ActivatorRailBlock@@UEBAHAEBVBlock@@@Z
