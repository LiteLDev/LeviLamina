...
public:
     ...
     */
    MCAPI CherrySaplingBlock(std::string const&, int); // NOLINT

    // protected:
    /**
     * @symbol
     * ?advanceTree\@CherrySaplingBlock\@\@IEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@PEAVActor\@\@\@Z
     */
    MCAPI bool advanceTree(class BlockSource&, class BlockPos const&, class Random&, class Actor*) const; // NOLINT

    // private:
    /**
     * @symbol ?_growTree\@CherrySaplingBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@_N\@Z
     */
    MCAPI bool _growTree(class BlockSource&, class BlockPos const&, class Random&, bool) const; // NOLINT
