...
public:
    ...
    // vIndex: 8, symbol: ?getAABB@BannerBlock@@UEBAAEBVAABB@@AEBVIConstBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z
    ...
    // vIndex: 71, symbol: ?checkIsPathable@BannerBlock@@UEBA_NAEAVActor@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 101, symbol: ?neighborChanged@BannerBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
    virtual void neighborChanged(class BlockSource&, class BlockPos const&, class BlockPos const&) const;

    // vIndex: 103, symbol: ?playerWillDestroy@BannerBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual bool playerWillDestroy(class Player&, class BlockPos const&, class Block const&) const;

    // vIndex: 105, symbol: ?asItemInstance@BannerBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 143, symbol: ?getVariant@BannerBlock@@UEBAHAEBVBlock@@@Z
