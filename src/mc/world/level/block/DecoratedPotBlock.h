...
public:
    ...
    // vIndex: 64, symbol: ?canContainLiquid@DecoratedPotBlock@@UEBA_NXZ
    virtual bool canContainLiquid() const;

    // vIndex: 71, symbol: ?checkIsPathable@DecoratedPotBlock@@UEBA_NAEAVActor@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 103, symbol: ?playerWillDestroy@DecoratedPotBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 105, symbol: ?asItemInstance@DecoratedPotBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
