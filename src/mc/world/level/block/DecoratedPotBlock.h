...
public:
     ...
     */
    MCAPI DecoratedPotBlock(std::string const&, int); // NOLINT
     ...
     */
    MCAPI void _addUserDataToItemInstance(class gsl::not_null<class DecoratedPotBlockActor const*>, class ItemInstance&)
        const; // NOLINT
