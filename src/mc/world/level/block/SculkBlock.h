...
public:
    ...
    /**
     * @symbol
     * ??0SculkBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HAEBVMaterial\@\@\@Z
     */
    MCAPI SculkBlock(std::string const&, int, class Material const&); // NOLINT
};
