...
public:
    ...
    // vIndex: 149, symbol: ?shouldTickOnSetBlock@BubbleColumnBlock@@UEBA_NXZ
    ...
    // vIndex: 164, symbol: ?getResourceCount@BubbleColumnBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
