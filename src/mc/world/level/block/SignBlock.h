...
public:
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@SignBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
     ...
     */
    virtual float getYRotationInDegrees(class Block const&) const; // NOLINT
    /**
     * @vftbl 194
     * @symbol ?_canSurvive\@SignBlock\@\@MEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@E\@Z
     */
    virtual bool _canSurvive(class BlockSource&, class BlockPos const&, unsigned char) const; // NOLINT
    /**
     * @vftbl 195
     * @symbol ?_getItemInstance\@SignBlock\@\@MEBA?AVItemInstance\@\@XZ
     */
    virtual class ItemInstance _getItemInstance() const; // NOLINT
    /**
     * @vftbl 196
     * @symbol ?_getShape\@SignBlock\@\@MEBAXHAEAVAABB\@\@\@Z
     */
    virtual void _getShape(int, class AABB&) const; // NOLINT
     ...
     */
    MCAPI SignBlock(std::string const&, int, bool, enum class SignBlock::SignType); // NOLINT
    /**
     * @symbol ?getSignTextColorFromDyeItem\@SignBlock\@\@SA?AVColor\@mce\@\@AEBVItem\@\@\@Z
     */
    MCAPI static class mce::Color getSignTextColorFromDyeItem(class Item const&); // NOLINT

    // private:
    /**
     * @symbol ?_canChangeSign\@SignBlock\@\@CA_NAEAVSignBlockActor\@\@AEAVPlayer\@\@\@Z
     */
    MCAPI static bool _canChangeSign(class SignBlockActor&, class Player&); // NOLINT
    /**
     * @symbol
