...
public:
    ...
    // vIndex: 57, symbol: ?isValidAuxValue@ChemistryTableBlock@@UEBA_NH@Z
    virtual bool isValidAuxValue(int) const;

    // vIndex: 60, symbol: ?onFillBlock@ChemistryTableBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 68, symbol: ?canBeUsedInCommands@ChemistryTableBlock@@UEBA_NAEBVBaseGameVersion@@@Z
    ...
    // vIndex: 105, symbol: ?asItemInstance@ChemistryTableBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 134, symbol: ?isAuxValueRelevantForPicking@ChemistryTableBlock@@UEBA_NXZ
    virtual bool isAuxValueRelevantForPicking() const;

    // vIndex: 143, symbol: ?getVariant@ChemistryTableBlock@@UEBAHAEBVBlock@@@Z
    virtual int getVariant(class Block const&) const;

    // vIndex: 146, symbol: ?getMappedFace@ChemistryTableBlock@@UEBAEEAEBVBlock@@@Z
