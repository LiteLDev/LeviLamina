...
public:
     ...
     */
    MCAPI ChemistryTableBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?getItemForType\@ChemistryTableBlock\@\@SA?AVItemInstance\@\@W4ChemistryTableType\@\@H\@Z
     */
    MCAPI static class ItemInstance getItemForType(enum class ChemistryTableType, int); // NOLINT
    /**
     * @symbol
     * ?isUIValidForPlayer\@ChemistryTableBlock\@\@SA_NAEBVBlockPos\@\@AEAVPlayer\@\@MW4ChemistryTableType\@\@\@Z
     */
    MCAPI static bool
    isUIValidForPlayer(class BlockPos const&, class Player&, float, enum class ChemistryTableType); // NOLINT
};
