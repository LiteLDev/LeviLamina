...
public:
    ...
    // vIndex: 75, symbol: ?onRedstoneUpdate@PoweredRailBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@H_N@Z
    ...
    // vIndex: 143, symbol: ?getVariant@PoweredRailBlock@@UEBAHAEBVBlock@@@Z
