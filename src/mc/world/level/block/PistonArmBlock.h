...
public:
     ...
     */
    MCAPI PistonArmBlock(std::string const&, int, enum class PistonBlock::Type); // NOLINT

    // private:
    /**
     * @symbol ?_getCollisions\@PistonArmBlock\@\@AEBAXAEAVAABB\@\@00E\@Z
     */
    MCAPI void _getCollisions(class AABB&, class AABB&, class AABB&, unsigned char) const; // NOLINT
    /**
     * @symbol ?_getResourceItem\@PistonArmBlock\@\@AEBA?AVItemInstance\@\@XZ
     */
    MCAPI class ItemInstance _getResourceItem() const; // NOLINT
