...
public:
    ...
    // vIndex: 57, symbol: ?isValidAuxValue@StoneSlabBlock3@@UEBA_NH@Z
    ...
    // vIndex: 105, symbol: ?asItemInstance@StoneSlabBlock3@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 134, symbol: ?isAuxValueRelevantForPicking@StoneSlabBlock3@@UEBA_NXZ
    virtual bool isAuxValueRelevantForPicking() const;

    // vIndex: 143, symbol: ?getVariant@StoneSlabBlock3@@UEBAHAEBVBlock@@@Z
