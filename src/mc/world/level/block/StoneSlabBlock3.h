...
public:
     ...
     */
    MCAPI StoneSlabBlock3(std::string const&, int, bool, class WeakPtr<class BlockLegacy>); // NOLINT
    /**
     * @symbol
     * ?SLAB_NAMES\@StoneSlabBlock3\@\@2V?$array\@V?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@$07\@std\@\@B
     */
    MCAPI static class std::array<std::string, 8> const SLAB_NAMES; // NOLINT
};
