...
public:
    ...
    // vIndex: 164, symbol: ?getResourceItem@RotatedPillarBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    ...
    MCAPI RotatedPillarBlock(std::string const& nameId, int, class Material const& material);
