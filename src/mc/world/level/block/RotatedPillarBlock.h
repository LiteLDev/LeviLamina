...
public:
    ...
    // vIndex: 105, symbol: ?asItemInstance@RotatedPillarBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 108, symbol:
    // ?getPlacementBlock@RotatedPillarBlock@@UEBAAEBVBlock@@AEBVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z
    ...
    // vIndex: 146, symbol: ?getMappedFace@RotatedPillarBlock@@UEBAEEAEBVBlock@@@Z
