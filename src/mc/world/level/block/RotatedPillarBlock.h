...
public:
     ...
     */
    MCVAPI ~RotatedPillarBlock(); // NOLINT
#endif
    /**
     * @symbol
     * ??0RotatedPillarBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HAEBVMaterial\@\@\@Z
     */
    MCAPI RotatedPillarBlock(std::string const&, int, class Material const&); // NOLINT
...
private:
     ...
     */
    MCAPI static int const mRotatedX[]; // NOLINT
    /**
     * @symbol ?mRotatedZ\@RotatedPillarBlock\@\@0QBHB
     */
    MCAPI static int const mRotatedZ[]; // NOLINT
};
