...
public:
     ...
     */
    MCAPI ObserverBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?MAX_TICK_DELAY\@ObserverBlock\@\@2UTick\@\@B
     */
    MCAPI static struct Tick const MAX_TICK_DELAY; // NOLINT

    // private:
    /**
     * @symbol ?_installCircuit\@ObserverBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@_N2\@Z
     */
    MCAPI void _installCircuit(class BlockSource&, class BlockPos const&, bool, bool) const; // NOLINT
    /**
     * @symbol ?_updateState\@ObserverBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVPulseCapacitor\@\@_N\@Z
     */
    MCAPI void _updateState(class BlockSource&, class BlockPos const&, class PulseCapacitor&, bool) const; // NOLINT
