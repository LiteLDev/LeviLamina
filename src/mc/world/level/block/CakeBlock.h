...
public:
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@CakeBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
     ...
     */
    MCAPI CakeBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?removeCakeSlice\@CakeBlock\@\@SAXAEAVPlayer\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@PEBVBlock\@\@\@Z
     */
    MCAPI static void
    removeCakeSlice(class Player&, class BlockSource&, class BlockPos const&, class Block const*); // NOLINT
};
