...
public:
    ...
    // vIndex: 105, symbol: ?asItemInstance@ChiseledBookshelfBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // NOLINTBEGIN
    // symbol:
    // ?_updateBlockEvents@ChiseledBookshelfBlock@@AEBAXAEAVBlockSource@@AEAVPlayer@@AEBVBlockPos@@W4LevelSoundEvent@@@Z
    MCAPI void _updateBlockEvents(class BlockSource&, class Player&, class BlockPos const&, ::LevelSoundEvent) const;
