...
public:
     ...
     */
    MCAPI ChiseledBookshelfBlock(std::string const&, int); // NOLINT
     ...
     */
    MCAPI void _updateBlockEvents(class BlockSource&, class Player&, class BlockPos const&, enum class LevelSoundEvent)
        const; // NOLINT
