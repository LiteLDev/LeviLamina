...
public:
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@CandleBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
     ...
     */
    MCAPI CandleBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?tryLightFire\@CandleBlock\@\@SA_NAEAVBlockSource\@\@AEBVBlockPos\@\@PEAVActor\@\@\@Z
     */
    MCAPI static bool tryLightFire(class BlockSource&, class BlockPos const&, class Actor*); // NOLINT
     ...
     */
    MCAPI static void
    _forEachCandle(class Block const&, class BlockPos const&, class std::function<void(class Vec3 const&, int)>); // NOLINT
