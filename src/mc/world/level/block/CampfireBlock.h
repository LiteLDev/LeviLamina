...
public:
     ...
     */
    MCAPI CampfireBlock(std::string const&, int, bool, bool); // NOLINT
    /**
     * @symbol ?isLit\@CampfireBlock\@\@SA_NAEBVBlock\@\@\@Z
     */
    MCAPI static bool isLit(class Block const&); // NOLINT
    /**
     * @symbol ?tryDouseFire\@CampfireBlock\@\@SA_NAEAVBlockSource\@\@AEBVBlockPos\@\@PEAVActor\@\@_N\@Z
     */
    MCAPI static bool tryDouseFire(class BlockSource&, class BlockPos const&, class Actor*, bool); // NOLINT
    /**
