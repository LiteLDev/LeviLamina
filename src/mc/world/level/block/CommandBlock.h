...
public:
     ...
     */
    MCAPI CommandBlock(std::string const&, int, enum class CommandBlockMode); // NOLINT
    /**
     * @symbol ?execute\@CommandBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void execute(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?getMode\@CommandBlock\@\@QEBA?AW4CommandBlockMode\@\@XZ
     */
    MCAPI enum class CommandBlockMode getMode() const; // NOLINT
    /**
     * @symbol ?updateBlock\@CommandBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@W4CommandBlockMode\@\@_N\@Z
     */
    MCAPI void
    updateBlock(class BlockSource&, class BlockPos const&, enum class CommandBlockMode, bool) const; // NOLINT
    /**
     * @symbol ?_getCommandBlockActor\@CommandBlock\@\@SAPEAVCommandBlockActor\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI static class CommandBlockActor* _getCommandBlockActor(class BlockSource&, class BlockPos const&); // NOLINT

    // private:
    /**
     * @symbol ?_execute\@CommandBlock\@\@AEBAXAEAVBlockSource\@\@AEAVCommandBlockActor\@\@AEBVBlockPos\@\@_N\@Z
     */
    MCAPI void _execute(class BlockSource&, class CommandBlockActor&, class BlockPos const&, bool) const; // NOLINT
    /**
     * @symbol ?_executeChain\@CommandBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _executeChain(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol
     * ?_executeChainBlock\@CommandBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVCommandBlockActor\@\@_N\@Z
     */
    MCAPI bool
    _executeChainBlock(class BlockSource&, class BlockPos const&, class CommandBlockActor&, bool) const; // NOLINT
    /**
     * @symbol ?_installCircuit\@CommandBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@_N\@Z
     */
    MCAPI void _installCircuit(class BlockSource&, class BlockPos const&, bool) const; // NOLINT

private:
    /**
     * @symbol ?mCBModeMap\@CommandBlock\@\@0PAHA
     */
    MCAPI static int mCBModeMap[]; // NOLINT
};
