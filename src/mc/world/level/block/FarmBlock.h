...
public:
    ...
    // vIndex: 8, symbol: ?getAABB@FarmBlock@@UEBAAEBVAABB@@AEBVIConstBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z
    ...
    // vIndex: 64, symbol: ?canContainLiquid@FarmBlock@@UEBA_NXZ
    virtual bool canContainLiquid() const;

    // vIndex: 74, symbol: ?transformOnFall@FarmBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@M@Z
    ...
    // vIndex: 101, symbol: ?neighborChanged@FarmBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 143, symbol: ?getVariant@FarmBlock@@UEBAHAEBVBlock@@@Z
    ...
    // vIndex: 185, symbol: ?getResourceItem@FarmBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
