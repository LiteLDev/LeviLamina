...
public:
    ...
    // vIndex: 71, symbol: ?checkIsPathable@CarpetBlock@@UEBA_NAEAVActor@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 94, symbol: ?mayPlace@CarpetBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    virtual bool mayPlace(class BlockSource&, class BlockPos const&) const;

    // vIndex: 101, symbol: ?neighborChanged@CarpetBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
    virtual void neighborChanged(class BlockSource&, class BlockPos const&, class BlockPos const&) const;

    // vIndex: 105, symbol: ?asItemInstance@CarpetBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
