...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_BLOCKTYPEREGISTRY_BLOCKCOMPLEXALIASBLOCKSTATE
    public:
...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_BLOCKTYPEREGISTRY_BLOCKCOMPLEXALIASCONTENT
    public:
...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_BLOCKTYPEREGISTRY_LOOKUPBYNAMEIMPLRETURNTYPE
    public:
...
public:
     ...
     */
    MCAPI static void
    registerComplexAlias(class HashedString const&, class std::function<class Block const*(int)>, std::vector<class std::reference_wrapper<class HashedString const>> const&, class BaseGameVersion const&);
    /**
