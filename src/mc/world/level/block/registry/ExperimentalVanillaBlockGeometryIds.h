...
namespace ExperimentalVanillaBlockGeometryIds {
// static variables
// NOLINTBEGIN
...
MCAPI ::HashedString const& BigDripleafStem();

MCAPI ::HashedString const& Button();

MCAPI ::HashedString const& ButtonPressed();

MCAPI ::HashedString const& Cross();
