...
public:
     ...
     */
    MCAPI FireBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?checkBurn\@FireBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@HAEAVRandomize\@\@H\@Z
     */
    MCAPI void checkBurn(class BlockSource&, class BlockPos const&, int, class Randomize&, int) const; // NOLINT
    /**
     * @symbol ?isSolidToppedBlock\@FireBlock\@\@SA_NAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI static bool isSolidToppedBlock(class BlockSource&, class BlockPos const&); // NOLINT

    // private:
    /**
     * @symbol ?_tryAddToTickingQueue\@FireBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@\@Z
     */
    MCAPI void _tryAddToTickingQueue(class BlockSource&, class BlockPos const&, class Random&) const; // NOLINT
    /**
     * @symbol ?_trySpawnSoulFire\@FireBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool _trySpawnSoulFire(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?getFireOdds\@FireBlock\@\@AEBAMAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI float getFireOdds(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?isValidFireLocation\@FireBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool isValidFireLocation(class BlockSource&, class BlockPos const&) const; // NOLINT
