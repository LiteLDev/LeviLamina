...
public:
     ...
     */
    MCAPI
    CutCopperSlab(std::string const&, int, bool, class HashedString const&, enum class CopperType, class HashedString const&); // NOLINT
    /**
     * @symbol
     * ??0CutCopperSlab\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H_NAEBVHashedString\@\@W4CopperType\@\@222\@Z
     */
    MCAPI
    CutCopperSlab(std::string const&, int, bool, class HashedString const&, enum class CopperType, class HashedString const&, class HashedString const&, class HashedString const&); // NOLINT
};
