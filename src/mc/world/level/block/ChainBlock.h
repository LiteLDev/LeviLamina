...
public:
    ...
    // vIndex: 64, symbol: ?canContainLiquid@ChainBlock@@UEBA_NXZ
    ...
    // vIndex: 105, symbol: ?asItemInstance@ChainBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 185, symbol: ?getResourceItem@ChainBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize&, class Block const&, int) const;

    // vIndex: 187, symbol: ?getSilkTouchItemInstance@ChainBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z
