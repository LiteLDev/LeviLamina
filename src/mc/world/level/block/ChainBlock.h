...
public:
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@ChainBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
    ...
    /**
     * @symbol
     * ??0ChainBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HAEBVMaterial\@\@\@Z
     */
    MCAPI ChainBlock(std::string const&, int, class Material const&); // NOLINT
};
