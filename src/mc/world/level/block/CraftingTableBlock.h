...
public:
    ...
    // vIndex: 143, symbol: ?_addHardCodedBlockComponents@CraftingTableBlock@@UEAAXXZ
    ...
    // vIndex: 154, symbol: ?use@CraftingTableBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z
    ...
    MCAPI CraftingTableBlock(std::string const& nameId, int);
