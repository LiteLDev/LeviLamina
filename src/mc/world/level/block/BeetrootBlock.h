...
public:
     ...
     * @vftbl 8
     * @symbol
     * ?getAABB\@BeetrootBlock\@\@UEBAAEBVAABB\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAV2\@_N\@Z
     */
     ...
     */
    virtual class ItemInstance const getBaseSeed() const; // NOLINT
    /**
     * @vftbl 195
     * @symbol ?getBaseCrop\@BeetrootBlock\@\@UEBA?BVItemInstance\@\@XZ
     */
    virtual class ItemInstance const getBaseCrop() const; // NOLINT
    /**
     * @vftbl 197
     * @symbol ?getCropNum\@BeetrootBlock\@\@UEBAHAEAVRandomize\@\@HH\@Z
     */
    virtual int getCropNum(class Randomize&, int, int) const; // NOLINT
    /**
     * @symbol
     * ??0BeetrootBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCAPI BeetrootBlock(std::string const&, int); // NOLINT
};
