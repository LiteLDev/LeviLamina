...
public:
    ...
    // vIndex: 64, symbol: ?canContainLiquid@AbstractCandleBlock@@UEBA_NXZ
    ...
    // vIndex: 101, symbol: ?neighborChanged@AbstractCandleBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 148, symbol: ?animateTick@AbstractCandleBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
