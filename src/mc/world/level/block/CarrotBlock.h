...
public:
    ...
    // vIndex: 8, symbol: ?getAABB@CarrotBlock@@UEBAAEBVAABB@@AEBVIConstBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z
    ...
    // vIndex: 143, symbol: ?getVariant@CarrotBlock@@UEBAHAEBVBlock@@@Z
