...
public:
    ...
    // vIndex: 95, symbol:
    // ?spawnResources@NetherSproutsBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    virtual void
    ...
    MCAPI NetherSproutsBlock(std::string const& nameId, int);
