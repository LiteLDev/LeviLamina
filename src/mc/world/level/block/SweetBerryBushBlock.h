...
public:
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@SweetBerryBushBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
     ...
     */
    MCAPI SweetBerryBushBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?SLOWDOWN_MULTIPLIER\@SweetBerryBushBlock\@\@2VVec3\@\@B
     */
    MCAPI static class Vec3 const SLOWDOWN_MULTIPLIER; // NOLINT

    // private:
    /**
     * @symbol ?_growBush\@SweetBerryBushBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@_NPEAVActor\@\@\@Z
     */
    MCAPI bool _growBush(class BlockSource&, class BlockPos const&, bool, class Actor*) const; // NOLINT
    /**
     * @symbol
     * ?_pickBerries\@SweetBerryBushBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAVActor\@\@\@Z
     */
    MCAPI bool
    _pickBerries(class BlockSource&, class BlockPos const&, class Block const&, class Actor&) const; // NOLINT
    /**
     * @symbol ?_popBerries\@SweetBerryBushBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEBH\@Z
     */
    MCAPI void _popBerries(class BlockSource&, class BlockPos const&, int const&) const; // NOLINT
