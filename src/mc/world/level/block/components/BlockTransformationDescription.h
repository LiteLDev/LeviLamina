...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI ::BlockTransformationDescription& setRotation(::BlockTransformationComponent::RotationType const& rotation);
    // NOLINTEND
...
public:
    ...
    MCAPI static ::BlockTransformationDescription makeCodeDescription();
