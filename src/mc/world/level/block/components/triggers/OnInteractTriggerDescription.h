...
public:
    ...
    // vIndex: 6, symbol: ?isNetworkComponent@OnInteractTriggerDescription@@UEBA_NXZ
    ...
    // vIndex: 8, symbol: ?initializeFromNetwork@OnInteractTriggerDescription@@UEAAXAEBVCompoundTag@@@Z
