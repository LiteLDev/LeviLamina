...
public:
    // NOLINTBEGIN
    // vIndex: 0, symbol: __gen_??1OnStepOffTriggerDescription@@UEAA@XZ
    virtual ~OnStepOffTriggerDescription() = default;

    // vIndex: 1, symbol:
    // ?getName@OnStepOffTriggerDescription@@UEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
    ...
    // vIndex: 3, symbol:
    // ?initializeComponent@?$BlockTriggerDescription@VOnStepOffTrigger@@@@UEBAXAEAVBlockComponentStorage@@@Z
    ...
    // vIndex: 6, symbol:
    // ?buildSchema@?$BlockTriggerDescription@VOnStepOffTrigger@@@@UEBAXAEAV?$shared_ptr@V?$JsonSchemaObjectNode@VEmptyClass@JsonUtil@@UBlockComponentGroupDescription@@@JsonUtil@@@std@@AEBVBlockComponentFactory@@@Z
