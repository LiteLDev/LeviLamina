...
public:
     ...
     */
    MCAPI PistonBlock(std::string const&, int, enum class PistonBlock::Type); // NOLINT
    /**
     * @symbol ?getFacingDir\@PistonBlock\@\@SAAEBVBlockPos\@\@E\@Z
     */
    MCAPI static class BlockPos const& getFacingDir(unsigned char); // NOLINT
...
private:
     ...
     */
    MCAPI static class BlockPos const ARM_DIRECTION_OFFSETS[]; // NOLINT
};
