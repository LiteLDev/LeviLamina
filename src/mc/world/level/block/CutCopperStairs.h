...
public:
     ...
     */
    MCAPI
    CutCopperStairs(std::string const&, int, class BlockLegacy const&, enum class CopperType, class HashedString const&, class HashedString const&, class HashedString const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI
    CutCopperStairs(std::string const&, int, class BlockLegacy const&, enum class CopperType, class HashedString const&); // NOLINT
};
