...
public:
     ...
     */
    MCAPI SkullBlock(std::string const&, int); // NOLINT
    /**
     * @symbol
     * ?checkMobSpawn\@SkullBlock\@\@QEBA_NAEAVLevel\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@AEAVSkullBlockActor\@\@\@Z
     */
    MCAPI bool
    checkMobSpawn(class Level&, class BlockSource&, class BlockPos const&, class SkullBlockActor&) const; // NOLINT
    /**
     * @symbol
     * ?getTypeDescriptionId\@SkullBlock\@\@SA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCAPI static std::string getTypeDescriptionId(int); // NOLINT

    // private:
    /**
     * @symbol ?_updatedDragonCircuit\@SkullBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _updatedDragonCircuit(class BlockSource&, class BlockPos const&) const; // NOLINT
