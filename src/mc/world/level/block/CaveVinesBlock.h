...
public:
     ...
     */
    MCAPI CaveVinesBlock(std::string const&, int, enum class CaveVinesVariant); // NOLINT
    /**
     * @symbol ?tryGrow\@CaveVinesBlock\@\@SAXAEAVBlockSource\@\@AEBVBlockPos\@\@MM\@Z
     */
    MCAPI static void tryGrow(class BlockSource&, class BlockPos const&, float, float); // NOLINT

    // private:
    /**
     * @symbol ?_isCaveVinesBlock\@CaveVinesBlock\@\@AEBA_NAEBVBlock\@\@\@Z
     */
    MCAPI bool _isCaveVinesBlock(class Block const&) const; // NOLINT
    /**
     * @symbol ?_pickBerries\@CaveVinesBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVActor\@\@\@Z
     */
    MCAPI bool _pickBerries(class BlockSource&, class BlockPos const&, class Actor&) const; // NOLINT
    /**
     * @symbol ?_updateBlockBasedOnNeighborBelow\@CaveVinesBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _updateBlockBasedOnNeighborBelow(class BlockSource&, class BlockPos const&) const; // NOLINT
