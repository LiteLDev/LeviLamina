...
public:
    ...
    // vIndex: 8, symbol: ?getAABB@PotatoBlock@@UEBAAEBVAABB@@AEBVIConstBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z
    ...
    // vIndex: 143, symbol: ?getVariant@PotatoBlock@@UEBAHAEBVBlock@@@Z
