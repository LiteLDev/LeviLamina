...
public:
     ...
     */
    MCAPI
    CopperBlock(std::string const&, int, enum class CopperType, class HashedString const&, class HashedString const&, class HashedString const&); // NOLINT
    /**
     * @symbol
     * ??0CopperBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HW4CopperType\@\@AEBVHashedString\@\@\@Z
     */
    MCAPI CopperBlock(std::string const&, int, enum class CopperType, class HashedString const&); // NOLINT
};
