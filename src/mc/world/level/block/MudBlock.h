...
public:
     ...
     * @vftbl 6
     * @symbol
     * ?getCollisionShape\@MudBlock\@\@UEBA_NAEAVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@V?$optional_ref\@$$CBVGetCollisionShapeInterface\@\@\@\@\@Z
     */
    virtual bool
     ...
     */
    MCAPI MudBlock(std::string const&, int); // NOLINT
    /**
