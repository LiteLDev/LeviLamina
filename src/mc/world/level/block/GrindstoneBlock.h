...
public:
     ...
     * @vftbl 8
     * @symbol
     * ?getAABB\@GrindstoneBlock\@\@UEBAAEBVAABB\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAV2\@_N\@Z
     */
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@GrindstoneBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
    ...
    /**
     * @vftbl 25
     * @symbol ?canProvideSupport\@GrindstoneBlock\@\@UEBA_NAEBVBlock\@\@EW4BlockSupportType\@\@\@Z
     */
    ...
    /**
     * @vftbl 108
     * @symbol ?getPlacementBlock\@GrindstoneBlock\@\@UEBAAEBVBlock\@\@AEBVActor\@\@AEBVBlockPos\@\@EAEBVVec3\@\@H\@Z
     */
    ...
    /**
     * @symbol
     * ??0GrindstoneBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCAPI GrindstoneBlock(std::string const&, int); // NOLINT
