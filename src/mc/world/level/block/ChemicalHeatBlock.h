...
public:
    ...
    /**
     * @symbol
     * ??0ChemicalHeatBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCAPI ChemicalHeatBlock(std::string const&, int); // NOLINT

    // private:
    /**
     * @symbol ?_queueTick\@ChemicalHeatBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@\@Z
     */
    MCAPI void _queueTick(class BlockSource&, class BlockPos const&, class Random&) const; // NOLINT
