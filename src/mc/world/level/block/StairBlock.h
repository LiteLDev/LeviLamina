...
public:
     ...
     */
    MCVAPI ~StairBlock(); // NOLINT
#endif
    /**
     * @symbol
     * ??0StairBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HAEBVBlockLegacy\@\@H\@Z
     */
    MCAPI StairBlock(std::string const&, int, class BlockLegacy const&, int); // NOLINT
    /**
     * @symbol
     * ?setInnerPieceShape\@StairBlock\@\@QEBA_NAEBVBlock\@\@AEBVBlockSource\@\@AEBVBlockPos\@\@AEAVAABB\@\@_N\@Z
     */
    MCAPI bool
    setInnerPieceShape(class Block const&, class BlockSource const&, class BlockPos const&, class AABB&, bool)
        const; // NOLINT
    /**
     * @symbol ?setStepShape\@StairBlock\@\@QEBA_NAEBVBlock\@\@AEBVBlockSource\@\@AEBVBlockPos\@\@AEAVAABB\@\@_N\@Z
     */
    MCAPI bool setStepShape(class Block const&, class BlockSource const&, class BlockPos const&, class AABB&, bool)
        const; // NOLINT
    /**
     * @symbol ?stairDirectionToFacing\@StairBlock\@\@SAEH\@Z
     */
    MCAPI static unsigned char stairDirectionToFacing(int); // NOLINT

    // protected:
    /**
     * @symbol ?shapeZFightShrink\@StairBlock\@\@IEBAXAEAVAABB\@\@\@Z
     */
    MCAPI void shapeZFightShrink(class AABB&) const; // NOLINT
