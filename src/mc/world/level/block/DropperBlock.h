...
public:
     ...
     */
    virtual void dispenseFrom(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ??0DropperBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCAPI DropperBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?getAttachedFace\@DropperBlock\@\@SAHH\@Z
     */
    MCAPI static int getAttachedFace(int); // NOLINT
};
