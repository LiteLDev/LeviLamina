...
public:
     ...
     */
    MCAPI GrassBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?fertilize\@GrassBlock\@\@QEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandomize\@\@\@Z
     */
    MCAPI bool fertilize(class BlockSource&, class BlockPos const&, class Randomize&) const; // NOLINT
    /**
     * @symbol ?MIN_BRIGHTNESS\@GrassBlock\@\@2UBrightness\@\@B
     */
    MCAPI static struct Brightness const MIN_BRIGHTNESS; // NOLINT

    // private:
    /**
     * @symbol ?_canBeGrass\@GrassBlock\@\@AEBA_NAEBVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool _canBeGrass(class BlockSource const&, class BlockPos const&) const; // NOLINT
