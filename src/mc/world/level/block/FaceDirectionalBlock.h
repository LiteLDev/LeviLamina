...
public:
     ...
     */
    MCVAPI ~FaceDirectionalBlock(); // NOLINT
#endif
    /**
     * @symbol
     * ??0FaceDirectionalBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HAEBVMaterial\@\@_NM\@Z
     */
    MCAPI FaceDirectionalBlock(std::string const&, int, class Material const&, bool, float); // NOLINT
    /**
     * @symbol ?getFaceFlipStatic\@FaceDirectionalBlock\@\@SA?AW4Flip\@\@EAEBVBlock\@\@_N\@Z
     */
    MCAPI static enum class Flip getFaceFlipStatic(unsigned char, class Block const&, bool); // NOLINT
    /**
     * @symbol ?getFacingDirection\@FaceDirectionalBlock\@\@SAEAEBVBlock\@\@_N\@Z
     */
    MCAPI static unsigned char getFacingDirection(class Block const&, bool); // NOLINT
    /**
     * @symbol ?getMappedFaceStatic\@FaceDirectionalBlock\@\@SAEEAEBVBlock\@\@_N\@Z
     */
    MCAPI static unsigned char getMappedFaceStatic(unsigned char, class Block const&, bool); // NOLINT
};
