...
public:
     ...
     * @vftbl 6
     * @symbol
     * ?getCollisionShape\@SnowBlock\@\@UEBA_NAEAVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@V?$optional_ref\@$$CBVGetCollisionShapeInterface\@\@\@\@\@Z
     */
    virtual bool
     ...
     */
    MCAPI SnowBlock(std::string const&, int); // NOLINT
};
