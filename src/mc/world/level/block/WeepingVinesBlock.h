...
public:
     ...
     */
    MCAPI WeepingVinesBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?placeVineString\@WeepingVinesBlock\@\@SAXAEAVBlockSource\@\@AEAVRandom\@\@AEBVBlockPos\@\@HHH\@Z
     */
    MCAPI static void
    placeVineString(class BlockSource&, class Random&, class BlockPos const&, int, int, int); // NOLINT

    // private:
    /**
     * @symbol ?_shouldGrow\@WeepingVinesBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@_K\@Z
     */
    MCAPI bool _shouldGrow(class BlockSource&, class BlockPos const&, unsigned __int64) const; // NOLINT
    /**
