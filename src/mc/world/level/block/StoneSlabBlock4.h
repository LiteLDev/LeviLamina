...
public:
    ...
    // vIndex: 95, symbol: ?asItemInstance@StoneSlabBlock4@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 119, symbol: ?isAuxValueRelevantForPicking@StoneSlabBlock4@@UEBA_NXZ
    virtual bool isAuxValueRelevantForPicking() const;

    // vIndex: 128, symbol: ?getVariant@StoneSlabBlock4@@UEBAHAEBVBlock@@@Z
    virtual int getVariant(class Block const& block) const;

    // vIndex: 159, symbol: ?getMapColor@StoneSlabBlock4@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual class mce::Color getMapColor(class BlockSource&, class BlockPos const&, class Block const& block) const;

    // symbol:
    // ??0StoneSlabBlock4@@QEAA@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H_NV?$WeakPtr@$$CBVBlockLegacy@@@@@Z
    MCAPI
    StoneSlabBlock4(std::string const& nameId, int id, bool fullSize, class WeakPtr<class BlockLegacy const> baseSlab);
