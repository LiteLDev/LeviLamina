...
public:
    ...
    // vIndex: 57, symbol: ?isValidAuxValue@StoneSlabBlock4@@UEBA_NH@Z
    ...
    // vIndex: 105, symbol: ?asItemInstance@StoneSlabBlock4@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 134, symbol: ?isAuxValueRelevantForPicking@StoneSlabBlock4@@UEBA_NXZ
    virtual bool isAuxValueRelevantForPicking() const;

    // vIndex: 143, symbol: ?getVariant@StoneSlabBlock4@@UEBAHAEBVBlock@@@Z
