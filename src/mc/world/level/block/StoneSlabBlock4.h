...
public:
    ...
    // vIndex: 164, symbol: ?getResourceItem@StoneSlabBlock4@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize&, class Block const& block, int) const;

    // vIndex: 166, symbol: ?getSilkTouchItemInstance@StoneSlabBlock4@@UEBA?AVItemInstance@@AEBVBlock@@@Z
    ...
    MCAPI StoneSlabBlock4(std::string const& nameId, int, bool fullSize, class WeakPtr<class BlockLegacy> baseSlab);
