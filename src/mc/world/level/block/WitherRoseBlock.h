...
public:
    ...
    // vIndex: 90, symbol: ?canBeFertilized@WitherRoseBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual bool canBeFertilized(class BlockSource&, class BlockPos const&, class Block const&) const;

    // vIndex: 95, symbol: ?mayPlaceOn@WitherRoseBlock@@MEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 134, symbol: ?isAuxValueRelevantForPicking@WitherRoseBlock@@UEBA_NXZ
    virtual bool isAuxValueRelevantForPicking() const;

    // vIndex: 144, symbol: ?canSpawnOn@WitherRoseBlock@@UEBA_NPEAVActor@@@Z
    virtual bool canSpawnOn(class Actor*) const;

    // vIndex: 148, symbol: ?animateTick@WitherRoseBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    ...
    // vIndex: 187, symbol: ?getSilkTouchItemInstance@WitherRoseBlock@@MEBA?AVItemInstance@@AEBVBlock@@@Z
