...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<8, 8> mUnk8ea9c4;
    ::ll::UntypedStorage<8, 8> mUnk1f185d;
    ::ll::UntypedStorage<8, 8> mUnk577f38;
    ::ll::UntypedStorage<8, 8> mUnk409b09;
    ::ll::UntypedStorage<8, 8> mUnk82ac1f;
    ::ll::UntypedStorage<8, 8> mUnk1a817d;
    // NOLINTEND
