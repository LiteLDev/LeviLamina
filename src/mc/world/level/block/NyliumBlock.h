...
public:
     ...
     */
    MCAPI NyliumBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?canBeNylium\@NyliumBlock\@\@QEBA_NAEBVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool canBeNylium(class BlockSource const&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?crimsonBlockProvider\@NyliumBlock\@\@SAAEBVBlock\@\@AEBVRandomize\@\@\@Z
     */
    MCAPI static class Block const& crimsonBlockProvider(class Randomize const&); // NOLINT
    /**
     * @symbol ?netherSproutBlockProvider\@NyliumBlock\@\@SAAEBVBlock\@\@AEBVRandomize\@\@\@Z
     */
    MCAPI static class Block const& netherSproutBlockProvider(class Randomize const&); // NOLINT
    /**
     * @symbol ?warpedBlockProvider\@NyliumBlock\@\@SAAEBVBlock\@\@AEBVRandomize\@\@\@Z
     */
    MCAPI static class Block const& warpedBlockProvider(class Randomize const&); // NOLINT
     ...
     */
    MCAPI bool
    _scatterVegetation(class BlockSource&, class BlockPos const&, class Random&, class std::function<class Block const&(class Randomize const&)>)
        const; // NOLINT
