...
public:
    ...
    // vIndex: 120, symbol: ?isAuxValueRelevantForPicking@StoneSlabBlock2@@UEBA_NXZ
    ...
    // vIndex: 164, symbol: ?getResourceItem@StoneSlabBlock2@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize&, class Block const& block, int) const;

    // vIndex: 166, symbol: ?getSilkTouchItemInstance@StoneSlabBlock2@@UEBA?AVItemInstance@@AEBVBlock@@@Z
