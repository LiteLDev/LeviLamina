...
public:
    ...
    /**
     * @symbol
     * ??0SlabBlockItem\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCAPI SlabBlockItem(std::string const&, int); // NOLINT
     ...
     */
    MCAPI bool
    _canConvertToDoubleBlock(class ItemStackBase&, class Actor&, unsigned char&, class Block const&) const; // NOLINT
