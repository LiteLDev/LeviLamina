...
public:
    ...
    /**
     * @vftbl 158
     * @symbol ?_addHardCodedBlockComponents\@IceBlock\@\@UEAAXXZ
     */
     ...
     */
    MCAPI IceBlock(std::string const&, int, bool); // NOLINT
    /**
     * @symbol ?melt\@IceBlock\@\@SAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI static void melt(class BlockSource&, class BlockPos const&); // NOLINT
};
