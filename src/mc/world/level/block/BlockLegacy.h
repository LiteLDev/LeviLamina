...
public:
    ...
    public:
        ...
        add(class BlockLegacy&,
            ...
            std::function<std::optional<int32_t>(class BlockLegacy const&, int32_t)>,
            std::function<class Block const*(class BlockLegacy const&, int32_t, int32_t)>,
...
public:
    ...
    LLNDAPI static optional_ref<BlockLegacy> tryGetFromRegistry(uint32_t legacyBlockID);
...
public:
     ...
     */
    MCAPI class Block const* tryGetStateFromLegacyData(uint16_t, bool unknown = false) const;
    /**
     * @symbol
