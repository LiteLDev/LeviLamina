...
public:
     ...
     */
    MCAPI BambooStalkBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?getMaxHeight\@BambooStalkBlock\@\@SAHAEBVBlockPos\@\@\@Z
     */
    MCAPI static int getMaxHeight(class BlockPos const&); // NOLINT

    // private:
    /**
     * @symbol ?_determineNewBlockState\@BambooStalkBlock\@\@AEBAAEBVBlock\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI class Block const& _determineNewBlockState(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?_getLeafSize\@BambooStalkBlock\@\@AEBA?AW4LeafSize\@\@AEBVBlock\@\@\@Z
     */
    MCAPI enum class LeafSize _getLeafSize(class Block const&) const; // NOLINT
    /**
     * @symbol ?_getStalkThickness\@BambooStalkBlock\@\@AEBA?AW4StalkThickness\@\@AEBVBlock\@\@\@Z
     */
    MCAPI enum class StalkThickness _getStalkThickness(class Block const&) const; // NOLINT
