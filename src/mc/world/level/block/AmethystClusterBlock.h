...
public:
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@AmethystClusterBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
     ...
     */
    MCAPI AmethystClusterBlock(std::string const&, int, int, int); // NOLINT

    // private:
    /**
     * @symbol ?_shapeFromDirection\@AmethystClusterBlock\@\@AEBA?AVAABB\@\@H\@Z
     */
    MCAPI class AABB _shapeFromDirection(int) const; // NOLINT
