...
public:
     ...
     */
    MCAPI FrostedIceBlock(std::string const&, int, bool); // NOLINT
    /**
     * @symbol ?_slightlyMelt\@FrostedIceBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@_N\@Z
     */
    MCAPI void _slightlyMelt(class BlockSource&, class BlockPos const&, class Random&, bool) const; // NOLINT
...
private:
     ...
     */
    MCAPI static int const MAX_AGE; // NOLINT
    /**
     * @symbol ?MIN_NEIGHBORS\@FrostedIceBlock\@\@0HB
     */
    MCAPI static int const MIN_NEIGHBORS; // NOLINT
};
