...
public:
    ...
    // vIndex: 7, symbol:
    // ?addCollisionShapes@EndGatewayBlock@@UEBA_NAEBVBlock@@AEBVBlockSource@@AEBVBlockPos@@PEBVAABB@@AEAV?$vector@VAABB@@V?$allocator@VAABB@@@std@@@std@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    virtual bool
    ...
    // vIndex: 64, symbol: ?canContainLiquid@EndGatewayBlock@@UEBA_NXZ
    ...
    // vIndex: 104, symbol:
    // ?spawnResources@EndGatewayBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    virtual void
    ...
    // vIndex: 105, symbol: ?asItemInstance@EndGatewayBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 148, symbol: ?animateTick@EndGatewayBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
