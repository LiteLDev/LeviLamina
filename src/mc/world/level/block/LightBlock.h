...
public:
     ...
     * @vftbl 8
     * @symbol
     * ?getAABB\@LightBlock\@\@UEBAAEBVAABB\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAV2\@_N\@Z
     */
     ...
     */
    MCAPI LightBlock(std::string const&, int, class Material const&); // NOLINT
};
