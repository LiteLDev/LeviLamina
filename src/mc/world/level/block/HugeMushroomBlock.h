...
public:
    // HugeMushroomBlock inner types declare
    // clang-format off
...
public:
     ...
     */
    MCAPI
    HugeMushroomBlock(std::string const&, int, class Material const&, enum class HugeMushroomBlock::Type); // NOLINT

    // private:
    /**
     * @symbol
     * ?_getBlockItemWithState\@HugeMushroomBlock\@\@AEBA?AVItemInstance\@\@AEBVBlock\@\@W4MushroomOuterType\@\@\@Z
     */
    MCAPI class ItemInstance _getBlockItemWithState(class Block const&, enum class MushroomOuterType) const; // NOLINT
