...
public:
    ...
    /**
     * @vftbl 105
     * @symbol ?asItemInstance\@StainedGlassPaneBlock\@\@UEBA?AVItemInstance\@\@AEBVBlock\@\@PEBVBlockActor\@\@\@Z
     */
     ...
     * @vftbl 133
     * @symbol
     * ?buildDescriptionId\@StainedGlassPaneBlock\@\@UEBA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@AEBVBlock\@\@\@Z
     */
     ...
     */
    MCAPI StainedGlassPaneBlock(std::string const&, int, class Material const&, bool, bool, bool); // NOLINT
};
