...
public:
    // NOLINTBEGIN
    // vIndex: 0, symbol: __gen_??1StainedGlassPaneBlock@@UEAA@XZ
    virtual ~StainedGlassPaneBlock() = default;
    ...
    // vIndex: 120, symbol: ?isAuxValueRelevantForPicking@StainedGlassPaneBlock@@UEBA_NXZ
