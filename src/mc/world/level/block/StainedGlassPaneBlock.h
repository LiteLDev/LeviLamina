...
public:
    ...
    // vIndex: 105, symbol: ?asItemInstance@StainedGlassPaneBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 134, symbol: ?isAuxValueRelevantForPicking@StainedGlassPaneBlock@@UEBA_NXZ
