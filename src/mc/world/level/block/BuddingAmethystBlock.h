...
public:
     ...
     */
    MCAPI BuddingAmethystBlock(std::string const&, int, class Material const&); // NOLINT
    /**
     * @symbol ?canBudGrowAtPos\@BuddingAmethystBlock\@\@SA_NAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI static bool canBudGrowAtPos(class BlockSource&, class BlockPos const&); // NOLINT
};
