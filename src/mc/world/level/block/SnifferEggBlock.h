...
public:
    ...
    // vIndex: 71, symbol: ?checkIsPathable@SnifferEggBlock@@UEBA_NAEAVActor@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 94, symbol: ?mayPlace@SnifferEggBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 143, symbol: ?getVariant@SnifferEggBlock@@UEBAHAEBVBlock@@@Z
