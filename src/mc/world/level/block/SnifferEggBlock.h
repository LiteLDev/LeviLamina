...
public:
     ...
     */
    MCAPI SnifferEggBlock(std::string const&, int); // NOLINT

    // private:
    /**
     * @symbol ?_addToRandomTickingQueue\@SnifferEggBlock\@\@CAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI static void _addToRandomTickingQueue(class BlockSource&, class BlockPos const&); // NOLINT
    /**
     * @symbol ?_shouldHatchFaster\@SnifferEggBlock\@\@CA_NAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI static bool _shouldHatchFaster(class BlockSource&, class BlockPos const&); // NOLINT
    /**
     * @symbol ?_spawnParticles\@SnifferEggBlock\@\@CAXW4LevelEvent\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI static void _spawnParticles(enum class LevelEvent, class BlockSource&, class BlockPos const&); // NOLINT
