...
public:
     ...
     */
    MCVAPI ~AmethystBlock(); // NOLINT
#endif
    /**
     * @symbol
     * ??0AmethystBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HAEBVMaterial\@\@\@Z
     */
    MCAPI AmethystBlock(std::string const&, int, class Material const&); // NOLINT
};
