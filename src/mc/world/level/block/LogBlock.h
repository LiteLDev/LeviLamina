...
public:
    ...
    // vIndex: 185, symbol: ?getResourceItem@LogBlock@@MEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize&, class Block const&, int) const;

    // vIndex: 187, symbol: ?getSilkTouchItemInstance@LogBlock@@MEBA?AVItemInstance@@AEBVBlock@@@Z
