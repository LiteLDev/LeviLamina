...
public:
    ...
    /**
     * @vftbl 158
     * @symbol ?_addHardCodedBlockComponents\@ObsidianBlock\@\@UEAAXXZ
     */
     ...
     */
    MCAPI ObsidianBlock(std::string const&, int, bool); // NOLINT
    /**
     * @symbol ?poofParticles\@ObsidianBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void poofParticles(class BlockSource&, class BlockPos const&) const; // NOLINT
};
