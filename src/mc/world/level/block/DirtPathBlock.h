...
public:
     ...
     * @vftbl 8
     * @symbol
     * ?getAABB\@DirtPathBlock\@\@UEBAAEBVAABB\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAV2\@_N\@Z
     */
    ...
    /**
     * @symbol
     * ??0DirtPathBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCAPI DirtPathBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?BLOCK_AABB\@DirtPathBlock\@\@2VAABB\@\@A
     */
    MCAPI static class AABB BLOCK_AABB; // NOLINT
};
