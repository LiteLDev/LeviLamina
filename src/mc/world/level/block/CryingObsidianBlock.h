...
public:
    ...
    // vIndex: 148, symbol: ?animateTick@CryingObsidianBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    ...
    // vIndex: 184, symbol: ?playerDestroy@CryingObsidianBlock@@UEBAXAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual void playerDestroy(class Player&, class BlockPos const&, class Block const&) const;

    // vIndex: 185, symbol: ?getResourceItem@CryingObsidianBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
