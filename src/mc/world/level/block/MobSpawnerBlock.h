...
public:
     ...
     * @vftbl 8
     * @symbol
     * ?getAABB\@MobSpawnerBlock\@\@UEBAAEBVAABB\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAV2\@_N\@Z
     */
    ...
    /**
     * @symbol
     * ??0MobSpawnerBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCAPI MobSpawnerBlock(std::string const&, int); // NOLINT
};
