...
public:
     ...
     */
    MCVAPI ~DeprecatedSlabBlockItem(); // NOLINT
#endif
    ...
    _canConvertToDoubleSlab(class ItemStackBase&, class Actor const&, unsigned char const&, class Block const&)
        const; // NOLINT
    /**
     * @symbol ?_findSlabType\@DeprecatedSlabBlockItem\@\@AEBAHAEBVBlock\@\@\@Z
     */
    MCAPI int _findSlabType(class Block const&) const; // NOLINT
