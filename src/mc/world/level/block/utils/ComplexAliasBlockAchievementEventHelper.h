...
/**
 * @symbol
 * ?getPostComplexAliasBlockToPreSplitBlockInfo\@ComplexAliasBlockAchievementEventHelper\@\@YA?AV?$optional\@V?$reference_wrapper\@$$CBUComplexAliasBlockPreSplitBlockInfo\@ComplexAliasBlockAchievementEventHelper\@\@\@std\@\@\@std\@\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@3\@\@Z
 */
MCAPI std::optional<
