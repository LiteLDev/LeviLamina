...
public:
    ...
    MCAPI static void loadJSON(class Json::Value value, class SemVersion const& engineVersion, class BlockDescriptor&);
    ...
    MCAPI static void
    loadJSON(class Json::Value value, class SemVersion const& engineVersion, std::vector<class BlockDescriptor>&);

    // symbol:
    // ?saveJSON@BlockListSerializer@@SAXAEBV?$vector@VBlockDescriptor@@V?$allocator@VBlockDescriptor@@@std@@@std@@AEAVValue@Json@@@Z
    MCAPI static void saveJSON(std::vector<class BlockDescriptor> const&, class Json::Value& value);
