...
public:
    ...
    // vIndex: 64, symbol: ?canContainLiquid@ThinFenceBlock@@UEBA_NXZ
    virtual bool canContainLiquid() const;

    // vIndex: 68, symbol: ?canBeUsedInCommands@ThinFenceBlock@@UEBA_NAEBVBaseGameVersion@@@Z
    ...
    // vIndex: 98, symbol: ?breaksFallingBlocks@ThinFenceBlock@@UEBA_NAEBVBlock@@VBaseGameVersion@@@Z
