...
public:
     ...
     */
    MCAPI ThinFenceBlock(std::string const&, int, class Material const&, bool, bool, bool); // NOLINT
...
private:
     ...
     */
    MCAPI static class BaseGameVersion const THIN_FENCE_DOESNT_BREAK_FALLING_BLOCK_VERSION; // NOLINT
};
