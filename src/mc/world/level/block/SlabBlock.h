...
public:
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@SlabBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
     ...
     */
    MCVAPI ~SlabBlock(); // NOLINT
#endif
    /**
     * @symbol
     * ??0SlabBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H_NAEBVMaterial\@\@V?$WeakPtr\@VBlockLegacy\@\@\@\@\@Z
     */
    MCAPI SlabBlock(std::string const&, int, bool, class Material const&, class WeakPtr<class BlockLegacy>); // NOLINT

    // protected:
    /**
     * @symbol ?getBaseSlab\@SlabBlock\@\@IEBAAEBVBlock\@\@XZ
     */
    MCAPI class Block const& getBaseSlab() const; // NOLINT
...
private:
     ...
     */
    MCAPI static class BaseGameVersion const TOP_SLAB_DOESNT_BREAK_FALLING_BLOCK_VERSION; // NOLINT
};
