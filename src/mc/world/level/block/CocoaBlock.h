...
public:
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@CocoaBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
     ...
     */
    MCAPI CocoaBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?isSupportedBy\@CocoaBlock\@\@SA_NAEBVBlock\@\@\@Z
     */
    MCAPI static bool isSupportedBy(class Block const&); // NOLINT
};
