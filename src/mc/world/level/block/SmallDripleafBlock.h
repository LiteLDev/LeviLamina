...
public:
     ...
     */
    MCAPI SmallDripleafBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?tryPlaceSmallDripleaf\@SmallDripleafBlock\@\@SA_NAEAVBlockSource\@\@AEBVBlockPos\@\@HH\@Z
     */
    MCAPI static bool tryPlaceSmallDripleaf(class BlockSource&, class BlockPos const&, int, int); // NOLINT

    // private:
    /**
     * @symbol ?_isViablePlacePos\@SmallDripleafBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool _isViablePlacePos(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?placeUpperBlock\@SmallDripleafBlock\@\@CAXAEAVBlockSource\@\@AEBVBlockPos\@\@H\@Z
     */
    MCAPI static void placeUpperBlock(class BlockSource&, class BlockPos const&, int); // NOLINT
