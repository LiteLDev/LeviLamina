...
public:
     ...
     */
    MCAPI FlowerPotBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?isSupportedBlock\@FlowerPotBlock\@\@SA_NAEBVBlock\@\@\@Z
     */
    MCAPI static bool isSupportedBlock(class Block const&); // NOLINT

    // private:
    /**
     * @symbol ?_tryPlaceFlower\@FlowerPotBlock\@\@AEBA_NAEAVPlayer\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool _tryPlaceFlower(class Player&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?_tryTakeFlower\@FlowerPotBlock\@\@AEBA_NAEAVPlayer\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool _tryTakeFlower(class Player&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol
