...
public:
    ...
    // vIndex: 64, symbol: ?canContainLiquid@MangrovePropaguleBlock@@UEBA_NXZ
    ...
    // vIndex: 90, symbol: ?canBeFertilized@MangrovePropaguleBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual bool canBeFertilized(class BlockSource&, class BlockPos const&, class Block const&) const;

    // vIndex: 95, symbol: ?mayPlaceOn@MangrovePropaguleBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 143, symbol: ?getVariant@MangrovePropaguleBlock@@UEBAHAEBVBlock@@@Z
