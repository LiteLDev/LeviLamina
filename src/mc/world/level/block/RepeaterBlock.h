...
public:
    ...
    // vIndex: 84, symbol: ?mayPlace@RepeaterBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 138, symbol: ?canBeSilkTouched@RepeaterBlock@@UEBA_NXZ
    ...
    // vIndex: 152, symbol: ?isInteractiveBlock@RepeaterBlock@@UEBA_NXZ
    virtual bool isInteractiveBlock() const;

    // vIndex: 153, symbol: ?use@RepeaterBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z
