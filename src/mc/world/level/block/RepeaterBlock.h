...
public:
     ...
     */
    virtual bool isLocked(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @vftbl 199
     * @symbol ?isAlternateInput\@RepeaterBlock\@\@MEBA_NAEBVBlock\@\@\@Z
     */
    virtual bool isAlternateInput(class Block const&) const; // NOLINT
    /**
     * @vftbl 203
     * @symbol ?getTurnOnDelay\@RepeaterBlock\@\@MEBAHAEBVBlock\@\@\@Z
     */
    virtual int getTurnOnDelay(class Block const&) const; // NOLINT
    /**
     * @vftbl 204
     * @symbol ?getOnBlock\@RepeaterBlock\@\@MEBAPEBVBlock\@\@PEBV2\@\@Z
     */
    virtual class Block const* getOnBlock(class Block const*) const; // NOLINT
    /**
     * @vftbl 205
     * @symbol ?getOffBlock\@RepeaterBlock\@\@MEBAPEBVBlock\@\@PEBV2\@\@Z
     */
    virtual class Block const* getOffBlock(class Block const*) const; // NOLINT
     ...
     */
    MCAPI RepeaterBlock(std::string const&, int, bool); // NOLINT
    /**
     * @symbol ?updateDelay\@RepeaterBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@_N\@Z
     */
    MCAPI void updateDelay(class BlockSource&, class BlockPos const&, bool) const; // NOLINT
    /**
     * @symbol ?DELAY_RENDER_OFFSETS\@RepeaterBlock\@\@2QBMB
     */
    MCAPI static float const DELAY_RENDER_OFFSETS[]; // NOLINT
...
private:
     ...
     */
    MCAPI static int const DELAYS[]; // NOLINT
};
