...
public:
    ...
    // vIndex: 66, symbol: ?shouldConnectToRedstone@TargetBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@H@Z
    virtual bool shouldConnectToRedstone(class BlockSource&, class BlockPos const&, int) const;

    // vIndex: 77, symbol: __unk_vfn_77
    virtual void __unk_vfn_77();

    // vIndex: 81, symbol: ?setupRedstoneComponent@TargetBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z
