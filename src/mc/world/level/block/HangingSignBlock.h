...
public:
    ...
    // vIndex: 6, symbol:
    // ?getCollisionShape@HangingSignBlock@@UEBA_NAEAVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    virtual bool
    ...
    // vIndex: 8, symbol:
    // ?getAABB@HangingSignBlock@@UEBAAEBVAABB@@AEBVIConstBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z
    ...
    // vIndex: 71, symbol: ?checkIsPathable@HangingSignBlock@@UEBA_NAEAVActor@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 93, symbol: ?mayPlace@HangingSignBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@E@Z
    ...
    // vIndex: 196, symbol: ?_getShape@HangingSignBlock@@MEBAXHAEAVAABB@@@Z
