...
public:
     ...
     */
    MCAPI HangingSignBlock(std::string const&, int, bool, enum class SignBlock::SignType); // NOLINT
    /**
     * @symbol ?isDoubleChainHangingSign\@HangingSignBlock\@\@SA_NAEBVBlock\@\@\@Z
     */
    MCAPI static bool isDoubleChainHangingSign(class Block const&); // NOLINT
    /**
     * @symbol ?isSideAttachedHangingSign\@HangingSignBlock\@\@SA_NAEBVBlock\@\@\@Z
     */
    MCAPI static bool isSideAttachedHangingSign(class Block const&); // NOLINT
    /**
     * @symbol ?isVShapedHangingSign\@HangingSignBlock\@\@SA_NAEBVBlock\@\@\@Z
     */
    MCAPI static bool isVShapedHangingSign(class Block const&); // NOLINT

    // protected:
    /**
     * @symbol ?_canAttachTo\@HangingSignBlock\@\@IEBA_NAEAVBlockSource\@\@VBlockPos\@\@EE\@Z
     */
    MCAPI bool _canAttachTo(class BlockSource&, class BlockPos, unsigned char, unsigned char) const; // NOLINT

    // private:
    /**
     * @symbol ?_isHangingSign\@HangingSignBlock\@\@CA_NAEBVBlock\@\@\@Z
     */
    MCAPI static bool _isHangingSign(class Block const&); // NOLINT
