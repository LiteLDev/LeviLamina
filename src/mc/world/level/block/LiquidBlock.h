...
public:
     ...
     */
    MCVAPI ~LiquidBlock(); // NOLINT
#endif
    /**
     * @symbol
     * ??0LiquidBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HAEBVMaterial\@\@\@Z
     */
    MCAPI LiquidBlock(std::string const&, int, class Material const&); // NOLINT
    /**
     * @symbol ?getTickDelay\@LiquidBlock\@\@QEBAHAEAVBlockSource\@\@\@Z
     */
    MCAPI int getTickDelay(class BlockSource&) const; // NOLINT
    /**
     * @symbol ?getHeightFromDepth\@LiquidBlock\@\@SAMH\@Z
     */
    MCAPI static float getHeightFromDepth(int); // NOLINT
    /**
     * @symbol
     * ?handleEntityInside\@LiquidBlock\@\@SAXAEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEAVVec3\@\@AEBVMaterial\@\@\@Z
     */
    MCAPI static void
    handleEntityInside(class IConstBlockSource const&, class BlockPos const&, class Vec3&, class Material const&); // NOLINT

    // protected:
    /**
     * @symbol ?emitFizzParticle\@LiquidBlock\@\@IEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void emitFizzParticle(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?solidify\@LiquidBlock\@\@IEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@1\@Z
     */
    MCAPI void solidify(class BlockSource&, class BlockPos const&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?trySpreadFire\@LiquidBlock\@\@IEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@\@Z
     */
    MCAPI void trySpreadFire(class BlockSource&, class BlockPos const&, class Random&) const; // NOLINT
    /**
     * @symbol ?getDepth\@LiquidBlock\@\@KAHAEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVMaterial\@\@\@Z
     */
    MCAPI static int getDepth(class IConstBlockSource const&, class BlockPos const&, class Material const&); // NOLINT
    /**
     * @symbol ?getRenderedDepth\@LiquidBlock\@\@KAHAEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVMaterial\@\@\@Z
     */
    MCAPI static int
    getRenderedDepth(class IConstBlockSource const&, class BlockPos const&, class Material const&); // NOLINT

    // private:
    /**
     * @symbol ?_solidify\@LiquidBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@1\@Z
     */
    MCAPI void _solidify(class BlockSource&, class BlockPos const&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?_getFlow\@LiquidBlock\@\@CA?AVVec3\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVMaterial\@\@\@Z
     */
    MCAPI static class Vec3
    _getFlow(class IConstBlockSource const&, class BlockPos const&, class Material const&); // NOLINT
