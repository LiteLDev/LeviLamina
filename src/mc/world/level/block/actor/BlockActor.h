...
private:
    ...
    MCAPI static class std::map<
        ...
        class std::allocator<struct std::pair<enum class BlockActorType const, std::string>>> const mClassIdMap;
    /**
     * @symbol
    ...
    MCAPI static class std::map<
        ...
        enum class BlockActorType,
        struct std::less<std::string>,
        class std::allocator<struct std::pair<std::string const, enum class BlockActorType>>> const mIdClassMap;
};
