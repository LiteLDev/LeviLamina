...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SIGNBLOCKACTOR_CACHEDLINEDATA
    public:
...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SIGNBLOCKACTOR_CACHEDMESSAGEDATA
    public:
...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SIGNBLOCKACTOR_TEXT
    public:
