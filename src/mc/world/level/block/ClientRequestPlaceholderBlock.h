...
public:
     ...
     * @vftbl 5
     * @symbol
     * ?clip\@ClientRequestPlaceholderBlock\@\@UEBA?AVHitResult\@\@AEBVBlockSource\@\@AEBVBlockPos\@\@AEBVVec3\@\@2_N\@Z
     */
     ...
     */
    MCAPI ClientRequestPlaceholderBlock(std::string const&, int, class Material const&); // NOLINT
};
