...
public:
    ...
    /**
     * @vftbl 105
     * @symbol ?asItemInstance\@PlanksBlock\@\@MEBA?AVItemInstance\@\@AEBVBlock\@\@PEBVBlockActor\@\@\@Z
     */
    ...
    /**
     * @vftbl 158
     * @symbol ?_addHardCodedBlockComponents\@PlanksBlock\@\@UEAAXXZ
     */
     ...
     */
    MCAPI PlanksBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?isValidWoodMaterial\@PlanksBlock\@\@SA_NH\@Z
     */
    MCAPI static bool isValidWoodMaterial(int); // NOLINT
    /**
     * @symbol
     * ?WOOD_NAMES\@PlanksBlock\@\@2V?$array\@V?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@$08\@std\@\@B
     */
    MCAPI static class std::array<std::string, 9> const WOOD_NAMES; // NOLINT
};
