...
public:
    ...
    // vIndex: 105, symbol: ?asItemInstance@PlanksBlock@@MEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 134, symbol: ?isAuxValueRelevantForPicking@PlanksBlock@@UEBA_NXZ
    ...
    // vIndex: 185, symbol: ?getResourceItem@PlanksBlock@@MEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize&, class Block const&, int) const;

    // vIndex: 187, symbol: ?getSilkTouchItemInstance@PlanksBlock@@MEBA?AVItemInstance@@AEBVBlock@@@Z
