...
public:
     ...
     * @vftbl 6
     * @symbol
     * ?getCollisionShape\@SoulSandBlock\@\@UEBA_NAEAVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@V?$optional_ref\@$$CBVGetCollisionShapeInterface\@\@\@\@\@Z
     */
    virtual bool
     ...
     * @vftbl 8
     * @symbol
     * ?getAABB\@SoulSandBlock\@\@UEBAAEBVAABB\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAV2\@_N\@Z
     */
     ...
     */
    MCAPI SoulSandBlock(std::string const&, int); // NOLINT
    /**
...
private:
     ...
     */
    MCAPI static class BaseGameVersion const SOUL_SAND_BREAKS_FALLING_BLOCK_VERSION; // NOLINT
};
