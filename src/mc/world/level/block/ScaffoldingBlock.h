...
public:
     ...
     */
    MCAPI ScaffoldingBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?MAX_STABILITY\@ScaffoldingBlock\@\@2HB
     */
    MCAPI static int const MAX_STABILITY; // NOLINT

    // protected:
    /**
     * @symbol ?calculateStability\@ScaffoldingBlock\@\@IEBAHAEBVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI int calculateStability(class BlockSource const&, class BlockPos const&) const; // NOLINT

    // private:
    /**
     * @symbol ?_updateBlockStability\@ScaffoldingBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool _updateBlockStability(class BlockSource&, class BlockPos const&) const; // NOLINT
