...
public:
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@ItemFrameBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
     ...
     */
    virtual class HashedString getSpawnedItemName() const; // NOLINT
     ...
     */
    MCAPI ItemFrameBlock(std::string const&, int); // NOLINT

    // private:
    /**
     * @symbol ?_checkAchievements\@ItemFrameBlock\@\@AEBAXAEAVPlayer\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _checkAchievements(class Player&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?getShape\@ItemFrameBlock\@\@AEBAXHAEAVAABB\@\@_N\@Z
     */
    MCAPI void getShape(int, class AABB&, bool) const; // NOLINT
