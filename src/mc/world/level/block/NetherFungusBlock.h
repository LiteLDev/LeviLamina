...
public:
    ...
    // vIndex: 8, symbol:
    // ?getAABB@NetherFungusBlock@@UEBAAEBVAABB@@AEBVIConstBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z
    ...
    // vIndex: 64, symbol: ?canContainLiquid@NetherFungusBlock@@UEBA_NXZ
    ...
    // vIndex: 90, symbol: ?canBeFertilized@NetherFungusBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual bool canBeFertilized(class BlockSource&, class BlockPos const&, class Block const&) const;

    // vIndex: 93, symbol: ?mayPlace@NetherFungusBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@E@Z
    virtual bool mayPlace(class BlockSource&, class BlockPos const&, uchar) const;

    // vIndex: 95, symbol: ?mayPlaceOn@NetherFungusBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    virtual bool mayPlaceOn(class BlockSource&, class BlockPos const&) const;

    // vIndex: 101, symbol: ?neighborChanged@NetherFungusBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
