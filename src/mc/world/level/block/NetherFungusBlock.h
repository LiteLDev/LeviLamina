...
public:
    ...
    // vIndex: 56, symbol: ?waterSpreadCausesSpawn@NetherFungusBlock@@UEBA_NXZ
    virtual bool waterSpreadCausesSpawn() const;

    // vIndex: 57, symbol: ?canContainLiquid@NetherFungusBlock@@UEBA_NXZ
    ...
    // vIndex: 82, symbol: ?canBeFertilized@NetherFungusBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual bool
    ...
    // vIndex: 87, symbol: ?mayPlaceOn@NetherFungusBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    virtual bool mayPlaceOn(class BlockSource& region, class BlockPos const& pos) const;

    // vIndex: 93, symbol: ?neighborChanged@NetherFungusBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
    virtual void
    neighborChanged(class BlockSource& region, class BlockPos const& pos, class BlockPos const& neighborPos) const;

    // vIndex: 148, symbol: ?tick@NetherFungusBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
    virtual void tick(class BlockSource& region, class BlockPos const& pos, class Random&) const;

    // vIndex: 154, symbol: ?canSurvive@NetherFungusBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
