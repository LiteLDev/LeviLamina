...
public:
     ...
     */
    MCAPI BellBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?hasValidAttachment\@BellBlock\@\@QEBA_NAEBVBlock\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool hasValidAttachment(class Block const&, class BlockSource&, class BlockPos const&) const; // NOLINT
    ...
    _determineAttachment(class Actor const&, class BlockSource&, class BlockPos const&, unsigned char) const; // NOLINT
    /**
     * @symbol
     * ?_getItemId\@BellBlock\@\@AEBAFAEBVBlockSource\@\@V?$basic_string_view\@DU?$char_traits\@D\@std\@\@\@std\@\@\@Z
     */
    MCAPI short _getItemId(class BlockSource const&, class std::basic_string_view<char, struct std::char_traits<char>>)
        const; // NOLINT
    /**
     * @symbol ?_getShape\@BellBlock\@\@AEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
    MCAPI class AABB const& _getShape(class Block const&, class AABB&) const; // NOLINT
    /**
     * @symbol ?_sendBellUsedEventToClient\@BellBlock\@\@AEBAXAEBVBlockSource\@\@AEBVActor\@\@\@Z
     */
    MCAPI void _sendBellUsedEventToClient(class BlockSource const&, class Actor const&) const; // NOLINT
    /**
     * @symbol ?_tryAttachToNeighbors\@BellBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@1H\@Z
     */
    MCAPI void
    _tryAttachToNeighbors(class BlockSource&, class BlockPos const&, class BlockPos const&, int) const; // NOLINT
