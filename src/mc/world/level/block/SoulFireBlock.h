...
public:
     ...
     * @vftbl 8
     * @symbol
     * ?getAABB\@SoulFireBlock\@\@UEBAAEBVAABB\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAV2\@_N\@Z
     */
     ...
     */
    MCAPI SoulFireBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?isValidSoulFireFuel\@SoulFireBlock\@\@SA_NAEBVBlockLegacy\@\@\@Z
     */
    MCAPI static bool isValidSoulFireFuel(class BlockLegacy const&); // NOLINT
};
