...
public:
    ...
    // vIndex: 64, symbol: ?canContainLiquid@SoulFireBlock@@UEBA_NXZ
    ...
    // vIndex: 91, symbol: ?mayPick@SoulFireBlock@@UEBA_NXZ
    virtual bool mayPick() const;

    // vIndex: 94, symbol: ?mayPlace@SoulFireBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    virtual bool mayPlace(class BlockSource&, class BlockPos const&) const;

    // vIndex: 101, symbol: ?neighborChanged@SoulFireBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z
    ...
    // vIndex: 148, symbol: ?animateTick@SoulFireBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
