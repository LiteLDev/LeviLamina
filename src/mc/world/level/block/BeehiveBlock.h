...
public:
     ...
     */
    MCAPI BeehiveBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?emitHoneyComb\@BeehiveBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void emitHoneyComb(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?evictAll\@BeehiveBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@_N\@Z
     */
    MCAPI void evictAll(class BlockSource&, class BlockPos const&, bool) const; // NOLINT
    /**
     * @symbol ?onPlayerPlace\@BeehiveBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void onPlayerPlace(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?deliverNectar\@BeehiveBlock\@\@SAXAEAVBlockSource\@\@AEBVBlock\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI static void deliverNectar(class BlockSource&, class Block const&, class BlockPos const&); // NOLINT
    /**
     * @symbol ?hasHoneyToHarvest\@BeehiveBlock\@\@SA_NAEBVBlock\@\@\@Z
     */
    MCAPI static bool hasHoneyToHarvest(class Block const&); // NOLINT
    /**
     * @symbol ?resetHoneyLevel\@BeehiveBlock\@\@SAXAEAVBlockSource\@\@AEBVBlock\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI static void resetHoneyLevel(class BlockSource&, class Block const&, class BlockPos const&); // NOLINT

    // private:
    /**
     * @symbol
     * ?_fillHoneyBottle\@BeehiveBlock\@\@AEBAXAEAVPlayer\@\@AEAVItemStack\@\@1AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void
    ...
    /**
     * @symbol
     * ?_getSilkTouchItemInstance\@BeehiveBlock\@\@AEBA?AVItemInstance\@\@AEBVBlock\@\@AEAVPlayer\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI class ItemInstance
    _getSilkTouchItemInstance(class Block const&, class Player&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?_playBottleSound\@BeehiveBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _playBottleSound(class BlockSource&, class BlockPos const&) const; // NOLINT
