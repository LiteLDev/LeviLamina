...
public:
     ...
     */
    virtual int getSignalStrength(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @vftbl 194
     * @symbol ?getSignalForData\@WeightedPressurePlateBlock\@\@MEBAHH\@Z
     */
    virtual int getSignalForData(int) const; // NOLINT
    /**
     * @vftbl 195
     * @symbol ?getRedstoneSignal\@WeightedPressurePlateBlock\@\@MEBAHH\@Z
     */
    virtual int getRedstoneSignal(int) const; // NOLINT
    /**
     * @symbol
     * ??0WeightedPressurePlateBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HAEBVMaterial\@\@H\@Z
     */
    MCAPI WeightedPressurePlateBlock(std::string const&, int, class Material const&, int); // NOLINT
    /**
     * @symbol ?MAX_WEIGHT_HEAVY\@WeightedPressurePlateBlock\@\@2HB
     */
    MCAPI static int const MAX_WEIGHT_HEAVY; // NOLINT
    /**
     * @symbol ?MAX_WEIGHT_LIGHT\@WeightedPressurePlateBlock\@\@2HB
     */
    MCAPI static int const MAX_WEIGHT_LIGHT; // NOLINT
};
