...
public:
    ...
    // vIndex: 163, symbol: ?getResourceItem@StoneSlabBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    virtual class ItemInstance getResourceItem(class Randomize&, class Block const& block, int) const;

    // vIndex: 165, symbol: ?getSilkTouchItemInstance@StoneSlabBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z
