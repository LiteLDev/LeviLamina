...
public:
    ...
    /**
     * @vftbl 105
     * @symbol ?asItemInstance\@SpongeBlock\@\@UEBA?AVItemInstance\@\@AEBVBlock\@\@PEBVBlockActor\@\@\@Z
     */
     ...
     */
    MCAPI SpongeBlock(std::string const&, int, class Material const&); // NOLINT

    // private:
    /**
     * @symbol ?_attemptAbsorbWater\@SpongeBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _attemptAbsorbWater(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?_evaporateWater\@SpongeBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _evaporateWater(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?_performAbsorbWater\@SpongeBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool _performAbsorbWater(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?_setShouldDry\@SpongeBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _setShouldDry(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?_spawnAbsorbParticles\@SpongeBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _spawnAbsorbParticles(class BlockSource&, class BlockPos const&) const; // NOLINT
