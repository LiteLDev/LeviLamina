...
public:
     ...
     */
    MCAPI UndyedShulkerBoxBlock(std::string const&, int); // NOLINT
     ...
     */
    MCAPI bool _isValidAttach(class BlockSource&, class BlockPos, unsigned char) const; // NOLINT

protected:
    /**
     * @symbol ?SHULKER_BOX_DOESNT_BREAK_FALLING_BLOCK_VERSION\@UndyedShulkerBoxBlock\@\@1VBaseGameVersion\@\@B
     */
    MCAPI static class BaseGameVersion const SHULKER_BOX_DOESNT_BREAK_FALLING_BLOCK_VERSION; // NOLINT
