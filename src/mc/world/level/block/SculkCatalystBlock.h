...
public:
     ...
     */
    MCAPI SculkCatalystBlock(std::string const&, int, class Material const&); // NOLINT
    /**
     * @symbol ?bloom\@SculkCatalystBlock\@\@SAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAVRandom\@\@\@Z
     */
    MCAPI static void bloom(class BlockSource&, class BlockPos const&, class Block const&, class Random&); // NOLINT
};
