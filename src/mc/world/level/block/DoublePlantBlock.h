...
public:
     ...
     */
    virtual class Block const& _keepRelevantStateForDropping(class Block const&) const; // NOLINT
    /**
     * @symbol
     * ??0DoublePlantBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCAPI DoublePlantBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?getType\@DoublePlantBlock\@\@QEBAHAEBVBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@\@Z
     */
    MCAPI int getType(class BlockSource const&, class BlockPos const&, class Block const&) const; // NOLINT
    /**
     * @symbol
     * ?placeAt\@DoublePlantBlock\@\@QEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@W4DoublePlantType\@\@HPEAVActor\@\@\@Z
     */
    MCAPI bool
    placeAt(class BlockSource&, class BlockPos const&, enum class DoublePlantType, int, class Actor*) const; // NOLINT
};
