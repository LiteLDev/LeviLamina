...
public:
     ...
     */
    MCAPI StainedGlassBlock(std::string const&, int, class Material const&, bool, bool); // NOLINT
...
private:
     ...
     */
    MCAPI static class BaseGameVersion const STAINED_GLASS_DOESNT_BREAK_FALLING_BLOCK_VERSION; // NOLINT
};
