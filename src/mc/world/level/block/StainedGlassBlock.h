...
public:
    ...
    // vIndex: 96, symbol: ?asItemInstance@StainedGlassBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 120, symbol: ?isAuxValueRelevantForPicking@StainedGlassBlock@@UEBA_NXZ
