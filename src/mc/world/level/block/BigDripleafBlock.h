...
public:
     ...
     */
    MCAPI BigDripleafBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?placeWithRandomHeight\@BigDripleafBlock\@\@SAXAEAVBlockSource\@\@AEAVRandom\@\@VBlockPos\@\@H\@Z
     */
    MCAPI static void placeWithRandomHeight(class BlockSource&, class Random&, class BlockPos, int); // NOLINT
    /**
     * @symbol ?MAX_DRIPLEAF_GROWTH_HEIGHT\@BigDripleafBlock\@\@2HB
     */
    MCAPI static int const MAX_DRIPLEAF_GROWTH_HEIGHT; // NOLINT

    // private:
    /**
     * @symbol ?_findHeadPos\@BigDripleafBlock\@\@AEBA?AVBlockPos\@\@AEAVBlockSource\@\@V2\@\@Z
     */
    MCAPI class BlockPos _findHeadPos(class BlockSource&, class BlockPos) const; // NOLINT
    /**
     * @symbol ?_resetTilt\@BigDripleafBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _resetTilt(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol
     * ?_setTiltAndScheduleTick\@BigDripleafBlock\@\@AEBAXW4BigDripleafTilt\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void
    _setTiltAndScheduleTick(enum class BigDripleafTilt, class BlockSource&, class BlockPos const&) const; // NOLINT
