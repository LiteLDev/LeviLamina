...
public:
    ...
    /**
     * @symbol
     * ??0RespawnAnchorBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCAPI RespawnAnchorBlock(std::string const&, int); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI static void _bumpCharge(class BlockSource&, class BlockPos const&, class Player*, short); // NOLINT
    /**
     * @symbol ?_explode\@RespawnAnchorBlock\@\@CAXAEAVPlayer\@\@AEBVBlockPos\@\@AEAVBlockSource\@\@AEAVLevel\@\@\@Z
     */
    MCAPI static void _explode(class Player&, class BlockPos const&, class BlockSource&, class Level&); // NOLINT
    /**
     * @symbol
     * ?_trySetSpawn\@RespawnAnchorBlock\@\@CA_NAEAVPlayer\@\@AEBVBlockPos\@\@AEAVBlockSource\@\@AEAVLevel\@\@\@Z
     */
    MCAPI static bool _trySetSpawn(class Player&, class BlockPos const&, class BlockSource&, class Level&); // NOLINT
