...
public:
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@StemBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
     ...
     */
    MCAPI StemBlock(std::string const&, int, class BlockLegacy const&); // NOLINT
    /**
     * @symbol ?getFruitBlock\@StemBlock\@\@QEBAAEBVBlockLegacy\@\@XZ
     */
    MCAPI class BlockLegacy const& getFruitBlock() const; // NOLINT

    // private:
    /**
     * @symbol ?getGrowthSpeed\@StemBlock\@\@AEBAMAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI float getGrowthSpeed(class BlockSource&, class BlockPos const&) const; // NOLINT
