...
public:
     ...
     */
    virtual class Block const& getMultifaceBlock() const; // NOLINT
    /**
     * @vftbl 193
     * @symbol ?getMultifaceSpreader\@GlowLichenBlock\@\@UEBAAEBVMultifaceSpreader\@\@XZ
     */
    virtual class MultifaceSpreader const& getMultifaceSpreader() const; // NOLINT
     ...
     */
    MCAPI GlowLichenBlock(std::string const&, int, class Material const&); // NOLINT
};
