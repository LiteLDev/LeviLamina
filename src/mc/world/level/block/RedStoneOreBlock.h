...
public:
    ...
    // vIndex: 164, symbol: ?getResourceCount@RedStoneOreBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z
    virtual int getResourceCount(class Randomize& randomize, class Block const&, int bonusLootLevel) const;

    // vIndex: 165, symbol: ?getSilkTouchItemInstance@RedStoneOreBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z
