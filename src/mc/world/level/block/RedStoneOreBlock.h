...
public:
     ...
     */
    virtual void _lightUpBlock(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol
     * ??0RedStoneOreBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H_N\@Z
     */
    MCAPI RedStoneOreBlock(std::string const&, int, bool); // NOLINT

    // private:
    /**
     * @symbol ?_poofParticles\@RedStoneOreBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _poofParticles(class BlockSource&, class BlockPos const&) const; // NOLINT
