...
public:
     ...
     * @vftbl 133
     * @symbol
     * ?buildDescriptionId\@ColoredTerracottaBlock\@\@UEBA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@AEBVBlock\@\@\@Z
     */
     ...
     * @vftbl 182
     * @symbol
     * ?getMapColor\@ColoredTerracottaBlock\@\@UEBA?AVColor\@mce\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@\@Z
     */
     ...
     */
    MCAPI ColoredTerracottaBlock(std::string const&, int, class Material const&); // NOLINT
};
