...
public:
     ...
     * @vftbl 8
     * @symbol
     * ?getAABB\@TorchBlock\@\@UEBAAEBVAABB\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAV2\@_N\@Z
     */
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@TorchBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
    ...
    /**
     * @vftbl 158
     * @symbol ?_addHardCodedBlockComponents\@TorchBlock\@\@UEAAXXZ
     */
     ...
     */
    MCAPI TorchBlock(std::string const&, int, enum class MaterialType); // NOLINT

    // protected:
    /**
     * @symbol ?_flameParticlePos\@TorchBlock\@\@IEBA?AVVec3\@\@AEBVBlockPos\@\@W4TorchFacing\@\@\@Z
     */
    MCAPI class Vec3 _flameParticlePos(class BlockPos const&, enum class TorchFacing) const; // NOLINT
    /**
     * @symbol ?canBePlacedOn\@TorchBlock\@\@IEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@E\@Z
     */
    MCAPI bool canBePlacedOn(class BlockSource&, class BlockPos const&, unsigned char) const; // NOLINT
...
private:
     ...
     */
    MCAPI static enum class TorchFacing const DATA_FROM_FACING[]; // NOLINT
    /**
     * @symbol ?FACING_FROM_DATA\@TorchBlock\@\@0QBGB
     */
    MCAPI static unsigned short const FACING_FROM_DATA[]; // NOLINT
};
