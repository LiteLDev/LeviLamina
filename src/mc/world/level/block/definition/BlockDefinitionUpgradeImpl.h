...
// functions
// NOLINTBEGIN
MCAPI ::SharedTypes::v1_26_20::BlockDefinition::GeometryComponent
...
MCAPI void transformFlowerPottable(
    ::BlockComponentDescription const& blockComponents,
    ::SharedTypes::v1_26_20::BlockDefinition::BlockComponents&
);
...
MCAPI ::std::unordered_map<
    ::std::string_view,
    ::std::function<
        void(::BlockComponentDescription const&, ::SharedTypes::v1_26_20::BlockDefinition::BlockComponents&)>>&
transformers();
// NOLINTEND
