...
public:
     ...
     */
    MCAPI TrapDoorBlock(std::string const&, int, class Material const&); // NOLINT

    // private:
    /**
     * @symbol ?_getShape\@TrapDoorBlock\@\@AEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@_N\@Z
     */
    MCAPI class AABB const& _getShape(class Block const&, class AABB&, bool) const; // NOLINT
    /**
     * @symbol ?_toggleOpen\@TrapDoorBlock\@\@AEBAXAEAVBlockSource\@\@PEAVActor\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _toggleOpen(class BlockSource&, class Actor*, class BlockPos const&) const; // NOLINT

private:
    /**
     * @symbol ?TRAP_DOOR_DOESNT_BREAK_FALLING_BLOCK_VERSION\@TrapDoorBlock\@\@0VBaseGameVersion\@\@B
     */
    MCAPI static class BaseGameVersion const TRAP_DOOR_DOESNT_BREAK_FALLING_BLOCK_VERSION; // NOLINT
};
