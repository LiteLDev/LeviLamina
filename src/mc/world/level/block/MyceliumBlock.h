...
public:
    ...
    /**
     * @symbol
     * ??0MyceliumBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCAPI MyceliumBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?MIN_BRIGHTNESS_TO_PERSIST\@MyceliumBlock\@\@2UBrightness\@\@B
     */
    MCAPI static struct Brightness const MIN_BRIGHTNESS_TO_PERSIST; // NOLINT
    /**
     * @symbol ?MIN_BRIGHTNESS_TO_SPREAD\@MyceliumBlock\@\@2UBrightness\@\@B
     */
    MCAPI static struct Brightness const MIN_BRIGHTNESS_TO_SPREAD; // NOLINT

    // private:
    /**
     * @symbol ?_canSpreadToBlock\@MyceliumBlock\@\@AEBA_NAEBVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI bool _canSpreadToBlock(class BlockSource const&, class BlockPos const&) const; // NOLINT
