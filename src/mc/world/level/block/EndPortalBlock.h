...
public:
    ...
    // vIndex: 6, symbol:
    // ?getCollisionShape@EndPortalBlock@@UEBA_NAEAVAABB@@AEBVBlock@@AEBVIConstBlockSource@@AEBVBlockPos@@V?$optional_ref@$$CBVGetCollisionShapeInterface@@@@@Z
    virtual bool
    ...
    // vIndex: 8, symbol:
    // ?getAABB@EndPortalBlock@@UEBAAEBVAABB@@AEBVIConstBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z
    ...
    // vIndex: 64, symbol: ?canContainLiquid@EndPortalBlock@@UEBA_NXZ
    ...
    // vIndex: 105, symbol: ?asItemInstance@EndPortalBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 148, symbol: ?animateTick@EndPortalBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
