...
public:
     ...
     */
    MCAPI LodestoneBlock(std::string const&, int, class Material const&); // NOLINT
    /**
     * @symbol ?getBlockActor\@LodestoneBlock\@\@SAPEAVLodestoneBlockActor\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI static class LodestoneBlockActor* getBlockActor(class BlockSource&, class BlockPos const&); // NOLINT
};
