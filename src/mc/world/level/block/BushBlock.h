...
public:
     ...
     */
    virtual void checkAlive(class BlockSource&, class BlockPos const&) const; // NOLINT
    /**
     * @vftbl 193
     * @symbol ?setGrowth\@BushBlock\@\@MEBAAEBVBlock\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@AEBV2\@GH\@Z
     */
    virtual class Block const&
    setGrowth(class BlockSource&, class BlockPos const&, class Block const&, unsigned short, int) const; // NOLINT
     ...
     */
    MCVAPI ~BushBlock(); // NOLINT
#endif
    /**
     * @symbol
     * ??0BushBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HAEBVMaterial\@\@\@Z
     */
    MCAPI BushBlock(std::string const&, int, class Material const&); // NOLINT
    /**
     * @symbol ?growCrops\@BushBlock\@\@QEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@W4FertilizerType\@\@\@Z
     */
    MCAPI bool growCrops(class BlockSource&, class BlockPos const&, enum class FertilizerType) const; // NOLINT
    /**
     * @symbol ?BUSH_VISUAL_SHAPE_MAX\@BushBlock\@\@2VVec3\@\@B
     */
    MCAPI static class Vec3 const BUSH_VISUAL_SHAPE_MAX; // NOLINT
    /**
     * @symbol ?BUSH_VISUAL_SHAPE_MIN\@BushBlock\@\@2VVec3\@\@B
     */
    MCAPI static class Vec3 const BUSH_VISUAL_SHAPE_MIN; // NOLINT
};
