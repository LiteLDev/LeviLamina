...
public:
     ...
     * @vftbl 8
     * @symbol
     * ?getAABB\@PitcherCropBlock\@\@UEBAAEBVAABB\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAV2\@_N\@Z
     */
     ...
     */
    MCAPI PitcherCropBlock(std::string const&, int); // NOLINT

    // private:
    /**
     * @symbol ?_grow\@PitcherCropBlock\@\@AEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@_N\@Z
     */
    MCAPI bool _grow(class BlockSource&, class BlockPos const&, bool) const; // NOLINT
