...
public:
     ...
     * @vftbl 6
     * @symbol
     * ?getCollisionShape\@HoneyBlock\@\@UEBA_NAEAVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@V?$optional_ref\@$$CBVGetCollisionShapeInterface\@\@\@\@\@Z
     */
    virtual bool
    ...
    /**
     * @vftbl 12
     * @symbol ?getVisualShape\@HoneyBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEAV2\@\@Z
     */
     ...
     */
    MCAPI HoneyBlock(std::string const&, int, class Material const&); // NOLINT
    /**
     * @symbol ?triggerSlidingDownEffects\@HoneyBlock\@\@SAXAEAVActor\@\@AEBVBlockPos\@\@AEBVBlock\@\@\@Z
     */
    MCAPI static void triggerSlidingDownEffects(class Actor&, class BlockPos const&, class Block const&); // NOLINT
};
