...
public:
    ...
    // vIndex: 138, symbol: ?canBeSilkTouched@LanternBlock@@UEBA_NXZ
    ...
    // vIndex: 163, symbol: ?getResourceItem@LanternBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
