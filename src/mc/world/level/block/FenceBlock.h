...
public:
     ...
     */
    MCAPI FenceBlock(std::string const&, int, class Material const&); // NOLINT
    /**
     * @symbol
...
private:
     ...
     */
    MCAPI static class BaseGameVersion const FENCE_DOESNT_BREAK_FALLING_BLOCK_VERSION; // NOLINT
};
