...
public:
    ...
    // vIndex: 95, symbol:
    // ?spawnResources@WebBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@AEBUResourceDropsContext@@@Z
    virtual void
    ...
    // vIndex: 143, symbol: ?_addHardCodedBlockComponents@WebBlock@@UEAAXXZ
    ...
    MCAPI WebBlock(std::string const& nameId, int);
