...
public:
     ...
     */
    MCAPI ChorusPlantBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?canGrowChorus\@ChorusPlantBlock\@\@SA_NAEBVBlock\@\@\@Z
     */
    MCAPI static bool canGrowChorus(class Block const&); // NOLINT
    /**
     * @symbol ?PLANT_HEIGHT\@ChorusPlantBlock\@\@2MB
     */
    MCAPI static float const PLANT_HEIGHT; // NOLINT
    /**
     * @symbol ?PLANT_ITEM_DIMENSION\@ChorusPlantBlock\@\@2MB
     */
    MCAPI static float const PLANT_ITEM_DIMENSION; // NOLINT
    /**
     * @symbol ?PLANT_WIDTH\@ChorusPlantBlock\@\@2MB
     */
    MCAPI static float const PLANT_WIDTH; // NOLINT
};
