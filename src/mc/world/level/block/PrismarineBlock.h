...
public:
    ...
    // vIndex: 105, symbol: ?asItemInstance@PrismarineBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 134, symbol: ?isAuxValueRelevantForPicking@PrismarineBlock@@UEBA_NXZ
    ...
    // vIndex: 185, symbol: ?getResourceItem@PrismarineBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
