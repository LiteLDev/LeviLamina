...
public:
    ...
    SetBlockProperty& operator=(SetBlockProperty const&);
    SetBlockProperty(SetBlockProperty const&);
    SetBlockProperty();
...
public:
    ...
    // vIndex: 2, symbol: ?executeAction@SetBlockProperty@@UEBAXAEAVRenderParams@@@Z
