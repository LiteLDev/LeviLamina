...
public:
     ...
     */
    MCAPI ColoredTorchBlock(std::string const&, int, enum class ColoredTorchColor); // NOLINT
    /**
     * @symbol ?getItemForColor\@ColoredTorchBlock\@\@SA?AVItemInstance\@\@W4ColoredTorchColor\@\@\@Z
     */
    MCAPI static class ItemInstance getItemForColor(enum class ColoredTorchColor); // NOLINT
};
