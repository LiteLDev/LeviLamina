...
public:
    ...
    // vIndex: 164, symbol: ?getResourceItem@ColoredTorchBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z
    ...
    MCAPI ColoredTorchBlock(std::string const& nameId, int, ::ColoredTorchColor baseColor);
