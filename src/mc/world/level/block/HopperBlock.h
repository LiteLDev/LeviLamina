...
public:
     ...
     */
    MCAPI HopperBlock(std::string const&, int); // NOLINT
    /**
     * @symbol ?getAttachedOffset\@HopperBlock\@\@SA?AVBlockPos\@\@E\@Z
     */
    MCAPI static class BlockPos getAttachedOffset(unsigned char); // NOLINT

    // private:
    /**
     * @symbol ?_getSpoutAABB\@HopperBlock\@\@AEBA?AVAABB\@\@AEBVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI class AABB _getSpoutAABB(class BlockSource const&, class BlockPos const&) const; // NOLINT
    /**
     * @symbol ?_installCircuit\@HopperBlock\@\@AEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void _installCircuit(class BlockSource&, class BlockPos const&) const; // NOLINT

private:
    /**
     * @symbol ?HOPPER_DOESNT_BREAK_FALLING_BLOCK_VERSION\@HopperBlock\@\@0VBaseGameVersion\@\@B
     */
    MCAPI static class BaseGameVersion const HOPPER_DOESNT_BREAK_FALLING_BLOCK_VERSION; // NOLINT
};
