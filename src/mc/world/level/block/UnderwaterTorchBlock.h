...
public:
    ...
    // vIndex: 64, symbol: ?canContainLiquid@UnderwaterTorchBlock@@UEBA_NXZ
    virtual bool canContainLiquid() const;

    // vIndex: 68, symbol: ?canBeUsedInCommands@UnderwaterTorchBlock@@UEBA_NAEBVBaseGameVersion@@@Z
    ...
    // vIndex: 94, symbol: ?mayPlace@UnderwaterTorchBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z
    ...
    // vIndex: 148, symbol: ?animateTick@UnderwaterTorchBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z
