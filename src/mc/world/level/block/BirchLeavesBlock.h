...
public:
    ...
    // symbol:
    // ??0BirchLeavesBlock@@QEAA@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@HV?$WeakPtr@VBlockLegacy@@@@@Z
    MCAPI BirchLeavesBlock(std::string const&, int, class WeakPtr<class BlockLegacy>);
