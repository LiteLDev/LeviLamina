...
public:
    ...
    // vIndex: 9, symbol: ?init@Dimension@@UEAAXAEBVStructureSetRegistry@worldgen@br@@@Z
    virtual void init(class br::worldgen::StructureSetRegistry const&);

    // vIndex: 10, symbol: ?tick@Dimension@@UEAAXXZ
    virtual void tick();

    // vIndex: 11, symbol: ?tickRedstone@Dimension@@UEAAXXZ
    ...
    // vIndex: 16, symbol: ?isValidSpawn@Dimension@@UEBA_NHH@Z
    virtual bool isValidSpawn(int x, int z) const;

    // vIndex: 17, symbol: ?getBrightnessDependentFogColor@Dimension@@UEBA?AVColor@mce@@AEBV23@M@Z
    virtual class mce::Color getBrightnessDependentFogColor(class mce::Color const& baseColor, float brightness) const;

    // vIndex: 18, symbol: ?isFoggyAt@Dimension@@UEBA_NHH@Z
    virtual bool isFoggyAt(int x, int z) const;

    // vIndex: 19, symbol: ?hasPrecipitationFog@Dimension@@UEBA_NXZ
    virtual bool hasPrecipitationFog() const;

    // vIndex: 20, symbol: ?getCloudHeight@Dimension@@UEBAFXZ
    virtual short getCloudHeight() const;

    // vIndex: 21, symbol: ?getDefaultBiome@Dimension@@UEBA?AVHashedString@@XZ
    virtual class HashedString getDefaultBiome() const;

    // vIndex: 22, symbol: ?mayRespawnViaBed@Dimension@@UEBA_NXZ
    virtual bool mayRespawnViaBed() const;

    // vIndex: 23, symbol: ?hasGround@Dimension@@UEBA_NXZ
    virtual bool hasGround() const;

    // vIndex: 24, symbol: ?getSpawnPos@Dimension@@UEBA?AVBlockPos@@XZ
    virtual class BlockPos getSpawnPos() const;

    // vIndex: 25, symbol: ?getSpawnYPosition@Dimension@@UEBAHXZ
    virtual int getSpawnYPosition() const;

    // vIndex: 26, symbol: ?hasBedrockFog@Dimension@@UEAA_NXZ
    virtual bool hasBedrockFog();

    // vIndex: 27, symbol: ?getClearColorScale@Dimension@@UEAAMXZ
    virtual float getClearColorScale();

    // vIndex: 28, symbol: ?showSky@Dimension@@UEBA_NXZ
    virtual bool showSky() const;

    // vIndex: 29, symbol: ?isDay@Dimension@@UEBA_NXZ
    virtual bool isDay() const;

    // vIndex: 30, symbol: ?getTimeOfDay@Dimension@@MEBAMHM@Z
    virtual float getTimeOfDay(int time, float a) const;

    // vIndex: 31, symbol: ?getSunIntensity@Dimension@@UEBAMMAEBVVec3@@M@Z
    virtual float getSunIntensity(float a, class Vec3 const& viewVector, float minInfluenceAngle) const;

    // vIndex: 32, symbol: ?forceCheckAllNeighChunkSavedStat@Dimension@@UEBA_NXZ
    virtual bool forceCheckAllNeighChunkSavedStat() const;

    // vIndex: 33, vIndex: 34, symbol: ?sendBroadcast@Dimension@@UEAAXAEBVPacket@@PEAVPlayer@@@Z
    virtual void sendBroadcast(class Packet const& packet, class Player* except);

    // vIndex: 34, symbol: ?is2DPositionRelevantForPlayer@Dimension@@UEBA_NAEBVBlockPos@@AEAVPlayer@@@Z
    virtual bool is2DPositionRelevantForPlayer(class BlockPos const& position, class Player& player) const;

    // vIndex: 35, symbol: ?isActorRelevantForPlayer@Dimension@@UEBA_NAEAVPlayer@@AEBVActor@@@Z
    virtual bool isActorRelevantForPlayer(class Player& player, class Actor const& actor) const;

    // vIndex: 36, symbol: ?getLightTextureImageBuilder@Dimension@@UEBAPEAVBaseLightTextureImageBuilder@@XZ
    virtual class BaseLightTextureImageBuilder* getLightTextureImageBuilder() const;

    // vIndex: 37, symbol: ?getBrightnessRamp@Dimension@@UEBAAEBVDimensionBrightnessRamp@@XZ
    virtual class DimensionBrightnessRamp const& getBrightnessRamp() const;

    // vIndex: 38, symbol: ?startLeaveGame@Dimension@@UEAAXXZ
