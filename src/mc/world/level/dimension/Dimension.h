...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_DIMENSION_PLAYERREPLICATIONSTRUCTURES
    public:
...
public:
     ...
     */
    MCAPI class Player*
    fetchNearestPlayer(class Vec3 const&, float, bool, class std::function<bool(class Player const&)>) const;
    /**
