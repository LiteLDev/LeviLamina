...
public:
     ...
     */
    virtual class OwnerPtrT<struct SharePtrRefTraits<class Dimension>> create(std::string const&) const; // NOLINT
    /**
     * @vftbl 2
     * @symbol ?initializeDimension\@DimensionFactory\@\@UEBAXAEAVDimension\@\@\@Z
     */
    virtual void initializeDimension(class Dimension&) const; // NOLINT
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_DIMENSIONFACTORY
    /**
     * @symbol __unk_destructor_-1
     */
    MCVAPI ~DimensionFactory(); // NOLINT
#endif
    /**
     * @symbol
     ...
     */
    MCAPI
        DimensionFactory(class gsl::not_null<class Bedrock::NonOwnerPointer<class ILevel>>, class gsl::not_null<class Bedrock::NonOwnerPointer<class Scheduler>>); // NOLINT
    /**
     * @symbol
     * ?getDimensionOwnerPtrFactory\@DimensionFactory\@\@QEAAAEAV?$OwnerPtrFactory\@VDimension\@\@AEAVILevel\@\@AEAVScheduler\@\@\@\@XZ
     */
    MCAPI class OwnerPtrFactory<class Dimension, class ILevel&, class Scheduler&>&
    getDimensionOwnerPtrFactory(); // NOLINT
    /**
     * @symbol
    ...
    getDimensionOwnerPtrFactory() const; // NOLINT
};
