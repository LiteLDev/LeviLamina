...
// functions
// NOLINTBEGIN
MCAPI_C ::std::unique_ptr<::IGameModeMessenger> createClientMessenger(::Player& player);

MCAPI_C ::std::unique_ptr<::IGameModeMessenger> createClientMessengerWithServerAuthBlockBreaking(::Player& player);
