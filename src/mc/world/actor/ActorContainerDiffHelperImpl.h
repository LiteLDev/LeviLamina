...
MCAPI std::vector<gsl::not_null<class DataItem const*>> const _createListOfPointers(class SynchedActorData const&);
...
MCAPI std::vector<std::unique_ptr<class DataItem>>
      _getDiff(class SynchedActorData const&, class SynchedActorData const&);
