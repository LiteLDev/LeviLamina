...
public:
     ...
     */
    MCAPI Sheep(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
    /**
     * @symbol ?isGrazing\@Sheep\@\@QEBA_NXZ
     */
    MCAPI bool isGrazing() const; // NOLINT
    /**
...
private:
     ...
     */
    MCAPI static int const EAT_ANIMATION_TICKS; // NOLINT
};
