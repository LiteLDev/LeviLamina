...
public:
    ...
    // vIndex: 69, symbol: ?getShadowRadius@Turtle@@UEBAMXZ
    ...
    // vIndex: 224, symbol: ?die@Turtle@@UEAAXAEBVActorDamageSource@@@Z
    ...
    // vIndex: 312, symbol: ?_getWalkTargetValue@Turtle@@UEAAMAEBVBlockPos@@@Z
