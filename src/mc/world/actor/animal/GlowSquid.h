...
public:
    ...
    /**
     * @symbol
     * ??0GlowSquid\@\@QEAA\@PEAVActorDefinitionGroup\@\@AEBUActorDefinitionIdentifier\@\@AEAVEntityContext\@\@\@Z
     */
    MCAPI
    GlowSquid(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT

    // private:
    /**
     * @symbol ?_startGoingDark\@GlowSquid\@\@AEAAXXZ
     */
    MCAPI void _startGoingDark(); // NOLINT
