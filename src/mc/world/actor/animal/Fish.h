...
public:
    ...
    // vIndex: 47, symbol: ?startRiding@Fish@@UEAA_NAEAVActor@@@Z
    ...
    // vIndex: 237, symbol: ?updateEntitySpecificMolangVariables@Fish@@UEAAXAEAVRenderParams@@@Z
    ...
    // vIndex: 306, symbol: ?createAIGoals@Fish@@UEAA_NXZ
