...
public:
     ...
     */
    MCAPI Panda(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
    /**
     * @symbol ?getLieOnBackAmount\@Panda\@\@QEBAMM\@Z
     */
    MCAPI float getLieOnBackAmount(float) const; // NOLINT
    /**
     * @symbol ?getSitAmount\@Panda\@\@QEBAMM\@Z
     */
    MCAPI float getSitAmount(float) const; // NOLINT
    /**
     * @symbol ?getSneezeCounter\@Panda\@\@QEBAHXZ
     */
    MCAPI int getSneezeCounter() const; // NOLINT
    /**
     * @symbol ?getUnhappyCounter\@Panda\@\@QEBAHXZ
     */
    MCAPI int getUnhappyCounter() const; // NOLINT
    /**
