...
public:
    ...
    // vIndex: 119, symbol: ?getAmbientSound@Panda@@UEBA?AW4LevelSoundEvent@@XZ
    ...
    // vIndex: 243, symbol: ?readAdditionalSaveData@Panda@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const&, class DataLoadHelper&);

    // vIndex: 247, symbol: __unk_vfn_247
    virtual void __unk_vfn_247();

    // vIndex: 252, symbol: ?_onSizeUpdated@Panda@@UEAAXXZ
    ...
    // vIndex: 309, symbol: ?setTransitioningSitting@Panda@@UEAAX_N@Z
