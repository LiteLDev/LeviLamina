...
public:
    ...
    // vIndex: 47, symbol: ?startRiding@TropicalFish@@UEAA_NAEAVActor@@@Z
    ...
    // vIndex: 173, symbol: ?onSynchedDataUpdate@TropicalFish@@UEAAXH@Z
    ...
    // vIndex: 237, symbol: ?updateEntitySpecificMolangVariables@TropicalFish@@UEAAXAEAVRenderParams@@@Z
    ...
    // vIndex: 306, symbol: ?createAIGoals@TropicalFish@@UEAA_NXZ
