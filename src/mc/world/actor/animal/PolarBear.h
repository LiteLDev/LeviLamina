...
public:
    ...
    /**
     * @symbol
     * ??0PolarBear\@\@QEAA\@PEAVActorDefinitionGroup\@\@AEBUActorDefinitionIdentifier\@\@AEAVEntityContext\@\@\@Z
     */
    MCAPI
    PolarBear(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
    /**
     * @symbol ?getStandingAnimationScale\@PolarBear\@\@QEAAMM\@Z
     */
    MCAPI float getStandingAnimationScale(float); // NOLINT
...
private:
     ...
     */
    MCAPI static float const STAND_ANIMATION_TICKS; // NOLINT
};
