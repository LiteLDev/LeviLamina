...
public:
    ...
    /**
     * @vftbl 168
     * @symbol ?causeFallDamage\@Camel\@\@MEAAXMMVActorDamageSource\@\@\@Z
     */
     ...
     */
    MCAPI Camel(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
    /**
     * @symbol ?getDashCooldown\@Camel\@\@QEBA?AV?$optional\@VExpiringTick\@\@\@std\@\@XZ
     */
    MCAPI class std::optional<class ExpiringTick> getDashCooldown() const; // NOLINT

    // private:
    /**
     * @symbol ?_monitorSitting\@Camel\@\@AEAAXXZ
     */
    MCAPI void _monitorSitting(); // NOLINT
