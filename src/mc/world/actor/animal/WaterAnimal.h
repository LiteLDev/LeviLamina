...
public:
     ...
     */
    virtual float getFlopVerticalVelocityFactor() const; // NOLINT
    /**
     * @vftbl 326
     * @symbol ?getFlopHorizontalVelocityFactor\@WaterAnimal\@\@UEBAMXZ
     */
    virtual float getFlopHorizontalVelocityFactor() const; // NOLINT
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_WATERANIMAL
    /**
     * @symbol __unk_destructor_-1
     */
    MCVAPI ~WaterAnimal(); // NOLINT
#endif
    /**
     * @symbol
     ...
     */
    MCAPI
    WaterAnimal(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
    /**
