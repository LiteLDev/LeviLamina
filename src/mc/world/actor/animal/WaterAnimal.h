...
public:
    ...
    // vIndex: 268, symbol: ?checkSpawnRules@WaterAnimal@@UEAA_N_N@Z
    ...
    // vIndex: 325, symbol: ?getFlopVerticalVelocityFactor@WaterAnimal@@UEBAMXZ
    virtual float getFlopVerticalVelocityFactor() const;

    // vIndex: 326, symbol: ?getFlopHorizontalVelocityFactor@WaterAnimal@@UEBAMXZ
