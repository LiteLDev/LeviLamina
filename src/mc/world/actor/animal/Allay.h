...
public:
     ...
     */
    MCAPI Allay(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
    /**
     * @symbol ?hasDuplicationCooldown\@Allay\@\@QEAA_NXZ
     */
    MCAPI bool hasDuplicationCooldown(); // NOLINT
    /**
     * @symbol ?setNewDuplicationCooldown\@Allay\@\@QEAAXXZ
     */
    MCAPI void setNewDuplicationCooldown(); // NOLINT
};
