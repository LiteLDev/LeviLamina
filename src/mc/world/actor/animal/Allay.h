...
public:
    ...
    // vIndex: 243, symbol: ?readAdditionalSaveData@Allay@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const&, class DataLoadHelper&);

    // vIndex: 244, symbol: ?addAdditionalSaveData@Allay@@UEBAXAEAVCompoundTag@@@Z
    ...
    // vIndex: 264, symbol: ?aiStep@Allay@@UEAAXXZ
    virtual void aiStep();
