...
public:
    ...
    // vIndex: 167, symbol: ?checkFallDamage@Bat@@MEAAXM_N@Z
    ...
    // vIndex: 240, symbol: ?_hurt@Bat@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    virtual bool _hurt(class ActorDamageSource const&, float, bool, bool);

    // vIndex: 243, symbol: ?readAdditionalSaveData@Bat@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const&, class DataLoadHelper&);

    // vIndex: 244, symbol: ?addAdditionalSaveData@Bat@@UEBAXAEAVCompoundTag@@@Z
    ...
    // vIndex: 266, symbol: ?pushActors@Bat@@UEAAXXZ
    ...
    // vIndex: 318, symbol: ?newServerAiStep@Bat@@MEAAXXZ
