...
public:
     ...
     */
    MCAPI Bat(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
    /**
     ...
     */
    MCAPI static bool hasRestingBlockAbove(class Vec3 const&, class BlockSource const&); // NOLINT
};
