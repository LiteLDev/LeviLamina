...
public:
     ...
     */
    MCAPI Ocelot(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
    /**
     * @symbol ?SNEAK_SPEED_MOD\@Ocelot\@\@2MB
     */
    MCAPI static float const SNEAK_SPEED_MOD; // NOLINT
    /**
     * @symbol ?SPRINT_SPEED_MOD\@Ocelot\@\@2MB
     */
    MCAPI static float const SPRINT_SPEED_MOD; // NOLINT
};
