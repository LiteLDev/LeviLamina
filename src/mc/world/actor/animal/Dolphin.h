...
public:
    // NOLINTBEGIN
    // vIndex: 12, symbol:
    // ?initializeComponents@Dolphin@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 176, symbol: ?canBePulledIntoVehicle@Dolphin@@UEBA_NXZ
    ...
    // vIndex: 264, symbol: ?aiStep@Dolphin@@UEAAXXZ
    virtual void aiStep();
    ...
    // vIndex: 306, symbol: ?createAIGoals@Dolphin@@UEAA_NXZ
    virtual bool createAIGoals();

    // vIndex: 312, symbol: ?_getWalkTargetValue@Dolphin@@UEAAMAEBVBlockPos@@@Z
