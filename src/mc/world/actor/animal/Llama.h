...
public:
    ...
    // vIndex: 109, symbol: ?onFailedTame@Llama@@UEAAXXZ
    virtual void onFailedTame();

    // vIndex: 164, symbol: __unk_vfn_164
    virtual void __unk_vfn_164();

    // vIndex: 168, symbol: ?causeFallDamage@Llama@@MEAAXMMVActorDamageSource@@@Z
    ...
    // vIndex: 237, symbol: ?updateEntitySpecificMolangVariables@Llama@@UEAAXAEAVRenderParams@@@Z
    virtual void updateEntitySpecificMolangVariables(class RenderParams&);

    // vIndex: 239, symbol: __unk_vfn_239
    virtual void __unk_vfn_239();

    // vIndex: 245, symbol: ?_playStepSound@Llama@@MEAAXAEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 285, symbol: ?getArmorValue@Llama@@UEBAHXZ
