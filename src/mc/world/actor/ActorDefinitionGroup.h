...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_ACTORDEFINITIONGROUP_LOADACTORRESULT
    public:
...
public:
     ...
     */
    MCAPI static void
    forEachComponentOf(class Json::Value&, std::string const&, class std::function<void(class Json::Value&, class Json::Value&)> const&);
    /**
     * @symbol
