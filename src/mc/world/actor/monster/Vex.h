...
public:
    ...
    // vIndex: 52, symbol: ?isInWall@Vex@@UEBA_NXZ
    ...
    // vIndex: 243, symbol: ?readAdditionalSaveData@Vex@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const&, class DataLoadHelper&);

    // vIndex: 244, symbol: ?addAdditionalSaveData@Vex@@UEBAXAEAVCompoundTag@@@Z
