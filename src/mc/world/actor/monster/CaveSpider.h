...
public:
     ...
     */
    virtual float getModelScale() const; // NOLINT
    /**
     * @vftbl 327
     * @symbol ?getSpiderType\@CaveSpider\@\@UEBA?AW4Type\@Spider\@\@XZ
     */
    virtual enum class Spider::Type getSpiderType() const; // NOLINT
    /**
     * @symbol
     * ??0CaveSpider\@\@QEAA\@PEAVActorDefinitionGroup\@\@AEBUActorDefinitionIdentifier\@\@AEAVEntityContext\@\@\@Z
     */
    MCAPI
    CaveSpider(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
};
