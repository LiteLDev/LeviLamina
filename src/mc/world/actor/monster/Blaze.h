...
public:
    ...
    // vIndex: 76, symbol: ?getBrightness@Blaze@@UEBAMMAEBVIConstBlockSource@@@Z
    ...
    // vIndex: 91, symbol: ?isOnFire@Blaze@@UEBA_NXZ
    ...
    // vIndex: 264, symbol: ?aiStep@Blaze@@UEAAXXZ
    virtual void aiStep();
    ...
    // vIndex: 325, symbol: ?isDarkEnoughToSpawn@Blaze@@UEBA_NXZ
