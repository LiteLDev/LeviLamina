...
public:
     ...
     */
    MCVAPI ~HumanoidMonster(); // NOLINT
#endif
    /**
     * @symbol
     * ??0HumanoidMonster\@\@QEAA\@PEAVActorDefinitionGroup\@\@AEBUActorDefinitionIdentifier\@\@AEAVEntityContext\@\@\@Z
     */
    MCAPI
    HumanoidMonster(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
...
private:
     ...
     */
    MCAPI static float const MAX_ENCHANTED_ARMOR_CHANCE; // NOLINT
    /**
     * @symbol ?MAX_ENCHANTED_WEAPON_CHANCE\@HumanoidMonster\@\@0MB
     */
    MCAPI static float const MAX_ENCHANTED_WEAPON_CHANCE; // NOLINT
    /**
     * @symbol ?MAX_PICKUP_LOOT_CHANCE\@HumanoidMonster\@\@0MB
     */
    MCAPI static float const MAX_PICKUP_LOOT_CHANCE; // NOLINT
    /**
     * @symbol ?MAX_WEARING_ARMOR_CHANCE\@HumanoidMonster\@\@0MB
     */
    MCAPI static float const MAX_WEARING_ARMOR_CHANCE; // NOLINT
};
