...
public:
    ...
    // vIndex: 240, symbol: ?_hurt@PigZombie@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    virtual bool _hurt(class ActorDamageSource const&, float, bool, bool);

    // vIndex: 243, symbol: ?readAdditionalSaveData@PigZombie@@MEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const&, class DataLoadHelper&);

    // vIndex: 244, symbol: ?addAdditionalSaveData@PigZombie@@MEBAXAEAVCompoundTag@@@Z
    ...
    // vIndex: 268, symbol: ?checkSpawnRules@PigZombie@@UEAA_N_N@Z
    ...
    // vIndex: 311, symbol: ?getAttackTime@PigZombie@@UEAAHXZ
