...
public:
    ...
    // vIndex: 127, symbol: ?handleEntityEvent@Silverfish@@UEAAXW4ActorEvent@@H@Z
    ...
    // vIndex: 245, symbol: ?_playStepSound@Silverfish@@MEAAXAEBVBlockPos@@AEBVBlock@@@Z
    ...
    // vIndex: 255, symbol: ?spawnAnim@Silverfish@@UEAAXXZ
    virtual void spawnAnim();

    // vIndex: 268, symbol: ?checkSpawnRules@Silverfish@@UEAA_N_N@Z
    ...
    // vIndex: 312, symbol: ?_getWalkTargetValue@Silverfish@@UEAAMAEBVBlockPos@@@Z
    virtual float _getWalkTargetValue(class BlockPos const&);

    // vIndex: 323, symbol: __unk_vfn_323
    virtual void __unk_vfn_323();

    // vIndex: 325, symbol: ?isDarkEnoughToSpawn@Silverfish@@UEBA_NXZ
