...
public:
    ...
    // vIndex: 224, symbol: ?die@EvocationIllager@@UEAAXAEBVActorDamageSource@@@Z
    ...
    // vIndex: 264, symbol: ?aiStep@EvocationIllager@@UEAAXXZ
    virtual void aiStep();

    // vIndex: 276, symbol: __unk_vfn_276
    virtual void __unk_vfn_276();

    // vIndex: 278, symbol: ?isAlliedTo@EvocationIllager@@UEAA_NPEAVMob@@@Z
    virtual bool isAlliedTo(class Mob*);

    // vIndex: 280, symbol: __unk_vfn_280
    virtual void __unk_vfn_280();

    // vIndex: 285, symbol: ?getArmorValue@EvocationIllager@@MEBAHXZ
