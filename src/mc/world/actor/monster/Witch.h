...
public:
    ...
    // vIndex: 100, symbol: ?canAttack@Witch@@UEBA_NPEAVActor@@_N@Z
    virtual bool canAttack(class Actor*, bool) const;

    // vIndex: 127, symbol: ?handleEntityEvent@Witch@@UEAAXW4ActorEvent@@H@Z
    ...
    // vIndex: 237, symbol: ?updateEntitySpecificMolangVariables@Witch@@UEAAXAEAVRenderParams@@@Z
    ...
    // vIndex: 252, symbol: ?_onSizeUpdated@Witch@@EEAAXXZ
    ...
    // vIndex: 303, symbol: ?getDamageAfterEnchantReduction@Witch@@MEBAMAEBVActorDamageSource@@M@Z
