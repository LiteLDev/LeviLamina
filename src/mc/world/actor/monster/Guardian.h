...
public:
     ...
     */
    MCAPI
    Guardian(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
    /**
     * @symbol ?getAttackDuration\@Guardian\@\@QEAAHXZ
     */
    MCAPI int getAttackDuration(); // NOLINT
    /**
     * @symbol ?getMoveEyeVector\@Guardian\@\@QEAA?AVVec3\@\@XZ
     */
    MCAPI class Vec3 getMoveEyeVector(); // NOLINT
    /**
     * @symbol ?getTargetEntity\@Guardian\@\@QEBAPEAVActor\@\@XZ
     */
    MCAPI class Actor* getTargetEntity() const; // NOLINT
    /**
     * @symbol ?isElder\@Guardian\@\@QEBA_NXZ
     */
    MCAPI bool isElder() const; // NOLINT
    /**
     * @symbol ?isElderGhost\@Guardian\@\@QEBA_NXZ
     */
    MCAPI bool isElderGhost() const; // NOLINT
    /**
     ...
     */
    MCAPI void setAttackTime(int); // NOLINT
    /**
     * @symbol ?setElder\@Guardian\@\@QEAAX_N\@Z
     */
    MCAPI void setElder(bool); // NOLINT

    // protected:
    /**
     * @symbol ?registerLoopingSounds\@Guardian\@\@IEAAXXZ
     */
    MCAPI void registerLoopingSounds(); // NOLINT
...
private:
     ...
     */
    MCAPI static int const ATTACK_TIME; // NOLINT
    /**
     * @symbol ?FIRST_DAMAGE_TIME\@Guardian\@\@0HB
     */
    MCAPI static int const FIRST_DAMAGE_TIME; // NOLINT
};
