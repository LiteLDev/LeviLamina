...
public:
     ...
     */
    MCAPI
    ChestBoat(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT

    // private:
    /**
     * @symbol ?_dropChestContents\@ChestBoat\@\@AEAAXAEBVVec3\@\@\@Z
     */
    MCAPI void _dropChestContents(class Vec3 const&); // NOLINT
