...
public:
    ...
    int32_t       mAge;           // this+Actor+160
    int32_t       mPickupDelay;   // this+Actor+164
    int32_t       mThrowTime;     // this+Actor+168
    float     mBobOffs;       // this+Actor+172
    int32_t       mHealth;        // this+Actor+176
    int32_t       mLifeTime;      // this+Actor+180
