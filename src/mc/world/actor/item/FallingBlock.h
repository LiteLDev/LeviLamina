...
public:
     ...
     */
    virtual class mce::Color getDustColor(class Block const&) const = 0; // NOLINT
    /**
     * @vftbl 193
     * @symbol
     * ?getDustParticleName\@DragonEggBlock\@\@UEBA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@AEBVBlock\@\@\@Z
     */
    virtual std::string getDustParticleName(class Block const&) const = 0; // NOLINT
    /**
     * @vftbl 194
     ...
     */
    MCVAPI ~FallingBlock(); // NOLINT
#endif
    /**
     * @symbol
     * ??0FallingBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HAEBVMaterial\@\@\@Z
     */
    MCAPI FallingBlock(std::string const&, int, class Material const&); // NOLINT
    /**
     * @symbol ?triggerFallCheck\@FallingBlock\@\@QEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void triggerFallCheck(class BlockSource&, class BlockPos const&) const; // NOLINT

    // protected:
    /**
     * @symbol ?_tickBlocksAround2D\@FallingBlock\@\@IEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@\@Z
     */
    MCAPI void _tickBlocksAround2D(class BlockSource&, class BlockPos const&, class Block const&) const; // NOLINT
    /**
     * @symbol ?checkSlide\@FallingBlock\@\@IEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    MCAPI void checkSlide(class BlockSource&, class BlockPos const&) const; // NOLINT
