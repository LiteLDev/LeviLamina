...
public:
    ...
    // vIndex: 254, symbol: ?destroy@MinecartHopper@@UEAAXAEBVActorDamageSource@@_N@Z
    virtual void destroy(class ActorDamageSource const&, bool);

    // vIndex: 255, symbol: ?getType@MinecartHopper@@UEAA?AW4MinecartType@@XZ
    virtual ::MinecartType getType();

    // vIndex: 256, symbol: ?getDefaultDisplayBlock@MinecartHopper@@UEBAPEBVBlock@@XZ
    virtual class Block const* getDefaultDisplayBlock() const;

    // vIndex: 257, symbol: __unk_vfn_257
    virtual void __unk_vfn_257();

    // vIndex: 258, symbol: ?getDefaultDisplayOffset@MinecartHopper@@UEBAHXZ
    virtual int getDefaultDisplayOffset() const;

    // vIndex: 259, symbol: ?applyNaturalSlowdown@MinecartHopper@@UEAAXAEAVBlockSource@@@Z
