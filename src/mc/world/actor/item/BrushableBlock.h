...
public:
    ...
    // vIndex: 89, symbol: ?mayConsumeFertilizer@BrushableBlock@@UEBA_NAEAVBlockSource@@@Z
    virtual bool mayConsumeFertilizer(class BlockSource&) const;

    // vIndex: 90, symbol: ?canBeFertilized@BrushableBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
    virtual bool canBeFertilized(class BlockSource&, class BlockPos const&, class Block const&) const;

    // vIndex: 105, symbol: ?asItemInstance@BrushableBlock@@UEBA?AVItemInstance@@AEBVBlock@@PEBVBlockActor@@@Z
    ...
    // vIndex: 143, symbol: ?getVariant@BrushableBlock@@UEBAHAEBVBlock@@@Z
