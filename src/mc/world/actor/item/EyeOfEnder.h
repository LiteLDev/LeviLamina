...
public:
     ...
     */
    MCAPI
    EyeOfEnder(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
    /**
     ...
     */
    MCAPI void signalTo(class Player const&, class BlockPos&); // NOLINT
};
