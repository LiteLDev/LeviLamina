...
public:
    ...
    ::ll::TypedStorage<8, 24, ::std::vector<::PlaceBlockGoal::WeightedBlockDescriptor>> mRandomlyPlaceableBlocks;
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI PlaceBlockGoal(::Mob& mob, ::std::string name, ::GoalId const& goalId);
    // NOLINTEND
