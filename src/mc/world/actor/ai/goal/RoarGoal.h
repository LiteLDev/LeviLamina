...
public:
...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_ROARGOAL_DEFINITION
    public:
    ...
    public:
         ...
         */
        MCAPI static void
        buildSchema(std::string const&, class std::shared_ptr<class JsonUtil::JsonSchemaObjectNode<class JsonUtil::EmptyClass, class RoarGoal::Definition>>&);
    };
