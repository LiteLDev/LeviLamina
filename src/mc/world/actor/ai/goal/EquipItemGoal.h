...
public:
...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_EQUIPITEMGOAL_DEFINITION
    public:
    ...
    public:
         ...
         */
        MCAPI static void
        buildSchema(std::string const&, class std::shared_ptr<class JsonUtil::JsonSchemaObjectNode<class JsonUtil::EmptyClass, class EquipItemGoal::Definition>>&);
    };
