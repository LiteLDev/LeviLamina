...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_VILLAGE_DWELLERDATA
    public:
...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_VILLAGE_STANDINGMODIFIERS
    public:
...
public:
     ...
     */
    MCAPI void
    _findWeightedPOI(std::vector<class std::weak_ptr<class POIInstance>>&, class Random&, struct ActorUniqueID);
    /**
