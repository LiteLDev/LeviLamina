...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_PLAYERINVENTORY_SLOTDATA
    public:
...
public:
     ...
     */
    MCVAPI void
        createTransactionContext(class std::function<void(class Container&, int, class ItemStack const&, class ItemStack const&)>, class std::function<void(void)>);
#endif
    /**
