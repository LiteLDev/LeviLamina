...
public:
    ...
    MCNAPI void _addParticlesAroundSelf(::ParticleType particleType);

    MCNAPI void consumeLoveFood();

    MCNAPI int getBreedingStackIndex() const;
    // NOLINTEND
