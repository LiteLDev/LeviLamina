...
public:
    ...
    // vIndex: 153, symbol: ?getEntityTypeId@WanderingTrader@@UEBA?AW4ActorType@@XZ
    ...
    // vIndex: 237, symbol: ?updateEntitySpecificMolangVariables@WanderingTrader@@UEAAXAEAVRenderParams@@@Z
