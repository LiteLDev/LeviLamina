...
MCAPI_C ::std::string_view getActionValue(::std::variant<::npc::CommandAction, ::npc::UrlAction> const& action);

MCAPI_C ::std::string_view getButtonLabel(::std::variant<::npc::CommandAction, ::npc::UrlAction> const& action);
