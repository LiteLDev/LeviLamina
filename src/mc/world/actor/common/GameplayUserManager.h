...
public:
    ...
    MCAPI class Bedrock::PubSub::Subscription
        registerGameplayUserAddedCallback(class std::function<void(class EntityContext&)>);
    /**
     * @symbol
     ...
     */
    MCAPI class Bedrock::PubSub::Subscription
        registerGameplayUserRemovedCallback(class std::function<void(class EntityContext&)>);
    /**
     * @symbol
     ...
     */
    MCAPI class Bedrock::PubSub::Subscription
        registerGameplayUserResumedCallback(class std::function<void(class EntityContext const&)>);
    /**
     * @symbol
     ...
     */
    MCAPI class Bedrock::PubSub::Subscription
        registerGameplayUserSuspendedCallback(class std::function<void(class EntityContext const&)>);
    /**
