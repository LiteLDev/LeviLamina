...
public:
    ...
    // vIndex: 82, symbol: ?isPickable@ShulkerBullet@@UEAA_NXZ
    ...
    // vIndex: 91, symbol: ?isOnFire@ShulkerBullet@@UEBA_NXZ
    ...
    // vIndex: 155, symbol: ?getSourceUniqueID@ShulkerBullet@@UEBA?AUActorUniqueID@@XZ
    ...
    // vIndex: 243, symbol: ?readAdditionalSaveData@ShulkerBullet@@MEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const&, class DataLoadHelper&);

    // vIndex: 244, symbol: ?addAdditionalSaveData@ShulkerBullet@@MEBAXAEAVCompoundTag@@@Z
