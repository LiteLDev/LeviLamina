...
public:
    ...
    // vIndex: 163, symbol: ?getThrowPower@ExperiencePotion@@MEAAMXZ
    virtual float getThrowPower();

    // vIndex: 164, symbol: ?getThrowUpAngleOffset@ExperiencePotion@@MEAAMXZ
    virtual float getThrowUpAngleOffset();

    // vIndex: 165, symbol: ?getGravity@ExperiencePotion@@MEAAMXZ
