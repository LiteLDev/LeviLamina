...
public:
    ...
    // vIndex: 169, symbol: ?getThrowPower@ExperiencePotion@@MEAAMXZ
    virtual float getThrowPower();

    // vIndex: 170, symbol: ?getThrowUpAngleOffset@ExperiencePotion@@MEAAMXZ
    virtual float getThrowUpAngleOffset();

    // vIndex: 171, symbol: ?getGravity@ExperiencePotion@@MEAAMXZ
