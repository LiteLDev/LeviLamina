...
public:
     ...
     */
    virtual enum class ParticleType getTrailParticle(); // NOLINT
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_DRAGONFIREBALL
    /**
     * @symbol ?shouldBurn\@DragonFireball\@\@MEAA_NXZ
     */
    MCVAPI bool shouldBurn(); // NOLINT
#endif
    /**
     * @symbol
     * ??0DragonFireball\@\@QEAA\@PEAVActorDefinitionGroup\@\@AEBUActorDefinitionIdentifier\@\@AEAVEntityContext\@\@\@Z
     */
    MCAPI
    DragonFireball(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
    /**
     * @symbol ?SPLASH_RANGE\@DragonFireball\@\@2MA
     */
    MCAPI static float SPLASH_RANGE; // NOLINT
};
