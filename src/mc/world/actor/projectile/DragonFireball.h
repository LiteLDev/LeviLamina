...
public:
    ...
    // vIndex: 48, symbol: ?isPickable@DragonFireball@@UEAA_NXZ
    virtual bool isPickable();

    // vIndex: 158, symbol: ?_hurt@DragonFireball@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    virtual bool _hurt(class ActorDamageSource const& source, float damage, bool knock, bool ignite);

    // vIndex: 164, symbol: ?getTrailParticle@DragonFireball@@MEAA?AW4ParticleType@@XZ
    virtual ::ParticleType getTrailParticle();

    // vIndex: 165, symbol: ?shouldBurn@DragonFireball@@MEAA_NXZ
