...
public:
    ...
    // vIndex: 69, symbol: ?getShadowRadius@EvocationFang@@UEBAMXZ
    ...
    // vIndex: 127, symbol: ?handleEntityEvent@EvocationFang@@UEAAXW4ActorEvent@@H@Z
    virtual void handleEntityEvent(::ActorEvent, int);

    // vIndex: 155, symbol: ?getSourceUniqueID@EvocationFang@@UEBA?AUActorUniqueID@@XZ
