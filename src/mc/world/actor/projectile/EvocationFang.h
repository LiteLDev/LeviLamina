...
public:
    ...
    /**
     * @symbol
     * ??0EvocationFang\@\@QEAA\@PEAVActorDefinitionGroup\@\@AEBUActorDefinitionIdentifier\@\@AEAVEntityContext\@\@\@Z
     */
    MCAPI
    EvocationFang(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT

    // private:
    /**
     * @symbol ?_dealDamageTo\@EvocationFang\@\@AEAAXAEAVMob\@\@\@Z
     */
    MCAPI void _dealDamageTo(class Mob&); // NOLINT
