...
public:
    // NOLINTBEGIN
    // vIndex: 12, symbol:
    // ?initializeComponents@ThrownPotion@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z
    ...
    // vIndex: 154, symbol: ?queryEntityRenderer@ThrownPotion@@UEBAAEBVHashedString@@XZ
    ...
    // vIndex: 211, symbol: ?setAuxValue@ThrownPotion@@UEAAXH@Z
    ...
    // vIndex: 243, symbol: ?readAdditionalSaveData@ThrownPotion@@UEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z
    virtual void readAdditionalSaveData(class CompoundTag const&, class DataLoadHelper&);

    // vIndex: 244, symbol: ?addAdditionalSaveData@ThrownPotion@@UEBAXAEAVCompoundTag@@@Z
