...
public:
    ...
    // vIndex: 82, symbol: ?isPickable@WitherSkull@@UEAA_NXZ
    ...
    // vIndex: 91, symbol: ?isOnFire@WitherSkull@@UEBA_NXZ
    ...
    // vIndex: 210, symbol: ?canDestroyBlock@WitherSkull@@UEBA_NAEBVBlock@@@Z
    ...
    // vIndex: 240, symbol: ?_hurt@WitherSkull@@MEAA_NAEBVActorDamageSource@@M_N1@Z
    ...
    // vIndex: 254, symbol: ?getInertia@WitherSkull@@MEAAMXZ
