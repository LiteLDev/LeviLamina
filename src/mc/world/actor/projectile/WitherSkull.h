...
public:
     ...
     */
    virtual float getInertia(); // NOLINT
    /**
     * @vftbl 255
    ...
    /**
     * @symbol
     * ??0WitherSkull\@\@QEAA\@PEAVActorDefinitionGroup\@\@AEBUActorDefinitionIdentifier\@\@AEAVEntityContext\@\@\@Z
     */
    MCAPI
    WitherSkull(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class EntityContext&); // NOLINT
};
