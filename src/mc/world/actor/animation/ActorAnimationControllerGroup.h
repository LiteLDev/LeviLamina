...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI_C ActorAnimationControllerGroup();
    ...
    MCNAPI_C ::ActorAnimationControllerPtr getActorAnimationController(::HashedString const& name);

    MCNAPI ::std::shared_ptr<::ActorAnimationControllerInfo>
    getActorAnimationControllerInfo(::HashedString const& name);

    MCNAPI_C void loadActorAnimationControllersAsync(
