...
MCAPI void
tickAutoClimbingMob(class StrictEntityContext const&, class Optional<class FlagComponent<struct CanStandOnSnowFlag> const>, class Optional<class FlagComponent<struct HasLightweightFamilyFlag> const>, struct SynchedActorDataComponent const&, struct AABBShapeComponent const&, struct StateVectorComponent&, class EntityModifier<class FlagComponent<struct AutoClimbTravelFlag>>, class IConstBlockSource const&);
...
MCAPI void
tickAutoClimbingMobInLava(class StrictEntityContext const&, class NavigationComponent const&, class Optional<class FlagComponent<struct CanStandOnSnowFlag> const>, class Optional<class FlagComponent<struct HasLightweightFamilyFlag> const>, struct SynchedActorDataComponent const&, struct AABBShapeComponent const&, struct StateVectorComponent&, class EntityModifier<class FlagComponent<struct AutoClimbTravelFlag>>, class IConstBlockSource const&);
// NOLINTEND
