 ...
 */
MCAPI void
_tickActorUpdatePositionAndAABBSystem2(struct ActorSetPositionRequestComponent const&, struct OffsetsComponent const&, class Optional<struct SlideOffsetComponent const>, struct AABBShapeComponent&, struct StateVectorComponent&, class Optional<class FlagComponent<struct PaintingFlag>>); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void
_tickAddLocalPlayerEntityMovedSystemAsynchronous1(class StrictEntityContext&, class EntityModifierT<class EntityRegistryBase, class StrictEntityContext, class FlagComponent<struct ActorChunkMoveFlag>, class FlagComponent<struct ActorLocalPlayerEntityMovedFlag>, struct ActorSetPositionRequestComponent>); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void
_tickChunkMoveNeededSystemSynchronous4(class ActorOwnerComponent const&, struct ChunkPositionComponent const&, struct StateVectorComponent const&); // NOLINT
/**
 * @symbol
 * ?_tickMoveHitboxSystem3\@ActorSetPosSystemImpl\@\@YAXAEBUActorSetPositionRequestComponent\@\@AEAVHitboxComponent\@\@\@Z
 */
MCAPI void _tickMoveHitboxSystem3(struct ActorSetPositionRequestComponent const&, class HitboxComponent&); // NOLINT
/**
 * @symbol
 * ?_tickShulkerUpdatePositionSystem5\@ActorSetPosSystemImpl\@\@YAXAEBUStateVectorComponent\@\@AEAUSynchedActorDataComponent\@\@\@Z
 */
MCAPI void
_tickShulkerUpdatePositionSystem5(struct StateVectorComponent const&, struct SynchedActorDataComponent&); // NOLINT
