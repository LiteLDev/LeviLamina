...
MCAPI void _calculateBoatControlledByLocalInstanceSystem(
    ...
    class EntityModifierT<
        class EntityRegistryBase,
        class StrictEntityContext,
        class FlagComponent<struct ControlledByLocalInstanceFlag>>,
    void (*)(class StrictEntityContext const&, std::optional<class StrictEntityContext> const&, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct Include<class FlagComponent<struct PlayerComponentFlag>>, class Optional<class FlagComponent<struct LocalPlayerComponentFlag>>> const&, class EntityModifierT<class EntityRegistryBase, class StrictEntityContext, class FlagComponent<struct ControlledByLocalInstanceFlag>>)
);
...
// symbol:
// ?setControlledByLocalInstanceClient@ControlledByLocalInstanceSystemImpl@@YAXAEBVStrictEntityContext@@V?$EntityModifierT@VEntityRegistryBase@@VStrictEntityContext@@V?$FlagComponent@UControlledByLocalInstanceFlag@@@@@@@Z
MCAPI void
setControlledByLocalInstanceClient(class StrictEntityContext const&, class EntityModifierT<class EntityRegistryBase, class StrictEntityContext, class FlagComponent<struct ControlledByLocalInstanceFlag>>);

// symbol:
// ?setControlledByLocalInstanceServer@ControlledByLocalInstanceSystemImpl@@YAXAEBVStrictEntityContext@@V?$EntityModifierT@VEntityRegistryBase@@VStrictEntityContext@@V?$FlagComponent@UControlledByLocalInstanceFlag@@@@@@@Z
MCAPI void
setControlledByLocalInstanceServer(class StrictEntityContext const&, class EntityModifierT<class EntityRegistryBase, class StrictEntityContext, class FlagComponent<struct ControlledByLocalInstanceFlag>>);
...
MCAPI void
setVehicleControlledByLocalInstanceClient(class StrictEntityContext const&, std::optional<class StrictEntityContext> const&, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct Include<class FlagComponent<struct PlayerComponentFlag>>, class Optional<class FlagComponent<struct LocalPlayerComponentFlag>>> const&, class EntityModifierT<class EntityRegistryBase, class StrictEntityContext, class FlagComponent<struct ControlledByLocalInstanceFlag>>);

// symbol:
// ?setVehicleControlledByLocalInstanceServer@ControlledByLocalInstanceSystemImpl@@YAXAEBVStrictEntityContext@@AEBV?$optional@VStrictEntityContext@@@std@@AEBV?$ViewT@VStrictEntityContext@@VEntityRegistryBase@@U?$Include@V?$FlagComponent@UPlayerComponentFlag@@@@@@V?$Optional@V?$FlagComponent@ULocalPlayerComponentFlag@@@@@@@@V?$EntityModifierT@VEntityRegistryBase@@VStrictEntityContext@@V?$FlagComponent@UControlledByLocalInstanceFlag@@@@@@@Z
MCAPI void
setVehicleControlledByLocalInstanceServer(class StrictEntityContext const&, std::optional<class StrictEntityContext> const&, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct Include<class FlagComponent<struct PlayerComponentFlag>>, class Optional<class FlagComponent<struct LocalPlayerComponentFlag>>> const&, class EntityModifierT<class EntityRegistryBase, class StrictEntityContext, class FlagComponent<struct ControlledByLocalInstanceFlag>>);
// NOLINTEND
