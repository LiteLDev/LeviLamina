...
public:
     ...
     */
    MCAPI static struct TickingSystemWithInfo createTriggerSystem(bool); // NOLINT
    /**
     * @symbol
    ...
    updatePlayerState(class GetCollisionShapeInterface const&, class AABB const&, class Vec2 const&, bool, bool, bool, bool, bool, bool, bool, bool, float, class IConstBlockSource const&, std::vector<class AABB>&); // NOLINT
};
