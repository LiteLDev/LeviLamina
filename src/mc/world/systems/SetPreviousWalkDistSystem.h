...
public:
    ...
    // NOLINTBEGIN
    // symbol:
    // ?_tickWalkDistPrevSystem@SetPreviousWalkDistSystem@@CAXV?$ViewT@VStrictEntityContext@@VEntityRegistryBase@@U?$Include@V?$FlagComponent@UActorMovementTickNeededFlag@@@@@@UWalkDistComponent@@@@@Z
