 ...
 */
MCAPI bool
decorateLargeFeature(class LevelChunk&, class BlockVolumeTarget&, class Random&, gsl::span<struct BiomeDecorationFeature>, class ChunkPos const&, std::string const&);
/**
 * @symbol
