 ...
 */
MCAPI void consolidateDecorationFeatures(class BiomeRegistry&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void
decorate(class LevelChunk&, class BlockSource&, class Random&, std::vector<class Biome const*>&, std::string const&, class IPreliminarySurfaceProvider const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI bool
decorateBiome(class LevelChunk&, class BlockSource&, class Random&, class gsl::span<struct BiomeDecorationFeature, -1>, std::string const&, class Biome const*, class IPreliminarySurfaceProvider const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI bool
decorateLargeFeature(class LevelChunk&, class BlockVolumeTarget&, class Random&, class gsl::span<struct BiomeDecorationFeature, -1>, class ChunkPos const&, std::string const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void
decorateLargeFeature(class Biome&, class LevelChunk&, class BlockVolumeTarget&, class Random&, class ChunkPos const&, std::string const&); // NOLINT
