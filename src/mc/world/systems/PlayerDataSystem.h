 ...
 */
MCAPI void
forEachIdByPrecedence(struct PlayerStorageIds const&, class std::function<bool(std::string const&, std::string const&)>);
/**
 * @symbol
...
MCAPI std::unique_ptr<class CompoundTag>
      loadPlayerDataFromTag(class LevelStorage&, class std::basic_string_view<char, struct std::char_traits<char>>);
/**
 * @symbol
