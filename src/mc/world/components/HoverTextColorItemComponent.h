...
public:
    ...
    // vIndex: 4, symbol:
    // ?buildNetworkTag@?$NetworkedItemComponent@VHoverTextColorItemComponent@@@@UEBA?AV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@AEBUReflectionCtx@cereal@@@Z
    virtual std::unique_ptr<class CompoundTag> buildNetworkTag(struct cereal::ReflectionCtx const&) const;

    // vIndex: 5, symbol:
    // ?initializeFromNetwork@?$NetworkedItemComponent@VHoverTextColorItemComponent@@@@UEAA_NAEBVCompoundTag@@AEBUReflectionCtx@cereal@@@Z
    ...
    // vIndex: 9, symbol: ?_initializeComponent@HoverTextColorItemComponent@@UEAAXXZ
