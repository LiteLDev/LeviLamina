...
public:
    ...
    /**
     * @symbol  ??0ClothBlockItem\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@HPEBVBlock\@\@\@Z
     */
    MCAPI ClothBlockItem(std::string const &, int, class Block const *);
