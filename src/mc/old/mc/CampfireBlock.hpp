...
#endif
    /**
     * @symbol  ??0CampfireBlock\@\@QEAA\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H_NW4Behavior\@0\@\@Z
     */
    MCAPI CampfireBlock(std::string const &, int, bool, enum class CampfireBlock::Behavior);
    /**
