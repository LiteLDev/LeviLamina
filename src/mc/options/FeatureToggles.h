...
public:
    ...
    public:
         ...
         */
        MCAPI FeatureToggle(struct FeatureToggles::FeatureToggle&&); // NOLINT
        /**
         * @symbol ??4FeatureToggle\@FeatureToggles\@\@QEAAAEAU01\@$$QEAU01\@\@Z
         */
        MCAPI struct FeatureToggles::FeatureToggle& operator=(struct FeatureToggles::FeatureToggle&&); // NOLINT
        /**
         * @symbol ??1FeatureToggle\@FeatureToggles\@\@QEAA\@XZ
         */
        MCAPI ~FeatureToggle(); // NOLINT
    };
...
public:
     ...
     */
    MCVAPI ~FeatureToggles(); // NOLINT
#endif
    /**
     * @symbol ??0FeatureToggles\@\@QEAA\@AEAVAppPlatform\@\@\@Z
     */
    MCAPI FeatureToggles(class AppPlatform&); // NOLINT
    /**
     * @symbol ?get\@FeatureToggles\@\@QEAAPEAVOption\@\@W4FeatureOptionID\@\@\@Z
     */
    MCAPI class Option* get(enum class FeatureOptionID); // NOLINT
    /**
     * @symbol ?isEnabled\@FeatureToggles\@\@QEBA_NW4FeatureOptionID\@\@\@Z
     */
    MCAPI bool isEnabled(enum class FeatureOptionID) const; // NOLINT
    ...
    MCAPI class std::function<void(class Option&)>
        _getDisabledIfOptionExpectationsNotMetSetupCallback(std::vector<enum class FeatureOptionID>, std::vector<enum class FeatureOptionID>); // NOLINT
    /**
     * @symbol
    ...
    MCAPI class std::function<void(bool&)>
        _getLockIfInGameOrOptionExpectationsNotMetLockCallback(std::vector<enum class FeatureOptionID>, std::vector<enum class FeatureOptionID>); // NOLINT
    /**
     * @symbol ?_initialize\@FeatureToggles\@\@AEAAXAEAVAppPlatform\@\@\@Z
     */
    MCAPI void _initialize(class AppPlatform&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    _registerFeature(enum class FeatureOptionTabID, enum class FeatureOptionID, std::string const&, std::string const&, bool, enum class FeatureOptionID, class std::function<void(class Option&)>, class std::function<void(bool&)>); // NOLINT
    /**
     * @symbol ?_registerFeatures\@FeatureToggles\@\@AEAAXXZ
     */
    MCAPI void _registerFeatures(); // NOLINT
    /**
     * @symbol ?_setupDependencies\@FeatureToggles\@\@AEAAXXZ
     */
    MCAPI void _setupDependencies(); // NOLINT
...
private:
     ...
     */
    MCAPI static std::unique_ptr<class FeatureToggles> mFeatureToggles; // NOLINT
};
