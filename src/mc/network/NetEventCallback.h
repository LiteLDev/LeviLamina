...
public:
     ...
     */
    virtual void
    sendPacketViolationDetectedTelemetryData(uint64_t, std::string, enum class PacketViolationResponse, enum class MinecraftPacketIds, class NetworkIdentifier const&);
    /**
     * @vftbl 10
     * @symbol __unk_vfn_10
     */
