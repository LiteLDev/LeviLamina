...
public:
    ...
    // vIndex: 99, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVClientboundCloseFormPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ClientboundCloseFormPacket const&);

    // vIndex: 100, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVClientCacheStatusPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ClientCacheStatusPacket const&);

    // vIndex: 101, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVRequestChunkRadiusPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class RequestChunkRadiusPacket const&);

    // vIndex: 102, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVMapCreateLockedCopyPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class MapCreateLockedCopyPacket const&);

    // vIndex: 103, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVMapInfoRequestPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class MapInfoRequestPacket const&);

    // vIndex: 104, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVChunkRadiusUpdatedPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ChunkRadiusUpdatedPacket const&);

    // vIndex: 105, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVBossEventPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class BossEventPacket const&);

    // vIndex: 106, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVUpdateTradePacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class UpdateTradePacket const&);

    // vIndex: 107, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVUpdateEquipPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class UpdateEquipPacket const&);

    // vIndex: 108, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVAvailableCommandsPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class AvailableCommandsPacket const&);

    // vIndex: 109, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVCommandRequestPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class CommandRequestPacket const&);

    // vIndex: 110, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVCommandOutputPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class CommandOutputPacket const&);

    // vIndex: 111, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVCommandBlockUpdatePacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class CommandBlockUpdatePacket const&);

    // vIndex: 112, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVCompletedUsingItemPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class CompletedUsingItemPacket const&);

    // vIndex: 113, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVCameraInstructionPacket@@@Z
    ...
    // vIndex: 115, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVCameraPresetsPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class CameraPresetsPacket const&);

    // vIndex: 116, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVCameraShakePacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class CameraShakePacket const&);

    // vIndex: 117, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVInventoryActionPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class InventoryActionPacket const&);

    // vIndex: 118, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVGameRulesChangedPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class GameRulesChangedPacket const&);

    // vIndex: 119, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVResourcePackDataInfoPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ResourcePackDataInfoPacket const&);

    // vIndex: 120, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVResourcePackChunkDataPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ResourcePackChunkDataPacket const&);

    // vIndex: 121, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVResourcePackChunkRequestPacket@@@Z
    ...
    // vIndex: 123, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVStructureBlockUpdatePacket@@@Z
    ...
    // vIndex: 126, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVTransferPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class TransferPacket const&);

    // vIndex: 127, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVPlaySoundPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class PlaySoundPacket const&);

    // vIndex: 128, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVStopSoundPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class StopSoundPacket const&);

    // vIndex: 129, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVSetTitlePacket@@@Z
    ...
    // vIndex: 131, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVAddBehaviorTreePacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class AddBehaviorTreePacket const&);

    // vIndex: 132, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVShowStoreOfferPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ShowStoreOfferPacket const&);

    // vIndex: 133, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVPurchaseReceiptPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class PurchaseReceiptPacket const&);

    // vIndex: 134, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVRemoveObjectivePacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class RemoveObjectivePacket const&);

    // vIndex: 135, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVSetDisplayObjectivePacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class SetDisplayObjectivePacket const&);

    // vIndex: 136, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVAutomationClientConnectPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class AutomationClientConnectPacket const&);

    // vIndex: 137, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVModalFormRequestPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ModalFormRequestPacket const&);

    // vIndex: 138, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVModalFormResponsePacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ModalFormResponsePacket const&);

    // vIndex: 139, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVToastRequestPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ToastRequestPacket const&);

    // vIndex: 140, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVOnScreenTextureAnimationPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class OnScreenTextureAnimationPacket const&);

    // vIndex: 141, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVServerSettingsRequestPacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ServerSettingsRequestPacket const&);

    // vIndex: 142, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVServerSettingsResponsePacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ServerSettingsResponsePacket const&);

    // vIndex: 143, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVShowProfilePacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class ShowProfilePacket const&);

    // vIndex: 144, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVSetScorePacket@@@Z
    virtual void handle(class NetworkIdentifier const&, class SetScorePacket const&);

    // vIndex: 145, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVSetScoreboardIdentityPacket@@@Z
    ...
    // vIndex: 215, symbol: ?handle@NetEventCallback@@UEAAXAEBVNetworkIdentifier@@AEBVAwardAchievementPacket@@@Z
