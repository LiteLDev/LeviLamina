...
public:
     ...
     */
    virtual void
    sendPacketViolationDetectedTelemetryData(unsigned __int64, std::string, enum class PacketViolationResponse, enum class MinecraftPacketIds, class NetworkIdentifier const&);
    /**
     * @vftbl 10
     * @symbol __unk_vfn_10
     */
