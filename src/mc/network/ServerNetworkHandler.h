...
public:
...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SERVERNETWORKHANDLER_CLIENT
    public:
    ...
    public:
         ...
         */
        MCAPI void removeSubClientRequest(enum class SubClientId);
    };
...
public:
     ...
     */
    MCVAPI void
    onDisconnect(class NetworkIdentifier const&, enum class Connection::DisconnectFailReason, std::string const&, bool, std::string const&);
    /**
     * @symbol
    ...
    _createNewPlayer(class NetworkIdentifier const&, class SubClientConnectionRequest const&, enum class SubClientId);
    /**
