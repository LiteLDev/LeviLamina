...
class SimulationTypePacket : public ::ll::PayloadPacket<::SimulationTypePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SimulationTypePacket(::SimulationTypePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SimulationTypePacketPayload payload);
    // NOLINTEND
