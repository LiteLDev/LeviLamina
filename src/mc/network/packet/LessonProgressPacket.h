...
class LessonProgressPacket : public ::ll::PayloadPacket<::LessonProgressPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk82f680;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit LessonProgressPacket(::LessonProgressPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::LessonProgressPacketPayload payload);
    // NOLINTEND
