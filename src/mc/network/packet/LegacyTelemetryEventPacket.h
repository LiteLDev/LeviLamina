...
#include "mc/network/packet/LegacyTelemetryEventPacketPayload.h"
...
class LegacyTelemetryEventPacket : public ::ll::PayloadPacket<::LegacyTelemetryEventPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit LegacyTelemetryEventPacket(::LegacyTelemetryEventPacketPayload payload);
