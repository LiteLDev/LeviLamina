...
class SetCommandsEnabledPacket : public ::ll::PayloadPacket<::SetCommandsEnabledPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SetCommandsEnabledPacket(::SetCommandsEnabledPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SetCommandsEnabledPacketPayload payload);
    // NOLINTEND
