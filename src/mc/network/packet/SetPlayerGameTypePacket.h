...
class SetPlayerGameTypePacket : public ::ll::PayloadPacket<::SetPlayerGameTypePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
#ifdef LL_PLAT_C
    MCAPI explicit SetPlayerGameTypePacket(::SetPlayerGameTypePacketPayload payload);
#endif
    // NOLINTEND
...
#ifdef LL_PLAT_C
    MCAPI void* $ctor(::SetPlayerGameTypePacketPayload payload);
#endif
    // NOLINTEND
