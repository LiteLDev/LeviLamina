...
class ResourcePackDataInfoPacket : public ::ll::PayloadPacket<::ResourcePackDataInfoPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk1df001;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit ResourcePackDataInfoPacket(::ResourcePackDataInfoPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::ResourcePackDataInfoPacketPayload payload);
    // NOLINTEND
