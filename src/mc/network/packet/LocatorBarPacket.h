...
#include "mc/network/packet/LocatorBarPacketPayload.h"
...
class LocatorBarPacket : public ::ll::PayloadPacket<::LocatorBarPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    virtual ~LocatorBarPacket() /*override*/;
    // NOLINTEND
