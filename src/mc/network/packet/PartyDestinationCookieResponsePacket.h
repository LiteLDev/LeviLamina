...
#include "mc/network/packet/PartyDestinationCookieResponsePacketPayload.h"
...
class PartyDestinationCookieResponsePacket : public ::ll::PayloadPacket<::PartyDestinationCookieResponsePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
