...
#include "mc/network/packet/SetSpawnPositionPacketPayload.h"
...
class SetSpawnPositionPacket : public ::ll::PayloadPacket<::SetSpawnPositionPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SetSpawnPositionPacket(::SetSpawnPositionPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SetSpawnPositionPacketPayload payload);
    // NOLINTEND
