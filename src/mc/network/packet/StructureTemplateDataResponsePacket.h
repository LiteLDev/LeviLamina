...
#include "mc/network/packet/StructureTemplateDataResponsePacketPayload.h"
...
class StructureTemplateDataResponsePacket : public ::ll::PayloadPacket<::StructureTemplateDataResponsePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit StructureTemplateDataResponsePacket(::StructureTemplateDataResponsePacketPayload payload);

    MCNAPI ::StructureTemplateDataResponsePacket& operator=(::StructureTemplateDataResponsePacket&&);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::StructureTemplateDataResponsePacketPayload payload);
    // NOLINTEND
