...
class PacketViolationWarningPacket : public ::ll::PayloadPacket<::PacketViolationWarningPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnkc00d96;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit PacketViolationWarningPacket(::PacketViolationWarningPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::PacketViolationWarningPacketPayload payload);
    // NOLINTEND
