...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk38d300;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI EditorNetworkPacket();

    MCNAPI EditorNetworkPacket(::EditorNetworkPacket const&);
    // NOLINTEND
...
public:
    ...
    MCNAPI void* $ctor(::EditorNetworkPacket const&);
    // NOLINTEND
