...
#include "mc/network/packet/AddPaintingPacketPayload.h"
...
class AddPaintingPacket : public ::ll::PayloadPacket<::AddPaintingPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit AddPaintingPacket(::AddPaintingPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::AddPaintingPacketPayload payload);
    // NOLINTEND
