...
#include "mc/network/packet/ServerboundDataStorePacketPayload.h"
...
class ServerboundDataStorePacket : public ::ll::PayloadPacket<::ServerboundDataStorePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
