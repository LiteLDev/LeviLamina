...
class ClientCacheStatusPacket : public ::ll::PayloadPacket<::ClientCacheStatusPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
#ifdef LL_PLAT_C
    MCAPI explicit ClientCacheStatusPacket(::ClientCacheStatusPacketPayload payload);
#endif
    // NOLINTEND
...
#ifdef LL_PLAT_C
    MCAPI void* $ctor(::ClientCacheStatusPacketPayload payload);
#endif
    // NOLINTEND
