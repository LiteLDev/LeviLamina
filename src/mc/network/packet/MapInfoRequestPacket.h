...
#include "mc/network/packet/MapInfoRequestPacketPayload.h"
...
class MapInfoRequestPacket : public ::ll::PayloadPacket<::MapInfoRequestPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit MapInfoRequestPacket(::MapInfoRequestPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::MapInfoRequestPacketPayload payload);
    // NOLINTEND
