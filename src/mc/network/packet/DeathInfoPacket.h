...
class DeathInfoPacket : public ::ll::PayloadPacket<::DeathInfoPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk3a45ac;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit DeathInfoPacket(::DeathInfoPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::DeathInfoPacketPayload payload);
    // NOLINTEND
