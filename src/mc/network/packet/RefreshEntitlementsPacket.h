...
struct RefreshEntitlementsPacketPayload;
namespace cereal { struct ReflectionCtx; }
// clang-format on

class RefreshEntitlementsPacket : public ::ll::PayloadPacket<::RefreshEntitlementsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnka0e160;
    // NOLINTEND
