...
#include "mc/network/packet/SetPlayerFurnaceOptionsPacketPayload.h"
...
class SetPlayerFurnaceOptionsPacket : public ::ll::PayloadPacket<::SetPlayerFurnaceOptionsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
