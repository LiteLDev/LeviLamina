...
class NetworkSettingsPacket : public ::ll::PayloadPacket<::NetworkSettingsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit NetworkSettingsPacket(::NetworkSettingsPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::NetworkSettingsPacketPayload payload);
    // NOLINTEND
