...
class NpcDialoguePacket : public ::ll::PayloadPacket<::NpcDialoguePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnke28dc1;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit NpcDialoguePacket(::NpcDialoguePacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::NpcDialoguePacketPayload payload);
    // NOLINTEND
