...
class ContainerClosePacket : public ::ll::PayloadPacket<::ContainerClosePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit ContainerClosePacket(::ContainerClosePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::ContainerClosePacketPayload payload);
    // NOLINTEND
