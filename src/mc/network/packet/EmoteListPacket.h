...
class EmoteListPacket : public ::ll::PayloadPacket<::EmoteListPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk9ec3cc;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit EmoteListPacket(::EmoteListPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::EmoteListPacketPayload payload);
    // NOLINTEND
