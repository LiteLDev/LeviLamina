...
#include "mc/network/packet/HurtArmorPacketPayload.h"
...
class HurtArmorPacket : public ::ll::PayloadPacket<::HurtArmorPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit HurtArmorPacket(::HurtArmorPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::HurtArmorPacketPayload payload);
    // NOLINTEND
