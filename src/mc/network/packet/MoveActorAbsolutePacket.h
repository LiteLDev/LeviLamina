...
class MoveActorAbsolutePacket : public ::ll::PayloadPacket<::MoveActorAbsolutePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit MoveActorAbsolutePacket(::MoveActorAbsolutePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::MoveActorAbsolutePacketPayload payload);
    // NOLINTEND
