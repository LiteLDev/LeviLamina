...
public:
    ...
    // NOLINTBEGIN
    // vIndex: 0
    virtual ~MoveActorAbsolutePacket() /*override*/;
...
public:
    ...
    MCAPI explicit MoveActorAbsolutePacket(::MoveActorAbsoluteData const& data);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::MoveActorAbsoluteData const& data);
    // NOLINTEND
