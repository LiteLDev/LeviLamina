...
class CurrentStructureFeaturePacket : public ::ll::PayloadPacket<::CurrentStructureFeaturePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI CurrentStructureFeaturePacket();

    MCAPI explicit CurrentStructureFeaturePacket(::CurrentStructureFeaturePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::CurrentStructureFeaturePacketPayload payload);
    // NOLINTEND
