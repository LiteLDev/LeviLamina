...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit CurrentStructureFeaturePacket(::CurrentStructureFeaturePacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::CurrentStructureFeaturePacketPayload payload);
    // NOLINTEND
