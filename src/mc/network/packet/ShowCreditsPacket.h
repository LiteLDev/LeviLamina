...
class ShowCreditsPacket : public ::ll::PayloadPacket<::ShowCreditsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit ShowCreditsPacket(::ShowCreditsPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::ShowCreditsPacketPayload payload);
    // NOLINTEND
