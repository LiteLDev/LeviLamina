...
class SetActorMotionPacket : public ::ll::PayloadPacket<::SetActorMotionPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SetActorMotionPacket(::SetActorMotionPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SetActorMotionPacketPayload payload);
    // NOLINTEND
