...
#include "mc/network/packet/PartyChangedPacketPayload.h"
...
class PartyChangedPacket : public ::ll::PayloadPacket<::PartyChangedPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
#ifdef LL_PLAT_S
    virtual ~PartyChangedPacket() /*override*/ = default;
#else // LL_PLAT_C
    virtual ~PartyChangedPacket() /*override*/;
#endif
