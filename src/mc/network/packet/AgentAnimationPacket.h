...
class AgentAnimationPacket : public ::ll::PayloadPacket<::AgentAnimationPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit AgentAnimationPacket(::AgentAnimationPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::AgentAnimationPacketPayload payload);
    // NOLINTEND
