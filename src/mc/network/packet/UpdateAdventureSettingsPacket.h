...
class UpdateAdventureSettingsPacket : public ::ll::PayloadPacket<::UpdateAdventureSettingsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit UpdateAdventureSettingsPacket(::UpdateAdventureSettingsPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::UpdateAdventureSettingsPacketPayload payload);
    // NOLINTEND
