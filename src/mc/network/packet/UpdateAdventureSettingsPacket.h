...
public:
     ...
     */
    MCVAPI ~UpdateAdventureSettingsPacket(); // NOLINT
#endif
    /**
     * @symbol ??0UpdateAdventureSettingsPacket\@\@QEAA\@AEBUAdventureSettings\@\@\@Z
     */
    MCAPI UpdateAdventureSettingsPacket(struct AdventureSettings const&); // NOLINT
    /**
     * @symbol ??0UpdateAdventureSettingsPacket\@\@QEAA\@XZ
     */
    MCAPI UpdateAdventureSettingsPacket(); // NOLINT
};
