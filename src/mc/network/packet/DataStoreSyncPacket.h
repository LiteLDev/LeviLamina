...
class DataStoreSyncPacket : public ::ll::PayloadPacket<::DataStoreSyncPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk1a311c;
    // NOLINTEND

public:
    // prevent constructor by default
    DataStoreSyncPacket& operator=(DataStoreSyncPacket const&);
    DataStoreSyncPacket(DataStoreSyncPacket const&);
    DataStoreSyncPacket();
...
public:
    ...
    virtual ~DataStoreSyncPacket() /*override*/;
    // NOLINTEND
