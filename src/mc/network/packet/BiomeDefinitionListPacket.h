...
#include "mc/network/packet/BiomeDefinitionListPacketPayload.h"
...
class BiomeDefinitionListPacket : public ::ll::PayloadPacket<::BiomeDefinitionListPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit BiomeDefinitionListPacket(::BiomeDefinitionListPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::BiomeDefinitionListPacketPayload payload);
    // NOLINTEND
