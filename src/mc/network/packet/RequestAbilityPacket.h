...
#include "mc/network/packet/RequestAbilityPacketPayload.h"
...
class RequestAbilityPacket : public ::ll::PayloadPacket<::RequestAbilityPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
#ifdef LL_PLAT_C
    MCAPI explicit RequestAbilityPacket(::RequestAbilityPacketPayload payload);
#endif
    // NOLINTEND
...
#ifdef LL_PLAT_C
    MCAPI void* $ctor(::RequestAbilityPacketPayload payload);
#endif
    // NOLINTEND
