...
class ScriptMessagePacket : public ::ll::PayloadPacket<::ScriptMessagePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnkb5f933;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit ScriptMessagePacket(::ScriptMessagePacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::ScriptMessagePacketPayload payload);
    // NOLINTEND
