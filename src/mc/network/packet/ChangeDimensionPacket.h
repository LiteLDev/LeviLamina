...
#include "mc/network/packet/ChangeDimensionPacketPayload.h"
...
class ChangeDimensionPacket : public ::ll::PayloadPacket<::ChangeDimensionPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit ChangeDimensionPacket(::ChangeDimensionPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::ChangeDimensionPacketPayload payload);
    // NOLINTEND
