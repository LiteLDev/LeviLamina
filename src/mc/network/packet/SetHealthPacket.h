...
class SetHealthPacket : public ::ll::PayloadPacket<::SetHealthPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SetHealthPacket(::SetHealthPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SetHealthPacketPayload payload);
    // NOLINTEND
