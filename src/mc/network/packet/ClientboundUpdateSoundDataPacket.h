...
#include "mc/network/packet/ClientboundUpdateSoundDataPacketPayload.h"
...
class ClientboundUpdateSoundDataPacket : public ::ll::PayloadPacket<::ClientboundUpdateSoundDataPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
