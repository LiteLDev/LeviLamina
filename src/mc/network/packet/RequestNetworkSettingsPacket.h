...
#include "mc/network/packet/RequestNetworkSettingsPacketPayload.h"
...
class RequestNetworkSettingsPacket : public ::ll::PayloadPacket<::RequestNetworkSettingsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
#ifdef LL_PLAT_C
    MCAPI explicit RequestNetworkSettingsPacket(::RequestNetworkSettingsPacketPayload payload);
#endif
    // NOLINTEND
...
#ifdef LL_PLAT_C
    MCAPI void* $ctor(::RequestNetworkSettingsPacketPayload payload);
#endif
    // NOLINTEND
