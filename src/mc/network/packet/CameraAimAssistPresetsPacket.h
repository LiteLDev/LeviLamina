...
#include "mc/network/packet/CameraAimAssistPresetsPacketPayload.h"
...
class CameraAimAssistPresetsPacket : public ::ll::PayloadPacket<::CameraAimAssistPresetsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
