...
public:
    // PlayerAuthInputPacketPayload inner types define
...
public:
    ...
    PlayerAuthInputPacketPayload& operator=(PlayerAuthInputPacketPayload const&);
...
public:
    ...
    MCAPI ~PlayerAuthInputPacketPayload();
    // NOLINTEND
