...
public:
     ...
     */
    MCVAPI ~AnimateEntityPacket(); // NOLINT
#endif
    /**
     * @symbol
     ...
     */
    MCAPI
    AnimateEntityPacket(std::vector<class ActorRuntimeID> const&, std::string const&, std::string const&, float, std::string const&, enum class MolangVersion, std::string const&); // NOLINT
    /**
     * @symbol ??0AnimateEntityPacket\@\@QEAA\@XZ
     */
    MCAPI AnimateEntityPacket(); // NOLINT
};
