...
#include "mc/network/packet/ResourcePackChunkDataPacketPayload.h"
...
class ResourcePackChunkDataPacket : public ::ll::PayloadPacket<::ResourcePackChunkDataPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit ResourcePackChunkDataPacket(::ResourcePackChunkDataPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::ResourcePackChunkDataPacketPayload payload);
    // NOLINTEND
