...
class PlaySoundPacket : public ::ll::PayloadPacket<::PlaySoundPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnkb1f6c6;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit PlaySoundPacket(::PlaySoundPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::PlaySoundPacketPayload payload);
    // NOLINTEND
