...
class RemoveActorPacket : public ::ll::PayloadPacket<::RemoveActorPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit RemoveActorPacket(::RemoveActorPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::RemoveActorPacketPayload payload);
    // NOLINTEND
