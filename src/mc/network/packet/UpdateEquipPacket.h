...
public:
     ...
     */
    MCVAPI ~UpdateEquipPacket(); // NOLINT
#endif
    /**
     * @symbol ??0UpdateEquipPacket\@\@QEAA\@XZ
     */
    MCAPI UpdateEquipPacket(); // NOLINT
    /**
     * @symbol
     * ??0UpdateEquipPacket\@\@QEAA\@W4ContainerID\@\@W4ContainerType\@\@H$$QEAVCompoundTag\@\@AEBUActorUniqueID\@\@\@Z
     */
    MCAPI
    UpdateEquipPacket(enum class ContainerID, enum class ContainerType, int, class CompoundTag&&, struct ActorUniqueID const&); // NOLINT
};
