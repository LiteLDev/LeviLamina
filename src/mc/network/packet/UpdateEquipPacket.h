...
class UpdateEquipPacket : public ::ll::PayloadPacket<::UpdateEquipPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk7ac2ac;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit UpdateEquipPacket(::UpdateEquipPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::UpdateEquipPacketPayload payload);
    // NOLINTEND
