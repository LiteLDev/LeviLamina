...
#include "mc/network/packet/SendPartyDestinationCookiePacketPayload.h"
...
class SendPartyDestinationCookiePacket : public ::ll::PayloadPacket<::SendPartyDestinationCookiePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit SendPartyDestinationCookiePacket(::SendPartyDestinationCookiePacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::SendPartyDestinationCookiePacketPayload payload);
    // NOLINTEND
