...
class UpdateBlockPacket : public ::ll::PayloadPacket<::UpdateBlockPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit UpdateBlockPacket(::UpdateBlockPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::UpdateBlockPacketPayload payload);
    // NOLINTEND
