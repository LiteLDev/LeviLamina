...
class ServerboundPackSettingChangePacket : public ::ll::PayloadPacket<::ServerboundPackSettingChangePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk4a2ab8;
    // NOLINTEND

public:
    // prevent constructor by default
    ServerboundPackSettingChangePacket& operator=(ServerboundPackSettingChangePacket const&);
    ServerboundPackSettingChangePacket(ServerboundPackSettingChangePacket const&);
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI_S ServerboundPackSettingChangePacket();

    MCNAPI_C explicit ServerboundPackSettingChangePacket(::ServerboundPackSettingChangePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCNAPI_C void* $ctor(::ServerboundPackSettingChangePacketPayload payload);
    // NOLINTEND
