...
class AvailableCommandsPacket : public ::ll::PayloadPacket<::AvailableCommandsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit AvailableCommandsPacket(::AvailableCommandsPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::AvailableCommandsPacketPayload payload);
    // NOLINTEND
