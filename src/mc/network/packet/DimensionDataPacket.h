...
#include "mc/network/packet/DimensionDataPacketPayload.h"
...
class DimensionDataPacket : public ::ll::PayloadPacket<::DimensionDataPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI DimensionDataPacket();

    MCAPI explicit DimensionDataPacket(::DimensionDataPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::DimensionDataPacketPayload payload);
    // NOLINTEND
