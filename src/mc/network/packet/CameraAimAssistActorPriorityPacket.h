...
#include "mc/network/packet/CameraAimAssistActorPriorityPacketPayload.h"
...
class CameraAimAssistActorPriorityPacket : public ::ll::PayloadPacket<::CameraAimAssistActorPriorityPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI CameraAimAssistActorPriorityPacket();

    MCAPI explicit CameraAimAssistActorPriorityPacket(::CameraAimAssistActorPriorityPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::CameraAimAssistActorPriorityPacketPayload payload);
    // NOLINTEND
