...
class UnlockedRecipesPacket : public ::ll::PayloadPacket<::UnlockedRecipesPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit UnlockedRecipesPacket(::UnlockedRecipesPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::UnlockedRecipesPacketPayload payload);
    // NOLINTEND
