...
#include "mc/network/packet/EduUriResourcePacketPayload.h"
...
class EduUriResourcePacket : public ::ll::PayloadPacket<::EduUriResourcePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    virtual ~EduUriResourcePacket() /*override*/;
    // NOLINTEND

public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit EduUriResourcePacket(::EduUriResourcePacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::EduUriResourcePacketPayload payload);
    // NOLINTEND
