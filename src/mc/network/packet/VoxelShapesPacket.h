...
#include "mc/network/packet/VoxelShapesPacketPayload.h"
...
class VoxelShapesPacket : public ::ll::PayloadPacket<::VoxelShapesPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI VoxelShapesPacket();

    MCAPI explicit VoxelShapesPacket(::VoxelShapesPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::VoxelShapesPacketPayload payload);
    // NOLINTEND
