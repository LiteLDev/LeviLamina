...
class UpdatePlayerGameTypePacket : public ::ll::PayloadPacket<::UpdatePlayerGameTypePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit UpdatePlayerGameTypePacket(::UpdatePlayerGameTypePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::UpdatePlayerGameTypePacketPayload payload);
    // NOLINTEND
