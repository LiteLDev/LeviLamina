...
class AnimatePacket : public ::ll::PayloadPacket<::AnimatePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit AnimatePacket(::AnimatePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::AnimatePacketPayload payload);
    // NOLINTEND
