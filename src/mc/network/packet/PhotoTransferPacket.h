...
class PhotoTransferPacket : public ::ll::PayloadPacket<::PhotoTransferPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk958c75;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI PhotoTransferPacket();

    MCNAPI_C explicit PhotoTransferPacket(::PhotoTransferPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCNAPI_C void* $ctor(::PhotoTransferPacketPayload payload);
    // NOLINTEND
