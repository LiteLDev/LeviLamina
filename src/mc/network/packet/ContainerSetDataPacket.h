...
class ContainerSetDataPacket : public ::ll::PayloadPacket<::ContainerSetDataPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit ContainerSetDataPacket(::ContainerSetDataPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::ContainerSetDataPacketPayload payload);
    // NOLINTEND
