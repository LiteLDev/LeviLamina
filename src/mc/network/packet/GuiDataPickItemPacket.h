...
class GuiDataPickItemPacket : public ::ll::PayloadPacket<::GuiDataPickItemPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk7710fc;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit GuiDataPickItemPacket(::GuiDataPickItemPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::GuiDataPickItemPacketPayload payload);
    // NOLINTEND
