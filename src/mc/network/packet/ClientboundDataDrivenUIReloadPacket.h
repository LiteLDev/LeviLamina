...
#include "mc/network/packet/ClientboundDataDrivenUIReloadPacketPayload.h"
...
class ClientboundDataDrivenUIReloadPacket : public ::ll::PayloadPacket<::ClientboundDataDrivenUIReloadPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    virtual ~ClientboundDataDrivenUIReloadPacket() /*override*/;
    // NOLINTEND
