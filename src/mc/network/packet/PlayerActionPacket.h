...
class PlayerActionPacket : public ::ll::PayloadPacket<::PlayerActionPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit PlayerActionPacket(::PlayerActionPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::PlayerActionPacketPayload payload);
    // NOLINTEND
