...
class ItemRegistryPacket : public ::ll::PayloadPacket<::ItemRegistryPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnkf8d89f;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit ItemRegistryPacket(::ItemRegistryPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::ItemRegistryPacketPayload payload);
    // NOLINTEND
