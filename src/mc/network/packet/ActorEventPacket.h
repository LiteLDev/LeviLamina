...
class ActorEventPacket : public ::ll::PayloadPacket<::ActorEventPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit ActorEventPacket(::ActorEventPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::ActorEventPacketPayload payload);
    // NOLINTEND
