...
#include "mc/network/packet/ClientCacheBlobStatusPacketPayload.h"
...
class ClientCacheBlobStatusPacket : public ::ll::PayloadPacket<::ClientCacheBlobStatusPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit ClientCacheBlobStatusPacket(::ClientCacheBlobStatusPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::ClientCacheBlobStatusPacketPayload payload);
    // NOLINTEND
