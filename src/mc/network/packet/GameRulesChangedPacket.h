...
#include "mc/network/packet/GameRulesChangedPacketPayload.h"
...
class GameRulesChangedPacket : public ::ll::PayloadPacket<::GameRulesChangedPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI GameRulesChangedPacket();

    MCAPI explicit GameRulesChangedPacket(::GameRulesChangedPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::GameRulesChangedPacketPayload payload);
    // NOLINTEND
