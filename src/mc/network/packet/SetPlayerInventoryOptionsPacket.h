...
#include "mc/network/packet/SetPlayerInventoryOptionsPacketPayload.h"
...
class SetPlayerInventoryOptionsPacket : public ::ll::PayloadPacket<::SetPlayerInventoryOptionsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SetPlayerInventoryOptionsPacket(::SetPlayerInventoryOptionsPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SetPlayerInventoryOptionsPacketPayload payload);
    // NOLINTEND
