...
#include "mc/network/packet/ResourcePacksInfoPacketPayload.h"
...
class ResourcePacksInfoPacket : public ::ll::PayloadPacket<::ResourcePacksInfoPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit ResourcePacksInfoPacket(::ResourcePacksInfoPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::ResourcePacksInfoPacketPayload payload);
    // NOLINTEND
