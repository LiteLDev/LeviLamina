...
class SimpleEventPacket : public ::ll::PayloadPacket<::SimpleEventPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SimpleEventPacket(::SimpleEventPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SimpleEventPacketPayload payload);
    // NOLINTEND
