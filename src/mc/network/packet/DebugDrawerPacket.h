...
class DebugDrawerPacket : public ::ll::PayloadPacket<::DebugDrawerPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk5dfd50;
    // NOLINTEND

public:
    // prevent constructor by default
    DebugDrawerPacket& operator=(DebugDrawerPacket const&);
    DebugDrawerPacket(DebugDrawerPacket const&);
    DebugDrawerPacket();
...
public:
    ...
    virtual ~DebugDrawerPacket() /*override*/;
    // NOLINTEND
