...
class MultiplayerSettingsPacket : public ::ll::PayloadPacket<::MultiplayerSettingsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit MultiplayerSettingsPacket(::MultiplayerSettingsPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::MultiplayerSettingsPacketPayload payload);
    // NOLINTEND
