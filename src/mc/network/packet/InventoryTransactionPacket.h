...
public:
     ...
     */
    MCVAPI ~InventoryTransactionPacket(); // NOLINT
#endif
    /**
     * @symbol
     ...
     */
    MCAPI InventoryTransactionPacket(std::unique_ptr<class ComplexInventoryTransaction>, bool); // NOLINT
    /**
     * @symbol ??0InventoryTransactionPacket\@\@QEAA\@XZ
     */
    MCAPI InventoryTransactionPacket(); // NOLINT
    /**
     * @symbol ?postLoadItems\@InventoryTransactionPacket\@\@QEBAXAEAVBlockPalette\@\@_N\@Z
     */
    MCAPI void postLoadItems(class BlockPalette&, bool) const; // NOLINT
};
