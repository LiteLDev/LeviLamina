...
#include "mc/network/packet/PlayerArmorDamagePacketPayload.h"
...
class PlayerArmorDamagePacket : public ::ll::PayloadPacket<::PlayerArmorDamagePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    virtual ~PlayerArmorDamagePacket() /*override*/;
    // NOLINTEND
