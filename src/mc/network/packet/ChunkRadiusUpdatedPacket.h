...
class ChunkRadiusUpdatedPacket : public ::ll::PayloadPacket<::ChunkRadiusUpdatedPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit ChunkRadiusUpdatedPacket(::ChunkRadiusUpdatedPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::ChunkRadiusUpdatedPacketPayload payload);
    // NOLINTEND
