...
#include "mc/network/packet/SetActorLinkPacketPayload.h"
...
class SetActorLinkPacket : public ::ll::PayloadPacket<::SetActorLinkPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SetActorLinkPacket(::SetActorLinkPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SetActorLinkPacketPayload payload);
    // NOLINTEND
