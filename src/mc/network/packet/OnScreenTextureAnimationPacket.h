...
#include "mc/network/packet/OnScreenTextureAnimationPacketPayload.h"
...
class OnScreenTextureAnimationPacket : public ::ll::PayloadPacket<::OnScreenTextureAnimationPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit OnScreenTextureAnimationPacket(::OnScreenTextureAnimationPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::OnScreenTextureAnimationPacketPayload payload);
    // NOLINTEND
