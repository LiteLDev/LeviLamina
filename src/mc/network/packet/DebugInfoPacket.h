...
class DebugInfoPacket : public ::ll::PayloadPacket<::DebugInfoPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnke8910a;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit DebugInfoPacket(::DebugInfoPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::DebugInfoPacketPayload payload);
    // NOLINTEND
