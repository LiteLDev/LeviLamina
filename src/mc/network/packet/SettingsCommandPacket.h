...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnkd8a830;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI_C explicit SettingsCommandPacket(::SettingsCommandPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI_C void* $ctor(::SettingsCommandPacketPayload payload);
    // NOLINTEND
