...
struct ClientboundCloseFormPacketPayload;
namespace cereal { struct ReflectionCtx; }
// clang-format on

class ClientboundCloseFormPacket : public ::ll::PayloadPacket<::ClientboundCloseFormPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnkb18a11;
    // NOLINTEND
