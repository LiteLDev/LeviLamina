...
class CreatePhotoPacket : public ::ll::PayloadPacket<::CreatePhotoPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk9b7c89;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit CreatePhotoPacket(::CreatePhotoPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::CreatePhotoPacketPayload payload);
    // NOLINTEND
