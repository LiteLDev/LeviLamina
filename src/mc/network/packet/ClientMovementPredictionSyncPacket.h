...
#include "mc/network/packet/ClientMovementPredictionSyncPacketPayload.h"
...
class ClientMovementPredictionSyncPacket : public ::ll::PayloadPacket<::ClientMovementPredictionSyncPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI ClientMovementPredictionSyncPacket();

#ifdef LL_PLAT_C
    MCAPI explicit ClientMovementPredictionSyncPacket(::ClientMovementPredictionSyncPacketPayload payload);
#endif
    // NOLINTEND
...
#ifdef LL_PLAT_C
    MCAPI void* $ctor(::ClientMovementPredictionSyncPacketPayload payload);
#endif
    // NOLINTEND
