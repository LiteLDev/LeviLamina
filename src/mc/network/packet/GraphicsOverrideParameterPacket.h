...
class GraphicsOverrideParameterPacket : public ::ll::PayloadPacket<::GraphicsOverrideParameterPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk4d7583;
    // NOLINTEND

public:
    // prevent constructor by default
    GraphicsOverrideParameterPacket& operator=(GraphicsOverrideParameterPacket const&);
    GraphicsOverrideParameterPacket(GraphicsOverrideParameterPacket const&);
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI GraphicsOverrideParameterPacket();
    // NOLINTEND
