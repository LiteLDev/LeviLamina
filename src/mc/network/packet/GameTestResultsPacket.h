...
class GameTestResultsPacket : public ::ll::PayloadPacket<::GameTestResultsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit GameTestResultsPacket(::GameTestResultsPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::GameTestResultsPacketPayload payload);
    // NOLINTEND
