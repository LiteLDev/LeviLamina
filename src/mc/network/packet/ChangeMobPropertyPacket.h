...
class ChangeMobPropertyPacket : public ::ll::PayloadPacket<::ChangeMobPropertyPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk4917e6;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit ChangeMobPropertyPacket(::ChangeMobPropertyPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::ChangeMobPropertyPacketPayload payload);
    // NOLINTEND
