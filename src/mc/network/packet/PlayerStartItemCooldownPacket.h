...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk5911c3;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit PlayerStartItemCooldownPacket(::PlayerStartItemCooldownPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::PlayerStartItemCooldownPacketPayload payload);
    // NOLINTEND
