...
#include "mc/network/packet/PlayerStartItemCooldownPacketPayload.h"
...
class PlayerStartItemCooldownPacket : public ::ll::PayloadPacket<::PlayerStartItemCooldownPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit PlayerStartItemCooldownPacket(::PlayerStartItemCooldownPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::PlayerStartItemCooldownPacketPayload payload);
    // NOLINTEND
