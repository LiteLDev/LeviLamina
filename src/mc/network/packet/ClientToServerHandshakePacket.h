...
struct ClientToServerHandshakePacketPayload;
namespace cereal { struct ReflectionCtx; }
// clang-format on

class ClientToServerHandshakePacket : public ::ll::PayloadPacket<::ClientToServerHandshakePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk5efb58;
    // NOLINTEND
