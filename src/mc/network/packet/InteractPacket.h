...
#include "mc/network/packet/InteractPacketPayload.h"
...
class InteractPacket : public ::ll::PayloadPacket<::InteractPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit InteractPacket(::InteractPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::InteractPacketPayload payload);
    // NOLINTEND
