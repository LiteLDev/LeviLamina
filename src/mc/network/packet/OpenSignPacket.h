...
#include "mc/network/packet/OpenSignPacketPayload.h"
...
public:
    ...
    MCAPI explicit OpenSignPacket(::OpenSignPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::OpenSignPacketPayload payload);
    // NOLINTEND
