...
#include "mc/network/packet/ServerStoreInfoPacketPayload.h"
...
class ServerStoreInfoPacket : public ::ll::PayloadPacket<::ServerStoreInfoPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
