...
class TickingAreasLoadStatusPacket : public ::ll::PayloadPacket<::TickingAreasLoadStatusPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit TickingAreasLoadStatusPacket(::TickingAreasLoadStatusPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::TickingAreasLoadStatusPacketPayload payload);
    // NOLINTEND
