...
class SetDifficultyPacket : public ::ll::PayloadPacket<::SetDifficultyPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SetDifficultyPacket(::SetDifficultyPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SetDifficultyPacketPayload payload);
    // NOLINTEND
