...
class CameraPacket : public ::ll::PayloadPacket<::CameraPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit CameraPacket(::CameraPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::CameraPacketPayload payload);
    // NOLINTEND
