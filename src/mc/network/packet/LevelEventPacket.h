...
#include "mc/network/packet/LevelEventPacketPayload.h"
...
class LevelEventPacket : public ::ll::PayloadPacket<::LevelEventPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit LevelEventPacket(::LevelEventPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::LevelEventPacketPayload payload);
    // NOLINTEND
