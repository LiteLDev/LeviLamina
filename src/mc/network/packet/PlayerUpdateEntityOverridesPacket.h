...
#include "mc/network/packet/PlayerUpdateEntityOverridesPacketPayload.h"
...
class PlayerUpdateEntityOverridesPacket : public ::ll::PayloadPacket<::PlayerUpdateEntityOverridesPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
