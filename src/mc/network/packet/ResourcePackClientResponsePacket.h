...
#include "mc/network/packet/ResourcePackClientResponsePacketPayload.h"
...
class ResourcePackClientResponsePacket : public ::ll::PayloadPacket<::ResourcePackClientResponsePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit ResourcePackClientResponsePacket(::ResourcePackClientResponsePacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::ResourcePackClientResponsePacketPayload payload);
    // NOLINTEND
