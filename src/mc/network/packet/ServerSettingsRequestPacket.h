...
struct ServerSettingsRequestPacketPayload;
namespace cereal { struct ReflectionCtx; }
// clang-format on

class ServerSettingsRequestPacket : public ::ll::PayloadPacket<::ServerSettingsRequestPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk962caf;
    // NOLINTEND
