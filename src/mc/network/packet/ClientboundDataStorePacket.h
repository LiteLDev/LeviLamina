...
#include "mc/network/packet/ClientboundDataStorePacketPayload.h"
...
class ClientboundDataStorePacket : public ::ll::PayloadPacket<::ClientboundDataStorePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI ClientboundDataStorePacket();

    MCAPI explicit ClientboundDataStorePacket(::ClientboundDataStorePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::ClientboundDataStorePacketPayload payload);
    // NOLINTEND
