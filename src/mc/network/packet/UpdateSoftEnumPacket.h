...
public:
     ...
     */
    MCVAPI ~UpdateSoftEnumPacket(); // NOLINT
#endif
    /**
     * @symbol ??0UpdateSoftEnumPacket\@\@QEAA\@XZ
     */
    MCAPI UpdateSoftEnumPacket(); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI
    UpdateSoftEnumPacket(enum class SoftEnumUpdateType, std::string const&, std::vector<std::string> const&); // NOLINT
};
