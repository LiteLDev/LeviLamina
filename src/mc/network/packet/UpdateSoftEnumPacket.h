...
class UpdateSoftEnumPacket : public ::ll::PayloadPacket<::UpdateSoftEnumPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk3555ef;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI UpdateSoftEnumPacket();

    MCNAPI explicit UpdateSoftEnumPacket(::UpdateSoftEnumPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCNAPI void* $ctor(::UpdateSoftEnumPacketPayload payload);
    // NOLINTEND
