...
class TakeItemActorPacket : public ::ll::PayloadPacket<::TakeItemActorPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit TakeItemActorPacket(::TakeItemActorPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::TakeItemActorPacketPayload payload);
    // NOLINTEND
