...
class UpdateBlockSyncedPacket : public ::ll::PayloadPacket<::UpdateBlockSyncedPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit UpdateBlockSyncedPacket(::UpdateBlockSyncedPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::UpdateBlockSyncedPacketPayload payload);
    // NOLINTEND
