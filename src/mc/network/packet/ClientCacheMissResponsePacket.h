...
#include "mc/network/packet/ClientCacheMissResponsePacketPayload.h"
...
class ClientCacheMissResponsePacket : public ::ll::PayloadPacket<::ClientCacheMissResponsePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
