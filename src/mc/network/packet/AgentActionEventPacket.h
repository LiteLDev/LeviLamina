...
public:
     ...
     */
    MCVAPI ~AgentActionEventPacket(); // NOLINT
#endif
    /**
     * @symbol
     ...
     */
    MCAPI AgentActionEventPacket(std::string const&, enum class AgentActionType, class Json::Value const&); // NOLINT
    /**
     * @symbol ??0AgentActionEventPacket\@\@QEAA\@XZ
     */
    MCAPI AgentActionEventPacket(); // NOLINT
};
