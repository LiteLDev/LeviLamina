...
#include "mc/network/packet/UpdateSubChunkBlocksPacketPayload.h"
...
class UpdateSubChunkBlocksPacket : public ::ll::PayloadPacket<::UpdateSubChunkBlocksPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit UpdateSubChunkBlocksPacket(::UpdateSubChunkBlocksPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::UpdateSubChunkBlocksPacketPayload payload);
    // NOLINTEND
