...
#include "mc/network/packet/BlockActorDataPacketPayload.h"
...
class BlockActorDataPacket : public ::ll::PayloadPacket<::BlockActorDataPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
#else // LL_PLAT_C
    virtual ~BlockActorDataPacket() /*override*/;
#endif
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit BlockActorDataPacket(::BlockActorDataPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::BlockActorDataPacketPayload payload);
    // NOLINTEND
