...
#include "mc/network/packet/PlayerHotbarPacketPayload.h"
...
public:
    ...
    MCAPI explicit PlayerHotbarPacket(::PlayerHotbarPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::PlayerHotbarPacketPayload payload);
    // NOLINTEND
