...
#include "mc/network/packet/UpdateTradePacketPayload.h"
...
class UpdateTradePacket : public ::ll::PayloadPacket<::UpdateTradePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit UpdateTradePacket(::UpdateTradePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::UpdateTradePacketPayload payload);
    // NOLINTEND
