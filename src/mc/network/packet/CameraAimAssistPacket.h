...
class CameraAimAssistPacket : public ::ll::PayloadPacket<::CameraAimAssistPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnkc1396f;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit CameraAimAssistPacket(::CameraAimAssistPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::CameraAimAssistPacketPayload payload);
    // NOLINTEND
