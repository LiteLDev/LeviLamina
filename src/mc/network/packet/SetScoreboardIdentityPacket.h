...
#include "mc/network/packet/SetScoreboardIdentityPacketPayload.h"
...
class SetScoreboardIdentityPacket : public ::ll::PayloadPacket<::SetScoreboardIdentityPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
