...
class AddVolumeEntityPacket : public ::ll::PayloadPacket<::AddVolumeEntityPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit AddVolumeEntityPacket(::AddVolumeEntityPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::AddVolumeEntityPacketPayload payload);
    // NOLINTEND
