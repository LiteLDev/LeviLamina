...
#include "mc/network/packet/StructureBlockUpdatePacketPayload.h"
...
class StructureBlockUpdatePacket : public ::ll::PayloadPacket<::StructureBlockUpdatePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
