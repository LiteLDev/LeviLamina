...
class SetLastHurtByPacket : public ::ll::PayloadPacket<::SetLastHurtByPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SetLastHurtByPacket(::SetLastHurtByPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SetLastHurtByPacketPayload payload);
    // NOLINTEND
