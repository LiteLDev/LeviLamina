...
class LevelSoundEventPacket : public ::ll::PayloadPacket<::LevelSoundEventPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCNAPI explicit LevelSoundEventPacket(::LevelSoundEventPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCNAPI void* $ctor(::LevelSoundEventPacketPayload payload);
    // NOLINTEND
