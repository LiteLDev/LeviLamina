...
class MotionPredictionHintsPacket : public ::ll::PayloadPacket<::MotionPredictionHintsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit MotionPredictionHintsPacket(::MotionPredictionHintsPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::MotionPredictionHintsPacketPayload payload);
    // NOLINTEND
