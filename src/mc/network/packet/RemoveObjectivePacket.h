...
class RemoveObjectivePacket : public ::ll::PayloadPacket<::RemoveObjectivePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk9298e5;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit RemoveObjectivePacket(::RemoveObjectivePacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::RemoveObjectivePacketPayload payload);
    // NOLINTEND
