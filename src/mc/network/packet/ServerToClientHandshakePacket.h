...
class ServerToClientHandshakePacket : public ::ll::PayloadPacket<::ServerToClientHandshakePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk5b98a9;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit ServerToClientHandshakePacket(::ServerToClientHandshakePacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::ServerToClientHandshakePacketPayload payload);
    // NOLINTEND
