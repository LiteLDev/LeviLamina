...
#include "mc/network/packet/LabTablePacketPayload.h"
...
class LabTablePacket : public ::ll::PayloadPacket<::LabTablePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit LabTablePacket(::LabTablePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::LabTablePacketPayload payload);
    // NOLINTEND
