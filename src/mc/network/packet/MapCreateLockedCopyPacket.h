...
class MapCreateLockedCopyPacket : public ::ll::PayloadPacket<::MapCreateLockedCopyPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit MapCreateLockedCopyPacket(::MapCreateLockedCopyPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::MapCreateLockedCopyPacketPayload payload);
    // NOLINTEND
