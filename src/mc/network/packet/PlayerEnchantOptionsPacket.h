...
#include "mc/network/packet/PlayerEnchantOptionsPacketPayload.h"
...
class PlayerEnchantOptionsPacket : public ::ll::PayloadPacket<::PlayerEnchantOptionsPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
