...
#include "mc/network/packet/CorrectPlayerMovePredictionPacketPayload.h"
...
class CorrectPlayerMovePredictionPacket : public ::ll::PayloadPacket<::CorrectPlayerMovePredictionPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI CorrectPlayerMovePredictionPacket();

    MCAPI explicit CorrectPlayerMovePredictionPacket(::CorrectPlayerMovePredictionPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::CorrectPlayerMovePredictionPacketPayload payload);
    // NOLINTEND
