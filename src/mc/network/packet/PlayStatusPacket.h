...
class PlayStatusPacket : public ::ll::PayloadPacket<::PlayStatusPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit PlayStatusPacket(::PlayStatusPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::PlayStatusPacketPayload payload);
    // NOLINTEND
