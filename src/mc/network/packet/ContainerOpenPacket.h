...
class ContainerOpenPacket : public ::ll::PayloadPacket<::ContainerOpenPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit ContainerOpenPacket(::ContainerOpenPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::ContainerOpenPacketPayload payload);
    // NOLINTEND
