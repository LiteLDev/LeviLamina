...
#include "mc/network/packet/ServerPresenceInfoPacketPayload.h"
...
class ServerPresenceInfoPacket : public ::ll::PayloadPacket<::ServerPresenceInfoPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI ServerPresenceInfoPacket();
    // NOLINTEND
