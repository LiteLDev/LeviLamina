...
#include "mc/network/packet/SetHudPacketPayload.h"
...
class SetHudPacket : public ::ll::PayloadPacket<::SetHudPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SetHudPacket(::SetHudPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SetHudPacketPayload payload);
    // NOLINTEND
