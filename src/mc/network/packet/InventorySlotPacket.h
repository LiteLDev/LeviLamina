...
class InventorySlotPacket : public ::ll::PayloadPacket<::InventorySlotPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit InventorySlotPacket(::InventorySlotPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::InventorySlotPacketPayload payload);
    // NOLINTEND
