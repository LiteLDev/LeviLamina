...
class CameraShakePacket : public ::ll::PayloadPacket<::CameraShakePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit CameraShakePacket(::CameraShakePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::CameraShakePacketPayload payload);
    // NOLINTEND
