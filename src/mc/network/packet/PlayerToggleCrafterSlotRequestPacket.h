...
#ifdef LL_PLAT_C
    MCAPI explicit PlayerToggleCrafterSlotRequestPacket(::PlayerToggleCrafterSlotRequestPacketPayload payload);
#endif
    // NOLINTEND
...
#ifdef LL_PLAT_C
    MCAPI void* $ctor(::PlayerToggleCrafterSlotRequestPacketPayload payload);
#endif
    // NOLINTEND
