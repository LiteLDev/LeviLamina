...
#include "mc/network/packet/ShowStoreOfferPacketPayload.h"
...
class ShowStoreOfferPacket : public ::ll::PayloadPacket<::ShowStoreOfferPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
#else // LL_PLAT_C
    virtual ~ShowStoreOfferPacket() /*override*/ = default;
#endif
