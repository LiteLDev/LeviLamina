...
#include "mc/network/packet/FeatureRegistryPacketPayload.h"
...
class FeatureRegistryPacket : public ::ll::PayloadPacket<::FeatureRegistryPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI FeatureRegistryPacket();

    MCAPI explicit FeatureRegistryPacket(::FeatureRegistryPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::FeatureRegistryPacketPayload payload);
    // NOLINTEND
