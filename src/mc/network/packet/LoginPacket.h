...
#include "mc/network/packet/LoginPacketPayload.h"
...
class LoginPacket : public ::ll::PayloadPacket<::LoginPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
#ifdef LL_PLAT_C
    MCAPI explicit LoginPacket(::LoginPacketPayload payload);
#endif
    // NOLINTEND
...
#ifdef LL_PLAT_C
    MCAPI void* $ctor(::LoginPacketPayload payload);
#endif
    // NOLINTEND
