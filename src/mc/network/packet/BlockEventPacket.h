...
class BlockEventPacket : public ::ll::PayloadPacket<::BlockEventPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit BlockEventPacket(::BlockEventPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::BlockEventPacketPayload payload);
    // NOLINTEND
