...
#include "mc/network/packet/ClientboundAttributeLayerSyncPacketPayload.h"
...
class ClientboundAttributeLayerSyncPacket : public ::ll::PayloadPacket<::ClientboundAttributeLayerSyncPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
