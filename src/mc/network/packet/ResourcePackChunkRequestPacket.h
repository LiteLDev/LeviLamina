...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit ResourcePackChunkRequestPacket(::ResourcePackChunkRequestPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::ResourcePackChunkRequestPacketPayload payload);
    // NOLINTEND
