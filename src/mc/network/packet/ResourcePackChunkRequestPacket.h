...
#include "mc/network/packet/ResourcePackChunkRequestPacketPayload.h"
...
class ResourcePackChunkRequestPacket : public ::ll::PayloadPacket<::ResourcePackChunkRequestPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
#ifdef LL_PLAT_S
    virtual ~ResourcePackChunkRequestPacket() /*override*/ = default;
#else // LL_PLAT_C
    virtual ~ResourcePackChunkRequestPacket() /*override*/;
#endif
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit ResourcePackChunkRequestPacket(::ResourcePackChunkRequestPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::ResourcePackChunkRequestPacketPayload payload);
    // NOLINTEND
