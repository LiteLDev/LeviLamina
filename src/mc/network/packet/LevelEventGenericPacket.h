...
public:
     ...
     */
    MCVAPI ~LevelEventGenericPacket(); // NOLINT
#endif
    /**
     * @symbol ??0LevelEventGenericPacket\@\@QEAA\@W4LevelEvent\@\@AEBVCompoundTag\@\@\@Z
     */
    MCAPI LevelEventGenericPacket(enum class LevelEvent, class CompoundTag const&); // NOLINT
    /**
     * @symbol ??0LevelEventGenericPacket\@\@QEAA\@XZ
     */
    MCAPI LevelEventGenericPacket(); // NOLINT
};
