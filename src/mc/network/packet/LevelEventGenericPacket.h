...
class LevelEventGenericPacket : public ::ll::PayloadPacket<::LevelEventGenericPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit LevelEventGenericPacket(::LevelEventGenericPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::LevelEventGenericPacketPayload payload);
    // NOLINTEND
