...
#include "mc/network/packet/AvailableActorIdentifiersPacketPayload.h"
...
class AvailableActorIdentifiersPacket : public ::ll::PayloadPacket<::AvailableActorIdentifiersPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit AvailableActorIdentifiersPacket(::AvailableActorIdentifiersPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::AvailableActorIdentifiersPacketPayload payload);
    // NOLINTEND
