...
#include "mc/network/packet/ClientboundMapItemDataPacketPayload.h"
...
class ClientboundMapItemDataPacket : public ::ll::PayloadPacket<::ClientboundMapItemDataPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
