...
class SpawnExperienceOrbPacket : public ::ll::PayloadPacket<::SpawnExperienceOrbPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SpawnExperienceOrbPacket(::SpawnExperienceOrbPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SpawnExperienceOrbPacketPayload payload);
    // NOLINTEND
