...
class CodeBuilderPacket : public ::ll::PayloadPacket<::CodeBuilderPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnk2b01c3;
    // NOLINTEND
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit CodeBuilderPacket(::CodeBuilderPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::CodeBuilderPacketPayload payload);
    // NOLINTEND
