...
class SetTimePacket : public ::ll::PayloadPacket<::SetTimePacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit SetTimePacket(::SetTimePacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::SetTimePacketPayload payload);
    // NOLINTEND
