...
public:
     ...
     * @vftbl 2
     * @symbol
     * ?getName\@SetTimePacket\@\@UEBA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@XZ
     */
     ...
     * @vftbl 7
     * @symbol
     * ?_read\@SetTimePacket\@\@EEAA?AV?$Result\@XVerror_code\@std\@\@\@Bedrock\@\@AEAVReadOnlyBinaryStream\@\@\@Z
     */
     ...
     */
    MCVAPI ~SetTimePacket(); // NOLINT
#endif
    /**
     * @symbol ??0SetTimePacket\@\@QEAA\@XZ
     */
    MCAPI SetTimePacket(); // NOLINT
    /**
     * @symbol ??0SetTimePacket\@\@QEAA\@H\@Z
     */
    MCAPI SetTimePacket(int); // NOLINT
};
