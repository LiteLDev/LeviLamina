...
public:
     ...
     */
    MCVAPI ~InventoryContentPacket(); // NOLINT
#endif
    /**
     * @symbol ??0InventoryContentPacket\@\@QEAA\@XZ
     */
    MCAPI InventoryContentPacket(); // NOLINT
    /**
     * @symbol
     * ??0InventoryContentPacket\@\@QEAA\@W4ContainerID\@\@AEBV?$vector\@VItemStack\@\@V?$allocator\@VItemStack\@\@\@std\@\@\@std\@\@\@Z
     */
    MCAPI InventoryContentPacket(enum class ContainerID, std::vector<class ItemStack> const&); // NOLINT
    /**
     * @symbol ?fromPlayerInventoryId\@InventoryContentPacket\@\@SA?AV1\@W4ContainerID\@\@AEAVPlayer\@\@\@Z
     */
    MCAPI static class InventoryContentPacket fromPlayerInventoryId(enum class ContainerID, class Player&); // NOLINT
};
