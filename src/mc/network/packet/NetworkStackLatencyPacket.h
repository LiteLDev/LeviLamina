...
#include "mc/network/packet/NetworkStackLatencyPacketPayload.h"
...
class NetworkStackLatencyPacket : public ::ll::PayloadPacket<::NetworkStackLatencyPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
#ifdef LL_PLAT_S
    virtual ~NetworkStackLatencyPacket() /*override*/ = default;
#else // LL_PLAT_C
    virtual ~NetworkStackLatencyPacket() /*override*/;
#endif
