...
#include "mc/network/packet/UpdateAttributesPacketPayload.h"
...
class UpdateAttributesPacket : public ::ll::PayloadPacket<::UpdateAttributesPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit UpdateAttributesPacket(::UpdateAttributesPacketPayload payload);
    // NOLINTEND

public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::UpdateAttributesPacketPayload payload);
    // NOLINTEND
