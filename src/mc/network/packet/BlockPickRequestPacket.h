...
class BlockPickRequestPacket : public ::ll::PayloadPacket<::BlockPickRequestPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
#ifdef LL_PLAT_C
    MCAPI explicit BlockPickRequestPacket(::BlockPickRequestPacketPayload payload);
#endif
    // NOLINTEND
...
#ifdef LL_PLAT_C
    MCAPI void* $ctor(::BlockPickRequestPacketPayload payload);
#endif
    // NOLINTEND
