...
#include "mc/network/packet/ClientboundTextureShiftPacketPayload.h"
...
class ClientboundTextureShiftPacket : public ::ll::PayloadPacket<::ClientboundTextureShiftPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
