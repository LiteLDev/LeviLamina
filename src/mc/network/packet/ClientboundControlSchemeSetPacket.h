...
#include "mc/network/packet/ClientboundControlSchemeSetPacketPayload.h"
...
class ClientboundControlSchemeSetPacket : public ::ll::PayloadPacket<::ClientboundControlSchemeSetPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI ClientboundControlSchemeSetPacket();

    MCAPI explicit ClientboundControlSchemeSetPacket(::ClientboundControlSchemeSetPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::ClientboundControlSchemeSetPacketPayload payload);
    // NOLINTEND
