...
class AwardAchievementPacket : public ::ll::PayloadPacket<::AwardAchievementPacketPayload> {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    MCAPI explicit AwardAchievementPacket(::AwardAchievementPacketPayload payload);
    // NOLINTEND
...
public:
    ...
    MCAPI void* $ctor(::AwardAchievementPacketPayload payload);
    // NOLINTEND
