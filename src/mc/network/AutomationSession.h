...
public:
     ...
     */
    MCVAPI void agentCommand(std::string const&, struct CodeBuilder::CommandRequest&&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCVAPI bool encryptConnection(std::string const&, struct CodeBuilder::EncryptionRequest const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCVAPI void error(std::string const&, struct CodeBuilder::ErrorMessage const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCVAPI void subscribe(std::string const&, std::string const&); // NOLINT
    /**
     * @symbol
     * ?unsubscribe\@AutomationSession\@Automation\@\@EEAAXAEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@0\@Z
     */
    MCVAPI void unsubscribe(std::string const&, std::string const&); // NOLINT
    /**
     * @symbol __unk_destructor_-1
     */
    MCVAPI ~AutomationSession(); // NOLINT
#endif
    /**
     * @symbol ??0AutomationSession\@Automation\@\@QEAA\@AEAVAutomationClient\@1\@\@Z
     */
    MCAPI AutomationSession(class Automation::AutomationClient&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI enum class WSConnectionResult connect(std::string const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI enum class WSConnectionResult connect(std::string const&, std::vector<std::string> const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI bool
    dhKeyExchange(std::string const&, std::string const&, std::string const&, enum class CodeBuilder::EncryptionCipherMode, std::string&); // NOLINT
    /**
