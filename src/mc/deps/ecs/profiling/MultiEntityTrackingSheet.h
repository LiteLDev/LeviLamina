...
class MultiEntityTrackingSheet : public ::ECS::Profiling::IEntityTrackingSheet {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4>      mUnk36bb92;
    ::ll::UntypedStorage<8, 732816> mUnkbeb17a;
    // NOLINTEND
...
public:
    ...
    virtual ~MultiEntityTrackingSheet() /*override*/ = default;
    // NOLINTEND
