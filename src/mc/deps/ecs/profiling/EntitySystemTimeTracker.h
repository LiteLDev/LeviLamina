...
public:
    ...
    // NOLINTBEGIN
#ifdef LL_PLAT_C
    MCNAPI void finishTimingCurrentEntity(::EntityId entity);

    MCNAPI void setTrackingSheet(::Bedrock::NonOwnerPointer<::ECS::Profiling::IEntityTrackingSheet> trackingSheet);
