...
MCAPI void addObjectField(class Json::Value&, std::string const&, class Json::Value const& object);

// symbol:
// ?addStringField@JsonHelpers@@YAXAEAVValue@Json@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@1@Z
MCAPI void addStringField(class Json::Value&, std::string const&, std::string const& value);
