...
getMemberByCaseInsensitiveName(class Json::Value&, class std::basic_string_view<char, struct std::char_traits<char>> const&);
/**
 * @symbol
...
getMemberByCaseInsensitiveNameConst(class Json::Value const&, class std::basic_string_view<char, struct std::char_traits<char>> const&);
/**
 * @symbol
 ...
 */
MCAPI bool
parseItem(std::string&, std::string&, int&, class std::basic_string_view<char, struct std::char_traits<char>>);
/**
 ...
 */
MCAPI void
printJsonSchema_childNode(std::string&, std::string const&, class HashedString const&, std::string const&, bool, unsigned __int64, unsigned __int64, std::string const&, std::string const&);
/**
 * @symbol
