 ...
 */
MCAPI std::pair<class Json::Value const, enum class PackParseErrorType>
 ...
 */
MCAPI std::pair<class Json::Value const, enum class PackParseErrorType> readValueAndReportErrors(
    class Json::Value const&,
    std::string const&,
