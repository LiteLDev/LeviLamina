...
public:
    ...
    ::ll::UntypedStorage<1, 1>  mUnk7a2ca6;
    ::ll::UntypedStorage<1, 1>  mUnkc83861;
    ::ll::UntypedStorage<4, 4>  mUnkb63cd5;
    bool                        mUnkc0d797 : 1;
    bool                        mUnkec249f : 1;
    bool                        mUnk63a5ec : 1;
    bool                        mUnk8c2808 : 1;
    ::ll::UntypedStorage<4, 4>  mUnk44ca14;
    ::ll::UntypedStorage<4, 4>  mUnkccc5db;
    // NOLINTEND
