...
public:
     ...
     */
    MCAPI
    SchemaFactory(struct cereal::ReflectionCtx&, std::unique_ptr<class cereal::internal::BasicCompositeSchema>, std::string const&, std::string const&); // NOLINT
