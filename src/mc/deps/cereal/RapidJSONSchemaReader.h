...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_CEREAL_RAPIDJSONSCHEMAREADER
public:
...
public:
     ...
     */
    virtual class std::optional<signed char> asInt8(struct cereal::SerializerTraits const&);
    /**
     * @vftbl 6
     * @symbol ?asUInt8\@RapidJSONSchemaReader\@cereal\@\@UEAA?AV?$optional\@E\@std\@\@AEBUSerializerTraits\@2\@\@Z
     */
    virtual class std::optional<unsigned char> asUInt8(struct cereal::SerializerTraits const&);
    /**
     * @vftbl 7
     * @symbol ?asInt16\@RapidJSONSchemaReader\@cereal\@\@UEAA?AV?$optional\@F\@std\@\@AEBUSerializerTraits\@2\@\@Z
     */
    virtual class std::optional<short> asInt16(struct cereal::SerializerTraits const&);
    /**
     * @vftbl 8
     * @symbol ?asUInt16\@RapidJSONSchemaReader\@cereal\@\@UEAA?AV?$optional\@G\@std\@\@AEBUSerializerTraits\@2\@\@Z
     */
    virtual class std::optional<unsigned short> asUInt16(struct cereal::SerializerTraits const&);
    /**
     * @vftbl 9
     * @symbol ?asInt32\@RapidJSONSchemaReader\@cereal\@\@UEAA?AV?$optional\@H\@std\@\@AEBUSerializerTraits\@2\@\@Z
     */
    virtual class std::optional<int> asInt32(struct cereal::SerializerTraits const&);
    /**
     * @vftbl 10
     * @symbol ?asUInt32\@RapidJSONSchemaReader\@cereal\@\@UEAA?AV?$optional\@I\@std\@\@AEBUSerializerTraits\@2\@\@Z
     */
    virtual class std::optional<unsigned int> asUInt32(struct cereal::SerializerTraits const&);
    /**
     * @vftbl 11
     * @symbol ?asInt64\@RapidJSONSchemaReader\@cereal\@\@UEAA?AV?$optional\@_J\@std\@\@AEBUSerializerTraits\@2\@\@Z
     */
    virtual class std::optional<__int64> asInt64(struct cereal::SerializerTraits const&);
    /**
     * @vftbl 12
     * @symbol ?asUInt64\@RapidJSONSchemaReader\@cereal\@\@UEAA?AV?$optional\@_K\@std\@\@AEBUSerializerTraits\@2\@\@Z
     */
    virtual class std::optional<unsigned __int64> asUInt64(struct cereal::SerializerTraits const&);
    /**
     * @vftbl 13
     ...
     */
    MCVAPI unsigned __int64 length(struct cereal::SerializerTraits const&);
    /**
     * @symbol ?members\@RapidJSONSchemaReader\@cereal\@\@UEAA_KAEBUSerializerTraits\@2\@\@Z
     */
    MCVAPI unsigned __int64 members(struct cereal::SerializerTraits const&);
    /**
