 ...
 */
MCAPI bool alwaysTrue(int64_t, entt::meta_any&);
/**
 * @symbol
...
MCAPI struct cereal::internal::Result getMapperAndLoad(
    ...
    bool(__cdecl*)(int64_t, entt::meta_any&)
);
/**
 * @symbol
...
MCAPI struct cereal::
    internal::
        Result
        iterateSequenceContainer(class cereal::internal::BasicSchema const&, struct cereal::internal::Result(__cdecl*)(class cereal::internal::BasicSchema const&, struct cereal::SchemaReader&, entt::meta_any&, struct cereal::SerializerTraits const&, entt::meta_any const&, class cereal::SerializerContext&), entt::meta_type const&, struct cereal::SchemaReader&, entt::meta_any&, struct cereal::SerializerTraits const&, entt::meta_any const&, class cereal::SerializerContext&);
/**
 * @symbol
