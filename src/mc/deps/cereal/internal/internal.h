 ...
 */
MCAPI struct cereal::internal::Result
validateTagsSequence(struct cereal::ReflectionCtx const&, std::vector<std::pair<std::string, std::string>> const&, class entt::meta_type const&, struct cereal::SchemaReader&, struct cereal::SerializerTraits const&, class cereal::SerializerContext&);
// NOLINTEND
