 ...
 */
MCAPI bool alwaysTrue(__int64, class entt::meta_any&);
/**
 * @symbol
...
derefAndLoad(class cereal::internal::BasicSchema const&, struct cereal::SchemaReader&, class entt::meta_any&, struct cereal::SerializerTraits const&, class entt::meta_any const&, class cereal::SerializerContext&);
/**
 * @symbol
 ...
 */
MCAPI struct cereal::internal::Result
derefAndSave(class cereal::internal::BasicSchema const&, struct cereal::SchemaWriter&, class entt::meta_any const&, struct cereal::SerializerTraits const&, class cereal::SerializerContext&);
/**
 * @symbol
 ...
 */
MCAPI struct cereal::internal::Result
derefAndValidate(class cereal::internal::BasicSchema const&, struct cereal::SchemaReader&, class entt::meta_any&, struct cereal::SerializerTraits const&, class cereal::SerializerContext&);
/**
 * @symbol
 ...
 */
MCAPI struct cereal::internal::Result
getMapperAndSave(class entt::meta_any const&, class entt::meta_type const&, class cereal::SerializerEnumMapping const*, struct cereal::SchemaWriter&, struct cereal::SerializerTraits const&, class cereal::SerializerContext&);
/**
 * @symbol
...
getNameAndVersion(struct cereal::ReflectionCtx const&, struct entt::type_info const&);
/**
 * @symbol
 ...
 */
MCAPI struct cereal::internal::Result
loadMapElement(struct cereal::ReflectionCtx const&, class entt::meta_type const&, class cereal::internal::BasicSchema const&, std::string const&, class entt::meta_any&, struct cereal::SchemaReader&, struct cereal::SerializerTraits const&, class entt::meta_any const&, class cereal::SerializerContext&);
/**
 * @symbol
 ...
 */
MCAPI struct cereal::internal::Result
loadSequenceElement(class cereal::internal::BasicSchema const&, struct cereal::SchemaReader&, class entt::meta_any&, struct cereal::SerializerTraits const&, class entt::meta_any const&, class cereal::SerializerContext&);
/**
 * @symbol
 ...
 */
MCAPI bool
saveAssociativeContainer(struct cereal::ReflectionCtx const&, class entt::meta_type const&, class entt::meta_any const&, class cereal::internal::BasicSchema const&, class cereal::internal::BasicSchema const&, struct cereal::SchemaWriter&, struct cereal::SerializerTraits const&, class cereal::SerializerContext&);
/**
 * @symbol
 ...
 */
MCAPI struct cereal::internal::Result
saveSequenceContainer(class cereal::internal::BasicSchema const&, struct cereal::SchemaWriter&, class entt::meta_any const&, struct cereal::SerializerTraits const&, class cereal::SerializerContext&);
/**
 * @symbol
 ...
 */
MCAPI struct cereal::internal::Result
validateMapElement(struct cereal::ReflectionCtx const&, class entt::meta_type const&, class cereal::internal::BasicSchema const&, std::string const&, class entt::meta_any&, struct cereal::SchemaReader&, struct cereal::SerializerTraits const&, class entt::meta_any const&, class cereal::SerializerContext&);
/**
 * @symbol
 ...
 */
MCAPI struct cereal::internal::Result
validateSequenceElement(class cereal::internal::BasicSchema const&, struct cereal::SchemaReader&, class entt::meta_any&, struct cereal::SerializerTraits const&, class entt::meta_any const&, class cereal::SerializerContext&);
/**
 * @symbol
 ...
 */
MCAPI struct cereal::internal::Result
validateTagsSequence(struct cereal::ReflectionCtx const&, std::vector<struct std::pair<std::string, std::string>> const&, class entt::meta_type const&, struct cereal::SchemaReader&, struct cereal::SerializerTraits const&, class cereal::SerializerContext&);
