...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_CORE_FILESYSTEM
public:
...
public:
     ...
     */
    MCAPI static class Core::Result getFileOrDirectorySize(class Core::Path const&, unsigned __int64*);
    /**
     * @symbol ?getFileSize\@FileSystem\@Core\@\@SA?AVResult\@2\@AEBVPath\@2\@PEA_K\@Z
     */
    MCAPI static class Core::Result getFileSize(class Core::Path const&, unsigned __int64*);
    /**
     * @symbol ?getLastModificationTime\@FileSystem\@Core\@\@SA?AVResult\@2\@AEBVPath\@2\@PEA_J\@Z
     */
    MCAPI static class Core::Result getLastModificationTime(class Core::Path const&, __int64*);
    /**
     * @symbol
     ...
     */
    MCAPI static class Core::Result
    readFileData(class Core::Path const&, unsigned __int64, unsigned __int64, std::vector<unsigned char>&, unsigned __int64&);
    /**
     * @symbol
