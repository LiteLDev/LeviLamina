...
public:
    ...
    openFile(class Core::Path const&, class Core::FileOpenMode, enum class Core::FileBufferingMode); // NOLINT
    /**
     * @vftbl 2
     * @symbol ?fileExists\@FileSystemInterfaceImpl\@Core\@\@UEAA_NAEBVPath\@2\@\@Z
     */
    virtual bool fileExists(class Core::Path const&); // NOLINT
    /**
     * @vftbl 3
     * @symbol
     ...
     */
    MCAPI FileSystemInterfaceImpl(); // NOLINT
};
