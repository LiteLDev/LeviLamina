 ...
 */
MCAPI struct std::nullopt_t createContext(); // NOLINT
/**
 * @symbol
 * ?createContext\@Detail\@Bedrock\@\@YA?AUContext\@CallStack\@2\@V?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@\@Z
 */
MCAPI struct Bedrock::CallStack::Context createContext(std::string); // NOLINT
/**
 * @symbol ?createError\@Detail\@Bedrock\@\@YA?AU?$ErrorInfoBuilder\@Verror_code\@std\@\@\@12\@W4errc\@std\@\@\@Z
 */
MCAPI struct Bedrock::Detail::ErrorInfoBuilder<class std::error_code> createError(enum class std::errc); // NOLINT
/**
 * @symbol ?defaultDataStoreDelete\@Detail\@Bedrock\@\@YAXAEBVPath\@Core\@\@\@Z
 */
MCAPI void defaultDataStoreDelete(class Core::Path const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI class std::optional<std::string> defaultDataStoreLoad(class Core::Path const&); // NOLINT
/**
 * @symbol
 * ?defaultDataStoreSave\@Detail\@Bedrock\@\@YAXAEBVPath\@Core\@\@V?$basic_string_view\@DU?$char_traits\@D\@std\@\@\@std\@\@\@Z
 */
MCAPI void
defaultDataStoreSave(class Core::Path const&, class std::basic_string_view<char, struct std::char_traits<char>>); // NOLINT
