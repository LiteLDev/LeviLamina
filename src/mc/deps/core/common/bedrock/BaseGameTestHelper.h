...
public:
    ...
    /**
     * @vftbl 32
     * @symbol ?assertEntityInstancePresent\@MinecraftGameTestHelper\@\@UEBA?AV?$optional\@UGameTestError\@gametest\@\@\@std\@\@PEBVActor\@\@_N\@Z
     */
     ...
     */
    virtual std::optional<struct gametest::GameTestError> assertEntityHasArmor(struct ActorDefinitionIdentifier const &, enum class ArmorSlot, std::string const &, int32_t, class BlockPos const &, bool) = 0;
    /**
     * @vftbl 45
     ...
     */
    virtual std::optional<struct gametest::GameTestError> spreadFromFaceTowardDirection(class BlockPos const &, enum class ScriptModuleMinecraft::ScriptFacing, enum class ScriptModuleMinecraft::ScriptFacing) = 0;
    /**
     * @vftbl 58
     ...
     */
    virtual std::variant<struct gametest::GameTestError, class SimulatedPlayer *> spawnSimulatedPlayer(std::string const &, class BlockPos const &, enum class GameType) = 0;
    /**
     * @vftbl 59
     ...
     */
    MCAPI struct gametest::GameTestError generateErrorWithContext(enum class gametest::GameTestErrorType, std::string, class BlockPos const &) const;
    /**
     ...
     */
    MCAPI struct gametest::GameTestError generateErrorWithContext(enum class gametest::GameTestErrorType, std::string, std::vector<std::string>, class BlockPos const &) const;
    /**
