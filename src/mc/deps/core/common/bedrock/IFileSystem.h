...
public:
    ...
    openFile(class Core::Path const&, class Core::FileOpenMode, enum class Core::FileBufferingMode) = 0;
    /**
     * @vftbl 2
    ...
    iterateOverDirectory(class Core::Path const&, enum class Core::DirectoryIterationFlags, std::function<class Core::Result(struct Core::DirectoryIterationItem const&)>) = 0;
    /**
     * @vftbl 4
     * @symbol
