 ...
 */
MCAPI extern struct std::adopt_lock_t const& AdoptLock; // NOLINT
/**
 * @symbol ?DeferLock\@Threading\@Bedrock\@\@3AEBUdefer_lock_t\@std\@\@EB
 */
MCAPI extern struct std::defer_lock_t const& DeferLock; // NOLINT
/**
 * @symbol ?IS_RUNNING_STATICS\@Threading\@Bedrock\@\@YA_NXZ
 */
MCAPI bool IS_RUNNING_STATICS(); // NOLINT
/**
 * @symbol ?MakeErrorCode\@Threading\@Bedrock\@\@YA?AVerror_code\@std\@\@W4AsyncErrc\@12\@\@Z
 */
MCAPI class std::error_code MakeErrorCode(enum class Bedrock::Threading::AsyncErrc); // NOLINT
/**
 * @symbol ?TryToLock\@Threading\@Bedrock\@\@3AEBUtry_to_lock_t\@std\@\@EB
 */
MCAPI extern struct std::try_to_lock_t const& TryToLock; // NOLINT
/**
 * @symbol ?getDefaultWorkerPool\@Threading\@Bedrock\@\@YA?AV?$not_null\@PEAVWorkerPool\@\@\@gsl\@\@XZ
 */
MCAPI class gsl::not_null<class WorkerPool*> getDefaultWorkerPool(); // NOLINT
/**
 * @symbol ?getMainThread\@Threading\@Bedrock\@\@YAAEAVAssignedThread\@12\@XZ
 */
MCAPI class Bedrock::Threading::AssignedThread& getMainThread(); // NOLINT
/**
 * @symbol ?getMainThreadScheduler\@Threading\@Bedrock\@\@YA?AV?$not_null\@PEAVScheduler\@\@\@gsl\@\@XZ
 */
MCAPI class gsl::not_null<class Scheduler*> getMainThreadScheduler(); // NOLINT
/**
 * @symbol ?getNetworkWorkerPool\@Threading\@Bedrock\@\@YA?AV?$not_null\@PEAVWorkerPool\@\@\@gsl\@\@XZ
 */
MCAPI class gsl::not_null<class WorkerPool*> getNetworkWorkerPool(); // NOLINT
/**
 * @symbol ?getServerThread\@Threading\@Bedrock\@\@YAAEAVAssignedThread\@12\@XZ
 */
MCAPI class Bedrock::Threading::AssignedThread& getServerThread(); // NOLINT
