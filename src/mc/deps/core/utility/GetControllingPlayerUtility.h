 ...
 */
MCAPI bool hasControllingPassenger(struct SynchedActorDataComponent const&, struct VehicleComponent const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI bool
isPassengerControllingVehicle(class StrictEntityContext const&, struct VehicleComponent const&, struct SynchedActorDataComponent const&); // NOLINT
/**
 * @symbol ?isWASDControlled\@GetControllingPlayerUtility\@\@YA_NAEBUSynchedActorDataComponent\@\@\@Z
 */
MCAPI bool isWASDControlled(struct SynchedActorDataComponent const&); // NOLINT
/**
 * @symbol
...
MCAPI class
    std::
        optional<class StrictEntityContext>
        tryGetControllingPlayerContext(class StrictEntityContext, class ViewT<class StrictEntityContext, class EntityRegistryBase, class FlagComponent<struct LocalPlayerComponentFlag> const>*, class ViewT<class StrictEntityContext, class EntityRegistryBase, class FlagComponent<struct ServerPlayerComponentFlag> const>*, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct Include<class FlagComponent<struct BoatFlag>>, struct VehicleComponent const>*, class ViewT<class StrictEntityContext, class EntityRegistryBase, struct Include<class FlagComponent<struct HorseFlag>>, struct VehicleComponent const, struct SynchedActorDataComponent const>*); // NOLINT
