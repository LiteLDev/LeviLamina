...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_CORE_FILE
public:
...
public:
    ...
    writeCreateOrAppendFileData(class Core::Path const&, unsigned __int64, unsigned __int64, std::vector<unsigned char> const&);
    /**
     * @symbol ?writeCreateOrAppendFileData\@File\@Core\@\@SA?AVResult\@2\@AEBVPath\@2\@_K1PEBE\@Z
     */
    MCAPI static class Core::Result
    writeCreateOrAppendFileData(class Core::Path const&, unsigned __int64, unsigned __int64, unsigned char const*);
};
