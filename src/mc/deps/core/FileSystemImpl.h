...
public:
    ...
    /**
     * @vftbl 15
     * @symbol ?_readFileData\@FileSystemImpl\@Core\@\@MEAA?AVResult\@2\@AEBVPath\@2\@AEAV?$vector\@EV?$allocator\@E\@std\@\@\@std\@\@\@Z
     */
    ...
    /**
     * @vftbl 26
     * @symbol ?_getDirectoryFiles\@FileSystemImpl\@Core\@\@MEAA?AVResult\@2\@AEAV?$vector\@V?$PathBuffer\@V?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@\@Core\@\@V?$allocator\@V?$PathBuffer\@V?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@\@Core\@\@\@std\@\@\@std\@\@AEBVPath\@2\@\@Z
     */
    virtual class Core::Result _getDirectoryFiles(std::vector<class Core::PathBuffer<std::string>> &, class Core::Path const &);
    /**
     * @vftbl 27
     * @symbol ?_getDirectoryFilesRecursively\@FileSystemImpl\@Core\@\@MEAA?AVResult\@2\@AEAV?$vector\@V?$PathBuffer\@V?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@\@Core\@\@V?$allocator\@V?$PathBuffer\@V?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@\@Core\@\@\@std\@\@\@std\@\@AEBVPath\@2\@\@Z
     */
    ...
    /**
     * @vftbl 29
     * @symbol ?_getDirectoryFilesAllocatedSizeRecursively\@FileSystemImpl\@Core\@\@MEAA?AVResult\@2\@AEA_K0AEBVPath\@2\@\@Z
     */
    ...
    /**
     * @vftbl 39
     * @symbol ?_flatFileIterateOverDirectory\@FileSystemImpl\@Core\@\@MEAA?AVResult\@2\@AEBVPath\@2\@0W4DirectoryIterationFlags\@2\@V?$function\@$$A6A?AVResult\@Core\@\@AEBUDirectoryIterationItem\@2\@\@Z\@std\@\@\@Z
     */
    virtual class Core::Result _flatFileIterateOverDirectory(class Core::Path const &, class Core::Path const &, enum class Core::DirectoryIterationFlags, std::function<class Core::Result (struct Core::DirectoryIterationItem const &)>);
    /**
     * @vftbl 40
    ...
    /**
     * @vftbl 41
     * @symbol ?_copyFlatFile\@FileSystemImpl\@Core\@\@MEAA?AVResult\@2\@AEBVPath\@2\@0AEBV?$vector\@UExcludedPath\@Core\@\@V?$allocator\@UExcludedPath\@Core\@\@\@std\@\@\@std\@\@1\@Z
     */
    ...
    /**
     * @vftbl 47
     * @symbol ?_writeOperation\@FileSystemImpl\@Core\@\@MEAA?AVResult\@2\@AEBVPath\@2\@$$QEAV32\@V?$function\@$$A6AXPEAVFileStorageArea\@Core\@\@\@Z\@std\@\@_K\@Z
     */
     ...
     */
    MCAPI FileSystemImpl(enum class Core::FileAccessType, std::shared_ptr<class Core::FileStorageArea>, enum class Core::TransactionFlags, std::shared_ptr<class Core::FlatFileManifestTracker>);
    /**
     ...
     */
    MCAPI class Core::Result iterateOverDirectory(class Core::Path const &, enum class Core::DirectoryIterationFlags, std::function<class Core::Result (struct Core::DirectoryIterationItem const &)>);
    /**
     ...
     */
    MCAPI class Core::Result openFile(std::unique_ptr<class Core::FileImpl> &, class Core::Path const &, class Core::FileOpenMode, enum class Core::FileBufferingMode);
    /**
     ...
     */
    MCAPI class Core::Result _flatFileOpenFlatFile(std::unique_ptr<class Core::FileImpl> &, class Core::Path const &, class Core::Path const &, class Core::FileOpenMode, enum class Core::FileBufferingMode);
    /**
