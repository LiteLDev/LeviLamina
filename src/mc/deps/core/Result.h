...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_CORE_RESULT
public:
...
public:
     ...
     */
    MCAPI Result(bool, class std::function<void(class Core::Result*)>);
    /**
     ...
     */
    MCAPI static class Core::Result makeFailure(class std::function<void(class Core::Result*)>&&);
    /**
