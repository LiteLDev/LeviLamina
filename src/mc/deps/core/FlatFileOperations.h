...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_CORE_FLATFILEOPERATIONS
public:
...
public:
     ...
     */
    MCAPI static unsigned __int64 const FLAT_FILE_CURRENT_VERSION;
    /**
     * @symbol
     ...
     */
    MCAPI static unsigned __int64 const FLAT_FILE_INVALID_VERSION;
    /**
     * @symbol
     ...
     */
    MCAPI static unsigned __int64 const FLAT_FILE_WRITE_CHUNK_SIZE;
    /**
     * @symbol
