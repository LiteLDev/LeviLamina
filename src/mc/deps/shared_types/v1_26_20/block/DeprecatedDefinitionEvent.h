...
public:
    ...
    ::ll::TypedStorage<8, 24, ::std::vector<::SharedTypes::v1_26_20::BlockDefinition::DeprecatedDefinitionEvent>>
                                                                                                          mChildren;
...
public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::SharedTypes::v1_26_20::BlockDefinition::DeprecatedDefinitionEvent const&);
    // NOLINTEND
