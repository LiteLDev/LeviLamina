...
public:
    ...
    MCNAPI CameraPreset(::SharedTypes::v1_21_70::CameraPreset&&);
...
public:
    ...
    MCNAPI static ::Bedrock::Result<::SharedTypes::v1_21_70::CameraPreset> read(::ReadOnlyBinaryStream& stream);
    // NOLINTEND
...
public:
    ...
    MCNAPI void* $ctor(::SharedTypes::v1_21_70::CameraPreset&&);
    // NOLINTEND
