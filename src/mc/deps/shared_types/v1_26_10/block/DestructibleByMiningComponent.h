...
public:
    ...
    public:
        ...
        ::ll::TypedStorage<
            8,
            24,
            ::std::vector<::SharedTypes::v1_26_10::BlockDefinition::DestructibleByMiningComponent::ItemSpecificSpeed>>
            mItemSpecificSpeeds;
        // NOLINTEND
...
public:
    ...
    ::ll::TypedStorage<
        ...
        40,
        ::std::
            variant<bool, ::SharedTypes::v1_26_10::BlockDefinition::DestructibleByMiningComponent::DetailedMiningSpeed>>
        mMiningSpeedValue;
    // NOLINTEND
