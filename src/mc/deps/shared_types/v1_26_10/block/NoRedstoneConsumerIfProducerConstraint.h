...
struct NoRedstoneConsumerIfProducerConstraint
: public ::cereal::ConstraintHandle<::SharedTypes::v1_26_10::BlockDefinition::NoRedstoneConsumerIfProducerConstraint> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~NoRedstoneConsumerIfProducerConstraint() /*override*/ = default;
    // NOLINTEND
