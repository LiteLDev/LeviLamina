...
struct RandomOffsetInBoundConstraint
: public ::cereal::ConstraintHandle<::SharedTypes::v1_26_10::BlockDefinition::RandomOffsetInBoundConstraint> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~RandomOffsetInBoundConstraint() /*override*/ = default;
    // NOLINTEND
