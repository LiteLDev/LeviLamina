...
: public ::cereal::ConstraintHandle<::SharedTypes::v1_26_10::BlockDefinition::NoRandomOffsetIfUnitBlockConstraint> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~NoRandomOffsetIfUnitBlockConstraint() /*override*/ = default;
    // NOLINTEND
