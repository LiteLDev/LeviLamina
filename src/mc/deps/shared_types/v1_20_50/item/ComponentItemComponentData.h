...
public:
    ...
    ::ll::TypedStorage<8, 40, ::std::optional<::SharedTypes::v1_20_50::IconItemComponent>> iconItemComponent;
...
public:
    ...
    MCAPI bool operator==(::SharedTypes::v1_20_50::ComponentItemComponentData const&) const;
