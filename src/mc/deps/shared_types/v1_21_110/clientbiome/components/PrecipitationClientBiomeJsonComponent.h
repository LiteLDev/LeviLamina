...
struct PrecipitationClientBiomeJsonComponent : public ::SharedTypes::v1_21_40::IClientBiomeJsonComponent {
public:
    // member variables
    // NOLINTBEGIN
...
public:
    ...
    virtual ~PrecipitationClientBiomeJsonComponent() /*override*/ = default;
    // NOLINTEND
