...
public:
    ...
    ::ll::TypedStorage<1, 1, ::SharedTypes::PushMode>                    mPushMode;
    ::ll::TypedStorage<1, 1, bool>                                       mRequireCollisionOverlap;
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI bool operator==(::SharedTypes::v1_26_40::PushableByEntityPreset const&) const;
    // NOLINTEND
