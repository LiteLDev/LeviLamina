...
#include "mc/deps/shared_types/v1_26_0/item/DamageItemComponent.h"
#include "mc/deps/shared_types/v1_26_0/item/PlanterItemComponent.h"
...
public:
    ...
    ::ll::TypedStorage<2, 4, ::std::optional<::SharedTypes::v1_26_0::DamageItemComponent>>    damageItemComponent;
    ...
    ::ll::TypedStorage<8, 72, ::std::optional<::SharedTypes::v1_26_0::PlanterItemComponent>> planterItemComponent;
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI ComponentItemComponentData(::SharedTypes::v1_26_0::ComponentItemComponentData&&);

    MCAPI ComponentItemComponentData(::SharedTypes::v1_26_0::ComponentItemComponentData const&);

    MCFOLD ::std::shared_ptr<::cereal::DynamicValue>
    getCustomComponent(::cereal::SerializerContext const& context) const;

    MCAPI ::SharedTypes::v1_26_0::ComponentItemComponentData&
    operator=(::SharedTypes::v1_26_0::ComponentItemComponentData&&);

    MCAPI ::SharedTypes::v1_26_0::ComponentItemComponentData&
    operator=(::SharedTypes::v1_26_0::ComponentItemComponentData const&);

    MCAPI bool operator==(::SharedTypes::v1_26_0::ComponentItemComponentData const&) const;
...
public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI void* $ctor(::SharedTypes::v1_26_0::ComponentItemComponentData&&);

    MCAPI void* $ctor(::SharedTypes::v1_26_0::ComponentItemComponentData const&);
    // NOLINTEND
