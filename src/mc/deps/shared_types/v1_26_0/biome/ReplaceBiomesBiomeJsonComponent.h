...
public:
    ...
    public:
        // member functions
        // NOLINTBEGIN
        MCFOLD ::SharedTypes::v1_26_0::ReplaceBiomesBiomeJsonComponent::BiomeReplacement&
        operator=(::SharedTypes::v1_26_0::ReplaceBiomesBiomeJsonComponent::BiomeReplacement&&);

        MCFOLD ::SharedTypes::v1_26_0::ReplaceBiomesBiomeJsonComponent::BiomeReplacement&
        operator=(::SharedTypes::v1_26_0::ReplaceBiomesBiomeJsonComponent::BiomeReplacement const&);
...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<8, 24, ::std::vector<::SharedTypes::v1_26_0::ReplaceBiomesBiomeJsonComponent::BiomeReplacement>>
        mBiomeReplacements;
    // NOLINTEND
