...
public:
    ...
    public:
        ...
        ::ll::TypedStorage<8, 32, ::SharedTypes::v1_21_110::BiomeJsonDocument::BiomeJsonObject::BiomeDescription>
                                                                           mDescription;
        ::ll::TypedStorage<8, 48, ::SharedTypes::v1_26_0::BiomeComponents> mComponents;
        // NOLINTEND
    ...
    public:
        // member functions
        // NOLINTBEGIN
        MCFOLD ::SharedTypes::v1_26_0::BiomeJsonDocument::BiomeJsonObject&
        operator=(::SharedTypes::v1_26_0::BiomeJsonDocument::BiomeJsonObject&&);

        MCFOLD ::SharedTypes::v1_26_0::BiomeJsonDocument::BiomeJsonObject&
        operator=(::SharedTypes::v1_26_0::BiomeJsonDocument::BiomeJsonObject const&);
