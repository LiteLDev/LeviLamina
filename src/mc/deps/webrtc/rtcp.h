...
// NOLINTBEGIN
// symbol: ?GetRemoteEstimateSerializer@rtcp@webrtc@@YAPEBVRemoteEstimateSerializer@12@XZ
MCAPI class webrtc::rtcp::RemoteEstimateSerializer const* GetRemoteEstimateSerializer();
// NOLINTEND
