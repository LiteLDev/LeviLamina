...
public:
    ...
    struct RemoteSystemStruct {
    public:
        // RemoteSystemStruct inner types declare
        // clang-format off
    ...
    public:
         ...
         */
        MCAPI RemoteSystemStruct(); // NOLINT
        /**
...
public:
     ...
     */
    MCVAPI void AddToBanList(char const*, unsigned int); // NOLINT
    /**
     * @symbol ?AddToSecurityExceptionList\@RakPeer\@RakNet\@\@UEAAXPEBD\@Z
     */
    MCVAPI void AddToSecurityExceptionList(char const*); // NOLINT
    /**
     * @symbol ?AdvertiseSystem\@RakPeer\@RakNet\@\@UEAA_NPEBDG0HI\@Z
     */
    MCVAPI bool AdvertiseSystem(char const*, unsigned short, char const*, int, unsigned int); // NOLINT
    /**
     * @symbol ?AllocRNS2RecvStruct\@RakPeer\@RakNet\@\@MEAAPEAURNS2RecvStruct\@2\@PEBDI\@Z
     */
    MCVAPI struct RakNet::RNS2RecvStruct* AllocRNS2RecvStruct(char const*, unsigned int); // NOLINT
    /**
     * @symbol ?AllocatePacket\@RakPeer\@RakNet\@\@UEAAPEAUPacket\@2\@I\@Z
     */
    MCVAPI struct RakNet::Packet* AllocatePacket(unsigned int); // NOLINT
    /**
     * @symbol ?AllowConnectionResponseIPMigration\@RakPeer\@RakNet\@\@UEAAX_N\@Z
     */
    MCVAPI void AllowConnectionResponseIPMigration(bool); // NOLINT
    /**
     * @symbol ?ApplyNetworkSimulator\@RakPeer\@RakNet\@\@UEAAXMGG\@Z
     */
    MCVAPI void ApplyNetworkSimulator(float, unsigned short, unsigned short); // NOLINT
    /**
     * @symbol ?AttachPlugin\@RakPeer\@RakNet\@\@UEAAXPEAVPluginInterface2\@2\@\@Z
     */
    MCVAPI void AttachPlugin(class RakNet::PluginInterface2*); // NOLINT
    /**
     * @symbol ?CancelConnectionAttempt\@RakPeer\@RakNet\@\@UEAAXUSystemAddress\@2\@\@Z
     */
    MCVAPI void CancelConnectionAttempt(struct RakNet::SystemAddress); // NOLINT
    /**
     * @symbol ?ChangeSystemAddress\@RakPeer\@RakNet\@\@UEAAXURakNetGUID\@2\@AEBUSystemAddress\@2\@\@Z
     */
    MCVAPI void ChangeSystemAddress(struct RakNet::RakNetGUID, struct RakNet::SystemAddress const&); // NOLINT
    /**
     * @symbol ?ClearBanList\@RakPeer\@RakNet\@\@UEAAXXZ
     */
    MCVAPI void ClearBanList(); // NOLINT
    /**
     * @symbol ?CloseConnection\@RakPeer\@RakNet\@\@UEAAXUAddressOrGUID\@2\@_NEW4PacketPriority\@\@\@Z
     */
    MCVAPI void CloseConnection(struct RakNet::AddressOrGUID, bool, unsigned char, enum class PacketPriority); // NOLINT
    /**
     ...
     */
    MCVAPI void DeallocRNS2RecvStruct(struct RakNet::RNS2RecvStruct*, char const*, unsigned int); // NOLINT
    /**
     * @symbol ?DeallocatePacket\@RakPeer\@RakNet\@\@UEAAXPEAUPacket\@2\@\@Z
     */
    MCVAPI void DeallocatePacket(struct RakNet::Packet*); // NOLINT
    /**
     * @symbol ?DetachPlugin\@RakPeer\@RakNet\@\@UEAAXPEAVPluginInterface2\@2\@\@Z
     */
    MCVAPI void DetachPlugin(class RakNet::PluginInterface2*); // NOLINT
    /**
     * @symbol ?DisableSecurity\@RakPeer\@RakNet\@\@UEAAXXZ
     */
    MCVAPI void DisableSecurity(); // NOLINT
    /**
     * @symbol ?GetAveragePing\@RakPeer\@RakNet\@\@UEAAHUAddressOrGUID\@2\@\@Z
     */
    MCVAPI int GetAveragePing(struct RakNet::AddressOrGUID); // NOLINT
    /**
     * @symbol ?GetClientPublicKeyFromSystemAddress\@RakPeer\@RakNet\@\@UEBA_NUSystemAddress\@2\@PEAD\@Z
     */
    MCVAPI bool GetClientPublicKeyFromSystemAddress(struct RakNet::SystemAddress, char*) const; // NOLINT
    /**
     * @symbol ?GetClockDifferential\@RakPeer\@RakNet\@\@UEAA_KUAddressOrGUID\@2\@\@Z
     */
    MCVAPI unsigned __int64 GetClockDifferential(struct RakNet::AddressOrGUID); // NOLINT
    /**
     * @symbol ?GetConnectionList\@RakPeer\@RakNet\@\@UEBA_NPEAUSystemAddress\@2\@PEAG\@Z
     */
    MCVAPI bool GetConnectionList(struct RakNet::SystemAddress*, unsigned short*) const; // NOLINT
    /**
     * @symbol ?GetConnectionState\@RakPeer\@RakNet\@\@UEAA?AW4ConnectionState\@2\@UAddressOrGUID\@2\@\@Z
     */
    MCVAPI enum class RakNet::ConnectionState GetConnectionState(struct RakNet::AddressOrGUID); // NOLINT
    /**
     * @symbol ?GetExternalID\@RakPeer\@RakNet\@\@UEBA?AUSystemAddress\@2\@U32\@\@Z
     */
    MCVAPI struct RakNet::SystemAddress GetExternalID(struct RakNet::SystemAddress) const; // NOLINT
    /**
     * @symbol ?GetGUIDFromIndex\@RakPeer\@RakNet\@\@UEAA?AURakNetGUID\@2\@I\@Z
     */
    MCVAPI struct RakNet::RakNetGUID GetGUIDFromIndex(unsigned int); // NOLINT
    /**
     * @symbol ?GetGuidFromSystemAddress\@RakPeer\@RakNet\@\@UEBAAEBURakNetGUID\@2\@USystemAddress\@2\@\@Z
     */
    MCVAPI struct RakNet::RakNetGUID const& GetGuidFromSystemAddress(struct RakNet::SystemAddress) const; // NOLINT
    /**
     * @symbol ?GetIncomingPassword\@RakPeer\@RakNet\@\@UEAAXPEADPEAH\@Z
     */
    MCVAPI void GetIncomingPassword(char*, int*); // NOLINT
    /**
     * @symbol ?GetIndexFromSystemAddress\@RakPeer\@RakNet\@\@UEBAHUSystemAddress\@2\@\@Z
     */
    MCVAPI int GetIndexFromSystemAddress(struct RakNet::SystemAddress) const; // NOLINT
    /**
     * @symbol ?GetInternalID\@RakPeer\@RakNet\@\@UEBA?AUSystemAddress\@2\@U32\@H\@Z
     */
    MCVAPI struct RakNet::SystemAddress GetInternalID(struct RakNet::SystemAddress, int) const; // NOLINT
    /**
     * @symbol ?GetLastPing\@RakPeer\@RakNet\@\@UEBAHUAddressOrGUID\@2\@\@Z
     */
    MCVAPI int GetLastPing(struct RakNet::AddressOrGUID) const; // NOLINT
    /**
     * @symbol ?GetLocalAdapter\@RakPeer\@RakNet\@\@UEAAAEAUNetworkAdapter\@2\@I\@Z
     */
    MCVAPI struct RakNet::NetworkAdapter& GetLocalAdapter(unsigned int); // NOLINT
    /**
     * @symbol ?GetLocalIP\@RakPeer\@RakNet\@\@UEAAPEBDI\@Z
     */
    MCVAPI char const* GetLocalIP(unsigned int); // NOLINT
    /**
     * @symbol ?GetLowestPing\@RakPeer\@RakNet\@\@UEBAHUAddressOrGUID\@2\@\@Z
     */
    MCVAPI int GetLowestPing(struct RakNet::AddressOrGUID) const; // NOLINT
    /**
     * @symbol ?GetMTUSize\@RakPeer\@RakNet\@\@UEBAHUSystemAddress\@2\@\@Z
     */
    MCVAPI int GetMTUSize(struct RakNet::SystemAddress) const; // NOLINT
    /**
     * @symbol ?GetMaximumIncomingConnections\@RakPeer\@RakNet\@\@UEBAIXZ
     */
    MCVAPI unsigned int GetMaximumIncomingConnections() const; // NOLINT
    /**
     * @symbol ?GetMaximumNumberOfPeers\@RakPeer\@RakNet\@\@UEBAIXZ
     */
    MCVAPI unsigned int GetMaximumNumberOfPeers() const; // NOLINT
    /**
     * @symbol ?GetMyBoundAddress\@RakPeer\@RakNet\@\@UEAA?AUSystemAddress\@2\@H\@Z
     */
    MCVAPI struct RakNet::SystemAddress GetMyBoundAddress(int); // NOLINT
    /**
     * @symbol ?GetMyGUID\@RakPeer\@RakNet\@\@UEBA?BURakNetGUID\@2\@XZ
     */
    MCVAPI struct RakNet::RakNetGUID const GetMyGUID() const; // NOLINT
    /**
     * @symbol ?GetNextSendReceipt\@RakPeer\@RakNet\@\@UEAAIXZ
     */
    MCVAPI unsigned int GetNextSendReceipt(); // NOLINT
    /**
     * @symbol ?GetNumberOfAdapters\@RakPeer\@RakNet\@\@UEAAIXZ
     */
    MCVAPI unsigned int GetNumberOfAdapters(); // NOLINT
    /**
     * @symbol ?GetNumberOfAddresses\@RakPeer\@RakNet\@\@UEAAIXZ
     */
    MCVAPI unsigned int GetNumberOfAddresses(); // NOLINT
    /**
     * @symbol ?GetOfflinePingResponse\@RakPeer\@RakNet\@\@UEAAXPEAPEADPEAI\@Z
     */
    MCVAPI void GetOfflinePingResponse(char**, unsigned int*); // NOLINT
    /**
     * @symbol ?GetReceiveBufferSize\@RakPeer\@RakNet\@\@UEAAIXZ
     */
    MCVAPI unsigned int GetReceiveBufferSize(); // NOLINT
    /**
     * @symbol ?GetSocket\@RakPeer\@RakNet\@\@UEAAPEAVRakNetSocket2\@2\@USystemAddress\@2\@\@Z
     */
    MCVAPI class RakNet::RakNetSocket2* GetSocket(struct RakNet::SystemAddress); // NOLINT
    /**
     * @symbol ?GetSockets\@RakPeer\@RakNet\@\@UEAAXAEAV?$List\@PEAVRakNetSocket2\@RakNet\@\@\@DataStructures\@\@\@Z
     */
    MCVAPI void GetSockets(class DataStructures::List<class RakNet::RakNetSocket2*>&); // NOLINT
    /**
     * @symbol ?GetSplitMessageProgressInterval\@RakPeer\@RakNet\@\@UEBAHXZ
     */
    MCVAPI int GetSplitMessageProgressInterval() const; // NOLINT
    /**
    ...
    GetStatistics(struct RakNet::SystemAddress, struct RakNet::RakNetStatistics*); // NOLINT
    /**
     * @symbol ?GetStatistics\@RakPeer\@RakNet\@\@UEAA_NIPEAURakNetStatistics\@2\@\@Z
     */
    MCVAPI bool GetStatistics(unsigned int, struct RakNet::RakNetStatistics*); // NOLINT
    /**
     * @symbol
     ...
     */
    MCVAPI void
    GetStatisticsList(class DataStructures::List<struct RakNet::SystemAddress>&, class DataStructures::List<struct RakNet::RakNetGUID>&, class DataStructures::List<struct RakNet::RakNetStatistics>&); // NOLINT
    /**
     * @symbol ?GetSystemAddressFromGuid\@RakPeer\@RakNet\@\@UEBA?AUSystemAddress\@2\@URakNetGUID\@2\@\@Z
     */
    MCVAPI struct RakNet::SystemAddress GetSystemAddressFromGuid(struct RakNet::RakNetGUID) const; // NOLINT
    /**
     * @symbol ?GetSystemAddressFromIndex\@RakPeer\@RakNet\@\@UEAA?AUSystemAddress\@2\@I\@Z
     */
    MCVAPI struct RakNet::SystemAddress GetSystemAddressFromIndex(unsigned int); // NOLINT
    /**
     * @symbol
     ...
     */
    MCVAPI unsigned int GetTimeoutTime(struct RakNet::SystemAddress); // NOLINT
    /**
     * @symbol ?IncrementNextSendReceipt\@RakPeer\@RakNet\@\@UEAAIXZ
     */
    MCVAPI unsigned int IncrementNextSendReceipt(); // NOLINT
    /**
     * @symbol ?InitializeSecurity\@RakPeer\@RakNet\@\@UEAA_NPEBD0_N\@Z
     */
    MCVAPI bool InitializeSecurity(char const*, char const*, bool); // NOLINT
    /**
     * @symbol ?IsActive\@RakPeer\@RakNet\@\@UEBA_NXZ
     */
    MCVAPI bool IsActive() const; // NOLINT
    /**
     * @symbol ?IsBanned\@RakPeer\@RakNet\@\@UEAA_NPEBD\@Z
     */
    MCVAPI bool IsBanned(char const*); // NOLINT
    /**
     * @symbol ?IsInSecurityExceptionList\@RakPeer\@RakNet\@\@UEAA_NPEBD\@Z
     */
    MCVAPI bool IsInSecurityExceptionList(char const*); // NOLINT
    /**
     * @symbol ?IsLocalIP\@RakPeer\@RakNet\@\@UEAA_NPEBD\@Z
     */
    MCVAPI bool IsLocalIP(char const*); // NOLINT
    /**
     * @symbol ?IsNetworkSimulatorActive\@RakPeer\@RakNet\@\@UEAA_NXZ
     */
    MCVAPI bool IsNetworkSimulatorActive(); // NOLINT
    /**
     * @symbol ?NumberOfConnections\@RakPeer\@RakNet\@\@UEBAGXZ
     */
    MCVAPI unsigned short NumberOfConnections() const; // NOLINT
    /**
     * @symbol ?OnRNS2Recv\@RakPeer\@RakNet\@\@MEAAXPEAURNS2RecvStruct\@2\@\@Z
     */
    MCVAPI void OnRNS2Recv(struct RakNet::RNS2RecvStruct*); // NOLINT
    /**
     * @symbol ?Ping\@RakPeer\@RakNet\@\@UEAAXUSystemAddress\@2\@\@Z
     */
    MCVAPI void Ping(struct RakNet::SystemAddress); // NOLINT
    /**
     * @symbol ?Ping\@RakPeer\@RakNet\@\@UEAA_NPEBDG_NI\@Z
     */
    MCVAPI bool Ping(char const*, unsigned short, bool, unsigned int); // NOLINT
    /**
     * @symbol ?PushBackPacket\@RakPeer\@RakNet\@\@UEAAXPEAUPacket\@2\@_N\@Z
     */
    MCVAPI void PushBackPacket(struct RakNet::Packet*, bool); // NOLINT
    /**
     * @symbol ?Receive\@RakPeer\@RakNet\@\@UEAAPEAUPacket\@2\@XZ
     */
    MCVAPI struct RakNet::Packet* Receive(); // NOLINT
    /**
     * @symbol ?ReleaseSockets\@RakPeer\@RakNet\@\@UEAAXAEAV?$List\@PEAVRakNetSocket2\@RakNet\@\@\@DataStructures\@\@\@Z
     */
    MCVAPI void ReleaseSockets(class DataStructures::List<class RakNet::RakNetSocket2*>&); // NOLINT
    /**
     * @symbol ?RemoveFromBanList\@RakPeer\@RakNet\@\@UEAAXPEBD\@Z
     */
    MCVAPI void RemoveFromBanList(char const*); // NOLINT
    /**
     * @symbol ?RemoveFromSecurityExceptionList\@RakPeer\@RakNet\@\@UEAAXPEBD\@Z
     */
    MCVAPI void RemoveFromSecurityExceptionList(char const*); // NOLINT
    /**
     * @symbol ?RunUpdateCycle\@RakPeer\@RakNet\@\@UEAA_NAEAVBitStream\@2\@\@Z
     */
    MCVAPI bool RunUpdateCycle(class RakNet::BitStream&); // NOLINT
    /**
     ...
     */
    MCVAPI void SendLoopback(char const*, int); // NOLINT
    /**
     * @symbol ?SendNatTraversalMessage\@RakPeer\@RakNet\@\@UEAAXUSystemAddress\@2\@\@Z
     */
    MCVAPI void SendNatTraversalMessage(struct RakNet::SystemAddress); // NOLINT
    /**
     * @symbol ?SendOutOfBand\@RakPeer\@RakNet\@\@UEAA_NPEBDG0II\@Z
     */
    MCVAPI bool SendOutOfBand(char const*, unsigned short, char const*, unsigned int, unsigned int); // NOLINT
    /**
     * @symbol ?SendTTL\@RakPeer\@RakNet\@\@UEAAXPEBDGHI\@Z
     */
    MCVAPI void SendTTL(char const*, unsigned short, int, unsigned int); // NOLINT
    /**
     * @symbol ?SetIncomingDatagramEventHandler\@RakPeer\@RakNet\@\@UEAAXP6A_NPEAURNS2RecvStruct\@2\@\@Z\@Z
     */
    MCVAPI void SetIncomingDatagramEventHandler(bool (*)(struct RakNet::RNS2RecvStruct*)); // NOLINT
    /**
     * @symbol ?SetIncomingPassword\@RakPeer\@RakNet\@\@UEAAXPEBDH\@Z
     */
    MCVAPI void SetIncomingPassword(char const*, int); // NOLINT
    /**
     * @symbol ?SetInternalID\@RakPeer\@RakNet\@\@UEAAXUSystemAddress\@2\@H\@Z
     */
    MCVAPI void SetInternalID(struct RakNet::SystemAddress, int); // NOLINT
    /**
     * @symbol ?SetLimitIPConnectionFrequency\@RakPeer\@RakNet\@\@UEAAX_N\@Z
     */
    MCVAPI void SetLimitIPConnectionFrequency(bool); // NOLINT
    /**
     * @symbol ?SetMaximumIncomingConnections\@RakPeer\@RakNet\@\@UEAAXG\@Z
     */
    MCVAPI void SetMaximumIncomingConnections(unsigned short); // NOLINT
    /**
     * @symbol ?SetOccasionalPing\@RakPeer\@RakNet\@\@UEAAX_N\@Z
     */
    MCVAPI void SetOccasionalPing(bool); // NOLINT
    /**
     * @symbol ?SetOfflinePingResponse\@RakPeer\@RakNet\@\@UEAAXPEBDI\@Z
     */
    MCVAPI void SetOfflinePingResponse(char const*, unsigned int); // NOLINT
    /**
     * @symbol ?SetPerConnectionOutgoingBandwidthLimit\@RakPeer\@RakNet\@\@UEAAXI\@Z
     */
    MCVAPI void SetPerConnectionOutgoingBandwidthLimit(unsigned int); // NOLINT
    /**
     * @symbol ?SetSplitMessageProgressInterval\@RakPeer\@RakNet\@\@UEAAXH\@Z
     */
    MCVAPI void SetSplitMessageProgressInterval(int); // NOLINT
    /**
     * @symbol ?SetTimeoutTime\@RakPeer\@RakNet\@\@UEAAXIUSystemAddress\@2\@\@Z
     */
    MCVAPI void SetTimeoutTime(unsigned int, struct RakNet::SystemAddress); // NOLINT
    /**
     * @symbol ?SetUnreliableTimeout\@RakPeer\@RakNet\@\@UEAAXI\@Z
     */
    MCVAPI void SetUnreliableTimeout(unsigned int); // NOLINT
    /**
     * @symbol ?SetUserUpdateThread\@RakPeer\@RakNet\@\@UEAAXP6AXPEAVRakPeerInterface\@2\@PEAX\@Z1\@Z
     */
    MCVAPI void SetUserUpdateThread(void (*)(class RakNet::RakPeerInterface*, void*), void*); // NOLINT
    /**
     * @symbol ?Shutdown\@RakPeer\@RakNet\@\@UEAAXIEW4PacketPriority\@\@\@Z
     */
    MCVAPI void Shutdown(unsigned int, unsigned char, enum class PacketPriority); // NOLINT
    /**
     * @symbol ?Startup\@RakPeer\@RakNet\@\@UEAA?AW4StartupResult\@2\@IPEAUSocketDescriptor\@2\@IH\@Z
     */
    MCVAPI enum class RakNet::StartupResult
    Startup(unsigned int, struct RakNet::SocketDescriptor*, unsigned int, int); // NOLINT
    /**
     * @symbol ?WriteOutOfBandHeader\@RakPeer\@RakNet\@\@UEAAXPEAVBitStream\@2\@\@Z
     */
    MCVAPI void WriteOutOfBandHeader(class RakNet::BitStream*); // NOLINT
    /**
     * @symbol ?resetMyGUID\@RakPeer\@RakNet\@\@UEAAXXZ
     */
    MCVAPI void resetMyGUID(); // NOLINT
    /**
     ...
     */
    MCAPI RakPeer(); // NOLINT

    // protected:
    /**
     * @symbol ?AddPacketToProducer\@RakPeer\@RakNet\@\@IEAAXPEAUPacket\@2\@\@Z
     */
    MCAPI void AddPacketToProducer(struct RakNet::Packet*); // NOLINT
    /**
     * @symbol ?AllocPacket\@RakPeer\@RakNet\@\@IEAAPEAUPacket\@2\@IPEAEPEBDI\@Z
     */
    MCAPI struct RakNet::Packet* AllocPacket(unsigned int, unsigned char*, char const*, unsigned int); // NOLINT
    /**
     * @symbol ?AllocPacket\@RakPeer\@RakNet\@\@IEAAPEAUPacket\@2\@IPEBDI\@Z
     */
    MCAPI struct RakNet::Packet* AllocPacket(unsigned int, char const*, unsigned int); // NOLINT
    /**
     * @symbol ?AllowIncomingConnections\@RakPeer\@RakNet\@\@IEBA_NXZ
     */
    MCAPI bool AllowIncomingConnections() const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void
    CallPluginCallbacks(class DataStructures::List<class RakNet::PluginInterface2*>&, struct RakNet::Packet*); // NOLINT
    /**
     * @symbol ?ClearBufferedCommands\@RakPeer\@RakNet\@\@IEAAXXZ
     */
    MCAPI void ClearBufferedCommands(); // NOLINT
    /**
     * @symbol ?ClearBufferedPackets\@RakPeer\@RakNet\@\@IEAAXXZ
     */
    MCAPI void ClearBufferedPackets(); // NOLINT
    /**
     * @symbol ?ClearRequestedConnectionList\@RakPeer\@RakNet\@\@IEAAXXZ
     */
    MCAPI void ClearRequestedConnectionList(); // NOLINT
    /**
     * @symbol ?ClearSocketQueryOutput\@RakPeer\@RakNet\@\@IEAAXXZ
     */
    MCAPI void ClearSocketQueryOutput(); // NOLINT
    /**
    ...
    MCAPI void CloseConnectionInternal(
        struct RakNet::AddressOrGUID const&,
        bool,
        bool,
        unsigned char,
        enum class PacketPriority
     ...
     */
    MCAPI void DerefAllSockets(); // NOLINT
    /**
     * @symbol ?DereferenceRemoteSystem\@RakPeer\@RakNet\@\@IEAAXAEBUSystemAddress\@2\@\@Z
     */
    MCAPI void DereferenceRemoteSystem(struct RakNet::SystemAddress const&); // NOLINT
    /**
     * @symbol ?FillIPList\@RakPeer\@RakNet\@\@IEAAXXZ
     */
    MCAPI void FillIPList(); // NOLINT
    /**
     * @symbol ?GenerateGUID\@RakPeer\@RakNet\@\@IEAAXXZ
     */
    MCAPI void GenerateGUID(); // NOLINT
    /**
     * @symbol ?GetIndexFromSystemAddress\@RakPeer\@RakNet\@\@IEBAHUSystemAddress\@2\@_N\@Z
     */
    MCAPI int GetIndexFromSystemAddress(struct RakNet::SystemAddress, bool) const; // NOLINT
    /**
     * @symbol ?GetRakNetSocketFromUserConnectionSocketIndex\@RakPeer\@RakNet\@\@IEBAII\@Z
     */
    MCAPI unsigned int GetRakNetSocketFromUserConnectionSocketIndex(unsigned int) const; // NOLINT
    /**
    ...
    GetRemoteSystem(struct RakNet::AddressOrGUID, bool, bool) const; // NOLINT
    /**
     * @symbol
     * ?GetRemoteSystemFromSystemAddress\@RakPeer\@RakNet\@\@IEBAPEAURemoteSystemStruct\@12\@USystemAddress\@2\@_N1\@Z
     */
    MCAPI struct RakNet::RakPeer::RemoteSystemStruct*
    GetRemoteSystemFromSystemAddress(struct RakNet::SystemAddress, bool, bool) const; // NOLINT
    /**
     * @symbol ?GetRemoteSystemIndex\@RakPeer\@RakNet\@\@IEBAIAEBUSystemAddress\@2\@\@Z
     */
    MCAPI unsigned int GetRemoteSystemIndex(struct RakNet::SystemAddress const&) const; // NOLINT
    /**
     * @symbol ?IsLoopbackAddress\@RakPeer\@RakNet\@\@IEBA_NAEBUAddressOrGUID\@2\@_N\@Z
     */
    MCAPI bool IsLoopbackAddress(struct RakNet::AddressOrGUID const&, bool) const; // NOLINT
    /**
     * @symbol ?NotifyAndFlagForShutdown\@RakPeer\@RakNet\@\@IEAAXUSystemAddress\@2\@_NEW4PacketPriority\@\@\@Z
     */
    MCAPI void
    NotifyAndFlagForShutdown(struct RakNet::SystemAddress, bool, unsigned char, enum class PacketPriority); // NOLINT
    /**
     * @symbol ?OnConnectedPong\@RakPeer\@RakNet\@\@IEAAX_K0PEAURemoteSystemStruct\@12\@\@Z
     */
    MCAPI void
    OnConnectedPong(unsigned __int64, unsigned __int64, struct RakNet::RakPeer::RemoteSystemStruct*); // NOLINT
    /**
     * @symbol ?OnConnectionRequest\@RakPeer\@RakNet\@\@IEAAXPEAURemoteSystemStruct\@12\@_K\@Z
     */
    MCAPI void OnConnectionRequest(struct RakNet::RakPeer::RemoteSystemStruct*, unsigned __int64); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void PingInternal(struct RakNet::SystemAddress, bool, enum class PacketReliability); // NOLINT
    /**
     * @symbol ?ReferenceRemoteSystem\@RakPeer\@RakNet\@\@IEAAXAEBUSystemAddress\@2\@I\@Z
     */
    MCAPI void ReferenceRemoteSystem(struct RakNet::SystemAddress const&, unsigned int); // NOLINT
    /**
     * @symbol
    ...
    SendConnectionRequest(char const*, unsigned short, char const*, int, struct RakNet::PublicKey*, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, class RakNet::RakNetSocket2*); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void ShiftIncomingTimestamp(unsigned char*, struct RakNet::SystemAddress const&) const; // NOLINT
