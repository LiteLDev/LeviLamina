 ...
 */
MCAPI class Vec2 ComputeFacingRotation(class Vec3, class Vec3 const&, int); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI class Vec3 getFacingDirectionFacingEntity(class Actor const&); // NOLINT
/**
 * @symbol
 * ?getFacingDirectionFacingPosition\@RotationCommandUtils\@\@YA?AVVec3\@\@HAEBVCommandOrigin\@\@VCommandPositionFloat\@\@\@Z
 */
MCAPI class Vec3
getFacingDirectionFacingPosition(int, class CommandOrigin const&, class CommandPositionFloat); // NOLINT
