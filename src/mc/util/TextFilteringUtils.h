...
public:
     ...
     */
    MCAPI static void
    checkChatFilteringEventsAndSendToastIfClientWasMuted(std::vector<enum class Safety::TextFilteringEvent> const&, class gsl::not_null<class PacketSender*>, class NetworkIdentifier const&, enum class SubClientId const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI static bool
    checkChatFilteringEventsForFlooding(std::vector<enum class Safety::TextFilteringEvent> const&); // NOLINT
};
