...
public:
     ...
     */
    MCAPI ExpressionNode(std::string const&, enum class MolangVersion, gsl::span<class HashedString const>);
    /**
     * @symbol
     * ??0ExpressionNode\@\@QEAA\@AEBVValue\@Json\@\@W4MolangVersion\@\@V?$span\@$$CBVHashedString\@\@$0?0\@gsl\@\@\@Z
     */
    MCAPI ExpressionNode(class Json::Value const&, enum class MolangVersion, gsl::span<class HashedString const>);
    /**
     * @symbol
     ...
     */
    MCAPI bool parse(std::string const&, enum class MolangVersion, gsl::span<class HashedString const>);
    /**
     ...
     */
    MCAPI bool _readNextToken(char const*&, gsl::span<class HashedString const> const&, enum class MolangVersion);
    /**
     * @symbol
