...
public:
     ...
     */
    MCAPI static std::function<struct MolangScriptArg const & (class RenderParams &, std::vector<class ExpressionNode> const &)> const * queryFunctionAccessorFromString(std::string const &, enum class MolangVersion, enum class MolangQueryFunctionReturnType &, bool);
    /**
     ...
     */
    MCAPI static struct MolangQueryFunction & registerQueryFunction(std::string const &, std::function<struct MolangScriptArg const & (class RenderParams &, std::vector<class ExpressionNode> const &)>, std::string const &, enum class MolangQueryFunctionReturnType, class HashedString, uint64_t, uint64_t, std::initializer_list<int32_t> const &);
    /**
     ...
     */
    MCAPI bool _tokenize(char const *, struct ExpressionOpBitField &, class gsl::span<class HashedString const> const &, enum class MolangVersion);
    /**
