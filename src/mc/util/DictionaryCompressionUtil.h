...
_getDictionary(std::string const&); // NOLINT
/**
 * @symbol
...
_pruneDictionary(class std::map<
                 ...
                 class std::allocator<struct std::pair<std::string const, unsigned __int64>>>&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI std::string dictionaryCompressString(std::string const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI class Bedrock::Result<std::string, class std::error_code>
dictionaryDecompressString(std::string const&); // NOLINT
