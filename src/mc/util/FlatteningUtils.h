...
// NOLINTBEGIN
// symbol:
// ?LegacyBlockInfos@FlatteningUtils@@3V?$vector@V?$reference_wrapper@$$CBULegacyBlockInfo@FlatteningUtils@@@std@@V?$allocator@V?$reference_wrapper@$$CBULegacyBlockInfo@FlatteningUtils@@@std@@@2@@std@@B
MCAPI extern std::vector<std::reference_wrapper<struct FlatteningUtils::LegacyBlockInfo const>> const LegacyBlockInfos;

// symbol: ?LegacyCarpetInfo@FlatteningUtils@@3ULegacyBlockInfo@1@B
MCAPI extern struct FlatteningUtils::LegacyBlockInfo const LegacyCarpetInfo;

// symbol: ?LegacyConcreteInfo@FlatteningUtils@@3ULegacyBlockInfo@1@B
...
// symbol: ?LegacyStainedGlassInfo@FlatteningUtils@@3ULegacyBlockInfo@1@B
MCAPI extern struct FlatteningUtils::LegacyBlockInfo const LegacyStainedGlassInfo;

// symbol: ?LegacyStainedGlassPaneInfo@FlatteningUtils@@3ULegacyBlockInfo@1@B
...
// symbol: ?LegacyWoodInfo@FlatteningUtils@@3ULegacyBlockInfo@1@B
MCAPI extern struct FlatteningUtils::LegacyBlockInfo const LegacyWoodInfo;

// symbol: ?LegacyWoodenDoubleSlabInfo@FlatteningUtils@@3ULegacyBlockInfo@1@B
MCAPI extern struct FlatteningUtils::LegacyBlockInfo const LegacyWoodenDoubleSlabInfo;

// symbol: ?LegacyWoodenSlabInfo@FlatteningUtils@@3ULegacyBlockInfo@1@B
MCAPI extern struct FlatteningUtils::LegacyBlockInfo const LegacyWoodenSlabInfo;

// symbol: ?LegacyWoolInfo@FlatteningUtils@@3ULegacyBlockInfo@1@B
