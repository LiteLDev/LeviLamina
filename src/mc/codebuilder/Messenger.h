...
public:
     ...
     */
    MCVAPI void blockBroken(class Player const*, class Block const&, int, int, unsigned short) const; // NOLINT
    /**
     * @symbol ?blockPlaced\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@AEBVBlock\@\@_NG\@Z
     */
    MCVAPI void blockPlaced(class Player const*, class Block const&, bool, unsigned short) const; // NOLINT
    /**
     * @symbol ?cameraUsed\@Messenger\@CodeBuilder\@\@UEBAX_N\@Z
     */
    MCVAPI void cameraUsed(bool) const; // NOLINT
    /**
     * @symbol ?chunkChanged\@Messenger\@CodeBuilder\@\@UEBAXAEAVLevelChunk\@\@\@Z
     */
    MCVAPI void chunkChanged(class LevelChunk&) const; // NOLINT
    /**
     * @symbol ?chunkLoaded\@Messenger\@CodeBuilder\@\@UEBAXAEAVLevelChunk\@\@\@Z
     */
    MCVAPI void chunkLoaded(class LevelChunk&) const; // NOLINT
    /**
     * @symbol ?chunkUnloaded\@Messenger\@CodeBuilder\@\@UEBAXAEAVLevelChunk\@\@\@Z
     */
    MCVAPI void chunkUnloaded(class LevelChunk&) const; // NOLINT
    /**
     * @symbol
     * ?codeBuilderRuntimeAction\@Messenger\@CodeBuilder\@\@UEBAXAEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@\@Z
     */
    MCVAPI void codeBuilderRuntimeAction(std::string const&) const; // NOLINT
    /**
     * @symbol
     * ?codeBuilderScoreChanged\@Messenger\@CodeBuilder\@\@UEBAXAEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
    MCVAPI void codeBuilderScoreChanged(std::string const&, int) const; // NOLINT
    /**
     * @symbol ?endOfDay\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@\@Z
     */
    MCVAPI void endOfDay(class Player const*) const; // NOLINT
    /**
     * @symbol ?entitySpawned\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@HI\@Z
     */
    MCVAPI void entitySpawned(class Player const*, int, unsigned int) const; // NOLINT
    /**
     * @symbol ?itemAcquired\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@AEBVItemDescriptor\@\@HIH\@Z
     */
    MCVAPI void itemAcquired(class Player const*, class ItemDescriptor const&, int, unsigned int, int) const; // NOLINT
    /**
     ...
     */
    MCVAPI void itemDropped(class Player const*, class ItemDescriptor const&) const; // NOLINT
    /**
     * @symbol ?itemEquipped\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@AEBVItemInstance\@\@H\@Z
     */
    MCVAPI void itemEquipped(class Player const*, class ItemInstance const&, int) const; // NOLINT
    /**
     * @symbol ?itemInteracted\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@AEBVItemInstance\@\@H\@Z
     */
    MCVAPI void itemInteracted(class Player const*, class ItemInstance const&, int) const; // NOLINT
    /**
     * @symbol ?itemSmelted\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@AEBVItemDescriptor\@\@1\@Z
     */
    MCVAPI void
    itemSmelted(class Player const*, class ItemDescriptor const&, class ItemDescriptor const&) const; // NOLINT
    /**
     * @symbol ?itemUsed\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@AEBVItemDescriptor\@\@H\@Z
     */
    MCVAPI void itemUsed(class Player const*, class ItemDescriptor const&, int) const; // NOLINT
    /**
     * @symbol ?mobInteracted\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@HHHE\@Z
     */
    MCVAPI void mobInteracted(class Player const*, int, int, int, unsigned char) const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCVAPI void
    mobKilled(class Player const*, class Actor*, class Mob&, unsigned int, std::string const&, int) const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCVAPI void onAgentAction(enum class AgentActionType, std::string const&, class Json::Value const&) const; // NOLINT
    /**
     * @symbol ?onCommand\@Messenger\@CodeBuilder\@\@UEAAXAEBVCommandOrigin\@\@AEBVCommandOutput\@\@\@Z
     */
    MCVAPI void onCommand(class CommandOrigin const&, class CommandOutput const&); // NOLINT
    /**
     * @symbol
     * ?piglinBarter\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@_N\@Z
     */
    MCVAPI void piglinBarter(class Player const*, std::string const&, bool) const; // NOLINT
    /**
     * @symbol ?playerBounced\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@AEBVBlock\@\@HH\@Z
     */
    MCVAPI void playerBounced(class Player const*, class Block const&, int, int) const; // NOLINT
    /**
     * @symbol ?playerDied\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@HHH_N\@Z
     */
    MCVAPI void playerDied(class Player const*, int, int, int, bool) const; // NOLINT
    /**
     * @symbol ?playerJoined\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@\@Z
     */
    MCVAPI void playerJoined(class Player const*) const; // NOLINT
    /**
     * @symbol ?playerLeave\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@\@Z
     */
    MCVAPI void playerLeave(class Player const*) const; // NOLINT
    /**
     * @symbol
     * ?playerMessage\@Messenger\@CodeBuilder\@\@UEBAXAEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@000\@Z
     */
    MCVAPI void
    playerMessage(std::string const&, std::string const&, std::string const&, std::string const&) const; // NOLINT
    /**
     * @symbol ?playerTeleported\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@MHH\@Z
     */
    MCVAPI void playerTeleported(class Player const*, float, int, int) const; // NOLINT
    /**
     * @symbol ?playerTransform\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@\@Z
     */
    MCVAPI void playerTransform(class Player const*) const; // NOLINT
    /**
     * @symbol ?playerTravelled\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@MHH\@Z
     */
    MCVAPI void playerTravelled(class Player const*, float, int, int) const; // NOLINT
    /**
     * @symbol ?targetBlockHit\@Messenger\@CodeBuilder\@\@UEBAXPEBVPlayer\@\@H\@Z
     */
    MCVAPI void targetBlockHit(class Player const*, int) const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI Messenger(class Bedrock::NonOwnerPointer<class CodeBuilder::IClient>); // NOLINT
};
