...
public:
    ...
    // vIndex: 4
    virtual ::ServiceReference<::flighting::TreatmentToggles> getTreatmentToggles() /*override*/;
...
public:
    ...
    MCNAPI ::ServiceReference<::flighting::TreatmentToggles> $getTreatmentToggles();
