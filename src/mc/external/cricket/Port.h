...
public:
    ...
    ::ll::UntypedStorage<8, 32> mUnke0c2db;
    ::ll::UntypedStorage<4, 4>  mUnk3fbd2d;
    ::ll::UntypedStorage<4, 4>  mUnkf89ead;
    ::ll::UntypedStorage<8, 32> mUnk7fe6d5;
    ::ll::UntypedStorage<8, 32> mUnk1ee6db;
    ::ll::UntypedStorage<8, 24> mUnk6465b0;
    ...
    ::ll::UntypedStorage<8, 32> mUnkc9677d;
