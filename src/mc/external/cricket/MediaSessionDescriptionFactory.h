...
public:
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::UntypedStorage<8, 24> mUnk994781;
        ::ll::UntypedStorage<8, 24> mUnk443990;
        // NOLINTEND
...
public:
    ...
    ::ll::UntypedStorage<8, 24> mUnk764593;
    ::ll::UntypedStorage<8, 24> mUnkfa14e2;
    ::ll::UntypedStorage<8, 24> mUnkbef650;
    ::ll::UntypedStorage<8, 24> mUnkb2446d;
    ::ll::UntypedStorage<8, 24> mUnkbfd66f;
    ::ll::UntypedStorage<8, 24> mUnk6359c2;
    ::ll::UntypedStorage<8, 24> mUnkd18dc8;
    ::ll::UntypedStorage<8, 24> mUnk7e6928;
...
public:
    ...
    MCNAPI ::webrtc::RTCError AddDataContentForAnswer(
        ::cricket::MediaDescriptionOptions const& media_description_options,
    ...
    MCNAPI ::webrtc::RTCError AddTransportAnswer(
        ...
        ::cricket::SessionDescription*         answer_desc
    ) const;
    ...
    MCNAPI ::webrtc::RTCErrorOr<::std::unique_ptr<::cricket::SessionDescription>> CreateAnswerOrError(
        ::cricket::SessionDescription const*  offer,
        ::cricket::MediaSessionOptions const& session_options,
        ::cricket::SessionDescription const*  current_description
    ) const;

    MCNAPI ::webrtc::RTCErrorOr<::std::unique_ptr<::cricket::SessionDescription>> CreateOfferOrError(
        ::cricket::MediaSessionOptions const& session_options,
        ::cricket::SessionDescription const*  current_description
    ) const;
