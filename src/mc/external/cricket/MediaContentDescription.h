...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<8, 32> mUnkdc342f;
    ...
    ::ll::UntypedStorage<8, 32> mUnkd71eca;
    ::ll::UntypedStorage<8, 24> mUnkb3dccb;
    ::ll::UntypedStorage<1, 1>  mUnk59597a;
    ::ll::UntypedStorage<8, 24> mUnk906b03;
    ...
    ::ll::UntypedStorage<8, 24> mUnk2cf76b;
    ::ll::UntypedStorage<8, 24> mUnk67e776;
    // NOLINTEND
