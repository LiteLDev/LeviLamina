...
public:
    ...
    ::ll::UntypedStorage<8, 32> mUnkf6260a;
    ::ll::UntypedStorage<4, 8>  mUnkdef386;
    ::ll::UntypedStorage<8, 24> mUnkc61728;
    ::ll::UntypedStorage<8, 24> mUnk4a7dac;
    ::ll::UntypedStorage<8, 24> mUnk1c4698;
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI MediaSenderInfo(::cricket::MediaSenderInfo const&);

    MCNAPI ::cricket::MediaSenderInfo& operator=(::cricket::MediaSenderInfo const&);
...
public:
    // constructor thunks
    // NOLINTBEGIN
    MCNAPI void* $ctor(::cricket::MediaSenderInfo const&);
    // NOLINTEND
