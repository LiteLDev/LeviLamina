...
GametestResultToScriptingValueResult(class std::variant<struct gametest::GameTestError, class BlockPos> const&);
/**
 * @symbol
 ...
 */
MCAPI class Scripting::Result<class Vec3>
GametestResultToScriptingValueResult(class std::variant<struct gametest::GameTestError, class Vec3> const&);
/**
 * @symbol
...
ScriptingResultToGameTestResult(class Scripting::ResultAny const&);
