...
public:
    // NOLINTBEGIN
    // symbol:
    // ??0ContextObject@QuickJS@Scripting@@QEAA@UContextId@2@PEAUJSContext@@VWeakLifetimeScope@2@$$QEAUModuleBindingBundle@2@$$QEAV?$unique_ptr@VScriptObjectFactory@Scripting@@U?$default_delete@VScriptObjectFactory@Scripting@@@std@@@std@@$$QEAV?$unique_ptr@VObjectInspector@QuickJS@Scripting@@U?$default_delete@VObjectInspector@QuickJS@Scripting@@@std@@@8@PEAVIPrinter@2@PEAVIDependencyLoader@2@PEAUJSRuntime@@AEBUContextConfig@2@@Z
