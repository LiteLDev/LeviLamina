...
public:
    ...
    MCAPI
    ContextObject(struct Scripting::ContextId, struct JSContext*, class Scripting::WeakLifetimeScope, struct Scripting::ModuleBindingBundle const&, std::unique_ptr<class Scripting::ScriptObjectFactory>&&, std::unique_ptr<class Scripting::QuickJS::ObjectInspector>&&, std::unique_ptr<class Scripting::IPrinter>&&, class Scripting::IDependencyLoader*, struct JSRuntime*, struct Scripting::ContextConfig const&);
    ...
    MCAPI void addUnhandledPromiseRejection(void*, std::string const&, bool);
    ...
    call(struct Scripting::TypedObjectHandle<struct Scripting::ClosureType>, entt::meta_any*, uint, entt::meta_type const&);
    ...
    MCAPI class Scripting::ResultAny run(std::string const&, std::string const&);
    ...
    MCAPI void _bindModules(std::vector<struct Scripting::ModuleBinding> const&);

    // symbol: ?_resolvePromise@ContextObject@QuickJS@Scripting@@AEAAXUJSValue@@AEAVmeta_any@entt@@@Z
    MCAPI void _resolvePromise(struct JSValue, entt::meta_any&);
    ...
    MCAPI static void _bindError(struct JSContext*, struct JSModuleDef*, class Scripting::QuickJS::RegisteredError&);

    // symbol:
    // ?_bindInterface@ContextObject@QuickJS@Scripting@@CAXPEAUJSContext@@PEAUJSModuleDef@@AEAVRegisteredInterface@23@@Z
    MCAPI static void
    _bindInterface(struct JSContext*, struct JSModuleDef*, class Scripting::QuickJS::RegisteredInterface&);
    ...
    _createConstant(struct JSContext*, class Scripting::QuickJS::ContextUserData&, struct JSValue, struct Scripting::ConstantFactory const&);
    ...
    MCAPI static void
    _createFunction(struct JSContext*, struct JSValue, struct Scripting::FunctionBinding const&, struct JSValue, std::string const&);

    // symbol:
    // ?_createGlobalObject@ContextObject@QuickJS@Scripting@@CAXPEAUJSContext@@AEAVContextUserData@23@AEBUObjectFactory@3@@Z
    MCAPI static void
    _createGlobalObject(struct JSContext*, class Scripting::QuickJS::ContextUserData&, struct Scripting::ObjectFactory const&);
    ...
    MCAPI static void
    _createModuleObject(struct JSContext*, struct JSModuleDef*, class Scripting::QuickJS::ContextUserData&, struct Scripting::ObjectFactory const&);
    ...
    MCAPI static void
    _createProperty(struct JSContext*, struct JSValue, struct Scripting::PropertyBinding const&, std::string const&);
    ...
    MCAPI static int
    _initializeModuleBinding(struct JSContext*, struct JSModuleDef*, class Scripting::QuickJS::ContextUserData&, struct Scripting::ModuleBinding const&);

    // symbol: ?_moduleInitializer@ContextObject@QuickJS@Scripting@@CAHPEAUJSContext@@PEAUJSModuleDef@@@Z
    MCAPI static int _moduleInitializer(struct JSContext*, struct JSModuleDef*);
