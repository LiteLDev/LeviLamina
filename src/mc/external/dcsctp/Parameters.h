...
public:
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::UntypedStorage<8, 24> mUnk7e9eba;
        // NOLINTEND
...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<8, 24> mUnkbd45be;
    // NOLINTEND
...
public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static ::std::optional<::dcsctp::Parameters> Parse(::webrtc::ArrayView<uchar const> data);
    // NOLINTEND
