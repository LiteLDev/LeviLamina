...
// clang-format off
namespace dcsctp { struct OutOfResourceParameterConfig; }
// clang-format on
...
public:
    ...
    virtual ~OutOfResourceErrorCause() /*override*/ = default;
    // NOLINTEND

public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static ::std::optional<::dcsctp::OutOfResourceErrorCause> Parse(::webrtc::ArrayView<uchar const> data);
    // NOLINTEND
