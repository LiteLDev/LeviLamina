...
class WinHttpConnection : public ::xbox::httpclient::hc_websocket_impl,
                          public ::std::enable_shared_from_this<::xbox::httpclient::WinHttpConnection> {
public:
...
public:
    ...
    MCNAPI long WebSocketSendMessageAsync(
        ::XAsyncBlock*                    async,
...
public:
    ...
    MCNAPI static void callback_status_data_available(
        void*                                  hRequestHandle,
        ::xbox::httpclient::WinHttpConnection* pRequestContext,
        void*                                  statusInfo
    );

    MCNAPI static void callback_status_headers_available(
        void*                                  hRequestHandle,
        ::xbox::httpclient::WinHttpConnection* pRequestContext,
        void*
    );

    MCNAPI static void callback_status_request_error(
        void*                                  hRequestHandle,
        ::xbox::httpclient::WinHttpConnection* pRequestContext,
        void*                                  statusInfo
    );

    MCNAPI static void callback_websocket_status_headers_available(
        void*                                       hRequestHandle,
        ::xbox::httpclient::WinHttpCallbackContext* winHttpContext
    );

    MCNAPI static void completion_callback(
        void*  hRequestHandle,
        uint64 context,
        ulong  statusCode,
        void*  statusInfo,
    ...
    MCNAPI static uint
    parse_status_code(::HC_CALL* call, void* hRequestHandle, ::xbox::httpclient::WinHttpConnection* pRequestContext);
