...
#include "mc/external/render_dragon/texture_decoder/texd/ImageFormat.h"
...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<4, 4, ::texd::ImageFormat>       imageFormat;
    ::ll::TypedStorage<4, 4, ::texd::CompressionScheme> compressionScheme;
    ...
    ::ll::TypedStorage<4, 4, uint>                      mipLevelCount;
    // NOLINTEND
};
