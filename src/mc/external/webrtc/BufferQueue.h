...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<1, 1>  mUnkde6b74;
    ::ll::UntypedStorage<8, 8>  mUnk640b01;
    ::ll::UntypedStorage<8, 8>  mUnk3aa751;
    ::ll::UntypedStorage<8, 40> mUnkd64d1a;
    ::ll::UntypedStorage<8, 24> mUnka5a835;
    // NOLINTEND
