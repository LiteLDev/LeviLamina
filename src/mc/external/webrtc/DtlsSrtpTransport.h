...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<8, 8>  mUnk332c10;
    ::ll::UntypedStorage<8, 8>  mUnk464a7c;
    ::ll::UntypedStorage<8, 32> mUnk18b51a;
    ::ll::UntypedStorage<8, 32> mUnk333ef5;
...
public:
    ...
    MCNAPI bool ExtractParams(
        ...
        ::webrtc::BufferT<uchar, 1>*     send_key,
        ::webrtc::BufferT<uchar, 1>*     recv_key
    );
