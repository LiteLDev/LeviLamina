...
public:
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::UntypedStorage<8, 24> mUnk7925c6;
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::UntypedStorage<8, 16>  mUnk213a90;
    ...
    public:
        ...
        ::ll::UntypedStorage<1, 23> mUnk255cb8;
...
public:
    ...
    ::ll::UntypedStorage<8, 8>   mUnkf1a3a6;
    ::ll::UntypedStorage<8, 8>   mUnk601db6;
    ::ll::UntypedStorage<8, 24>  mUnk9a98bb;
    ::ll::UntypedStorage<8, 16>  mUnk144ed6;
...
public:
    ...
    MCNAPI int EncodeFec(
        ::std::list<::std::unique_ptr<::webrtc::ForwardErrorCorrection::Packet>> const& media_packets,
    ...
    MCNAPI void GenerateFecPayloads(
        ::std::list<::std::unique_ptr<::webrtc::ForwardErrorCorrection::Packet>> const& media_packets,
        uint64                                                                          num_fec_packets
    );

    MCNAPI int InsertZerosInPacketMasks(
        ::std::list<::std::unique_ptr<::webrtc::ForwardErrorCorrection::Packet>> const& media_packets,
        uint64                                                                          num_fec_packets
    );
...
public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static ::std::unique_ptr<::webrtc::ForwardErrorCorrection>
    CreateFlexfec(uint ssrc, uint protected_media_ssrc);
    ...
    MCNAPI static void XorPayloads(
        ::webrtc::ForwardErrorCorrection::Packet const& src,
