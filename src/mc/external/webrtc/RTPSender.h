...
public:
    ...
    ::ll::UntypedStorage<8, 32> mUnkf7da01;
    ::ll::UntypedStorage<8, 32> mUnkf82aa9;
...
public:
    ...
    MCNAPI ::std::vector<::std::unique_ptr<::webrtc::RtpPacketToSend>>
    GeneratePadding(uint64 target_size_bytes, bool media_has_been_sent, bool can_send_padding_on_media_ssrc);
