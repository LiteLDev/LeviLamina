...
public:
    ...
    InitiateProbing(::webrtc::Timestamp now, ::std::vector<::webrtc::DataRate> bitrates_to_probe, bool probe_further);

    MCNAPI ::std::vector<::webrtc::ProbeClusterConfig>
    OnMaxTotalAllocatedBitrate(::webrtc::DataRate max_total_allocated_bitrate, ::webrtc::Timestamp at_time);
    ...
    MCNAPI ::std::vector<::webrtc::ProbeClusterConfig> SetEstimatedBitrate(
