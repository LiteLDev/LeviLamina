...
public:
    ...
    ::ll::UntypedStorage<8, 16> mUnk2aafcd;
    // NOLINTEND
...
public:
    ...
    MCNAPI AttributeInit(
        ...
        ::std::variant<
            ...
            ::std::optional<::std::vector<uint>> const*,
            ::std::optional<::std::vector<int64>> const*,
            ::std::optional<::std::vector<uint64>> const*,
