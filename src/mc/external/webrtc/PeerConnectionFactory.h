...
namespace webrtc { class NetworkControllerFactoryInterface; }
...
public:
    ...
    ::ll::UntypedStorage<4, 12> mUnkf54a1e;
    ::ll::UntypedStorage<8, 96> mUnk5e1d4f;
    ::ll::UntypedStorage<8, 8>  mUnk7b661a;
    ::ll::UntypedStorage<8, 8>  mUnk2383ee;
    ::ll::UntypedStorage<8, 8>  mUnkb3b8c7;
    ::ll::UntypedStorage<8, 8>  mUnkef1122;
    ::ll::UntypedStorage<8, 8>  mUnk54b71d;
    ::ll::UntypedStorage<8, 8>  mUnk24d11d;
    ::ll::UntypedStorage<8, 8>  mUnka749b1;
    ::ll::UntypedStorage<8, 8>  mUnk5c809d;
    // NOLINTEND
...
public:
    ...
    virtual ::webrtc::RtpCapabilities GetRtpSenderCapabilities(::webrtc::MediaType kind) const /*override*/;

    virtual ::webrtc::RtpCapabilities GetRtpReceiverCapabilities(::webrtc::MediaType kind) const /*override*/;
    ...
    CreateAudioSource(::webrtc::AudioOptions const& options) /*override*/;
...
public:
    ...
    MCNAPI ::std::unique_ptr<::webrtc::Call> CreateCall_w(
        ...
        ::webrtc::PeerConnectionInterface::RTCConfiguration const&     configuration,
        ::std::unique_ptr<::webrtc::NetworkControllerFactoryInterface> per_call_network_controller_factory
    );
...
public:
    ...
    MCNAPI ::webrtc::RtpCapabilities $GetRtpSenderCapabilities(::webrtc::MediaType kind) const;

    MCNAPI ::webrtc::RtpCapabilities $GetRtpReceiverCapabilities(::webrtc::MediaType kind) const;
    ...
    $CreateAudioSource(::webrtc::AudioOptions const& options);
