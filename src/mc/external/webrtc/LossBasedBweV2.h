...
public:
    ...
    public:
        ...
        ::ll::UntypedStorage<8, 24> mUnkb79a85;
...
public:
    ...
    ::ll::UntypedStorage<8, 24>  mUnk967274;
    ::ll::UntypedStorage<8, 24>  mUnkac1d8e;
...
public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static ::std::optional<::webrtc::LossBasedBweV2::Config>
    CreateConfig(::webrtc::FieldTrialsView const* key_value_config);
    // NOLINTEND
