...
public:
    ...
    ::ll::UntypedStorage<8, 32> mUnk11c308;
    ::ll::UntypedStorage<8, 32> mUnke22640;
    ::ll::UntypedStorage<8, 32> mUnke2612e;
    ::ll::UntypedStorage<4, 4>  mUnk2ee3f0;
    ::ll::UntypedStorage<8, 32> mUnk6bde40;
    ::ll::UntypedStorage<8, 24> mUnk1499a0;
