...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<8, 40> mUnkfc02a6;
    ::ll::UntypedStorage<8, 32> mUnk8c3356;
    ...
    ::ll::UntypedStorage<8, 8>  mUnk859431;
    ::ll::UntypedStorage<8, 32> mUnkf086ce;
    ...
    ::ll::UntypedStorage<8, 8>  mUnk953c69;
