...
public:
     ...
     */
    MCVAPI void fireBannedSkinVerificationEvent(unsigned int const&, std::string const&, std::string const&);
    /**
     ...
     */
    MCVAPI void
    fireCommunitySIFTProcessEvent(std::string const&, enum class TextProcessingEventOrigin, unsigned short, std::string const&, bool, double, char, char, class Json::Value const&);
    /**
     * @symbol
     ...
     */
    MCVAPI void
        fireDayOneExperienceStateChanged(enum class IMinecraftEventing::DayOneExperienceState, class std::optional<unsigned int>, class std::optional<unsigned __int64>);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireEventBlockTypeRegistryChecksumMismatch(std::string const&, unsigned __int64 const&, unsigned __int64 const&, std::string const&);
    /**
     ...
     */
    MCVAPI void
    fireEventConnectedStorageResult(enum class ConnectedStorageEventType, bool, unsigned int, class std::optional<unsigned int>, std::string const&, std::string const&, __int64, class std::optional<unsigned int>, class std::optional<unsigned int>, class std::optional<unsigned int>);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireEventDeviceAccountFailure(enum class IMinecraftEventing::SignInStage, enum class IMinecraftEventing::DeviceAccountFailurePhase, unsigned int, std::string const&);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireEventImGuiScreenChanged(std::string const&, class std::unordered_map<std::string, std::string, struct std::hash<std::string>, struct std::equal_to<std::string>, class std::allocator<struct std::pair<std::string const, std::string>>> const&);
    /**
     * @symbol
     ...
     */
    MCVAPI void fireEventLevelDataOverride(class std::basic_string_view<char, struct std::char_traits<char>>) const;
    /**
     ...
     */
    MCVAPI void
    fireEventMultiplayerConnectionStateChanged(bool, std::string const&, std::string const&, unsigned int, unsigned int, unsigned int, std::string const&);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireEventPacketViolationDetected(unsigned __int64, std::string, enum class PacketViolationResponse, enum class MinecraftPacketIds, class NetworkIdentifier const&);
    /**
     ...
     */
    MCVAPI void
    fireEventPlayIntegrityCheck(int, std::string const&, std::string const&, std::string const&, std::string const&);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireEventScreenChanged(unsigned int const&, std::string const&, class std::unordered_map<std::string, std::string, struct std::hash<std::string>, struct std::equal_to<std::string>, class std::allocator<struct std::pair<std::string const, std::string>>> const&);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireEventServerDrivenLayoutImagesLoaded(class RequestTelemetry&, std::string, int, unsigned __int64, int, int, int, std::vector<unsigned short>&);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireEventSidebarNavigation(unsigned int const&, std::string const&, std::string const&, int, bool, bool, bool);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireEventSignInEdu(std::string const&, enum class edu::Role, enum class IMinecraftEventing::EduSignInStage, std::string const&, std::string const&, std::vector<struct std::pair<std::string, std::string>> const&);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireEventSignInToIdentity(enum class IMinecraftEventing::SignInAccountType, enum class IMinecraftEventing::SignInTrigger, bool, enum class IMinecraftEventing::SignInStage, enum class Social::SignInResult, int, struct Social::PlayerIDs, std::string const&);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireEventSignalServiceConnect(enum class IConnectionEventing::SignalServiceConnectState, bool, int, std::string const&);
    /**
     ...
     */
    MCVAPI void
    fireEventUgcAcquisitionStateChanged(std::string const&, unsigned __int64, double, bool, int, bool, int, std::string const&, std::string const&);
    /**
     ...
     */
    MCVAPI void
    fireEventWorldCorruptionCausedWorldShutdown(struct LevelStorageEventingContext const&, std::string const&, class std::optional<bool>);
    /**
     ...
     */
    MCVAPI void
        fireEventWorldLoadedClassroomCustomization(enum class IMinecraftEventing::WorldClassroomCustomization, class buffer_span<struct std::pair<class std::basic_string_view<char, struct std::char_traits<char>>, class std::basic_string_view<char, struct std::char_traits<char>>>>);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    firePerfTestEvent(std::string const&, std::string const&, std::string const&, unsigned int, unsigned int, std::string const&, std::vector<struct std::pair<std::string, float>> const&);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireScreenLoadTimeUpdateEvent(unsigned int const&, std::string const&, class std::chrono::duration<__int64, struct std::ratio<1, 1000000000>>, std::string const&);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireServerConnectionEvent(enum class IConnectionEventing::ServerConnectionOutcome, unsigned int, double, std::string const&);
    /**
     * @symbol
     ...
     */
    MCVAPI void
    fireStorageMigrationEvent(bool, enum class Bedrock::StorageMigration::StorageMigrationType, int, int, class std::chrono::duration<__int64, struct std::ratio<1, 1000000000>>, std::string const&);
    /**
     * @symbol
     ...
     */
    MCAPI static void
    fireEventBlockBroken(class Player*, class Block const&, enum class MinecraftEventing::BlockPlacementMethod, int);
    /**
     ...
     */
    MCAPI static void
    fireEventPlayerTeleported(class Player*, float, enum class MinecraftEventing::TeleportationCause, int);
    /**
