...
public:
    ...
    // symbol:
    // ?fireEventTextProcessorStartupFailed@MinecraftEventing@@UEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z
    MCVAPI void fireEventTextProcessorStartupFailed(std::string const&, int);
