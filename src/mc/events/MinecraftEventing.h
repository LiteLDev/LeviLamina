...
public:
     ...
     */
    MCVAPI void fireClubsOpenFeedScreenEvent(enum class IMinecraftEventing::ClubsFeedScreenSource, struct Realms::RealmId, std::string const &, int32_t);
    /**
     ...
     */
    MCVAPI void fireCommunitySIFTProcessEvent(std::string const &, enum class TextProcessingEventOrigin, uint16_t, std::string const &, bool, double, char, char, class Json::Value const &);
    /**
     ...
     */
    MCVAPI void fireDayOneExperienceStateChanged(enum class IMinecraftEventing::DayOneExperienceState, std::optional<uint32_t>, std::optional<uint64_t>);
    /**
     ...
     */
    MCVAPI void fireEventConnectedStorageResult(enum class ConnectedStorageEventType, bool, uint32_t, std::optional<uint32_t>, std::string const &, std::string const &, int64_t, std::optional<uint32_t>, std::optional<uint32_t>, std::optional<uint32_t>);
    /**
     ...
     */
    MCVAPI void fireEventDeviceAccountFailure(enum class IMinecraftEventing::SignInStage, enum class IMinecraftEventing::DeviceAccountFailurePhase, uint32_t, std::string const &);
    /**
     ...
     */
    MCVAPI void fireEventElementConstructorUsed(int32_t, int32_t, enum class IMinecraftEventing::ElementConstructorUseType);
    /**
     ...
     */
    MCVAPI void fireEventMultiplayerConnectionStateChanged(bool, std::string const &, std::string const &, uint32_t, uint32_t, uint32_t, std::string const &);
    /**
     ...
     */
    MCVAPI void fireEventPacketViolationDetected(uint64_t, std::string, enum class PacketViolationResponse, enum class MinecraftPacketIds, class NetworkIdentifier const &);
    /**
     ...
     */
    MCVAPI void fireEventPersonaItemPreviewed(std::string const &, std::string const &, std::string const &, uint32_t, uint32_t, enum class IMinecraftEventing::PromotionType, bool, std::string const &, std::string const &, double, enum class IMinecraftEventing::StoreType);
    /**
     ...
     */
    MCVAPI void fireEventPlayIntegrityCheck(int32_t, std::string const &, std::string const &, std::string const &, std::string const &);
    /**
    ...
    /**
     * @symbol ?fireEventPlayerJoinWorld\@MinecraftEventing\@\@UEAAXAEBIW4SubClientId\@\@_NV?$optional\@_N\@std\@\@W4PlayerJoinWorldAttemptState\@IConnectionEventing\@\@HW4DisconnectFailReason\@Connection\@\@W4TransportLayer\@\@\@Z
     */
    MCVAPI void fireEventPlayerJoinWorld(uint32_t const &, enum class SubClientId, bool, std::optional<bool>, enum class IConnectionEventing::PlayerJoinWorldAttemptState, int32_t, enum class Connection::DisconnectFailReason, enum class TransportLayer);
    /**
     ...
     */
    MCVAPI void fireEventScriptWatchdog(enum class Scripting::WatchdogEventType, bool, uint64_t, float, int32_t, uint64_t, struct Scripting::ModuleDescriptor const *, bool);
    /**
     ...
     */
    MCVAPI void fireEventSignInEdu(std::string const &, enum class edu::Role, enum class IMinecraftEventing::EduSignInStage, std::string const &, std::string const &, std::vector<std::pair<std::string, std::string>> const &);
    /**
     ...
     */
    MCVAPI void fireEventSignInToIdentity(enum class IMinecraftEventing::SignInAccountType, enum class IMinecraftEventing::SignInTrigger, bool, enum class IMinecraftEventing::SignInStage, enum class Social::SignInResult, int32_t, struct Social::PlayerIDs, std::string const &);
    /**
     * @symbol ?fireEventSignOutEdu\@MinecraftEventing\@\@UEAAXAEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@W4Role\@edu\@\@00\@Z
     */
     ...
     */
    MCVAPI void fireEventSignalServiceConnect(enum class IConnectionEventing::SignalServiceConnectState, bool, int32_t, std::string const &);
    /**
     ...
     */
    MCVAPI void fireEventWorldLoadedClassroomCustomization(enum class IMinecraftEventing::WorldClassroomCustomization, class buffer_span<std::pair<std::string_view, std::string_view>>);
    /**
     ...
     */
    MCVAPI void fireHostClientTransportSettingSync(enum class TransportLayer, enum class TransportLayer, std::string const &, std::string const &, std::string const &, uint64_t, bool);
    /**
     ...
     */
    MCVAPI void fireIgnoredNotificationsEvent(enum class IMinecraftEventing::IgnoredNotificationsType, int32_t, std::set<enum class IMinecraftEventing::IgnoredNotificationSource>);
    /**
     ...
     */
    MCVAPI void fireLessonActionTaken(std::string const &, std::string const &, std::string const &, enum class IMinecraftEventing::EducationLessonAction, int32_t);
    /**
     ...
     */
    MCVAPI void fireServerConnectionEvent(enum class IConnectionEventing::ServerConnectionOutcome, uint32_t, double, std::string const &);
    /**
     ...
     */
    MCVAPI void fireStorageMigrationEvent(bool, enum class Bedrock::StorageMigration::StorageMigrationType, int32_t, int32_t, std::chrono::nanoseconds, std::string const &);
    /**
     ...
     */
    MCAPI static void fireEventBlockBroken(class Player *, class Block const &, enum class MinecraftEventing::BlockPlacementMethod, int32_t);
    /**
     ...
     */
    MCAPI static void fireEventPlayerTeleported(class Player *, float, enum class MinecraftEventing::TeleportationCause, int32_t);
    /**
