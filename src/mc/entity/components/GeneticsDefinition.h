...
public:
     ...
     */
    MCAPI GeneticsDefinition(); // NOLINT
    /**
     * @symbol ?addGeneDefinition\@GeneticsDefinition\@\@QEAAXAEBUGeneDefinition\@\@\@Z
     */
    MCAPI void addGeneDefinition(struct GeneDefinition const&); // NOLINT
    /**
     * @symbol ?initialize\@GeneticsDefinition\@\@QEBAXAEAVEntityContext\@\@AEAVGeneticsComponent\@\@\@Z
     */
    MCAPI void initialize(class EntityContext&, class GeneticsComponent&) const; // NOLINT
    /**
     * @symbol
    ...
    buildSchema(class std::shared_ptr<
                class JsonUtil::JsonSchemaObjectNode<class JsonUtil::EmptyClass, class GeneticsDefinition>>&); // NOLINT
...
private:
     ...
     */
    MCAPI static float const DEFAULT_MUTATION_RATE; // NOLINT
};
