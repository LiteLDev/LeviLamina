...
public:
     ...
     */
    MCAPI HealableDefinition(); // NOLINT
    /**
     * @symbol ?addFeedItem\@HealableDefinition\@\@QEAAXAEBUFeedItem\@\@\@Z
     */
    MCAPI void addFeedItem(struct FeedItem const&); // NOLINT
    /**
     * @symbol
    ...
    buildSchema(class std::shared_ptr<
                class JsonUtil::JsonSchemaObjectNode<class JsonUtil::EmptyClass, class HealableDefinition>>&); // NOLINT
};
