...
public:
    ...
    public:
        ...
        ::ll::UntypedStorage<8, 24> mUnk9f1611;
        // NOLINTEND
    ...
    public:
        // member variables
        // NOLINTBEGIN
        ::ll::UntypedStorage<8, 32> mUnk7428fb;
...
public:
    ...
    addActorMovementCorrectionDivergence(::ActorType actorType, ::std::vector<float> const& divergences);
#endif
