...
public:
     ...
     */
    virtual void onLanguageChanged(std::string const&, bool); // NOLINT
     ...
     */
    MCVAPI void onLanguageKeywordsLoadedFromPack(class PackManifest const&); // NOLINT
    /**
     * @symbol ?onLanguagesLoaded\@NpcI18nObserver\@\@UEAAXXZ
     */
    MCVAPI void onLanguagesLoaded(); // NOLINT
#endif
     ...
     */
    MCAPI void _loadNpcData(); // NOLINT
