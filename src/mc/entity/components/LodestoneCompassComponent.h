...
public:
     ...
     */
    MCAPI LodestoneCompassComponent(class LodestoneCompassComponent&&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI int
    getAnimationFrame(class std::variant<struct ActorUniqueID, struct std::pair<class BlockPos, class AutomaticID<class Dimension, int>>> const&, class BlockPos const&, class AutomaticID<class Dimension, int> const&); // NOLINT
    /**
     * @symbol ?initialize\@LodestoneCompassComponent\@\@QEAAXAEBVPositionTrackingId\@\@\@Z
     */
    MCAPI void initialize(class PositionTrackingId const&); // NOLINT
    /**
     * @symbol ??4LodestoneCompassComponent\@\@QEAAAEAV0\@$$QEAV0\@\@Z
     */
    MCAPI class LodestoneCompassComponent& operator=(class LodestoneCompassComponent&&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI ~LodestoneCompassComponent(); // NOLINT
    /**
     * @symbol ?getSpinningAnimationFrame\@LodestoneCompassComponent\@\@SAHXZ
     */
    MCAPI static int getSpinningAnimationFrame(); // NOLINT
    /**
     * @symbol
    ...
    MCAPI static class std::
        ...
        makeCalculatorId(struct ActorUniqueID const&); // NOLINT
...
private:
     ...
     */
    MCAPI static class CompassSpriteCalculator mSpinningLodestone; // NOLINT
};
