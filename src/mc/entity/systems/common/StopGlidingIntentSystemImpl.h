...
// NOLINTBEGIN
// symbol:
// ?doStopGlidingIntent@StopGlidingIntentSystemImpl@@YAXAEBVStrictEntityContext@@V?$Optional@$$CBV?$FlagComponent@UArmorFlyEnabledFlag@@@@@@V?$Optional@$$CBUOnGroundFlagComponent@@@@V?$Optional@$$CBUPassengerComponent@@@@V?$Optional@$$CBV?$FlagComponent@UInWaterFlag@@@@@@V?$Optional@$$CBV?$FlagComponent@UCanStandOnSnowFlag@@@@@@V?$Optional@$$CBV?$FlagComponent@UHasLightweightFamilyFlag@@@@@@AEBUAABBShapeComponent@@AEBUFallFlyTicksComponent@@AEBUMoveInputComponent@@AEBUStateVectorComponent@@AEBUActorDataFlagComponent@@AEBUVanillaClientGameplayComponent@@AEAUPlayerActionComponent@@AEAUPlayerInputRequestComponent@@AEBVIConstBlockSource@@@Z
MCAPI void
