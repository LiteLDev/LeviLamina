...
public:
    // NOLINTBEGIN
    // vIndex: 0, symbol: __gen_??1DiscardSystem@ClientRewind@@UEAA@XZ
    ...
    // vIndex: 6, symbol:
    // ?singleTick@DiscardSystem@ClientRewind@@UEAAXAEAV?$StrictExecutionContext@U?$Filter@V?$FlagComponent@UActorMovementTickNeededFlag@@@@@@U?$Read@UActorDataFlagComponent@@UActorDataHorseFlagComponent@@UActorDataJumpDurationComponent@@UActorDataBoundingBoxComponent@@UActorDataSeatOffsetComponent@@@@U?$Write@UReplayStateTrackerComponent@@@@U?$AddRemove@$$V@@U?$GlobalRead@$$V@@U?$GlobalWrite@$$V@@U?$EntityFactoryT@$$V@@@@AEAVStrictEntityContext@@@Z
    ...
    // symbol:
    // ?tickEntity@DiscardSystem@ClientRewind@@SAXAEBVStrictEntityContext@@AEAUReplayStateTrackerComponent@@AEBV?$ViewT@VStrictEntityContext@@$$CBUActorDataFlagComponent@@V?$Optional@$$CBUActorDataHorseFlagComponent@@@@V?$Optional@$$CBUActorDataJumpDurationComponent@@@@V?$Optional@$$CBUActorDataBoundingBoxComponent@@@@V?$Optional@$$CBUActorDataSeatOffsetComponent@@@@@@@Z
    MCAPI static void
