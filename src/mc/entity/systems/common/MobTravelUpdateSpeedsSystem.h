...
public:
    ...
    MCAPI static void
    tickMobTravelUpdateSpeedsSystem(class ViewT<class StrictEntityContext, struct Include<struct MobTravelComponent>, struct SynchedActorDataComponent const, struct VehicleComponent const, struct FlySpeedComponent, struct AttributesComponent const, class Optional<class FlagComponent<struct CanVehicleSprintFlag> const>> view, class ViewT<class StrictEntityContext, struct AttributesComponent const, struct MovementSpeedComponent const>, class ViewT<class StrictEntityContext, struct MovementSpeedComponent, struct LocalMoveVelocityComponent>, class ViewT<class StrictEntityContext, struct Include<class FlagComponent<struct PlayerComponentFlag>>> players, class ViewT<class StrictEntityContext, struct SynchedActorDataComponent const>);
