 ...
 */
MCAPI void
doFlySpeedControlSystem(class StrictEntityContext const&, struct AbilitiesComponent const&, struct MoveInputComponent const&, struct ActorGameTypeComponent const&, struct FrictionModifierComponent&, struct StateVectorComponent&, struct ExternalDataInterface const&); // NOLINT
