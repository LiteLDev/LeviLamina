...
// symbol:
// ?doSetRequestTick@SprintTriggerSystem@@YAXAEBVStrictEntityContext@@AEBV?$Optional@$$CBUPassengerComponent@@@@AEBUMovementAttributesComponent@@AEAUPlayerInputRequestComponent@@AEBV?$ViewT@VStrictEntityContext@@UVehicleComponent@@$$CBUActorDataControllingSeatIndexComponent@@V?$Optional@V?$FlagComponent@UCanVehicleSprintFlag@@@@@@@@@Z
MCAPI void
