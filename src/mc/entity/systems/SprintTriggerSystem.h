...
MCAPI void
doIntentTick(class Optional<struct ItemInUseComponent const> const&, class Optional<class FlagComponent<struct OnGroundFlag> const> const&, class Optional<class FlagComponent<struct InWaterFlag> const> const&, struct AbilitiesComponent const&, struct MobEffectsComponent const&, struct MoveInputComponent const&, struct PlayerInputModeComponent const&, struct StateVectorComponent const&, struct PlayerLastPosComponent const&, struct SynchedActorDataComponent const&, struct PlayerInputRequestComponent&, struct VanillaClientGameplayComponent&, struct PlayerActionComponent&);

// symbol:
// ?doSetRequestTick@SprintTriggerSystem@@YAXAEBVStrictEntityContext@@AEBV?$Optional@$$CBUPassengerComponent@@@@AEBUAbilitiesComponent@@AEBUAttributesComponent@@AEAUPlayerInputRequestComponent@@AEBV?$ViewT@VStrictEntityContext@@VEntityRegistryBase@@UVehicleComponent@@USynchedActorDataComponent@@V?$Optional@V?$FlagComponent@UCanVehicleSprintFlag@@@@@@@@@Z
MCAPI void
