...
public:
    ...
    MCAPI static void
        _setSeatDescriptionToActorDataSystem(class ViewT<class StrictEntityContext, struct PassengerComponent const, struct PositionPassengerRequestComponent const, struct OffsetsComponent const, struct ActorDataFlagComponent, struct ActorDataSeatOffsetComponent, struct ActorDataDirtyFlagsComponent, struct SynchedActorDataComponent>, class ViewT<class StrictEntityContext, struct VehicleComponent const, struct SynchedActorDataComponent const, class RideableComponent const>, class ViewT<class StrictEntityContext, struct RidingHeightComponent const>, class ViewT<class StrictEntityContext, struct AdultRidingHeightOffsetComponent const>);

    // symbol:
    // ?_setSeatDescriptionToActorDataSystemSingleEntity@VehicleServerSeatPositionSystem@@CAXAEBVStrictEntityContext@@V?$ViewT@VStrictEntityContext@@$$CBUPassengerComponent@@$$CBUPositionPassengerRequestComponent@@$$CBUOffsetsComponent@@UActorDataFlagComponent@@UActorDataSeatOffsetComponent@@UActorDataDirtyFlagsComponent@@USynchedActorDataComponent@@@@V?$ViewT@VStrictEntityContext@@$$CBUVehicleComponent@@$$CBUSynchedActorDataComponent@@$$CBVRideableComponent@@@@V?$ViewT@VStrictEntityContext@@$$CBURidingHeightComponent@@@@V?$ViewT@VStrictEntityContext@@$$CBUAdultRidingHeightOffsetComponent@@@@@Z
