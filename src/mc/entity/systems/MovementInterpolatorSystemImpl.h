...
public:
     ...
     */
    MCAPI static void
    _onGroundPostTick(class StrictEntityContext const&, struct MovementInterpolatorComponent const&, struct StateVectorComponent&); // NOLINT
    /**
     * @symbol
    ...
    _tickPosition(struct MovementInterpolatorComponent&, class Vec3 const&, float); // NOLINT
    /**
     * @symbol
    ...
    _tickRotation(struct MovementInterpolatorComponent&, class Vec2 const&, class Vec2 const&); // NOLINT
};
