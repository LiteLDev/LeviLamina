...
public:
    ...
    MCAPI static void
    _setPreviousPosRot(class StrictEntityContext&, struct StateVectorComponent&, struct ActorRotationComponent&, class EntityModifier<class FlagComponent<struct PrevPosRotSetThisTickFlag>>);
