...
struct TickWorldDescription : public ::ActorComponentDescription {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<4, 4> mUnka324c2;
    ::ll::UntypedStorage<4, 4> mUnk6ea304;
    ::ll::UntypedStorage<1, 1> mUnk10d26c;
    // NOLINTEND
