...
public:
    ...
    ::ll::TypedStorage<1, 1, bool>                mTeleportsOnProjectileHit;
    ::ll::TypedStorage<8, 64, ::ActorFilterGroup> mProjectileFilter;
...
public:
    ...
    MCAPI bool tryTeleportFromProjectileHit(::Actor& owner, ::Actor const& projectile);
    // NOLINTEND
};
