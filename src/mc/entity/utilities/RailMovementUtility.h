...
public:
    ...
    calculateGoldenRailSpeedIncrease(class IConstBlockSource const&, class BlockPos const&, int32_t, class Vec3);
    /**
     * @symbol
     * ?calculateMoveVelocity\@RailMovementUtility\@\@SA?AVVec3\@\@AEBVBlock\@\@HM_NAEAV2\@AEA_N3AEBV?$function\@$$A6A_NAEAVVec3\@\@\@Z\@std\@\@\@Z
     */
    MCAPI static class Vec3
    calculateMoveVelocity(class Block const&, int32_t, float, bool, class Vec3&, bool&, bool&, std::function<bool(class Vec3&)> const&);
    /**
     ...
     */
    MCAPI static class Vec3
    calculatePostRailMovementMinecartPosition(class IConstBlockSource const&, class Vec3 const&, class Vec3, class BlockPos const&, int32_t, class Vec3&);
    /**
