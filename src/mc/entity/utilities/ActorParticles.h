 ...
 */
MCAPI void
spawnParticlesInArea(class ILevel&, unsigned int, enum class ParticleType, class Vec3 const&, class Vec2 const&, class Random&);
/**
 ...
 */
MCAPI void
spawnTreasureHuntingParticles(unsigned int, class Vec3, class Vec3, class Vec2, class ILevel&, class Random&);
