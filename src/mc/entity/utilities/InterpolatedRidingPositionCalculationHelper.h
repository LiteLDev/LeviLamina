...
public:
     ...
     */
    MCAPI static class Vec3 getCamelInterpolatedRidingOffset(bool); // NOLINT
    /**
     * @symbol
     * ?getCamelInterpolatedRidingOffset\@InterpolatedRidingPositionCalculationHelper\@\@SA?AVVec3\@\@AEBUSynchedActorDataComponent\@\@\@Z
     */
    MCAPI static class Vec3 getCamelInterpolatedRidingOffset(struct SynchedActorDataComponent const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI static class Vec3 getInterpolatedPosition(struct StateVectorComponent const&, float); // NOLINT
    /**
     * @symbol
