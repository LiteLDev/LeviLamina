 ...
 */
MCAPI extern class BaseGameVersion const PATCH_UPGRADE_VERSION; // NOLINT
/**
 * @symbol ?REQUIRED_BASE_GAME_VERSION_FOR_OLD_CONTENT\@BaseGameVersioning\@\@3VBaseGameVersion\@\@B
 */
MCAPI extern class BaseGameVersion const REQUIRED_BASE_GAME_VERSION_FOR_OLD_CONTENT; // NOLINT
/**
 * @symbol
 ...
 */
MCAPI std::vector<class BaseGameVersion> const& getAvailableBehaviorPackBaseGameVersions(); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI std::vector<class BaseGameVersion> const& getAvailableResourcePackBaseGameVersions(); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI bool
upgradeBaseGameVersionFromWorldTemplate(class gsl::not_null<class Bedrock::NonOwnerPointer<class WorldTemplateManager const>> const&, class LevelData&); // NOLINT
