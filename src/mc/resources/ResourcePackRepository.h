...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_RESOURCEPACKREPOSITORY_KNOWNPACKCONTAINER
    public:
...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_RESOURCEPACKREPOSITORY_KNOWNPACKINFO
    public:
