...
public:
    ...
    MCAPI std::string getExpandedI18nErrorList(std::string const&, std::vector<std::string> const& arguments) const;
    ...
    getExpandedI18nErrorList(uint, std::string const&, std::vector<std::string> const& arguments);
