...
public:
    ...
    ScriptWidgetGroup_ServiceInterface& operator=(ScriptWidgetGroup_ServiceInterface const&);
    ScriptWidgetGroup_ServiceInterface(ScriptWidgetGroup_ServiceInterface const&);
