...
public:
    ...
    ScriptWidgetGroup_WidgetInterface& operator=(ScriptWidgetGroup_WidgetInterface const&);
    ScriptWidgetGroup_WidgetInterface(ScriptWidgetGroup_WidgetInterface const&);
    ScriptWidgetGroup_WidgetInterface();
