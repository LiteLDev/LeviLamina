...
public:
    // member variables
    // NOLINTBEGIN
    ::ll::UntypedStorage<8, 40> mUnk613d58;
    ::ll::UntypedStorage<8, 32> mUnkc55301;
    ::ll::UntypedStorage<8, 40> mUnk4a0153;
    ::ll::UntypedStorage<8, 40> mUnkc13d96;
    ::ll::UntypedStorage<8, 40> mUnkc1cfbd;
