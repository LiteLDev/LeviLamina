...
class WidgetAddBoundingBoxComponentPayload
: public ::Editor::Network::NetworkPayload<::Editor::Network::WidgetAddBoundingBoxComponentPayload>,
...
public:
    ...
    ::ll::UntypedStorage<4, 4>  mUnkda6d6e;
    ::ll::UntypedStorage<4, 32> mUnk5f7376;
    // NOLINTEND
