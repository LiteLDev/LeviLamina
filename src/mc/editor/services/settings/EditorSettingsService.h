...
public:
    ...
    MCNAPI ::Editor::Settings::Audio& $getAudioSettings();

    MCNAPI ::Editor::Settings::Audio const& $getAudioSettings() const;
    ...
    MCNAPI void $_handleAudioSettingsChangedPayload(::Editor::Network::AudioSettingsChangedPayload const&);
