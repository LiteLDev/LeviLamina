...
public:
    ...
    listenForAudioSettingsChanged(::std::function<void(::Editor::Settings::AudioProps const&)> func) = 0;
    ...
    listenForGraphicsSettingsChanged(::std::function<void(::Editor::Settings::GraphicsProps const&)> func) = 0;
    ...
    virtual ::Bedrock::PubSub::Subscription
    listenForSpeedSettingsChanged(::std::function<void(::Editor::Settings::SpeedProps const&)> func) = 0;
    ...
    virtual ::Bedrock::PubSub::Subscription
    listenForThemeSettingsChanged(::std::function<void(::Editor::Settings::ThemeProps const&)> func) = 0;

    virtual ::Bedrock::PubSub::Subscription
    listenForCurrentThemeChanged(::std::function<void(::std::string const&)> func) = 0;
