...
class ScriptNavigationClimbComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                                  ::ScriptModuleMinecraft::ScriptNavigationClimbComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
