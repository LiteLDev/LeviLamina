...
class ScriptMovementJumpComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                               ::ScriptModuleMinecraft::ScriptMovementJumpComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptMovementJumpComponentFactory() /*override*/ = default;
