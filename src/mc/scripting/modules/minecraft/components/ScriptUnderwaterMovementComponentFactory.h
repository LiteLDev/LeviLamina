...
class ScriptUnderwaterMovementComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                                     ::ScriptModuleMinecraft::ScriptUnderwaterMovementComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptUnderwaterMovementComponentFactory() /*override*/ = default;
