...
class ScriptNavigationFloatComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                                  ::ScriptModuleMinecraft::ScriptNavigationFloatComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptNavigationFloatComponentFactory() /*override*/ = default;
