...
: public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<::ScriptModuleMinecraft::ScriptHealthComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptHealthComponentFactory() /*override*/ = default;
