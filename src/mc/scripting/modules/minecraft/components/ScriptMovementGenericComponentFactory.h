...
class ScriptMovementGenericComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                                  ::ScriptModuleMinecraft::ScriptMovementGenericComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
