...
public:
    ...
    // vIndex: 0
    virtual ~ScriptNavigationFloatComponent() /*override*/ = default;
    // NOLINTEND

public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static ::Scripting::ClassBindingBuilder<::ScriptModuleMinecraft::ScriptNavigationFloatComponent>
