...
class ScriptMovementBasicComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                                ::ScriptModuleMinecraft::ScriptMovementBasicComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptMovementBasicComponentFactory() /*override*/ = default;
