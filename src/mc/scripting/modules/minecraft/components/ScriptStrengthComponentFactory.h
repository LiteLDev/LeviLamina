...
: public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<::ScriptModuleMinecraft::ScriptStrengthComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptStrengthComponentFactory() /*override*/ = default;
