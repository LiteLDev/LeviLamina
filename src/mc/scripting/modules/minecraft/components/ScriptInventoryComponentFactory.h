...
class ScriptInventoryComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                            ::ScriptModuleMinecraft::ScriptInventoryComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptInventoryComponentFactory() /*override*/ = default;
