...
class ScriptNavigationGenericComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                                    ::ScriptModuleMinecraft::ScriptNavigationGenericComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptNavigationGenericComponentFactory() /*override*/ = default;
