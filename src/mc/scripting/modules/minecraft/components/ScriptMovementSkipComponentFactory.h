...
class ScriptMovementSkipComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                               ::ScriptModuleMinecraft::ScriptMovementSkipComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptMovementSkipComponentFactory() /*override*/ = default;
