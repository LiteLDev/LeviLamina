...
: public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<::ScriptModuleMinecraft::ScriptMovementComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptMovementComponentFactory() /*override*/ = default;
