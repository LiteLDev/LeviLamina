...
class ScriptNavigationHoverComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                                  ::ScriptModuleMinecraft::ScriptNavigationHoverComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptNavigationHoverComponentFactory() /*override*/ = default;
