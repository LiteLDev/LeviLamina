...
public:
    ...
    // vIndex: 0
    virtual ~ScriptMovementGenericComponent() /*override*/ = default;
    // NOLINTEND

public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static ::Scripting::ClassBindingBuilder<::ScriptModuleMinecraft::ScriptMovementGenericComponent>
