...
namespace ScriptModuleMinecraft { class ScriptCursorInventoryComponent; }
namespace Scripting { class WeakLifetimeScope; }
// clang-format on

namespace ScriptModuleMinecraft {

class ScriptCursorInventoryComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                                  ::ScriptModuleMinecraft::ScriptCursorInventoryComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
