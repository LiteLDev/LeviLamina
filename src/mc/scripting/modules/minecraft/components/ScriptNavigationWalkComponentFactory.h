...
class ScriptNavigationWalkComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                                 ::ScriptModuleMinecraft::ScriptNavigationWalkComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptNavigationWalkComponentFactory() /*override*/ = default;
