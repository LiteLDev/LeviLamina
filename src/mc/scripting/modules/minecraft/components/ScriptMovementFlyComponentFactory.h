...
class ScriptMovementFlyComponentFactory : public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<
                                              ::ScriptModuleMinecraft::ScriptMovementFlyComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptMovementFlyComponentFactory() /*override*/ = default;
