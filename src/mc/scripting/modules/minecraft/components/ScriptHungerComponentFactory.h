...
namespace ScriptModuleMinecraft { class ScriptHungerComponent; }
namespace Scripting { class WeakLifetimeScope; }
// clang-format on

namespace ScriptModuleMinecraft {

class ScriptHungerComponentFactory
: public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<::ScriptModuleMinecraft::ScriptHungerComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptHungerComponentFactory() /*override*/ = default;
