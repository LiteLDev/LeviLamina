...
namespace ScriptModuleMinecraft { class ScriptIsTamedComponent; }
namespace Scripting { class WeakLifetimeScope; }
// clang-format on

namespace ScriptModuleMinecraft {

class ScriptIsTamedComponentFactory
: public ::ScriptModuleMinecraft::GenericScriptActorComponentFactory<::ScriptModuleMinecraft::ScriptIsTamedComponent> {
public:
    // virtual functions
    // NOLINTBEGIN
    virtual ~ScriptIsTamedComponentFactory() /*override*/ = default;
