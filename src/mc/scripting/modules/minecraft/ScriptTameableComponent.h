...
public:
     ...
     */
    MCVAPI ~ScriptTameableComponent(); // NOLINT
#endif
    /**
     * @symbol
     ...
     */
    MCAPI
    ScriptTameableComponent(class WeakEntityRef const&, class Scripting::WeakLifetimeScope const&, std::string const&); // NOLINT
    /**
     * @symbol ?getProbability\@ScriptTameableComponent\@ScriptModuleMinecraft\@\@QEBA?AV?$Result\@M\@Scripting\@\@XZ
     */
    MCAPI class Scripting::Result<float> getProbability() const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<std::vector<std::string>> getTameItems() const; // NOLINT
    /**
     * @symbol ?tame\@ScriptTameableComponent\@ScriptModuleMinecraft\@\@QEBA?AV?$Result\@_N\@Scripting\@\@XZ
     */
    MCAPI class Scripting::Result<bool> tame() const; // NOLINT
    /**
     * @symbol
