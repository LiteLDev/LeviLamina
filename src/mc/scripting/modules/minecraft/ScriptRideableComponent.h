...
public:
    ...
    // symbol: ?getControllingSeat@ScriptRideableComponent@ScriptModuleMinecraft@@QEBA?AV?$Result@H@Scripting@@XZ
    MCAPI class Scripting::Result<int> getControllingSeat() const;

    // symbol: ?getCrouchingSkipInteract@ScriptRideableComponent@ScriptModuleMinecraft@@QEBA?AV?$Result@_N@Scripting@@XZ
    ...
    // symbol: ?getPassengerCanInteract@ScriptRideableComponent@ScriptModuleMinecraft@@QEBA?AV?$Result@_N@Scripting@@XZ
    MCAPI class Scripting::Result<bool> getPassengerCanInteract() const;

    // symbol: ?getPullInEntities@ScriptRideableComponent@ScriptModuleMinecraft@@QEBA?AV?$Result@_N@Scripting@@XZ
