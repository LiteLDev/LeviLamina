...
public:
    ...
    add(class Scripting::WeakLifetimeScope&, std::string const&, bool); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptItemType>
    getBetaItem(std::string const&); // NOLINT
    /**
     * @symbol
     * ?registerCustomItems\@ScriptItems\@ScriptModuleMinecraft\@\@QEAAXVWeakLifetimeScope\@Scripting\@\@VItemRegistryRef\@\@\@Z
     */
    MCAPI void registerCustomItems(class Scripting::WeakLifetimeScope, class ItemRegistryRef); // NOLINT
    /**
     * @symbol
     * ?bind\@ScriptItems\@ScriptModuleMinecraft\@\@SAXAEAVModuleBindingBuilder\@Scripting\@\@VItemRegistryRef\@\@\@Z
     */
    MCAPI static void bind(class Scripting::ModuleBindingBuilder&, class ItemRegistryRef); // NOLINT
    /**
     * @symbol
    ...
    getItemTypeHandle(class Scripting::WeakLifetimeScope, std::string const&); // NOLINT
};
