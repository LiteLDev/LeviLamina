...
public:
    ...
    // symbol:
    // ?get@ScriptItems@ScriptModuleMinecraft@@QEAA?AV?$StrongTypedObjectHandle@VScriptItemType@ScriptModuleMinecraft@@@Scripting@@AEAVWeakLifetimeScope@4@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptItemType>
    get(class Scripting::WeakLifetimeScope&, std::string const&);

    // symbol:
    // ?getBetaItem@ScriptItems@ScriptModuleMinecraft@@QEAA?AV?$StrongTypedObjectHandle@VScriptItemType@ScriptModuleMinecraft@@@Scripting@@AEAVWeakLifetimeScope@4@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptItemType>
    ...
    // symbol:
    // ?getItemTypeHandle@ScriptItems@ScriptModuleMinecraft@@SA?AV?$optional@V?$StrongTypedObjectHandle@VScriptItemType@ScriptModuleMinecraft@@@Scripting@@@std@@VWeakLifetimeScope@Scripting@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@4@@Z
