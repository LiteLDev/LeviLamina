...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFT_SCRIPTDIMENSION
public:
...
public:
    ...
    MCAPI class
        Scripting::
            Result<unsigned int>
            fillBlocks(class Vec3 const&, class Vec3 const&, class std::variant<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptBlockType>, class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptBlockPermutation>> const&, class std::optional<struct ScriptModuleMinecraft::ScriptBlockFillOptions> const&);
    /**
     * @symbol
    ...
    MCAPI class Scripting::Result<
        ...
        getEntities(class std::optional<struct ScriptModuleMinecraft::ScriptActorQueryOptions>) const;
    /**
     * @symbol
    ...
    MCAPI class Scripting::Result<
        ...
        getEntities_V010(class std::optional<struct ScriptModuleMinecraft::ScriptActorQueryOptions>) const;
    /**
     * @symbol
    ...
    MCAPI class Scripting::Result<
        ...
        getPlayers(class std::optional<struct ScriptModuleMinecraft::ScriptActorQueryOptions>) const;
    /**
     * @symbol
    ...
    MCAPI class Scripting::Result<
        ...
        getPlayers_V010(class std::optional<struct ScriptModuleMinecraft::ScriptActorQueryOptions>) const;
    /**
     ...
     */
    MCAPI class Scripting::Result<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptActor>>
    spawnEntity_V010(std::string const&, class std::variant<class BlockPos, class Vec3> const&) const;
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<void>
    spawnParticle(std::string const&, class Vec3 const&, class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptMolangVariableMap>);
    /**
     * @symbol
