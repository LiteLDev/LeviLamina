...
class ScriptEllipsoidPrimitive : public ::ScriptModuleMinecraft::ScriptPrimitiveShape {
public:
    // member variables
    // NOLINTBEGIN
    ::ll::TypedStorage<4, 12, ::Vec3> mRadii;
    ::ll::TypedStorage<4, 4, int>     mSegmentsPerAxis;
    // NOLINTEND
