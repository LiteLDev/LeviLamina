...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFT_SCRIPTCONTAINERSLOT
public:
...
public:
     ...
     */
    MCAPI class Scripting::Result<class std::optional<std::string>> getNameTag() const;
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<class std::optional<std::string>> getTypeId() const;
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<void> setCanDestroy(class std::optional<std::vector<std::string>> const&);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<void> setCanPlaceOn(class std::optional<std::vector<std::string>> const&);
    /**
     * @symbol
    ...
    setItem(class std::optional<class ScriptModuleMinecraft::ScriptItemStack> const&);
    /**
     ...
     */
    MCAPI class Scripting::Result<void> setLore(class std::optional<std::vector<std::string>> const&);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<void> setNameTag(class std::optional<std::string>);
    /**
