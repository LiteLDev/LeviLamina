...
public:
    ...
    // symbol: ?getLockMode@ScriptContainerSlot@ScriptModuleMinecraft@@QEBA?AV?$Result@W4ItemLockMode@@@Scripting@@XZ
    ...
    // symbol: ?setLockMode@ScriptContainerSlot@ScriptModuleMinecraft@@QEAA?AV?$Result@X@Scripting@@W4ItemLockMode@@@Z
