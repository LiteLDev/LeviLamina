...
public:
     ...
     */
    MCVAPI ~BaseScriptBlockComponent(); // NOLINT
#endif
    /**
     * @symbol ??0BaseScriptBlockComponent\@ScriptModuleMinecraft\@\@QEAA\@AEBV01\@\@Z
     */
    MCAPI BaseScriptBlockComponent(class ScriptModuleMinecraft::BaseScriptBlockComponent const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI
    BaseScriptBlockComponent(class BlockActor&, class BlockSource&, class BlockPos, class Scripting::WeakLifetimeScope const&, std::string const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptBlock> getBlock() const; // NOLINT
    /**
    ...
    operator=(class ScriptModuleMinecraft::BaseScriptBlockComponent const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI static class Scripting::ClassBindingBuilder<class ScriptModuleMinecraft::BaseScriptBlockComponent>
    bind(); // NOLINT
     ...
     */
    MCAPI class BlockActor* _tryGetOwner(); // NOLINT
    /**
     * @symbol ?_tryGetOwner\@BaseScriptBlockComponent\@ScriptModuleMinecraft\@\@IEBAPEBVBlockActor\@\@XZ
     */
    MCAPI class BlockActor const* _tryGetOwner() const; // NOLINT
