...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFT_SCRIPTSTRENGTHCOMPONENTFACTORY
public:
...
public:
    ...
    /**
     * @vftbl 2
     * @symbol ?hasComponent\@ScriptStrengthComponentFactory\@ScriptModuleMinecraft\@\@UEBA_NVWeakEntityRef\@\@\@Z
     */
