...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFT_SCRIPTMOVEMENTCOMPONENTFACTORY
public:
...
public:
    ...
    /**
     * @vftbl 2
     * @symbol ?hasComponent\@ScriptMovementComponentFactory\@ScriptModuleMinecraft\@\@UEBA_NVWeakEntityRef\@\@\@Z
     */
