...
public:
     ...
     */
    MCVAPI ~ScriptItemDefinitionBeforeEvent(); // NOLINT
#endif
    /**
     * @symbol
     ...
     */
    MCAPI
    ScriptItemDefinitionBeforeEvent(class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptItemStack>, struct ItemDefinitionEventTriggeredEvent&, class Scripting::WeakLifetimeScope const&); // NOLINT
    /**
     * @symbol ??0ScriptItemDefinitionBeforeEvent\@ScriptModuleMinecraft\@\@QEAA\@AEBU01\@\@Z
     */
    MCAPI
    ScriptItemDefinitionBeforeEvent(struct ScriptModuleMinecraft::ScriptItemDefinitionBeforeEvent const&); // NOLINT
    /**
     * @symbol ??0ScriptItemDefinitionBeforeEvent\@ScriptModuleMinecraft\@\@QEAA\@$$QEAU01\@\@Z
     */
    MCAPI ScriptItemDefinitionBeforeEvent(struct ScriptModuleMinecraft::ScriptItemDefinitionBeforeEvent&&); // NOLINT
    /**
    ...
    operator=(struct ScriptModuleMinecraft::ScriptItemDefinitionBeforeEvent&&); // NOLINT
    /**
     * @symbol
