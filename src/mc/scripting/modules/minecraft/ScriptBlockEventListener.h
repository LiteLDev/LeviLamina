...
public:
     ...
     */
    virtual enum class EventResult
    onBlockDestroyedByPlayer(class Player&, class Block const&, class BlockPos const&); // NOLINT
    /**
     * @vftbl 3
     * @symbol __unk_vfn_3
     */
     ...
     */
    virtual enum class EventResult
    onBlockDestructionStarted(class Player&, class BlockPos const&, unsigned char); // NOLINT
    /**
     * @vftbl 7
     * @symbol __unk_vfn_7
     */
     ...
     */
    virtual enum class EventResult
    onBlockExploded(class Dimension&, class BlockPos const&, class Block const&, class Actor*); // NOLINT
    /**
     * @vftbl 9
     * @symbol __unk_vfn_9
     */
     ...
     */
    virtual enum class EventResult onEvent(struct ExplosionStartedEvent const&); // NOLINT
    /**
     * @vftbl 12
     * @symbol
     * ?onEvent\@?$EventListenerDispatcher\@VBlockEventListener\@\@\@\@MEAA?AW4EventResult\@\@AEBUBlockNotificationEvent\@\@\@Z
     */
    virtual enum class EventResult onEvent(struct BlockNotificationEvent const&); // NOLINT
    /**
     * @vftbl 13
     * @symbol __unk_vfn_13
     */
     ...
     */
    MCAPI
    ScriptBlockEventListener(class Scripting::WeakLifetimeScope const&, struct Scripting::TypedObjectHandle<class ScriptModuleMinecraft::IScriptAfterEvents>); // NOLINT
};
