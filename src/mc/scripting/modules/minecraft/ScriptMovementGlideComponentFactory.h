...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFT_SCRIPTMOVEMENTGLIDECOMPONENTFACTORY
public:
...
public:
    ...
    /**
     * @vftbl 2
     * @symbol ?hasComponent\@ScriptMovementGlideComponentFactory\@ScriptModuleMinecraft\@\@UEBA_NVWeakEntityRef\@\@\@Z
     */
