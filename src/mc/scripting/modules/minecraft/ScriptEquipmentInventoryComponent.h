...
public:
    ...
    ScriptEquipmentInventoryComponent& operator=(ScriptEquipmentInventoryComponent const&);
    ScriptEquipmentInventoryComponent(ScriptEquipmentInventoryComponent const&);
    ScriptEquipmentInventoryComponent();
