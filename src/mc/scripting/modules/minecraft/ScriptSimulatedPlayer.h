...
public:
    ...
    // vIndex: 8, symbol: ?_isValid@ScriptSimulatedPlayer@ScriptModuleGameTest@@EEBA_NXZ
    ...
    // symbol: ?getHeadRotation@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEAA?AV?$Result@VVec2@@@Scripting@@XZ
    ...
    // symbol: ?lookAtBlock@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@X@Scripting@@AEBVVec3@@@Z
    ...
    // symbol: ?lookAtLocation@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@X@Scripting@@AEBVVec3@@@Z
    ...
    // symbol: ?moveToBlock@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@X@Scripting@@AEBVVec3@@M@Z
    MCAPI class Scripting::Result<void> moveToBlock(class Vec3 const&, float) const;

    // symbol: ?moveToLocation@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEBA?AV?$Result@X@Scripting@@AEBVVec3@@M@Z
    ...
    // symbol: ?setGameMode@ScriptSimulatedPlayer@ScriptModuleGameTest@@QEAA?AV?$Result@X@Scripting@@W4GameType@@@Z
