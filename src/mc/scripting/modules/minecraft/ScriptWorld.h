...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFT_SCRIPTWORLD
public:
...
public:
    ...
    playMusic(std::string const&, class std::optional<struct ScriptModuleMinecraft::ScriptMusicOptions>);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<void>
    playSound(std::string const&, class Vec3 const&, class std::optional<struct ScriptModuleMinecraft::ScriptWorldSoundOptions>);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<void>
    queueMusic(std::string const&, class std::optional<struct ScriptModuleMinecraft::ScriptMusicOptions>);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<void>
    setDynamicProperty(struct Scripting::ContextConfig const&, std::string const&, class std::variant<float, bool, std::string> const&);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<void>
        setTimeOfDay(class std::variant<int, enum class ScriptModuleMinecraft::ScriptTimeOfDay>);
    /**
     ...
     */
    MCAPI class Scripting::Result<void>
    _playSoundInternal(std::string const&, class Vec3 const&, class std::optional<struct ScriptModuleMinecraft::ScriptWorldSoundOptions>);
    /**
     * @symbol
    ...
    _validateDynamicProperty(std::string const&, class std::variant<float, bool, std::string> const*) const;
