...
class ScriptBlockDestructionParticlesComponent : public ::ScriptModuleMinecraft::BaseScriptBlockComponent {
public:
    // virtual functions
    // NOLINTBEGIN
    // vIndex: 0
...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI ::Scripting::Result<::std::string, ::Scripting::Error> texture() const;
...
public:
    // static functions
    // NOLINTBEGIN
    MCNAPI static ::Scripting::ClassBindingBuilder<::ScriptModuleMinecraft::ScriptBlockDestructionParticlesComponent>
    bind();
