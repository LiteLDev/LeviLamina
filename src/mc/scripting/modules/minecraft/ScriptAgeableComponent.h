...
public:
     ...
     */
    MCVAPI ~ScriptAgeableComponent(); // NOLINT
#endif
    /**
     * @symbol
     ...
     */
    MCAPI
    ScriptAgeableComponent(class WeakEntityRef const&, class Scripting::WeakLifetimeScope const&, std::string const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<std::vector<std::string>> getDropItems() const; // NOLINT
    /**
     * @symbol ?getDuration\@ScriptAgeableComponent\@ScriptModuleMinecraft\@\@QEBA?AV?$Result\@M\@Scripting\@\@XZ
     */
    MCAPI class Scripting::Result<float> getDuration() const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<std::vector<struct ActorDefinitionFeedItem>> getFeedItems() const; // NOLINT
    /**
     * @symbol
     * ?getGrowUp\@ScriptAgeableComponent\@ScriptModuleMinecraft\@\@QEBA?AV?$Result\@VActorDefinitionTrigger\@\@\@Scripting\@\@XZ
     */
    MCAPI class Scripting::Result<class ActorDefinitionTrigger> getGrowUp() const; // NOLINT
    /**
     * @symbol
