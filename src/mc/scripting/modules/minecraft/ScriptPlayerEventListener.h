...
public:
     ...
     */
    virtual enum class EventResult onEvent(struct PlayerNotificationEvent const&);
    /**
     * @vftbl 43
     * @symbol __unk_vfn_43
     */
     ...
     */
    virtual enum class EventResult onEvent(struct PlayerRespawnEvent const&);
    /**
     * @vftbl 51
     * @symbol __unk_vfn_51
     */
     ...
     */
    virtual enum class EventResult onEvent(struct PlayerInitialSpawnEvent const&);
    /**
     * @symbol
