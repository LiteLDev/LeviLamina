...
public:
    ...
    ScriptSimpleBlockVolumeUtils& operator=(ScriptSimpleBlockVolumeUtils const&);
    ScriptSimpleBlockVolumeUtils(ScriptSimpleBlockVolumeUtils const&);
    ScriptSimpleBlockVolumeUtils();
