...
public:
     ...
     */
    MCAPI
    ScriptDataDrivenActorTriggerBeforeEvent(class Actor&, std::string const&, std::vector<struct ActorDefinitionModifier>&, class Scripting::WeakLifetimeScope const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI void setModifiers(std::vector<struct ActorDefinitionModifier> const&); // NOLINT
    /**
     * @symbol
