...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI explicit ScriptBlockComponentRegistry(::ScriptModuleMinecraft::ScriptBlockCustomComponentsRegistry& registry);
...
public:
    // constructor thunks
    // NOLINTBEGIN
    MCFOLD void* $ctor(::ScriptModuleMinecraft::ScriptBlockCustomComponentsRegistry& registry);
    // NOLINTEND
};
