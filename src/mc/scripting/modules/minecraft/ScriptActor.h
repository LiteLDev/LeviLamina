...
public:
    ...
    // vIndex: 2, symbol: ?clearVelocity@ScriptActor@ScriptModuleMinecraft@@UEAA?AV?$Result@X@Scripting@@AEAVActor@@@Z
    ...
    // vIndex: 5, symbol: ?getSneaking@ScriptActor@ScriptModuleMinecraft@@UEBA?AV?$Result@_N@Scripting@@AEBVActor@@@Z
    virtual class Scripting::Result<bool> getSneaking(class Actor const&) const;

    // vIndex: 6, symbol: ?setSneaking@ScriptActor@ScriptModuleMinecraft@@UEAA?AV?$Result@X@Scripting@@AEAVActor@@_N@Z
    ...
    // vIndex: 8, symbol: ?_isValid@ScriptActor@ScriptModuleMinecraft@@MEBA_NXZ
    ...
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptActorComponent>
    ...
    MCAPI class Scripting::Result<
        std::optional<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptScoreboardIdentity>>>
    ...
    MCAPI class Scripting::Result<void>
    setDynamicProperty(class Actor&, struct Scripting::ContextConfig const&, std::string const&, std::variant<float, bool, std::string> const&);
    ...
    _validateDynamicProperty(class Actor&, std::string const&, std::variant<float, bool, std::string> const*, std::string const&);
