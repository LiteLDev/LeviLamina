...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFT_SCRIPTNAVIGATIONFLYCOMPONENTFACTORY
public:
...
public:
    ...
    /**
     * @vftbl 2
     * @symbol ?hasComponent\@ScriptNavigationFlyComponentFactory\@ScriptModuleMinecraft\@\@UEBA_NVWeakEntityRef\@\@\@Z
     */
