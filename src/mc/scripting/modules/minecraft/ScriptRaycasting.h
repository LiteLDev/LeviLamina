...
getEntitiesFromRay(class BlockSource&, class Vec3 const&, class Vec3 const&, struct ScriptModuleMinecraft::ScriptEntityRaycastOptions const&, class std::optional<class Actor const*>);
