...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFT_SCRIPTVECTOR
public:
...
public:
    ...
    divide(class Vec3 const&, class std::variant<float, class Vec3> const&);
    /**
    ...
    multiply(class Vec3 const&, class std::variant<float, class Vec3> const&);
    /**
