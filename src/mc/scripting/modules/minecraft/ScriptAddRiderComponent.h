...
public:
     ...
     */
    MCVAPI ~ScriptAddRiderComponent(); // NOLINT
#endif
    /**
     * @symbol
     ...
     */
    MCAPI
    ScriptAddRiderComponent(class WeakEntityRef const&, class Scripting::WeakLifetimeScope const&, std::string const&); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<std::string> getEntityType() const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<std::string> getSpawnEvent() const; // NOLINT
    /**
     * @symbol
