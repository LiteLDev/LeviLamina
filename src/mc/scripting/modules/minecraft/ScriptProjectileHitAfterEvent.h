...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFT_SCRIPTPROJECTILEHITAFTEREVENT
public:
...
public:
     ...
     */
    MCAPI class std::optional<struct ScriptModuleMinecraft::ScriptBlockHitInformation> getBlockHit() const;
    /**
     * @symbol
     ...
     */
    MCAPI class std::optional<struct ScriptModuleMinecraft::ScriptEntityHitInformation> getEntityHit() const;
    /**
