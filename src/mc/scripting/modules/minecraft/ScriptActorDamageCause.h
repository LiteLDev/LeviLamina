...
public:
     ...
     */
    MCAPI static class Scripting::EnumBindingBuilder<std::string, std::string> bindV010(); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI static class Scripting::EnumBindingBuilder<std::string, enum class ActorDamageCause> bindV1(); // NOLINT
};
