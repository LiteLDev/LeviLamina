...
public:
    ...
    // vIndex: 21, symbol:
    // ?onPlayerInputPermissionCategoryChange@IScriptWorldAfterEvents@ScriptModuleMinecraft@@UEAAXAEAV?$StrongTypedObjectHandle@UScriptPlayerInputPermissionCategoryChangeAfterEvent@ScriptModuleMinecraft@@@Scripting@@@Z
