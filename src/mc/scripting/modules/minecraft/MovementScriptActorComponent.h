...
public:
     ...
     */
    virtual class Scripting::Result<float> getMaxTurn() const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI
    MovementScriptActorComponent(class WeakEntityRef const&, class Scripting::WeakLifetimeScope const&, std::string const&, struct Description* ActorDefinitionDescriptor::*); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI static class Scripting::ClassBindingBuilder<class ScriptModuleMinecraft::MovementScriptActorComponent>
    bind(); // NOLINT
};
