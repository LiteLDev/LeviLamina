...
public:
     ...
     */
    MCVAPI ~ScriptBlockSignComponent(); // NOLINT
#endif
    /**
     * @symbol
    ...
    MCAPI class Scripting::Result<class std::optional<struct ScriptModuleMinecraft::ScriptRawTextInterface>>
        getRawText(enum class SignTextSide) const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<class std::optional<std::string>> getText(enum class SignTextSide) const; // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::Result<bool> getWaxed() const; // NOLINT
    /**
     * @symbol
    ...
    MCAPI class Scripting::Result<void>
        setTextDyeColor(class std::optional<enum class ItemColor>, enum class SignTextSide); // NOLINT
    /**
     * @symbol ?setWaxed\@ScriptBlockSignComponent\@ScriptModuleMinecraft\@\@QEAA?AV?$Result\@X\@Scripting\@\@XZ
     */
    MCAPI class Scripting::Result<void> setWaxed(); // NOLINT
    /**
     * @symbol
