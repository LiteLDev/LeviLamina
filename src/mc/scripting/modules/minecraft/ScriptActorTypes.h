...
public:
    // NOLINTBEGIN
    // symbol:
    // ?get@ScriptActorTypes@ScriptModuleMinecraft@@QEAA?AV?$StrongTypedObjectHandle@VScriptActorType@ScriptModuleMinecraft@@@Scripting@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
