...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFT_SCRIPTLAVAMOVEMENTCOMPONENTFACTORY
public:
...
public:
    ...
    /**
     * @vftbl 2
     * @symbol ?hasComponent\@ScriptLavaMovementComponentFactory\@ScriptModuleMinecraft\@\@UEBA_NVWeakEntityRef\@\@\@Z
     */
