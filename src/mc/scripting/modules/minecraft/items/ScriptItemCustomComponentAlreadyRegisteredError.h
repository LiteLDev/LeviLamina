...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI explicit ScriptItemCustomComponentAlreadyRegisteredError(::HashedString const& componentName);

    MCNAPI ~ScriptItemCustomComponentAlreadyRegisteredError();
    // NOLINTEND
