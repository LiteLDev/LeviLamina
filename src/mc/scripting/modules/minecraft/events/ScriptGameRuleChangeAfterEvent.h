...
public:
    // ScriptGameRuleChangeAfterEvent inner types define
    using QueueType = ::ScriptModuleMinecraft::ScriptGameRuleChangeAfterEventIntermediateData;
...
public:
    // member functions
    // NOLINTBEGIN
    MCAPI ScriptGameRuleChangeAfterEvent(
        ::std::shared_ptr<::ScriptModuleMinecraft::ScriptGameRuleChangeAfterEventIntermediateData> const& eventData,
