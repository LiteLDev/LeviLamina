...
public:
    ...
    MCAPI void setReturnValues(int& durabilityDamage, class ItemStack& item, class Actor&, class Mob&);
...
public:
    // NOLINTBEGIN
    MCAPI void* ctor$(struct ScriptModuleMinecraft::ScriptItemCustomComponentBeforeDurabilityDamageEvent const&);
