...
struct ScriptActorTamedAfterEvent {
public:
    // ScriptActorTamedAfterEvent inner types define
    using QueueType = ::ScriptModuleMinecraft::ScriptActorTamedAfterEventIntermediateData;
