...
public:
    // ScriptPlayerInputPermissionCategoryChangeAfterEvent inner types define
    using QueueType = ::ScriptModuleMinecraft::ScriptPlayerInputPermissionCategoryChangeIntermediateData;
