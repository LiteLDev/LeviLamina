...
public:
    ...
    // vIndex: 38
    virtual ::EventResult onEvent(struct PlayerGameModeChangeEvent const& playerGameModeChangeEvent);
    ...
    // vIndex: 45
    virtual ::EventResult onEvent(struct PlayerDimensionChangeAfterEvent const& playerDimensionChangeEvent);

    // vIndex: 46
    virtual ::EventResult onEvent(struct PlayerInteractWithEntityAfterEvent const& playerInteractWithEntityEvent);

    // vIndex: 47
    virtual ::EventResult onEvent(struct PlayerInteractWithBlockAfterEvent const& playerInteractWithBlockEvent);

    // vIndex: 48
    virtual ::EventResult onEvent(struct PlayerInputPermissionCategoryChangeEvent const& event);
    ...
    // vIndex: 53
    virtual ::EventResult onEvent(struct PlayerRespawnEvent const& respawnEvent);
