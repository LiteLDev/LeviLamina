...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFT_SCRIPTCONTAINERWRAPPER
public:
...
public:
    ...
    setItem(int, class std::optional<class ScriptModuleMinecraft::ScriptItemStack> const&) const;
    /**
     * @symbol
