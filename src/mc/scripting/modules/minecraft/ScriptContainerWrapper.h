...
public:
    ...
    // symbol: ?moveItem@ScriptContainerWrapper@ScriptModuleMinecraft@@QEBA?AV?$Result@X@Scripting@@HHAEAV12@@Z
    ...
    // symbol: ?swapItems@ScriptContainerWrapper@ScriptModuleMinecraft@@QEBA?AV?$Result@X@Scripting@@HHAEAV12@@Z
