...
public:
    ...
    canPlace(std::variant<class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptBlockType>, class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraft::ScriptBlockPermutation>> const&, std::optional<::ScriptModuleMinecraft::ScriptFacing>)
        const;
    ...
    // symbol: ?getRedstonePower@ScriptBlock@ScriptModuleMinecraft@@QEBA?AV?$Result@V?$optional@H@std@@@Scripting@@XZ
    ...
    // symbol: ?setType@ScriptBlock@ScriptModuleMinecraft@@QEAA?AV?$Result@X@Scripting@@AEBVScriptBlockType@2@@Z
