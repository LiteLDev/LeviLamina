...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFTSERVERUI_SCRIPTMODALFORMDATA
public:
...
public:
    ...
    dropdown(class std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface> const&, std::vector<class std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface>>, class std::optional<int>);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraftServerUI::ScriptModalFormData>
    dropdownV010(std::string const&, std::vector<std::string>, class std::optional<int>);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraftServerUI::ScriptModalFormData>
    slider(class std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface> const&, float, float, float, class std::optional<float>);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraftServerUI::ScriptModalFormData>
    sliderV010(std::string const&, float, float, float, class std::optional<float>);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraftServerUI::ScriptModalFormData>
    textField(class std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface> const&, class std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface>, class std::optional<std::string>);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraftServerUI::ScriptModalFormData>
    textFieldV010(std::string const&, std::string const&, class std::optional<std::string>);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraftServerUI::ScriptModalFormData>
    title(class std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface> const&);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraftServerUI::ScriptModalFormData>
    toggle(class std::variant<std::string, struct ScriptModuleMinecraft::ScriptRawMessageInterface> const&, class std::optional<bool>);
    /**
     * @symbol
     ...
     */
    MCAPI class Scripting::StrongTypedObjectHandle<class ScriptModuleMinecraftServerUI::ScriptModalFormData>
    toggleV010(std::string const&, class std::optional<bool>);
    /**
