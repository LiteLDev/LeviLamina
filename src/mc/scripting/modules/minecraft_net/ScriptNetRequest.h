...
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SCRIPTMODULEMINECRAFTNET_SCRIPTNETREQUEST
public:
...
public:
    ...
    addHeader(std::string const&, class std::variant<std::string, class ScriptModuleMinecraftServerAdmin::ScriptSecretString> const&);
    /**
