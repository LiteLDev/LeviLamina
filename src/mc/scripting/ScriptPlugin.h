...
public:
    ...
    onLoadScript(std::string const&, class std::optional<std::vector<struct Scripting::ModuleBinding>>); // NOLINT
#ifdef ENABLE_VIRTUAL_FAKESYMBOL_SCRIPTPLUGIN
    /**
     * @symbol __unk_destructor_-1
     */
    MCVAPI ~ScriptPlugin(); // NOLINT
#endif
    /**
     ...
     */
    MCAPI std::vector<std::string> reportErrors() const; // NOLINT
     ...
     */
    MCAPI class std::optional<struct Scripting::ScriptData> _loadScript(std::string const&); // NOLINT
