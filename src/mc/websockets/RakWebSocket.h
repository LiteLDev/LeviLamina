...
public:
    ...
    MCAPI bool _sendDataFrame(uchar const* payload, uint size, ::OpCode opCode, bool);
    ...
    MCAPI void _splitWebSocketURI(std::string const& uri, std::string&, std::string& host, std::string& path);
