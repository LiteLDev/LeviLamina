 ...
 */
MCAPI void
AddCommandBlockAndButtonToStartTest(class BlockPos const&, enum class Rotation, class BlockPos const&, std::string const&, class BlockSource&); // NOLINT
/**
 * @symbol ?ClearSpaceForStructure\@StructureUtils\@gametest\@\@YAXAEBVBoundingBox\@\@HAEAVBlockSource\@\@\@Z
 */
MCAPI void ClearSpaceForStructure(class BoundingBox const&, int, class BlockSource&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI void
CreateNewEmptyStructureBlock(std::string const&, class BlockPos const&, class BlockPos const&, enum class Rotation, class BlockSource&); // NOLINT
/**
 * @symbol ?DoesStructureContain\@StructureUtils\@gametest\@\@YA_NAEBVBlockPos\@\@0AEAVBlockSource\@\@\@Z
 */
MCAPI bool DoesStructureContain(class BlockPos const&, class BlockPos const&, class BlockSource&); // NOLINT
/**
 * @symbol
 * ?FindNearestStructureBlock\@StructureUtils\@gametest\@\@YAPEAVStructureBlockActor\@\@AEBVBlockPos\@\@HAEAVBlockSource\@\@\@Z
 */
MCAPI class StructureBlockActor* FindNearestStructureBlock(class BlockPos const&, int, class BlockSource&); // NOLINT
/**
 * @symbol
...
FindStructureBlockContainingPos(class BlockPos const&, int, class BlockSource&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI std::vector<class BlockPos> FindStructureBlocks(class BlockPos const&, int, class BlockSource&); // NOLINT
/**
 * @symbol ?GetRotationForRotationSteps\@StructureUtils\@gametest\@\@YA?AW4Rotation\@\@H\@Z
 */
MCAPI enum class Rotation GetRotationForRotationSteps(int); // NOLINT
/**
 * @symbol
...
GetStructureBoundingBox(std::string const&, class Level&, enum class Rotation const&, class BlockPos); // NOLINT
/**
 * @symbol ?GetStructureBoundingBox\@StructureUtils\@gametest\@\@YA?AVBoundingBox\@\@AEBVStructureBlockActor\@\@\@Z
 */
MCAPI class BoundingBox GetStructureBoundingBox(class StructureBlockActor const&); // NOLINT
/**
 * @symbol ?GetStructureBounds\@StructureUtils\@gametest\@\@YA?AVAABB\@\@AEBVStructureBlockActor\@\@\@Z
 */
MCAPI class AABB GetStructureBounds(class StructureBlockActor const&); // NOLINT
/**
 * @symbol
...
GetStructureEditorData(class StructureTemplate const&, enum class Rotation const&); // NOLINT
/**
 * @symbol ?GetStructureRelativePos\@StructureUtils\@gametest\@\@YA?AVBlockPos\@\@AEBVStructureBlockActor\@\@AEBV3\@\@Z
 */
MCAPI class BlockPos GetStructureRelativePos(class StructureBlockActor const&, class BlockPos const&); // NOLINT
/**
 * @symbol
 ...
 */
MCAPI class StructureTemplate* GetStructureTemplate(std::string const&, class Level&); // NOLINT
/**
 * @symbol
...
SpawnStructure(std::string const&, class BlockPos const&, enum class Rotation, int, class BlockSource&); // NOLINT
/**
 * @symbol ?transform\@StructureUtils\@gametest\@\@YA?AVVec3\@\@AEBV3\@W4Mirror\@\@W4Rotation\@\@0\@Z
 */
MCAPI class Vec3 transform(class Vec3 const&, enum class Mirror, enum class Rotation, class Vec3 const&); // NOLINT
