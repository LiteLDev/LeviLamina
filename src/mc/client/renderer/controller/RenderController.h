...
public:
    ...
    ::ll::UntypedStorage<8, 216> mUnk82218a;
    ::ll::UntypedStorage<8, 864> mUnkd6f969;
    ::ll::UntypedStorage<8, 864> mUnkd9ddbc;
    ::ll::UntypedStorage<8, 864> mUnk117366;
    ::ll::UntypedStorage<8, 864> mUnk6e4053;
    ::ll::UntypedStorage<8, 864> mUnk44f009;
    ...
    ::ll::UntypedStorage<8, 216> mUnk39f6f1;
