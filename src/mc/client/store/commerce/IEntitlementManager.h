...
public:
    ...
    // vIndex: 5
    virtual ::Bedrock::Threading::Async<bool> processExternalStorePurchases() = 0;
    ...
    // vIndex: 16
    virtual ::Bedrock::Threading::Async<void> refreshInventory() = 0;
    ...
    // vIndex: 23
    virtual ::Bedrock::Threading::Async<::TransactionStatus> purchaseCatalogOffer(
        ::std::string const&,
        ::std::string const&,
        ::std::string const&,
