...
#ifdef LL_PLAT_S
    ::ll::TypedStorage<1, 1, ::mce::MaterialPtr> mDefaultMaterial;
#else // LL_PLAT_C
...
public:
    ...
    MCAPI_C void copyTransformMatricesToModelParts(::RenderParams& renderParams);
    ...
    MCAPI_C ::std::vector<::HashedString> getQueryableBoneOrientations() const;

    MCAPI_C ::SkeletalHierarchyIndex getSkeletalHierarchyIndex() const;

    MCAPI_C void setupModelPart(
...
public:
    // constructor thunks
    // NOLINTBEGIN
    MCAPI_C void* $ctor(::DataDrivenModel& owner, ::std::string const& name, ::GeometryPtr sourceGeo);
    // NOLINTEND
