...
public:
    // member functions
    // NOLINTBEGIN
    MCNAPI_C MinecraftScreenController(
        ::std::shared_ptr<::MinecraftScreenModel> model,
        ::ScreenExitBehavior                      exitBehavior,
        bool                                      usesErrorPopupInfo
    );

    MCNAPI_C void _attemptAddFriends(::std::function<void()> callback);

    MCNAPI_C void _attemptConnect(::std::function<void(::Social::UserPlatformConnectionResult)> callback);

    MCNAPI_C bool _attemptSignIn(
    ...
    MCNAPI_C void _displayPrivilegesBlockedModalPopup(
        ::std::string const& messageString,
        ::std::string const& closeButtonTitle,
        bool                 showOpenAccountSettingButton
    );

    MCNAPI_C void _displaySignOutFailedModalPopup(::std::string const& error);

    MCNAPI_C void _displayStandardModalPopup(
    ...
    MCNAPI_C void _gateRealmsWhenCrossPlatformIsDisabled(::std::function<void()> callback);

    MCNAPI_C int
    _getStepSliderValue(::std::function<int()> getValue, ::std::string const& valueBindingName, bool continuousUpdate);

    MCNAPI_C void _handleSignIn(
        ::Social::IdentitySignInTrigger                            signInTrigger,
        ::std::string const&                                       signInSource,
        ::std::function<void(::Social::MultiIdentitySigninResult)> signInCallback
    );

    MCNAPI_C void _handleSignInFailure(
        ::Social::MultiIdentitySigninResult const&                 signInResult,
        ::std::function<void(::Social::MultiIdentitySigninResult)> callback,
        bool                                                       isAutoSignIn
    );

    MCNAPI_C bool _isApprovedLink(::std::string const& hyperlink) const;

    MCNAPI_C void _onAttemptSignInResult(
        ::Social::MultiIdentitySigninResult const&                 result,
        ::std::function<void(::Social::MultiIdentitySigninResult)> callback
    );

    MCNAPI_C ::ui::ViewRequest _onModalEventReceived(::ModalScreenButtonId modalResult, bool buttonClosesModal);

    MCNAPI_C void
    _promptEduSwitchAccounts(bool showModal, ::std::string const& buttonName, ::LastClickedSource lastClickedSource);

    MCNAPI_C void _registerEventHandlers();

    MCNAPI_C bool _resolveSafeZoneVisibility(::SafeZoneBuffer buffer) const;

    MCNAPI_C ::std::string const
    _retrieveBindingValueFromPropertyBag(::std::string const& bindingName, ::UIPropertyBag& propertyBag) const;

    MCNAPI_C void _showLiveMultiplayerModal();

    MCNAPI_C void _showNoWifiModal();

    MCNAPI_C bool _tryNavigateToXblUpsellScreen();

    MCNAPI_C bool _tryShowSuspendWarningModal(::std::function<void()> onConfirm);
    ...
    MCNAPI_C void gateOnPlatformSignInForStoreAccess(::std::function<void()> callback);

    MCNAPI_C ::ui::ViewRequest promptSignIn(
        ::Social::IdentitySignInTrigger                            signInTrigger,
        ::std::string const&                                       signInSource,
        ::std::function<void(::Social::MultiIdentitySigninResult)> signInCallback
    );

    MCNAPI_C ::std::shared_ptr<::DropdownScreenController> setUpCallbacksForCollectionDropdownOption(
        ::std::string const&                            collectionName,
    ...
    MCNAPI_C void setUpCallbacksForDropdownOption(
        ::OptionID                                      optionID,
        ::std::string const&                            dropdownName,
        ::std::unordered_map<::std::string, int> const& nameValuePairs,
        ::std::unordered_map<int, ::std::string> const& valueLabelPairs
    ...
    MCNAPI_C void setUpCallbacksForFloatOption(
        ::OptionID                                                        optionID,
    ...
    MCNAPI_C void setUpCallbacksForNestedButtonInCollection(
    ...
    MCNAPI_C void setUpCallbacksForStackPanelGrid(
    ...
    MCNAPI_C void setUpCallbacksForStepOption(
        ::OptionID                          optionID,
        ::std::string const&                sliderName,
    ...
    MCNAPI_C void showPickFileDialog(::std::shared_ptr<::FilePickerSettings> settings);

    MCNAPI_C void showRemoteStorageErrorModal(::Core::Path const& storageDirectory);

    MCNAPI_C ::ui::ViewRequest showSignIn();
    // NOLINTEND

public:
    // static functions
    // NOLINTBEGIN
    MCNAPI_C static int packItemInstance(::ItemInstance const& item);
    // NOLINTEND

public:
    // static variables
    // NOLINTBEGIN
    MCNAPI_C static ::std::string const& defaultOptionFormat();

    MCNAPI_C static ::std::function<::std::string(::std::string const&, float, bool)>&
    defaultProgressSliderOptionLabeller();

    MCNAPI_C static ::UpdateSliderProgressMode const& defaultUpdateSliderProgressMode();

    MCNAPI_C static ::OptionID& mSliderOptionID();

    MCNAPI_C static ::std::string& mSliderOptionTitle();
    // NOLINTEND
