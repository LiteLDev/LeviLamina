...
public:
     ...
     */
    MCAPI void clear_retry_state(unsigned int); // NOLINT
    /**
     * @symbol ?get_retry_state\@http_singleton\@httpclient\@xbox\@\@QEAA?AUhttp_retry_after_api_state\@23\@I\@Z
     */
    MCAPI struct xbox::httpclient::http_retry_after_api_state get_retry_state(unsigned int); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI
    http_singleton(struct HttpPerformInfo const&, struct WebSocketPerformInfo const&, class std::unique_ptr<struct HC_PERFORM_ENV, struct http_alloc_deleter<struct HC_PERFORM_ENV>>&&); // NOLINT
    /**
     * @symbol ?set_retry_state\@http_singleton\@httpclient\@xbox\@\@QEAAXIAEBUhttp_retry_after_api_state\@23\@\@Z
     */
    MCAPI void set_retry_state(unsigned int, struct xbox::httpclient::http_retry_after_api_state const&); // NOLINT
    /**
     * @symbol ??1http_singleton\@httpclient\@xbox\@\@QEAA\@XZ
     */
    MCAPI ~http_singleton(); // NOLINT
    /**
     * @symbol ?create\@http_singleton\@httpclient\@xbox\@\@SAJPEAUHCInitArgs\@\@\@Z
     */
    MCAPI static long create(struct HCInitArgs*); // NOLINT
     ...
     */
    MCAPI static long
    singleton_access(enum class xbox::httpclient::http_singleton::singleton_access_mode, struct HCInitArgs*, class std::shared_ptr<struct xbox::httpclient::http_singleton>&); // NOLINT
};
