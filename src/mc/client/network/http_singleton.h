...
public:
     ...
     */
    MCAPI static long
    singleton_access(enum class xbox::httpclient::http_singleton::singleton_access_mode, struct HCInitArgs*, std::shared_ptr<struct xbox::httpclient::http_singleton>&);
    // NOLINTEND
};
