 ...
 */
MCAPI class std::basic_string<wchar_t, struct std::char_traits<wchar_t>, class http_stl_allocator<wchar_t>>
flatten_http_headers(class std::map<
                     ...
                     class http_stl_allocator<struct std::pair<
                         class std::
                             basic_string<char, struct std::char_traits<char>, class http_stl_allocator<char>> const,
