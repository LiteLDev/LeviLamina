...
public:
     ...
     */
    MCAPI static long
    WebSocketConnectAsyncHandler(char const*, char const*, struct HC_WEBSOCKET_OBSERVER*, struct XAsyncBlock*, void*, struct HC_PERFORM_ENV*); // NOLINT
    /**
     * @symbol
     * ?WebSocketDisconnectHandler\@WinHttpProvider\@httpclient\@xbox\@\@SAJPEAUHC_WEBSOCKET_OBSERVER\@\@W4HCWebSocketCloseStatus\@\@PEAX\@Z
     */
    MCAPI static long
    WebSocketDisconnectHandler(struct HC_WEBSOCKET_OBSERVER*, enum class HCWebSocketCloseStatus, void*); // NOLINT
    /**
     * @symbol
     * ?WebSocketSendAsyncHandler\@WinHttpProvider\@httpclient\@xbox\@\@SAJPEAUHC_WEBSOCKET_OBSERVER\@\@PEBDPEAUXAsyncBlock\@\@PEAX\@Z
     */
    MCAPI static long
    WebSocketSendAsyncHandler(struct HC_WEBSOCKET_OBSERVER*, char const*, struct XAsyncBlock*, void*); // NOLINT
    /**
     * @symbol
     * ?WebSocketSendBinaryAsyncHandler\@WinHttpProvider\@httpclient\@xbox\@\@SAJPEAUHC_WEBSOCKET_OBSERVER\@\@PEBEIPEAUXAsyncBlock\@\@PEAX\@Z
     */
    MCAPI static long
    WebSocketSendBinaryAsyncHandler(struct HC_WEBSOCKET_OBSERVER*, unsigned char const*, unsigned int, struct XAsyncBlock*, void*); // NOLINT

    // private:
    /**
     * @symbol ?CloseAllConnections\@WinHttpProvider\@httpclient\@xbox\@\@AEAAJXZ
     */
    MCAPI long CloseAllConnections(); // NOLINT
    /**
     * @symbol ?GetHSession\@WinHttpProvider\@httpclient\@xbox\@\@AEAA?AV?$Result\@PEAX\@\@I\@Z
     */
    MCAPI class Result<void*> GetHSession(unsigned int); // NOLINT
    /**
     * @symbol ?HttpCallPerformAsync\@WinHttpProvider\@httpclient\@xbox\@\@AEAAJPEAUHC_CALL\@\@PEAUXAsyncBlock\@\@\@Z
     */
    MCAPI long HttpCallPerformAsync(struct HC_CALL*, struct XAsyncBlock*); // NOLINT
    /**
     * @symbol
     * ?WebSocketConnectAsync\@WinHttpProvider\@httpclient\@xbox\@\@AEAAJPEBD0PEAUHC_WEBSOCKET_OBSERVER\@\@PEAUXAsyncBlock\@\@\@Z
     */
    MCAPI long
    WebSocketConnectAsync(char const*, char const*, struct HC_WEBSOCKET_OBSERVER*, struct XAsyncBlock*); // NOLINT
    /**
     * @symbol
     ...
     */
    MCAPI static long
    GetProxyName(enum class xbox::httpclient::proxy_type, class xbox::httpclient::Uri, unsigned long&, class std::basic_string<wchar_t, struct std::char_traits<wchar_t>, class http_stl_allocator<wchar_t>>&); // NOLINT
    /**
     * @symbol ?SetGlobalProxyForHSession\@WinHttpProvider\@httpclient\@xbox\@\@CAJPEAXPEBD\@Z
     */
    MCAPI static long SetGlobalProxyForHSession(void*, char const*); // NOLINT
