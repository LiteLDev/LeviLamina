...
Tag* Tag::fromSNBT(const string& snbt) {
...
Tag* Tag::fromBinaryNBT(void* data, size_t len, size_t& offset, bool isLittleEndian) {
    void* vtbl;
    if (isLittleEndian)
...
Tag* Tag::fromBinaryNBT(void* data, size_t len, bool isLittleEndian) {
    size_t offset = 0;
