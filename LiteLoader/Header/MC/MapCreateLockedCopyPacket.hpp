...
public:
    ...
    inline int \/*enum enum StreamReadResult*\/ _read(class ReadOnlyBinaryStream& a0){
        int \/*enum enum StreamReadResult*\/ (MapCreateLockedCopyPacket::*rv)(class ReadOnlyBinaryStream&);
    ...
    inline int \/*enum enum MinecraftPacketIds*\/ getId() const{
        int \/*enum enum MinecraftPacketIds*\/ (MapCreateLockedCopyPacket::*rv)() const;
        *((void**)&rv) = dlsym("?getId@MapCreateLockedCopyPacket@@UEBA?AW4MinecraftPacketIds@@XZ");
        return (this->*rv)();
    }
    inline std::string getName() const{
        std::string (MapCreateLockedCopyPacket::*rv)() const;
        *((void**)&rv) = dlsym("?getName@MapCreateLockedCopyPacket@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ");
        return (this->*rv)();
    }
