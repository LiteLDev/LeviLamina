...
public:
    ...
    inline bool place(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        bool (IcePatchFeature::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?place@IcePatchFeature@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
