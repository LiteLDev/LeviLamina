...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_BOTTLEITEM
#include "Extra/BottleItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_BOTTLEITEM
...
public:
    ...
    inline bool isLiquidClipItem(int a0) const{
        bool (BottleItem::*rv)(int) const;
        *((void**)&rv) = dlsym("?isLiquidClipItem@BottleItem@@UEBA_NH@Z");
    ...
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (BottleItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@BottleItem@@EEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
    ...
    inline bool dispense(class BlockSource& a0, class Container& a1, int a2, class Vec3 const& a3, unsigned char a4) const{
        bool (BottleItem::*rv)(class BlockSource&, class Container&, int, class Vec3 const&, unsigned char) const;
        *((void**)&rv) = dlsym("?dispense@BottleItem@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z");
