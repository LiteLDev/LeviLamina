...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_COALITEM
#include "Extra/CoalItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_COALITEM
...
public:
    ...
    /*76*/ virtual float getFurnaceXPmultiplier(class ItemStackBase const&) const;
    ...
    inline std::string buildDescriptionId(class ItemDescriptor const& a0, class CompoundTag const* a1) const{
        std::string (CoalItem::*rv)(class ItemDescriptor const&, class CompoundTag const*) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@CoalItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z");
    ...
    inline float getFurnaceXPmultiplier(class ItemStackBase const& a0) const{
        float (CoalItem::*rv)(class ItemStackBase const&) const;
        *((void**)&rv) = dlsym("?getFurnaceXPmultiplier@CoalItem@@UEBAMAEBVItemStackBase@@@Z");
