...
public:
    ...
    inline float getShadowHeightOffs(){
        float (LlamaSpit::*rv)();
        *((void**)&rv) = dlsym("?getShadowHeightOffs@LlamaSpit@@UEAAMXZ");
        return (this->*rv)();
    }
    inline float getPickRadius(){
        float (LlamaSpit::*rv)();
        *((void**)&rv) = dlsym("?getPickRadius@LlamaSpit@@UEAAMXZ");
        return (this->*rv)();
    }
    inline float getBrightness(float a0) const{
        float (LlamaSpit::*rv)(float) const;
        *((void**)&rv) = dlsym("?getBrightness@LlamaSpit@@UEBAMM@Z");
        return (this->*rv)(std::forward<float>(a0));
    }
    inline struct ActorUniqueID getSourceUniqueID() const{
        struct ActorUniqueID (LlamaSpit::*rv)() const;
        *((void**)&rv) = dlsym("?getSourceUniqueID@LlamaSpit@@UEBA?AUActorUniqueID@@XZ");
        return (this->*rv)();
    }
    inline void normalTick(){
        void (LlamaSpit::*rv)();
        *((void**)&rv) = dlsym("?normalTick@LlamaSpit@@UEAAXXZ");
        return (this->*rv)();
    }
    */
