...
public:
    ...
    inline bool canContainLiquid() const{
        bool (ConduitBlock::*rv)() const;
        *((void**)&rv) = dlsym("?canContainLiquid@ConduitBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool mayPlace(class BlockSource& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (ConduitBlock::*rv)(class BlockSource&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?mayPlace@ConduitBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@E@Z");
