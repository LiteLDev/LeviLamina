...
#define EXTRA_INCLUDE_PART_GLOWLICHENBLOCK
#include "Extra/GlowLichenBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_GLOWLICHENBLOCK
...
public:
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (GlowLichenBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@GlowLichenBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class BlockLegacy& init(){
        class BlockLegacy& (GlowLichenBlock::*rv)();
        *((void**)&rv) = dlsym("?init@GlowLichenBlock@@UEAAAEAVBlockLegacy@@XZ");
        return (this->*rv)();
    }
    inline bool canBeFertilized(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        bool (GlowLichenBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?canBeFertilized@GlowLichenBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1), std::forward<class Block const&>(a2));
    }
    inline class Block const* getMultifaceBlockPtr() const{
        class Block const* (GlowLichenBlock::*rv)() const;
        *((void**)&rv) = dlsym("?getMultifaceBlockPtr@GlowLichenBlock@@MEBAPEBVBlock@@XZ");
        return (this->*rv)();
    }
    inline bool onFertilized(class BlockSource& a0, class BlockPos const& a1, class Actor* a2, int \/*enum enum FertilizerType*\/ a3) const{
        bool (GlowLichenBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor*, int \/*enum enum FertilizerType*\/) const;
        *((void**)&rv) = dlsym("?onFertilized@GlowLichenBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z");
    ...
    inline void playerDestroy(class Player& a0, class BlockPos const& a1, class Block const& a2) const{
        void (GlowLichenBlock::*rv)(class Player&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?playerDestroy@GlowLichenBlock@@UEBAXAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z");
