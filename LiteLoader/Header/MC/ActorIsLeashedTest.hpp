...
public:
    ...
    inline bool evaluate(struct FilterContext const& a0) const{
        bool (ActorIsLeashedTest::*rv)(struct FilterContext const&) const;
        *((void**)&rv) = dlsym("?evaluate@ActorIsLeashedTest@@UEBA_NAEBUFilterContext@@@Z");
        return (this->*rv)(std::forward<struct FilterContext const&>(a0));
    }
    inline class gsl::basic_string_span<char const, -1> getName() const{
        class gsl::basic_string_span<char const, -1> (ActorIsLeashedTest::*rv)() const;
        *((void**)&rv) = dlsym("?getName@ActorIsLeashedTest@@UEBA?AV?$basic_string_span@$$CBD$0?0@gsl@@XZ");
        return (this->*rv)();
    }
    */
