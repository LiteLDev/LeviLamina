...
public:
    ...
    /*198*/ virtual int getSignalStrength(class BlockSource&, class BlockPos const&) const;
    /*199*/ virtual int getSignalForData(int) const;
    /*200*/ virtual int getRedstoneSignal(int) const;
