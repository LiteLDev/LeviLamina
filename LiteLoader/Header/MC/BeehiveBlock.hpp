...
#define EXTRA_INCLUDE_PART_BEEHIVEBLOCK
#include "Extra/BeehiveBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_BEEHIVEBLOCK
...
public:
    ...
    inline void animateTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (BeehiveBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?animateTick@BeehiveBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (BeehiveBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@BeehiveBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline void executeEvent(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, std::string const& a3, class Actor& a4) const{
        void (BeehiveBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, std::string const&, class Actor&) const;
        *((void**)&rv) = dlsym("?executeEvent@BeehiveBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVActor@@@Z");
    ...
    inline int getComparatorSignal(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, unsigned char a3) const{
        int (BeehiveBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, unsigned char) const;
        *((void**)&rv) = dlsym("?getComparatorSignal@BeehiveBlock@@UEBAHAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@E@Z");
    ...
    inline unsigned char getMappedFace(unsigned char a0, class Block const& a1) const{
        unsigned char (BeehiveBlock::*rv)(unsigned char, class Block const&) const;
        *((void**)&rv) = dlsym("?getMappedFace@BeehiveBlock@@UEBAEEAEBVBlock@@@Z");
    ...
    inline class Block const* getNextBlockPermutation(class Block const& a0) const{
        class Block const* (BeehiveBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getNextBlockPermutation@BeehiveBlock@@UEBAPEBVBlock@@AEBV2@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (BeehiveBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@BeehiveBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline int getVariant(class Block const& a0) const{
        int (BeehiveBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@BeehiveBlock@@UEBAHAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline bool playerWillDestroy(class Player& a0, class BlockPos const& a1, class Block const& a2) const{
        bool (BeehiveBlock::*rv)(class Player&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?playerWillDestroy@BeehiveBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (BeehiveBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@BeehiveBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
