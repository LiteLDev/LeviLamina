...
#define EXTRA_INCLUDE_PART_ROTATEDPILLARBLOCK
#include "Extra/RotatedPillarBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_ROTATEDPILLARBLOCK
...
public:
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (RotatedPillarBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@RotatedPillarBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (RotatedPillarBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@RotatedPillarBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline unsigned char getMappedFace(unsigned char a0, class Block const& a1) const{
        unsigned char (RotatedPillarBlock::*rv)(unsigned char, class Block const&) const;
        *((void**)&rv) = dlsym("?getMappedFace@RotatedPillarBlock@@UEBAEEAEBVBlock@@@Z");
    ...
    inline class Block const& getPlacementBlock(class Actor& a0, class BlockPos const& a1, unsigned char a2, class Vec3 const& a3, int a4) const{
        class Block const& (RotatedPillarBlock::*rv)(class Actor&, class BlockPos const&, unsigned char, class Vec3 const&, int) const;
        *((void**)&rv) = dlsym("?getPlacementBlock@RotatedPillarBlock@@UEBAAEBVBlock@@AEAVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z");
...
private:
    MCAPI static int const* const const mRotatedX;
    MCAPI static int const* const const mRotatedZ;
};