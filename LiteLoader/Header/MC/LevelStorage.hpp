...
public:
    ...
    /*2*/ virtual std::unique_ptr<class CompoundTag> getCompoundTag(std::string const&, int /*enum DBHelpers::Category*/)                                                                                                                                       = 0;
    /*3*/ virtual bool hasKey(class gsl::basic_string_span<char const, -1>, int /*enum DBHelpers::Category*/) const                                                                                                                                             = 0;
    /*4*/ virtual void forEachKeyWithPrefix(class gsl::basic_string_span<char const, -1>, int /*enum DBHelpers::Category*/, class std::function<void(class gsl::basic_string_span<char const, -1>, class gsl::basic_string_span<char const, -1>)> const&) const = 0;
    /*5*/ virtual bool loadLevelData(class LevelData&)                                                                                                                                                                                                          = 0;
    /*6*/ virtual std::unique_ptr<class ChunkSource> createChunkStorage(std::unique_ptr<class ChunkSource>, int /*enum StorageVersion*/)                                                                                                                        = 0;
    /*7*/ virtual void saveLevelData(class LevelData const&)                                                                                                                                                                                                    = 0;
    /*8*/ virtual class Core::PathBuffer<std::string> const& getFullPath() const                                                                                                                                                                                = 0;
    /*9*/ virtual class std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> saveData(std::string const&, std::string&&, int /*enum DBHelpers::Category*/)                                                                                             = 0;
    /*10*/ virtual class std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> saveData(class LevelStorageWriteBatch const&)                                                                                                                            = 0;
    /*11*/ virtual class std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> deleteData(std::string const&, int /*enum DBHelpers::Category*/)                                                                                                         = 0;
    ...
    /*29*/ virtual void setCompactionCallback(class std::function<void(int /*enum CompactionStatus*/)>) = 0;
