...
#undef AFTER_EXTRA
    ...
    MCAPI extern class WeakPtr<class BlockLegacy> mMangroveLog;
    MCAPI extern class WeakPtr<class BlockLegacy> mMangrovePlanks;
    ...
    MCAPI extern class WeakPtr<class BlockLegacy> mStrippedMangroveLog;
