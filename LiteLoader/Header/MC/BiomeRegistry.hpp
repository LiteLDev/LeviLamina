...
public:
    ...
    inline class OwnerPtrT<struct EntityRegistryRefTraits>& getEntityRegistry(){
        class OwnerPtrT<struct EntityRegistryRefTraits>& (BiomeRegistry::*rv)();
        *((void**)&rv) = dlsym("?getEntityRegistry@BiomeRegistry@@UEAAAEAV?$OwnerPtrT@UEntityRegistryRefTraits@@@@XZ");
        return (this->*rv)();
    }
    */
