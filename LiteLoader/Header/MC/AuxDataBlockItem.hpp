...
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_AUXDATABLOCKITEM
#include "Extra/AuxDataBlockItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_AUXDATABLOCKITEM
...
public:
    ...
    inline std::string buildDescriptionId(class ItemDescriptor const& a0, class CompoundTag const* a1) const{
        std::string (AuxDataBlockItem::*rv)(class ItemDescriptor const&, class CompoundTag const*) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@AuxDataBlockItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z");
    ...
    inline int getLevelDataForAuxValue(int a0) const{
        int (AuxDataBlockItem::*rv)(int) const;
        *((void**)&rv) = dlsym("?getLevelDataForAuxValue@AuxDataBlockItem@@UEBAHH@Z");
