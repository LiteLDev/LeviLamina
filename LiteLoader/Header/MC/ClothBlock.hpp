...
#define EXTRA_INCLUDE_PART_CLOTHBLOCK
#include "Extra/ClothBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_CLOTHBLOCK
...
public:
    ...
    inline bool isAuxValueRelevantForPicking() const{
        ...
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@ClothBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (ClothBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@ClothBlock@@MEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (ClothBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@ClothBlock@@MEBA?AVItemInstance@@AEBVBlock@@@Z");
    ...
    inline class mce::Color getMapColor(class BlockSource& a0, class BlockPos const& a1) const{
        class mce::Color (ClothBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getMapColor@ClothBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z");
