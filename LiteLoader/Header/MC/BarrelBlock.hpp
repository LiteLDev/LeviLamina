...
#define EXTRA_INCLUDE_PART_BARRELBLOCK
#include "Extra/BarrelBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_BARRELBLOCK
...
public:
    ...
    inline int getComparatorSignal(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, unsigned char a3) const{
        int (BarrelBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, unsigned char) const;
        *((void**)&rv) = dlsym("?getComparatorSignal@BarrelBlock@@UEBAHAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@E@Z");
    ...
    inline int \/*enum enum Flip*\/ getFaceFlip(unsigned char a0, class Block const& a1) const{
        int \/*enum enum Flip*\/ (BarrelBlock::*rv)(unsigned char, class Block const&) const;
        *((void**)&rv) = dlsym("?getFaceFlip@BarrelBlock@@UEBA?AW4Flip@@EAEBVBlock@@@Z");
    ...
    inline int getVariant(class Block const& a0) const{
        int (BarrelBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@BarrelBlock@@UEBAHAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline void onRemove(class BlockSource& a0, class BlockPos const& a1) const{
        void (BarrelBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onRemove@BarrelBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (BarrelBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@BarrelBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
