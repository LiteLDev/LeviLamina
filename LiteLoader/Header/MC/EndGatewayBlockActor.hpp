...
public:
    ...
    inline std::unique_ptr<class BlockActorDataPacket> _getUpdatePacket(class BlockSource& a0){
        std::unique_ptr<class BlockActorDataPacket> (EndGatewayBlockActor::*rv)(class BlockSource&);
        *((void**)&rv) = dlsym("?_getUpdatePacket@EndGatewayBlockActor@@MEAA?AV?$unique_ptr@VBlockActorDataPacket@@U?$default_delete@VBlockActorDataPacket@@@std@@@std@@AEAVBlockSource@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0));
    }
    inline void load(class Level& a0, class CompoundTag const& a1, class DataLoadHelper& a2){
        void (EndGatewayBlockActor::*rv)(class Level&, class CompoundTag const&, class DataLoadHelper&);
        *((void**)&rv) = dlsym("?load@EndGatewayBlockActor@@UEAAXAEAVLevel@@AEBVCompoundTag@@AEAVDataLoadHelper@@@Z");
    ...
    inline void onChanged(class BlockSource& a0){
        void (EndGatewayBlockActor::*rv)(class BlockSource&);
        *((void**)&rv) = dlsym("?onChanged@EndGatewayBlockActor@@UEAAXAEAVBlockSource@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0));
    }
    inline bool save(class CompoundTag& a0) const{
        bool (EndGatewayBlockActor::*rv)(class CompoundTag&) const;
        *((void**)&rv) = dlsym("?save@EndGatewayBlockActor@@UEBA_NAEAVCompoundTag@@@Z");
        return (this->*rv)(std::forward<class CompoundTag&>(a0));
    }
    inline void tick(class BlockSource& a0){
        void (EndGatewayBlockActor::*rv)(class BlockSource&);
        *((void**)&rv) = dlsym("?tick@EndGatewayBlockActor@@UEAAXAEAVBlockSource@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0));
    }
    inline void triggerEvent(int a0, int a1){
        void (EndGatewayBlockActor::*rv)(int, int);
        *((void**)&rv) = dlsym("?triggerEvent@EndGatewayBlockActor@@UEAAXHH@Z");
