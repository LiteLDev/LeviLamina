...
public:
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (StructureBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@StructureBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline void onPlace(class BlockSource& a0, class BlockPos const& a1) const{
        void (StructureBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onPlace@StructureBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (StructureBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@StructureBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline void onRedstoneUpdate(class BlockSource& a0, class BlockPos const& a1, int a2, bool a3) const{
        void (StructureBlock::*rv)(class BlockSource&, class BlockPos const&, int, bool) const;
        *((void**)&rv) = dlsym("?onRedstoneUpdate@StructureBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@H_N@Z");
    ...
    inline void setupRedstoneComponent(class BlockSource& a0, class BlockPos const& a1) const{
        void (StructureBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?setupRedstoneComponent@StructureBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    */
