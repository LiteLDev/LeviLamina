...
#define EXTRA_INCLUDE_PART_DAYLIGHTDETECTORBLOCKACTOR
#include "Extra/DaylightDetectorBlockActorAPI.hpp"
#undef EXTRA_INCLUDE_PART_DAYLIGHTDETECTORBLOCKACTOR
...
public:
    ...
    inline void tick(class BlockSource& a0){
        void (DaylightDetectorBlockActor::*rv)(class BlockSource&);
        *((void**)&rv) = dlsym("?tick@DaylightDetectorBlockActor@@UEAAXAEAVBlockSource@@@Z");
