...
public:
    ...
    inline void load(class Level& a0, class CompoundTag const& a1, class DataLoadHelper& a2){
        void (MusicBlockActor::*rv)(class Level&, class CompoundTag const&, class DataLoadHelper&);
        *((void**)&rv) = dlsym("?load@MusicBlockActor@@UEAAXAEAVLevel@@AEBVCompoundTag@@AEAVDataLoadHelper@@@Z");
    ...
    inline bool save(class CompoundTag& a0) const{
        bool (MusicBlockActor::*rv)(class CompoundTag&) const;
        *((void**)&rv) = dlsym("?save@MusicBlockActor@@UEBA_NAEAVCompoundTag@@@Z");
