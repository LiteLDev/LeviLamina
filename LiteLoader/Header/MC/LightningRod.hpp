...
#define EXTRA_INCLUDE_PART_LIGHTNINGROD
#include "Extra/LightningRodAPI.hpp"
#undef EXTRA_INCLUDE_PART_LIGHTNINGROD
...
public:
    ...
    inline void onPlace(class BlockSource& a0, class BlockPos const& a1) const{
        void (LightningRod::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onPlace@LightningRod@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void animateTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (LightningRod::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?animateTick@LightningRod@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (LightningRod::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@LightningRod@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (LightningRod::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@LightningRod@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (LightningRod::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@LightningRod@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
    ...
    inline bool breaksFallingBlocks(class Block const& a0, class BaseGameVersion a1) const{
        bool (LightningRod::*rv)(class Block const&, class BaseGameVersion) const;
        *((void**)&rv) = dlsym("?breaksFallingBlocks@LightningRod@@UEBA_NAEBVBlock@@VBaseGameVersion@@@Z");
    ...
    inline class Block const& getPlacementBlock(class Actor& a0, class BlockPos const& a1, unsigned char a2, class Vec3 const& a3, int a4) const{
        class Block const& (LightningRod::*rv)(class Actor&, class BlockPos const&, unsigned char, class Vec3 const&, int) const;
        *((void**)&rv) = dlsym("?getPlacementBlock@LightningRod@@UEBAAEBVBlock@@AEAVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z");
    ...
    inline class AABB const& getVisualShape(class Block const& a0, class AABB& a1, bool a2) const{
        class AABB const& (LightningRod::*rv)(class Block const&, class AABB&, bool) const;
        *((void**)&rv) = dlsym("?getVisualShape@LightningRod@@UEBAAEBVAABB@@AEBVBlock@@AEAV2@_N@Z");
    ...
    inline void onLightningHit(class BlockSource& a0, class BlockPos const& a1) const{
        void (LightningRod::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onLightningHit@LightningRod@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void onProjectileHit(class BlockSource& a0, class BlockPos const& a1, class Actor const& a2) const{
        void (LightningRod::*rv)(class BlockSource&, class BlockPos const&, class Actor const&) const;
        *((void**)&rv) = dlsym("?onProjectileHit@LightningRod@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVActor@@@Z");
    ...
    inline void setupRedstoneComponent(class BlockSource& a0, class BlockPos const& a1) const{
        void (LightningRod::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?setupRedstoneComponent@LightningRod@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (LightningRod::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@LightningRod@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1), std::forward<class Random&>(a2));
    }
    */
