...
#define EXTRA_INCLUDE_PART_OBSIDIANBLOCK
#include "Extra/ObsidianBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_OBSIDIANBLOCK
...
public:
    ...
    inline void animateTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (ObsidianBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?animateTick@ObsidianBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
