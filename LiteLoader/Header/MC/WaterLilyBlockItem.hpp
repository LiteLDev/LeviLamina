...
public:
    ...
    inline bool isLiquidClipItem(int a0) const{
        bool (WaterLilyBlockItem::*rv)(int) const;
        *((void**)&rv) = dlsym("?isLiquidClipItem@WaterLilyBlockItem@@UEBA_NH@Z");
        return (this->*rv)(std::forward<int>(a0));
    }
    inline bool _calculatePlacePos(class ItemStackBase& a0, class Actor& a1, unsigned char& a2, class BlockPos& a3) const{
        bool (WaterLilyBlockItem::*rv)(class ItemStackBase&, class Actor&, unsigned char&, class BlockPos&) const;
        *((void**)&rv) = dlsym("?_calculatePlacePos@WaterLilyBlockItem@@UEBA_NAEAVItemStackBase@@AEAVActor@@AEAEAEAVBlockPos@@@Z");
