...
#define EXTRA_INCLUDE_PART_LODESTONEBLOCK
#include "Extra/LodestoneBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_LODESTONEBLOCK
...
public:
    ...
    inline bool playerWillDestroy(class Player& a0, class BlockPos const& a1, class Block const& a2) const{
        bool (LodestoneBlock::*rv)(class Player&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?playerWillDestroy@LodestoneBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z");
