...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_ENCHANTEDBOOKITEM
#include "Extra/EnchantedBookItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_ENCHANTEDBOOKITEM
...
public:
    ...
    inline int getEnchantValue() const{
        int (EnchantedBookItem::*rv)() const;
        *((void**)&rv) = dlsym("?getEnchantValue@EnchantedBookItem@@UEBAHXZ");
        return (this->*rv)();
    }
    inline int getEnchantSlot() const{
        int (EnchantedBookItem::*rv)() const;
        *((void**)&rv) = dlsym("?getEnchantSlot@EnchantedBookItem@@UEBAHXZ");
        return (this->*rv)();
    }
    inline bool isGlint(class ItemStackBase const& a0) const{
        bool (EnchantedBookItem::*rv)(class ItemStackBase const&) const;
        *((void**)&rv) = dlsym("?isGlint@EnchantedBookItem@@UEBA_NAEBVItemStackBase@@@Z");
