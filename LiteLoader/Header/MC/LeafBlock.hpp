...
public:
    ...
    /*123*/ virtual class ItemInstance getExtraResourceItem(class Block const&) const;
    /*
    inline bool canProvideSupport(class Block const& a0, unsigned char a1, enum BlockSupportType a2) const{
        bool (LeafBlock::*rv)(class Block const&, unsigned char, enum BlockSupportType) const;
