...
#define EXTRA_INCLUDE_PART_SOULSANDBLOCK
#include "Extra/SoulSandBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_SOULSANDBLOCK
...
public:
    ...
    inline void onPlace(class BlockSource& a0, class BlockPos const& a1) const{
        void (SoulSandBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onPlace@SoulSandBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
    ...
    inline void randomTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        ...
        *((void**)&rv) = dlsym("?randomTick@SoulSandBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (SoulSandBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@SoulSandBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1), std::forward<class Random&>(a2));
    }
    inline bool breaksFallingBlocks(class Block const& a0, class BaseGameVersion a1) const{
        bool (SoulSandBlock::*rv)(class Block const&, class BaseGameVersion) const;
        *((void**)&rv) = dlsym("?breaksFallingBlocks@SoulSandBlock@@UEBA_NAEBVBlock@@VBaseGameVersion@@@Z");
    ...
    inline float calcGroundFriction(struct IMobMovementProxy const& a0, class BlockPos const& a1) const{
        float (SoulSandBlock::*rv)(struct IMobMovementProxy const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?calcGroundFriction@SoulSandBlock@@UEBAMAEBUIMobMovementProxy@@AEBVBlockPos@@@Z");
    ...
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (SoulSandBlock::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@SoulSandBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
