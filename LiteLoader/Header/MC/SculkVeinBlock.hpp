...
#define EXTRA_INCLUDE_PART_SCULKVEINBLOCK
#include "Extra/SculkVeinBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_SCULKVEINBLOCK
...
public:
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (SculkVeinBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@SculkVeinBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class Block const* getMultifaceBlockPtr() const{
        ...
        *((void**)&rv) = dlsym("?getMultifaceBlockPtr@SculkVeinBlock@@MEBAPEBVBlock@@XZ");
        return (this->*rv)();
    }
    inline class BlockLegacy& init(){
        class BlockLegacy& (SculkVeinBlock::*rv)();
        *((void**)&rv) = dlsym("?init@SculkVeinBlock@@UEAAAEAVBlockLegacy@@XZ");
        return (this->*rv)();
    }
    */
