...
#define EXTRA_INCLUDE_PART_SCULKBLOCK
#include "Extra/SculkBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_SCULKBLOCK
...
public:
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (SculkBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@SculkBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline int getExperienceDrop(class Random& a0) const{
        int (SculkBlock::*rv)(class Random&) const;
        *((void**)&rv) = dlsym("?getExperienceDrop@SculkBlock@@UEBAHAEAVRandom@@@Z");
