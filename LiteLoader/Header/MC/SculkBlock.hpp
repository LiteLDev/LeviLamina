...
public:
    ...
    /**
     * @vtable 104
     * @symbol ?trySpawnResourcesOnExplosion@SculkBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@PEAV?$vector@PEBVItem@@V?$allocator@PEBVItem@@@std@@@std@@MH@Z
     */
    ...
    /**
     * @vtable 114
     * @symbol ?getExperienceDrop@SculkBlock@@UEBAHAEAVRandom@@@Z
     */
    ...
    /**
     * @vtable -1
     * @symbol ?canBeSilkTouched@SculkBlock@@UEBA_NXZ
     */
