...
MCAPI extern struct std::nothrow_t const nothrow;
MCAPI extern struct std::nullopt_t const nullopt;
MCAPI extern struct std::piecewise_construct_t const piecewise_construct;
