...
public:
    ...
    inline bool canBeOriginalSurface() const{
        bool (DeepslateBlock::*rv)() const;
        *((void**)&rv) = dlsym("?canBeOriginalSurface@DeepslateBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (DeepslateBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@DeepslateBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (DeepslateBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@DeepslateBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class Block const* tryGetInfested(class Block const& a0) const{
        class Block const* (DeepslateBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?tryGetInfested@DeepslateBlock@@UEBAPEBVBlock@@AEBV2@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    */
