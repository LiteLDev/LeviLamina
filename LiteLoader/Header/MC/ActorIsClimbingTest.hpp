...
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_ACTORISCLIMBINGTEST
#include "Extra/ActorIsClimbingTestAPI.hpp"
#undef EXTRA_INCLUDE_PART_ACTORISCLIMBINGTEST
...
public:
    ...
    inline bool evaluate(struct FilterContext const& a0) const{
        bool (ActorIsClimbingTest::*rv)(struct FilterContext const&) const;
        *((void**)&rv) = dlsym("?evaluate@ActorIsClimbingTest@@UEBA_NAEBUFilterContext@@@Z");
        return (this->*rv)(std::forward<struct FilterContext const&>(a0));
    }
    inline class gsl::basic_string_span<char const, -1> getName() const{
        class gsl::basic_string_span<char const, -1> (ActorIsClimbingTest::*rv)() const;
        *((void**)&rv) = dlsym("?getName@ActorIsClimbingTest@@UEBA?AV?$basic_string_span@$$CBD$0?0@gsl@@XZ");
        return (this->*rv)();
    }
    */
