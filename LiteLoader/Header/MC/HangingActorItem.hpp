...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_HANGINGACTORITEM
#include "Extra/HangingActorItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_HANGINGACTORITEM
...
public:
    ...
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (HangingActorItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@HangingActorItem@@EEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
