...
#define EXTRA_INCLUDE_PART_ICEBLOCK
#include "Extra/IceBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_ICEBLOCK
...
public:
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (IceBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@IceBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline bool breaksFallingBlocks(class Block const& a0, class BaseGameVersion a1) const{
        bool (IceBlock::*rv)(class Block const&, class BaseGameVersion) const;
        *((void**)&rv) = dlsym("?breaksFallingBlocks@IceBlock@@UEBA_NAEBVBlock@@VBaseGameVersion@@@Z");
    ...
    inline bool playerWillDestroy(class Player& a0, class BlockPos const& a1, class Block const& a2) const{
        bool (IceBlock::*rv)(class Player&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?playerWillDestroy@IceBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline void randomTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (IceBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?randomTick@IceBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
