...
public:
    ...
    inline int \/*enum enum StreamReadResult*\/ _read(class ReadOnlyBinaryStream& a0){
        int \/*enum enum StreamReadResult*\/ (UpdateTradePacket::*rv)(class ReadOnlyBinaryStream&);
        *((void**)&rv) = dlsym("?_read@UpdateTradePacket@@EEAA?AW4StreamReadResult@@AEAVReadOnlyBinaryStream@@@Z");
        return (this->*rv)(std::forward<class ReadOnlyBinaryStream&>(a0));
    }
    inline int \/*enum enum MinecraftPacketIds*\/ getId() const{
        int \/*enum enum MinecraftPacketIds*\/ (UpdateTradePacket::*rv)() const;
        *((void**)&rv) = dlsym("?getId@UpdateTradePacket@@UEBA?AW4MinecraftPacketIds@@XZ");
        return (this->*rv)();
    }
    inline void write(class BinaryStream& a0) const{
        void (UpdateTradePacket::*rv)(class BinaryStream&) const;
        *((void**)&rv) = dlsym("?write@UpdateTradePacket@@UEBAXAEAVBinaryStream@@@Z");
