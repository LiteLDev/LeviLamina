...
public:
    ...
    /*
    inline int getOutputSignal(){
        int (ComparatorBlockActor::*rv)();
        *((void**)&rv) = dlsym("?getOutputSignal@ComparatorBlockActor@@UEAAHXZ");
        return (this->*rv)();
    }
    inline void load(class Level& a0, class CompoundTag const& a1, class DataLoadHelper& a2){
        void (ComparatorBlockActor::*rv)(class Level&, class CompoundTag const&, class DataLoadHelper&);
        *((void**)&rv) = dlsym("?load@ComparatorBlockActor@@UEAAXAEAVLevel@@AEBVCompoundTag@@AEAVDataLoadHelper@@@Z");
    ...
    inline bool save(class CompoundTag& a0) const{
        bool (ComparatorBlockActor::*rv)(class CompoundTag&) const;
        *((void**)&rv) = dlsym("?save@ComparatorBlockActor@@UEBA_NAEAVCompoundTag@@@Z");
        return (this->*rv)(std::forward<class CompoundTag&>(a0));
    }
    inline void setOutputSignal(int a0){
        void (ComparatorBlockActor::*rv)(int);
        *((void**)&rv) = dlsym("?setOutputSignal@ComparatorBlockActor@@UEAAXH@Z");
        return (this->*rv)(std::forward<int>(a0));
    }
    inline void tick(class BlockSource& a0){
        void (ComparatorBlockActor::*rv)(class BlockSource&);
        *((void**)&rv) = dlsym("?tick@ComparatorBlockActor@@UEAAXAEAVBlockSource@@@Z");
