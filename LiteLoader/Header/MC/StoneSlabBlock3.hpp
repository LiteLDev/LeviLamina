...
#define EXTRA_INCLUDE_PART_STONESLABBLOCK3
#include "Extra/StoneSlabBlock3API.hpp"
#undef EXTRA_INCLUDE_PART_STONESLABBLOCK3
...
public:
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (StoneSlabBlock3::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@StoneSlabBlock3@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (StoneSlabBlock3::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@StoneSlabBlock3@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
    ...
    inline class mce::Color getMapColor(class BlockSource& a0, class BlockPos const& a1) const{
        class mce::Color (StoneSlabBlock3::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getMapColor@StoneSlabBlock3@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (StoneSlabBlock3::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@StoneSlabBlock3@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (StoneSlabBlock3::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@StoneSlabBlock3@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline int getVariant(class Block const& a0) const{
        int (StoneSlabBlock3::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@StoneSlabBlock3@@UEBAHAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
