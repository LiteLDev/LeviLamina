...
public:
    ...
    /*50*/ virtual void updateEntityAfterFallOn(class BlockPos const&, struct IActorMovementProxy&) const;
    ...
    inline int getExtraRenderLayers() const{
        int (SlimeBlock::*rv)() const;
        *((void**)&rv) = dlsym("?getExtraRenderLayers@SlimeBlock@@UEBAHXZ");
        return (this->*rv)();
    }
    inline void onFallOn(class BlockSource& a0, class BlockPos const& a1, class Actor& a2, float a3) const{
        void (SlimeBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor&, float) const;
        *((void**)&rv) = dlsym("?onFallOn@SlimeBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVActor@@M@Z");
    ...
    inline void onStandOn(class Actor& a0, class BlockPos const& a1) const{
        void (SlimeBlock::*rv)(class Actor&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onStandOn@SlimeBlock@@UEBAXAEAVActor@@AEBVBlockPos@@@Z");
    ...
    inline void updateEntityAfterFallOn(class BlockPos const& a0, struct IActorMovementProxy& a1) const{
        void (SlimeBlock::*rv)(class BlockPos const&, struct IActorMovementProxy&) const;
        *((void**)&rv) = dlsym("?updateEntityAfterFallOn@SlimeBlock@@UEBAXAEBVBlockPos@@AEAUIActorMovementProxy@@@Z");
