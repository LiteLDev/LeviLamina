...
#define EXTRA_INCLUDE_PART_SWEETBERRYBUSHBLOCK
#include "Extra/SweetBerryBushBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_SWEETBERRYBUSHBLOCK
...
public:
    ...
    /*117*/ virtual int /*enum enum BlockRenderLayer*/ getRenderLayer() const;
    /*118*/ virtual int /*enum enum BlockRenderLayer*/ getRenderLayer(class Block const&, class BlockSource&, class BlockPos const&) const;
    ...
    inline bool canSurvive(class BlockSource& a0, class BlockPos const& a1) const{
        bool (SweetBerryBushBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?canSurvive@SweetBerryBushBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline bool mayPlace(class BlockSource& a0, class BlockPos const& a1) const{
        bool (SweetBerryBushBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?mayPlace@SweetBerryBushBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (SweetBerryBushBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@SweetBerryBushBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1), std::forward<class Block const&>(a2));
    }
    inline bool attack(class Player* a0, class BlockPos const& a1) const{
        bool (SweetBerryBushBlock::*rv)(class Player*, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?attack@SweetBerryBushBlock@@UEBA_NPEAVPlayer@@AEBVBlockPos@@@Z");
    ...
    inline bool checkIsPathable(class Actor& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        bool (SweetBerryBushBlock::*rv)(class Actor&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?checkIsPathable@SweetBerryBushBlock@@UEBA_NAEAVActor@@AEBVBlockPos@@1@Z");
    ...
    inline bool dealsContactDamage(class Actor const& a0, class Block const& a1, bool a2) const{
        bool (SweetBerryBushBlock::*rv)(class Actor const&, class Block const&, bool) const;
        *((void**)&rv) = dlsym("?dealsContactDamage@SweetBerryBushBlock@@UEBA_NAEBVActor@@AEBVBlock@@_N@Z");
    ...
    inline void entityInside(class BlockSource& a0, class BlockPos const& a1, class Actor& a2) const{
        void (SweetBerryBushBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor&) const;
        *((void**)&rv) = dlsym("?entityInside@SweetBerryBushBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVActor@@@Z");
    ...
    inline void executeEvent(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, std::string const& a3, class Actor& a4) const{
        void (SweetBerryBushBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, std::string const&, class Actor&) const;
        *((void**)&rv) = dlsym("?executeEvent@SweetBerryBushBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVActor@@@Z");
    ...
    inline class AABB const& getAABB(class BlockSource const& a0, class BlockPos const& a1, class Block const& a2, class AABB& a3, bool a4) const{
        class AABB const& (SweetBerryBushBlock::*rv)(class BlockSource const&, class BlockPos const&, class Block const&, class AABB&, bool) const;
        *((void**)&rv) = dlsym("?getAABB@SweetBerryBushBlock@@UEBAAEBVAABB@@AEBVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z");
    ...
    inline int \/*enum enum BlockRenderLayer*\/ getRenderLayer() const{
        int \/*enum enum BlockRenderLayer*\/ (SweetBerryBushBlock::*rv)() const;
    ...
    inline int \/*enum enum BlockRenderLayer*\/ getRenderLayer(class Block const& a0, class BlockSource& a1, class BlockPos const& a2) const{
        int \/*enum enum BlockRenderLayer*\/ (SweetBerryBushBlock::*rv)(class Block const&, class BlockSource&, class BlockPos const&) const;
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (SweetBerryBushBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@SweetBerryBushBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline int getVariant(class Block const& a0) const{
        int (SweetBerryBushBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@SweetBerryBushBlock@@UEBAHAEBVBlock@@@Z");
    ...
    inline class AABB const& getVisualShape(class Block const& a0, class AABB& a1, bool a2) const{
        class AABB const& (SweetBerryBushBlock::*rv)(class Block const&, class AABB&, bool) const;
        *((void**)&rv) = dlsym("?getVisualShape@SweetBerryBushBlock@@UEBAAEBVAABB@@AEBVBlock@@AEAV2@_N@Z");
    ...
    inline bool hasTag(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, std::string const& a3) const{
        bool (SweetBerryBushBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, std::string const&) const;
        *((void**)&rv) = dlsym("?hasTag@SweetBerryBushBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z");
    ...
    inline bool mayPlaceOn(class BlockSource& a0, class BlockPos const& a1) const{
        bool (SweetBerryBushBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?mayPlaceOn@SweetBerryBushBlock@@MEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline bool onFertilized(class BlockSource& a0, class BlockPos const& a1, class Actor* a2, int \/*enum enum FertilizerType*\/ a3) const{
        bool (SweetBerryBushBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor*, int \/*enum enum FertilizerType*\/) const;
        *((void**)&rv) = dlsym("?onFertilized@SweetBerryBushBlock@@MEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z");
    ...
    inline void randomTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (SweetBerryBushBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?randomTick@SweetBerryBushBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline void spawnResources(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, class Randomize& a3, std::vector<class Item const*>* a4, float a5, int a6) const{
        void (SweetBerryBushBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, class Randomize&, std::vector<class Item const*>*, float, int) const;
        *((void**)&rv) = dlsym("?spawnResources@SweetBerryBushBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@PEAV?$vector@PEBVItem@@V?$allocator@PEBVItem@@@std@@@std@@MH@Z");
    ...
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (SweetBerryBushBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@SweetBerryBushBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
