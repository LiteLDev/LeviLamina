...
public:
    ...
    /*181*/ virtual int /*enum BlockRenderLayer*/ getRenderLayer() const;
    /*182*/ virtual int /*enum BlockRenderLayer*/ getRenderLayer(class Block const&, class BlockSource&, class BlockPos const&) const;
