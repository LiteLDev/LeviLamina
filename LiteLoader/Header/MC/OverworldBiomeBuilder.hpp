...
#define EXTRA_INCLUDE_PART_OVERWORLDBIOMEBUILDER
#include "Extra/OverworldBiomeBuilderAPI.hpp"
#undef EXTRA_INCLUDE_PART_OVERWORLDBIOMEBUILDER
...
private:
    ...
    MCAPI static struct ClimateUtils::Parameter const* const const EROSIONS;
    MCAPI static struct ClimateUtils::Parameter const FULL_RANGE;
    MCAPI static struct ClimateUtils::Parameter const* const const HUMIDITIES;
    MCAPI static struct ClimateUtils::Parameter const* const const TEMPERATURES;
