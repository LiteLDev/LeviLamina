...
#define EXTRA_INCLUDE_PART_BLASTFURNACEBLOCK
#include "Extra/BlastFurnaceBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_BLASTFURNACEBLOCK
...
public:
    ...
    /*101*/ virtual void __unk_vfn_30();
    /*102*/ virtual void __unk_vfn_31();
    /*103*/ virtual void tick(class BlockSource&, class BlockPos const&, class Random&) const;
    ...
    /*109*/ virtual void __unk_vfn_34();
    /*110*/ virtual void __unk_vfn_35();
    /*
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (BlastFurnaceBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@BlastFurnaceBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (BlastFurnaceBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@BlastFurnaceBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (BlastFurnaceBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@BlastFurnaceBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (BlastFurnaceBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@BlastFurnaceBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
