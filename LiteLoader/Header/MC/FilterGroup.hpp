...
public:
    ...
    inline bool _setupContext(class FilterTest const& a0, struct FilterContext& a1) const{
        bool (FilterGroup::*rv)(class FilterTest const&, struct FilterContext&) const;
        *((void**)&rv) = dlsym("?_setupContext@FilterGroup@@MEBA_NAEBVFilterTest@@AEAUFilterContext@@@Z");
        return (this->*rv)(std::forward<class FilterTest const&>(a0), std::forward<struct FilterContext&>(a1));
    }
    */
