...
#define EXTRA_INCLUDE_PART_CRYINGOBSIDIANBLOCK
#include "Extra/CryingObsidianBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_CRYINGOBSIDIANBLOCK
...
public:
    ...
    inline void animateTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (CryingObsidianBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?animateTick@CryingObsidianBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (CryingObsidianBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@CryingObsidianBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline void playerDestroy(class Player& a0, class BlockPos const& a1, class Block const& a2) const{
        void (CryingObsidianBlock::*rv)(class Player&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?playerDestroy@CryingObsidianBlock@@UEBAXAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z");
