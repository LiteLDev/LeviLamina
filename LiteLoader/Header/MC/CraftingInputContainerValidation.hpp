...
public:
    ...
    inline bool isValidSlotForContainer(class ContainerScreenContext const& a0, class Container const& a1, int a2) const{
        bool (CraftingInputContainerValidation::*rv)(class ContainerScreenContext const&, class Container const&, int) const;
        *((void**)&rv) = dlsym("?isValidSlotForContainer@CraftingInputContainerValidation@@UEBA_NAEBVContainerScreenContext@@AEBVContainer@@H@Z");
