...
public:
    ...
    inline bool canBeOriginalSurface() const{
        bool (ClayBlock::*rv)() const;
        *((void**)&rv) = dlsym("?canBeOriginalSurface@ClayBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool mayConsumeFertilizer(class BlockSource& a0) const{
        bool (ClayBlock::*rv)(class BlockSource&) const;
        *((void**)&rv) = dlsym("?mayConsumeFertilizer@ClayBlock@@UEBA_NAEAVBlockSource@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0));
    }
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (ClayBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@ClayBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline bool canBeFertilized(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        bool (ClayBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?canBeFertilized@ClayBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline bool onFertilized(class BlockSource& a0, class BlockPos const& a1, class Actor* a2, int \/*enum enum FertilizerType*\/ a3) const{
        bool (ClayBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor*, int \/*enum enum FertilizerType*\/) const;
        *((void**)&rv) = dlsym("?onFertilized@ClayBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (ClayBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@ClayBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
        return (this->*rv)(std::forward<class Randomize&>(a0), std::forward<class Block const&>(a1), std::forward<int>(a2));
    }
    */
