...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_BALLOONITEM
#include "Extra/BalloonItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_BALLOONITEM
...
public:
    ...
    inline bool isDyeable() const{
        bool (BalloonItem::*rv)() const;
        *((void**)&rv) = dlsym("?isDyeable@BalloonItem@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (BalloonItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@BalloonItem@@EEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
    ...
    inline std::string buildDescriptionId(class ItemDescriptor const& a0, class CompoundTag const* a1) const{
        std::string (BalloonItem::*rv)(class ItemDescriptor const&, class CompoundTag const*) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@BalloonItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z");
    ...
    inline class mce::Color getColor(class CompoundTag const* a0, class ItemDescriptor const& a1) const{
        class mce::Color (BalloonItem::*rv)(class CompoundTag const*, class ItemDescriptor const&) const;
        *((void**)&rv) = dlsym("?getColor@BalloonItem@@UEBA?AVColor@mce@@PEBVCompoundTag@@AEBVItemDescriptor@@@Z");
