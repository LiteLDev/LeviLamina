...
public:
    ...
    inline class Scripting::StrongTypedObjectHandle<class ScriptActorComponent> createComponent(class WeakEntityRef a0, class Scripting::WeakLifetimeScope const& a1, std::string const& a2){
        class Scripting::StrongTypedObjectHandle<class ScriptActorComponent> (ScriptMovementFlyComponentFactory::*rv)(class WeakEntityRef, class Scripting::WeakLifetimeScope const&, std::string const&);
        *((void**)&rv) = dlsym("?createComponent@ScriptMovementFlyComponentFactory@@UEAA?AV?$StrongTypedObjectHandle@VScriptActorComponent@@@Scripting@@VWeakEntityRef@@AEBVWeakLifetimeScope@3@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z");
    ...
    inline bool hasComponent(class WeakEntityRef a0) const{
        bool (ScriptMovementFlyComponentFactory::*rv)(class WeakEntityRef) const;
        *((void**)&rv) = dlsym("?hasComponent@ScriptMovementFlyComponentFactory@@UEBA_NVWeakEntityRef@@@Z");
