...
public:
    ...
    inline int \/*enum enum StreamReadResult*\/ _read(class ReadOnlyBinaryStream& a0){
        int \/*enum enum StreamReadResult*\/ (CreativeContentPacket::*rv)(class ReadOnlyBinaryStream&);
    ...
    inline int \/*enum enum MinecraftPacketIds*\/ getId() const{
        int \/*enum enum MinecraftPacketIds*\/ (CreativeContentPacket::*rv)() const;
        *((void**)&rv) = dlsym("?getId@CreativeContentPacket@@UEBA?AW4MinecraftPacketIds@@XZ");
        return (this->*rv)();
    }
    inline std::string getName() const{
        std::string (CreativeContentPacket::*rv)() const;
        *((void**)&rv) = dlsym("?getName@CreativeContentPacket@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ");
        return (this->*rv)();
    }
    inline void write(class BinaryStream& a0) const{
        void (CreativeContentPacket::*rv)(class BinaryStream&) const;
        *((void**)&rv) = dlsym("?write@CreativeContentPacket@@UEBAXAEAVBinaryStream@@@Z");
