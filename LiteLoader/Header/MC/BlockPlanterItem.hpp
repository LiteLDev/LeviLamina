...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_BLOCKPLANTERITEM
#include "Extra/BlockPlanterItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_BLOCKPLANTERITEM
...
public:
    ...
    inline bool isBlockPlanterItem() const{
        bool (BlockPlanterItem::*rv)() const;
        *((void**)&rv) = dlsym("?isBlockPlanterItem@BlockPlanterItem@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool _calculatePlacePos(class ItemStackBase& a0, class Actor& a1, unsigned char& a2, class BlockPos& a3) const{
        bool (BlockPlanterItem::*rv)(class ItemStackBase&, class Actor&, unsigned char&, class BlockPos&) const;
        *((void**)&rv) = dlsym("?_calculatePlacePos@BlockPlanterItem@@MEBA_NAEAVItemStackBase@@AEAVActor@@AEAEAEAVBlockPos@@@Z");
    ...
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (BlockPlanterItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@BlockPlanterItem@@MEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
