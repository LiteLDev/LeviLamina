...
public:
    ...
    inline void fireEventStoreLocalizationBinaryFetchResponse(bool a0, bool a1){
        void (MinecraftEventing::*rv)(bool, bool);
        *((void**)&rv) = dlsym("?fireEventStoreLocalizationBinaryFetchResponse@MinecraftEventing@@UEAAX_N0@Z");
