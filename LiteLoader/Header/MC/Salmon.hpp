...
#include <Global.h>
#include "Fish.hpp"
#define EXTRA_INCLUDE_PART_SALMON
#include "Extra/SalmonAPI.hpp"
#undef EXTRA_INCLUDE_PART_SALMON
...
public:
    MCAPI Salmon(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class OwnerPtrT<struct EntityRefTraits> const&);
};