...
#define EXTRA_INCLUDE_PART_OCEANMONUMENTPENTHOUSE
#include "Extra/OceanMonumentPenthouseAPI.hpp"
#undef EXTRA_INCLUDE_PART_OCEANMONUMENTPENTHOUSE
...
public:
    ...
    inline int \/*enum enum StructurePieceType*\/ getType() const{
        int \/*enum enum StructurePieceType*\/ (OceanMonumentPenthouse::*rv)() const;
        *((void**)&rv) = dlsym("?getType@OceanMonumentPenthouse@@UEBA?AW4StructurePieceType@@XZ");
        return (this->*rv)();
    }
    inline bool postProcess(class BlockSource& a0, class Random& a1, class BoundingBox const& a2){
        bool (OceanMonumentPenthouse::*rv)(class BlockSource&, class Random&, class BoundingBox const&);
        *((void**)&rv) = dlsym("?postProcess@OceanMonumentPenthouse@@UEAA_NAEAVBlockSource@@AEAVRandom@@AEBVBoundingBox@@@Z");
    ...
    inline void postProcessMobsAt(class BlockSource& a0, class Random& a1, class BoundingBox const& a2){
        void (OceanMonumentPenthouse::*rv)(class BlockSource&, class Random&, class BoundingBox const&);
        *((void**)&rv) = dlsym("?postProcessMobsAt@OceanMonumentPenthouse@@UEAAXAEAVBlockSource@@AEAVRandom@@AEBVBoundingBox@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class Random&>(a1), std::forward<class BoundingBox const&>(a2));
    }
    */
