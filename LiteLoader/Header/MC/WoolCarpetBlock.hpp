...
#define EXTRA_INCLUDE_PART_WOOLCARPETBLOCK
#include "Extra/WoolCarpetBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_WOOLCARPETBLOCK
...
public:
    ...
    inline class mce::Color getMapColor(class BlockSource& a0, class BlockPos const& a1) const{
        class mce::Color (WoolCarpetBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getMapColor@WoolCarpetBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (WoolCarpetBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@WoolCarpetBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (WoolCarpetBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@WoolCarpetBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline bool isAuxValueRelevantForPicking() const{
        bool (WoolCarpetBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@WoolCarpetBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    */
