...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_GOATHORNITEM
#include "Extra/GoatHornItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_GOATHORNITEM
...
public:
    ...
    inline bool canBeCharged() const{
        bool (GoatHornItem::*rv)() const;
        *((void**)&rv) = dlsym("?canBeCharged@GoatHornItem@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline class ItemStack& use(class ItemStack& a0, class Player& a1) const{
        class ItemStack& (GoatHornItem::*rv)(class ItemStack&, class Player&) const;
        *((void**)&rv) = dlsym("?use@GoatHornItem@@UEBAAEAVItemStack@@AEAV2@AEAVPlayer@@@Z");
    ...
    inline int \/*enum enum ItemUseMethod*\/ useTimeDepleted(class ItemStack& a0, class Level* a1, class Player* a2) const{
        int \/*enum enum ItemUseMethod*\/ (GoatHornItem::*rv)(class ItemStack&, class Level*, class Player*) const;
        *((void**)&rv) = dlsym("?useTimeDepleted@GoatHornItem@@UEBA?AW4ItemUseMethod@@AEAVItemStack@@PEAVLevel@@PEAVPlayer@@@Z");
