...
public:
    ...
    inline bool canBeSilkTouched() const{
        ...
        *((void**)&rv) = dlsym("?canBeSilkTouched@MysteriousFrameSlot@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool canBeOriginalSurface() const{
        bool (MysteriousFrameSlot::*rv)() const;
        *((void**)&rv) = dlsym("?canBeOriginalSurface@MysteriousFrameSlot@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (MysteriousFrameSlot::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@MysteriousFrameSlot@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
