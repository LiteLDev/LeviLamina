...
#define EXTRA_INCLUDE_PART_HONEYBLOCK
#include "Extra/HoneyBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_HONEYBLOCK
...
public:
    ...
    /*109*/ virtual void onFallOn(class BlockSource&, class BlockPos const&, class Actor&, float) const;
    ...
    inline int getExtraRenderLayers() const{
        int (HoneyBlock::*rv)() const;
        *((void**)&rv) = dlsym("?getExtraRenderLayers@HoneyBlock@@UEBAHXZ");
        return (this->*rv)();
    }
    inline void entityInside(class BlockSource& a0, class BlockPos const& a1, class Actor& a2) const{
        void (HoneyBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor&) const;
        *((void**)&rv) = dlsym("?entityInside@HoneyBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVActor@@@Z");
    ...
    inline bool getCollisionShape(class AABB& a0, class Block const& a1, class BlockSource const& a2, class BlockPos const& a3, class optional_ref<struct IActorMovementProxy> a4) const{
        bool (HoneyBlock::*rv)(class AABB&, class Block const&, class BlockSource const&, class BlockPos const&, class optional_ref<struct IActorMovementProxy>) const;
        *((void**)&rv) = dlsym("?getCollisionShape@HoneyBlock@@UEBA_NAEAVAABB@@AEBVBlock@@AEBVBlockSource@@AEBVBlockPos@@V?$optional_ref@UIActorMovementProxy@@@@@Z");
    ...
    inline class AABB const& getVisualShape(class Block const& a0, class AABB& a1, bool a2) const{
        class AABB const& (HoneyBlock::*rv)(class Block const&, class AABB&, bool) const;
        *((void**)&rv) = dlsym("?getVisualShape@HoneyBlock@@UEBAAEBVAABB@@AEBVBlock@@AEAV2@_N@Z");
    ...
    inline void onFallOn(class BlockSource& a0, class BlockPos const& a1, class Actor& a2, float a3) const{
        void (HoneyBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor&, float) const;
        *((void**)&rv) = dlsym("?onFallOn@HoneyBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVActor@@M@Z");
    ...
    inline void onStandOn(class Actor& a0, class BlockPos const& a1) const{
        void (HoneyBlock::*rv)(class Actor&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onStandOn@HoneyBlock@@UEBAXAEAVActor@@AEBVBlockPos@@@Z");
