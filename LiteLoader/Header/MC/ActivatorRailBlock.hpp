...
#define EXTRA_INCLUDE_PART_ACTIVATORRAILBLOCK
#include "Extra/ActivatorRailBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_ACTIVATORRAILBLOCK
...
public:
    ...
    inline int getVariant(class Block const& a0) const{
        int (ActivatorRailBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@ActivatorRailBlock@@UEBAHAEBVBlock@@@Z");
    ...
    inline void onRedstoneUpdate(class BlockSource& a0, class BlockPos const& a1, int a2, bool a3) const{
        void (ActivatorRailBlock::*rv)(class BlockSource&, class BlockPos const&, int, bool) const;
        *((void**)&rv) = dlsym("?onRedstoneUpdate@ActivatorRailBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@H_N@Z");
