...
#define EXTRA_INCLUDE_PART_TARGETBLOCK
#include "Extra/TargetBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_TARGETBLOCK
...
public:
    ...
    inline bool shouldConnectToRedstone(class BlockSource& a0, class BlockPos const& a1, int a2) const{
        bool (TargetBlock::*rv)(class BlockSource&, class BlockPos const&, int) const;
        *((void**)&rv) = dlsym("?shouldConnectToRedstone@TargetBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@H@Z");
    ...
    inline bool isSignalSource() const{
        bool (TargetBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isSignalSource@TargetBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline void onPlace(class BlockSource& a0, class BlockPos const& a1) const{
        void (TargetBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onPlace@TargetBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void onProjectileHit(class BlockSource& a0, class BlockPos const& a1, class Actor const& a2) const{
        void (TargetBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor const&) const;
        *((void**)&rv) = dlsym("?onProjectileHit@TargetBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVActor@@@Z");
    ...
    inline void setupRedstoneComponent(class BlockSource& a0, class BlockPos const& a1) const{
        void (TargetBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?setupRedstoneComponent@TargetBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (TargetBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@TargetBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
