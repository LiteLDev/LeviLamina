...
#include "../Global.h"
#include "Enchant.hpp"
#define EXTRA_INCLUDE_PART_SWIMENCHANT
#include "Extra/SwimEnchantAPI.hpp"
#undef EXTRA_INCLUDE_PART_SWIMENCHANT
...
public:
    ...
    inline bool _isValidEnchantmentTypeForCategory(int \/*enum enum Enchant::Type*\/ a0) const{
        bool (SwimEnchant::*rv)(int \/*enum enum Enchant::Type*\/) const;
        *((void**)&rv) = dlsym("?_isValidEnchantmentTypeForCategory@SwimEnchant@@EEBA_NW4Type@Enchant@@@Z");
        return (this->*rv)(std::forward<int \/*enum enum Enchant::Type*\/>(a0));
    }
    inline int getMaxCost(int a0) const{
        int (SwimEnchant::*rv)(int) const;
        *((void**)&rv) = dlsym("?getMaxCost@SwimEnchant@@UEBAHH@Z");
        return (this->*rv)(std::forward<int>(a0));
    }
    inline int getMaxLevel() const{
        int (SwimEnchant::*rv)() const;
        *((void**)&rv) = dlsym("?getMaxLevel@SwimEnchant@@UEBAHXZ");
        return (this->*rv)();
    }
    inline int getMinCost(int a0) const{
        int (SwimEnchant::*rv)(int) const;
        *((void**)&rv) = dlsym("?getMinCost@SwimEnchant@@UEBAHH@Z");
        return (this->*rv)(std::forward<int>(a0));
    }
    */
