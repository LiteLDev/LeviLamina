...
public:
    ...
    inline int \/*enum enum HandlerResult*\/ handleKnockBack(struct KnockBackEvent const& a0){
        int \/*enum enum HandlerResult*\/ (ScriptActorGameplayHandler::*rv)(struct KnockBackEvent const&);
    ...
    inline int \/*enum enum HandlerResult*\/ handleActorRemoveEffect(struct ActorRemoveEffectEvent const& a0){
        int \/*enum enum HandlerResult*\/ (ScriptActorGameplayHandler::*rv)(struct ActorRemoveEffectEvent const&);
    ...
    inline int \/*enum enum HandlerResult*\/ handleActorUseItem(struct ActorUseItemEvent const& a0){
        int \/*enum enum HandlerResult*\/ (ScriptActorGameplayHandler::*rv)(struct ActorUseItemEvent const&);
    ...
    inline int \/*enum enum HandlerResult*\/ handleActorAcquiredItem(struct ActorAcquiredItemEvent const& a0){
        int \/*enum enum HandlerResult*\/ (ScriptActorGameplayHandler::*rv)(struct ActorAcquiredItemEvent const&);
    ...
    inline int \/*enum enum HandlerResult*\/ handleActorHurt(struct ActorHurtEvent const& a0){
        int \/*enum enum HandlerResult*\/ (ScriptActorGameplayHandler::*rv)(struct ActorHurtEvent const&);
    ...
    inline struct GameplayHandlerResult<int \/*enum enum CoordinatorResult*\/> handleActorGriefingBlock(struct ActorGriefingBlockEvent const& a0){
        struct GameplayHandlerResult<int \/*enum enum CoordinatorResult*\/> (ScriptActorGameplayHandler::*rv)(struct ActorGriefingBlockEvent const&);
    ...
    inline struct GameplayHandlerResult<int \/*enum enum CoordinatorResult*\/> handleProjectileHit(struct ProjectileHitEvent const& a0){
        struct GameplayHandlerResult<int \/*enum enum CoordinatorResult*\/> (ScriptActorGameplayHandler::*rv)(struct ProjectileHitEvent const&);
