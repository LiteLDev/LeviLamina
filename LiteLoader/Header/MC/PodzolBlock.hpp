...
#define EXTRA_INCLUDE_PART_PODZOLBLOCK
#include "Extra/PodzolBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_PODZOLBLOCK
...
public:
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (PodzolBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@PodzolBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (PodzolBlock::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@PodzolBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
