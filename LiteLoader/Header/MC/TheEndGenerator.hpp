...
public:
    ...
    inline class std::optional<short> getPreliminarySurfaceLevel(class DividedPos2d<4> a0) const{
        class std::optional<short> (TheEndGenerator::*rv)(class DividedPos2d<4>) const;
        *((void**)&rv) = dlsym("?getPreliminarySurfaceLevel@TheEndGenerator@@UEBA?AV?$optional@F@std@@V?$DividedPos2d@$03@@@Z");
