...
public:
    ...
    /*119*/ virtual class mce::Color getDustColor(class Block const&) const;
    /*120*/ virtual std::string getDustParticleName(class Block const&) const;
    /*121*/ virtual void __unk_vfn_64();
    /*122*/ virtual void onLand(class BlockSource&, class BlockPos const&) const;
    /*
    ...
    inline bool onFertilized(class BlockSource& a0, class BlockPos const& a1, class Actor* a2, enum FertilizerType a3) const{
        bool (SandBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor*, enum FertilizerType) const;
