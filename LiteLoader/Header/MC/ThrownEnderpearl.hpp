...
public:
    ...
    inline void reloadHardcoded(int \/*enum enum Actor::InitializationMethod*\/ a0, class VariantParameterList const& a1){
        void (ThrownEnderpearl::*rv)(int \/*enum enum Actor::InitializationMethod*\/, class VariantParameterList const&);
        *((void**)&rv) = dlsym("?reloadHardcoded@ThrownEnderpearl@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z");
