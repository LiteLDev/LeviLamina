...
public:
    ...
    /*117*/ virtual class mce::Color getDustColor(class Block const&) const = 0;
    /*118*/ virtual std::string getDustParticleName(class Block const&) const = 0;
    /*119*/ virtual void __unk_vfn_63();
    /*120*/ virtual void onLand(class BlockSource&, class BlockPos const&) const;
    /*121*/ virtual bool isFreeToFall(class BlockSource&, class BlockPos const&) const;
    /*122*/ virtual void startFalling(class BlockSource&, class BlockPos const&, class Block const&, bool) const;
    /*
