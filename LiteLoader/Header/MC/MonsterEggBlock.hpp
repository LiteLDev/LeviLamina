...
public:
    ...
    inline bool isAuxValueRelevantForPicking() const{
        bool (MonsterEggBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@MonsterEggBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (MonsterEggBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@MonsterEggBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline int getVariant(class Block const& a0) const{
        int (MonsterEggBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@MonsterEggBlock@@UEBAHAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline class Block const* tryGetUninfested(class Block const& a0) const{
        class Block const* (MonsterEggBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?tryGetUninfested@MonsterEggBlock@@UEBAPEBVBlock@@AEBV2@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    */
