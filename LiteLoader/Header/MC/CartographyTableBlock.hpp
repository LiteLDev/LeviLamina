...
#define EXTRA_INCLUDE_PART_CARTOGRAPHYTABLEBLOCK
#include "Extra/CartographyTableBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_CARTOGRAPHYTABLEBLOCK
...
public:
    ...
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (CartographyTableBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@CartographyTableBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
