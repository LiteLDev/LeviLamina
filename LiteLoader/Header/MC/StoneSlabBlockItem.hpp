...
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_STONESLABBLOCKITEM
#include "Extra/StoneSlabBlockItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_STONESLABBLOCKITEM
...
public:
    ...
    inline int getLevelDataForAuxValue(int a0) const{
        int (StoneSlabBlockItem::*rv)(int) const;
        *((void**)&rv) = dlsym("?getLevelDataForAuxValue@StoneSlabBlockItem@@UEBAHH@Z");
