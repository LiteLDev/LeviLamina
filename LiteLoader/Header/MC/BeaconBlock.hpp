...
#define EXTRA_INCLUDE_PART_BEACONBLOCK
#include "Extra/BeaconBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_BEACONBLOCK
...
public:
    ...
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (BeaconBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@BeaconBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
        return (this->*rv)(std::forward<class Player&>(a0), std::forward<class BlockPos const&>(a1), std::forward<unsigned char>(a2));
    }
    inline bool isInteractiveBlock() const{
        bool (BeaconBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isInteractiveBlock@BeaconBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool canContainLiquid() const{
        bool (BeaconBlock::*rv)() const;
        *((void**)&rv) = dlsym("?canContainLiquid@BeaconBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    */
