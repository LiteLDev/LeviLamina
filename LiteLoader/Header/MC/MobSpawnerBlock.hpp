...
#define EXTRA_INCLUDE_PART_MOBSPAWNERBLOCK
#include "Extra/MobSpawnerBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_MOBSPAWNERBLOCK
...
public:
    ...
    inline bool canProvideSupport(class Block const& a0, unsigned char a1, int \/*enum enum BlockSupportType*\/ a2) const{
        bool (MobSpawnerBlock::*rv)(class Block const&, unsigned char, int \/*enum enum BlockSupportType*\/) const;
        *((void**)&rv) = dlsym("?canProvideSupport@MobSpawnerBlock@@UEBA_NAEBVBlock@@EW4BlockSupportType@@@Z");
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (MobSpawnerBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@MobSpawnerBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline bool canContainLiquid() const{
        ...
        *((void**)&rv) = dlsym("?canContainLiquid@MobSpawnerBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    ...
    inline int getExperienceDrop(class Random& a0) const{
        int (MobSpawnerBlock::*rv)(class Random&) const;
        *((void**)&rv) = dlsym("?getExperienceDrop@MobSpawnerBlock@@UEBAHAEAVRandom@@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (MobSpawnerBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@MobSpawnerBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
        return (this->*rv)(std::forward<class Randomize&>(a0), std::forward<class Block const&>(a1), std::forward<int>(a2));
    }
    */
