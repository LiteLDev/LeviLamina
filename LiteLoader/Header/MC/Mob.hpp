...
public:
    ...
    /*17*/ virtual void lerpMotion(class Vec3 const&);
    /*18*/ virtual void normalTick();
    /*19*/ virtual void baseTick();
    /*20*/ virtual void vehicleTick();
    /*21*/ virtual float getRidingHeight();
    /*22*/ virtual bool startRiding(class Actor&);
    /*23*/ virtual void addPassenger(class Actor&);
    /*24*/ virtual void __unk_vfn_3();
    /*25*/ virtual void __unk_vfn_4();
    /*26*/ virtual float getCameraOffset() const;
    /*27*/ virtual void __unk_vfn_5();
    /*28*/ virtual void __unk_vfn_6();
    /*29*/ virtual void playerTouch(class Player&);
    /*30*/ virtual bool isImmobile() const;
    /*31*/ virtual bool isPickable();
    /*32*/ virtual void __unk_vfn_7();
    /*33*/ virtual bool isSleeping() const;
    /*34*/ virtual void setSleeping(bool);
    /*35*/ virtual void __unk_vfn_8();
    /*36*/ virtual bool isBlocking() const;
    /*37*/ virtual void __unk_vfn_9();
    /*38*/ virtual bool isAlive() const;
    /*39*/ virtual void __unk_vfn_10();
    /*40*/ virtual bool isSurfaceMob() const;
    /*41*/ virtual void __unk_vfn_11();
    /*42*/ virtual void __unk_vfn_12();
    /*43*/ virtual void __unk_vfn_13();
    /*44*/ virtual void setTarget(class Actor*);
    /*45*/ virtual class Actor* findAttackTarget();
    /*46*/ virtual void __unk_vfn_14();
    /*47*/ virtual bool attack(class Actor&, enum ActorDamageCause const&);
    /*48*/ virtual void adjustDamageAmount(int&) const;
    /*49*/ virtual void onTame();
    /*50*/ virtual void onFailedTame();
    /*51*/ virtual bool canPowerJump() const;
    /*52*/ virtual bool isJumping() const;
    /*53*/ virtual void vehicleLanded(class Vec3 const&, class Vec3 const&);
    /*54*/ virtual enum ActorDamageCause getBlockDamageCause(class Block const&) const;
    /*55*/ virtual void actuallyHurt(int, class ActorDamageSource const&, bool);
    /*56*/ virtual void animateHurt();
    /*57*/ virtual bool doFireHurt(int);
    /*58*/ virtual void onBounceStarted(class BlockPos const&, class Block const&);
    /*59*/ virtual void handleEntityEvent(enum ActorEvent, int);
    /*60*/ virtual float getPickRadius();
    /*61*/ virtual void awardKillScore(class Actor&, int);
    /*62*/ virtual enum ArmorMaterialType getArmorMaterialTypeInSlot(enum ArmorSlot) const;
    /*63*/ virtual enum ArmorTextureType getArmorMaterialTextureTypeInSlot(enum ArmorSlot) const;
    /*64*/ virtual float getArmorColorInSlot(enum ArmorSlot, int) const;
    /*65*/ virtual void setEquippedSlot(enum EquipmentSlot, class ItemStack const&);
    /*66*/ virtual class HashedString const& queryEntityRenderer() const;
    /*67*/ virtual struct ActorUniqueID getSourceUniqueID() const;
    /*68*/ virtual bool canFreeze() const;
    /*69*/ virtual int getPortalWaitTime() const;
    /*70*/ virtual void __unk_vfn_15();
    /*71*/ virtual void __unk_vfn_16();
    /*72*/ virtual struct ActorUniqueID getControllingPlayer() const;
    /*73*/ virtual void causeFallDamage(float, float, class ActorDamageSource);
    /*74*/ virtual void __unk_vfn_17();
    /*75*/ virtual void __unk_vfn_18();
    /*76*/ virtual bool inCaravan() const;
    /*77*/ virtual void __unk_vfn_19();
    /*78*/ virtual void __unk_vfn_20();
    /*79*/ virtual void stopRiding(bool, bool, bool);
    /*80*/ virtual void buildDebugInfo(std::string&) const;
    /*81*/ virtual int getDeathTime() const;
    /*82*/ virtual void swing();
    /*83*/ virtual void __unk_vfn_21();
    /*84*/ virtual void __unk_vfn_22();
    /*85*/ virtual float getYHeadRot() const;
    /*86*/ virtual void __unk_vfn_23();
    /*87*/ virtual void __unk_vfn_24();
    /*88*/ virtual void __unk_vfn_25();
    /*89*/ virtual void __unk_vfn_26();
    /*90*/ virtual void setAuxValue(int);
    /*91*/ virtual void stopSpinAttack();
    /*92*/ virtual void __unk_vfn_27();
    /*93*/ virtual void __unk_vfn_28();
    /*94*/ virtual void kill();
    /*95*/ virtual void die(class ActorDamageSource const&);
    /*96*/ virtual bool shouldDropDeathLoot() const;
    /*97*/ virtual void updateEntitySpecificMolangVariables(class RenderParams&);
    /*98*/ virtual void __unk_vfn_29();
    /*99*/ virtual bool _hurt(class ActorDamageSource const&, int, bool, bool);
    /*100*/ virtual void readAdditionalSaveData(class CompoundTag const&, class DataLoadHelper&);
    /*101*/ virtual void addAdditionalSaveData(class CompoundTag&);
    /*102*/ virtual void _playStepSound(class BlockPos const&, class Block const&);
    /*103*/ virtual void __unk_vfn_30();
    /*104*/ virtual void _removePassenger(struct ActorUniqueID const&, bool, bool, bool);
    /*105*/ virtual void _onSizeUpdated();
    /*106*/ virtual void __unk_vfn_31();
    /*107*/ virtual void knockback(class Actor*, int, float, float, float, float, float);
    /*108*/ virtual void spawnAnim();
    /*109*/ virtual void setSprinting(bool);
    /*110*/ virtual enum LevelSoundEvent getHurtSound();
    /*111*/ virtual enum LevelSoundEvent getDeathSound();
    /*112*/ virtual struct TextureUVCoordinateSet const* getItemInHandIcon(class ItemStack const&, int);
    /*113*/ virtual float getSpeed() const;
    /*114*/ virtual void setSpeed(float);
    /*115*/ virtual float getJumpPower() const;
    /*116*/ virtual bool hurtEffects(class ActorDamageSource const&, int, bool, bool);
    /*117*/ virtual int getMeleeWeaponDamageBonus(class Mob*);
    /*118*/ virtual int getMeleeKnockbackBonus();
    /*119*/ virtual void travel(float, float, float);
    /*120*/ virtual void travel(struct IMobMovementProxy&, float, float, float) const;
    /*121*/ virtual void applyFinalFriction(float, bool);
