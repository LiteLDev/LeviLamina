...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_BANNERPATTERNITEM
#include "Extra/BannerPatternItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_BANNERPATTERNITEM
...
public:
    ...
    inline void appendFormattedHovertext(class ItemStackBase const& a0, class Level& a1, std::string& a2, bool a3) const{
        void (BannerPatternItem::*rv)(class ItemStackBase const&, class Level&, std::string&, bool) const;
        *((void**)&rv) = dlsym("?appendFormattedHovertext@BannerPatternItem@@UEBAXAEBVItemStackBase@@AEAVLevel@@AEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_N@Z");
    ...
    inline std::string buildDescriptionId(class ItemDescriptor const& a0, class CompoundTag const* a1) const{
        std::string (BannerPatternItem::*rv)(class ItemDescriptor const&, class CompoundTag const*) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@BannerPatternItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z");
    ...
    inline int getPatternIndex() const{
        int (BannerPatternItem::*rv)() const;
        *((void**)&rv) = dlsym("?getPatternIndex@BannerPatternItem@@UEBAHXZ");
        return (this->*rv)();
    }
    */
