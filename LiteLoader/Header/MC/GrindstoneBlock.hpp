...
#define EXTRA_INCLUDE_PART_GRINDSTONEBLOCK
#include "Extra/GrindstoneBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_GRINDSTONEBLOCK
...
public:
    ...
    inline bool canContainLiquid() const{
        ...
        *((void**)&rv) = dlsym("?canContainLiquid@GrindstoneBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (GrindstoneBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@GrindstoneBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
    ...
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (GrindstoneBlock::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@GrindstoneBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (GrindstoneBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@GrindstoneBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (GrindstoneBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@GrindstoneBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline bool canSurvive(class BlockSource& a0, class BlockPos const& a1) const{
        bool (GrindstoneBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?canSurvive@GrindstoneBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
    ...
    inline class AABB const& getAABB(class BlockSource const& a0, class BlockPos const& a1, class Block const& a2, class AABB& a3, bool a4) const{
        class AABB const& (GrindstoneBlock::*rv)(class BlockSource const&, class BlockPos const&, class Block const&, class AABB&, bool) const;
        *((void**)&rv) = dlsym("?getAABB@GrindstoneBlock@@UEBAAEBVAABB@@AEBVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z");
    ...
    inline class Block const& getPlacementBlock(class Actor& a0, class BlockPos const& a1, unsigned char a2, class Vec3 const& a3, int a4) const{
        class Block const& (GrindstoneBlock::*rv)(class Actor&, class BlockPos const&, unsigned char, class Vec3 const&, int) const;
        *((void**)&rv) = dlsym("?getPlacementBlock@GrindstoneBlock@@UEBAAEBVBlock@@AEAVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z");
    ...
    inline class AABB const& getVisualShape(class Block const& a0, class AABB& a1, bool a2) const{
        class AABB const& (GrindstoneBlock::*rv)(class Block const&, class AABB&, bool) const;
        *((void**)&rv) = dlsym("?getVisualShape@GrindstoneBlock@@UEBAAEBVAABB@@AEBVBlock@@AEAV2@_N@Z");
    ...
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (GrindstoneBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@GrindstoneBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
