...
#include "Actor.hpp"
#define EXTRA_INCLUDE_PART_LARGEFIREBALL
#include "Extra/LargeFireballAPI.hpp"
#undef EXTRA_INCLUDE_PART_LARGEFIREBALL
...
public:
    ...
    /*76*/ virtual int /*enum enum ParticleType*/ getTrailParticle();
