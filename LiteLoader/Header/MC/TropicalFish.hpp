...
public:
    ...
    inline bool createAIGoals(){
        bool (TropicalFish::*rv)();
        *((void**)&rv) = dlsym("?createAIGoals@TropicalFish@@UEAA_NXZ");
        return (this->*rv)();
    }
    inline void initializeComponents(int \/*enum enum Actor::InitializationMethod*\/ a0, class VariantParameterList const& a1){
        void (TropicalFish::*rv)(int \/*enum enum Actor::InitializationMethod*\/, class VariantParameterList const&);
        *((void**)&rv) = dlsym("?initializeComponents@TropicalFish@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z");
        return (this->*rv)(std::forward<int \/*enum enum Actor::InitializationMethod*\/>(a0), std::forward<class VariantParameterList const&>(a1));
    }
    inline void normalTick(){
        void (TropicalFish::*rv)();
        *((void**)&rv) = dlsym("?normalTick@TropicalFish@@UEAAXXZ");
        return (this->*rv)();
    }
    inline void updateEntitySpecificMolangVariables(class RenderParams& a0){
        void (TropicalFish::*rv)(class RenderParams&);
        *((void**)&rv) = dlsym("?updateEntitySpecificMolangVariables@TropicalFish@@UEAAXAEAVRenderParams@@@Z");
