...
public:
    ...
    /*65*/ virtual void fixupCommon(class ItemStackBase&) const;
    ...
    inline void fixupCommon(class ItemStackBase& a0) const{
        void (ChemistryItem::*rv)(class ItemStackBase&) const;
        *((void**)&rv) = dlsym("?fixupCommon@ChemistryItem@@UEBAXAEAVItemStackBase@@@Z");
