...
#define EXTRA_INCLUDE_PART_DEEPSLATEOREBLOCK
#include "Extra/DeepslateOreBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_DEEPSLATEOREBLOCK
...
public:
    ...
    inline bool canBeOriginalSurface() const{
        bool (DeepslateOreBlock::*rv)() const;
        *((void**)&rv) = dlsym("?canBeOriginalSurface@DeepslateOreBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline int getExperienceDrop(class Random& a0) const{
        int (DeepslateOreBlock::*rv)(class Random&) const;
        *((void**)&rv) = dlsym("?getExperienceDrop@DeepslateOreBlock@@UEBAHAEAVRandom@@@Z");
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (DeepslateOreBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@DeepslateOreBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (DeepslateOreBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@DeepslateOreBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
        return (this->*rv)(std::forward<class Randomize&>(a0), std::forward<class Block const&>(a1), std::forward<int>(a2));
    }
    inline void spawnResources(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, class Randomize& a3, std::vector<class Item const*>* a4, float a5, int a6) const{
        void (DeepslateOreBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, class Randomize&, std::vector<class Item const*>*, float, int) const;
        *((void**)&rv) = dlsym("?spawnResources@DeepslateOreBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@PEAV?$vector@PEBVItem@@V?$allocator@PEBVItem@@@std@@@std@@MH@Z");
