...
public:
    ...
    inline bool isAuxValueRelevantForPicking() const{
        bool (SandStoneBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@SandStoneBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool canBeOriginalSurface() const{
        bool (SandStoneBlock::*rv)() const;
        *((void**)&rv) = dlsym("?canBeOriginalSurface@SandStoneBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (SandStoneBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@SandStoneBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (SandStoneBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@SandStoneBlock@@MEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (SandStoneBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@SandStoneBlock@@MEBA?AVItemInstance@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    */
