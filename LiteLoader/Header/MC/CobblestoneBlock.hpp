...
#define EXTRA_INCLUDE_PART_COBBLESTONEBLOCK
#include "Extra/CobblestoneBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_COBBLESTONEBLOCK
...
public:
    ...
    inline class Block const* tryGetInfested(class Block const& a0) const{
        class Block const* (CobblestoneBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?tryGetInfested@CobblestoneBlock@@UEBAPEBVBlock@@AEBV2@@Z");
