...
#define EXTRA_INCLUDE_PART_INFESTEDDEEPSLATEBLOCK
#include "Extra/InfestedDeepslateBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_INFESTEDDEEPSLATEBLOCK
...
public:
    ...
    inline class Block const* tryGetUninfested(class Block const& a0) const{
        class Block const* (InfestedDeepslateBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?tryGetUninfested@InfestedDeepslateBlock@@UEBAPEBVBlock@@AEBV2@@Z");
