...
#define EXTRA_INCLUDE_PART_LOGBLOCK
#include "Extra/LogBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_LOGBLOCK
...
public:
    ...
    inline bool isAuxValueRelevantForPicking() const{
        bool (LogBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@LogBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (LogBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@LogBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline void onRemove(class BlockSource& a0, class BlockPos const& a1) const{
        void (LogBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onRemove@LogBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
