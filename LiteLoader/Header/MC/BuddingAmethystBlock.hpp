...
#define EXTRA_INCLUDE_PART_BUDDINGAMETHYSTBLOCK
#include "Extra/BuddingAmethystBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_BUDDINGAMETHYSTBLOCK
...
public:
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (BuddingAmethystBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@BuddingAmethystBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline void randomTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (BuddingAmethystBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?randomTick@BuddingAmethystBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
