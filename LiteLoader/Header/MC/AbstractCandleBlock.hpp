...
public:
    ...
    /*116*/ virtual struct Brightness getLightEmission(class Block const&) const;
    ...
    /*120*/ virtual int _getNumCandles(class Block const&) const;
    /*121*/ virtual void _iterateCandles(class Block const&, class BlockPos const&, class std::function<void (class Vec3 const& , int)>) const;
    /*122*/ virtual void _tryLightOnFire(class BlockSource&, class BlockPos const&) const;
    /*
