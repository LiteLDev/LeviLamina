...
public:
    ...
    inline void _tryLightOnFire(class BlockSource& a0, class BlockPos const& a1) const{
        void (AbstractCandleBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?_tryLightOnFire@AbstractCandleBlock@@MEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
    ...
    inline bool isWaterBlocking() const{
        bool (AbstractCandleBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isWaterBlocking@AbstractCandleBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool canContainLiquid() const{
        bool (AbstractCandleBlock::*rv)() const;
        *((void**)&rv) = dlsym("?canContainLiquid@AbstractCandleBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    ...
    inline void _iterateCandles(class Block const& a0, class BlockPos const& a1, class std::function<void (class Vec3 const&, int)> a2) const{
        void (AbstractCandleBlock::*rv)(class Block const&, class BlockPos const&, class std::function<void (class Vec3 const&, int)>) const;
        *((void**)&rv) = dlsym("?_iterateCandles@AbstractCandleBlock@@MEBAXAEBVBlock@@AEBVBlockPos@@V?$function@$$A6AXAEBVVec3@@H@Z@std@@@Z");
    ...
    inline void animateTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (AbstractCandleBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?animateTick@AbstractCandleBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline void entityInside(class BlockSource& a0, class BlockPos const& a1, class Actor& a2) const{
        void (AbstractCandleBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor&) const;
        *((void**)&rv) = dlsym("?entityInside@AbstractCandleBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVActor@@@Z");
    ...
    inline struct Brightness getLightEmission(class Block const& a0) const{
        struct Brightness (AbstractCandleBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getLightEmission@AbstractCandleBlock@@UEBA?AUBrightness@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (AbstractCandleBlock::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@AbstractCandleBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
    ...
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (AbstractCandleBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@AbstractCandleBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1), std::forward<class Random&>(a2));
    }
    */
