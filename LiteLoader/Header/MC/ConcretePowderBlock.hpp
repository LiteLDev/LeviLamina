...
#define EXTRA_INCLUDE_PART_CONCRETEPOWDERBLOCK
#include "Extra/ConcretePowderBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_CONCRETEPOWDERBLOCK
...
public:
    ...
    /*77*/ virtual bool shouldStopFalling(class Actor&) const;
    ...
    inline bool isAuxValueRelevantForPicking() const{
        bool (ConcretePowderBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@ConcretePowderBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool isValidAuxValue(int a0) const{
        bool (ConcretePowderBlock::*rv)(int) const;
        *((void**)&rv) = dlsym("?isValidAuxValue@ConcretePowderBlock@@UEBA_NH@Z");
        return (this->*rv)(std::forward<int>(a0));
    }
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (ConcretePowderBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@ConcretePowderBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (ConcretePowderBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@ConcretePowderBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
    ...
    inline class mce::Color getMapColor(class BlockSource& a0, class BlockPos const& a1) const{
        class mce::Color (ConcretePowderBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getMapColor@ConcretePowderBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (ConcretePowderBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@ConcretePowderBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    ...
    inline std::string getDustParticleName(class Block const& a0) const{
        std::string (ConcretePowderBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getDustParticleName@ConcretePowderBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (ConcretePowderBlock::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@ConcretePowderBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
    ...
    inline void onPlace(class BlockSource& a0, class BlockPos const& a1) const{
        void (ConcretePowderBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onPlace@ConcretePowderBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline bool shouldStopFalling(class Actor& a0) const{
        bool (ConcretePowderBlock::*rv)(class Actor&) const;
        *((void**)&rv) = dlsym("?shouldStopFalling@ConcretePowderBlock@@UEBA_NAEAVActor@@@Z");
