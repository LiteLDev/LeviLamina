...
public:
    ...
    /*203*/ virtual int getTurnOnDelay(class Block const&) const;
    /*204*/ virtual class Block const* getOnBlock(class Block const*) const;
    /*205*/ virtual class Block const* getOffBlock(class Block const*) const;
