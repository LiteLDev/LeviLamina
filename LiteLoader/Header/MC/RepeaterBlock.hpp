...
public:
    ...
    /*117*/ virtual bool isLocked(class BlockSource&, class BlockPos const&) const;
    /*118*/ virtual bool isAlternateInput(class Block const&) const;
    /*119*/ virtual int getOutputSignal(class Block const&) const;
    /*120*/ virtual int getTurnOnDelay(class Block const&) const;
    /*121*/ virtual class Block const* getOnBlock(class Block const*) const;
    /*122*/ virtual class Block const* getOffBlock(class Block const*) const;
    /*
