...
public:
    ...
    /*208*/ virtual int getTurnOnDelay(class Block const&) const;
    /*209*/ virtual class Block const* getOnBlock(class Block const*) const;
    /*210*/ virtual class Block const* getOffBlock(class Block const*) const;
    /*
