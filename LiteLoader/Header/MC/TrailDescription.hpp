...
public:
    ...
    inline void deserializeData(struct DeserializeDataParams a0){
        void (TrailDescription::*rv)(struct DeserializeDataParams);
        *((void**)&rv) = dlsym("?deserializeData@TrailDescription@@UEAAXUDeserializeDataParams@@@Z");
        return (this->*rv)(std::forward<struct DeserializeDataParams>(a0));
    }
    inline char const* getJsonName() const{
        char const* (TrailDescription::*rv)() const;
        *((void**)&rv) = dlsym("?getJsonName@TrailDescription@@UEBAPEBDXZ");
        return (this->*rv)();
    }
    inline void serializeData(class Json::Value& a0) const{
        void (TrailDescription::*rv)(class Json::Value&) const;
        *((void**)&rv) = dlsym("?serializeData@TrailDescription@@UEBAXAEAVValue@Json@@@Z");
