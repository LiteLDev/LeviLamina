...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_ICEBOMBITEM
#include "Extra/IceBombItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_ICEBOMBITEM
...
public:
    ...
    /*67*/ virtual class HashedString const& getCooldownType() const;
    /*68*/ virtual int getCooldownTime() const;
    ...
    inline int getCooldownTime() const{
        int (IceBombItem::*rv)() const;
        *((void**)&rv) = dlsym("?getCooldownTime@IceBombItem@@UEBAHXZ");
        return (this->*rv)();
    }
    inline bool dispense(class BlockSource& a0, class Container& a1, int a2, class Vec3 const& a3, unsigned char a4) const{
        bool (IceBombItem::*rv)(class BlockSource&, class Container&, int, class Vec3 const&, unsigned char) const;
        *((void**)&rv) = dlsym("?dispense@IceBombItem@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z");
    ...
    inline class HashedString const& getCooldownType() const{
        class HashedString const& (IceBombItem::*rv)() const;
        *((void**)&rv) = dlsym("?getCooldownType@IceBombItem@@UEBAAEBVHashedString@@XZ");
        return (this->*rv)();
    }
    inline bool isThrowable() const{
        bool (IceBombItem::*rv)() const;
        *((void**)&rv) = dlsym("?isThrowable@IceBombItem@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline class ItemStack& use(class ItemStack& a0, class Player& a1) const{
        class ItemStack& (IceBombItem::*rv)(class ItemStack&, class Player&) const;
        *((void**)&rv) = dlsym("?use@IceBombItem@@UEBAAEAVItemStack@@AEAV2@AEAVPlayer@@@Z");
