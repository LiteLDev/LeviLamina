...
#define EXTRA_INCLUDE_PART_GLAZEDTERRACOTTABLOCK
#include "Extra/GlazedTerracottaBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_GLAZEDTERRACOTTABLOCK
...
public:
    ...
    inline bool isValidAuxValue(int a0) const{
        bool (GlazedTerracottaBlock::*rv)(int) const;
        *((void**)&rv) = dlsym("?isValidAuxValue@GlazedTerracottaBlock@@UEBA_NH@Z");
    ...
    inline class Block const& getPlacementBlock(class Actor& a0, class BlockPos const& a1, unsigned char a2, class Vec3 const& a3, int a4) const{
        class Block const& (GlazedTerracottaBlock::*rv)(class Actor&, class BlockPos const&, unsigned char, class Vec3 const&, int) const;
        *((void**)&rv) = dlsym("?getPlacementBlock@GlazedTerracottaBlock@@UEBAAEBVBlock@@AEAVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z");
