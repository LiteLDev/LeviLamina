...
#define EXTRA_INCLUDE_PART_FROSTEDICEBLOCK
#include "Extra/FrostedIceBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_FROSTEDICEBLOCK
...
public:
    ...
    /*61*/ virtual bool breaksFallingBlocks(class Block const&, class BaseGameVersion) const;
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (FrostedIceBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@FrostedIceBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (FrostedIceBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@FrostedIceBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline bool breaksFallingBlocks(class Block const& a0, class BaseGameVersion a1) const{
        bool (FrostedIceBlock::*rv)(class Block const&, class BaseGameVersion) const;
        *((void**)&rv) = dlsym("?breaksFallingBlocks@FrostedIceBlock@@UEBA_NAEBVBlock@@VBaseGameVersion@@@Z");
    ...
    inline void onPlace(class BlockSource& a0, class BlockPos const& a1) const{
        void (FrostedIceBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onPlace@FrostedIceBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void playerDestroy(class Player& a0, class BlockPos const& a1, class Block const& a2) const{
        void (FrostedIceBlock::*rv)(class Player&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?playerDestroy@FrostedIceBlock@@UEBAXAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline bool playerWillDestroy(class Player& a0, class BlockPos const& a1, class Block const& a2) const{
        bool (FrostedIceBlock::*rv)(class Player&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?playerWillDestroy@FrostedIceBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Player&>(a0), std::forward<class BlockPos const&>(a1), std::forward<class Block const&>(a2));
    }
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (FrostedIceBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@FrostedIceBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
