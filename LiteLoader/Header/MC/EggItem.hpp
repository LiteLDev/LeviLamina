...
public:
    ...
    inline bool isThrowable() const{
        bool (EggItem::*rv)() const;
        *((void**)&rv) = dlsym("?isThrowable@EggItem@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool dispense(class BlockSource& a0, class Container& a1, int a2, class Vec3 const& a3, unsigned char a4) const{
        bool (EggItem::*rv)(class BlockSource&, class Container&, int, class Vec3 const&, unsigned char) const;
        *((void**)&rv) = dlsym("?dispense@EggItem@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z");
    ...
    inline class ItemStack& use(class ItemStack& a0, class Player& a1) const{
        class ItemStack& (EggItem::*rv)(class ItemStack&, class Player&) const;
        *((void**)&rv) = dlsym("?use@EggItem@@UEBAAEAVItemStack@@AEAV2@AEAVPlayer@@@Z");
