...
public:
    ...
    inline void execute(class CommandOrigin const& a0, class CommandOutput& a1) const{
        void (WorldBuilderCommand::*rv)(class CommandOrigin const&, class CommandOutput&) const;
        *((void**)&rv) = dlsym("?execute@WorldBuilderCommand@@UEBAXAEBVCommandOrigin@@AEAVCommandOutput@@@Z");
