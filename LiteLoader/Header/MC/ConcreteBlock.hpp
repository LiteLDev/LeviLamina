...
#define EXTRA_INCLUDE_PART_CONCRETEBLOCK
#include "Extra/ConcreteBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_CONCRETEBLOCK
...
public:
    ...
    inline bool isAuxValueRelevantForPicking() const{
        bool (ConcreteBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@ConcreteBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool isValidAuxValue(int a0) const{
        bool (ConcreteBlock::*rv)(int) const;
        *((void**)&rv) = dlsym("?isValidAuxValue@ConcreteBlock@@UEBA_NH@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        ...
        *((void**)&rv) = dlsym("?getResourceItem@ConcreteBlock@@MEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (ConcreteBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@ConcreteBlock@@MEBA?AVItemInstance@@AEBVBlock@@@Z");
    ...
    inline class mce::Color getMapColor(class BlockSource& a0, class BlockPos const& a1) const{
        class mce::Color (ConcreteBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getMapColor@ConcreteBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (ConcreteBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@ConcreteBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    */
