...
public:
    ...
    inline void apply(class ItemInstance& a0, class Random& a1, class LootTableContext& a2){
        void (SetItemDamageFunction::*rv)(class ItemInstance&, class Random&, class LootTableContext&);
        *((void**)&rv) = dlsym("?apply@SetItemDamageFunction@@UEAAXAEAVItemInstance@@AEAVRandom@@AEAVLootTableContext@@@Z");
    ...
    inline void apply(class ItemStack& a0, class Random& a1, class LootTableContext& a2){
        void (SetItemDamageFunction::*rv)(class ItemStack&, class Random&, class LootTableContext&);
        *((void**)&rv) = dlsym("?apply@SetItemDamageFunction@@UEAAXAEAVItemStack@@AEAVRandom@@AEAVLootTableContext@@@Z");
