...
public:
    ...
    inline void buildSchema(class std::shared_ptr<class JsonUtil::JsonSchemaObjectNode<class JsonUtil::EmptyClass, struct BlockComponentGroupDescription> >& a0, class BlockComponentFactory const& a1) const{
        void (BlockBreakOnPushDescription::*rv)(class std::shared_ptr<class JsonUtil::JsonSchemaObjectNode<class JsonUtil::EmptyClass, struct BlockComponentGroupDescription> >&, class BlockComponentFactory const&) const;
        *((void**)&rv) = dlsym("?buildSchema@BlockBreakOnPushDescription@@UEBAXAEAV?$shared_ptr@V?$JsonSchemaObjectNode@VEmptyClass@JsonUtil@@UBlockComponentGroupDescription@@@JsonUtil@@@std@@AEBVBlockComponentFactory@@@Z");
    ...
    inline std::string const& getName() const{
        std::string const& (BlockBreakOnPushDescription::*rv)() const;
        *((void**)&rv) = dlsym("?getName@BlockBreakOnPushDescription@@UEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ");
        return (this->*rv)();
    }
    inline void initializeComponent(class EntityContext& a0) const{
        void (BlockBreakOnPushDescription::*rv)(class EntityContext&) const;
        *((void**)&rv) = dlsym("?initializeComponent@BlockBreakOnPushDescription@@UEBAXAEAVEntityContext@@@Z");
