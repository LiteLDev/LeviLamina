...
class FrogEggBlockItem : public BlockItem {

#define AFTER_EXTRA

#undef AFTER_EXTRA

#ifndef DISABLE_CONSTRUCTOR_PREVENTION_FROGEGGBLOCKITEM
public:
    class FrogEggBlockItem& operator=(class FrogEggBlockItem const&) = delete;
    FrogEggBlockItem(class FrogEggBlockItem const&) = delete;
    FrogEggBlockItem() = delete;
#endif

public:
    /*0*/ virtual ~FrogEggBlockItem();
    ...
    inline bool isLiquidClipItem(int a0) const{
        bool (FrogEggBlockItem::*rv)(int) const;
        *((void**)&rv) = dlsym("?isLiquidClipItem@FrogEggBlockItem@@UEBA_NH@Z");
        return (this->*rv)(std::forward<int>(a0));
    }
    inline bool _calculatePlacePos(class ItemStackBase& a0, class Actor& a1, unsigned char& a2, class BlockPos& a3) const{
        bool (FrogEggBlockItem::*rv)(class ItemStackBase&, class Actor&, unsigned char&, class BlockPos&) const;
        *((void**)&rv) = dlsym("?_calculatePlacePos@FrogEggBlockItem@@UEBA_NAEAVItemStackBase@@AEAVActor@@AEAEAEAVBlockPos@@@Z");
    ...
    */
    MCAPI FrogEggBlockItem(std::string const&, int);
