...
#define EXTRA_INCLUDE_PART_STONEBLOCK
#include "Extra/StoneBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_STONEBLOCK
...
public:
    ...
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (StoneBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@StoneBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
    ...
    inline class mce::Color getMapColor(class BlockSource& a0, class BlockPos const& a1) const{
        class mce::Color (StoneBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getMapColor@StoneBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (StoneBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@StoneBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class Block const* tryGetInfested(class Block const& a0) const{
        class Block const* (StoneBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?tryGetInfested@StoneBlock@@UEBAPEBVBlock@@AEBV2@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    */
