...
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_SCAFFOLDINGBLOCKITEM
#include "Extra/ScaffoldingBlockItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_SCAFFOLDINGBLOCKITEM
...
public:
    ...
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (ScaffoldingBlockItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@ScaffoldingBlockItem@@EEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
