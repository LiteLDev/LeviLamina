...
public:
    ...
    /*120*/ virtual class ItemInstance const getBaseSeed() const;
    /*121*/ virtual class ItemInstance const getBaseCrop() const;
    /*122*/ virtual int getSeedNum(class Randomize&, int, int) const;
    /*123*/ virtual int getCropNum(class Randomize&, int, int) const;
    /*
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (CropBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@CropBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1), std::forward<class Block const&>(a2));
    }
    inline bool canSurvive(class BlockSource& a0, class BlockPos const& a1) const{
        bool (CropBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?canSurvive@CropBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
    ...
    inline void executeEvent(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, std::string const& a3, class Actor& a4) const{
        void (CropBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, std::string const&, class Actor&) const;
        *((void**)&rv) = dlsym("?executeEvent@CropBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVActor@@@Z");
    ...
    inline class AABB const& getAABB(class BlockSource const& a0, class BlockPos const& a1, class Block const& a2, class AABB& a3, bool a4) const{
        class AABB const& (CropBlock::*rv)(class BlockSource const&, class BlockPos const&, class Block const&, class AABB&, bool) const;
        *((void**)&rv) = dlsym("?getAABB@CropBlock@@UEBAAEBVAABB@@AEBVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z");
    ...
    inline class ItemInstance const getBaseCrop() const{
        class ItemInstance const (CropBlock::*rv)() const;
        *((void**)&rv) = dlsym("?getBaseCrop@CropBlock@@MEBA?BVItemInstance@@XZ");
        return (this->*rv)();
    }
    inline class ItemInstance const getBaseSeed() const{
        class ItemInstance const (CropBlock::*rv)() const;
        *((void**)&rv) = dlsym("?getBaseSeed@CropBlock@@MEBA?BVItemInstance@@XZ");
        return (this->*rv)();
    }
    inline int getCropNum(class Randomize& a0, int a1, int a2) const{
        int (CropBlock::*rv)(class Randomize&, int, int) const;
        *((void**)&rv) = dlsym("?getCropNum@CropBlock@@MEBAHAEAVRandomize@@HH@Z");
        return (this->*rv)(std::forward<class Randomize&>(a0), std::forward<int>(a1), std::forward<int>(a2));
    }
    inline int getSeedNum(class Randomize& a0, int a1, int a2) const{
        int (CropBlock::*rv)(class Randomize&, int, int) const;
        *((void**)&rv) = dlsym("?getSeedNum@CropBlock@@MEBAHAEAVRandomize@@HH@Z");
        return (this->*rv)(std::forward<class Randomize&>(a0), std::forward<int>(a1), std::forward<int>(a2));
    }
    inline int getVariant(class Block const& a0) const{
        int (CropBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@CropBlock@@UEBAHAEBVBlock@@@Z");
    ...
    inline bool hasTag(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, std::string const& a3) const{
        bool (CropBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, std::string const&) const;
        *((void**)&rv) = dlsym("?hasTag@CropBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z");
    ...
    inline bool mayPlaceOn(class BlockSource& a0, class BlockPos const& a1) const{
        bool (CropBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?mayPlaceOn@CropBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (CropBlock::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@CropBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
    ...
    inline bool onFertilized(class BlockSource& a0, class BlockPos const& a1, class Actor* a2, int \/*enum enum FertilizerType*\/ a3) const{
        bool (CropBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor*, int \/*enum enum FertilizerType*\/) const;
        *((void**)&rv) = dlsym("?onFertilized@CropBlock@@MEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z");
    ...
    inline void randomTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (CropBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?randomTick@CropBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline void spawnResources(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, class Randomize& a3, std::vector<class Item const*>* a4, float a5, int a6) const{
        void (CropBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, class Randomize&, std::vector<class Item const*>*, float, int) const;
        *((void**)&rv) = dlsym("?spawnResources@CropBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@PEAV?$vector@PEBVItem@@V?$allocator@PEBVItem@@@std@@@std@@MH@Z");
