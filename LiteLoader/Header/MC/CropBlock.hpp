...
public:
    ...
    virtual class ItemInstance const getBaseSeed();
    virtual class ItemInstance const getBaseCrop();
    virtual int getSeedNum(class Randomize&, int, int);
    virtual int getCropNum(class Randomize&, int, int);
