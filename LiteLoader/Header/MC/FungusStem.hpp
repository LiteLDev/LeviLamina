...
public:
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (FungusStem::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@FungusStem@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
    ...
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (FungusStem::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@FungusStem@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
