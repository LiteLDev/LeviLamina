...
public:
    ...
    inline class ContainerScreenContext _postInit(){
        class ContainerScreenContext (LoomContainerManagerModel::*rv)();
        *((void**)&rv) = dlsym("?_postInit@LoomContainerManagerModel@@MEAA?AVContainerScreenContext@@XZ");
        return (this->*rv)();
    }
    inline std::vector<class ItemStack> getItemCopies() const{
        std::vector<class ItemStack> (LoomContainerManagerModel::*rv)() const;
        *((void**)&rv) = dlsym("?getItemCopies@LoomContainerManagerModel@@UEBA?AV?$vector@VItemStack@@V?$allocator@VItemStack@@@std@@@std@@XZ");
        return (this->*rv)();
    }
    inline class ItemStack const& getSlot(int a0) const{
        class ItemStack const& (LoomContainerManagerModel::*rv)(int) const;
        *((void**)&rv) = dlsym("?getSlot@LoomContainerManagerModel@@UEBAAEBVItemStack@@H@Z");
        return (this->*rv)(std::forward<int>(a0));
    }
    inline bool isValid(float a0){
        bool (LoomContainerManagerModel::*rv)(float);
        *((void**)&rv) = dlsym("?isValid@LoomContainerManagerModel@@UEAA_NM@Z");
        return (this->*rv)(std::forward<float>(a0));
    }
    inline void setSlot(int a0, class ItemStack const& a1, bool a2){
        void (LoomContainerManagerModel::*rv)(int, class ItemStack const&, bool);
        *((void**)&rv) = dlsym("?setSlot@LoomContainerManagerModel@@UEAAXHAEBVItemStack@@_N@Z");
