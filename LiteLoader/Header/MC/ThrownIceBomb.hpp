...
#include "Actor.hpp"
#define EXTRA_INCLUDE_PART_THROWNICEBOMB
#include "Extra/ThrownIceBombAPI.hpp"
#undef EXTRA_INCLUDE_PART_THROWNICEBOMB
...
public:
    ...
    inline void reloadHardcoded(int \/*enum enum Actor::InitializationMethod*\/ a0, class VariantParameterList const& a1){
        void (ThrownIceBomb::*rv)(int \/*enum enum Actor::InitializationMethod*\/, class VariantParameterList const&);
        *((void**)&rv) = dlsym("?reloadHardcoded@ThrownIceBomb@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z");
