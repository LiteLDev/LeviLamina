...
#pragma once
#include "../Global.h"
#define EXTRA_INCLUDE_PART_WEIGHTEDRANDOMFEATURE
#include "Extra/WeightedRandomFeatureAPI.hpp"
#undef EXTRA_INCLUDE_PART_WEIGHTEDRANDOMFEATURE
...
public:
    ...
    inline class std::optional<class BlockPos> place(class IBlockWorldGenAPI& a0, class BlockPos const& a1, class Random& a2, class RenderParams& a3) const{
        class std::optional<class BlockPos> (WeightedRandomFeature::*rv)(class IBlockWorldGenAPI&, class BlockPos const&, class Random&, class RenderParams&) const;
        *((void**)&rv) = dlsym("?place@WeightedRandomFeature@@UEBA?AV?$optional@VBlockPos@@@std@@AEAVIBlockWorldGenAPI@@AEBVBlockPos@@AEAVRandom@@AEAVRenderParams@@@Z");
