...
public:
    ...
    inline bool isNetworkComponent() const{
        ...
        *((void**)&rv) = dlsym("?isNetworkComponent@FuelItemComponent@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline std::unique_ptr<class CompoundTag> buildNetworkTag() const{
        std::unique_ptr<class CompoundTag> (FuelItemComponent::*rv)() const;
        *((void**)&rv) = dlsym("?buildNetworkTag@FuelItemComponent@@UEBA?AV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@XZ");
        return (this->*rv)();
    }
    inline void initializeFromNetwork(class CompoundTag const& a0){
        void (FuelItemComponent::*rv)(class CompoundTag const&);
        *((void**)&rv) = dlsym("?initializeFromNetwork@FuelItemComponent@@UEAAXAEBVCompoundTag@@@Z");
