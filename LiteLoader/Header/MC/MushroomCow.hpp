...
#include "Animal.hpp"
#include "Actor.hpp"
#define EXTRA_INCLUDE_PART_MUSHROOMCOW
#include "Extra/MushroomCowAPI.hpp"
#undef EXTRA_INCLUDE_PART_MUSHROOMCOW
class MushroomCow : public Animal {
#include "Extra/MushroomCowAPI.hpp"
public:
    /*0*/ virtual ~MushroomCow();
    ...
    /*52*/ virtual bool checkSpawnRules(bool);
    ...
    /*63*/ virtual void _serverAiMobStep();
    /*64*/ virtual void __unk_vfn_27();
    /*
    inline bool checkSpawnRules(bool a0){
        bool (MushroomCow::*rv)(bool);
        *((void**)&rv) = dlsym("?checkSpawnRules@MushroomCow@@UEAA_N_N@Z");
