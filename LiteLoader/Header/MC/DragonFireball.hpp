...
#include "Actor.hpp"
#define EXTRA_INCLUDE_PART_DRAGONFIREBALL
#include "Extra/DragonFireballAPI.hpp"
#undef EXTRA_INCLUDE_PART_DRAGONFIREBALL
...
public:
    ...
    inline int \/*enum enum ParticleType*\/ getTrailParticle(){
        int \/*enum enum ParticleType*\/ (DragonFireball::*rv)();
        *((void**)&rv) = dlsym("?getTrailParticle@DragonFireball@@MEAA?AW4ParticleType@@XZ");
        return (this->*rv)();
    }
    */
