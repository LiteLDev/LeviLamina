...
#define EXTRA_INCLUDE_PART_COLOREDBLOCK
#include "Extra/ColoredBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_COLOREDBLOCK
...
public:
    ...
    inline bool isAuxValueRelevantForPicking() const{
        bool (ColoredBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@ColoredBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (ColoredBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@ColoredBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (ColoredBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@ColoredBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
    ...
    inline class mce::Color getMapColor(class BlockSource& a0, class BlockPos const& a1) const{
        class mce::Color (ColoredBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getMapColor@ColoredBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (ColoredBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@ColoredBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    */
