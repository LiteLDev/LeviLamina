...
#include "Actor.hpp"
#define EXTRA_INCLUDE_PART_EXPERIENCEPOTION
#include "Extra/ExperiencePotionAPI.hpp"
#undef EXTRA_INCLUDE_PART_EXPERIENCEPOTION
class ExperiencePotion : public Throwable {
#include "Extra/ExperiencePotionAPI.hpp"
public:
    /*0*/ virtual void reloadHardcoded(int /*enum enum Actor::InitializationMethod*/, class VariantParameterList const&);
    /*1*/ virtual ~ExperiencePotion();
    ...
    /*73*/ virtual float getThrowPower();
    ...
    inline float getGravity(){
        float (ExperiencePotion::*rv)();
        *((void**)&rv) = dlsym("?getGravity@ExperiencePotion@@MEAAMXZ");
        return (this->*rv)();
    }
    inline float getThrowUpAngleOffset(){
        float (ExperiencePotion::*rv)();
        *((void**)&rv) = dlsym("?getThrowUpAngleOffset@ExperiencePotion@@MEAAMXZ");
        return (this->*rv)();
    }
    */
