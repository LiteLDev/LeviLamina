...
public:
    ...
    inline class std::optional<class BlockPos> placeCanopy(class IBlockWorldGenAPI& a0, class BlockPos const& a1, class Random& a2, class RenderParams& a3, struct TreeHelper::TreeParams const& a4, std::vector<class BlockPos> const& a5) const{
        class std::optional<class BlockPos> (SimpleTreeCanopy::*rv)(class IBlockWorldGenAPI&, class BlockPos const&, class Random&, class RenderParams&, struct TreeHelper::TreeParams const&, std::vector<class BlockPos> const&) const;
        *((void**)&rv) = dlsym("?placeCanopy@SimpleTreeCanopy@@UEBA?AV?$optional@VBlockPos@@@std@@AEAVIBlockWorldGenAPI@@AEBVBlockPos@@AEAVRandom@@AEAVRenderParams@@AEBUTreeParams@TreeHelper@@AEBV?$vector@VBlockPos@@V?$allocator@VBlockPos@@@std@@@3@@Z");
