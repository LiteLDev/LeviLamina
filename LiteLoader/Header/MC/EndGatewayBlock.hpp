...
public:
    ...
    inline bool canContainLiquid() const{
        bool (EndGatewayBlock::*rv)() const;
        *((void**)&rv) = dlsym("?canContainLiquid@EndGatewayBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (EndGatewayBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@EndGatewayBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline void spawnResources(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, class Randomize& a3, std::vector<class Item const*>* a4, float a5, int a6) const{
        void (EndGatewayBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, class Randomize&, std::vector<class Item const*>*, float, int) const;
        *((void**)&rv) = dlsym("?spawnResources@EndGatewayBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@PEAV?$vector@PEBVItem@@V?$allocator@PEBVItem@@@std@@@std@@MH@Z");
    ...
    inline bool isWaterBlocking() const{
        bool (EndGatewayBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isWaterBlocking@EndGatewayBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool addCollisionShapes(class Block const& a0, class BlockSource& a1, class BlockPos const& a2, class AABB const* a3, std::vector<class AABB>& a4, class optional_ref<struct IActorMovementProxy> a5) const{
        bool (EndGatewayBlock::*rv)(class Block const&, class BlockSource&, class BlockPos const&, class AABB const*, std::vector<class AABB>&, class optional_ref<struct IActorMovementProxy>) const;
        *((void**)&rv) = dlsym("?addCollisionShapes@EndGatewayBlock@@UEBA_NAEBVBlock@@AEAVBlockSource@@AEBVBlockPos@@PEBVAABB@@AEAV?$vector@VAABB@@V?$allocator@VAABB@@@std@@@std@@V?$optional_ref@UIActorMovementProxy@@@@@Z");
    ...
    inline void animateTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (EndGatewayBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?animateTick@EndGatewayBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (EndGatewayBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@EndGatewayBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline class std::shared_ptr<class BlockActor> newBlockEntity(class BlockPos const& a0, class Block const& a1) const{
        class std::shared_ptr<class BlockActor> (EndGatewayBlock::*rv)(class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?newBlockEntity@EndGatewayBlock@@UEBA?AV?$shared_ptr@VBlockActor@@@std@@AEBVBlockPos@@AEBVBlock@@@Z");
