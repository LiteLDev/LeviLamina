...
public:
    ...
    /*17*/ virtual int /*enum ActorType*/ getOwnerEntityType();
    ...
    /*56*/ virtual std::string getExitTip(std::string const&, int /*enum InputMode*/) const;
    ...
    /*74*/ virtual bool isUnderLiquid(int /*enum MaterialType*/) const;
    ...
    /*133*/ virtual int /*enum LevelSoundEvent*/ getAmbientSound() const;
    ...
    /*154*/ virtual class ItemStack const& getArmor(int /*enum ArmorSlot*/) const;
    ...
    /*159*/ virtual class ItemStack const& getEquippedSlot(int /*enum EquipmentSlot*/) const;
    ...
    /*176*/ virtual class AABB getLiquidAABB(int /*enum MaterialType*/) const;
    ...
    /*188*/ virtual void playSynchronizedSound(int /*enum LevelSoundEvent*/, class Vec3 const&, class Block const&, bool);
    /*189*/ virtual void playSynchronizedSound(int /*enum LevelSoundEvent*/, class Vec3 const&, int, bool);
    ...
    /*260*/ virtual class AnimationComponent& _getAnimationComponent(class std::shared_ptr<class AnimationComponent>&, int /*enum AnimationComponentGroup*/);
