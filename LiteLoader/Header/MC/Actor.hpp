...
public:
    ...
    MCAPI void exitVehicle(class Actor const&, class std::optional<class Vec3> (*)(struct VehicleDirections const&, class std::function<bool(class Vec3 const&, class Vec3 const&)>));
    ...
    MCAPI int /* enum Actor::InitializationMethod */   getInitializationMethod();
