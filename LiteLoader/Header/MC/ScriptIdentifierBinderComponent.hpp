...
public:
    ...
    inline bool deserialize(class ScriptEngine& a0, class ScriptApi::ScriptObjectHandle const& a1){
        bool (ScriptIdentifierBinderComponent::*rv)(class ScriptEngine&, class ScriptApi::ScriptObjectHandle const&);
        *((void**)&rv) = dlsym("?deserialize@ScriptIdentifierBinderComponent@@UEAA_NAEAVScriptEngine@@AEBVScriptObjectHandle@ScriptApi@@@Z");
    ...
    inline bool serialize(class ScriptEngine& a0, class ScriptApi::ScriptObjectHandle const& a1) const{
        bool (ScriptIdentifierBinderComponent::*rv)(class ScriptEngine&, class ScriptApi::ScriptObjectHandle const&) const;
        *((void**)&rv) = dlsym("?serialize@ScriptIdentifierBinderComponent@@UEBA_NAEAVScriptEngine@@AEBVScriptObjectHandle@ScriptApi@@@Z");
        return (this->*rv)(std::forward<class ScriptEngine&>(a0), std::forward<class ScriptApi::ScriptObjectHandle const&>(a1));
    }
    */
