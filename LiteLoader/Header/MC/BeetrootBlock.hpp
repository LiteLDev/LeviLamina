...
public:
    ...
    inline class AABB const& getAABB(class BlockSource const& a0, class BlockPos const& a1, class Block const& a2, class AABB& a3, bool a4) const{
        class AABB const& (BeetrootBlock::*rv)(class BlockSource const&, class BlockPos const&, class Block const&, class AABB&, bool) const;
        *((void**)&rv) = dlsym("?getAABB@BeetrootBlock@@UEBAAEBVAABB@@AEBVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z");
    ...
    inline class ItemInstance const getBaseCrop() const{
        class ItemInstance const (BeetrootBlock::*rv)() const;
        *((void**)&rv) = dlsym("?getBaseCrop@BeetrootBlock@@UEBA?BVItemInstance@@XZ");
        return (this->*rv)();
    }
    inline class ItemInstance const getBaseSeed() const{
        class ItemInstance const (BeetrootBlock::*rv)() const;
        *((void**)&rv) = dlsym("?getBaseSeed@BeetrootBlock@@UEBA?BVItemInstance@@XZ");
        return (this->*rv)();
    }
    inline int getCropNum(class Randomize& a0, int a1, int a2) const{
        int (BeetrootBlock::*rv)(class Randomize&, int, int) const;
        *((void**)&rv) = dlsym("?getCropNum@BeetrootBlock@@UEBAHAEAVRandomize@@HH@Z");
    ...
    inline int getVariant(class Block const& a0) const{
        int (BeetrootBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@BeetrootBlock@@UEBAHAEBVBlock@@@Z");
