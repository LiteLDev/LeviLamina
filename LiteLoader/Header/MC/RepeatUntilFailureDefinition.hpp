...
public:
    ...
    inline void load(class Json::Value a0, class BehaviorFactory const& a1){
        void (RepeatUntilFailureDefinition::*rv)(class Json::Value, class BehaviorFactory const&);
        *((void**)&rv) = dlsym("?load@RepeatUntilFailureDefinition@@UEAAXVValue@Json@@AEBVBehaviorFactory@@@Z");
