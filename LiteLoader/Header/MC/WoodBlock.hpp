...
#define EXTRA_INCLUDE_PART_WOODBLOCK
#include "Extra/WoodBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_WOODBLOCK
...
public:
    ...
    inline bool isAuxValueRelevantForPicking() const{
        bool (WoodBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@WoodBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (WoodBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@WoodBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (WoodBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@WoodBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
    ...
    inline class mce::Color getMapColor(class BlockSource& a0, class BlockPos const& a1) const{
        class mce::Color (WoodBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getMapColor@WoodBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (WoodBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@WoodBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (WoodBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@WoodBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline class Block const& getStrippedBlock(class Block const& a0) const{
        class Block const& (WoodBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getStrippedBlock@WoodBlock@@UEBAAEBVBlock@@AEBV2@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline int getVariant(class Block const& a0) const{
        int (WoodBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@WoodBlock@@UEBAHAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline bool isStrippable(class Block const& a0) const{
        bool (WoodBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?isStrippable@WoodBlock@@UEBA_NAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (WoodBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@WoodBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
