...
#define EXTRA_INCLUDE_PART_MYSTERIOUSFRAME
#include "Extra/MysteriousFrameAPI.hpp"
#undef EXTRA_INCLUDE_PART_MYSTERIOUSFRAME
class MysteriousFrame : public BlockLegacy {
#include "Extra/MysteriousFrameAPI.hpp"
public:
    /*0*/ virtual ~MysteriousFrame();
    ...
    inline bool canBeSilkTouched() const{
        bool (MysteriousFrame::*rv)() const;
        *((void**)&rv) = dlsym("?canBeSilkTouched@MysteriousFrame@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool canBeOriginalSurface() const{
        bool (MysteriousFrame::*rv)() const;
        *((void**)&rv) = dlsym("?canBeOriginalSurface@MysteriousFrame@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (MysteriousFrame::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@MysteriousFrame@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
