...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_SUSPICIOUSSTEWITEM
#include "Extra/SuspiciousStewItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_SUSPICIOUSSTEWITEM
...
public:
    ...
    inline int \/*enum enum ItemUseMethod*\/ useTimeDepleted(class ItemStack& a0, class Level* a1, class Player* a2) const{
        int \/*enum enum ItemUseMethod*\/ (SuspiciousStewItem::*rv)(class ItemStack&, class Level*, class Player*) const;
        *((void**)&rv) = dlsym("?useTimeDepleted@SuspiciousStewItem@@UEBA?AW4ItemUseMethod@@AEAVItemStack@@PEAVLevel@@PEAVPlayer@@@Z");
