...
public:
    ...
    /*120*/ virtual int getIconYOffset() const;
    /*121*/ virtual class Item & setIcon(std::string const &, int);
    /*122*/ virtual class Item & setIcon(struct TextureUVCoordinateSet const &);
    /*123*/ virtual class Item & setIconAtlas(std::string const &, int);
    /*124*/ virtual bool canBeCharged() const;
    /*125*/ virtual void playSoundIncrementally(class ItemInstance const &, class Mob &) const;
    /*126*/ virtual void playSoundIncrementally(class ItemStack const &, class Mob &) const;
    /*127*/ virtual float getFurnaceBurnIntervalMultipler(class ItemStackBase const &) const;
    /*128*/ virtual float getFurnaceXPmultiplier(class ItemStackBase const &) const;
