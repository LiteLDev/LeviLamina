...
public:
    ...
    inline void hurtActor(class ItemStack& a0, class Actor& a1, class Mob& a2) const{
        void (ShearsItem::*rv)(class ItemStack&, class Actor&, class Mob&) const;
        *((void**)&rv) = dlsym("?hurtActor@ShearsItem@@UEBAXAEAVItemStack@@AEAVActor@@AEAVMob@@@Z");
    ...
    inline int getEnchantSlot() const{
        int (ShearsItem::*rv)() const;
        *((void**)&rv) = dlsym("?getEnchantSlot@ShearsItem@@UEBAHXZ");
        return (this->*rv)();
    }
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (ShearsItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@ShearsItem@@UEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
    ...
    inline bool canDestroySpecial(class Block const& a0) const{
        bool (ShearsItem::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?canDestroySpecial@ShearsItem@@UEBA_NAEBVBlock@@@Z");
    ...
    inline bool dispense(class BlockSource& a0, class Container& a1, int a2, class Vec3 const& a3, unsigned char a4) const{
        bool (ShearsItem::*rv)(class BlockSource&, class Container&, int, class Vec3 const&, unsigned char) const;
        *((void**)&rv) = dlsym("?dispense@ShearsItem@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z");
    ...
    inline float getDestroySpeed(class ItemStackBase const& a0, class Block const& a1) const{
        float (ShearsItem::*rv)(class ItemStackBase const&, class Block const&) const;
        *((void**)&rv) = dlsym("?getDestroySpeed@ShearsItem@@UEBAMAEBVItemStackBase@@AEBVBlock@@@Z");
    ...
    inline bool mineBlock(class ItemStack& a0, class Block const& a1, int a2, int a3, int a4, class Actor* a5) const{
        bool (ShearsItem::*rv)(class ItemStack&, class Block const&, int, int, int, class Actor*) const;
        *((void**)&rv) = dlsym("?mineBlock@ShearsItem@@UEBA_NAEAVItemStack@@AEBVBlock@@HHHPEAVActor@@@Z");
