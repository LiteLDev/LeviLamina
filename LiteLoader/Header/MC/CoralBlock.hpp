...
#define EXTRA_INCLUDE_PART_CORALBLOCK
#include "Extra/CoralBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_CORALBLOCK
...
public:
    ...
    inline bool isAuxValueRelevantForPicking() const{
        bool (CoralBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@CoralBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (CoralBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@CoralBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (CoralBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@CoralBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
    ...
    inline class mce::Color getMapColor(class BlockSource& a0, class BlockPos const& a1) const{
        class mce::Color (CoralBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getMapColor@CoralBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (CoralBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@CoralBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline int getVariant(class Block const& a0) const{
        int (CoralBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@CoralBlock@@UEBAHAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline bool isValidAuxValue(int a0) const{
        bool (CoralBlock::*rv)(int) const;
        *((void**)&rv) = dlsym("?isValidAuxValue@CoralBlock@@UEBA_NH@Z");
        return (this->*rv)(std::forward<int>(a0));
    }
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (CoralBlock::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@CoralBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
    ...
    inline void onPlace(class BlockSource& a0, class BlockPos const& a1) const{
        void (CoralBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onPlace@CoralBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (CoralBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@CoralBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
