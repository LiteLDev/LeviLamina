...
public:
    ...
    inline int getVariant(class Block const& a0) const{
        int (CarrotBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@CarrotBlock@@UEBAHAEBVBlock@@@Z");
    ...
    inline class AABB const& getAABB(class BlockSource const& a0, class BlockPos const& a1, class Block const& a2, class AABB& a3, bool a4) const{
        class AABB const& (CarrotBlock::*rv)(class BlockSource const&, class BlockPos const&, class Block const&, class AABB&, bool) const;
        *((void**)&rv) = dlsym("?getAABB@CarrotBlock@@UEBAAEBVAABB@@AEBVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z");
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (CarrotBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@CarrotBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
