...
public:
    ...
    /*108*/ virtual enum BlockRenderLayer getRenderLayer() const;
    ...
    /*114*/ virtual class ItemInstance const getBaseSeed() const;
    /*115*/ virtual class ItemInstance const getBaseCrop() const;
    /*116*/ virtual int getCropNum(class Randomize&, int, int) const;
    /*
