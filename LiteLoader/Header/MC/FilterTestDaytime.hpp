...
public:
    ...
    inline bool evaluate(struct FilterContext const& a0) const{
        bool (FilterTestDaytime::*rv)(struct FilterContext const&) const;
        *((void**)&rv) = dlsym("?evaluate@FilterTestDaytime@@UEBA_NAEBUFilterContext@@@Z");
        return (this->*rv)(std::forward<struct FilterContext const&>(a0));
    }
    inline class gsl::basic_string_span<char const, -1> getName() const{
        class gsl::basic_string_span<char const, -1> (FilterTestDaytime::*rv)() const;
        *((void**)&rv) = dlsym("?getName@FilterTestDaytime@@UEBA?AV?$basic_string_span@$$CBD$0?0@gsl@@XZ");
        return (this->*rv)();
    }
    */
