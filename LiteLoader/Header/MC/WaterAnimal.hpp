...
#include "Mob.hpp"
#include "Actor.hpp"
#define EXTRA_INCLUDE_PART_WATERANIMAL
#include "Extra/WaterAnimalAPI.hpp"
#undef EXTRA_INCLUDE_PART_WATERANIMAL
...
public:
    ...
    inline void aiStep(){
        void (WaterAnimal::*rv)();
        *((void**)&rv) = dlsym("?aiStep@WaterAnimal@@UEAAXXZ");
        return (this->*rv)();
    }
    inline bool checkSpawnRules(bool a0){
        bool (WaterAnimal::*rv)(bool);
        *((void**)&rv) = dlsym("?checkSpawnRules@WaterAnimal@@UEAA_N_N@Z");
