...
public:
    ...
    inline int getEnchantSlot() const{
        int (BowItem::*rv)() const;
        *((void**)&rv) = dlsym("?getEnchantSlot@BowItem@@UEBAHXZ");
        return (this->*rv)();
    }
    inline struct TextureUVCoordinateSet const& getIcon(class ItemStackBase const& a0, int a1, bool a2) const{
        struct TextureUVCoordinateSet const& (BowItem::*rv)(class ItemStackBase const&, int, bool) const;
        *((void**)&rv) = dlsym("?getIcon@BowItem@@UEBAAEBUTextureUVCoordinateSet@@AEBVItemStackBase@@H_N@Z");
    ...
    inline class Item& setIcon(std::string const& a0, int a1){
        class Item& (BowItem::*rv)(std::string const&, int);
        *((void**)&rv) = dlsym("?setIcon@BowItem@@UEAAAEAVItem@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z");
