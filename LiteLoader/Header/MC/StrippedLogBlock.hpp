...
#define EXTRA_INCLUDE_PART_STRIPPEDLOGBLOCK
#include "Extra/StrippedLogBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_STRIPPEDLOGBLOCK
...
public:
    ...
    inline int getVariant(class Block const& a0) const{
        int (StrippedLogBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@StrippedLogBlock@@UEBAHAEBVBlock@@@Z");
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (StrippedLogBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@StrippedLogBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (StrippedLogBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@StrippedLogBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
        return (this->*rv)(std::forward<class Randomize&>(a0), std::forward<class Block const&>(a1), std::forward<int>(a2));
    }
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (StrippedLogBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@StrippedLogBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (StrippedLogBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@StrippedLogBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    */
