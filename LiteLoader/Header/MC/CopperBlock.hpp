...
#define EXTRA_INCLUDE_PART_COPPERBLOCK
#include "Extra/CopperBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_COPPERBLOCK
...
public:
    ...
    inline void onLightningHit(class BlockSource& a0, class BlockPos const& a1) const{
        void (CopperBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onLightningHit@CopperBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void randomTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (CopperBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?randomTick@CopperBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline class CopperBehavior const* tryGetCopperBehavior() const{
        class CopperBehavior const* (CopperBlock::*rv)() const;
        *((void**)&rv) = dlsym("?tryGetCopperBehavior@CopperBlock@@UEBAPEBVCopperBehavior@@XZ");
        return (this->*rv)();
    }
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (CopperBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@CopperBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
