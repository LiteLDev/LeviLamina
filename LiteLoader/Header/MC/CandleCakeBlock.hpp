...
public:
    ...
    virtual int _getNumCandles(class Block const&);
    virtual void _iterateCandles(class Block const&, class BlockPos const&, class std::function<void(class Vec3 const&, int)>);
    virtual void _tryLightOnFire(class BlockSource&, class BlockPos const&);
