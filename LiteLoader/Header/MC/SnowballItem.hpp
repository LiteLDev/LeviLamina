...
public:
    ...
    inline bool isThrowable() const{
        bool (SnowballItem::*rv)() const;
        *((void**)&rv) = dlsym("?isThrowable@SnowballItem@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool dispense(class BlockSource& a0, class Container& a1, int a2, class Vec3 const& a3, unsigned char a4) const{
        bool (SnowballItem::*rv)(class BlockSource&, class Container&, int, class Vec3 const&, unsigned char) const;
        *((void**)&rv) = dlsym("?dispense@SnowballItem@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z");
    ...
    inline class ItemStack& use(class ItemStack& a0, class Player& a1) const{
        class ItemStack& (SnowballItem::*rv)(class ItemStack&, class Player&) const;
        *((void**)&rv) = dlsym("?use@SnowballItem@@UEBAAEAVItemStack@@AEAV2@AEAVPlayer@@@Z");
