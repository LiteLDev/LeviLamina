...
public:
    ...
    /*22*/ virtual enum CommandOriginType getOriginType() const;
    /*23*/ virtual void __unk_vfn_1();
    /*24*/ virtual void handleCommandOutputCallback(class Json::Value&&) const;
    /*25*/ virtual void updateValues();
    /*26*/ virtual class Vec3 const getExecutePosition(int, class CommandPositionFloat const&) const;
    /*27*/ virtual class CompoundTag serialize() const;
    /*28*/ virtual bool isValid() const;
    /*29*/ virtual void _setUUID(class mce::UUID const&);
