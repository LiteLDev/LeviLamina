...
public:
    ...
    /*123*/ virtual int getTickDelay() const;
    /*124*/ virtual int getSignalStrength(class BlockSource&, class BlockPos const&) const = 0;
    /*125*/ virtual int getSignalForData(int) const = 0;
    /*126*/ virtual int getRedstoneSignal(int) const = 0;
    /*127*/ virtual class AABB const getSensitiveAABB(class BlockPos const&) const;
    /*
