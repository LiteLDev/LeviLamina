...
public:
    ...
    virtual int getSignalStrength(class BlockSource&, class BlockPos const&);
    virtual int getSignalForData(int);
    virtual int getRedstoneSignal(int);
    virtual class AABB const getSensitiveAABB(class BlockPos const&);
