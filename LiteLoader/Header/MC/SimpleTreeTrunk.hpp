...
public:
    ...
    inline class std::optional<class BlockPos> placeTrunk(class IBlockWorldGenAPI& a0, class BlockPos const& a1, class Random& a2, class RenderParams& a3, struct TreeHelper::TreeParams const& a4, class ITreeCanopy const* a5) const{
        class std::optional<class BlockPos> (SimpleTreeTrunk::*rv)(class IBlockWorldGenAPI&, class BlockPos const&, class Random&, class RenderParams&, struct TreeHelper::TreeParams const&, class ITreeCanopy const*) const;
        *((void**)&rv) = dlsym("?placeTrunk@SimpleTreeTrunk@@UEBA?AV?$optional@VBlockPos@@@std@@AEAVIBlockWorldGenAPI@@AEBVBlockPos@@AEAVRandom@@AEAVRenderParams@@AEBUTreeParams@TreeHelper@@PEBVITreeCanopy@@@Z");
