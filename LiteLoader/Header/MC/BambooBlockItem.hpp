...
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_BAMBOOBLOCKITEM
#include "Extra/BambooBlockItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_BAMBOOBLOCKITEM
...
public:
    ...
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (BambooBlockItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@BambooBlockItem@@UEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
    ...
    inline int getLevelDataForAuxValue(int a0) const{
        int (BambooBlockItem::*rv)(int) const;
        *((void**)&rv) = dlsym("?getLevelDataForAuxValue@BambooBlockItem@@UEBAHH@Z");
