...
public:
    ...
    inline bool getInteraction(class Player& a0, class ActorInteraction& a1, class Vec3 const& a2){
        bool (Piglin::*rv)(class Player&, class ActorInteraction&, class Vec3 const&);
        *((void**)&rv) = dlsym("?getInteraction@Piglin@@UEAA_NAEAVPlayer@@AEAVActorInteraction@@AEBVVec3@@@Z");
    ...
    inline float getRidingHeight(){
        float (Piglin::*rv)();
        *((void**)&rv) = dlsym("?getRidingHeight@Piglin@@UEAAMXZ");
        return (this->*rv)();
    }
