...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_MINECARTITEM
#include "Extra/MinecartItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_MINECARTITEM
...
public:
    ...
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (MinecartItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@MinecartItem@@EEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
    ...
    inline bool dispense(class BlockSource& a0, class Container& a1, int a2, class Vec3 const& a3, unsigned char a4) const{
        bool (MinecartItem::*rv)(class BlockSource&, class Container&, int, class Vec3 const&, unsigned char) const;
        *((void**)&rv) = dlsym("?dispense@MinecartItem@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z");
    ...
    inline bool isDestructive(int a0) const{
        bool (MinecartItem::*rv)(int) const;
        *((void**)&rv) = dlsym("?isDestructive@MinecartItem@@UEBA_NH@Z");
