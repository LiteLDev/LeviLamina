...
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_SEAPICKLEBLOCKITEM
#include "Extra/SeaPickleBlockItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_SEAPICKLEBLOCKITEM
...
public:
    ...
    inline int getLevelDataForAuxValue(int a0) const{
        int (SeaPickleBlockItem::*rv)(int) const;
        *((void**)&rv) = dlsym("?getLevelDataForAuxValue@SeaPickleBlockItem@@UEBAHH@Z");
    ...
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (SeaPickleBlockItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@SeaPickleBlockItem@@UEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
