...
public:
    ...
    inline bool getEventData(class ScriptApi::ScriptVersionInfo const& a0, class ScriptEngine& a1, class ScriptServerContext& a2, std::string const& a3, class ScriptApi::ScriptObjectHandle& a4){
        bool (ScriptServerSpawnParticleInWorldEvent::*rv)(class ScriptApi::ScriptVersionInfo const&, class ScriptEngine&, class ScriptServerContext&, std::string const&, class ScriptApi::ScriptObjectHandle&);
        *((void**)&rv) = dlsym("?getEventData@ScriptServerSpawnParticleInWorldEvent@@UEAA_NAEBVScriptVersionInfo@ScriptApi@@AEAVScriptEngine@@AEAVScriptServerContext@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVScriptObjectHandle@3@@Z");
    ...
    inline bool receivedEvent(class ScriptApi::ScriptVersionInfo const& a0, class ScriptEngine& a1, class ScriptServerContext& a2, std::string const& a3, class ScriptApi::ScriptObjectHandle const& a4){
        bool (ScriptServerSpawnParticleInWorldEvent::*rv)(class ScriptApi::ScriptVersionInfo const&, class ScriptEngine&, class ScriptServerContext&, std::string const&, class ScriptApi::ScriptObjectHandle const&);
        *((void**)&rv) = dlsym("?receivedEvent@ScriptServerSpawnParticleInWorldEvent@@UEAA_NAEBVScriptVersionInfo@ScriptApi@@AEAVScriptEngine@@AEAVScriptServerContext@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVScriptObjectHandle@3@@Z");
