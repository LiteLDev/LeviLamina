...
public:
    ...
    inline float getShadowRadius() const{
        float (LightningBolt::*rv)() const;
        *((void**)&rv) = dlsym("?getShadowRadius@LightningBolt@@UEBAMXZ");
        return (this->*rv)();
    }
    ...
    inline void normalTick(){
        void (LightningBolt::*rv)();
        *((void**)&rv) = dlsym("?normalTick@LightningBolt@@UEAAXXZ");
        return (this->*rv)();
    }
    inline void reloadHardcoded(int \/*enum enum Actor::InitializationMethod*\/ a0, class VariantParameterList const& a1){
        void (LightningBolt::*rv)(int \/*enum enum Actor::InitializationMethod*\/, class VariantParameterList const&);
        *((void**)&rv) = dlsym("?reloadHardcoded@LightningBolt@@UEAAXW4InitializationMethod@Actor@@AEBVVariantParameterList@@@Z");
        return (this->*rv)(std::forward<int \/*enum enum Actor::InitializationMethod*\/>(a0), std::forward<class VariantParameterList const&>(a1));
    }
    */
