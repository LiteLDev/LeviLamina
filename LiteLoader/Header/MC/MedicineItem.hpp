...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_MEDICINEITEM
#include "Extra/MedicineItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_MEDICINEITEM
...
public:
    ...
    inline std::string buildDescriptionId(class ItemDescriptor const& a0, class CompoundTag const* a1) const{
        std::string (MedicineItem::*rv)(class ItemDescriptor const&, class CompoundTag const*) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@MedicineItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z");
    ...
    inline bool isValidAuxValue(int a0) const{
        bool (MedicineItem::*rv)(int) const;
        *((void**)&rv) = dlsym("?isValidAuxValue@MedicineItem@@UEBA_NH@Z");
        return (this->*rv)(std::forward<int>(a0));
    }
    inline class Item& setIcon(std::string const& a0, int a1){
        class Item& (MedicineItem::*rv)(std::string const&, int);
        *((void**)&rv) = dlsym("?setIcon@MedicineItem@@UEAAAEAVItem@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z");
    ...
    inline class ItemStack& use(class ItemStack& a0, class Player& a1) const{
        class ItemStack& (MedicineItem::*rv)(class ItemStack&, class Player&) const;
        *((void**)&rv) = dlsym("?use@MedicineItem@@UEBAAEAVItemStack@@AEAV2@AEAVPlayer@@@Z");
    ...
    inline int \/*enum enum ItemUseMethod*\/ useTimeDepleted(class ItemStack& a0, class Level* a1, class Player* a2) const{
        int \/*enum enum ItemUseMethod*\/ (MedicineItem::*rv)(class ItemStack&, class Level*, class Player*) const;
        *((void**)&rv) = dlsym("?useTimeDepleted@MedicineItem@@UEBA?AW4ItemUseMethod@@AEAVItemStack@@PEAVLevel@@PEAVPlayer@@@Z");
