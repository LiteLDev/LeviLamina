...
public:
    ...
    inline bool createAndApplyTemplate(class ScriptApi::ScriptVersionInfo const& a0, class ScriptEngine& a1, class ScriptServerContext& a2, class Actor** a3, std::string const& a4) const{
        bool (ApplyLegacyEntityBinding::*rv)(class ScriptApi::ScriptVersionInfo const&, class ScriptEngine&, class ScriptServerContext&, class Actor**, std::string const&) const;
        *((void**)&rv) = dlsym("?createAndApplyTemplate@ApplyLegacyEntityBinding@@UEBA_NAEBVScriptVersionInfo@ScriptApi@@AEAVScriptEngine@@AEAVScriptServerContext@@PEAPEAVActor@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z");
