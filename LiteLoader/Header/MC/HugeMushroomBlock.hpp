...
#define EXTRA_INCLUDE_PART_HUGEMUSHROOMBLOCK
#include "Extra/HugeMushroomBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_HUGEMUSHROOMBLOCK
...
public:
    ...
    inline bool isAuxValueRelevantForPicking() const{
        bool (HugeMushroomBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@HugeMushroomBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (HugeMushroomBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@HugeMushroomBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (HugeMushroomBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@HugeMushroomBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (HugeMushroomBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@HugeMushroomBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (HugeMushroomBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@HugeMushroomBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
        return (this->*rv)(std::forward<class Randomize&>(a0), std::forward<class Block const&>(a1), std::forward<int>(a2));
    }
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (HugeMushroomBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@HugeMushroomBlock@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    */
