...
#define EXTRA_INCLUDE_PART_FACING
#include "Extra/FacingAPI.hpp"
#undef EXTRA_INCLUDE_PART_FACING
class Facing {
#include "Extra/FacingAPI.hpp"
...
public:
    ...
    MCAPI static enum Facing::Name const* const const BY2DDATA;
    MCAPI static class BlockPos const* const const DIRECTION;
    MCAPI static enum Facing::Name const* const const DIRECTIONS;
    MCAPI static unsigned char const* const const FACINGMASK;
    MCAPI static unsigned char const* const const FACINGMASK_INV;
    MCAPI static class Vec3 const* const const NORMAL;
    MCAPI static unsigned char const* const const OPPOSITE_FACING;
    MCAPI static int const* const const STEP_X;
    MCAPI static int const* const const STEP_Y;
