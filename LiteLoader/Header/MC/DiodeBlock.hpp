...
public:
    ...
    virtual int getSignal(class BlockSource&, class BlockPos const&, int);
    virtual bool isLocked(class BlockSource&, class BlockPos const&);
    virtual bool isSameDiode(class Block const&);
    virtual bool shouldPrioritize(class BlockSource&, class BlockPos const&);
    virtual bool isOn();
    virtual bool shouldTurnOn(class BlockSource&, class BlockPos const&);
    virtual int getInputSignal(class BlockSource&, class BlockPos const&);
    virtual bool isAlternateInput(class Block const&);
    virtual int getAlternateSignal(class BlockSource&, class BlockPos const&);
    virtual void unk_vfn_199();
    virtual int getTurnOffDelay(class Block const&);
    virtual int getTurnOnDelay(class Block const&);
    virtual class Block const* getOnBlock(class Block const*);
    virtual class Block const* getOffBlock(class Block const*);
