...
#define EXTRA_INCLUDE_PART_DIODEBLOCK
#include "Extra/DiodeBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_DIODEBLOCK
...
public:
    ...
    /*118*/ virtual int getSignal(class BlockSource&, class BlockPos const&, int) const;
    /*119*/ virtual bool isLocked(class BlockSource&, class BlockPos const&) const;
    /*120*/ virtual bool isSameDiode(class Block const&) const;
    /*121*/ virtual bool shouldPrioritize(class BlockSource&, class BlockPos const&) const;
    /*122*/ virtual bool isOn() const;
    /*123*/ virtual bool shouldTurnOn(class BlockSource&, class BlockPos const&) const;
    /*124*/ virtual int getInputSignal(class BlockSource&, class BlockPos const&) const;
    /*125*/ virtual bool isAlternateInput(class Block const&) const;
    /*126*/ virtual int getAlternateSignal(class BlockSource&, class BlockPos const&) const;
    /*127*/ virtual void __unk_vfn_36();
    ...
    /*
    inline bool isLocked(class BlockSource& a0, class BlockPos const& a1) const{
        bool (DiodeBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?isLocked@DiodeBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
    ...
    inline int getOutputSignal(class Block const& a0) const{
        int (DiodeBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getOutputSignal@DiodeBlock@@MEBAHAEBVBlock@@@Z");
    ...
    inline int getDirectSignal(class BlockSource& a0, class BlockPos const& a1, int a2) const{
        ...
        *((void**)&rv) = dlsym("?getDirectSignal@DiodeBlock@@UEBAHAEAVBlockSource@@AEBVBlockPos@@H@Z");
    ...
    inline bool canSurvive(class BlockSource& a0, class BlockPos const& a1) const{
        bool (DiodeBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?canSurvive@DiodeBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline int getAlternateSignal(class BlockSource& a0, class BlockPos const& a1) const{
        int (DiodeBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getAlternateSignal@DiodeBlock@@MEBAHAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline int getInputSignal(class BlockSource& a0, class BlockPos const& a1) const{
        int (DiodeBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getInputSignal@DiodeBlock@@MEBAHAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline class Block const& getPlacementBlock(class Actor& a0, class BlockPos const& a1, unsigned char a2, class Vec3 const& a3, int a4) const{
        class Block const& (DiodeBlock::*rv)(class Actor&, class BlockPos const&, unsigned char, class Vec3 const&, int) const;
        *((void**)&rv) = dlsym("?getPlacementBlock@DiodeBlock@@UEBAAEBVBlock@@AEAVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z");
    ...
    inline int getTurnOffDelay(class Block const& a0) const{
        int (DiodeBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getTurnOffDelay@DiodeBlock@@MEBAHAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline int getVariant(class Block const& a0) const{
        int (DiodeBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@DiodeBlock@@UEBAHAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline bool isAlternateInput(class Block const& a0) const{
        bool (DiodeBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?isAlternateInput@DiodeBlock@@MEBA_NAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline bool isOn() const{
        bool (DiodeBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isOn@DiodeBlock@@MEBA_NXZ");
        return (this->*rv)();
    }
    inline bool isSameDiode(class Block const& a0) const{
        bool (DiodeBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?isSameDiode@DiodeBlock@@UEBA_NAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline bool mayPlace(class BlockSource& a0, class BlockPos const& a1) const{
        bool (DiodeBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?mayPlace@DiodeBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (DiodeBlock::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@DiodeBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
    ...
    inline void onRedstoneUpdate(class BlockSource& a0, class BlockPos const& a1, int a2, bool a3) const{
        void (DiodeBlock::*rv)(class BlockSource&, class BlockPos const&, int, bool) const;
        *((void**)&rv) = dlsym("?onRedstoneUpdate@DiodeBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@H_N@Z");
    ...
    inline bool shouldPrioritize(class BlockSource& a0, class BlockPos const& a1) const{
        bool (DiodeBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?shouldPrioritize@DiodeBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline bool shouldTurnOn(class BlockSource& a0, class BlockPos const& a1) const{
        bool (DiodeBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?shouldTurnOn@DiodeBlock@@MEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    */
