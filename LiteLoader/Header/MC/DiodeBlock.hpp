...
public:
    ...
    /*119*/ virtual int getSignal(class BlockSource&, class BlockPos const&, int) const;
    /*120*/ virtual void __unk_vfn_62();
    /*121*/ virtual bool isSameDiode(class Block const&) const;
    /*122*/ virtual bool shouldPrioritize(class BlockSource&, class BlockPos const&) const;
    /*123*/ virtual bool isOn() const;
    /*124*/ virtual bool shouldTurnOn(class BlockSource&, class BlockPos const&) const;
    /*125*/ virtual int getInputSignal(class BlockSource&, class BlockPos const&) const;
    /*126*/ virtual bool isAlternateInput(class Block const&) const;
    /*127*/ virtual int getAlternateSignal(class BlockSource&, class BlockPos const&) const;
    /*128*/ virtual int getOutputSignal(class Block const&) const;
    /*129*/ virtual int getTurnOffDelay(class Block const&) const;
    /*130*/ virtual int getTurnOnDelay(class Block const&) const = 0;
    /*131*/ virtual class Block const* getOnBlock(class Block const*) const = 0;
    /*132*/ virtual class Block const* getOffBlock(class Block const*) const = 0;
    /*
