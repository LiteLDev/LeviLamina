...
#define EXTRA_INCLUDE_PART_STONEBRICKBLOCK
#include "Extra/StoneBrickBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_STONEBRICKBLOCK
...
public:
    ...
    inline bool isAuxValueRelevantForPicking() const{
        bool (StoneBrickBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@StoneBrickBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (StoneBrickBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@StoneBrickBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (StoneBrickBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@StoneBrickBlock@@MEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (StoneBrickBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@StoneBrickBlock@@MEBA?AVItemInstance@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline class Block const* tryGetInfested(class Block const& a0) const{
        class Block const* (StoneBrickBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?tryGetInfested@StoneBrickBlock@@UEBAPEBVBlock@@AEBV2@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    */
