...
#include "../Global.h"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_PACKMANIFEST
#include "Extra/PackManifestAPI.hpp"
#undef EXTRA_INCLUDE_PART_PACKMANIFEST
class PackManifest {
#include "Extra/PackManifestAPI.hpp"
public:
    ...
    inline std::unique_ptr<class PackManifest> clone() const{
        std::unique_ptr<class PackManifest> (PackManifest::*rv)() const;
        *((void**)&rv) = dlsym("?clone@PackManifest@@UEBA?AV?$unique_ptr@VPackManifest@@U?$default_delete@VPackManifest@@@std@@@std@@XZ");
        return (this->*rv)();
    }
    */
