...
public:
    ...
    inline bool canBeUsedInCommands(class BaseGameVersion const& a0) const{
        bool (ChemicalHeatBlock::*rv)(class BaseGameVersion const&) const;
        *((void**)&rv) = dlsym("?canBeUsedInCommands@ChemicalHeatBlock@@UEBA_NAEBVBaseGameVersion@@@Z");
        return (this->*rv)(std::forward<class BaseGameVersion const&>(a0));
    }
    inline int getExtraRenderLayers() const{
        int (ChemicalHeatBlock::*rv)() const;
        *((void**)&rv) = dlsym("?getExtraRenderLayers@ChemicalHeatBlock@@UEBAHXZ");
        return (this->*rv)();
    }
    inline void onPlace(class BlockSource& a0, class BlockPos const& a1) const{
        void (ChemicalHeatBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onPlace@ChemicalHeatBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (ChemicalHeatBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@ChemicalHeatBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
