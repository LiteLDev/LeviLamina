...
public:
    ...
    inline bool canDestroySpecial(class Block const& a0) const{
        bool (PickaxeItem::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?canDestroySpecial@PickaxeItem@@UEBA_NAEBVBlock@@@Z");
    ...
    inline float getDestroySpeed(class ItemStackBase const& a0, class Block const& a1) const{
        float (PickaxeItem::*rv)(class ItemStackBase const&, class Block const&) const;
        *((void**)&rv) = dlsym("?getDestroySpeed@PickaxeItem@@UEBAMAEBVItemStackBase@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class ItemStackBase const&>(a0), std::forward<class Block const&>(a1));
    }
    inline int getEnchantSlot() const{
        int (PickaxeItem::*rv)() const;
        *((void**)&rv) = dlsym("?getEnchantSlot@PickaxeItem@@UEBAHXZ");
        return (this->*rv)();
    }
    */
