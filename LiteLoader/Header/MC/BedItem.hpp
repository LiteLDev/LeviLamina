...
public:
    ...
    /*79*/ virtual bool _checkUseOnPermissions(class Actor&, class ItemStackBase&, unsigned char const&, class BlockPos const&) const;
    ...
    inline class Item& setIcon(std::string const& a0, int a1){
        class Item& (BedItem::*rv)(std::string const&, int);
        *((void**)&rv) = dlsym("?setIcon@BedItem@@UEAAAEAVItem@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z");
        return (this->*rv)(std::forward<std::string const&>(a0), std::forward<int>(a1));
    }
    inline bool isValidAuxValue(int a0) const{
        bool (BedItem::*rv)(int) const;
        *((void**)&rv) = dlsym("?isValidAuxValue@BedItem@@UEBA_NH@Z");
    ...
    inline bool _checkUseOnPermissions(class Actor& a0, class ItemStackBase& a1, unsigned char const& a2, class BlockPos const& a3) const{
        bool (BedItem::*rv)(class Actor&, class ItemStackBase&, unsigned char const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?_checkUseOnPermissions@BedItem@@EEBA_NAEAVActor@@AEAVItemStackBase@@AEBEAEBVBlockPos@@@Z");
    ...
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (BedItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@BedItem@@EEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
    ...
    inline std::string buildDescriptionId(class ItemDescriptor const& a0, class CompoundTag const* a1) const{
        std::string (BedItem::*rv)(class ItemDescriptor const&, class CompoundTag const*) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@BedItem@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVItemDescriptor@@PEBVCompoundTag@@@Z");
    ...
    inline struct TextureUVCoordinateSet const& getIcon(class ItemStackBase const& a0, int a1, bool a2) const{
        struct TextureUVCoordinateSet const& (BedItem::*rv)(class ItemStackBase const&, int, bool) const;
        *((void**)&rv) = dlsym("?getIcon@BedItem@@UEBAAEBUTextureUVCoordinateSet@@AEBVItemStackBase@@H_N@Z");
