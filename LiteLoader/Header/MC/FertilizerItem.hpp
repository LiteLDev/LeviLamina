...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_FERTILIZERITEM
#include "Extra/FertilizerItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_FERTILIZERITEM
...
public:
    ...
    inline bool isFertilizer() const{
        bool (FertilizerItem::*rv)() const;
        *((void**)&rv) = dlsym("?isFertilizer@FertilizerItem@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (FertilizerItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@FertilizerItem@@MEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
    ...
    inline bool dispense(class BlockSource& a0, class Container& a1, int a2, class Vec3 const& a3, unsigned char a4) const{
        bool (FertilizerItem::*rv)(class BlockSource&, class Container&, int, class Vec3 const&, unsigned char) const;
        *((void**)&rv) = dlsym("?dispense@FertilizerItem@@UEBA_NAEAVBlockSource@@AEAVContainer@@HAEBVVec3@@E@Z");
    ...
    inline void executeEvent(class ItemStackBase& a0, std::string const& a1, class RenderParams& a2) const{
        void (FertilizerItem::*rv)(class ItemStackBase&, std::string const&, class RenderParams&) const;
        *((void**)&rv) = dlsym("?executeEvent@FertilizerItem@@UEBAXAEAVItemStackBase@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVRenderParams@@@Z");
