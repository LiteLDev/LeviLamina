...
public:
    ...
    inline int getVariant(class Block const& a0) const{
        int (BambooSapling::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@BambooSapling@@UEBAHAEBVBlock@@@Z");
    ...
    inline bool canSurvive(class BlockSource& a0, class BlockPos const& a1) const{
        bool (BambooSapling::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?canSurvive@BambooSapling@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (BambooSapling::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@BambooSapling@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (BambooSapling::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@BambooSapling@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1), std::forward<class Block const&>(a2));
    }
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (BambooSapling::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@BambooSapling@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (BambooSapling::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@BambooSapling@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    inline bool isValidAuxValue(int a0) const{
        bool (BambooSapling::*rv)(int) const;
        *((void**)&rv) = dlsym("?isValidAuxValue@BambooSapling@@UEBA_NH@Z");
        return (this->*rv)(std::forward<int>(a0));
    }
    inline bool mayPlace(class BlockSource& a0, class BlockPos const& a1) const{
        bool (BambooSapling::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?mayPlace@BambooSapling@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline bool onFertilized(class BlockSource& a0, class BlockPos const& a1, class Actor* a2, int \/*enum enum FertilizerType*\/ a3) const{
        bool (BambooSapling::*rv)(class BlockSource&, class BlockPos const&, class Actor*, int \/*enum enum FertilizerType*\/) const;
        *((void**)&rv) = dlsym("?onFertilized@BambooSapling@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z");
    ...
    inline void randomTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (BambooSapling::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?randomTick@BambooSapling@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline class Vec3 randomlyModifyPosition(class BlockPos const& a0) const{
        class Vec3 (BambooSapling::*rv)(class BlockPos const&) const;
        *((void**)&rv) = dlsym("?randomlyModifyPosition@BambooSapling@@UEBA?AVVec3@@AEBVBlockPos@@@Z");
