...
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_ACTORISMOVINGTEST
#include "Extra/ActorIsMovingTestAPI.hpp"
#undef EXTRA_INCLUDE_PART_ACTORISMOVINGTEST
...
public:
    ...
    inline bool evaluate(struct FilterContext const& a0) const{
        bool (ActorIsMovingTest::*rv)(struct FilterContext const&) const;
        *((void**)&rv) = dlsym("?evaluate@ActorIsMovingTest@@UEBA_NAEBUFilterContext@@@Z");
        return (this->*rv)(std::forward<struct FilterContext const&>(a0));
    }
    inline class gsl::basic_string_span<char const, -1> getName() const{
        class gsl::basic_string_span<char const, -1> (ActorIsMovingTest::*rv)() const;
        *((void**)&rv) = dlsym("?getName@ActorIsMovingTest@@UEBA?AV?$basic_string_span@$$CBD$0?0@gsl@@XZ");
        return (this->*rv)();
    }
    */
