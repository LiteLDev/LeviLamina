...
public:
    ...
    inline float getShadeBrightness(class Block const& a0) const{
        float (BarrierBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getShadeBrightness@BarrierBlock@@UEBAMAEBVBlock@@@Z");
    ...
    inline bool canConnect(class Block const& a0, unsigned char a1, class Block const& a2) const{
        bool (BarrierBlock::*rv)(class Block const&, unsigned char, class Block const&) const;
        *((void**)&rv) = dlsym("?canConnect@BarrierBlock@@UEBA_NAEBVBlock@@E0@Z");
