...
public:
    ...
    inline std::unique_ptr<class StructureStart> createStructureStart(class Dimension& a0, class BiomeSource const& a1, class Random& a2, class ChunkPos const& a3, class IPreliminarySurfaceProvider const& a4){
        std::unique_ptr<class StructureStart> (RuinedPortalFeature::*rv)(class Dimension&, class BiomeSource const&, class Random&, class ChunkPos const&, class IPreliminarySurfaceProvider const&);
        *((void**)&rv) = dlsym("?createStructureStart@RuinedPortalFeature@@MEAA?AV?$unique_ptr@VStructureStart@@U?$default_delete@VStructureStart@@@std@@@std@@AEAVDimension@@AEBVBiomeSource@@AEAVRandom@@AEBVChunkPos@@AEBVIPreliminarySurfaceProvider@@@Z");
    ...
    inline bool getNearestGeneratedFeature(class Dimension& a0, class BiomeSource const& a1, class BlockPos const& a2, class BlockPos& a3, class IPreliminarySurfaceProvider const& a4, bool a5){
        bool (RuinedPortalFeature::*rv)(class Dimension&, class BiomeSource const&, class BlockPos const&, class BlockPos&, class IPreliminarySurfaceProvider const&, bool);
        *((void**)&rv) = dlsym("?getNearestGeneratedFeature@RuinedPortalFeature@@UEAA_NAEAVDimension@@AEBVBiomeSource@@AEBVBlockPos@@AEAV4@AEBVIPreliminarySurfaceProvider@@_N@Z");
    ...
    inline bool isFeatureChunk(class BiomeSource const& a0, class Random& a1, class ChunkPos const& a2, unsigned int a3, class IPreliminarySurfaceProvider const& a4){
        bool (RuinedPortalFeature::*rv)(class BiomeSource const&, class Random&, class ChunkPos const&, unsigned int, class IPreliminarySurfaceProvider const&);
        *((void**)&rv) = dlsym("?isFeatureChunk@RuinedPortalFeature@@MEAA_NAEBVBiomeSource@@AEAVRandom@@AEBVChunkPos@@IAEBVIPreliminarySurfaceProvider@@@Z");
