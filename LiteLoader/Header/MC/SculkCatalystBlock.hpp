...
public:
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (SculkCatalystBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@SculkCatalystBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline int getExperienceDrop(class Random& a0) const{
        int (SculkCatalystBlock::*rv)(class Random&) const;
        *((void**)&rv) = dlsym("?getExperienceDrop@SculkCatalystBlock@@UEBAHAEAVRandom@@@Z");
        return (this->*rv)(std::forward<class Random&>(a0));
    }
    inline int getVariant(class Block const& a0) const{
        int (SculkCatalystBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@SculkCatalystBlock@@UEBAHAEBVBlock@@@Z");
    ...
    inline bool playerWillDestroy(class Player& a0, class BlockPos const& a1, class Block const& a2) const{
        bool (SculkCatalystBlock::*rv)(class Player&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?playerWillDestroy@SculkCatalystBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (SculkCatalystBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@SculkCatalystBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
