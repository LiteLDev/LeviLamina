...
public:
    ...
    inline int \/*enum enum Flip*\/ getFaceFlip(unsigned char a0, class Block const& a1) const{
        int \/*enum enum Flip*\/ (FaceDirectionalActorBlock::*rv)(unsigned char, class Block const&) const;
        *((void**)&rv) = dlsym("?getFaceFlip@FaceDirectionalActorBlock@@UEBA?AW4Flip@@EAEBVBlock@@@Z");
    ...
    inline unsigned char getMappedFace(unsigned char a0, class Block const& a1) const{
        unsigned char (FaceDirectionalActorBlock::*rv)(unsigned char, class Block const&) const;
        *((void**)&rv) = dlsym("?getMappedFace@FaceDirectionalActorBlock@@UEBAEEAEBVBlock@@@Z");
        return (this->*rv)(std::forward<unsigned char>(a0), std::forward<class Block const&>(a1));
    }
    inline class Block const& getPlacementBlock(class Actor& a0, class BlockPos const& a1, unsigned char a2, class Vec3 const& a3, int a4) const{
        class Block const& (FaceDirectionalActorBlock::*rv)(class Actor&, class BlockPos const&, unsigned char, class Vec3 const&, int) const;
        *((void**)&rv) = dlsym("?getPlacementBlock@FaceDirectionalActorBlock@@UEBAAEBVBlock@@AEAVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z");
    ...
    inline class Block const& getRenderBlock() const{
        class Block const& (FaceDirectionalActorBlock::*rv)() const;
        *((void**)&rv) = dlsym("?getRenderBlock@FaceDirectionalActorBlock@@UEBAAEBVBlock@@XZ");
        return (this->*rv)();
    }
    */
