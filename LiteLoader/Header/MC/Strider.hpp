...
#include <Global.h>
#include "Animal.hpp"
#define EXTRA_INCLUDE_PART_STRIDER
#include "Extra/StriderAPI.hpp"
#undef EXTRA_INCLUDE_PART_STRIDER
...
public:
    MCAPI Strider(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class OwnerPtrT<struct EntityRefTraits> const&);
};