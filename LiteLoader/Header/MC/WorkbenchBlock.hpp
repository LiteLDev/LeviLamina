...
#define EXTRA_INCLUDE_PART_WORKBENCHBLOCK
#include "Extra/WorkbenchBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_WORKBENCHBLOCK
...
public:
    ...
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (WorkbenchBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@WorkbenchBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
