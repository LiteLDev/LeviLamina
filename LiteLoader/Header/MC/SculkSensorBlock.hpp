...
#define EXTRA_INCLUDE_PART_SCULKSENSORBLOCK
#include "Extra/SculkSensorBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_SCULKSENSORBLOCK
...
public:
    ...
    /*111*/ virtual struct Brightness getLightEmission(class Block const&) const;
    ...
    inline bool shouldConnectToRedstone(class BlockSource& a0, class BlockPos const& a1, int a2) const{
        bool (SculkSensorBlock::*rv)(class BlockSource&, class BlockPos const&, int) const;
        *((void**)&rv) = dlsym("?shouldConnectToRedstone@SculkSensorBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@H@Z");
    ...
    inline bool isSignalSource() const{
        bool (SculkSensorBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isSignalSource@SculkSensorBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline void onPlace(class BlockSource& a0, class BlockPos const& a1) const{
        void (SculkSensorBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?onPlace@SculkSensorBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (SculkSensorBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@SculkSensorBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (SculkSensorBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@SculkSensorBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline void animateTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (SculkSensorBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?animateTick@SculkSensorBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline int getComparatorSignal(class BlockSource& a0, class BlockPos const& a1, class Block const& a2, unsigned char a3) const{
        int (SculkSensorBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&, unsigned char) const;
        *((void**)&rv) = dlsym("?getComparatorSignal@SculkSensorBlock@@UEBAHAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@E@Z");
    ...
    inline struct Brightness getLightEmission(class Block const& a0) const{
        struct Brightness (SculkSensorBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getLightEmission@SculkSensorBlock@@UEBA?AUBrightness@@AEBVBlock@@@Z");
    ...
    inline void setupRedstoneComponent(class BlockSource& a0, class BlockPos const& a1) const{
        void (SculkSensorBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?setupRedstoneComponent@SculkSensorBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (SculkSensorBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@SculkSensorBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1), std::forward<class Random&>(a2));
    }
    */
