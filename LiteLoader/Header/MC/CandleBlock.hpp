...
public:
    ...
    inline int _getNumCandles(class Block const& a0) const{
        int (CandleBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?_getNumCandles@CandleBlock@@MEBAHAEBVBlock@@@Z");
    ...
    inline void _iterateCandles(class Block const& a0, class BlockPos const& a1, class std::function<void (class Vec3 const&, int)> a2) const{
        void (CandleBlock::*rv)(class Block const&, class BlockPos const&, class std::function<void (class Vec3 const&, int)>) const;
        *((void**)&rv) = dlsym("?_iterateCandles@CandleBlock@@MEBAXAEBVBlock@@AEBVBlockPos@@V?$function@$$A6AXAEBVVec3@@H@Z@std@@@Z");
    ...
    inline void _tryLightOnFire(class BlockSource& a0, class BlockPos const& a1) const{
        void (CandleBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?_tryLightOnFire@CandleBlock@@MEBAXAEAVBlockSource@@AEBVBlockPos@@@Z");
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (CandleBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@CandleBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline int getResourceCount(class Randomize& a0, class Block const& a1, int a2) const{
        int (CandleBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceCount@CandleBlock@@UEBAHAEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (CandleBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@CandleBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
        return (this->*rv)(std::forward<class Randomize&>(a0), std::forward<class Block const&>(a1), std::forward<int>(a2));
    }
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (CandleBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@CandleBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
