...
public:
    ...
    /*8*/ virtual bool isResourcePackLoaded(struct PackIdVersion const&, int /*enum PackOrigin*/ const&);
    ...
    /*27*/ virtual class Core::PathBuffer<std::string> const getKnownPacksPath(int /*enum KnownPackType*/) const;
    ...
    /*37*/ virtual std::vector<class ResourcePack*> getPacksByResourceLocation(int /*enum PackOrigin*/) const;
    /*38*/ virtual std::vector<class ResourcePack*> getPacksByType(int /*enum PackType*/) const;
    /*39*/ virtual void addKnownPackFromImport(class PackManifest const&);
    /*40*/ virtual void addInvalidPack(class ResourceLocation const&, int /*enum PackType*/);
    /*41*/ virtual std::vector<class ResourceLocation> const& getInvalidPacks(int /*enum PackType*/) const;
