...
public:
    ...
    virtual class Core::PathBuffer<std::string> const getKnownPacksPath(int /*enum KnownPackType*/) const;
    ...
    virtual class IContentKeyProvider const& getKeyProvider() const;
    ...
    virtual std::vector<class ResourcePack*> getPacksByResourceLocation(int /*enum PackOrigin*/) const;
    virtual std::vector<class ResourcePack*> getPacksByType(int /*enum PackType*/) const;
    ...
    virtual std::vector<class ResourceLocation> const& getInvalidPacks(int /*enum PackType*/) const;
