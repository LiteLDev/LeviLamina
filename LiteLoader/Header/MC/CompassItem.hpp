...
public:
    ...
    inline int getEnchantSlot() const{
        int (CompassItem::*rv)() const;
        *((void**)&rv) = dlsym("?getEnchantSlot@CompassItem@@UEBAHXZ");
        return (this->*rv)();
    }
    inline struct TextureUVCoordinateSet const& getIcon(class ItemStackBase const& a0, int a1, bool a2) const{
        struct TextureUVCoordinateSet const& (CompassItem::*rv)(class ItemStackBase const&, int, bool) const;
        *((void**)&rv) = dlsym("?getIcon@CompassItem@@UEBAAEBUTextureUVCoordinateSet@@AEBVItemStackBase@@H_N@Z");
    ...
    inline bool _useOn(class ItemStack& a0, class Actor& a1, class BlockPos a2, unsigned char a3, float a4, float a5, float a6) const{
        bool (CompassItem::*rv)(class ItemStack&, class Actor&, class BlockPos, unsigned char, float, float, float) const;
        *((void**)&rv) = dlsym("?_useOn@CompassItem@@EEBA_NAEAVItemStack@@AEAVActor@@VBlockPos@@EMMM@Z");
    ...
    inline int getAnimationFrameFor(class Mob* a0, bool a1, class ItemStack const* a2, bool a3) const{
        int (CompassItem::*rv)(class Mob*, bool, class ItemStack const*, bool) const;
        *((void**)&rv) = dlsym("?getAnimationFrameFor@CompassItem@@UEBAHPEAVMob@@_NPEBVItemStack@@_N@Z");
