...
#define EXTRA_INCLUDE_PART_GILDEDBLACKSTONE
#include "Extra/GildedBlackstoneAPI.hpp"
#undef EXTRA_INCLUDE_PART_GILDEDBLACKSTONE
...
public:
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (GildedBlackstone::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@GildedBlackstone@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline class ItemInstance getSilkTouchItemInstance(class Block const& a0) const{
        class ItemInstance (GildedBlackstone::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getSilkTouchItemInstance@GildedBlackstone@@UEBA?AVItemInstance@@AEBVBlock@@@Z");
