...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_ENDEREYEITEM
#include "Extra/EnderEyeItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_ENDEREYEITEM
...
public:
    ...
    inline bool isThrowable() const{
        bool (EnderEyeItem::*rv)() const;
        *((void**)&rv) = dlsym("?isThrowable@EnderEyeItem@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline class ItemStack& use(class ItemStack& a0, class Player& a1) const{
        class ItemStack& (EnderEyeItem::*rv)(class ItemStack&, class Player&) const;
        *((void**)&rv) = dlsym("?use@EnderEyeItem@@UEBAAEAVItemStack@@AEAV2@AEAVPlayer@@@Z");
