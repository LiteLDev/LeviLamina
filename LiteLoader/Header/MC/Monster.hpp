...
#include <Global.h>
#include "Mob.hpp"
#define EXTRA_INCLUDE_PART_MONSTER
#include "Extra/MonsterAPI.hpp"
#undef EXTRA_INCLUDE_PART_MONSTER
...
public:
    MCAPI Monster(class ActorDefinitionGroup*, struct ActorDefinitionIdentifier const&, class OwnerPtrT<struct EntityRefTraits> const&);
};