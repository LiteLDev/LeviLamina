...
#include "Item.hpp"
#include "Json.hpp"
#define EXTRA_INCLUDE_PART_CLOCKITEM
#include "Extra/ClockItemAPI.hpp"
#undef EXTRA_INCLUDE_PART_CLOCKITEM
...
public:
    ...
    inline int getAnimationFrameFor(class Mob* a0, bool a1, class ItemStack const* a2, bool a3) const{
        int (ClockItem::*rv)(class Mob*, bool, class ItemStack const*, bool) const;
        *((void**)&rv) = dlsym("?getAnimationFrameFor@ClockItem@@UEBAHPEAVMob@@_NPEBVItemStack@@_N@Z");
    ...
    inline struct TextureUVCoordinateSet const& getIcon(class ItemStackBase const& a0, int a1, bool a2) const{
        struct TextureUVCoordinateSet const& (ClockItem::*rv)(class ItemStackBase const&, int, bool) const;
        *((void**)&rv) = dlsym("?getIcon@ClockItem@@UEBAAEBUTextureUVCoordinateSet@@AEBVItemStackBase@@H_N@Z");
