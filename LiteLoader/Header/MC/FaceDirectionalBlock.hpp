...
public:
    ...
    inline int \/*enum enum Flip*\/ getFaceFlip(unsigned char a0, class Block const& a1) const{
        int \/*enum enum Flip*\/ (FaceDirectionalBlock::*rv)(unsigned char, class Block const&) const;
        *((void**)&rv) = dlsym("?getFaceFlip@FaceDirectionalBlock@@UEBA?AW4Flip@@EAEBVBlock@@@Z");
    ...
    inline unsigned char getMappedFace(unsigned char a0, class Block const& a1) const{
        unsigned char (FaceDirectionalBlock::*rv)(unsigned char, class Block const&) const;
        *((void**)&rv) = dlsym("?getMappedFace@FaceDirectionalBlock@@UEBAEEAEBVBlock@@@Z");
        return (this->*rv)(std::forward<unsigned char>(a0), std::forward<class Block const&>(a1));
    }
    inline class Block const& getPlacementBlock(class Actor& a0, class BlockPos const& a1, unsigned char a2, class Vec3 const& a3, int a4) const{
        class Block const& (FaceDirectionalBlock::*rv)(class Actor&, class BlockPos const&, unsigned char, class Vec3 const&, int) const;
        *((void**)&rv) = dlsym("?getPlacementBlock@FaceDirectionalBlock@@UEBAAEBVBlock@@AEAVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z");
    ...
    inline class Block const& getRenderBlock() const{
        class Block const& (FaceDirectionalBlock::*rv)() const;
        *((void**)&rv) = dlsym("?getRenderBlock@FaceDirectionalBlock@@UEBAAEBVBlock@@XZ");
        return (this->*rv)();
    }
    inline bool isValidAuxValue(int a0) const{
        bool (FaceDirectionalBlock::*rv)(int) const;
        *((void**)&rv) = dlsym("?isValidAuxValue@FaceDirectionalBlock@@UEBA_NH@Z");
