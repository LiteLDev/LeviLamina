...
public:
    ...
    inline bool canBeUsedInCommands(class BaseGameVersion const& a0) const{
        bool (ElementBlock::*rv)(class BaseGameVersion const&) const;
        *((void**)&rv) = dlsym("?canBeUsedInCommands@ElementBlock@@UEBA_NAEBVBaseGameVersion@@@Z");
        return (this->*rv)(std::forward<class BaseGameVersion const&>(a0));
    }
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (ElementBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@ElementBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
    ...
    inline class mce::Color getMapColor(class BlockSource& a0, class BlockPos const& a1) const{
        class mce::Color (ElementBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getMapColor@ElementBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline class Block const* tryLegacyUpgrade(unsigned short a0) const{
        class Block const* (ElementBlock::*rv)(unsigned short) const;
        *((void**)&rv) = dlsym("?tryLegacyUpgrade@ElementBlock@@UEBAPEBVBlock@@G@Z");
