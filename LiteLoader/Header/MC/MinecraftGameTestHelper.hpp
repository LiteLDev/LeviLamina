...
public:
    ...
    /*42*/ virtual class std::optional<struct gametest::GameTestError> assertEntityHasArmor(struct ActorDefinitionIdentifier const&, int /*enum ArmorSlot*/, std::string const&, int, class BlockPos const&, bool);
