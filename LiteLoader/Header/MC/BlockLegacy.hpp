...
public:
    ...
    /*50*/ virtual bool canHurtAndBreakItem() const;
    ...
    /*65*/ virtual float getThickness() const;
    /*66*/ virtual float getFlexibility(class BlockSource &, class BlockPos const &) const;
    /*67*/ virtual bool checkIsPathable(class Actor &, class BlockPos const &, class BlockPos const &) const;
    /*68*/ virtual bool shouldDispense(class BlockSource &, class Container &) const;
    ...
    /*83*/ virtual bool ignoreEntitiesOnPistonMove(class Block const &) const;
    ...
    /*111*/ virtual bool shouldTriggerOnStandOn(class Actor &, class BlockPos const &) const;
    ...
    /*118*/ virtual void executeEvent(std::string const &, class RenderParams &) const;
    ...
    /*120*/ virtual bool executeTrigger(class DefinitionTrigger const &, class RenderParams &) const;
    ...
    /*155*/ virtual class BlockLegacy & addState(class ItemState const &);
    /*156*/ virtual class BlockLegacy & addState(class ItemState const &, unsigned __int64);
    ...
    /*162*/ virtual class Block const * tryGetUninfested(class Block const &) const;
    ...
    /*186*/ virtual class mce::Color getMapColor() const;
