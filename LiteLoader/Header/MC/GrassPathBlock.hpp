...
public:
    ...
    inline bool canContainLiquid() const{
        bool (GrassPathBlock::*rv)() const;
        *((void**)&rv) = dlsym("?canContainLiquid@GrassPathBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool canBeOriginalSurface() const{
        bool (GrassPathBlock::*rv)() const;
        *((void**)&rv) = dlsym("?canBeOriginalSurface@GrassPathBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (GrassPathBlock::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@GrassPathBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (GrassPathBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@GrassPathBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (GrassPathBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@GrassPathBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
    ...
    inline class AABB const& getAABB(class BlockSource const& a0, class BlockPos const& a1, class Block const& a2, class AABB& a3, bool a4) const{
        class AABB const& (GrassPathBlock::*rv)(class BlockSource const&, class BlockPos const&, class Block const&, class AABB&, bool) const;
        *((void**)&rv) = dlsym("?getAABB@GrassPathBlock@@UEBAAEBVAABB@@AEBVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z");
    ...
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (GrassPathBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@GrassPathBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline bool canSurvive(class BlockSource& a0, class BlockPos const& a1) const{
        bool (GrassPathBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?canSurvive@GrassPathBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
    ...
    inline bool tryToTill(class BlockSource& a0, class BlockPos const& a1, class Actor& a2, class ItemStack& a3) const{
        bool (GrassPathBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor&, class ItemStack&) const;
        *((void**)&rv) = dlsym("?tryToTill@GrassPathBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEAVActor@@AEAVItemStack@@@Z");
