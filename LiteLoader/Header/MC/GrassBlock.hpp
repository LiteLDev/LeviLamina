...
#define EXTRA_INCLUDE_PART_GRASSBLOCK
#include "Extra/GrassBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_GRASSBLOCK
...
public:
    ...
    /*72*/ virtual int calcVariant(class BlockSource&, class BlockPos const&, class mce::Color const&) const;
    ...
    inline bool canBeOriginalSurface() const{
        ...
        *((void**)&rv) = dlsym("?canBeOriginalSurface@GrassBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    ...
    inline bool canBeFertilized(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        bool (GrassBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?canBeFertilized@GrassBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (GrassBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@GrassBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (GrassBlock::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@GrassBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
    ...
    inline bool use(class Player& a0, class BlockPos const& a1, unsigned char a2) const{
        bool (GrassBlock::*rv)(class Player&, class BlockPos const&, unsigned char) const;
        *((void**)&rv) = dlsym("?use@GrassBlock@@UEBA_NAEAVPlayer@@AEBVBlockPos@@E@Z");
    ...
    inline int calcVariant(class BlockSource& a0, class BlockPos const& a1, class mce::Color const& a2) const{
        int (GrassBlock::*rv)(class BlockSource&, class BlockPos const&, class mce::Color const&) const;
        *((void**)&rv) = dlsym("?calcVariant@GrassBlock@@UEBAHAEAVBlockSource@@AEBVBlockPos@@AEBVColor@mce@@@Z");
    ...
    inline int getColor(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        int (GrassBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?getColor@GrassBlock@@UEBAHAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1), std::forward<class Block const&>(a2));
    }
    inline int getColor(class Block const& a0) const{
        int (GrassBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getColor@GrassBlock@@UEBAHAEBVBlock@@@Z");
    ...
    inline class mce::Color getMapColor(class BlockSource& a0, class BlockPos const& a1) const{
        class mce::Color (GrassBlock::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?getMapColor@GrassBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z");
    ...
    inline bool onFertilized(class BlockSource& a0, class BlockPos const& a1, class Actor* a2, int \/*enum enum FertilizerType*\/ a3) const{
        bool (GrassBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor*, int \/*enum enum FertilizerType*\/) const;
        *((void**)&rv) = dlsym("?onFertilized@GrassBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@PEAVActor@@W4FertilizerType@@@Z");
    ...
    inline void randomTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (GrassBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?randomTick@GrassBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline bool tryToTill(class BlockSource& a0, class BlockPos const& a1, class Actor& a2, class ItemStack& a3) const{
        bool (GrassBlock::*rv)(class BlockSource&, class BlockPos const&, class Actor&, class ItemStack&) const;
        *((void**)&rv) = dlsym("?tryToTill@GrassBlock@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@AEAVActor@@AEAVItemStack@@@Z");
