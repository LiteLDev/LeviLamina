...
public:
    ...
    inline void load(class Level& a0, class CompoundTag const& a1, class DataLoadHelper& a2){
        void (NetherReactorBlockActor::*rv)(class Level&, class CompoundTag const&, class DataLoadHelper&);
        *((void**)&rv) = dlsym("?load@NetherReactorBlockActor@@UEAAXAEAVLevel@@AEBVCompoundTag@@AEAVDataLoadHelper@@@Z");
    ...
    inline bool save(class CompoundTag& a0) const{
        bool (NetherReactorBlockActor::*rv)(class CompoundTag&) const;
        *((void**)&rv) = dlsym("?save@NetherReactorBlockActor@@UEBA_NAEAVCompoundTag@@@Z");
