...
public:
    ...
    inline class ContainerScreenContext _postInit(){
        class ContainerScreenContext (LabTableContainerManagerModel::*rv)();
        *((void**)&rv) = dlsym("?_postInit@LabTableContainerManagerModel@@MEAA?AVContainerScreenContext@@XZ");
        return (this->*rv)();
    }
    inline std::vector<class ItemStack> getItemCopies() const{
        std::vector<class ItemStack> (LabTableContainerManagerModel::*rv)() const;
        *((void**)&rv) = dlsym("?getItemCopies@LabTableContainerManagerModel@@UEBA?AV?$vector@VItemStack@@V?$allocator@VItemStack@@@std@@@std@@XZ");
        return (this->*rv)();
    }
    inline class ItemStack const& getSlot(int a0) const{
        class ItemStack const& (LabTableContainerManagerModel::*rv)(int) const;
        *((void**)&rv) = dlsym("?getSlot@LabTableContainerManagerModel@@UEBAAEBVItemStack@@H@Z");
        return (this->*rv)(std::forward<int>(a0));
    }
    inline bool isValid(float a0){
        bool (LabTableContainerManagerModel::*rv)(float);
        *((void**)&rv) = dlsym("?isValid@LabTableContainerManagerModel@@UEAA_NM@Z");
        return (this->*rv)(std::forward<float>(a0));
    }
    inline void setSlot(int a0, class ItemStack const& a1, bool a2){
        void (LabTableContainerManagerModel::*rv)(int, class ItemStack const&, bool);
        *((void**)&rv) = dlsym("?setSlot@LabTableContainerManagerModel@@UEAAXHAEBVItemStack@@_N@Z");
