...
#define EXTRA_INCLUDE_PART_SPOREBLOSSOM
#include "Extra/SporeBlossomAPI.hpp"
#undef EXTRA_INCLUDE_PART_SPOREBLOSSOM
...
public:
    ...
    inline bool canBeSilkTouched() const{
        bool (SporeBlossom::*rv)() const;
        *((void**)&rv) = dlsym("?canBeSilkTouched@SporeBlossom@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool canContainLiquid() const{
        bool (SporeBlossom::*rv)() const;
        *((void**)&rv) = dlsym("?canContainLiquid@SporeBlossom@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline bool canSurvive(class BlockSource& a0, class BlockPos const& a1) const{
        bool (SporeBlossom::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?canSurvive@SporeBlossom@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    inline void neighborChanged(class BlockSource& a0, class BlockPos const& a1, class BlockPos const& a2) const{
        void (SporeBlossom::*rv)(class BlockSource&, class BlockPos const&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?neighborChanged@SporeBlossom@@UEBAXAEAVBlockSource@@AEBVBlockPos@@1@Z");
    ...
    inline class AABB const& getAABB(class BlockSource const& a0, class BlockPos const& a1, class Block const& a2, class AABB& a3, bool a4) const{
        class AABB const& (SporeBlossom::*rv)(class BlockSource const&, class BlockPos const&, class Block const&, class AABB&, bool) const;
        *((void**)&rv) = dlsym("?getAABB@SporeBlossom@@UEBAAEBVAABB@@AEBVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAV2@_N@Z");
    ...
    inline void tick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (SporeBlossom::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?tick@SporeBlossom@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline void animateTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (SporeBlossom::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?animateTick@SporeBlossom@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1), std::forward<class Random&>(a2));
    }
    inline bool mayPlace(class BlockSource& a0, class BlockPos const& a1) const{
        bool (SporeBlossom::*rv)(class BlockSource&, class BlockPos const&) const;
        *((void**)&rv) = dlsym("?mayPlace@SporeBlossom@@UEBA_NAEAVBlockSource@@AEBVBlockPos@@@Z");
        return (this->*rv)(std::forward<class BlockSource&>(a0), std::forward<class BlockPos const&>(a1));
    }
    */
