...
#define EXTRA_INCLUDE_PART_COLOREDTORCHBLOCK
#include "Extra/ColoredTorchBlockAPI.hpp"
#undef EXTRA_INCLUDE_PART_COLOREDTORCHBLOCK
...
public:
    ...
    /*38*/ virtual bool canBeUsedInCommands(class BaseGameVersion const&) const;
    ...
    /*110*/ virtual int /*enum enum BlockRenderLayer*/ getRenderLayer(class Block const&, class BlockSource&, class BlockPos const&) const;
    ...
    inline bool canBeUsedInCommands(class BaseGameVersion const& a0) const{
        bool (ColoredTorchBlock::*rv)(class BaseGameVersion const&) const;
        *((void**)&rv) = dlsym("?canBeUsedInCommands@ColoredTorchBlock@@UEBA_NAEBVBaseGameVersion@@@Z");
        return (this->*rv)(std::forward<class BaseGameVersion const&>(a0));
    }
    inline bool isAuxValueRelevantForPicking() const{
        bool (ColoredTorchBlock::*rv)() const;
        *((void**)&rv) = dlsym("?isAuxValueRelevantForPicking@ColoredTorchBlock@@UEBA_NXZ");
        return (this->*rv)();
    }
    inline void animateTick(class BlockSource& a0, class BlockPos const& a1, class Random& a2) const{
        void (ColoredTorchBlock::*rv)(class BlockSource&, class BlockPos const&, class Random&) const;
        *((void**)&rv) = dlsym("?animateTick@ColoredTorchBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEAVRandom@@@Z");
    ...
    inline class ItemInstance asItemInstance(class BlockSource& a0, class BlockPos const& a1, class Block const& a2) const{
        class ItemInstance (ColoredTorchBlock::*rv)(class BlockSource&, class BlockPos const&, class Block const&) const;
        *((void**)&rv) = dlsym("?asItemInstance@ColoredTorchBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z");
    ...
    inline std::string buildDescriptionId(class Block const& a0) const{
        std::string (ColoredTorchBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?buildDescriptionId@ColoredTorchBlock@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVBlock@@@Z");
    ...
    inline class Block const& getPlacementBlock(class Actor& a0, class BlockPos const& a1, unsigned char a2, class Vec3 const& a3, int a4) const{
        class Block const& (ColoredTorchBlock::*rv)(class Actor&, class BlockPos const&, unsigned char, class Vec3 const&, int) const;
        *((void**)&rv) = dlsym("?getPlacementBlock@ColoredTorchBlock@@UEBAAEBVBlock@@AEAVActor@@AEBVBlockPos@@EAEBVVec3@@H@Z");
    ...
    inline class ItemInstance getResourceItem(class Randomize& a0, class Block const& a1, int a2) const{
        class ItemInstance (ColoredTorchBlock::*rv)(class Randomize&, class Block const&, int) const;
        *((void**)&rv) = dlsym("?getResourceItem@ColoredTorchBlock@@UEBA?AVItemInstance@@AEAVRandomize@@AEBVBlock@@H@Z");
    ...
    inline int getVariant(class Block const& a0) const{
        int (ColoredTorchBlock::*rv)(class Block const&) const;
        *((void**)&rv) = dlsym("?getVariant@ColoredTorchBlock@@UEBAHAEBVBlock@@@Z");
        return (this->*rv)(std::forward<class Block const&>(a0));
    }
    */
