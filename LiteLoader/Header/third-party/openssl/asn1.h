...
#define B_ASN1_PRINTABLE                                                                    \
    B_ASN1_NUMERICSTRING | B_ASN1_PRINTABLESTRING | B_ASN1_T61STRING | B_ASN1_IA5STRING |   \
        B_ASN1_BIT_STRING | B_ASN1_UNIVERSALSTRING | B_ASN1_BMPSTRING | B_ASN1_UTF8STRING | \
        B_ASN1_SEQUENCE | B_ASN1_UNKNOWN

#define B_ASN1_DIRECTORYSTRING                                                                  \
    B_ASN1_PRINTABLESTRING | B_ASN1_TELETEXSTRING | B_ASN1_BMPSTRING | B_ASN1_UNIVERSALSTRING | \
        B_ASN1_UTF8STRING
...
#define ASN1_dup_of_const(type, i2d, d2i, x)                                      \
    ((type *)ASN1_dup(CHECKED_I2D_OF(const type, i2d), CHECKED_D2I_OF(type, d2i), \
...
#    define ASN1_d2i_fp_of(type, xnew, d2i, in, x)                                      \
        ((type *)ASN1_d2i_fp(CHECKED_NEW_OF(type, xnew), CHECKED_D2I_OF(type, d2i), in, \
...
#define ASN1_d2i_bio_of(type, xnew, d2i, in, x)                                      \
    ((type *)ASN1_d2i_bio(CHECKED_NEW_OF(type, xnew), CHECKED_D2I_OF(type, d2i), in, \
                          CHECKED_PPTR_OF(type, x)))
