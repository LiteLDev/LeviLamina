...
typedef int (*tls_session_secret_cb_fn)(SSL *s,
                                        void *secret,
                                        int *secret_len,
...
typedef int (*custom_ext_add_cb)(SSL *s,
...
typedef void (*custom_ext_free_cb)(SSL *s,
                                   unsigned int ext_type,
                                   const unsigned char *out,
                                   void *add_arg);

typedef int (*custom_ext_parse_cb)(SSL *s,
                                   unsigned int ext_type,
...
typedef void (*SSL_custom_ext_free_cb_ex)(SSL *s,
                                          unsigned int ext_type,
                                          unsigned int context,
                                          const unsigned char *out,
                                          void *add_arg);
...
#define SSL_OP_ALL                                                      \
    (SSL_OP_CRYPTOPRO_TLSEXT_BUG | SSL_OP_DONT_INSERT_EMPTY_FRAGMENTS | \
     SSL_OP_LEGACY_SERVER_CONNECT | SSL_OP_TLSEXT_PADDING | SSL_OP_SAFARI_ECDHE_ECDSA_BUG)
...
typedef int (*SSL_psk_find_session_cb_func)(SSL *ssl,
                                            ...
                                            size_t identity_len,
                                            SSL_SESSION **sess);
typedef int (*SSL_psk_use_session_cb_func)(SSL *ssl,
                                           const EVP_MD *md,
...
__owur int SSL_get_changed_async_fds(SSL *s,
                                     OSSL_ASYNC_FD *addfd,
                                     size_t *numaddfds,
                                     OSSL_ASYNC_FD *delfd,
                                     size_t *numdelfds);
