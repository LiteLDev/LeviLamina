...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_MANGROVEROOTSBLOCK
public:
    class MangroveRootsBlock& operator=(class MangroveRootsBlock const &) = delete;
    MangroveRootsBlock(class MangroveRootsBlock const &) = delete;
