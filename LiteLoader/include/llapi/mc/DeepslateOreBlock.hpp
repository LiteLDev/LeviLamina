...
/**
 * @brief MC class DeepslateOreBlock.
 *
 */
...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_DEEPSLATEOREBLOCK
public:
    class DeepslateOreBlock& operator=(class DeepslateOreBlock const &) = delete;
    DeepslateOreBlock(class DeepslateOreBlock const &) = delete;
...
public:
     ...
     * @hash   840681484
     * @vftbl  104
     * @symbol ?spawnResources@DeepslateOreBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@PEAV?$vector@PEBVItem@@V?$allocator@PEBVItem@@@std@@@std@@MH@Z
     */
