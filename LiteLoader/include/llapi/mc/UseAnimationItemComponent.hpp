/**
 * @file  UseAnimationItemComponent.hpp
 *
 */
#pragma once
...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_USEANIMATIONITEMCOMPONENT
public:
    class UseAnimationItemComponent& operator=(class UseAnimationItemComponent const &) = delete;
    UseAnimationItemComponent(class UseAnimationItemComponent const &) = delete;
#endif
...
public:
    ...
    /**
     * @vftbl 9
     * @symbol ?_initializeComponent\@UseAnimationItemComponent\@\@UEBAXXZ
     */
