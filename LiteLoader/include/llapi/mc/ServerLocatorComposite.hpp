...
public:
    ...
    /**
     * @symbol ?setNetherNetServerLocator\@ServerLocatorComposite\@\@QEAAX$$QEAV?$NonOwnerPointer\@UNetherNetConnector\@\@\@Bedrock\@\@\@Z
     */
    MCAPI void setNetherNetServerLocator(class Bedrock::NonOwnerPointer<struct NetherNetConnector> &&);
