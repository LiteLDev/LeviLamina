...
public:
    ...
    /**
     * @vftbl 6
     * @symbol ?getCollisionShape\@SoulSandBlock\@\@UEBA?AVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@V?$optional_ref\@$$CBVGetCollisionShapeInterface\@\@\@\@\@Z
     */
    ...
    /**
     * @vftbl 7
     * @symbol ?getCollisionShapeForCamera\@SoulSandBlock\@\@UEBA_NAEAVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
