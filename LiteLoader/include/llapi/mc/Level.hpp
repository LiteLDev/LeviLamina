...
#define ENABLE_VIRTUAL_FAKESYMBOL_LEVEL
     ...
     */
    LIAPI static Actor* spawnMob(Vec3 const& pos, int dimId, std::string typeName);

    LIAPI static Actor* spawnItem(Vec3 const& pos, int dimId, ItemStack* item);
    LIAPI static bool createExplosion(Vec3 const& pos, int dimId, Actor* source, float radius, bool createFire,
                                      bool canBreak, float maxResistance = 3.40282347e+38);
     ...
     */
    LIAPI static Actor* cloneMob(Vec3 const& pos, int dimId, Actor* ac);
     ...
     */
    LIAPI static Block const* getBlock(const BlockPos& pos, int dimId);
    LIAPI static Block const* getBlock(const BlockPos& pos, BlockSource* blockSource);
    LIAPI static Block const* getBlockEx(const BlockPos& pos, int dimId);
     ...
     */
    LIAPI static bool setBlock(const BlockPos& pos, int dim, Block const* block);
    ...
    LIAPI static bool hasContainer(BlockPos const& pos, int dim);
    LIAPI static Container* getContainer(BlockPos const& pos, int dim);
    ...
    LIAPI static void broadcastTitle(const string& text, TitleType Type, int FadeInDuration, int RemainDuration,
                                     int FadeOutDuration);

    [[deprecated("This is a typo. Use Level::sendPacketForAllPlayers")]] LIAPI static void
        sendPacketForAllPlayer(Packet& pkt);
...
public:
     ...
     */
    MCVAPI void forEachUser(class std::function<bool (class EntityContext &)>);
    /**
     * @symbol ?forEachUser\@Level\@\@UEBAXV?$function\@$$A6A_NAEBVEntityContext\@\@\@Z\@std\@\@\@Z
     */
    MCVAPI void forEachUser(class std::function<bool (class EntityContext const &)>) const;
    /**
     ...
     */
    MCVAPI class std::weak_ptr<class TrimMaterialRegistry const> getTrimMaterialRegistry() const;
    /**
     * @symbol ?getTrimMaterialRegistry\@Level\@\@UEAA?AV?$weak_ptr\@VTrimMaterialRegistry\@\@\@std\@\@XZ
     */
    MCVAPI class std::weak_ptr<class TrimMaterialRegistry> getTrimMaterialRegistry();
    /**
     * @symbol ?getTrimPatternRegistry\@Level\@\@UEBA?AV?$weak_ptr\@$$CBVTrimPatternRegistry\@\@\@std\@\@XZ
     */
    MCVAPI class std::weak_ptr<class TrimPatternRegistry const> getTrimPatternRegistry() const;
    /**
     * @symbol ?getTrimPatternRegistry\@Level\@\@UEAA?AV?$weak_ptr\@VTrimPatternRegistry\@\@\@std\@\@XZ
     */
    MCVAPI class std::weak_ptr<class TrimPatternRegistry> getTrimPatternRegistry();
    /**
     ...
     */
    MCVAPI void playSound(class IConstBlockSource const &, enum class LevelSoundEvent, class Vec3 const &, int, struct ActorDefinitionIdentifier const &, bool, bool);
    /**
    ...
    /**
     * @symbol ?getLevelSoundManager\@Level\@\@QEAA?AV?$not_null\@V?$NonOwnerPointer\@VLevelSoundManager\@\@\@Bedrock\@\@\@gsl\@\@XZ
     */
    MCAPI class gsl::not_null<class Bedrock::NonOwnerPointer<class LevelSoundManager>> getLevelSoundManager();
    /**
     ...
     */
    MCAPI class std::shared_ptr<class ServerLevelEventCoordinator> getServerLevelEventCoordinatorAsSharedPointer();
    /**
     ...
     */
    MCAPI void setClientLevelEventCoordinator(class std::shared_ptr<class ClientLevelEventCoordinator> &&);
    /**
     ...
     */
    MCAPI void setServerLevelEventCoordinator(class std::shared_ptr<class ServerLevelEventCoordinator> &&);
    /**
