...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_NETHERSPROUTSBLOCK
public:
    class NetherSproutsBlock& operator=(class NetherSproutsBlock const &) = delete;
    NetherSproutsBlock(class NetherSproutsBlock const &) = delete;
...
public:
    ...
    /**
     * @vftbl 6
     * @symbol ?getCollisionShape\@NetherSproutsBlock\@\@UEBA?AVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@V?$optional_ref\@$$CBVGetCollisionShapeInterface\@\@\@\@\@Z
     */
    ...
    /**
     * @vftbl 10
     * @symbol ?getOutline\@NetherSproutsBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEAV2\@\@Z
     */
