/**
 * @file  UseDurationItemComponent.hpp
 *
 */
#pragma once
...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_USEDURATIONITEMCOMPONENT
public:
    class UseDurationItemComponent& operator=(class UseDurationItemComponent const &) = delete;
    UseDurationItemComponent(class UseDurationItemComponent const &) = delete;
...
public:
    ...
    /**
     * @vftbl 9
     * @symbol ?_initializeComponent\@UseDurationItemComponent\@\@UEBAXXZ
     */
