...
public:
    ...
    /**
     * @symbol ?_tickServerPlayerFallDamageSystem\@ServerPlayerFallDamageSystem\@\@SAXV?$ViewT\@VStrictEntityContext\@\@VEntityRegistryBase\@\@U?$Include\@V?$FlagComponent\@UActorMovementTickNeededFlag\@\@\@\@V?$FlagComponent\@UServerPlayerComponentFlag\@\@\@\@\@\@$$CBUAbilitiesComponent\@\@$$CBUSynchedActorDataComponent\@\@$$CBUStateVectorComponent\@\@UFallDistanceComponent\@\@V?$Optional\@$$CBV?$FlagComponent\@UWasOnGroundFlag\@\@\@\@\@\@V?$Optional\@$$CBV?$FlagComponent\@UOnGroundFlag\@\@\@\@\@\@V?$Optional\@$$CBV?$FlagComponent\@UHasTeleportedFlag\@\@\@\@\@\@\@\@V?$EntityModifierT\@VEntityRegistryBase\@\@VStrictEntityContext\@\@V?$FlagComponent\@UHasTeleportedFlag\@\@\@\@V?$FlagComponent\@USendPlayerOnGroundRequestFlag\@\@\@\@UCheckFallDamageRequestComponent\@\@V?$FlagComponent\@UWasOnGroundFlag\@\@\@\@\@\@\@Z
     */
    MCAPI static void _tickServerPlayerFallDamageSystem(class ViewT<class StrictEntityContext, class EntityRegistryBase, struct Include<class FlagComponent<struct ActorMovementTickNeededFlag>, class FlagComponent<struct ServerPlayerComponentFlag>>, struct AbilitiesComponent const, struct SynchedActorDataComponent const, struct StateVectorComponent const, struct FallDistanceComponent, class Optional<class FlagComponent<struct WasOnGroundFlag> const>, class Optional<class FlagComponent<struct OnGroundFlag> const>, class Optional<class FlagComponent<struct HasTeleportedFlag> const>>, class EntityModifierT<class EntityRegistryBase, class StrictEntityContext, class FlagComponent<struct HasTeleportedFlag>, class FlagComponent<struct SendPlayerOnGroundRequestFlag>, struct CheckFallDamageRequestComponent, class FlagComponent<struct WasOnGroundFlag>>);
    /**
