...
public:
    ...
    /**
     * @vftbl 6
     * @symbol ?getCollisionShape\@NetherFungusBlock\@\@UEBA?AVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@V?$optional_ref\@$$CBVGetCollisionShapeInterface\@\@\@\@\@Z
     */
    ...
    /**
     * @vftbl 10
     * @symbol ?getOutline\@NetherFungusBlock\@\@UEBAAEBVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@AEAV2\@\@Z
     */
