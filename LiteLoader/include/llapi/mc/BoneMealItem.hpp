...
public:
    class BoneMealItem& operator=(class BoneMealItem const &) = delete;
    BoneMealItem(class BoneMealItem const &) = delete;
    BoneMealItem() = delete;
#endif
...
public:
    ...
    /**
     * @vftbl 95
     * @symbol ?buildDescriptionId\@BoneMealItem\@\@UEBA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@AEBVItemDescriptor\@\@PEBVCompoundTag\@\@\@Z
     */
    ...
    /**
     * @vftbl 119
     * @symbol ?setIconInfo\@BoneMealItem\@\@UEAAAEAVItem\@\@AEBV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@H\@Z
     */
