...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_AZALEALEAVESBLOCK
public:
    class AzaleaLeavesBlock& operator=(class AzaleaLeavesBlock const &) = delete;
    AzaleaLeavesBlock(class AzaleaLeavesBlock const &) = delete;
...
public:
    ...
    /**
     * @vftbl 180
     * @symbol ?getRenderLayer\@AzaleaLeavesBlock\@\@UEBA?AW4BlockRenderLayer\@\@AEBVBlock\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    virtual enum class BlockRenderLayer getRenderLayer(class Block const &, class BlockSource &, class BlockPos const &) const;
    /**
     * @vftbl 185
     * @symbol ?getMapColor\@AzaleaLeavesBlock\@\@UEBA?AVColor\@mce\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@\@Z
     */
