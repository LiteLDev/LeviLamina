...
#undef AFTER_EXTRA
     ...
     */
    MCAPI bool decorateLargeFeature(enum class GeneratorType, unsigned int const &, class BlockVolumeTarget &, class Random &, class gsl::span<struct BiomeDecorationFeature, -1>, class ChunkPos const &, std::string const &);
