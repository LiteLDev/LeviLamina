...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_OLDLEAVESBLOCK
public:
    class OldLeavesBlock& operator=(class OldLeavesBlock const &) = delete;
    OldLeavesBlock(class OldLeavesBlock const &) = delete;
...
public:
    ...
    /**
     * @vftbl 102
     * @symbol ?asItemInstance\@OldLeavesBlock\@\@UEBA?AVItemInstance\@\@AEBVBlock\@\@PEBVBlockActor\@\@\@Z
     */
    ...
    /**
     * @vftbl 132
     * @symbol ?buildDescriptionId\@OldLeavesBlock\@\@UEBA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@AEBVBlock\@\@\@Z
     */
    virtual std::string buildDescriptionId(class Block const &) const;
    /**
     * @vftbl 133
     * @symbol ?isAuxValueRelevantForPicking\@OldLeavesBlock\@\@UEBA_NXZ
     */
    ...
    /**
     * @vftbl 180
     * @symbol ?getRenderLayer\@OldLeavesBlock\@\@UEBA?AW4BlockRenderLayer\@\@AEBVBlock\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    virtual enum class BlockRenderLayer getRenderLayer(class Block const &, class BlockSource &, class BlockPos const &) const;
    /**
     * @vftbl 185
     * @symbol ?getMapColor\@OldLeavesBlock\@\@UEBA?AVColor\@mce\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@\@Z
     */
    ...
    /**
     * @vftbl 194
     * @symbol ?getExtraResourceItem\@OldLeavesBlock\@\@MEBA?AVItemInstance\@\@AEBVBlock\@\@\@Z
     */
