/**
 * @file  PlayerChangeDimensionRequestComponent.hpp
 *
 */
#pragma once
...
public:
    struct PlayerChangeDimensionRequestComponent& operator=(struct PlayerChangeDimensionRequestComponent const &) = delete;
    PlayerChangeDimensionRequestComponent(struct PlayerChangeDimensionRequestComponent const &) = delete;
