...
#undef AFTER_EXTRA
     ...
     */
    MCAPI class ChunkLocalHeight calculateHeight(class BlendingData &, std::vector<struct BlendingDataFactoryUtil::BorderCellEntry> &, class ChunkLocalHeight, class std::function<struct SubChunk & (int)>);
    /**
