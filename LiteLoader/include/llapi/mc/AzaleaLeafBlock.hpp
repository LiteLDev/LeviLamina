...
public:
     ...
     * @hash   52892306
     * @vftbl  103
     * @symbol ?asItemInstance@AzaleaLeafBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
     */
     ...
     * @hash   -1267677113
     * @vftbl  187
     * @symbol ?getMapColor@AzaleaLeafBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z
     */
