/**
 * @file  CalibratedSculkSensorBlock.hpp
 *
 */
#pragma once
#define AUTO_GENERATED
#include "llapi/Global.h"
#include "SculkSensorBlock.hpp"
...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_CALIBRATEDSCULKSENSORBLOCK
public:
    class CalibratedSculkSensorBlock& operator=(class CalibratedSculkSensorBlock const &) = delete;
    CalibratedSculkSensorBlock(class CalibratedSculkSensorBlock const &) = delete;
...
public:
    ...
    /**
     * @vftbl 81
     * @symbol ?setupRedstoneComponent\@CalibratedSculkSensorBlock\@\@UEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    ...
    /**
     * @vftbl 108
     * @symbol ?getPlacementBlock\@CalibratedSculkSensorBlock\@\@UEBAAEBVBlock\@\@AEBVActor\@\@AEBVBlockPos\@\@EAEBVVec3\@\@H\@Z
     */
