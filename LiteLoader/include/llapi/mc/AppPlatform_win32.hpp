...
public:
     ...
     */
    MCAPI AppPlatform_win32(struct HWND__*, std::string const &, std::string const &, class std::basic_string_view<char, struct std::char_traits<char>>, class std::shared_ptr<class HIDController>, int, int);
    /**
