...
public:
    ...
    /**
     * @vftbl 57
     * @symbol ?isLiquidClipItem\@WaterLilyBlockItem\@\@UEBA_NXZ
     */
    ...
    /**
     * @vftbl 135
     * @symbol ?_useOn\@WaterLilyBlockItem\@\@UEBA?AVInteractionResult\@\@AEAVItemStack\@\@AEAVActor\@\@VBlockPos\@\@EAEBVVec3\@\@\@Z
     */
