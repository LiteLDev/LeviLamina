...
#undef AFTER_EXTRA
     ...
     */
    MCAPI class Json::Value & getMemberByCaseInsensitiveName(class Json::Value &, class std::basic_string_view<char, struct std::char_traits<char>> const &);
    /**
     ...
     */
    MCAPI class Json::Value const & getMemberByCaseInsensitiveNameConst(class Json::Value const &, class std::basic_string_view<char, struct std::char_traits<char>> const &);
    /**
