...
public:
     ...
     */
    MCAPI bool deserializeKey(class std::basic_string_view<char, struct std::char_traits<char>>, class std::basic_string_view<char, struct std::char_traits<char>>);
    /**
     ...
     */
    MCAPI static struct std::pair<enum class LevelChunkTag, short> getTagAndSubIndexFromKey(class std::basic_string_view<char, struct std::char_traits<char>>);
    /**
