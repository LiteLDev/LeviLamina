...
/**
 * @brief MC class MangroveLeafBlock.
 *
 */
...
public:
     ...
     * @hash   -1996359095
     * @vftbl  103
     * @symbol ?asItemInstance@MangroveLeafBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
     */
