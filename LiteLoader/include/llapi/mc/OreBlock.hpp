...
public:
     ...
     * @hash   -1990905873
     * @vftbl  104
     * @symbol ?spawnResources@OreBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@PEAV?$vector@PEBVItem@@V?$allocator@PEBVItem@@@std@@@std@@MH@Z
     */
