/**
 * @file  GildedBlackstoneBlock.hpp
 *
 */
#pragma once
...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_GILDEDBLACKSTONEBLOCK
public:
    class GildedBlackstoneBlock& operator=(class GildedBlackstoneBlock const &) = delete;
    GildedBlackstoneBlock(class GildedBlackstoneBlock const &) = delete;
