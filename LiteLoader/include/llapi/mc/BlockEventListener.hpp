...
public:
     ...
     */
    virtual enum class EventResult onBlockPlacedByPlayer(class Player &, class Block const &, class BlockPos const &, bool);
    /**
     * @vftbl 2
     * @symbol ?onBlockDestroyedByPlayer\@BlockEventListener\@\@UEAA?AW4EventResult\@\@AEAVPlayer\@\@AEBVBlock\@\@AEBVBlockPos\@\@AEBVItemStackBase\@\@3\@Z
     */
    virtual enum class EventResult onBlockDestroyedByPlayer(class Player &, class Block const &, class BlockPos const &, class ItemStackBase const &, class ItemStackBase const &);
    /**
     * @vftbl 3
     * @symbol __unk_vfn_3
     */
    ...
    /**
     * @vftbl 6
     * @symbol ?onBlockDestructionStarted\@BlockEventListener\@\@UEAA?AW4EventResult\@\@AEAVPlayer\@\@AEBVBlockPos\@\@E\@Z
     */
     ...
     */
    virtual enum class EventResult onBlockExploded(class Dimension &, class BlockPos const &, class Block const &, class Actor *);
    /**
     * @vftbl 9
     * @symbol __unk_vfn_9
     */
