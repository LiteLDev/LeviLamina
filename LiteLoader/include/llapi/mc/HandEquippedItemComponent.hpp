/**
 * @file  HandEquippedItemComponent.hpp
 *
 */
#pragma once
...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_HANDEQUIPPEDITEMCOMPONENT
public:
    class HandEquippedItemComponent& operator=(class HandEquippedItemComponent const &) = delete;
    HandEquippedItemComponent(class HandEquippedItemComponent const &) = delete;
...
public:
    ...
    /**
     * @vftbl 9
     * @symbol ?_initializeComponent\@HandEquippedItemComponent\@\@UEBAXXZ
     */
