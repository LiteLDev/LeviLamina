...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_HAYBLOCK
public:
    class HayBlock& operator=(class HayBlock const &) = delete;
    HayBlock(class HayBlock const &) = delete;
    HayBlock() = delete;
#endif
...
public:
    ...
    /**
     * @vftbl 102
     * @symbol ?asItemInstance\@HayBlock\@\@UEBA?AVItemInstance\@\@AEBVBlock\@\@PEBVBlockActor\@\@\@Z
     */
    ...
    /**
     * @vftbl 168
     * @symbol ?onFallOn\@HayBlock\@\@UEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVActor\@\@M\@Z
     */
