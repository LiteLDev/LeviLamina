/**
 * @file  MC/RotatedPillarInfestedBlock.hpp
 *
 */
#pragma once
...
public:
     ...
     * @hash   1666765402
     * @vftbl  104
     * @symbol ?spawnResources@RotatedPillarInfestedBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@PEAV?$vector@PEBVItem@@V?$allocator@PEBVItem@@@std@@@std@@MH@Z
     */
