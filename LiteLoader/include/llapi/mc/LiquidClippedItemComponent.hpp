/**
 * @file  LiquidClippedItemComponent.hpp
 *
 */
#pragma once
...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_LIQUIDCLIPPEDITEMCOMPONENT
public:
    class LiquidClippedItemComponent& operator=(class LiquidClippedItemComponent const &) = delete;
    LiquidClippedItemComponent(class LiquidClippedItemComponent const &) = delete;
#endif
...
public:
    ...
    /**
     * @vftbl 9
     * @symbol ?_initializeComponent\@LiquidClippedItemComponent\@\@UEBAXXZ
     */
