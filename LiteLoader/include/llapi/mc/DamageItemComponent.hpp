...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_DAMAGEITEMCOMPONENT
public:
    class DamageItemComponent& operator=(class DamageItemComponent const &) = delete;
    DamageItemComponent(class DamageItemComponent const &) = delete;
#endif
...
public:
    ...
    /**
     * @vftbl 9
     * @symbol ?_initializeComponent\@DamageItemComponent\@\@UEBAXXZ
     */
