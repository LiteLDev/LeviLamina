...
public:
     ...
     */
    virtual class std::optional<struct gametest::GameTestError> assertEntityInstancePresent(class Actor const *, bool) const;
    /**
     * @vftbl 33
...
//private:
     ...
     */
    MCAPI class std::optional<struct gametest::GameTestError> _assertEntityInstancePresent(class Actor const *, class AABB const &, class BlockPos const &, bool) const;
    /**
