...
/**
 * @brief MC class NetherReactorBlock.
 *
 */
...
public:
     ...
     * @hash   2133810791
     * @vftbl  104
     * @symbol ?spawnResources@NetherReactorBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@PEAV?$vector@PEBVItem@@V?$allocator@PEBVItem@@@std@@@std@@MH@Z
     */
