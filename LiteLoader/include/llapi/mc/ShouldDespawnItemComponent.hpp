/**
 * @file  ShouldDespawnItemComponent.hpp
 *
 */
#pragma once
...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SHOULDDESPAWNITEMCOMPONENT
public:
    class ShouldDespawnItemComponent& operator=(class ShouldDespawnItemComponent const &) = delete;
    ShouldDespawnItemComponent(class ShouldDespawnItemComponent const &) = delete;
#endif
...
public:
    ...
    /**
     * @vftbl 9
     * @symbol ?_initializeComponent\@ShouldDespawnItemComponent\@\@UEBAXXZ
     */
