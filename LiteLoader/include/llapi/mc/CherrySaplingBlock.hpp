...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_CHERRYSAPLINGBLOCK
public:
    class CherrySaplingBlock& operator=(class CherrySaplingBlock const &) = delete;
    CherrySaplingBlock(class CherrySaplingBlock const &) = delete;
...
public:
    ...
    /**
     * @vftbl 64
     * @symbol ?canContainLiquid\@CherrySaplingBlock\@\@UEBA_NXZ
     */
    ...
    /**
     * @vftbl 88
     * @symbol ?onFertilized\@CherrySaplingBlock\@\@UEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@PEAVActor\@\@W4FertilizerType\@\@\@Z
     */
    virtual bool onFertilized(class BlockSource &, class BlockPos const &, class Actor *, enum class FertilizerType) const;
    /**
     * @vftbl 90
     * @symbol ?canBeFertilized\@CherrySaplingBlock\@\@UEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@\@Z
     */
    virtual bool canBeFertilized(class BlockSource &, class BlockPos const &, class Block const &) const;
    /**
     * @vftbl 94
     * @symbol ?mayPlace\@CherrySaplingBlock\@\@UEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    ...
    /**
     * @vftbl 169
     * @symbol ?randomTick\@CherrySaplingBlock\@\@UEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@\@Z
     */
    ...
    /**
     * @vftbl 176
     * @symbol ?getRenderLayer\@CherrySaplingBlock\@\@UEBA?AW4BlockRenderLayer\@\@XZ
     */
    virtual enum class BlockRenderLayer getRenderLayer() const;
    /**
     * @vftbl 177
     * @symbol ?getRenderLayer\@CherrySaplingBlock\@\@UEBA?AW4BlockRenderLayer\@\@AEBVBlock\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
