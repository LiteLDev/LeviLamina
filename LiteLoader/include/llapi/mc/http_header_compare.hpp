...
public:
    class http_header_compare& operator=(class http_header_compare const &) = delete;
    http_header_compare(class http_header_compare const &) = delete;
