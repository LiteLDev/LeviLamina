...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_LIGHTNINGRODBLOCK
public:
    class LightningRodBlock& operator=(class LightningRodBlock const &) = delete;
    LightningRodBlock(class LightningRodBlock const &) = delete;
...
public:
    ...
    /**
     * @vftbl 147
     * @symbol ?animateTickBedrockLegacy\@LightningRodBlock\@\@UEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@\@Z
     */
