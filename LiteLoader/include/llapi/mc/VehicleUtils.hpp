...
public:
     ...
     */
    //MCAPI static class std::optional<class Vec3> (__cdecl *)(struct VehicleUtils::VehicleDirections const &, class std::function<bool (class Vec3 const &, class Vec3 const &)>) getActivatorRailExitPatternStrategy(class BaseGameVersion const &);
    /**
     ...
     */
    //MCAPI static class std::optional<class Vec3> (__cdecl *)(struct VehicleUtils::VehicleDirections const &, class std::function<bool (class Vec3 const &, class Vec3 const &)>) getActorExitPatternStrategy(class BaseGameVersion const &);
    /**
