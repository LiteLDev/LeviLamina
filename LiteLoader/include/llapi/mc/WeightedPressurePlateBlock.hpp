...
/**
 * @brief MC class WeightedPressurePlateBlock.
 *
 */
...
public:
     ...
     * @hash   1669111638
     * @vftbl  103
     * @symbol ?asItemInstance@WeightedPressurePlateBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
     */
