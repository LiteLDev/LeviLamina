...
public:
     ...
     * @hash   1246036255
     * @vftbl  104
     * @symbol ?spawnResources@DragonEggBlock@@UEBAXAEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@AEAVRandomize@@PEAV?$vector@PEBVItem@@V?$allocator@PEBVItem@@@std@@@std@@MH@Z
     */
