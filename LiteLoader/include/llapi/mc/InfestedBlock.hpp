...
public:
    ...
    /**
     * @vftbl 101
     * @symbol ?spawnResources\@InfestedBlock\@\@UEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@AEAVRandomize\@\@AEBUResourceDropsContext\@\@\@Z
     */
    ...
    /**
     * @vftbl 102
     * @symbol ?asItemInstance\@InfestedBlock\@\@UEBA?AVItemInstance\@\@AEBVBlock\@\@PEBVBlockActor\@\@\@Z
     */
    ...
    /**
     * @vftbl 132
     * @symbol ?buildDescriptionId\@InfestedBlock\@\@UEBA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@AEBVBlock\@\@\@Z
     */
    virtual std::string buildDescriptionId(class Block const &) const;
    /**
     * @vftbl 133
     * @symbol ?isAuxValueRelevantForPicking\@InfestedBlock\@\@UEBA_NXZ
     */
    ...
    /**
     * @vftbl 159
     * @symbol ?tryGetUninfested\@InfestedBlock\@\@UEBAPEBVBlock\@\@AEBV2\@\@Z
     */
