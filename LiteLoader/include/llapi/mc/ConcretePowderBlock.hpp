...
public:
    ...
    /**
     * @vftbl 104
     * @symbol ?asItemInstance\@ConcretePowderBlock\@\@UEBA?AVItemInstance\@\@AEBVBlock\@\@PEBVBlockActor\@\@\@Z
     */
...
//private:
     ...
     */
    MCAPI bool _tryTouchWater(class BlockSource &, class BlockPos const &, class std::optional<class HashedString>) const;
