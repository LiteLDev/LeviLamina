...
public:
    ...
    /**
     * @vftbl 3
     * @symbol ?hasKey\@DBStorage\@\@UEBA_NV?$basic_string_view\@DU?$char_traits\@D\@std\@\@\@std\@\@W4Category\@DBHelpers\@\@\@Z
     */
    virtual bool hasKey(class std::basic_string_view<char, struct std::char_traits<char>>, enum class DBHelpers::Category) const = 0;
    /**
     * @vftbl 4
     * @symbol ?forEachKeyWithPrefix\@DBStorage\@\@UEBAXV?$basic_string_view\@DU?$char_traits\@D\@std\@\@\@std\@\@W4Category\@DBHelpers\@\@AEBV?$function\@$$A6AXV?$basic_string_view\@DU?$char_traits\@D\@std\@\@\@std\@\@0\@Z\@3\@\@Z
     */
    virtual void forEachKeyWithPrefix(class std::basic_string_view<char, struct std::char_traits<char>>, enum class DBHelpers::Category, class std::function<void (class std::basic_string_view<char, struct std::char_traits<char>>, class std::basic_string_view<char, struct std::char_traits<char>>)> const &) const = 0;
    /**
     * @vftbl 5
     ...
     */
    virtual bool clonePlayerData(class std::basic_string_view<char, struct std::char_traits<char>>, class std::basic_string_view<char, struct std::char_traits<char>>);
    /**
     * @vftbl 14
     * @symbol __unk_vfn_14
     */
    ...
    /**
     * @vftbl 18
     * @symbol ?loadData\@LevelStorage\@\@UEBA_NV?$basic_string_view\@DU?$char_traits\@D\@std\@\@\@std\@\@AEAV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@3\@W4Category\@DBHelpers\@\@\@Z
     */
    virtual bool loadData(class std::basic_string_view<char, struct std::char_traits<char>>, std::string &, enum class DBHelpers::Category) const;
    /**
     * @vftbl 19
     * @symbol __unk_vfn_19
     */
     ...
     */
    MCAPI std::unique_ptr<class CompoundTag> loadPlayerDataFromTag(class std::basic_string_view<char, struct std::char_traits<char>>);
    /**
