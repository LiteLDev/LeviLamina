...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_GLOWSTONEBLOCK
public:
    class GlowstoneBlock& operator=(class GlowstoneBlock const &) = delete;
    GlowstoneBlock(class GlowstoneBlock const &) = delete;
