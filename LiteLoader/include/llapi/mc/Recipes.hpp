...
public:
    ...
    /**
     * @symbol ?addShulkerBoxRecipe\@Recipes\@\@QEAAXAEAV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@AEBVItemInstance\@\@AEBV?$vector\@VType\@Recipes\@\@V?$allocator\@VType\@Recipes\@\@\@std\@\@\@3\@AEBV?$vector\@VHashedString\@\@V?$allocator\@VHashedString\@\@\@std\@\@\@3\@V?$optional\@VRecipeUnlockingRequirement\@\@\@3\@\@Z
     */
    MCAPI void addShulkerBoxRecipe(std::string &, class ItemInstance const &, std::vector<class Recipes::Type> const &, std::vector<class HashedString> const &, class std::optional<class RecipeUnlockingRequirement>);
    /**
     ...
     */
    MCAPI void forEachRecipeFor(class HashedString const &, class std::function<void (class Recipe const &)> const &) const;
    /**
...
//protected:
     ...
     */
    MCAPI class std::optional<class RecipeUnlockingRequirement> _loadUnlockingRequirementFromJson(class Json::Value const &, class SemVersion const &, std::string const &) const;
    /**
