...
public:
     ...
     */
    MCAPI void addShulkerBoxRecipe(std::string &, class ItemInstance const &, std::vector<class Recipes::Type> const &, std::vector<class HashedString> const &, class std::optional<class RecipeUnlockingRequirement>, class SemVersion const &);
    /**
     ...
     */
    MCAPI bool loadRecipe(struct std::pair<std::string, class Json::Value> const &, class SemVersion const &, class SemVersion const &, bool);
    /**
...
//protected:
     ...
     */
    MCAPI class std::optional<class RecipeUnlockingRequirement> _createUnlockingRequirementFromContext(enum class RecipeUnlockingRequirement::UnlockingContext) const;
    /**
