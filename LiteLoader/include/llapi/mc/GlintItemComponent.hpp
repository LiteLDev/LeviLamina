...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_GLINTITEMCOMPONENT
public:
    class GlintItemComponent& operator=(class GlintItemComponent const &) = delete;
    GlintItemComponent(class GlintItemComponent const &) = delete;
...
public:
    ...
    /**
     * @vftbl 9
     * @symbol ?_initializeComponent\@GlintItemComponent\@\@UEBAXXZ
     */
