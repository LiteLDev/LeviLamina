...
public:
    class PinkPetalsBlock& operator=(class PinkPetalsBlock const &) = delete;
    PinkPetalsBlock(class PinkPetalsBlock const &) = delete;
...
public:
    ...
    /**
     * @vftbl 6
     * @symbol ?getCollisionShape\@PinkPetalsBlock\@\@UEBA?AVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@V?$optional_ref\@$$CBVGetCollisionShapeInterface\@\@\@\@\@Z
     */
    ...
    /**
     * @vftbl 87
     * @symbol ?onFertilized\@PinkPetalsBlock\@\@UEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@PEAVActor\@\@W4FertilizerType\@\@\@Z
     */
