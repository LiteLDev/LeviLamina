/**
 * @file  StackedByDataItemComponent.hpp
 *
 */
#pragma once
...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_STACKEDBYDATAITEMCOMPONENT
public:
    class StackedByDataItemComponent& operator=(class StackedByDataItemComponent const &) = delete;
    StackedByDataItemComponent(class StackedByDataItemComponent const &) = delete;
...
public:
    ...
    /**
     * @vftbl 9
     * @symbol ?_initializeComponent\@StackedByDataItemComponent\@\@UEBAXXZ
     */
