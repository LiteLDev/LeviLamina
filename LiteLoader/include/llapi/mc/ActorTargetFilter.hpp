...
public:
     ...
     */
    MCAPI static class std::unordered_map<class HashedString, bool (__cdecl *)(struct ActorTargetFilter const &, class Actor &), struct std::hash<class HashedString>, struct std::equal_to<class HashedString>, class std::allocator<struct std::pair<class HashedString const, bool (__cdecl *)(struct ActorTargetFilter const &, class Actor &)>>> ConditionPredicates;
