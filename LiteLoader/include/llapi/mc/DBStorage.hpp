...
public:
     ...
     */
    virtual bool hasKey(class std::basic_string_view<char, struct std::char_traits<char>>, enum class DBHelpers::Category) const;
    /**
     * @vftbl 4
     ...
     */
    virtual void forEachKeyWithPrefix(class std::basic_string_view<char, struct std::char_traits<char>>, enum class DBHelpers::Category, class std::function<void (class std::basic_string_view<char, struct std::char_traits<char>>, class std::basic_string_view<char, struct std::char_traits<char>>)> const &) const;
    /**
     * @vftbl 5
    ...
    /**
     * @vftbl 18
     * @symbol ?loadData\@DBStorage\@\@UEBA_NV?$basic_string_view\@DU?$char_traits\@D\@std\@\@\@std\@\@AEAV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@3\@W4Category\@DBHelpers\@\@\@Z
     */
...
//protected:
     ...
     */
    MCAPI void _read(class std::basic_string_view<char, struct std::char_traits<char>>, enum class DBHelpers::Category, class std::function<void (class std::basic_string_view<char, struct std::char_traits<char>>, class std::basic_string_view<char, struct std::char_traits<char>>)> const &) const;
    /**
