...
public:
     ...
     * @hash   1533588995
     * @vftbl  103
     * @symbol ?asItemInstance@OldLogBlock@@UEBA?AVItemInstance@@AEAVBlockSource@@AEBVBlockPos@@AEBVBlock@@@Z
     */
     ...
     * @hash   -1650586890
     * @vftbl  187
     * @symbol ?getMapColor@OldLogBlock@@UEBA?AVColor@mce@@AEAVBlockSource@@AEBVBlockPos@@@Z
     */
