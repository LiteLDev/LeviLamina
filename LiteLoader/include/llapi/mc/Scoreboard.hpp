...
public:
     ...
     * @hash   363657777
     */
    virtual class DisplayObjective const* setDisplayObjective(std::string const&, class Objective const&,
     ...
     * @hash   1850498911
     */
    MCAPI int applyPlayerOperation(bool&, std::vector<struct ScoreboardId>&, struct ScoreboardId const&,
                                   class Objective&, std::vector<struct ScoreboardId>&, class Objective&,
     ...
     * @hash   -1721369802
     */
    MCAPI int modifyPlayerScore(bool&, struct ScoreboardId const&, class Objective&, int,
     ...
     * @hash   1616157924
     */
    MCAPI class ScoreboardIdentityRef const& registerScoreboardIdentity(struct ScoreboardId const&,
     ...
     */
    MCAPI class ScoreboardIdentityRef const& registerScoreboardIdentity(struct ScoreboardId const&,
                                                                        struct PlayerScoreboardId const&);
    /**
     * @symbol
    ...
    MCAPI class std::unordered_map<
        std::string, std::unique_ptr<class ObjectiveCriteria>, struct std::hash<std::string>,
     ...
     */
    MCAPI class std::unordered_map<
        std::string, std::unique_ptr<class Objective>, struct std::hash<std::string>, struct std::equal_to<std::string>,
