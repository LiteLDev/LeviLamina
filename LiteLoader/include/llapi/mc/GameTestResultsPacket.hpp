/**
 * @file  MC/GameTestResultsPacket.hpp
 *
 */
#pragma once
...
public:
    ...
    /**
     * @symbol ??0GameTestResultsPacket@@QEAA@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@_N@Z
     */
    MCAPI GameTestResultsPacket(std::string const &, std::string, bool);
