...
public:
    class BlockUnitCubeDescription& operator=(class BlockUnitCubeDescription const &) = delete;
    BlockUnitCubeDescription(class BlockUnitCubeDescription const &) = delete;
