...
public:
    ...
    /**
     * @vftbl 6
     * @symbol ?getCollisionShape\@RedStoneWireBlock\@\@UEBA?AVAABB\@\@AEBVBlock\@\@AEBVIConstBlockSource\@\@AEBVBlockPos\@\@V?$optional_ref\@$$CBVGetCollisionShapeInterface\@\@\@\@\@Z
     */
    ...
    /**
     * @vftbl 147
     * @symbol ?animateTickBedrockLegacy\@RedStoneWireBlock\@\@UEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@\@Z
     */
