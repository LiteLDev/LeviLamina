...
public:
    ...
    MCAPI void disable();
    /**
     * @symbol ?getActiveConnector\@RemoteConnectorComposite\@\@QEBA?AV?$NonOwnerPointer\@VRemoteConnector\@\@\@Bedrock\@\@XZ
     */
    MCAPI class Bedrock::NonOwnerPointer<class RemoteConnector> getActiveConnector() const;
    /**
     * @symbol ?getNetherNetConnector\@RemoteConnectorComposite\@\@QEBA?AV?$NonOwnerPointer\@UNetherNetConnector\@\@\@Bedrock\@\@XZ
     */
    MCAPI class Bedrock::NonOwnerPointer<struct NetherNetConnector> getNetherNetConnector() const;
    /**
     * @symbol ?getRakNetConnector\@RemoteConnectorComposite\@\@QEBA?AV?$NonOwnerPointer\@VRakNetConnector\@\@\@Bedrock\@\@XZ
     */
    MCAPI class Bedrock::NonOwnerPointer<class RakNetConnector> getRakNetConnector() const;
    /**
