/**
 * @file  LegacyTelemetryEventPacket.hpp
 *
 */
#pragma once
...
public:
    class LegacyTelemetryEventPacket& operator=(class LegacyTelemetryEventPacket const &) = delete;
    LegacyTelemetryEventPacket(class LegacyTelemetryEventPacket const &) = delete;
#endif
...
public:
    ...
    /**
     * @vftbl 2
     * @symbol ?getName\@LegacyTelemetryEventPacket\@\@UEBA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@XZ
     */
    ...
    /**
     * @vftbl 7
     * @symbol ?_read\@LegacyTelemetryEventPacket\@\@EEAA?AV?$Result\@XVerror_code\@std\@\@\@Bedrock\@\@AEAVReadOnlyBinaryStream\@\@\@Z
     */
     ...
     */
    MCAPI LegacyTelemetryEventPacket(class Player const *, class Actor const *, class gsl::not_null<class Mob const *>, enum class ActorDamageCause, enum class ActorType);
    /**
