...
//private:
     ...
     */
    MCAPI Potion(class std::basic_string_view<char, struct std::char_traits<char>>, std::vector<std::string>, std::vector<class MobEffectInstance>, enum class Potion::PotionVariant);
    /**
     * @symbol ??0Potion\@\@AEAA\@V?$basic_string_view\@DU?$char_traits\@D\@std\@\@\@std\@\@0AEBVMobEffectInstance\@\@W4PotionVariant\@0\@\@Z
     */
    MCAPI Potion(class std::basic_string_view<char, struct std::char_traits<char>>, class std::basic_string_view<char, struct std::char_traits<char>>, class MobEffectInstance const &, enum class Potion::PotionVariant);
    /**
