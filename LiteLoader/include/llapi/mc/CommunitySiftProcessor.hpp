...
//private:
     ...
     * @hash   -239565665
     */
    MCAPI class std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> _createRequest(std::string const &, std::string const &, class IMinecraftEventing *, std::string const &, enum class TextProcessingEventOrigin, class std::shared_ptr<std::vector<std::string>>, class std::shared_ptr<std::vector<std::string>>, bool, std::string const &);
    /**
