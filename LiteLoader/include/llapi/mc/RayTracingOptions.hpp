...
public:
    ...
    /**
     * @symbol ?getPackDeferredCapability\@RayTracingOptions\@\@SA?AVPackCapability\@\@V?$NonOwnerPointer\@VIAdvancedGraphicsOptions\@\@\@Bedrock\@\@\@Z
     */
    MCAPI static class PackCapability getPackDeferredCapability(class Bedrock::NonOwnerPointer<class IAdvancedGraphicsOptions>);
