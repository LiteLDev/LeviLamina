...
public:
     ...
     */
    MCAPI static std::string deserializeActorStorageToString(bool, std::string const &, class std::function<bool (class std::basic_string_view<char, struct std::char_traits<char>>, std::string &)>);
...
//private:
     ...
     */
    MCAPI void _saveBlendData(class LevelStorageWriteBatch &, class std::basic_string_view<char, struct std::char_traits<char>> const &, std::string &, struct PersistentBlendData) const;
    /**
     ...
     */
    MCAPI std::string _upgradeActorStorage(class ChunkKey, class std::basic_string_view<char, struct std::char_traits<char>> &);
    /**
