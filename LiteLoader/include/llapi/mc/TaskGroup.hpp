...
public:
     ...
     */
    MCAPI class std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> queue(class std::basic_string_view<char, struct std::char_traits<char>>, class std::function<class TaskResult (void)> &&, class std::function<void (void)> &&);
    /**
     ...
     */
    MCAPI class std::shared_ptr<class Bedrock::Threading::IAsyncResult<void>> queueSync(class std::basic_string_view<char, struct std::char_traits<char>>, class std::function<class TaskResult (void)> &&);
    /**
