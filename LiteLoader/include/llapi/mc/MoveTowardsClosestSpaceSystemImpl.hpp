/**
 * @file  MoveTowardsClosestSpaceSystemImpl.hpp
 *
 */
#pragma once
...
public:
    struct MoveTowardsClosestSpaceSystemImpl& operator=(struct MoveTowardsClosestSpaceSystemImpl const &) = delete;
    MoveTowardsClosestSpaceSystemImpl(struct MoveTowardsClosestSpaceSystemImpl const &) = delete;
