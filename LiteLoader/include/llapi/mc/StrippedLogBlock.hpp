...
public:
    ...
    /**
     * @vftbl 185
     * @symbol ?getMapColor\@StrippedLogBlock\@\@UEBA?AVColor\@mce\@\@AEAVBlockSource\@\@AEBVBlockPos\@\@AEBVBlock\@\@\@Z
     */
     ...
     */
    MCAPI StrippedLogBlock(std::string const &, int, class std::optional<struct LogBlockMapColors>);
