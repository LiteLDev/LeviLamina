...
public:
     ...
     */
    MCAPI enum class NetworkPeer::DataStatus receivePacket(std::string &, class NetworkSystem &, class std::shared_ptr<class std::chrono::time_point<struct std::chrono::steady_clock, class std::chrono::duration<__int64, struct std::ratio<1, 1000000000>>>> const &);
    /**
