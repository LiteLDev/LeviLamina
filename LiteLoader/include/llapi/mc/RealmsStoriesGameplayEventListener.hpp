/**
 * @file  RealmsStoriesGameplayEventListener.hpp
 *
 */
#pragma once
...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_REALMSSTORIESGAMEPLAYEVENTLISTENER
public:
    class RealmsStoriesGameplayEventListener& operator=(class RealmsStoriesGameplayEventListener const &) = delete;
    RealmsStoriesGameplayEventListener(class RealmsStoriesGameplayEventListener const &) = delete;
