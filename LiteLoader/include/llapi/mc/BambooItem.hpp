...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_BAMBOOITEM
public:
    class BambooItem& operator=(class BambooItem const &) = delete;
    BambooItem(class BambooItem const &) = delete;
    BambooItem() = delete;
#endif
...
public:
    ...
    /**
     * @vftbl 134
     * @symbol ?_useOn\@BambooItem\@\@UEBA?AVInteractionResult\@\@AEAVItemStack\@\@AEAVActor\@\@VBlockPos\@\@EAEBVVec3\@\@\@Z
     */
