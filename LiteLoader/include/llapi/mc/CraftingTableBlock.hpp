...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_CRAFTINGTABLEBLOCK
public:
    class CraftingTableBlock& operator=(class CraftingTableBlock const &) = delete;
    CraftingTableBlock(class CraftingTableBlock const &) = delete;
...
public:
    ...
    /**
     * @vftbl 160
     * @symbol ?_addHardCodedBlockComponents\@CraftingTableBlock\@\@UEAAXXZ
     */
