...
#undef AFTER_EXTRA
#ifndef DISABLE_CONSTRUCTOR_PREVENTION_SNIFFEREGGBLOCK
public:
    class SnifferEggBlock& operator=(class SnifferEggBlock const &) = delete;
    SnifferEggBlock(class SnifferEggBlock const &) = delete;
...
public:
    ...
    /**
     * @vftbl 71
     * @symbol ?checkIsPathable\@SnifferEggBlock\@\@UEBA_NAEAVActor\@\@AEBVBlockPos\@\@1\@Z
     */
    ...
    /**
     * @vftbl 94
     * @symbol ?mayPlace\@SnifferEggBlock\@\@UEBA_NAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    ...
    /**
     * @vftbl 133
     * @symbol ?buildDescriptionId\@SnifferEggBlock\@\@UEBA?AV?$basic_string\@DU?$char_traits\@D\@std\@\@V?$allocator\@D\@2\@\@std\@\@AEBVBlock\@\@\@Z
     */
    ...
    /**
     * @vftbl 165
     * @symbol ?onPlace\@SnifferEggBlock\@\@UEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@\@Z
     */
    ...
    /**
     * @vftbl 168
     * @symbol ?tick\@SnifferEggBlock\@\@UEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@\@Z
     */
...
//private:
     ...
     */
    MCAPI static void _spawnParticles(enum class LevelEvent, class BlockSource &, class BlockPos const &);
