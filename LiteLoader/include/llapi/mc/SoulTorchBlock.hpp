...
public:
    ...
    /**
     * @vftbl 147
     * @symbol ?animateTickBedrockLegacy\@SoulTorchBlock\@\@UEBAXAEAVBlockSource\@\@AEBVBlockPos\@\@AEAVRandom\@\@\@Z
     */
    ...
    /**
     * @vftbl 158
     * @symbol ?_addHardCodedBlockComponents\@SoulTorchBlock\@\@UEAAXXZ
     */
