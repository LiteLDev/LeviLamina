...
mkdir %OUTPUT_DIR%\plugins\LiteLoader\pdb >nul
copy /Y %PROJECT_PATH%\build\LiteLoader\Release\LiteLoader.pdb %OUTPUT_DIR%\plugins\LiteLoader\pdb\ >nul
copy /Y %PROJECT_PATH%\build\ScriptEngine\CMake\ScriptEngine-QuickJs\Release\LiteLoader.Js.pdb %OUTPUT_DIR%\plugins\LiteLoader\pdb\ >nul
copy /Y %PROJECT_PATH%\build\ScriptEngine\CMake\ScriptEngine-NodeJs\Release\LiteLoader.NodeJs.pdb %OUTPUT_DIR%\plugins\LiteLoader\pdb\ >nul
copy /Y %PROJECT_PATH%\build\ScriptEngine\CMake\ScriptEngine-Lua\Release\LiteLoader.Lua.pdb %OUTPUT_DIR%\plugins\LiteLoader\pdb\ >nul
